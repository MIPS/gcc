...
;; Operand2 is either the static chain or 0.
...
(define_insn "*call_indirect_aix<ptrsize>_internal"
  [(call (mem:SI (match_operand:P 0 "register_operand" "c,*l"))
   ...
   (use (match_operand:P 2 "optional_static_chain_operand" "rO,rO"))
   (set (reg:P 2)
	(match_operand:P 3 "memory_operand" "m,m"))
   (clobber (reg:P LR_REGNO))]
...
;; Operand4 is the location in the function descriptor to load r2 from
;; Operand5 is the stack location to hold the current TOC pointer
...
(define_insn_and_split "call_value_indirect_aix<ptrsize>"
  [(set (match_operand 0 "" "")
   ...
   (use (match_operand:P 4 "memory_operand" "m,m"))
   (use (match_operand:P 5 "memory_operand" "m,m"))
   (clobber (reg:P LR_REGNO))]
  "DEFAULT_ABI == ABI_AIX"
  "#"
  "&& reload_completed"
