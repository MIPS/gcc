...
;; These patterns caused various errors, comment out for now
...
;; the base register is live after the load, don't do this optimization
;; (define_peephole2
;;   [(set (match_operand:P 0 "base_reg_operand" "")
;; 	(match_operand:P 1 "fusion_gpr_addis" ""))
;;    (set (match_dup 0)
;; 	(lo_sum:P (match_dup 0)
;; 		  (match_operand:P 2 "" "")))
...
;;   rtx addr;
;; 
;;   fuse_ops[0] = operands[0];
;;   fuse_ops[1] = operands[1];
;;   fuse_ops[2] = operands[3];
;; 
;;   addr = gen_rtx_LO_SUM (Pmode, operands[0], operands[2]);
;;   fuse_ops[3] = replace_equiv_address_nv (operands[4], addr, false);
;;   expand_fusion_extra_load (fuse_ops);
;;   DONE;
;; })
;; 
;; (define_peephole2
...
;; 
;;   addr = gen_rtx_LO_SUM (Pmode, operands[0], operands[2]);
;;   new_mem = replace_equiv_address_nv (operands[4], addr, false);
;;   fuse_ops[3] = gen_rtx_FLOAT_EXTEND (DFmode, new_mem);
;;   expand_fusion_extra_load (fuse_ops);
;;   DONE;
;; })
;; 
...
;;   [(set (match_operand:P 0 "base_reg_operand" "")
;; 	(match_operand:P 1 "fusion_gpr_addis" ""))
;;    (set (match_operand:GPR_FUSION 2 "offsettable_mem_operand" "")
;; 	(match_operand:GPR_FUSION 3 "int_reg_operand" ""))]
;;   "TARGET_FUSION_EXTRA && peep2_reg_dead_p (2, operands[0])
;;    && fusion_extra_p (operands[0], operands[1], operands[2], operands[3])"
;;   [(const_int 0)]
;; {
