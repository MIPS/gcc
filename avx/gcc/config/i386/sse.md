...
(define_mode_attr avxmodesuffixp
 [(V2DF "pd") (V4SI "si") (V4SF "ps") (V8SF "ps") (V8SI "si") (V4DF "pd")])
  ...
  [(set (match_operand:V4SF 0 "register_operand" "=x")
	(vec_select:V4SF
	  ...
	  (parallel [(const_int 1)
		     ...
		     (const_int 7)])))]
  "TARGET_SSE3"
  "* return TARGET_AVX ? \"vmovshdup\t{%1, %0|%0, %1}\"
                       : \"movshdup\t{%1, %0|%0, %1}\";"
  [(set_attr "type" "sse")
   (set_attr "prefix_rep" "1")
   (set_attr "prefix" "maybe_vex")
  ...
  [(set (match_operand:V4SF 0 "register_operand" "=x")
	(vec_select:V4SF
	  ...
	  (parallel [(const_int 0)
		     ...
		     (const_int 6)])))]
  "TARGET_SSE3"
  "* return TARGET_AVX ? \"vmovsldup\t{%1, %0|%0, %1}\"
                       : \"movsldup\t{%1, %0|%0, %1}\";"
  [(set_attr "type" "sse")
   (set_attr "prefix_rep" "1")
   (set_attr "prefix" "maybe_vex")
...
(define_insn "*sse4_1_extractps"
  ...
  "TARGET_SSE4_1"
  "* return TARGET_AVX ? \"vextractps\t{%2, %1, %0|%0, %1, %2}\"
  ...
  [(set (match_operand:V2DF 0 "nonimmediate_operand"     "=x,x,o")
	(vec_concat:V2DF
	  (vec_select:DF
	    (match_operand:V2DF 1 "nonimmediate_operand" " x,x,0")
	    (parallel [(const_int 0)]))
	  (match_operand:DF 2 "nonimmediate_operand"     " m,x,x*fr")))]
  "TARGET_AVX && !(MEM_P (operands[1]) && MEM_P (operands[2]))"
  "@
   vmovhpd\t{%2, %1, %0|%0, %1, %2}
   vunpcklpd\t{%2, %1, %0|%0, %1, %2}
   #"
  [(set_attr "type" "ssemov,sselog,other")
   (set_attr "prefix" "vex")
   (set_attr "mode" "V1DF,V2DF,DF")])
...
(define_insn "*avx_loadlpd"
  [(set (match_operand:V2DF 0 "nonimmediate_operand"    "=x,x,x,x,m")
	(vec_concat:V2DF
	  (match_operand:DF 2 "nonimmediate_operand"    " m,m,x,x,x*fr")
	  (vec_select:DF
	    (match_operand:V2DF 1 "vector_move_operand" " C,x,x,o,0")
	    (parallel [(const_int 1)]))))]
  "TARGET_AVX && !(MEM_P (operands[1]) && MEM_P (operands[2]))"
  "@
   vmovsd\t{%2, %0|%0, %2}
   ...
   #"
  [(set_attr "type" "ssemov,ssemov,ssemov,ssemov,other")
   (set_attr "prefix" "vex")
   (set_attr "mode" "DF,V1DF,V1DF,V1DF,DF")])
  ...
  "TARGET_SSE2"
{
  ...
  return TARGET_AVX ? "vpshufd\t{%2, %1, %0|%0, %1, %2}"
                    : "pshufd\t{%2, %1, %0|%0, %1, %2}";
}
  [(set_attr "type" "sselog1")
   (set_attr "prefix_data16" "1")
  ...
  "TARGET_SSE2"
{
  ...
  return TARGET_AVX ? "vpshuflw\t{%2, %1, %0|%0, %1, %2}"
                    : "pshuflw\t{%2, %1, %0|%0, %1, %2}";
}
  [(set_attr "type" "sselog")
   (set_attr "prefix_rep" "1")
  ...
  "TARGET_SSE2"
{
  ...
  return TARGET_AVX ? "vpshufhw\t{%2, %1, %0|%0, %1, %2}"
                    : "pshufhw\t{%2, %1, %0|%0, %1, %2}";
}
  [(set_attr "type" "sselog")
   (set_attr "prefix_rep" "1")
...
(define_insn "*sse2_storeq_rex64_avx"
...
(define_insn "*sse2_maskmovdqu"
  ...
  "* return TARGET_AVX ? \"vmaskmovdqu\t{%2, %1|%1, %2}\"
                       : \"maskmovdqu\t{%2, %1|%1, %2}\";"
  [(set_attr "type" "ssecvt")
   (set_attr "prefix_data16" "1")
   (set_attr "prefix" "maybe_vex")
...
(define_insn "sse4_1_movntdqa"
  [(set (match_operand:V2DI 0 "register_operand" "=x")
	(unspec:V2DI [(match_operand:V2DI 1 "memory_operand" "m")]
		     UNSPEC_MOVNTDQA))]
  "TARGET_SSE4_1"
  "* return TARGET_AVX ? \"vmovntdqa\t{%1, %0|%0, %1}\"
                       : \"movntdqa\t{%1, %0|%0, %1}\";"
  [(set_attr "type" "ssecvt")
   (set_attr "prefix_extra" "1")
   (set_attr "prefix" "maybe_vex")
...
(define_insn "sse4_1_phminposuw"
  [(set (match_operand:V8HI 0 "register_operand" "=x")
	(unspec:V8HI [(match_operand:V8HI 1 "nonimmediate_operand" "xm")]
		     UNSPEC_PHMINPOSUW))]
  "TARGET_SSE4_1"
  "* return TARGET_AVX ? \"vphminposuw\t{%1, %0|%0, %1}\"
                       : \"phminposuw\t{%1, %0|%0, %1}\";"
  [(set_attr "type" "sselog1")
   (set_attr "prefix_extra" "1")
   (set_attr "prefix" "maybe_vex")
  ...
  [(set (match_operand:SI 0 "register_operand" "=c,c")
   ...
   (set (reg:CC FLAGS_REG)
	(unspec:CC
	  ...
	  UNSPEC_PCMPISTR))]
  "TARGET_SSE4_2"
  "* return TARGET_AVX ? \"vpcmpistri\t{%3, %2, %1|%1, %2, %3}\"
  ...
  [(set (match_operand:V16QI 0 "register_operand" "=Yz,Yz")
   ...
   (set (reg:CC FLAGS_REG)
	(unspec:CC
	  ...
	  UNSPEC_PCMPISTR))]
  "TARGET_SSE4_2"
  "* return TARGET_AVX ? \"vpcmpistrm\t{%3, %2, %1|%1, %2, %3}\"
...
(define_insn "*avx_pcmpistr_cconly"
  [(set (reg:CC FLAGS_REG)
	(unspec:CC
	  [(match_operand:V16QI 2 "register_operand" "x,x,x,x")
