...
;; ISEL/ISEL_64/BCP8/BCP8_64 target selection
(define_mode_attr sel [(SI "") (DI "_64")])
...
;; XXX in the original code we prefered to use volatile CRs (0, 1, 6, 7) over
;; the saved CRs (2, 3, 4) to reduce the chance that we will need to save and
;; restore the CRs.  Check into this later
