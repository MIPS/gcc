...
*/
#ifdef CYGWIN32
# error "Use pthreads with cygwin"
#endif
...
/* threadAttach/threadDetach routines used by the DLL implementation,
 * since it receives explicit notification on thread * creation/destruction.
 */
