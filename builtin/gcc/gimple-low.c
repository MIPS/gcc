  ...
  if (data.calls_builtin_setjmp)
    {
	 ...
	 and insert.  */
      ...
      t = builtin_decl (BUILT_IN_SETJMP_DISPATCHER, BU_IMPLICIT);
...
lower_builtin_setjmp (gimple_stmt_iterator *gsi)
{
  ...
  t = builtin_decl (BUILT_IN_SETJMP_SETUP, BU_IMPLICIT);
  ...
  arg = build_addr (next_label, current_function_decl);
  t = builtin_decl (BUILT_IN_SETJMP_RECEIVER, BU_IMPLICIT);
