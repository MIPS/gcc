...
extern tree lhd_builtin_function_lazy_create (enum built_in_function, bool);
...
#define LANG_HOOKS_BUILTIN_FUNCTION_LAZY_CREATE	lhd_builtin_function_lazy_create
...
#define LANG_HOOKS_INITIALIZER { \
  ...
  LANG_HOOKS_BUILTIN_FUNCTION_LAZY_CREATE, \
  LANG_HOOKS_INIT_TS,          \
