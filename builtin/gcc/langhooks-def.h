...
extern void lhd_builtin_function_lazy (enum built_in_function);
...
#define LANG_HOOKS_BUILTIN_FUNCTION_LAZY lhd_builtin_function_lazy
...
#define LANG_HOOKS_INITIALIZER { \
  ...
  LANG_HOOKS_BUILTIN_FUNCTION_LAZY, \
  LANG_HOOKS_INIT_TS,          \
