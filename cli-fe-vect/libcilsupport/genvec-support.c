...
/*
v16qi
genvec_support_VQI_ALoad(u16qi* addr)
{
	int addr_val = (int)addr;
	int rounded_addr = addr_val & ~0xf;
	return *(u16qi*)rounded_addr;
}
*/
v16qi
...
/*
v16qi
genvec_support_VQI_VQI_mask_for_load_Mono_Simd_Vector16sb_Mono_Simd_Vector16sb_System_Int32_System_Int32(u16qi* v, int a, int b)
{
      // FIXME
...
/*
v16qi
genvec_support_VQI_RealignLoad(u16qi a, u16qi b, u16qi c, u16qi* d, int e, int f)
{
	return *d;
}
*/
...
/*
v8hi
genvec_support_VHI_VHI_mask_for_load(unsigned int a, u8hi* v)
{
      // FIXME
...
/*
v8hi
genvec_support_VHI_RealignLoad(u8hi a, u8hi b, u8hi c, u8hi* d, int e, int f)
{
	return *d;
}
*/
...
/*
v4si
genvec_support_VSI_ALoad(u4si* addr)
{
	int addr_val = (int)addr;
	int rounded_addr = addr_val & ~0xf;
	return *(u4si*)rounded_addr;
}
*/
...
/*
v4si
genvec_support_VSI_VSI_mask_for_load(unsigned int a, u4si* v)
{
      // FIXME
...
/*
v4si
genvec_support_VSI_RealignLoad(u4si a, u4si b, u4si c, u4si* d, int e, int f)
{
	return *d;
}
*/
...
/*
v2di
genvec_support_VDI_ALoad(u2di* addr)
{
	int addr_val = (int)addr;
	int rounded_addr = addr_val & ~0xf;
	return *(u2di*)rounded_addr;
}
*/
...
/*
v2di
genvec_support_VDI_VDI_mask_for_load(unsigned int a, u2di* v)
{
      // FIXME
...
/*
v2di
genvec_support_VDI_RealignLoad(u2di a, u2di b, u2di c, u2di* d, int e, int f)
{
	return *d;
}
*/
...
/*
v4sf
genvec_support_VSF_ALoad(u4sf* addr)
{
	int addr_val = (int)addr;
	int rounded_addr = addr_val & ~0xf;
	return *(u4sf*)rounded_addr;
}
*/
...
v4sf
genvec_support_VSF_VSF_reduc_min_epilogue(u4sf v)
{
...
v4sf
genvec_support_VSF_VSF_reduc_max_epilogue(u4sf v)
{
      float tmp0_0 = v.a[1] > v.a[2] ? v.a[1] : v.a[2];
      float tmp0_1 = v.a[3] > v.a[0] ? v.a[3] : v.a[0];
...
/*
v4sf
genvec_support_VSF_VSF_mask_for_load(unsigned int a, u4sf* v)
{
      // FIXME
...
/*
v4sf
genvec_support_VSF_RealignLoad(u4sf a, u4sf b, u4sf c, u4sf* d, int e, int f)
{
      return *d;
}
*/
...
unsigned int
genvec_support_VSF_VSF_realign_offset()
{
      return 0;
}
