...
(define_insn ""
  ...
  ""
{
  if (m68k_arch_68020 || TARGET_COLDFIRE || ! ADDRESS_REG_P (operands[0]))
    return "tst%.l %0";
...
(define_insn "*movsi_cf"
  ...
  "TARGET_COLDFIRE && !m68k_arch_isab"
  "* return output_move_simode (operands);")
  ...
  ""
{
  ...
  if (m68k_arch_68020 || TARGET_COLDFIRE)
    {
      if (ADDRESS_REG_P (operands[1]))
...
(define_insn "*68k_extendqisi2"
  ...
  "m68k_arch_68020 || (TARGET_COLDFIRE && !m68k_arch_isab)"
  "extb%.l %0")

    ...
    [(set (subreg:SI (match_operand:DI 0 "register_operand" "") 4)
     ...
     (set (subreg:SI (match_dup 0) 0)
	  (truncate:SI (lshiftrt:DI (mult:DI (zero_extend:DI (match_dup 1))
				    ...
				    (const_int 32))))])]
  "m68k_arch_68020 && !TUNE_68060 && !TARGET_COLDFIRE"
  "")
...
{
  operands[3] = GEN_INT(INTVAL(operands[0]) - 4);
  if (!TARGET_COLDFIRE && GET_CODE(operands[2]) == CONST_INT)
    {
...
(define_peephole2
  ...
  "!TARGET_COLDFIRE && !reg_mentioned_p (stack_pointer_rtx, operands[0])"
