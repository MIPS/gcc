...
; Types that can be stored from a GPR with a single instruction, which can
; be fused.
(define_mode_iterator GPR_STORE [QI
				 HI
				 SI
				 (DI	"TARGET_POWERPC64")
				 SF
...
;; Fusion insn, created by the define_peephole2 above (and eventually by
;; reload)
(define_insn "*fusion_extra_<P:mode>_<SFDF:mode>_load"
  [(set (match_operand:SFDF 0 "fpr_reg_operand" "=<SFDF:Ff>")
	(unspec:SFDF [(match_operand:SFDF 1 "fusion_gpr_mem_combo" "wF")]
		     UNSPEC_FUSION_EXTRA))
...
(define_insn "*fusion_extra_<P:mode>_<SFDF:mode>_fstore"
  [(set (match_operand:SFDF 0 "fusion_gpr_mem_combo2" "=wF")
	(unspec:SFDF [(match_operand:SFDF 1 "fpr_reg_operand" "<SFDF:Ff>")]
		     UNSPEC_FUSION_EXTRA))
   (clobber (match_operand:P 2 "base_reg_operand" "=&b"))]
  "TARGET_FUSION_EXTRA"
{
...
(define_insn "*fusion_extra_<P:mode>_<GPR_STORE:mode>_gstore"
  [(set (match_operand:GPR_STORE 0 "fusion_gpr_mem_combo2" "=wF")
	(unspec:GPR_STORE [(match_operand:GPR_STORE 1 "int_reg_operand" "r")]
		     UNSPEC_FUSION_EXTRA))
   (clobber (match_operand:P 2 "base_reg_operand" "=&b"))]
  "TARGET_FUSION_EXTRA"
{
