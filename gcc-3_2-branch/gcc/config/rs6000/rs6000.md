...
(define_constants
  [(UNSPEC_FRSP			0)	; frsp for POWER machines
   ...
   (UNSPEC_TLSGD		600)
   (UNSPEC_TLSLD		601)
   (UNSPEC_TLSDTPREL		602)
   (UNSPEC_TLSDTPRELHA		603)
   (UNSPEC_TLSDTPRELLO		604)
   (UNSPEC_TLSGOTDTPREL		605)
   (UNSPEC_TLSTPREL		606)
   (UNSPEC_TLSTPRELHA		607)
   (UNSPEC_TLSTPRELLO		608)
   (UNSPEC_TLSGOTTPREL		609)
   (UNSPEC_TLSTLS		610)
  ])
...
(define_insn "elf_high"
  ...
  "TARGET_ELF && (TARGET_32BIT || TARGET_ADDR32)"
  "{liu|lis} %0,%1@ha")
...
(define_insn "elf_high64"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=b*r")
	(high:DI (match_operand 1 "" "")))]
  "TARGET_ELF && TARGET_ADDR32"
  "lis %0,%1@ha")

(define_insn "elf_low64"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=r,r")
...
(define_insn "load_toc_v4_PIC_1b"
  [(set (match_operand:SI 0 "register_operand" "=l")
	(match_operand:SI 1 "immediate_operand" "s"))
   (use (unspec [(match_dup 1) (match_operand 2 "immediate_operand" "s")] 6))]
  "TARGET_ELF && DEFAULT_ABI != ABI_AIX && flag_pic == 2"
  "bcl 20,31,%1+4\\n%1:\\n\\t.long %2-%1"
  [(set_attr "type" "branch")
   (set_attr "length" "8")])
