...
/* { dg-final { scan-tree-dump "f1: va_list escapes 1, needs to save all GPR units" "stdarg" { target xxia64-*-* xxi?86-*-* } } } */
...
/* { dg-final { scan-tree-dump "f2: va_list escapes 1, needs to save all GPR units" "stdarg" { target xxia64-*-* xxi?86-*-* } } } */
...
/* { dg-final { scan-tree-dump "f3: va_list escapes 1, needs to save all GPR units" "stdarg" { target xxia64-*-* xxi?86-*-* } } } */
...
/* { dg-final { scan-tree-dump "f6: va_list escapes 1, needs to save all GPR units" "stdarg" { target xxia64-*-* xxi?86-*-* } } } */
...
/* { dg-final { scan-tree-dump "f11: va_list escapes 1, needs to save all GPR units" "stdarg" { target xxia64-*-* xxi?86-*-* } } } */
...
/* { dg-final { scan-tree-dump "f12: va_list escapes 1, needs to save all GPR units" "stdarg" { target xxia64-*-* xxi?86-*-* } } } */
