...
(define_insn "movdd"
  [(set (match_operand:DD 0 "nonimmediate_operand" "=f,f,m,r,r,m")
        (match_operand:DD 1 "input_operand" "f,m,f,r,m,r"))]
  "ENABLE_DECIMAL_FLOAT && TARGET_HARD_FLOAT && TARGET_FPRS"
  "*
{
  switch (which_alternative)
  {
  ...
  [(set_attr "type" "fp,fpload,fpstore,*,load,store")
   (set_attr "length" "4,4,4,8,16,16")])

(define_insn_and_split "movtd"
   [(set (match_operand:TD 0 "nonimmediate_operand" "=m,f,f,m,r,r")
 	(match_operand:TD 1 "input_operand"         "f,m,f,r,m,r"))]
   "ENABLE_DECIMAL_FLOAT && TARGET_HARD_FLOAT && TARGET_FPRS"
   "#"
   "&& reload_completed"
   [(pc)]
   { rs6000_split_multireg_move (operands[0], operands[1]); DONE; }
   [(set_attr "length" "8,8,8,16,16,16")])

