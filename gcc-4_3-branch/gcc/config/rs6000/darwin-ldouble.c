...
/* Avoid the horrible code gcc generates when using a union to turn
   a pair of doubles into a long double.  All PowerPC ABIs using this
   file return a long double in fr1/fr2, except of course when using
   soft-float.  */
