...
static tree GTY(()) __pixel_keyword;
static tree GTY(()) pixel_keyword;
static tree GTY(()) __bool_keyword;
static tree GTY(()) bool_keyword;
static tree GTY(()) _Bool_keyword;
...
{
  unsigned int nargs = list_length (arglist);
