...
extern bool (*rs6000_cannot_change_mode_class_ptr) (enum machine_mode,
						    enum machine_mode,
						    enum reg_class);
extern bool (*rs6000_legitimate_address_ptr) (enum machine_mode, rtx, bool);
extern rtx (*rs6000_legitimize_address_ptr) (rtx, rtx, enum machine_mode);
...
extern void rs6000_emit_add (rtx, rtx, rtx);
