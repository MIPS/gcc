...
(define_expand "mov<mode>cc"
  ...
  "TARGET_ISEL_OR_SMALL_CBRANCH<sel>"
  "
{
...
;; Like isel, but targeting conditional branch + 8 optimization Note we don't
;; expose the jump to the rest of the compiler to make sure that the
;; conditional branch is 8 bytes away and the instruction being jumped over is
;; one of the limited insns supported by the optimizaiton.

(define_insn "bcp8_signed_<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(if_then_else:GPR
	 (match_operator 1 "branch_comparison_operator"
			 [(match_operand:CC 4 "cc_reg_operand" "y")
			  (const_int 0)])
	 (match_operand:GPR 2 "gpc_reg_operand" "0")
	 (match_operand:GPR 3 "reg_or_cint_operand" "rIL")))]
  "TARGET_SMALL_CBRANCH<sel>"
  "* return output_bcp8 (operands);"
  [(set_attr "type" "two")
   (set_attr "length" "8")])

(define_insn "bcp8_unsigned_<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(if_then_else:GPR
	 (match_operator 1 "branch_comparison_operator"
			 [(match_operand:CCUNS 4 "cc_reg_operand" "y")
			  (const_int 0)])
	 (match_operand:GPR 2 "reg_or_cint_operand" "0")
	 (match_operand:GPR 3 "gpc_reg_operand" "rIL")))]
  "TARGET_SMALL_CBRANCH<sel>"
  "* return output_bcp8 (operands);"
  [(set_attr "type" "two")
   (set_attr "length" "8")])
...
(define_expand "smindi3"
  [(match_operand:DI 0 "gpc_reg_operand" "")
   (match_operand:DI 1 "gpc_reg_operand" "")
   (match_operand:DI 2 "gpc_reg_operand" "")]
  "TARGET_ISEL_OR_SMALL_CBRANCH64"
  "
{
  rs6000_emit_minmax (operands[0], SMIN, operands[1], operands[2]);
  DONE;
...
(define_insn "*movdf_hardfloat64_mfpgpr"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=Y,r,!r,d,ws,?wa,d,ws,?wa,m,Z,?Z,wa,*c*l,!r,*h,!r,!r,!r,r,d")
	(match_operand:DF 1 "input_operand" "r,Y,r,d,ws,?wa,m,Z,Z,d,ws,wa,j,r,h,0,G,H,F,d,r"))]
  ...
  "@
   ...
   mftgpr %0,%1
   mffgpr %0,%1"
  [(set_attr "type" "store,load,*,fp,vecsimple,vecsimple,fpload,fpload,fpload,fpstore,fpstore,fpstore,vecsimple,mtjmpr,mfjmpr,*,*,*,*,mftgpr,mffgpr")
   (set_attr "length" "4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,8,12,16,4,4")])

; ld/std require word-aligned displacements -> 'Y' constraint.
; List Y->r and r->Y before r->r for reload.
(define_insn "*movdf_hardfloat64"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=Y,r,!r,d,ws,?wa,d,ws,?wa,m, Z,?Z,wa,*c*l,!r,*h,!r,!r,!r")
	(match_operand:DF 1 "input_operand" "        r,Y, r,d,ws, wa,m, Z,  Z,d,ws,wa, j,   r, h, 0, G, H, F"))]
  "TARGET_POWERPC64 && !TARGET_MFPGPR && TARGET_HARD_FLOAT && TARGET_FPRS 
   && TARGET_DOUBLE_FLOAT
   && (gpc_reg_operand (operands[0], DFmode)
       || gpc_reg_operand (operands[1], DFmode))"
  "@
   ...
   #
   #"
  [(set_attr "type" "store,load,*,fp,vecsimple,vecsimple,fpload,fpload,fpload,fpstore,fpstore,fpstore,vecsimple,mtjmpr,mfjmpr,*,*,*,*")
...
(define_insn "*ne0si"
  ...
  "! TARGET_POWER && TARGET_32BIT && ! TARGET_ISEL_OR_SMALL_CBRANCH"
...
(define_insn "*ne0di"
  ...
  "TARGET_64BIT && !TARGET_SMALL_CBRANCH"
