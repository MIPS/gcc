...
extern void lhd_builtin_function_init (enum built_in_function);
...
#define LANG_HOOKS_BUILTIN_FUNCTION_INIT lhd_builtin_function_init
...
#define LANG_HOOKS_INITIALIZER { \
  ...
  LANG_HOOKS_BUILTIN_FUNCTION_INIT, \
  LANG_HOOKS_INIT_TS,          \
