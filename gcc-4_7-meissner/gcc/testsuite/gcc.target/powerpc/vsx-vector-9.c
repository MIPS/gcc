...
/* { dg-options "-mvsx -Ofast -ftree-vectorize -mno-unaligned-vector -std=gnu99" } */

/* Check whether the compiler does not do unaligned vector loads if desired.  */
...
/* { dg-final { scan-assembler-not "lvsr" } } */
