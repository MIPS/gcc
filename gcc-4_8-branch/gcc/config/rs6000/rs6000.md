...
(define_c_enum "unspec"
  [UNSPEC_FRSP			; frsp for POWER machines
   ...
   UNSPEC_LONGDOUBLE_DW0
   UNSPEC_LONGDOUBLE_DW1
   UNSPEC_PACK_LONGDOUBLE
  ])
...
(define_insn_and_split "longdouble_dw0"
  [(set (match_operand:DF 0 "register_operand" "=d,d")
	(unspec:DF [(match_operand:TF 1 "register_operand" "0,d")]
		   UNSPEC_LONGDOUBLE_DW0))]
  "!TARGET_IEEEQUAD && !TARGET_XL_COMPAT
   && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_LONG_DOUBLE_128"
  "@
...
(define_insn "longdouble_dw1"
  [(set (match_operand:DF 0 "register_operand" "=d")
	(unspec:DF [(match_operand:TF 1 "register_operand" "d")]
		   UNSPEC_LONGDOUBLE_DW1))]
  "!TARGET_IEEEQUAD && !TARGET_XL_COMPAT
   && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_LONG_DOUBLE_128"
  "fmr %0,%L1"
...
(define_insn "pack_longdouble"
  [(set (match_operand:TF 0 "gpc_reg_operand" "=d,&d")
        (unspec:TF [(match_operand:DF 1 "gpc_reg_operand" "0,d")
		    (match_operand:DF 2 "gpc_reg_operand" "d,d")]
		    UNSPEC_PACK_LONGDOUBLE))]
  "!TARGET_IEEEQUAD && !TARGET_XL_COMPAT
   && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_LONG_DOUBLE_128"
  "@
