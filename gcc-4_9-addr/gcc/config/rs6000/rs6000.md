...
;; Types that have secondary reload helper functions to allow allocation of a
;; secondary base register.
(define_mode_iterator RELOAD	[QI HI SI DI TI PTI SF DF TF SD DD TD
;				 V1DI V4HI V2SI V2SF
...

;; Generalized address reload support.  Before reload, we support 'generalized'
;; addresses of the form:
;;	*reg
;;	*(reg + reg)
;;	*(reg + offset)
;;	*(pre-modify (reg + reg))
;;	*(pre-modify (reg + offset))
;;	*((reg + reg) & -16)
;;
;; During secondary reload these insns are used to create the temporary
;; registers necessary to create the addresses.

(define_expand "reload_<RELOAD:mode>_<P:mptrsize>_store"
  [(parallel [(match_operand:RELOAD 0 "memory_operand" "m")
              (match_operand:RELOAD 1 "gpc_reg_operand" "r")
...
(define_expand "reload_<RELOAD:mode>_<P:mptrsize>_load"
  [(parallel [(match_operand:RELOAD 0 "gpc_reg_operand" "=&r")
