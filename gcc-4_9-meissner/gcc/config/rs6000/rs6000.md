...
;; Use the standard reload support for normal sized integers.
(define_mode_iterator RELOAD	[
;;				 QI HI SI DI
				 TI PTI
				 SF DF TF
				 SD DD TD
				 V16QI V8HI V4SI V4SF V2DI V2DF
;;				 V1DI V8QI V4HI V2SI V2SF
				 ])

...
(define_insn "*negsf2"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy")
	(neg:SF (match_operand:SF 1 "gpc_reg_operand" "f,wy")))]
...
(define_insn "*abssf2"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy")
	(abs:SF (match_operand:SF 1 "gpc_reg_operand" "f,wy")))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_SINGLE_FLOAT"
  "@
   fabs %0,%1
   xsabsdp %x0,%x1"
...
(define_insn "*nabssf2"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy")
	(neg:SF (abs:SF (match_operand:SF 1 "gpc_reg_operand" "f,wy"))))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_SINGLE_FLOAT"
  "@
   fnabs %0,%1
   xsnabsdp %x0,%x1"
...
(define_insn "*addsf3"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy")
	(plus:SF (match_operand:SF 1 "gpc_reg_operand" "%f,wy")
		 (match_operand:SF 2 "gpc_reg_operand" "f,wy")))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_SINGLE_FLOAT"
  "@
   fadds %0,%1,%2
   xsaddsp %x0,%x1,%x2"
...
(define_insn "*subsf3"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy")
	(minus:SF (match_operand:SF 1 "gpc_reg_operand" "f,wy")
		  (match_operand:SF 2 "gpc_reg_operand" "f,wy")))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_SINGLE_FLOAT"
  "@
   fsubs %0,%1,%2
...
(define_insn "*mulsf3"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy")
	(mult:SF (match_operand:SF 1 "gpc_reg_operand" "%f,wy")
		 (match_operand:SF 2 "gpc_reg_operand" "f,wy")))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_SINGLE_FLOAT"
  "@
   fmuls %0,%1,%2
...
(define_insn "*divsf3"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy")
	(div:SF (match_operand:SF 1 "gpc_reg_operand" "f,wy")
		(match_operand:SF 2 "gpc_reg_operand" "f,wy")))]
...
(define_insn "fres"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy")
	(unspec:SF [(match_operand:SF 1 "gpc_reg_operand" "f,wy")]
		   UNSPEC_FRES))]
  "TARGET_FRES"
  "@
   fres %0,%1
...
(define_insn "*fmasf4_fpr"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=d,wy,wy")
	(fma:SF
	  (match_operand:SF 1 "gpc_reg_operand" "%d,wy,wy")
	  (match_operand:SF 2 "gpc_reg_operand" "d,wy,0")
	  (match_operand:SF 3 "gpc_reg_operand" "d,0,wy")))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_SINGLE_FLOAT"
  "@
   fmadds %0,%1,%2,%3
   xsmaddasp %x0,%x1,%x2
...
(define_insn "*fmssf4_fpr"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy,wy")
	(fma:SF (match_operand:SF 1 "gpc_reg_operand" "f,wy,wy")
		(match_operand:SF 2 "gpc_reg_operand" "f,wy,0")
		(neg:SF (match_operand:SF 3 "gpc_reg_operand" "f,0,wy"))))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_SINGLE_FLOAT"
  "fmsubs %0,%1,%2,%3
   xsmsubasp %x0,%x1,%x2
   xsmsubmsp %x0,%x1,%x3"
...
(define_insn "*nfmasf4_fpr"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy,wy")
	(neg:SF (fma:SF (match_operand:SF 1 "gpc_reg_operand" "f,wy,wy")
			(match_operand:SF 2 "gpc_reg_operand" "f,wy,0")
			(match_operand:SF 3 "gpc_reg_operand" "f,0,wy"))))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_SINGLE_FLOAT"
  "@
   fnmadds %0,%1,%2,%3
   xsnmaddasp %x0,%x1,%x2
...
(define_insn "*sqrtsf2"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy")
	(sqrt:SF (match_operand:SF 1 "gpc_reg_operand" "f,wy")))]
...
(define_insn "*copysignsf3_vsx"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f,wy")
	(unspec:SF [(match_operand:SF 1 "gpc_reg_operand" "f,wy")
		    (match_operand:SF 2 "gpc_reg_operand" "f,wy")]
		   UNSPEC_COPYSIGN))]
  "TARGET_CMPB && VECTOR_UNIT_VSX_P (SFmode)"
  "@
   fcpsgn %0,%2,%1
   xscpsgnsp %x0,%x2,%x1"
  [(set_attr "type" "fp")])
...
(define_insn "mov<mode>_hardfloat"
  [(set (match_operand:FMOVE32 0 "nonimmediate_operand" "=!r,!r,m,f,wa,wa,<f32_lr>,<f32_sm>,wy, Z,?<f32_dm>,      ?r,*c*l,!r,*h,!r,!r")
	(match_operand:FMOVE32 1 "input_operand"         " r, m,r,f,wa, j,<f32_lm>,<f32_sr>, Z,wy,        r,<f32_dm>,   r, h, 0, G,Fn"))]
...
(define_insn "*cmpsf_internal1"
  [(set (match_operand:CCFP 0 "cc_reg_operand" "=y,y")
	(compare:CCFP (match_operand:SF 1 "gpc_reg_operand" "f,wy")
		      (match_operand:SF 2 "gpc_reg_operand" "f,wy")))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_SINGLE_FLOAT"
  "@
   fcmpu %0,%1,%2
