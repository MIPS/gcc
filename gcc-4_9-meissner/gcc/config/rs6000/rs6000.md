...
(define_insn "*fmasf4_fpr"
  [(set (match_operand:DF 0 "gpc_reg_operand" "=d,wy,wy")
	(fma:DF
	  (match_operand:DF 1 "gpc_reg_operand" "%d,wy,wy")
	  (match_operand:DF 2 "gpc_reg_operand" "d,wy,0")
	  (match_operand:DF 3 "gpc_reg_operand" "d,0,wy")))]
  "VECTOR_UNIT_VSX_P (DFmode)"
  "@
   fmadds %0,%1,%2,%3
   xsmaddasp %x0,%x1,%x2
