...
(define_insn "*movdi_internal64"
  [(set (match_operand:DI 0 "nonimmediate_operand" "=Y,r,r,r,r, r,?m,?*d,?*d,?Z,?wv,?ws, r,*h,*h,?wa,  r,?*wg,  r,?*wm")
	(match_operand:DI 1 "input_operand"         "r,Y,r,I,L,nF, d,  m,  d,wv,  Z, ws,*h, r, 0,  O,*wg,   r,*wm,   r"))]
  "TARGET_POWERPC64
   && (gpc_reg_operand (operands[0], DImode)
       || gpc_reg_operand (operands[1], DImode))"
  "@
