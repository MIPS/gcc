...
(define_insn "*movdi_internal64"
  [(set (match_operand:DI 0 "nonimmediate_operand" "=Y,r,r,r,r, r,?m,?*d,?*d, r,*h,*h,?wa,  r,?*wg,  r,?*wm")
	(match_operand:DI 1 "input_operand"         "r,Y,r,I,L,nF, d,  m,  d,*h, r, 0,  O,*wg,   r,*wm,   r"))]
  "TARGET_POWERPC64
   && (gpc_reg_operand (operands[0], DImode)
       || gpc_reg_operand (operands[1], DImode))"
  "@
...
(define_expand "reload_<SFDF:mode>_<P:mptrsize>_const"
  [(parallel [(match_operand:SFDF 0 "register_operand" "=&f")
              (match_operand:SFDF 1 "input_operand" "F")
              (match_operand:P 2 "register_operand" "=&b")])]
  "<P:tptrsize>"
{
  rs6000_secondary_reload_inner (operands[0], operands[1], operands[2], false);
