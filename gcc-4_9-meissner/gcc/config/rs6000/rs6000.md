  ...
  ""
{
  if (<MODE>mode == DImode && !TARGET_POWERPC64)
    {
      rtx hi_op0 = gen_highpart (SImode, operands[0]);
      rtx hi_op1 = gen_highpart (SImode, operands[1]);
      rtx lo_op0 = gen_lowpart (SImode, operands[0]);
      rtx lo_op1 = gen_lowpart (SImode, operands[1]);
      emit_insn (gen_one_cmplsi2 (hi_op0, hi_op1));
      emit_insn (gen_one_cmplsi2 (lo_op0, lo_op1));
      DONE;
    }
})
  ...
  ""
{
  if (!TARGET_POWERPC64)
    {
      rs6000_split_logical_di (operands, AND);
      DONE;
    }
  ...
  "
{
  if (!TARGET_POWERPC64)
    {
      rs6000_split_logical_di (operands, IOR);
      DONE;
    }
  ...
  "
{
  if (!TARGET_POWERPC64)
    {
      rs6000_split_logical_di (operands, XOR);
      DONE;
    }
  else if (!reg_or_logical_cint_operand (operands[2], DImode))
    operands[2] = force_reg (DImode, operands[2]);
