...
(define_insn "mov<mode>_hardfloat"
  [(set (match_operand:FMOVE32 0 "nonimmediate_operand" "=!r,!r,m,f,ww,ww,<f32_lr>,<f32_sm>,wu, Z,?<f32_dm>,      ?r,*c*l,!r,*h,!r,!r")
	(match_operand:FMOVE32 1 "input_operand"          "r, m,r,f,ww, j,<f32_lm>,<f32_sr>, Z,wu,        r,<f32_dm>,   r, h, 0, G,Fn"))]
...
(define_insn "*mov<mode>_hardfloat32"
  [(set (match_operand:FMOVE64 0 "nonimmediate_operand" "=m,d,d,wv, Z,ws,ws,Y,r,!r,!r,!r,!r")
	(match_operand:FMOVE64 1 "input_operand"         "d,m,d, Z,wv,ws, j,r,Y, r, G,H,F"))]
...
(define_insn "*mov<mode>_hardfloat64"
  [(set (match_operand:FMOVE64 0 "nonimmediate_operand" "=m,d,d,wv, Z,ws,ws,Y,r,!r,*c*l,!r,*h,!wn,!wn,!wn, r,wg, r,wm")
	(match_operand:FMOVE64 1 "input_operand"         "d,m,d, Z,wv,ws, j,r,Y, r,   r, h, 0,  G,  H,  F,wg, r,wm, r"))]
  "TARGET_POWERPC64 && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT
   && (gpc_reg_operand (operands[0], <MODE>mode)
       || gpc_reg_operand (operands[1], <MODE>mode))"
  "@
...
(define_insn_and_split "reload_vsx_from_gprsf"
  [(set (match_operand:SF 0 "register_operand" "=wy")
...
(define_insn_and_split "reload_gpr_from_vsxsf"
  [(set (match_operand:SF 0 "register_operand" "=r")
	(unspec:SF [(match_operand:SF 1 "register_operand" "wy")]
		   UNSPEC_P8V_RELOAD_FROM_VSX))
...
;; There seems to be an interaction between the loop unroller and using DFmode
;; in VMX registers that shows up in the spec 2006 456.hmmer benchmark.  It
;; shows up when the VSX versions of the instructions are enabled
;; (i.e. xsmaddadp and xsmaddmdp for example).  For now, just use the
;; traditional 4 operand instruction.

(define_insn "*fma<mode>4_fpr"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<Ff>")
	(fma:SFDF
	  (match_operand:SFDF 1 "gpc_reg_operand" "<Ff>")
...
(define_insn "*fms<mode>4_fpr"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<Ff>")
	(fma:SFDF
	 (match_operand:SFDF 1 "gpc_reg_operand" "<Ff>")
	 (match_operand:SFDF 2 "gpc_reg_operand" "<Ff>")
	 (neg:SFDF (match_operand:SFDF 3 "gpc_reg_operand" "<Ff>"))))]
  "TARGET_<MODE>_FPR"
  "fmsub<Ftrad> %0,%1,%2,%3"
  [(set_attr "type" "fp")
   (set_attr "fp_type" "fp_maddsub_<Fs>")])
