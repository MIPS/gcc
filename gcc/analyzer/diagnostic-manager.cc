				...
				state_machine::state_t state) const
{
  ...
  /* First pass: apply verbosity level, pruning unrelated state
     change events.
  ...
  /* Second pass: remove redundant interprocedural information.  For
     example, given:
  ...
  /* Third pass.  If all we're left with is in one function, then
     filter function entry events.  */
