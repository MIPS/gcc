...
static inline void maybe_init_pretty_print (void);
static void print_declaration (output_buffer *, tree, int, int);
static void print_struct_decl (output_buffer *, tree, int);
static void dump_c_tree (output_buffer *, tree, int);
static int dump_c_node (output_buffer *, tree, int, int);
...
void
print_c_node_brief (FILE *file, tree t)
{
  maybe_init_pretty_print ();
...
static void
dump_c_tree (output_buffer *buffer, tree t, int spc)
{
  tree node = t;
  htab_t htab;
  int circularity_p = 0;
...
static int
dump_c_node (output_buffer *buffer, tree node, int spc, int brief_dump)
{
  tree type;
  tree op0, op1;
  const char* str;
...
static void
print_declaration (output_buffer *buffer, tree t, int spc, int brief_dump)
{
