...
extern int    arm_process_pragma	PROTO ((int (*)(void), void (*) (int),
						char *));
...
extern int    arm_split_constant	PROTO ((RTX_CODE, enum machine_mode,
...
extern int    arm_rtx_costs		PROTO ((rtx, RTX_CODE, RTX_CODE));
...
extern int    load_multiple_sequence	PROTO ((rtx *, int, int *, int *,
						HOST_WIDE_INT *));
extern char * emit_ldm_seq		PROTO ((rtx *, int));
extern int    store_multiple_sequence	PROTO ((rtx *, int, int *, int *,
						HOST_WIDE_INT *));
extern char * emit_stm_seq		PROTO ((rtx *, int));
extern rtx    arm_gen_load_multiple	PROTO ((int, int, rtx, int, int, int,
						int, int));
extern rtx    arm_gen_store_multiple	PROTO ((int, int, rtx, int, int, int,
						int, int));
extern int    arm_gen_movstrqi		PROTO ((rtx *));
extern rtx    gen_rotated_half_load	PROTO ((rtx));
extern enum machine_mode arm_select_cc_mode PROTO ((RTX_CODE, rtx, rtx));
...
extern rtx    arm_function_arg		PROTO ((CUMULATIVE_ARGS *,
						enum machine_mode, tree, int));
extern void   arm_init_cumulative_args	PROTO ((CUMULATIVE_ARGS *, tree, rtx,
						int));
#endif
...
extern rtx *  thumb_legitimize_pic_address
					PROTO ((rtx, enum machine_mode, rtx));
