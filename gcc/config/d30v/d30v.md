...
;; The same, only let flow know we're exiting the function.
(define_insn "return_internal"
  [(use (match_operand:SI 0 "gpr_operand" "d"))
   (return)]
  ""
  "jmp %0"
  [(set_attr "length" "4")
...
;; XXX figure out how to represent cond_exec_call/cond_exec_call_value
