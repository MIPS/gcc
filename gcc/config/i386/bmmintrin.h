...
static __inline __m128 __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE5))
_mm_macc_ps(__m128 __A, __m128 __B, __m128 __C)
{
  return (__m128) __builtin_ia32_fmaddps ((__v4sf)__A, (__v4sf)__B, (__v4sf)__C);
}

static __inline __m128d __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE5))
...
static __inline __m128i __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE5))
