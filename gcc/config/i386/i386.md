...
(define_insn_and_split "*and<mode>3_doubleword"
  ...
  [(const_int 0)]
{
  machine_mode hmode = <MODE>mode == TImode ? DImode : SImode;
  split_double_mode (<MODE>mode, &operands[0], 3, &operands[0],
		     &operands[3]);
  if (operands[2] == const0_rtx)
    {
      operands[1] = const0_rtx;
      ix86_expand_move (hmode, &operands[0]);
    }
  else if (operands[2] != constm1_rtx)
    ix86_expand_binary_operator (AND, hmode, &operands[0]);
  else if (operands[5] == constm1_rtx)
    emit_note (NOTE_INSN_DELETED);
  if (operands[5] == const0_rtx)
    {
      operands[4] = const0_rtx;
      ix86_expand_move (hmode, &operands[3]);
    }
  else if (operands[5] != constm1_rtx)
    ix86_expand_binary_operator (AND, hmode, &operands[3]);
  DONE;
})
  ...
  [(const_int 0)]
{
  ...
  if (operands[2] == constm1_rtx)
	...
	ix86_expand_unary_operator (NOT, hmode, &operands[0]);
    }
  else if (operands[2] != const0_rtx)
    ix86_expand_binary_operator (<CODE>, hmode, &operands[0]);
  ...
  if (operands[5] == constm1_rtx)
	...
	ix86_expand_unary_operator (NOT, hmode, &operands[3]);
    }
  else if (operands[5] != const0_rtx)
    ix86_expand_binary_operator (<CODE>, hmode, &operands[3]);
  DONE;
})
