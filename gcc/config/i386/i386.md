...
(define_insn "<mode>_mk"
  [(set (match_operand:BND 0 "register_operand" "=v")
    (unspec:BND [(match_operand:<bnd_ptr> 1 "register_operand" "r")
		 (match_operand:<bnd_ptr> 2 "address_no_base_operand" "p")] UNSPEC_BNDMK))]
  "TARGET_PL"
{
...
(define_insn "<mode>_ldx"
  [(set (match_operand:BND 0 "register_operand" "=v") 
    (unspec [(match_operand:<bnd_ptr> 1 "address_no_index_operand" "p")
...
(define_insn "<mode>_stx"
 [(unspec [(match_operand:<bnd_ptr> 0 "address_no_index_operand" "p")
