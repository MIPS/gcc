...
;; Bound modes.
(define_mode_iterator BND [(CSI "!TARGET_64BIT") (CDI "TARGET_64BIT")])
...
(define_insn "bnd_mk<MODE>"
  ...
  "TARGET_PL"
{
  return "bndmk\t{%1, %0|%0, %1}";
})

(define_insn "bnd_mov<MODE>"
...
(define_insn "bnd_ldx<MODE>"
  ...
  "TARGET_PL"
{
  return "bnd_ldx\t{%1, %0|%0, %1}";
})

(define_insn "bnd_stx<MODE>"
  [(set (match_operand 0 "memory_operand") 
        (unspec_volatile[(match_operand 1 "memory_operand" "m")
             (match_operand:BND 2 "register_operand" "v")] UNSPECV_BNDSTX))]
;;    (clobber (match_dup 0))(clobber (match_dup 1))(clobber (match_dup 2))])]
  "TARGET_PL"
{
  return "bnd_stx\t{%1, %0|%0, %1}";
})
