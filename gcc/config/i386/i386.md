...
(define_insn "<mode>_mk"
  ...
  "TARGET_PL && ix86_decomposed_address_p (operands[2], operands[1])"
{
...
(define_insn "<mode>_ldx"
  ...
  "TARGET_PL && ix86_decomposed_address_p (operands[1], operands[2])"
{
...
(define_insn "<mode>_stx"
 [(unspec [(match_operand:<bnd_ptr> 0 "address_operand" "p")
  ...
  "TARGET_PL && ix86_decomposed_address_p (operands[0], operands[1])"
{
