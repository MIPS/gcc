...
(define_attr "mode"
  "unknown,none,QI,HI,SI,DI,SF,DF,SD,DD,TD,XF,TI,V4SF,V2DF,V2SF,V1DF"
...
;; Use GPRs on 64-bit systems.
;;
(define_insn "*movdd_gprs"
  [(set (match_operand:DD 0 "nonimmediate_operand" "=r,m,r")
   (match_operand:DD 1 "general_operand" "r,r,m"))]
  "TARGET_64BIT"
{
   /* Same output for every alternative.  */
   return "mov\t{%1, %0|%0, %1}";
...
;; For non-64-bit systems use SSE registers, which I assume are slower.
;;
