...
(define_split
  ...
  "!TARGET_64BIT && reload_completed && FP_REGNO_P (REGNO (operands[1]))"
  [(set (reg:SI 7) (plus:SI (reg:SI 7) (const_int -8)))
...
(define_insn "*extendsfdf2_1"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=Y#f,f#Y,mf#Y")
        (float_extend:DF (match_operand:SF 1 "nonimmediate_operand" "mY#f,fm#Y,f#Y")))]
  "(TARGET_80387 || TARGET_SSE2)
   && (GET_CODE (operands[0]) != MEM || GET_CODE (operands[1]) != MEM)"
{
  switch (which_alternative)
  ...
  [(set_attr "type" "sse,fmov,fmov")
   (set_attr "mode" "DF,SF,XF")])
