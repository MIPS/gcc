...
(define_insn "*cmpqi_ext_1"
  [(set (reg:CC 17)
	(compare:CC
	  ...
	  (subreg:QI
	    (match_operator:SI 2 "extract_operator"
	  ...
	  (subreg:QI
	    (match_operator:SI 2 "extract_operator"
	      [(match_operand:SI 0 "register_operand" "q")
	       ...
	       (const_int 8)]) 0)
	  (subreg:QI
	    (match_operator:SI 3 "extract_operator"
	      [(match_operand:SI 1 "register_operand" "q")
	       (const_int 8)
	       (const_int 8)]) 0)))]
  ""
...
(define_insn "*movsi_extzv_1"
  [(set (match_operand:SI 0 "register_operand" "r")
	(zero_extract:SI (match_operand:SI 1 "register_operand" "q")
			 (const_int 8)
			 (const_int 8)))]
  ""
  "movz{bl|x}\\t{%h1, %0|%0, %h1}"
...
(define_insn "*movqi_extzv_1"
  [(set (match_operand:QI 0 "nonimmediate_operand" "qm*r")
        (subreg:QI (zero_extract:SI (match_operand:SI 1 "register_operand" "q")
				    (const_int 8)
				    (const_int 8)) 0))]
  ""
  "*
...
(define_insn "*movsi_insv_1"
  [(set (zero_extract:SI (match_operand:SI 0 "register_operand" "q")
			 (const_int 8)
			 (const_int 8))
...
(define_insn "*addqi_ext_1"
  [(set (zero_extract:SI (match_operand:SI 0 "register_operand" "q")
			 (const_int 8)
			 (const_int 8))
	(and:SI (subreg:SI (plus:QI
			     (subreg:QI
			       (match_operator:SI 3 "extract_operator"
				 [(match_operand:SI 1 "register_operand" "0")
				  (const_int 8)
				  (const_int 8)]) 0)
			     (match_operand:QI 2 "general_operand" "qmn")) 0)
		(const_int 255)))
   (clobber (reg:CC 17))]
  ""
  "*
...
(define_insn "*addqi_ext_2"
  [(set (zero_extract:SI (match_operand:SI 0 "register_operand" "q")
			 (const_int 8)
			 (const_int 8))
	(and:SI (plus:SI (match_operator:SI 3 "extract_operator"
			   [(match_operand:SI 1 "register_operand" "%0")
			    (const_int 8)
			    (const_int 8)])
			 (match_operator:SI 4 "extract_operator"
  ...
  "*
{
  switch (get_attr_type (insn))
	...
	abort ();
      ...
      /* If operand[2] is an immediate, we may be able to use xor.
