...
(define_insn "bnd_mk<mode>"
  [(set (match_operand:BND 0 "register_operand" "=v")
        ...
        (match_operand 2 "address_no_base_operand" "p")] UNSPEC_BNDMK))]
  "TARGET_PL"
{
...
(define_insn "bnd_cl<mode>"
  [(unspec [(match_operand:BND 0 "register_operand" "v,v")
        (match_operand 1 "general_operand" "r,p")] UNSPEC_BNDCL)]
  "TARGET_PL"
{
...
(define_insn "bnd_cu<mode>" 
  [(unspec [(match_operand:BND 0 "register_operand" "v,v")
        (match_operand 1 "general_operand" "r,p")] UNSPEC_BNDCU)]
  "TARGET_PL" 
{ 
...
(define_insn "bnd_ldx<mode>"
  [(set (match_operand:BND 0 "register_operand" "=v") 
        (unspec [(match_operand:BND 1 "address_no_index_operand" "p")
        (match_operand:BND 2 "register_operand" "r")] UNSPEC_BNDLDX))]
  "TARGET_PL"
{
...
(define_insn "bnd_stx<mode>"
  [(unspec [(match_operand 0 "address_no_index_operand" "p")
                (match_operand 1 "register_operand" "r")
