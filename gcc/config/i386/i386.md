...
(define_insn "bnd_mk<mode>"
  [(set (match_operand:BND 0 "register_operand" "=v")
        ...
        (match_operand 2 "register_operand" "r")] UNSPEC_BNDMK))]
  "TARGET_PL"
{
...
(define_insn "bnd_cl<mode>"
  [(unspec [(match_operand:BND 0 "register_operand" "v")
        (match_operand 1 "general_operand")] UNSPEC_BNDCL)]
  "TARGET_PL"
{
...
(define_insn "bnd_cu<mode>" 
  [(unspec [(match_operand:BND 0 "register_operand" "v")
        (match_operand 1 "general_operand")] UNSPEC_BNDCU)]
  "TARGET_PL" 
{ 
...
;;??? status registers
;;(define_insn "bnd_cu"
;;  [(match_operand:BND 0 "register_operand" "v") 
;;        (match_operand 1 "memory_operand" "m")
;;   (clobber (reg:CC FLAGS_REG))]
;;  "TARGET_PL"
;;{
...
(define_insn "bnd_ldx<mode>"
  [(unspec [(match_operand:BND 0 "register_operand" "v") 
            (match_operand:BND 1 "memory_operand" "m")
            (match_operand:BND 2 "memory_operand" "m")] UNSPEC_BNDLDX)]
  "TARGET_PL"
{
...
(define_insn "bnd_stx<mode>"
  [(unspec [(match_operand 0 "memory_operand")
                (match_operand 1 "memory_operand")
