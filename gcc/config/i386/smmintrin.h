...
#ifdef __OPTIMIZE__
static __inline __m128i __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE41))
...
#ifdef __OPTIMIZE__
static __inline __m128 __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE41))
...
#ifdef __OPTIMIZE__
static __inline __m128d __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE41))
...
#ifdef __OPTIMIZE__
static __inline int __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE41))
...
#ifdef __x86_64__
static __inline long long  __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE41))
...
#ifndef ATTR_SSE42
#define ATTR_SSE42 option("msse42")
#define ADD_ATTR_SSE42 ,ATTR_SSE42
#endif /* ATTR_SSE42 */
...
#ifdef __OPTIMIZE__
static __inline __m128i __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE42))
...
static __inline int __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE42))
...
#ifdef __x86_64__
static __inline long long  __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE42))
...
static __inline unsigned int __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE42))
...
#ifdef __x86_64__
static __inline unsigned long long __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSE42))
