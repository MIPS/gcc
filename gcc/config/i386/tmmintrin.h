...
#ifndef ATTR_SSSE3
#define ATTR_SSSE3 option("mssse3")
#define ADD_ATTR_SSSE3 ,ATTR_SSSE3
#endif /* ATTR_SSSE3 */

static __inline __m128i __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSSE3))
...
static __inline __m64 __attribute__((__always_inline__, __artificial__ ADD_ATTR_SSSE3))
