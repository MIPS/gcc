;; DFA-based pipeline description for i7200.
;;
...
(define_reservation "i7200_agen_mdu" "i7200_agen, i7200_gpmuldiv")
...
;; movep
(define_insn_reservation "i7200_int_movep" 1
  (and (eq_attr "cpu" "i7200")
       (eq_attr "type" "move_move"))
  "i7200_control_alu0 + i7200_agen_alu1")
...
;; mult, multu, mul
(define_insn_reservation "i7200_int_mult" 5
  (and (eq_attr "cpu" "i7200")
       (eq_attr "type" "imul3,imul3nc,imul"))
  "i7200_agen_mdu")
...
(define_insn_reservation "i7200_int_load" 2
  (and (eq_attr "cpu" "i7200")
       (eq_attr "move_type" "load,multimem_load"))
  "i7200_agen_lsu")

;; store
(define_insn_reservation "i7200_int_store" 1
  (and (eq_attr "cpu" "i7200")
       (eq_attr "move_type" "store,multimem_store"))
  "i7200_agen_lsu")
...
(define_bypass 3 "i7200_int_load" "i7200_int_load")
(define_bypass 3 "i7200_int_load" "i7200_int_store" "!mips_store_data_bypass_p")
(define_bypass 3 "i7200_int_load" "i7200_int_prefetch")

;; arith->next use :  1 cycles (Default)
;; arith->load base:  2 cycles
;; arith->store base: 2 cycles
;; arith->prefetch:   2 cycles
(define_bypass 2 "i7200_int_arith" "i7200_int_load")
(define_bypass 2 "i7200_int_arith" "i7200_int_store" "!mips_store_data_bypass_p")
(define_bypass 2 "i7200_int_arith" "i7200_int_prefetch")

;; movep->next use :  1 cycles (Default)
;; movep->load base:  2 cycles
;; movep->store base: 2 cycles
;; movep->prefetch:   2 cycles
(define_bypass 2 "i7200_int_movep" "i7200_int_load")
(define_bypass 2 "i7200_int_movep" "i7200_int_store" "!mips_store_data_bypass_p")
(define_bypass 2 "i7200_int_movep" "i7200_int_prefetch")

;; mul3->next use : 5 cycles (default)
;; mul3->l/s base : 6 cycles
;; mul3->prefetch : 6 cycles
(define_bypass 6 "i7200_int_mult" "i7200_int_load")
(define_bypass 6 "i7200_int_mult" "i7200_int_store" "!mips_store_data_bypass_p")
(define_bypass 6 "i7200_int_mult" "i7200_int_prefetch")
