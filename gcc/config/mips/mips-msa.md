...
(define_insn "msa_tc_ilvr_<msafmt>"
  [(set (match_operand:<VDMODE> 0 "register_operand" "=f")
	(unspec:<VDMODE> [(match_operand:IMSA_X2 1 "register_operand" "f")
		      (match_operand:IMSA_X2 2 "register_operand" "f")]
		      UNSPEC_MSA_ILVR))]
  "ISA_HAS_MSA"
...
(define_expand "vec_set<mode>"
  ...
  "ISA_HAS_MSA"
{
  emit_insn (gen_msa_insert_<msafmt>_insn (operands[0], operands[0], operands[2],
					   operands[1]));
  DONE;
})
...
(define_insn "msa_insert_<msafmt_f>"
  [(set (match_operand:FMSA 0 "register_operand" "=f")
	(unspec:FMSA [(match_operand:FMSA 1 "register_operand" "0")
		      (match_operand 2 "const_<indeximm>_operand" "")
		      (match_operand:<UNITMODE> 3 "register_operand" "d")]
		     UNSPEC_MSA_INSERT))]
  "ISA_HAS_MSA"
  "insert.<msafmt>\t%w0[%2],%z3"
  [(set_attr "type"     "mtc")
