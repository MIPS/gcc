...
extern const char *mips_output_save_restore (rtx, HOST_WIDE_INT, bool, bool);
...
extern bool umips_movep_no_overlap_p (rtx, rtx, rtx, rtx);
...
extern bool m16_4x4_based_address_p (rtx, machine_mode,
				     int (*)(rtx_def*, machine_mode));
