...
mips_option_override (void)
{
  ...
  if (mips_isa_rev == 6 && TARGET_NANOMIPS
    ...
    error ("nanoMIPS is only compatible with p32 or p64 ABI");
...
{
  /* Disable this code until the middle-end patch is ported */
#if 0
