...
#define MIPS_JR(DEST) \
  (TARGET_CB_ALWAYS && !TARGET_FIX_I6500 ? ((0x1b << 27) | ((DEST) << 16)) \
...
enum mips_builtin_type {
  ...
  /* For generating dspmac* type instructions in MIPS32 DSP ASE.
     Operand 0 of these instructions serves as both input and output.  */
  MIPS_BUILTIN_DSPMAC
};
...
/* Construct a mips_builtin_description from the given arguments.
   ...
   PURE indicates whether the builtin is a pure function.  */
...
/* Define __builtin_mips_<INSN>, which is a MIPS_BUILTIN_DSPMAC function
   mapped to instruction CODE_FOR_mips_<INSN>,  FUNCTION_TYPE and AVAIL
   are as for MIPS_BUILTIN.  */
#define DSPMAC_BUILTIN(INSN, FUNCTION_TYPE, AVAIL)                      \
  MIPS_BUILTIN (INSN, f, #INSN, MIPS_BUILTIN_DSPMAC, FUNCTION_TYPE,	\
		AVAIL, false)
...
/* Define a non-pure MSA MIPS_BUILTIN_DIRECT function __builtin_msa_<INSN>
   for instruction CODE_FOR_msa_<INSN>.  FUNCTION_TYPE is a builtin_description
   field.  */
#define MSA_BUILTIN_NOT_PURE(INSN, FUNCTION_TYPE)			\
    { CODE_FOR_msa_ ## INSN, MIPS_FP_COND_f,				\
    "__builtin_msa_" #INSN,  MIPS_BUILTIN_DIRECT,			\
...
#define MIPS_SET_FCSR 1
  ...
  DSPMAC_BUILTIN (dpau_h_qbl, MIPS_DI_FTYPE_DI_V4QI_V4QI, dsp_32),
  DSPMAC_BUILTIN (dpau_h_qbr, MIPS_DI_FTYPE_DI_V4QI_V4QI, dsp_32),
  DSPMAC_BUILTIN (dpsu_h_qbl, MIPS_DI_FTYPE_DI_V4QI_V4QI, dsp_32),
  DSPMAC_BUILTIN (dpsu_h_qbr, MIPS_DI_FTYPE_DI_V4QI_V4QI, dsp_32),
  DSPMAC_BUILTIN (dpaq_s_w_ph, MIPS_DI_FTYPE_DI_V2HI_V2HI, dsp_32),
  DSPMAC_BUILTIN (dpsq_s_w_ph, MIPS_DI_FTYPE_DI_V2HI_V2HI, dsp_32),
  DSPMAC_BUILTIN (mulsaq_s_w_ph, MIPS_DI_FTYPE_DI_V2HI_V2HI, dsp_32),
  DSPMAC_BUILTIN (dpaq_sa_l_w, MIPS_DI_FTYPE_DI_SI_SI, dsp_32),
  DSPMAC_BUILTIN (dpsq_sa_l_w, MIPS_DI_FTYPE_DI_SI_SI, dsp_32),
  DSPMAC_BUILTIN (maq_s_w_phl, MIPS_DI_FTYPE_DI_V2HI_V2HI, dsp_32),
  DSPMAC_BUILTIN (maq_s_w_phr, MIPS_DI_FTYPE_DI_V2HI_V2HI, dsp_32),
  DSPMAC_BUILTIN (maq_sa_w_phl, MIPS_DI_FTYPE_DI_V2HI_V2HI, dsp_32),
  DSPMAC_BUILTIN (maq_sa_w_phr, MIPS_DI_FTYPE_DI_V2HI_V2HI, dsp_32),
  ...
  DSPMAC_BUILTIN (dpa_w_ph, MIPS_DI_FTYPE_DI_V2HI_V2HI, dspr2_32),
  DSPMAC_BUILTIN (dps_w_ph, MIPS_DI_FTYPE_DI_V2HI_V2HI, dspr2_32),
  DSPMAC_BUILTIN (mulsa_w_ph, MIPS_DI_FTYPE_DI_V2HI_V2HI, dspr2_32),
  DSPMAC_BUILTIN (dpax_w_ph, MIPS_DI_FTYPE_DI_V2HI_V2HI, dspr2_32),
  DSPMAC_BUILTIN (dpsx_w_ph, MIPS_DI_FTYPE_DI_V2HI_V2HI, dspr2_32),
  DSPMAC_BUILTIN (dpaqx_s_w_ph, MIPS_DI_FTYPE_DI_V2HI_V2HI, dspr2_32),
  DSPMAC_BUILTIN (dpaqx_sa_w_ph, MIPS_DI_FTYPE_DI_V2HI_V2HI, dspr2_32),
  DSPMAC_BUILTIN (dpsqx_s_w_ph, MIPS_DI_FTYPE_DI_V2HI_V2HI, dspr2_32),
  DSPMAC_BUILTIN (dpsqx_sa_w_ph, MIPS_DI_FTYPE_DI_V2HI_V2HI, dspr2_32),
  ...
  MSA_BUILTIN_NOT_PURE (ceq_b, MIPS_V16QI_FTYPE_V16QI_V16QI),
  MSA_BUILTIN_NOT_PURE (ceq_h, MIPS_V8HI_FTYPE_V8HI_V8HI),
  MSA_BUILTIN_NOT_PURE (ceq_w, MIPS_V4SI_FTYPE_V4SI_V4SI),
  MSA_BUILTIN_NOT_PURE (ceq_d, MIPS_V2DI_FTYPE_V2DI_V2DI),
  MSA_BUILTIN_NOT_PURE (ceqi_b, MIPS_V16QI_FTYPE_V16QI_QI),
  MSA_BUILTIN_NOT_PURE (ceqi_h, MIPS_V8HI_FTYPE_V8HI_QI),
  MSA_BUILTIN_NOT_PURE (ceqi_w, MIPS_V4SI_FTYPE_V4SI_QI),
  MSA_BUILTIN_NOT_PURE (ceqi_d, MIPS_V2DI_FTYPE_V2DI_QI),
  MSA_BUILTIN_NOT_PURE (clt_s_b, MIPS_V16QI_FTYPE_V16QI_V16QI),
  MSA_BUILTIN_NOT_PURE (clt_s_h, MIPS_V8HI_FTYPE_V8HI_V8HI),
  MSA_BUILTIN_NOT_PURE (clt_s_w, MIPS_V4SI_FTYPE_V4SI_V4SI),
  MSA_BUILTIN_NOT_PURE (clt_s_d, MIPS_V2DI_FTYPE_V2DI_V2DI),
  MSA_BUILTIN_NOT_PURE (clti_s_b, MIPS_V16QI_FTYPE_V16QI_QI),
  MSA_BUILTIN_NOT_PURE (clti_s_h, MIPS_V8HI_FTYPE_V8HI_QI),
  MSA_BUILTIN_NOT_PURE (clti_s_w, MIPS_V4SI_FTYPE_V4SI_QI),
  MSA_BUILTIN_NOT_PURE (clti_s_d, MIPS_V2DI_FTYPE_V2DI_QI),
  MSA_BUILTIN_NOT_PURE (clt_u_b, MIPS_V16QI_FTYPE_UV16QI_UV16QI),
  MSA_BUILTIN_NOT_PURE (clt_u_h, MIPS_V8HI_FTYPE_UV8HI_UV8HI),
  MSA_BUILTIN_NOT_PURE (clt_u_w, MIPS_V4SI_FTYPE_UV4SI_UV4SI),
  MSA_BUILTIN_NOT_PURE (clt_u_d, MIPS_V2DI_FTYPE_UV2DI_UV2DI),
  MSA_BUILTIN_NOT_PURE (clti_u_b, MIPS_V16QI_FTYPE_UV16QI_UQI),
  MSA_BUILTIN_NOT_PURE (clti_u_h, MIPS_V8HI_FTYPE_UV8HI_UQI),
  MSA_BUILTIN_NOT_PURE (clti_u_w, MIPS_V4SI_FTYPE_UV4SI_UQI),
  MSA_BUILTIN_NOT_PURE (clti_u_d, MIPS_V2DI_FTYPE_UV2DI_UQI),
  MSA_BUILTIN_NOT_PURE (cle_s_b, MIPS_V16QI_FTYPE_V16QI_V16QI),
  MSA_BUILTIN_NOT_PURE (cle_s_h, MIPS_V8HI_FTYPE_V8HI_V8HI),
  MSA_BUILTIN_NOT_PURE (cle_s_w, MIPS_V4SI_FTYPE_V4SI_V4SI),
  MSA_BUILTIN_NOT_PURE (cle_s_d, MIPS_V2DI_FTYPE_V2DI_V2DI),
  MSA_BUILTIN_NOT_PURE (clei_s_b, MIPS_V16QI_FTYPE_V16QI_QI),
  MSA_BUILTIN_NOT_PURE (clei_s_h, MIPS_V8HI_FTYPE_V8HI_QI),
  MSA_BUILTIN_NOT_PURE (clei_s_w, MIPS_V4SI_FTYPE_V4SI_QI),
  MSA_BUILTIN_NOT_PURE (clei_s_d, MIPS_V2DI_FTYPE_V2DI_QI),
  MSA_BUILTIN_NOT_PURE (cle_u_b, MIPS_V16QI_FTYPE_UV16QI_UV16QI),
  MSA_BUILTIN_NOT_PURE (cle_u_h, MIPS_V8HI_FTYPE_UV8HI_UV8HI),
  MSA_BUILTIN_NOT_PURE (cle_u_w, MIPS_V4SI_FTYPE_UV4SI_UV4SI),
  MSA_BUILTIN_NOT_PURE (cle_u_d, MIPS_V2DI_FTYPE_UV2DI_UV2DI),
  MSA_BUILTIN_NOT_PURE (clei_u_b, MIPS_V16QI_FTYPE_UV16QI_UQI),
  MSA_BUILTIN_NOT_PURE (clei_u_h, MIPS_V8HI_FTYPE_UV8HI_UQI),
  MSA_BUILTIN_NOT_PURE (clei_u_w, MIPS_V4SI_FTYPE_UV4SI_UQI),
  MSA_BUILTIN_NOT_PURE (clei_u_d, MIPS_V2DI_FTYPE_UV2DI_UQI),
  MSA_BUILTIN_NOT_PURE (ld_b, MIPS_V16QI_FTYPE_CVPOINTER_SI),
  MSA_BUILTIN_NOT_PURE (ld_h, MIPS_V8HI_FTYPE_CVPOINTER_SI),
  MSA_BUILTIN_NOT_PURE (ld_w, MIPS_V4SI_FTYPE_CVPOINTER_SI),
  MSA_BUILTIN_NOT_PURE (ld_d, MIPS_V2DI_FTYPE_CVPOINTER_SI),
  ...
  MSA_BUILTIN_NOT_PURE (fill_b, MIPS_V16QI_FTYPE_SI),
  MSA_BUILTIN_NOT_PURE (fill_h, MIPS_V8HI_FTYPE_SI),
  MSA_BUILTIN_NOT_PURE (fill_w, MIPS_V4SI_FTYPE_SI),
  MSA_BUILTIN_NOT_PURE (fill_d, MIPS_V2DI_FTYPE_DI),
  ...
  MSA_BUILTIN_NOT_PURE (copy_s_b, MIPS_SI_FTYPE_V16QI_UQI),
  MSA_BUILTIN_NOT_PURE (copy_s_h, MIPS_SI_FTYPE_V8HI_UQI),
  MSA_BUILTIN_NOT_PURE (copy_s_w, MIPS_SI_FTYPE_V4SI_UQI),
  MSA_BUILTIN_NOT_PURE (copy_s_d, MIPS_DI_FTYPE_V2DI_UQI),
  MSA_BUILTIN_NOT_PURE (copy_u_b, MIPS_USI_FTYPE_V16QI_UQI),
  MSA_BUILTIN_NOT_PURE (copy_u_h, MIPS_USI_FTYPE_V8HI_UQI),
  MSA_BUILTIN_REMAP (copy_u_w, copy_s_w, MIPS_USI_FTYPE_V4SI_UQI),
  MSA_BUILTIN_REMAP (copy_u_d, copy_s_d, MIPS_UDI_FTYPE_V2DI_UQI),
  MSA_BUILTIN_NOT_PURE (insert_b, MIPS_V16QI_FTYPE_V16QI_UQI_SI),
  MSA_BUILTIN_NOT_PURE (insert_h, MIPS_V8HI_FTYPE_V8HI_UQI_SI),
  MSA_BUILTIN_NOT_PURE (insert_w, MIPS_V4SI_FTYPE_V4SI_UQI_SI),
  MSA_BUILTIN_NOT_PURE (insert_d, MIPS_V2DI_FTYPE_V2DI_UQI_DI),
  MSA_BUILTIN_NOT_PURE (insve_b, MIPS_V16QI_FTYPE_V16QI_UQI_V16QI),
  MSA_BUILTIN_NOT_PURE (insve_h, MIPS_V8HI_FTYPE_V8HI_UQI_V8HI),
  MSA_BUILTIN_NOT_PURE (insve_w, MIPS_V4SI_FTYPE_V4SI_UQI_V4SI),
  MSA_BUILTIN_NOT_PURE (insve_d, MIPS_V2DI_FTYPE_V2DI_UQI_V2DI),
  ...
  MSA_BUILTIN_NOT_PURE (ldi_b, MIPS_V16QI_FTYPE_HI),
  MSA_BUILTIN_NOT_PURE (ldi_h, MIPS_V8HI_FTYPE_HI),
  MSA_BUILTIN_NOT_PURE (ldi_w, MIPS_V4SI_FTYPE_HI),
  MSA_BUILTIN_NOT_PURE (ldi_d, MIPS_V2DI_FTYPE_HI),
  MSA_BUILTIN_NOT_PURE (fcaf_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fcaf_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fcor_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fcor_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fcun_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fcun_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fcune_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fcune_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fcueq_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fcueq_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fceq_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fceq_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fcne_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fcne_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fclt_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fclt_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fcult_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fcult_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fcle_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fcle_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fcule_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fcule_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fsaf_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fsaf_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fsor_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fsor_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fsun_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fsun_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fsune_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fsune_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fsueq_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fsueq_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fseq_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fseq_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fsne_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fsne_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fslt_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fslt_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fsult_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fsult_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fsle_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fsle_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  MSA_BUILTIN_NOT_PURE (fsule_w, MIPS_V4SI_FTYPE_V4SF_V4SF),
  MSA_BUILTIN_NOT_PURE (fsule_d, MIPS_V2DI_FTYPE_V2DF_V2DF),
  ...
  MSA_BUILTIN_NOT_PURE (fclass_w, MIPS_V4SI_FTYPE_V4SF),
  MSA_BUILTIN_NOT_PURE (fclass_d, MIPS_V2DI_FTYPE_V2DF),
  ...
  MSA_BUILTIN_NOT_PURE (fexupl_w, MIPS_V4SF_FTYPE_V8HI),
  MSA_BUILTIN_NOT_PURE (fexupl_d, MIPS_V2DF_FTYPE_V4SF),
  MSA_BUILTIN_NOT_PURE (fexupr_w, MIPS_V4SF_FTYPE_V8HI),
  MSA_BUILTIN_NOT_PURE (fexupr_d, MIPS_V2DF_FTYPE_V4SF),
  MSA_BUILTIN_NOT_PURE (ffql_w, MIPS_V4SF_FTYPE_V8HI),
  MSA_BUILTIN_NOT_PURE (ffql_d, MIPS_V2DF_FTYPE_V4SI),
  MSA_BUILTIN_NOT_PURE (ffqr_w, MIPS_V4SF_FTYPE_V8HI),
  MSA_BUILTIN_NOT_PURE (ffqr_d, MIPS_V2DF_FTYPE_V4SI),
  MSA_BUILTIN_NOT_PURE (ftint_s_w, MIPS_V4SI_FTYPE_V4SF),
  MSA_BUILTIN_NOT_PURE (ftint_s_d, MIPS_V2DI_FTYPE_V2DF),
  MSA_BUILTIN_NOT_PURE (ftint_u_w, MIPS_UV4SI_FTYPE_V4SF),
  MSA_BUILTIN_NOT_PURE (ftint_u_d, MIPS_UV2DI_FTYPE_V2DF),
  MSA_BUILTIN_NOT_PURE (ftrunc_s_w, MIPS_V4SI_FTYPE_V4SF),
  MSA_BUILTIN_NOT_PURE (ftrunc_s_d, MIPS_V2DI_FTYPE_V2DF),
  MSA_BUILTIN_NOT_PURE (ftrunc_u_w, MIPS_UV4SI_FTYPE_V4SF),
  MSA_BUILTIN_NOT_PURE (ftrunc_u_d, MIPS_UV2DI_FTYPE_V2DF),
  MSA_BUILTIN_NOT_PURE (ffint_s_w, MIPS_V4SF_FTYPE_V4SI),
  MSA_BUILTIN_NOT_PURE (ffint_s_d, MIPS_V2DF_FTYPE_V2DI),
  MSA_BUILTIN_NOT_PURE (ffint_u_w, MIPS_V4SF_FTYPE_UV4SI),
  MSA_BUILTIN_NOT_PURE (ffint_u_d, MIPS_V2DF_FTYPE_UV2DI),
  MSA_NO_TARGET_BUILTIN (ctcmsa, MIPS_VOID_FTYPE_UQI_SI),
  MSA_BUILTIN_NOT_PURE (cfcmsa, MIPS_SI_FTYPE_UQI),
  MSA_BUILTIN_NOT_PURE (move_v, MIPS_V16QI_FTYPE_V16QI),
};
...
mips_init_builtins (void)
{
  ...
  for (i = 0; i < ARRAY_SIZE (mips_builtins); i++)
      ...
      if (d->avail ())
	{
	  ...
	  if (mips_builtin_decls[i] && d->pure)
...
/* Expand a __builtin_mips_dp* -like built-in function. EXP is the CALL_EXPR
   that calls the function and ICODE is the code of the associated .md pattern.
   TARGET, if nonnull, suggests a good place to put the result.  */

static rtx
mips_expand_builtin_dspmac (enum insn_code icode, rtx target ATTRIBUTE_UNUSED,
                            tree exp)
{
  struct expand_operand ops[MAX_RECOG_OPERANDS];
  int argno;
  ...
  /* Operand 0 is input/output, so we perform a copy to a new reg.
     Expand will later copy this reg to the target if needed.  */
  ops[0].value = copy_to_mode_reg(ops[0].mode, ops[0].value);

  return mips_expand_builtin_insn (icode, argno, ops, true);
}
		     ...
		     machine_mode mode, int ignore)
{
  ...
  switch (d->builtin_type)
    ...
    case MIPS_BUILTIN_DSPMAC:
      return mips_expand_builtin_dspmac (d->icode, target, exp);
    }
  gcc_unreachable ();
}

...
mips_option_override (void)
{
  ...
  if (((target_flags_explicit & MASK_FIX_I6500) || TARGET_FIX_I6400)
       && mips_isa_rev == 6)
    target_flags |= MASK_FIX_I6500;
...
static rtx_insn *
mips_next_real_nondebug_insn (rtx uncast_insn)
{
			  ...
			  rtx *opvec, int noperands)
{
  ...
  if (INSN_P (insn)
      ...
      && (next_insn = mips_next_real_nondebug_insn (insn)))
    {
