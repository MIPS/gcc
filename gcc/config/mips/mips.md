...
(define_insn "*mov<mode>_internal"
  [(set (match_operand:IMOVE32 0 "nonimmediate_operand" "=d,!u,!u,d,e,!u,!ks,d,ZS,ZT,m,*f,*f,*d,*m,*d,*z,*a,*d,*B*C*D,*B*C*D,*d,*m,d,kd")
	(match_operand:IMOVE32 1 "move_operand" "d,J,Udb7,Yd,Yf,ZT,ZS,m,!ks,!kbJ,dJ,*d*J,*m,*f,*f,*z,*d,*J*d,*a,*d,*m,*B*C*D,*B*C*D,n,ZY"))]
  "!TARGET_MIPS16
   && (register_operand (operands[0], <MODE>mode)
       || reg_or_0_operand (operands[1], <MODE>mode))"
  { return mips_output_move (insn, operands[0], operands[1]); }
  [(set_attr "move_type" "move,move,const,const,const,load,load,load,store,store,store,mtc,fpload,mfc,fpstore,mfc,mtc,mtlo,mflo,mtc,fpload,mfc,fpstore,move,load")
...
(define_insn "*seq_<GPR:mode><GPR2:mode>_seq"
  [(set (match_operand:GPR2 0 "register_operand" "=d,d,d,d")
	(eq:GPR2 (match_operand:GPR 1 "register_operand" "%d,d,d,d")
		 (match_operand:GPR 2 "set_on_cond_operand" "d,J,YB,K")))]
...
(define_insn "*sne_<GPR:mode><GPR2:mode>_sne"
  ...
  "ISA_HAS_SEQ_SNE"
  "@
   sdbbp32 11; # sne\t%0,%1,%2
   sltu\t%0,%.,%1
   sdbbp32 12; # snei\t%0,%1,%2"
  [(set_attr "type" "slt")
   (set_attr "mode" "<GPR:MODE>")])
