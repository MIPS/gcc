  ...
  "!TARGET_MIPS16"
{
  ...
  switch (which_alternative)
	...
	return "sdbbp32 6 # l<SHORT:size>ux\t%0,%1";
      else
  ...
  "ISA_HAS_SEB_SEH"
{
  ...
  if (which_alternative == 0)
    ...
    return "sdbbp32 6 # l<SHORT:size>x\t%0,%1";
  else if (mips_index_scaled_address_p (XEXP (operands[1], 0), <MODE>mode))
    return "sdbbp32 4 # l<SHORT:size>xs\t%0,%1";
  else
  ...
  "ISA_HAS_LWXS"
{
  ...
  if (M16_REG_P (REGNO (operands[0]))
    ...
    return "sdbbp16 4 # lwxs16\t%0,%1(%2)";
  else
    return "sdbbp32 4 # lwxs\t%0,%1(%2)";
}
  [(set_attr "type"	"load")
   (set_attr "mode"	"SI")])
...
(define_insn "*mov<GPR:mode>_on_<MOVECC:mode>"
  ...
  ;; FIXME
  "@
    sdbbp32 9 # mov%T4\t%0,%z2,%1
    sdbbp32 9 # mov%t4\t%0,%z3,%1"
...
(define_insn "*mov<GPR:mode>_on_<GPR2:mode>_ne"
  ...
  ;; FIXME
  "@
    sdbbp32 9 # movn\t%0,%z2,%1
    sdbbp32 9 # movz\t%0,%z3,%1"
  [(set_attr "type" "condmove")
   (set_attr "mode" "<GPR:MODE>")])
