  ...
  [(set_attr "move_type" "load,load,load,andi,andi,andi,andi,ext_ins,shift_shift,logical,logical,ext_ins")
   ...
   (set (attr "enabled")
	(cond [(and (eq_attr "alternative" "3,4")
		    (not (match_test "TARGET_MICROMIPS_R7 && TARGET_NEW_ANDI")))
		  (const_string "no")]
	      (const_string "yes")))])
...
(define_insn "*mov<mode>_internal"
  [(set (match_operand:IMOVE32 0 "nonimmediate_operand" "=d,!u,!u,d,e,!u,!ks,d,ZS,ZT,m,*f,*f,*d,*ZB,*d,*z,*a,*d,*B*C*D,*B*C*D,*d,*m,kd,ZY,d")
	(match_operand:IMOVE32 1 "move_operand" "d,J,Udb7,Yd,Yf,ZT,ZS,m,!ks,!kbJ,dJ,*d*J,*ZB,*f,*f,*z,*d,*J*d,*a,*d,*m,*B*C*D,*B*C*D,ZY,kd,n"))]
  "!TARGET_MIPS16
   ...
   (set (attr "enabled")
	(cond [(and (eq_attr "alternative" "23")
		    (ior (not (match_test "TARGET_MICROMIPS_R7"))
			 (not (match_test "TARGET_ADD_LW4X4"))))
		  (const_string "no")
	       (and (eq_attr "alternative" "24")
		    (ior (not (match_test "TARGET_MICROMIPS_R7"))
...
(define_insn "*slt<u>_<GPR:mode><GPR2:mode>"
  [(set (match_operand:GPR2 0 "register_operand" "=d,d,d,d")
	(any_lt:GPR2 (match_operand:GPR 1 "register_operand" "d,d,d,d")
		     (match_operand:GPR 2 "arith_operand" "dI,d,YD,YE")))]
  "!TARGET_MIPS16"
  "@
   slt<u>\t%0,%1,%2
   slt<u>\t%0,%1,%2
