...
#define OPTION_DEFAULT_SPECS \
  ...
  {"cpu", "%{mcpu=*|te500mc|te500v1|te500v2|te600|te6500:;:-mcpu=%(VALUE)}" }, \
  {"cpu_32", "%{" OPT_ARCH32 ":%{mcpu=*|te500mc|te500v1|te500v2|te600|te6500:;:-mcpu=%(VALUE)}}" }, \
  {"cpu_64", "%{" OPT_ARCH64 ":%{mcpu=*|te500mc|te500v1|te500v2|te600|te6500:;:-mcpu=%(VALUE)}}" }, \
