...
extern int word_offset_memref_operand PARAMS ((rtx, enum machine_mode));
...
extern HOST_WIDE_INT rs6000_initial_elimination_offset PARAMS ((int, int));
...
#ifdef TREE_CODE
extern unsigned int rs6000_special_round_type_align PARAMS ((tree, int, int));
extern bool rs6000_return_in_memory PARAMS ((tree));
...
extern void setup_incoming_varargs PARAMS ((CUMULATIVE_ARGS *,
					    ...
					    int *, int));
extern rtx rs6000_function_value PARAMS ((tree, tree));
extern rtx rs6000_libcall_value PARAMS ((enum machine_mode));
extern struct rtx_def *rs6000_va_arg PARAMS ((tree, tree));
extern bool rs6000_function_ok_for_sibcall PARAMS ((tree));
...
extern void rs6000_emit_eh_reg_restore PARAMS ((rtx, rtx));
