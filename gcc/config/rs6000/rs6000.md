  ...
  "
{
  if (GET_CODE (operands[1]) != CONST_VECTOR
      || easy_vector_constant (operands[1], V4SImode))
    abort ();
...
(define_split
  [(set (mem:V4SI (plus:SI (match_operand:SI 0 "gpc_reg_operand" "")
...
(define_insn ""
  [(set (mem:V4SI (plus:SI (match_operand:SI 0 "gpc_reg_operand" "b,r")
...
(define_insn ""
  [(set (mem:V4SI (match_operand:SI 0 "gpc_reg_operand" "r"))
...
(define_split
  [(set (match_operand:V4SI 0 "register_operand" "")
	(mem:V4SI (plus:SI (match_operand:SI 1 "gpc_reg_operand" "")
			 (match_operand:SI 2 "short_cint_operand" ""))))
   (clobber (match_operand:SI 3 "gpc_reg_operand" ""))]
  ""
...
(define_insn ""
  [(set (match_operand:V4SI 0 "register_operand" "=v,v")
	(mem:V4SI (plus:SI (match_operand:SI 1 "gpc_reg_operand" "b,r")
...
(define_insn ""
  [(set (match_operand:V4SI 0 "register_operand" "=v")
        (mem:V4SI (match_operand:SI 1 "gpc_reg_operand" "r")))]
  ""
  "lvx %0,0,%1"
  [(set_attr "type" "vec_load")])
...
(define_insn "mov_from_vrsave"
  [(set (match_operand:SI 0 "register_operand" "=r")
	(unspec:SI [(const_int 0)] UNSPEC_MOV_FROM_VRSAVE))]
  ""
  "mfspr %0,VRsave"
  [(set_attr "type" "*")
   (set_attr "length" "4")])
...
(define_insn "mov_to_vrsave"
  [(set (unspec_volatile:SI [(const_int 0)] UNSPECV_MOV_TO_VRSAVE)
...
(define_expand "j_24_f_fxx_simple"
  [(parallel [(set (reg:CC 74)
	      ...
	      (clobber (match_scratch:V4SI 4 "=v"))])
   (set (match_operand:SI 0 "register_operand" "=r")
	(lt:SI (reg:CC 74)
	       (const_int 0)))
...
(define_expand "j_24_f_frxx_simple"
  [(parallel [(set (reg:CC 74)
		   (unspec:CC [(match_operand:V4SI 2 "register_operand" "v")
			       (match_operand:V4SI 1 "register_operand" "v")
			       (match_operand 3 "any_operand" "")] 1))
	      (clobber (match_scratch:V4SI 4 "=v"))])
   (set (match_operand:SI 0 "register_operand" "=r")
...
(define_insn "xfx_perm"
  [(set (match_operand:V4SI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V4SI 1 "register_operand" "v"))
		    (match_operand 2 "any_operand" "")] 1))]
  ""
  "%2 %0,%1"
...
(define_insn "xfxx_perm"
  [(set (match_operand:V4SI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V4SI 1 "register_operand" "v"))
		    (use (match_operand:V4SI 2 "register_operand" "v"))
		    (match_operand 3 "any_operand" "")] 1))]
  ""
  "%3 %0,%1,%2"
  [(set_attr "type" "vec_perm")])
...
(define_insn "xfxxx_perm"
  [(set (match_operand:V4SI 0 "register_operand" "=v")
	(unspec [(use (match_operand:V4SI 1 "register_operand" "v"))
		    (use (match_operand:V4SI 2 "register_operand" "v"))
		    (use (match_operand:V4SI 3 "register_operand" "v"))
...
(define_insn "vfx_fxu"
  [(unspec_volatile
    [(use (match_operand:V4SI 0 "register_operand" "v"))
     (match_operand 1 "any_operand" "")] 2)]
  ""
  "%1 %0"
  [(set_attr "type" "integer")])
