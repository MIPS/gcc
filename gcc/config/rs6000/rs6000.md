  ...
  "
{
  if (TARGET_POWERPC64)
    {
      /* APPLE LOCAL assign_stack_local_with_alias scheduling speedup */
...
(define_insn "mov_mixed_update"
  [(set (mem:DI (plus:SI (match_operand:SI 1 "gpc_reg_operand" "0,0")
                         (match_operand:SI 2 "reg_or_short_operand" "r,I")))
        (match_operand:DI 3 "gpc_reg_operand" "r,r"))
   (set (match_operand:SI 0 "gpc_reg_operand" "=b,b")
        (plus:SI (match_dup 1) (match_dup 2)))]
  "TARGET_POWERPC64 && TARGET_32BIT && TARGET_UPDATE"
  "@
   stdux %3,%0,%2
   stdu %3,%2(%0)"
  [(set_attr "type" "store_ux,store_u")])
