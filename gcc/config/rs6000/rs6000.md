...

;; copy main memory starting at operand 1 to SPE memory starting at operand 0;
;; transfer size is operands[2].
(define_insn "spu_dma_in_<mode>"
  [(set (reg:CC_BLK SPU_MEM)
        (unspec [(reg:CC_BLK SPU_MEM)
                 (mem:BLK (match_operand:P 1 "general_operand"))
...
;; copy SPE memory starting at operand 0 to main memory starting at operand 1;
;; transfer size is operands[2].
(define_insn "spu_dma_out_<mode>"
  [(set (mem:BLK (match_operand:P 1 "general_operand"))
        (unspec [(reg:CC_BLK SPU_MEM)
                 (match_operand:SI 0 "general_operand")
                 (match_operand:SI 2 "immediate_operand")]
         UNSPEC_PPE_SPU_DMA))]
