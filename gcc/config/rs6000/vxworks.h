...
/* target_flags has no free bits on rs6000, so we have to handle these
   switches by other means.  This leads to some duplication.  */
#undef  TARGET_VXWORKS_RTP
#define TARGET_VXWORKS_RTP  rs6000_rtp
