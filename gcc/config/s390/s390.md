...
;
; cmpmemdi instruction pattern(s).
;
   ...
   "
{
  ...
  if (GET_CODE (operands[3]) == CONST_INT && INTVAL (operands[3]) < 256) 
	...
	DONE;
      ...
      emit_insn (gen_cmpmem_const (operands[1], operands[2], operands[3]));
    ...
    {	
      ...
      /* Compare! */
      emit_insn (gen_cmpmem_64 (reg0, reg1, reg0, reg1));
      emit_insn (gen_cmpint_di (operands[0]));
      DONE;
    }
}")
  ...
  if (GET_CODE (operands[3]) == CONST_INT && INTVAL (operands[3]) < 256) 
      ...
      else
	{
      ...
      if (TARGET_64BIT) 
          ...
          emit_insn (gen_cmpmem_31 (reg0, reg1, reg0, reg1));
