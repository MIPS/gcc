...
(define_insn_and_split "movsf_ie_ra"
  [(set (match_operand:SF 0 "general_movdst_operand"
   ...
   (clobber (match_scratch:SF 3 "=r,r,Bsc,Bsc,&z,r,r,X,r,r,r,r,r,y,r,r,r,r,r"))
   (const_int 0)]
  "TARGET_SH2E
   && (arith_reg_operand (operands[0], SFmode)
  ...
  "@
	...
	! move optimized away"
  "reload_completed
   && sh_movsf_ie_ra_split_p (operands[0], operands[1], operands[3])"
  [(const_int 0)]
{
  if (! rtx_equal_p (operands[0], operands[1]))
    {
      emit_sf_insn (gen_movsf_ie (operands[3], operands[1], get_fpscr_rtx ()));
      emit_sf_insn (gen_movsf_ie (operands[0], operands[3], get_fpscr_rtx ()));
    }
}
  [(set_attr "type" "fmove,move,fmove,fmove,pcfload,fload,fstore,pcload,load,
		     store,fmove,fmove,load,*,fpul_gp,gp_fpul,fstore,load,nil")
  ...
  if (TARGET_SH2E)
      ...
      if (lra_in_progress)
	{
	  if (GET_CODE (operands[0]) == SCRATCH)
	    DONE;
	  emit_sf_insn (gen_movsf_ie_ra (operands[0], operands[1],
	  	       			 get_fpscr_rtx ()));
	  DONE;
	}
