...
#if TARGET_CPU_DEFAULT == TARGET_CPU_v9 || TARGET_CPU_DEFAULT == TARGET_CPU_ultrasparc || TARGET_CPU_DEFAULT == TARGET_CPU_ultrasparc3
...
%{mcpu=ultrasparc3:" DEF_ARCH32_SPEC("-D__sparcv8") "} \
