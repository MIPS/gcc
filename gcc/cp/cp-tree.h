...
/* Given a FUNCTION_DECL, returns the first TREE_LIST out of
   DECL_ARGUMENTS which refers to a user-written parameter.  */
...
extern int fn_type_unification			(tree, tree, tree, VEC(tree,heap) **,
