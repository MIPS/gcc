...
const struct attribute_spec std_attribute_table[] =
{
  ...
  { "maybe_unused", 0, 0, false, false, false,
    handle_unused_decl_attribute,  handle_unused_type_attribute, false },
  { "nodiscard", 0, 0, false, false, false,
    handle_nodiscard_attribute, NULL, false },
  { NULL,	      0, 0, false, false, false, NULL, NULL, false }
};
...
/* Handle an "abi_tag" ecl attribute; arguments as in
   struct attribute_spec.handler.  */
