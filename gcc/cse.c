...
static int delete_trivially_dead_insns_1 (rtx, int, struct df *);
...
void
delete_trivially_dead_insns_df (rtx insns, int nreg, struct df *df)
{
...
static int
delete_trivially_dead_insns_1 (rtx insns, int nreg, struct df *df)
{
  int *counts;
  rtx insn, prev;
