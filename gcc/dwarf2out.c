...
static unsigned int dbx_reg_number	PARAMS ((rtx));
...
static dw_loc_descr_ref based_loc_descr	PARAMS ((unsigned, long, int));
...
static dw_loc_descr_ref loc_descriptor	PARAMS ((rtx, int));
...
static dw_loc_descr_ref
based_loc_descr (reg, offset, can_use_fbreg)
     unsigned reg;
     long int offset;
     int can_use_fbreg;
{
...
static dw_loc_descr_ref
mem_loc_descriptor (rtl, mode, can_use_fbreg)
     rtx rtl;
...
static dw_loc_descr_ref
loc_descriptor (rtl, can_use_fbreg)
     rtx rtl;
     int can_use_fbreg;
{
  dw_loc_descr_ref loc_result = NULL;
...
static void
add_location_or_const_value_attribute (die, decl, attr)
     dw_die_ref die;
     tree decl;
