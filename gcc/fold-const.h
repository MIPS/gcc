...
extern tree native_interpret_expr (ttype_p , const unsigned char *, int);
...
extern tree fold_unary_loc (location_t, enum tree_code, ttype_p, tree);
...
extern tree fold_binary_loc (location_t, enum tree_code, ttype_p, tree, tree);
#define fold_ternary(CODE,T1,T2,T3,T4)\
   fold_ternary_loc (UNKNOWN_LOCATION, CODE, T1, T2, T3, T4)
extern tree fold_ternary_loc (location_t, enum tree_code, ttype_p, tree, tree, tree);
...
extern tree fold_build1_stat_loc (location_t, enum tree_code, ttype_p,
				  tree MEM_STAT_DECL);
...
extern tree fold_build2_stat_loc (location_t, enum tree_code, ttype_p, tree,
				  tree MEM_STAT_DECL);
...
extern tree fold_build3_stat_loc (location_t, enum tree_code, ttype_p, tree, tree,
				  tree MEM_STAT_DECL);
extern tree fold_build1_initializer_loc (location_t, enum tree_code, ttype_p, tree);
extern tree fold_build2_initializer_loc (location_t, enum tree_code, ttype_p, tree, tree);
#define fold_build_call_array(T1,T2,N,T4)\
   fold_build_call_array_loc (UNKNOWN_LOCATION, T1, T2, N, T4)
extern tree fold_build_call_array_loc (location_t, ttype_p, tree, int, tree *);
#define fold_build_call_array_initializer(T1,T2,N,T4)\
   fold_build_call_array_initializer_loc (UNKNOWN_LOCATION, T1, T2, N, T4)
extern tree fold_build_call_array_initializer_loc (location_t, ttype_p, tree, int, tree *);
extern tree get_array_ctor_element_at_index (tree, offset_int);
extern bool fold_convertible_p (const ttype_p, const_tree);
#define fold_convert(T1,T2)\
   fold_convert_loc (UNKNOWN_LOCATION, T1, T2)
extern tree fold_convert_loc (location_t, ttype_p, tree);
extern tree fold_single_bit_test (location_t, enum tree_code, tree, tree, tree);
extern tree fold_ignored_result (tree);
extern tree fold_abs_const (tree, ttype_p);
extern tree fold_indirect_ref_1 (location_t, ttype_p, tree);
extern void fold_defer_overflow_warnings (void);
extern void fold_undefer_overflow_warnings (bool, const gimple *, int);
extern void fold_undefer_and_ignore_overflow_warnings (void);
extern bool fold_deferring_overflow_warnings_p (void);
extern int operand_equal_p (const_tree, const_tree, unsigned int);
extern int multiple_of_p (ttype_p, const_tree, const_tree);
#define omit_one_operand(T1,T2,T3)\
   omit_one_operand_loc (UNKNOWN_LOCATION, T1, T2, T3)
extern tree omit_one_operand_loc (location_t, ttype_p, tree, tree);
#define omit_two_operands(T1,T2,T3,T4)\
   omit_two_operands_loc (UNKNOWN_LOCATION, T1, T2, T3, T4)
extern tree omit_two_operands_loc (location_t, ttype_p , tree, tree, tree);
...
extern tree constant_boolean_node (bool, ttype_p);
...
extern bool tree_unary_nonzero_warnv_p (enum tree_code, ttype_p, tree, bool *);
extern bool tree_binary_nonzero_warnv_p (enum tree_code, ttype_p, tree,
					 tree op1, bool *);
extern bool tree_single_nonzero_warnv_p (tree, bool *);
extern bool tree_unary_nonnegative_warnv_p (enum tree_code, ttype_p, tree,
					    bool *, int);
extern bool tree_binary_nonnegative_warnv_p (enum tree_code, ttype_p, tree, tree,
					     bool *, int);
extern bool tree_single_nonnegative_warnv_p (tree, bool *, int);
extern bool tree_call_nonnegative_warnv_p (ttype_p, combined_fn, tree, tree,
					   bool *, int);
...
extern bool fold_real_zero_addition_p (const ttype_p, const_tree, int);
...
extern tree make_range_step (location_t, enum tree_code, tree, tree, ttype_p,
			     tree *, tree *, int *, bool *);
extern tree build_range_check (location_t, ttype_p, tree, int, tree, tree);
extern bool merge_ranges (int *, tree *, tree *, int, tree, tree, int,
			  tree, tree);
extern tree sign_bit_p (tree, const_tree);
extern tree exact_inverse (ttype_p, tree);
extern tree const_unop (enum tree_code, ttype_p, tree);
extern tree const_binop (enum tree_code, ttype_p, tree, tree);
