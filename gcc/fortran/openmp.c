...
/* OpenACC 2.0 clauses. */
#define OMP_CLAUSE_ASYNC                (1 << 25)
#define OMP_CLAUSE_NUM_GANGS            (1 << 26)
#define OMP_CLAUSE_NUM_WORKERS          (1 << 27)
#define OMP_CLAUSE_VECTOR_LENGTH        (1 << 28)
#define OMP_CLAUSE_COPY                 (1 << 29)
#define OMP_CLAUSE_COPYOUT              (1 << 30)
#define OMP_CLAUSE_CREATE               (1 << 31)
#define OMP_CLAUSE_PRESENT              (1LL << 32)
#define OMP_CLAUSE_PRESENT_OR_COPY      (1LL << 33)
#define OMP_CLAUSE_PRESENT_OR_COPYIN    (1LL << 34)
#define OMP_CLAUSE_PRESENT_OR_COPYOUT   (1LL << 35)
#define OMP_CLAUSE_PRESENT_OR_CREATE    (1LL << 36)
#define OMP_CLAUSE_DEVICEPTR            (1LL << 37)
#define OMP_CLAUSE_GANG                 (1LL << 38)
#define OMP_CLAUSE_WORKER               (1LL << 39)
#define OMP_CLAUSE_VECTOR               (1LL << 40)
#define OMP_CLAUSE_SEQ                  (1LL << 41)
#define OMP_CLAUSE_INDEPENDENT          (1LL << 42)
#define OMP_CLAUSE_USE_DEVICE           (1LL << 43)
#define OMP_CLAUSE_DEVICE_RESIDENT      (1LL << 44)
#define OMP_CLAUSE_HOST                 (1LL << 45)
#define OMP_CLAUSE_DEVICE               (1LL << 46)
#define OMP_CLAUSE_OACC_COPYIN          (1LL << 47)
#define OMP_CLAUSE_WAIT                 (1LL << 48)
#define OMP_CLAUSE_DELETE               (1LL << 49)
#define OMP_CLAUSE_AUTO                 (1LL << 50)
#define OMP_CLAUSE_TILE                 (1LL << 51)

/* Match OpenMP and OpenACC directive clauses. MASK is a bitmask of
   clauses that are allowed for a particular directive.  */

static match
gfc_match_omp_clauses (gfc_omp_clauses **cp, long long mask, bool first = true,
