...
open_base_files (void)
{
  ...
  /* gtype-desc.c is a little special, so we create it here.  */
  {
    ...
    static const char *const ifiles[] = {
      ...
      "tree.h", "rtl.h", "wide-int.h", "hash-set.h", "vec.h", "machmode.h",
      "tm.h", "hard-reg-set.h", "input.h", "function.h", "insn-config.h",
      "expr.h", "predict.h", "basic-block.h", "cselib.h", "insn-addr.h",
