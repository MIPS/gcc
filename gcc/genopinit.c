...
{ "sext_optab->handlers[$B][$A].insn_code = CODE_FOR_$(extend$a$b2$)",
  ...
  "ssmadd_widen_optab->handlers[$B].insn_code = CODE_FOR_$(ssmadd$a$b4$)$N",
  "usmadd_widen_optab->handlers[$B].insn_code = CODE_FOR_$(usmadd$a$b4$)$N",
  ...
  "ssmsub_widen_optab->handlers[$B].insn_code = CODE_FOR_$(ssmsub$a$b4$)$N",
  "usmsub_widen_optab->handlers[$B].insn_code = CODE_FOR_$(usmsub$a$b4$)$N",
