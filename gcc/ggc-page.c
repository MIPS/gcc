...
/* Bound `allocated_last_gc' to 4MB or 8MB (for 64bit systems), to prevent
   the memory expansion test from triggering too often when the heap
   is small.  */
#define GGC_MIN_LAST_ALLOCATED ((HOST_BITS_PER_WIDE_INT / 32) * 1024 * 1024)
