...
class integer_cst_desc : public constant_desc
{
  ...
  public:
    unsigned char nunits () const;
    unsigned char ext_nunits () const;
    unsigned char offset_nunits () const;
    unsigned HOST_WIDE_INT low () const;
    unsigned HOST_WIDE_INT operator[] (unsigned i) const;
    const HOST_WIDE_INT *addr (unsigned i) const;
};
