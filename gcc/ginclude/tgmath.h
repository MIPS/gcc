...
#define fdim(x)          __TGMATH_REAL(x, fdim)
...
#define hypot(x,y)       __TGMATH_REAL(x, y, hypot)
...
#define nexttoward(x,y)  __TGMATH_REAL_1_2(x, nexttoward)
#define remainder(x,y)   __TGMATH_REAL(x, y, remainder)
