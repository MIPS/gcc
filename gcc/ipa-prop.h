...
void ipa_add_method (ipa_methodlist_p *, ipa_method);
ipa_method ipa_remove_method (ipa_methodlist_p *);

/* ipa_callsite interface.  */
inline int ipa_callsite_param_count (ipa_callsite);
inline void ipa_callsite_param_count_set (ipa_callsite, int);
inline struct ipa_jump_func *ipa_callsite_param (ipa_callsite, int);
inline ipa_method ipa_callsite_callee (ipa_callsite);
void ipa_callsite_compute_param (ipa_callsite);
void ipa_callsite_compute_count (ipa_callsite);

/* ipa_method interface.  */
inline int ipa_method_formal_count (ipa_method);
inline void ipa_method_formal_count_set (ipa_method, int);
inline tree ipa_method_get_tree (ipa_method, int);
void ipa_method_compute_tree_map (ipa_method);
void ipa_method_formal_compute_count (ipa_method);
void ipa_method_compute_modify (ipa_method);
...
inline void ipa_node_create (ipa_method);
void ipa_free (void);
