...
java_init_decl_processing (void)
{
 ...
 #error "unsupported size"
  ...
  t = tree_cons (NULL_TREE, class_ptr_type, endlink);
  init_object_node = add_builtin_function ("_Jv_InitObject",
					   build_function_type (ptr_type_node, t),
					   0, NOT_BUILT_IN, NULL, NULL_TREE);
  ...
  init_no_finalizer_node = 
    add_builtin_function ("_Jv_InitObjectNoFinalizer",
  ...
  soft_initclass_node = 
    add_builtin_function ("_Jv_InitClass", 
			  build_function_type (void_type_node, t), 0,
  ...
  t = tree_cons (NULL_TREE, ptr_type_node, 
		 tree_cons (NULL_TREE, int_type_node, endlink));
  init_newarray_node
      = add_builtin_function ("_Jv_InitPrimArray",
			      build_function_type (ptr_type_node, t),
			      0, NOT_BUILT_IN, NULL, NULL_TREE);
  ...
  t = tree_cons (NULL_TREE, int_type_node,
		 tree_cons (NULL_TREE, class_ptr_type,
			    tree_cons (NULL_TREE, object_ptr_type_node,
				       endlink)));
  init_anewarray_node = 
    add_builtin_function ("_Jv_InitObjectArray",
			  build_function_type (ptr_type_node, t),
			  0, NOT_BUILT_IN, NULL, NULL_TREE);
  ...
  init_multianewarray_node
      = add_builtin_function ("_Jv_InitMultiArray",
			      build_function_type (ptr_type_node, t),
			      0, NOT_BUILT_IN, NULL, NULL_TREE);
