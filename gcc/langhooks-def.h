...
#define LANG_HOOKS_USES_CONDITIONAL_SYMTAB false
#define LANG_HOOKS_INIT_OUTPUT_FRAGMENT lhd_do_nothing
#define LANG_HOOKS_CREATE_OUTPUT_FRAGMENT lhd_do_nothing
#define LANG_HOOKS_END_OUTPUT_FRAGMENT lhd_do_nothing
...
#define LANG_HOOKS_INITIALIZER { \
  ...
  LANG_HOOKS_USES_CONDITIONAL_SYMTAB, \
  LANG_HOOKS_INIT_OUTPUT_FRAGMENT, \
  LANG_HOOKS_CREATE_OUTPUT_FRAGMENT, \
  LANG_HOOKS_END_OUTPUT_FRAGMENT \
}
