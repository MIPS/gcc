...
#define LANG_HOOKS_BUILTIN_FUNCTION_GLOBAL_MD	LANG_HOOKS_BUILTIN_FUNCTION
...
#define LANG_HOOKS_BUILD_ENUM		NULL
...
#define LANG_HOOKS_INITIALIZER { \
  ...
  LANG_HOOKS_BUILTIN_FUNCTION_GLOBAL_MD, \
  LANG_HOOKS_INIT_TS,          \
