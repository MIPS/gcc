...
extern tree lhd_return_null_const_ttype (const ttype_p);
...
#define LANG_HOOKS_GENERIC_TYPE_P	hook_bool_const_ttype_false
...
#define LANG_HOOKS_TYPE_MAX_SIZE	lhd_return_null_const_ttype
