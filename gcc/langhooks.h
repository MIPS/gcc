...
struct lang_hooks_for_types
{
  ...
  tree (*build_enum) (location_t, const char *, vec<string_int_pair>);
...
struct lang_hooks
{
  ...
  tree (*builtin_function_global_md) (tree decl);
...
extern tree add_builtin_function_ext_scope (const char *name, tree type,
					    ...
					    const char *library_name,
					    tree attrs);
extern tree add_builtin_function_global_md (location_t, const char *, tree,
					    int, const char *, tree);
