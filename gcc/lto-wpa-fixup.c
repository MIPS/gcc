...
static void
output_wpa_fixup (cgraph_node_set set)
{
...
static void
input_wpa_fixup_1 (struct lto_file_decl_data *file_data,
...
input_wpa_fixup (void)
{
  ...
  while ((file_data = file_data_vec[i++]))
	...
	= lto_create_simple_input_block (file_data, LTO_section_wpa_fixup,
      ...
      input_wpa_fixup_1 (file_data, ib);
...
struct ipa_opt_pass pass_ipa_lto_wpa_fixup =
{
 ...
 output_wpa_fixup,			/* write_summary */
 input_wpa_fixup,			/* read_summary */
