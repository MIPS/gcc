...
#@#@#
#@#@# It has been AutoGen-ed  October  2, 2013 at 10:49:38 AM by AutoGen 5.18
...
if [ ! -f $meltcheckruntime_stamp -o $meltcheckruntime_stamp -ot "$GCCMELT_RUNTIME_ARGS" \
	...
	if [ -n "$MELTGCCBUILTIN_BUILD_WITH_CXX" ]; then
		...
		|| meltbuild_error melt-build-script.tpl:755/659 failed  $GCCMELT_CC1 with arguments @$meltcheckruntime_args
	fi
