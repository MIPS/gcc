...
#@#@#
#@#@# It has been AutoGen-ed  September 24, 2013 at 12:12:22 PM by AutoGen 5.18
...
################################################################
#@ melt-build-script.tpl:550/505 making the meltbuild-common.args file to make life easier
# I would often use that meltbuild-common.args for testing, etc.
meltcommon_args=meltbuild-common.args
meltbuild_info melt-build-script.tpl:553/506 making $meltcommon_args
meltcommon_argstemp=$meltcommon_args-tmp$$
echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:555/507"' > $meltcommon_argstemp
...
meltbuild_info melt-build-script.tpl:564/508 $meltcommon_args is
cat $meltcommon_args < /dev/null >&2


################
### the warmelt modules lists  melt-build-script.tpl:569/509
...
if [ ! -f meltbuild-sources/warmelt.quicklybuilt.modlis \
  ...
  #  melt-build-script.tpl:573/510 warmelt module list quicklybuilt
...
if [ ! -f meltbuild-sources/warmelt.optimized.modlis \
  ...
  #  melt-build-script.tpl:573/511 warmelt module list optimized
...
if [ ! -f meltbuild-sources/warmelt.debugnoline.modlis \
  ...
  #  melt-build-script.tpl:573/512 warmelt module list debugnoline
...
################################################################
#@ melt-build-script.tpl:584/513
if [ "$melt_overall_goal" = "translator" ]; then
    meltbuild_info melt-build-script.tpl:586/514 done translation overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

################
#@ melt-build-script.tpl:591/515 before application xtramelt* modules
################################################################
meltbuild_info melt-build-script.tpl:593/516 before applications GCCMELT_SKIPEMITC=$GCCMELT_SKIPEMITC.

meltbuild_info melt-build-script.tpl:595/517 times before applications at `date '+%x %H:%M:%S'`: ;  times >&2
 
melt_final_application_stamp=meltbuild-final-application.stamp

function meltbuild_do_applications () {
meltbuild_notice 'doing applications'  melt-build-script.tpl:600/518 doing applications 



  ## meltbuild_do_applications xtramelt-ana-base melt-build-script.tpl:604/519
  ...
  ## meltbuild_do_applications xtramelt-ana-base melt-build-script.tpl:608/520
  if [ ! -f meltbuild-sources/xtramelt-ana-base.cc -o  ! -f meltbuild-sources/xtramelt-ana-base+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:614/521 emit application C code for xtramelt-ana-base
      meltbuild_emit melt-build-script.tpl:615/522 \
	  translatefile \
	  xtramelt-ana-base \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:622/523 failed to generate C code of application xtramelt-ana-base
  else
      meltbuild_info melt-build-script.tpl:624/524 DONT emit application C code for xtramelt-ana-base
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-base.meltmod-$meltapp_ANA_BASE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:632/525 compiling application module for xtramelt-ana-base quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/526 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:641/527 in meltbuild-modules failed to compile application xtramelt-ana-base quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/528 not compiling application module for xtramelt-ana-base quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-base.meltmod-$meltapp_ANA_BASE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:632/529 compiling application module for xtramelt-ana-base optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/530 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-base \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-base \
	  || meltbuild_error  melt-build-script.tpl:641/531 in meltbuild-modules failed to compile application xtramelt-ana-base optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/532 not compiling application module for xtramelt-ana-base optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-base.meltmod-$meltapp_ANA_BASE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:632/533 compiling application module for xtramelt-ana-base debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/534 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-base \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-base \
	  || meltbuild_error  melt-build-script.tpl:641/535 in meltbuild-modules failed to compile application xtramelt-ana-base debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/536 not compiling application module for xtramelt-ana-base debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-ana-tree melt-build-script.tpl:604/537
  ...
  ## meltbuild_do_applications xtramelt-ana-tree melt-build-script.tpl:608/538
 ...
 -o meltbuild-sources/xtramelt-ana-base+meltdesc.c -ot meltbuild-sources/xtramelt-ana-tree+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:614/539 emit application C code for xtramelt-ana-tree
      meltbuild_emit melt-build-script.tpl:615/540 \
	  translatefile \
	  xtramelt-ana-tree \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:622/541 failed to generate C code of application xtramelt-ana-tree
  else
      meltbuild_info melt-build-script.tpl:624/542 DONT emit application C code for xtramelt-ana-tree
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-tree.meltmod-$meltapp_ANA_TREE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:632/543 compiling application module for xtramelt-ana-tree quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/544 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:641/545 in meltbuild-modules failed to compile application xtramelt-ana-tree quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/546 not compiling application module for xtramelt-ana-tree quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-tree.meltmod-$meltapp_ANA_TREE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:632/547 compiling application module for xtramelt-ana-tree optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/548 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-tree \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-tree \
	  || meltbuild_error  melt-build-script.tpl:641/549 in meltbuild-modules failed to compile application xtramelt-ana-tree optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/550 not compiling application module for xtramelt-ana-tree optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-tree.meltmod-$meltapp_ANA_TREE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:632/551 compiling application module for xtramelt-ana-tree debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/552 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-tree \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-tree \
	  || meltbuild_error  melt-build-script.tpl:641/553 in meltbuild-modules failed to compile application xtramelt-ana-tree debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/554 not compiling application module for xtramelt-ana-tree debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-ana-gimple melt-build-script.tpl:604/555
  ...
  ## meltbuild_do_applications xtramelt-ana-gimple melt-build-script.tpl:608/556
 ...
 -o meltbuild-sources/xtramelt-ana-tree+meltdesc.c -ot meltbuild-sources/xtramelt-ana-gimple+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:614/557 emit application C code for xtramelt-ana-gimple
      meltbuild_emit melt-build-script.tpl:615/558 \
	  translatefile \
	  xtramelt-ana-gimple \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:622/559 failed to generate C code of application xtramelt-ana-gimple
  else
      meltbuild_info melt-build-script.tpl:624/560 DONT emit application C code for xtramelt-ana-gimple
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-gimple.meltmod-$meltapp_ANA_GIMPLE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:632/561 compiling application module for xtramelt-ana-gimple quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/562 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:641/563 in meltbuild-modules failed to compile application xtramelt-ana-gimple quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/564 not compiling application module for xtramelt-ana-gimple quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-gimple.meltmod-$meltapp_ANA_GIMPLE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:632/565 compiling application module for xtramelt-ana-gimple optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/566 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-gimple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-gimple \
	  || meltbuild_error  melt-build-script.tpl:641/567 in meltbuild-modules failed to compile application xtramelt-ana-gimple optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/568 not compiling application module for xtramelt-ana-gimple optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-gimple.meltmod-$meltapp_ANA_GIMPLE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:632/569 compiling application module for xtramelt-ana-gimple debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/570 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-gimple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-gimple \
	  || meltbuild_error  melt-build-script.tpl:641/571 in meltbuild-modules failed to compile application xtramelt-ana-gimple debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/572 not compiling application module for xtramelt-ana-gimple debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-probe melt-build-script.tpl:604/573
  ...
  ## meltbuild_do_applications xtramelt-probe melt-build-script.tpl:608/574
 ...
 -o meltbuild-sources/xtramelt-ana-gimple+meltdesc.c -ot meltbuild-sources/xtramelt-probe+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:614/575 emit application C code for xtramelt-probe
      meltbuild_emit melt-build-script.tpl:615/576 \
	  translatefile \
	  xtramelt-probe \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:622/577 failed to generate C code of application xtramelt-probe
  else
      meltbuild_info melt-build-script.tpl:624/578 DONT emit application C code for xtramelt-probe
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltapp_PROBE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:632/579 compiling application module for xtramelt-probe quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/580 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:641/581 in meltbuild-modules failed to compile application xtramelt-probe quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/582 not compiling application module for xtramelt-probe quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltapp_PROBE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:632/583 compiling application module for xtramelt-probe optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/584 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
	  || meltbuild_error  melt-build-script.tpl:641/585 in meltbuild-modules failed to compile application xtramelt-probe optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/586 not compiling application module for xtramelt-probe optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltapp_PROBE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:632/587 compiling application module for xtramelt-probe debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/588 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
	  || meltbuild_error  melt-build-script.tpl:641/589 in meltbuild-modules failed to compile application xtramelt-probe debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/590 not compiling application module for xtramelt-probe debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-ana-simple melt-build-script.tpl:604/591
  ...
  ## meltbuild_do_applications xtramelt-ana-simple melt-build-script.tpl:608/592
 ...
 -o meltbuild-sources/xtramelt-probe+meltdesc.c -ot meltbuild-sources/xtramelt-ana-simple+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:614/593 emit application C code for xtramelt-ana-simple
      meltbuild_emit melt-build-script.tpl:615/594 \
	  translatefile \
	  xtramelt-ana-simple \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:622/595 failed to generate C code of application xtramelt-ana-simple
  else
      meltbuild_info melt-build-script.tpl:624/596 DONT emit application C code for xtramelt-ana-simple
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltapp_ANA_SIMPLE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:632/597 compiling application module for xtramelt-ana-simple quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/598 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:641/599 in meltbuild-modules failed to compile application xtramelt-ana-simple quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/600 not compiling application module for xtramelt-ana-simple quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltapp_ANA_SIMPLE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:632/601 compiling application module for xtramelt-ana-simple optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/602 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
	  || meltbuild_error  melt-build-script.tpl:641/603 in meltbuild-modules failed to compile application xtramelt-ana-simple optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/604 not compiling application module for xtramelt-ana-simple optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltapp_ANA_SIMPLE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:632/605 compiling application module for xtramelt-ana-simple debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/606 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
	  || meltbuild_error  melt-build-script.tpl:641/607 in meltbuild-modules failed to compile application xtramelt-ana-simple debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/608 not compiling application module for xtramelt-ana-simple debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-c-generator melt-build-script.tpl:604/609
  ...
  ## meltbuild_do_applications xtramelt-c-generator melt-build-script.tpl:608/610
 ...
 -o meltbuild-sources/xtramelt-ana-simple+meltdesc.c -ot meltbuild-sources/xtramelt-c-generator+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:614/611 emit application C code for xtramelt-c-generator
      meltbuild_emit melt-build-script.tpl:615/612 \
	  translatefile \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:622/613 failed to generate C code of application xtramelt-c-generator
  else
      meltbuild_info melt-build-script.tpl:624/614 DONT emit application C code for xtramelt-c-generator
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-c-generator.meltmod-$meltapp_C_GENERATOR_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:632/615 compiling application module for xtramelt-c-generator quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/616 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:641/617 in meltbuild-modules failed to compile application xtramelt-c-generator quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/618 not compiling application module for xtramelt-c-generator quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-c-generator.meltmod-$meltapp_C_GENERATOR_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:632/619 compiling application module for xtramelt-c-generator optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/620 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-c-generator \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-c-generator \
	  || meltbuild_error  melt-build-script.tpl:641/621 in meltbuild-modules failed to compile application xtramelt-c-generator optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/622 not compiling application module for xtramelt-c-generator optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-c-generator.meltmod-$meltapp_C_GENERATOR_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:632/623 compiling application module for xtramelt-c-generator debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/624 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-c-generator \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-c-generator \
	  || meltbuild_error  melt-build-script.tpl:641/625 in meltbuild-modules failed to compile application xtramelt-c-generator debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/626 not compiling application module for xtramelt-c-generator debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-opengpu melt-build-script.tpl:604/627
  ...
  ## meltbuild_do_applications xtramelt-opengpu melt-build-script.tpl:608/628
 ...
 -o meltbuild-sources/xtramelt-c-generator+meltdesc.c -ot meltbuild-sources/xtramelt-opengpu+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:614/629 emit application C code for xtramelt-opengpu
      meltbuild_emit melt-build-script.tpl:615/630 \
	  translatefile \
	  xtramelt-opengpu \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:622/631 failed to generate C code of application xtramelt-opengpu
  else
      meltbuild_info melt-build-script.tpl:624/632 DONT emit application C code for xtramelt-opengpu
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-opengpu.meltmod-$meltapp_OPENGPU_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:632/633 compiling application module for xtramelt-opengpu quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/634 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:641/635 in meltbuild-modules failed to compile application xtramelt-opengpu quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/636 not compiling application module for xtramelt-opengpu quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-opengpu.meltmod-$meltapp_OPENGPU_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:632/637 compiling application module for xtramelt-opengpu optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/638 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-opengpu \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-opengpu \
	  || meltbuild_error  melt-build-script.tpl:641/639 in meltbuild-modules failed to compile application xtramelt-opengpu optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/640 not compiling application module for xtramelt-opengpu optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-opengpu.meltmod-$meltapp_OPENGPU_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:632/641 compiling application module for xtramelt-opengpu debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/642 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-opengpu \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-opengpu \
	  || meltbuild_error  melt-build-script.tpl:641/643 in meltbuild-modules failed to compile application xtramelt-opengpu debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/644 not compiling application module for xtramelt-opengpu debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-playground melt-build-script.tpl:604/645
  ...
  ## meltbuild_do_applications xtramelt-playground melt-build-script.tpl:608/646
 ...
 -o meltbuild-sources/xtramelt-opengpu+meltdesc.c -ot meltbuild-sources/xtramelt-playground+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:614/647 emit application C code for xtramelt-playground
      meltbuild_emit melt-build-script.tpl:615/648 \
	  translatefile \
	  xtramelt-playground \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:622/649 failed to generate C code of application xtramelt-playground
  else
      meltbuild_info melt-build-script.tpl:624/650 DONT emit application C code for xtramelt-playground
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltapp_PLAYGROUND_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:632/651 compiling application module for xtramelt-playground quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/652 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:641/653 in meltbuild-modules failed to compile application xtramelt-playground quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/654 not compiling application module for xtramelt-playground quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltapp_PLAYGROUND_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:632/655 compiling application module for xtramelt-playground optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/656 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
	  || meltbuild_error  melt-build-script.tpl:641/657 in meltbuild-modules failed to compile application xtramelt-playground optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/658 not compiling application module for xtramelt-playground optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltapp_PLAYGROUND_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:632/659 compiling application module for xtramelt-playground debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:634/660 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
	  || meltbuild_error  melt-build-script.tpl:641/661 in meltbuild-modules failed to compile application xtramelt-playground debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:643/662 not compiling application module for xtramelt-playground debugnoline
  fi
 

  ## meltbuild_do_applications  melt-build-script.tpl:647/663
...
meltbuild_info melt-build-script.tpl:660/664 times after applications at `date '+%x %H:%M:%S'`: ;  times >&2
} ## end meltbuild_do_applications  melt-build-script.tpl:661/665
...
if [ ! -f  "$melt_final_application_stamp" \
 ...
 -o "$melt_final_application_stamp" -ot "$GCCMELT_MELTSOURCEDIR/xtramelt-playground.melt" \
    ...
    meltbuild_info melt-build-script.tpl:667/666 building MELT applications
    meltbuild_do_applications
else
    meltbuild_info melt-build-script.tpl:670/667 not building MELT applications because of applstamp  "$melt_final_application_stamp"
fi

################################################################
#@ melt-build-script.tpl:674/668
if [ "$melt_overall_goal" = "applications" ]; then
    meltbuild_info melt-build-script.tpl:676/669 done applications overall goal with stamp  $melt_final_translator_stamp
    meltbuild_notice 'Done applications' melt-build-script.tpl:677/670 applications overall goal 
    exit 0
fi
################################################################
################################################################
### the modules lists melt-build-script.tpl:682/671
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis" \
  ...
  #  melt-build-script.tpl:687/672 module list quicklybuilt
  meltbuild_info  melt-build-script.tpl:688/673 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:702/675 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" \
  ...
  #  melt-build-script.tpl:687/676 module list optimized
  meltbuild_info  melt-build-script.tpl:688/677 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:702/679 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" \
  ...
  #  melt-build-script.tpl:687/680 module list debugnoline
  meltbuild_info  melt-build-script.tpl:688/681 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:702/683 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"  
fi


#@ melt-build-script.tpl:706/684
...
################################################################
#@ melt-build-script.tpl:712/685 module lists
if [ "$melt_overall_goal" = "modlists" ]; then
    meltbuild_info melt-build-script.tpl:714/686 done modlists overall goal with stamp  $melt_final_application_stamp
    exit 0
fi
...
################################################################
#@ melt-build-script.tpl:722/687 runtime self check

##  melt-build-script.tpl:724/688 FIXME: should skip that when cross-compiler MELT plugin..
...
if [ ! -f $meltcheckruntime_stamp -o $meltcheckruntime_stamp -ot "$GCCMELT_RUNTIME_ARGS" \
    ...
    #@ melt-build-script.tpl:730/689 checkruntime
    if [ -f melt-no-check-runtime -o -n "$MELTGCC_NO_CHECK_RUNTIME" -o ! -f melt-runtime.i ]; then
	meltbuild_info melt-build-script.tpl:732/690 skipping check of MELT runtime
    else
	meltcheckruntime_args=meltbuild-checkruntime.args 
	meltcheckruntime_argstemp=$meltcheckruntime_args-tmp$$
	echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:736/691"' ' -DGCCMELT_CHECKMELTRUNTIME' > $meltcheckruntime_argstemp
	...
	[ -f "$meltcheckruntime_args" ] || meltbuild_error  melt-build-script.tpl:747/692 missing check runtime args  "$meltcheckruntime_args"
	meltbuild_info melt-build-script.tpl:748/693 $meltcheckruntime_args  is
	...
	if [ -n "$MELTGCCBUILTIN_BUILD_WITH_CXX" ]; then
		...
		|| meltbuild_error melt-build-script.tpl:752/694 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	else
	    $GCCMELT_CC1_PREFIX $GCCMELT_CC1 @$meltcheckruntime_args \
		|| meltbuild_error melt-build-script.tpl:755/695 failed  $GCCMELT_CC1 with arguments @$meltcheckruntime_args
	fi
	meltbuild_info melt-build-script.tpl:757/696 done check runtime with $meltcheckruntime_args
    fi

   #@ melt-build-script.tpl:760/697 checkhello
    meltcheckhelloworld_args=meltbuild-checkhelloworld.args 
    meltcheckhelloworld_argstemp=$meltcheckhelloworld_args-tmp$$
    echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:763/698"' > $meltcheckhelloworld_argstemp
    ...
    [ -f "$meltcheckhelloworld_args" ] || meltbuild_error  melt-build-script.tpl:777/699 missing check helloworld args  "$meltcheckhelloworld_args"
   meltbuild_info melt-build-script.tpl:778/700 $meltcheckhelloworld_args  is
   cat $meltcheckhelloworld_args < /dev/null >&2
    $GCCMELT_CC1_PREFIX $GCCMELT_CC1 @$meltcheckhelloworld_args \
	|| meltbuild_error melt-build-script.tpl:781/701 running helloworld failed with arguments @$meltcheckhelloworld_args
   meltbuild_info melt-build-script.tpl:782/702 done check helloworld with $meltcheckhelloworld_args
   #@ melt-build-script.tpl:783/703 runtime stamp
    meltcheckruntime_stamptemp=$meltcheckruntime_stamp-tmp$$
    [ -f "$GCCMELT_RUNTIME_C" ] || meltbuild_error melt-build-script.tpl:785/704 missing MELT runtime C file $GCCMELT_RUNTIME_C
    ...
    [ -f "$melt_final_translator_stamp" ] || meltbuild_error melt-build-script.tpl:790/705 missing final translator stamp "$melt_final_translator_stamp"
    [ -f "$melt_final_application_stamp" ] || meltbuild_error melt-build-script.tpl:791/706 missing final application stamp "$melt_final_application_stamp"
    ...
    meltbuild_info melt-build-script.tpl:795/707 done check runtime  $meltcheckruntime_stamp
else
    meltbuild_info melt-build-script.tpl:797/708 keeping runtime checks  $meltcheckruntime_stamp
fi

if [ "$melt_overall_goal" = "checkruntime" ]; then
    meltbuild_info melt-build-script.tpl:801/709 done checkruntime overall goal with stamp  $meltcheckruntime_stamp
    exit 0
fi
################################################################
################################################################
#@ melt-build-script.tpl:806/710
if [ "$melt_overall_goal" = "regenerate" ]; then
    meltbuild_notice regenerating runtime support melt-build-script.tpl:808/711 
    ...
    echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:812/712"' > $meltregen_argstemp
   ...
   meltbuild_info melt-build-script.tpl:822/713 $meltregen_args  is
   cat $meltregen_args < /dev/null >&2
    $GCCMELT_CC1_PREFIX $GCCMELT_CC1 @$meltregen_args \
	|| meltbuild_error melt-build-script.tpl:825/714 failed with arguments @$meltregen_args
    meltbuild_info melt-build-script.tpl:826/715 done regenerate overall goal
    exit 0
fi

################################################################
################################################################
### the generated documentation meltgendoc.texi melt-build-script.tpl:832/716
...
if [   ! -f meltgendoc.texi  -o meltbuild-sources/warmelt-first.melt -nt meltgendoc.texi  \
 ...
 -o meltbuild-sources/xtramelt-playground.melt -nt meltgendoc.texi   ]; then
   meltbuild_info melt-build-script.tpl:836/717 generating meltgendoc.texi
   meltgen_args=meltbuild-gendoc.args-tmp$$
   echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:838/718"' > $meltgen_args
...
meltbuild_arg "module-makefile=\"$GCCMELT_MODULE_MK\""  >>  $meltgen_args
   ...
   meltbuild_info melt-build-script.tpl:852/719  meltbuild-gendoc.args is
   cat meltbuild-gendoc.args < /dev/null >&2
   $GCCMELT_CC1_PREFIX $GCCMELT_CC1 @meltbuild-gendoc.args \
     || meltbuild_error melt-build-script.tpl:855/720 failed with arguments @meltbuild-gendoc.args
else
   meltbuild_info melt-build-script.tpl:857/721 keeping meltgendoc.texi
fi

################
meltbuild_info melt-build-script.tpl:861/722 successfully done with times at `date '+%x %H:%M:%S'`: ; times >&2

################################################################
#@ melt-build-script.tpl:864/723
if [ "$melt_overall_goal" = "gendoc" ]; then
    meltbuild_info melt-build-script.tpl:866/724 done gendoc overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

## #@ melt-build-script.tpl:870/725 if we get here something is wrong in this script
meltbuild_error  melt-build-script.tpl:871/726 unexpected MELT overall goal "$melt_overall_goal" buggy melt-build-script.tpl
#@ eof melt-build-script.tpl:872/727 end of generated melt-build-script.sh
