...
#@#@#
#@#@# It has been AutoGen-ed  October 19, 2013 at 09:11:53 AM by AutoGen 5.18.1
...
meltbuild_notice 'doing applications'  melt-build-script.tpl:616/584 doing applications 
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-base.meltmod-$meltapp_ANA_BASE_cumulmd5.quicklybuilt.so \
	  ...
	  || meltbuild_error  melt-build-script.tpl:657/593 in meltbuild-modules failed to compile application xtramelt-ana-base quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/594 not compiling application module for xtramelt-ana-base quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-base.meltmod-$meltapp_ANA_BASE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:648/595 compiling application module for xtramelt-ana-base optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:650/596 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-base \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-base \
	  || meltbuild_error  melt-build-script.tpl:657/597 in meltbuild-modules failed to compile application xtramelt-ana-base optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/598 not compiling application module for xtramelt-ana-base optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-base.meltmod-$meltapp_ANA_BASE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:648/599 compiling application module for xtramelt-ana-base debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  ...
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-base \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-base \
	  || meltbuild_error  melt-build-script.tpl:657/601 in meltbuild-modules failed to compile application xtramelt-ana-base debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/602 not compiling application module for xtramelt-ana-base debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-ana-tree melt-build-script.tpl:620/603
  ...
  ## meltbuild_do_applications xtramelt-ana-tree melt-build-script.tpl:624/604
 ...
 -o meltbuild-sources/xtramelt-ana-base+meltdesc.c -ot meltbuild-sources/xtramelt-ana-tree+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:630/605 emit application C code for xtramelt-ana-tree
      meltbuild_emit melt-build-script.tpl:631/606 \
	  translatefile \
	  xtramelt-ana-tree \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:638/607 failed to generate C code of application xtramelt-ana-tree
  else
      meltbuild_info melt-build-script.tpl:640/608 DONT emit application C code for xtramelt-ana-tree
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-tree.meltmod-$meltapp_ANA_TREE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:648/609 compiling application module for xtramelt-ana-tree quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:650/610 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:657/611 in meltbuild-modules failed to compile application xtramelt-ana-tree quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/612 not compiling application module for xtramelt-ana-tree quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-tree.meltmod-$meltapp_ANA_TREE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:648/613 compiling application module for xtramelt-ana-tree optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:650/614 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-tree \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-tree \
	  || meltbuild_error  melt-build-script.tpl:657/615 in meltbuild-modules failed to compile application xtramelt-ana-tree optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/616 not compiling application module for xtramelt-ana-tree optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-tree.meltmod-$meltapp_ANA_TREE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:648/617 compiling application module for xtramelt-ana-tree debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  ...
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-tree \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-tree \
	  || meltbuild_error  melt-build-script.tpl:657/619 in meltbuild-modules failed to compile application xtramelt-ana-tree debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/620 not compiling application module for xtramelt-ana-tree debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-ana-gimple melt-build-script.tpl:620/621
  ...
  ## meltbuild_do_applications xtramelt-ana-gimple melt-build-script.tpl:624/622
 ...
 -o meltbuild-sources/xtramelt-ana-tree+meltdesc.c -ot meltbuild-sources/xtramelt-ana-gimple+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:630/623 emit application C code for xtramelt-ana-gimple
      meltbuild_emit melt-build-script.tpl:631/624 \
	  translatefile \
	  xtramelt-ana-gimple \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:638/625 failed to generate C code of application xtramelt-ana-gimple
  else
      meltbuild_info melt-build-script.tpl:640/626 DONT emit application C code for xtramelt-ana-gimple
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-gimple.meltmod-$meltapp_ANA_GIMPLE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:648/627 compiling application module for xtramelt-ana-gimple quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  ...
	  || meltbuild_error  melt-build-script.tpl:657/629 in meltbuild-modules failed to compile application xtramelt-ana-gimple quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/630 not compiling application module for xtramelt-ana-gimple quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-gimple.meltmod-$meltapp_ANA_GIMPLE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:648/631 compiling application module for xtramelt-ana-gimple optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:650/632 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-gimple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-gimple \
	  || meltbuild_error  melt-build-script.tpl:657/633 in meltbuild-modules failed to compile application xtramelt-ana-gimple optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/634 not compiling application module for xtramelt-ana-gimple optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-gimple.meltmod-$meltapp_ANA_GIMPLE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:648/635 compiling application module for xtramelt-ana-gimple debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  ...
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-gimple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-gimple \
	  || meltbuild_error  melt-build-script.tpl:657/637 in meltbuild-modules failed to compile application xtramelt-ana-gimple debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/638 not compiling application module for xtramelt-ana-gimple debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-probe melt-build-script.tpl:620/639
  ...
  ## meltbuild_do_applications xtramelt-probe melt-build-script.tpl:624/640
 ...
 -o meltbuild-sources/xtramelt-ana-gimple+meltdesc.c -ot meltbuild-sources/xtramelt-probe+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:630/641 emit application C code for xtramelt-probe
      meltbuild_emit melt-build-script.tpl:631/642 \
	  translatefile \
	  xtramelt-probe \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:638/643 failed to generate C code of application xtramelt-probe
  else
      meltbuild_info melt-build-script.tpl:640/644 DONT emit application C code for xtramelt-probe
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltapp_PROBE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:648/645 compiling application module for xtramelt-probe quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  ...
	  || meltbuild_error  melt-build-script.tpl:657/647 in meltbuild-modules failed to compile application xtramelt-probe quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/648 not compiling application module for xtramelt-probe quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltapp_PROBE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:648/649 compiling application module for xtramelt-probe optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:650/650 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
	  || meltbuild_error  melt-build-script.tpl:657/651 in meltbuild-modules failed to compile application xtramelt-probe optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/652 not compiling application module for xtramelt-probe optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltapp_PROBE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:648/653 compiling application module for xtramelt-probe debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:650/654 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
	  || meltbuild_error  melt-build-script.tpl:657/655 in meltbuild-modules failed to compile application xtramelt-probe debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/656 not compiling application module for xtramelt-probe debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-ana-simple melt-build-script.tpl:620/657
  ...
  ## meltbuild_do_applications xtramelt-ana-simple melt-build-script.tpl:624/658
 ...
 -o meltbuild-sources/xtramelt-probe+meltdesc.c -ot meltbuild-sources/xtramelt-ana-simple+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:630/659 emit application C code for xtramelt-ana-simple
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:638/661 failed to generate C code of application xtramelt-ana-simple
  else
      meltbuild_info melt-build-script.tpl:640/662 DONT emit application C code for xtramelt-ana-simple
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltapp_ANA_SIMPLE_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:648/663 compiling application module for xtramelt-ana-simple quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  ...
	  || meltbuild_error  melt-build-script.tpl:657/665 in meltbuild-modules failed to compile application xtramelt-ana-simple quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/666 not compiling application module for xtramelt-ana-simple quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltapp_ANA_SIMPLE_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:648/667 compiling application module for xtramelt-ana-simple optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:650/668 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
	  || meltbuild_error  melt-build-script.tpl:657/669 in meltbuild-modules failed to compile application xtramelt-ana-simple optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/670 not compiling application module for xtramelt-ana-simple optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltapp_ANA_SIMPLE_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:648/671 compiling application module for xtramelt-ana-simple debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:650/672 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
	  || meltbuild_error  melt-build-script.tpl:657/673 in meltbuild-modules failed to compile application xtramelt-ana-simple debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/674 not compiling application module for xtramelt-ana-simple debugnoline
  fi
 


  ## meltbuild_do_applications xtramelt-playground melt-build-script.tpl:620/675
  ...
  ## meltbuild_do_applications xtramelt-playground melt-build-script.tpl:624/676
 ...
 -o meltbuild-sources/xtramelt-ana-simple+meltdesc.c -ot meltbuild-sources/xtramelt-playground+meltdesc.c \
      ...
      meltbuild_info melt-build-script.tpl:630/677 emit application C code for xtramelt-playground
      meltbuild_emit melt-build-script.tpl:631/678 \
	  translatefile \
	  xtramelt-playground \
	  meltbuild-sources \
	  meltbuild-modules \
    ...
    "" \
	  || meltbuild_error melt-build-script.tpl:638/679 failed to generate C code of application xtramelt-playground
  else
      meltbuild_info melt-build-script.tpl:640/680 DONT emit application C code for xtramelt-playground
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltapp_PLAYGROUND_cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:648/681 compiling application module for xtramelt-playground quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:650/682 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  ...
	  || meltbuild_error  melt-build-script.tpl:657/683 in meltbuild-modules failed to compile application xtramelt-playground quicklybuilt "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/684 not compiling application module for xtramelt-playground quicklybuilt
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltapp_PLAYGROUND_cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:648/685 compiling application module for xtramelt-playground optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:650/686 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=optimized \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
	  || meltbuild_error  melt-build-script.tpl:657/687 in meltbuild-modules failed to compile application xtramelt-playground optimized "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/688 not compiling application module for xtramelt-playground optimized
  fi
  ...
  if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltapp_PLAYGROUND_cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:648/689 compiling application module for xtramelt-playground debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	  GCCMELT_FROM=melt-build-script.tpl:650/690 \
	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	  GCCMELT_MODULE_FLAVOR=debugnoline \
	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
	  || meltbuild_error  melt-build-script.tpl:657/691 in meltbuild-modules failed to compile application xtramelt-playground debugnoline "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS
  else
      meltbuild_info melt-build-script.tpl:659/692 not compiling application module for xtramelt-playground debugnoline
  fi
 

  ## meltbuild_do_applications  melt-build-script.tpl:663/693
...
meltbuild_info melt-build-script.tpl:676/694 times after applications at `date '+%x %H:%M:%S'`: ;  times >&2
} ## end meltbuild_do_applications  melt-build-script.tpl:677/695
...
if [ ! -f  "$melt_final_application_stamp" \
 ...
 -o "$melt_final_application_stamp" -ot "$GCCMELT_MELTSOURCEDIR/xtramelt-playground.melt" \
    ...
    meltbuild_info melt-build-script.tpl:683/696 building MELT applications
    meltbuild_do_applications
else
    meltbuild_info melt-build-script.tpl:686/697 not building MELT applications because of applstamp  "$melt_final_application_stamp"
fi

################################################################
#@ melt-build-script.tpl:690/698
if [ "$melt_overall_goal" = "applications" ]; then
    meltbuild_info melt-build-script.tpl:692/699 done applications overall goal with stamp  $melt_final_translator_stamp
    meltbuild_notice 'Done applications' melt-build-script.tpl:693/700 applications overall goal 
    exit 0
fi
################################################################
################################################################
### the modules lists melt-build-script.tpl:698/701
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis" \
  ...
  #  melt-build-script.tpl:703/702 module list quicklybuilt
  meltbuild_info  melt-build-script.tpl:704/703 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:718/705 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" \
  ...
  #  melt-build-script.tpl:703/706 module list optimized
  meltbuild_info  melt-build-script.tpl:704/707 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:718/709 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" \
  ...
  #  melt-build-script.tpl:703/710 module list debugnoline
  meltbuild_info  melt-build-script.tpl:704/711 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:718/713 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"  
fi


#@ melt-build-script.tpl:722/714
...
################################################################
#@ melt-build-script.tpl:728/715 module lists
if [ "$melt_overall_goal" = "modlists" ]; then
    meltbuild_info melt-build-script.tpl:730/716 done modlists overall goal with stamp  $melt_final_application_stamp
    exit 0
fi
...
################################################################
#@ melt-build-script.tpl:738/717 runtime self check

##  melt-build-script.tpl:740/718 FIXME: should skip that when cross-compiler MELT plugin..

if [ -z "$GCCMELT_RUNTIME_CC" ]; then 
    meltbuild_error melt-build-script.tpl:743/719 failed because no GCCMELT_RUNTIME_CC shell variable
    exit 1
fi
...
if [ ! -f $meltcheckruntime_stamp -o $meltcheckruntime_stamp -ot "$GCCMELT_RUNTIME_ARGS" \
    ...
    #@ melt-build-script.tpl:751/720 checkruntime
    if [ -f melt-no-check-runtime -o -n "$MELTGCC_NO_CHECK_RUNTIME" -o ! -f melt-runtime.i ]; then
	meltbuild_info melt-build-script.tpl:753/721 skipping check of MELT runtime
    else
	meltcheckruntime_args=meltbuild-checkruntime.args 
	meltcheckruntime_argstemp=$meltcheckruntime_args-tmp$$
	echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:757/722"' ' -DGCCMELT_CHECKMELTRUNTIME' > $meltcheckruntime_argstemp
	...
	[ -f "$meltcheckruntime_args" ] || meltbuild_error  melt-build-script.tpl:768/723 missing check runtime args  "$meltcheckruntime_args"
	meltbuild_info melt-build-script.tpl:769/724 $meltcheckruntime_args  is
	...
	if [ -n "$MELTGCCBUILTIN_BUILD_WITH_CXX" ]; then
		...
		|| meltbuild_error melt-build-script.tpl:773/725 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	else
	    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltcheckruntime_args \
		|| meltbuild_error melt-build-script.tpl:776/726 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	fi
	meltbuild_info melt-build-script.tpl:778/727 done check runtime with $meltcheckruntime_args
    fi

   #@ melt-build-script.tpl:781/728 checkhello
    meltcheckhelloworld_args=meltbuild-checkhelloworld.args 
    meltcheckhelloworld_argstemp=$meltcheckhelloworld_args-tmp$$
    echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:784/729"' > $meltcheckhelloworld_argstemp
    ...
    [ -f "$meltcheckhelloworld_args" ] || meltbuild_error  melt-build-script.tpl:798/730 missing check helloworld args  "$meltcheckhelloworld_args"
   meltbuild_info melt-build-script.tpl:799/731 $meltcheckhelloworld_args  is
   cat $meltcheckhelloworld_args < /dev/null >&2
    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltcheckhelloworld_args \
	|| meltbuild_error melt-build-script.tpl:802/732 running helloworld failed with arguments @$meltcheckhelloworld_args
   meltbuild_info melt-build-script.tpl:803/733 done check helloworld with $meltcheckhelloworld_args
   #@ melt-build-script.tpl:804/734 runtime stamp
    meltcheckruntime_stamptemp=$meltcheckruntime_stamp-tmp$$
    [ -f "$GCCMELT_RUNTIME_CC" ] || meltbuild_error melt-build-script.tpl:806/735 missing MELT runtime C++ file $GCCMELT_RUNTIME_CC
    ...
    [ -f "$melt_final_translator_stamp" ] || meltbuild_error melt-build-script.tpl:811/736 missing final translator stamp "$melt_final_translator_stamp"
    [ -f "$melt_final_application_stamp" ] || meltbuild_error melt-build-script.tpl:812/737 missing final application stamp "$melt_final_application_stamp"
    ...
    meltbuild_info melt-build-script.tpl:816/738 done check runtime  $meltcheckruntime_stamp
else
    meltbuild_info melt-build-script.tpl:818/739 keeping runtime checks  $meltcheckruntime_stamp
fi

if [ "$melt_overall_goal" = "checkruntime" ]; then
    meltbuild_info melt-build-script.tpl:822/740 done checkruntime overall goal with stamp  $meltcheckruntime_stamp
    exit 0
fi
################################################################
################################################################
#@ melt-build-script.tpl:827/741
if [ "$melt_overall_goal" = "regenerate" ]; then
    meltbuild_notice regenerating runtime support melt-build-script.tpl:829/742 
    ...
    echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:833/743"' > $meltregen_argstemp
   ...
   meltbuild_info melt-build-script.tpl:843/744 $meltregen_args  is
   cat $meltregen_args < /dev/null >&2
    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltregen_args \
	|| meltbuild_error melt-build-script.tpl:846/745 failed with arguments @$meltregen_args
    meltbuild_info melt-build-script.tpl:847/746 done regenerate overall goal
    exit 0
fi

################################################################
################################################################
### the generated documentation meltgendoc.texi melt-build-script.tpl:853/747
...
if [   ! -f meltgendoc.texi  -o meltbuild-sources/warmelt-first.melt -nt meltgendoc.texi  \
 ...
 -o meltbuild-sources/xtramelt-playground.melt -nt meltgendoc.texi   ]; then
   meltbuild_info melt-build-script.tpl:857/748 generating meltgendoc.texi
   meltgen_args=meltbuild-gendoc.args-tmp$$
   echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:859/749"' > $meltgen_args
...
meltbuild_arg "module-makefile=\"$GCCMELT_MODULE_MK\""  >>  $meltgen_args
   ...
   meltbuild_info melt-build-script.tpl:873/750  meltbuild-gendoc.args is
   cat meltbuild-gendoc.args < /dev/null >&2
   $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @meltbuild-gendoc.args \
     || meltbuild_error melt-build-script.tpl:876/751  "$GCCMELT_CC1PLUS" failed with arguments @meltbuild-gendoc.args
else
   meltbuild_info melt-build-script.tpl:878/752 keeping meltgendoc.texi
fi

################
meltbuild_info melt-build-script.tpl:882/753 successfully done with times at `date '+%x %H:%M:%S'`: ; times >&2

################################################################
#@ melt-build-script.tpl:885/754
if [ "$melt_overall_goal" = "gendoc" ]; then
    meltbuild_info melt-build-script.tpl:887/755 done gendoc overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

## #@ melt-build-script.tpl:891/756 if we get here something is wrong in this script
meltbuild_error  melt-build-script.tpl:892/757 unexpected MELT overall goal "$melt_overall_goal" buggy melt-build-script.tpl
#@ eof melt-build-script.tpl:893/758 end of generated melt-build-script.sh
