...
if [ ! -f "$GCCMELT_RUNTIME_DEPENDENCY" ]; then
    meltbuild_error  melt-build-script.tpl:111/6 missing MELT runtime dependency "$GCCMELT_RUNTIME_DEPENDENCY" 
fi

if [ -z "$GCCMELT_CC1PLUS" ]; then
   meltbuild_error  melt-build-script.tpl:115/7 missing GCCMELT_CC1PLUS
fi

if [ ! -f meltrunsup.h ]; then 
    meltbuild_symlink $GCCMELT_MELTSOURCEDIR/generated/meltrunsup.h meltrunsup.h 
    meltbuild_info  melt-build-script.tpl:120/8 symlinking meltrunsup.h header
fi
...
case $melt_overall_goal in
    ...
    gendoc) ;;
    regenerate) ;;
    *) meltbuild_error  melt-build-script.tpl:133/9 bad MELT overall goal "$melt_overall_goal:" \
...
## The base name of the MELT translator files melt-build-script.tpl:142/10
...
case $GCCMELT_ZERO_FLAVOR in
    ...
    debugnoline) ;;
    quicklybuilt) ;;
    *) meltbuild_error  melt-build-script.tpl:150/11 bad zero flavor $GCCMELT_ZERO_FLAVOR ;;
esac


## our stage0 melt-build-script.tpl:154/12

[ -d $GCCMELT_STAGE_ZERO ] || mkdir  $GCCMELT_STAGE_ZERO


function meltbuild_do_stage_zero () {
meltbuild_notice STAGE0+  melt-build-script.tpl:160/13 starting stage zero


  meltbuild_info making stage0 warmelt-first  melt-build-script.tpl:163/14

##  stage0 melt-build-script.tpl:165/15 symlink descriptor file warmelt-first
...
##  stage0 melt-build-script.tpl:170/16 symlink melt/generated source code warmelt-first
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-first.cc" ]; then
      meltbuild_info making stage0 warmelt-first symlinking sources melt-build-script.tpl:172/17
...
##  stage0 melt-build-script.tpl:179/18 symlink stamp warmelt-first
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-first+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-first symlinking timestamp melt-build-script.tpl:181/19
...
## manually generate the stage0 warmelt-first+meltbuild.mk file  melt-build-script.tpl:188/20
  ...
  echo "# generated " melt-build-script.tpl:192/21 >> $MELT_ZERO_GENERATED_FIRST_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-first melt-build-script.tpl:196/22' >> $MELT_ZERO_GENERATED_FIRST_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_FIRST_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-first melt-build-script.tpl:204/23'  >> $MELT_ZERO_GENERATED_FIRST_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:217/24 generated stagezero makedep $MELT_ZERO_GENERATED_FIRST_BUILDMK
  ls -l $MELT_ZERO_GENERATED_FIRST_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:221/25 \
      ...
      || meltbuild_error  melt-build-script.tpl:231/26 stage0 warmelt-first did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:233/27 stage0 warmelt-first module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-first.meltmod-$MELT_ZERO_GENERATED_FIRST_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:235/28 stage0 warmelt-first fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-first.meltmod-$MELT_ZERO_GENERATED_FIRST_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:238/29 successfully build stage0 warmelt-first
# end stage0  melt-build-script.tpl:239/30 base  warmelt-first

  meltbuild_info making stage0 warmelt-base  melt-build-script.tpl:163/31

##  stage0 melt-build-script.tpl:165/32 symlink descriptor file warmelt-base
...
##  stage0 melt-build-script.tpl:170/33 symlink melt/generated source code warmelt-base
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-base.cc" ]; then
      meltbuild_info making stage0 warmelt-base symlinking sources melt-build-script.tpl:172/34
...
##  stage0 melt-build-script.tpl:179/35 symlink stamp warmelt-base
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-base+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-base symlinking timestamp melt-build-script.tpl:181/36
...
## manually generate the stage0 warmelt-base+meltbuild.mk file  melt-build-script.tpl:188/37
  ...
  echo "# generated " melt-build-script.tpl:192/38 >> $MELT_ZERO_GENERATED_BASE_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-base melt-build-script.tpl:196/39' >> $MELT_ZERO_GENERATED_BASE_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_BASE_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-base melt-build-script.tpl:204/40'  >> $MELT_ZERO_GENERATED_BASE_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:217/41 generated stagezero makedep $MELT_ZERO_GENERATED_BASE_BUILDMK
  ls -l $MELT_ZERO_GENERATED_BASE_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:221/42 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:231/43 stage0 warmelt-base did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:233/44 stage0 warmelt-base module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-base.meltmod-$MELT_ZERO_GENERATED_BASE_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:235/45 stage0 warmelt-base fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-base.meltmod-$MELT_ZERO_GENERATED_BASE_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:238/46 successfully build stage0 warmelt-base
# end stage0  melt-build-script.tpl:239/47 base  warmelt-base

  meltbuild_info making stage0 warmelt-debug  melt-build-script.tpl:163/48

##  stage0 melt-build-script.tpl:165/49 symlink descriptor file warmelt-debug
...
##  stage0 melt-build-script.tpl:170/50 symlink melt/generated source code warmelt-debug
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-debug.cc" ]; then
      meltbuild_info making stage0 warmelt-debug symlinking sources melt-build-script.tpl:172/51
...
##  stage0 melt-build-script.tpl:179/52 symlink stamp warmelt-debug
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-debug+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-debug symlinking timestamp melt-build-script.tpl:181/53
...
## manually generate the stage0 warmelt-debug+meltbuild.mk file  melt-build-script.tpl:188/54
  ...
  echo "# generated " melt-build-script.tpl:192/55 >> $MELT_ZERO_GENERATED_DEBUG_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-debug melt-build-script.tpl:196/56' >> $MELT_ZERO_GENERATED_DEBUG_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_DEBUG_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-debug melt-build-script.tpl:204/57'  >> $MELT_ZERO_GENERATED_DEBUG_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:217/58 generated stagezero makedep $MELT_ZERO_GENERATED_DEBUG_BUILDMK
  ls -l $MELT_ZERO_GENERATED_DEBUG_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:221/59 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:231/60 stage0 warmelt-debug did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:233/61 stage0 warmelt-debug module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-debug.meltmod-$MELT_ZERO_GENERATED_DEBUG_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:235/62 stage0 warmelt-debug fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-debug.meltmod-$MELT_ZERO_GENERATED_DEBUG_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:238/63 successfully build stage0 warmelt-debug
# end stage0  melt-build-script.tpl:239/64 base  warmelt-debug

  meltbuild_info making stage0 warmelt-macro  melt-build-script.tpl:163/65

##  stage0 melt-build-script.tpl:165/66 symlink descriptor file warmelt-macro
...
##  stage0 melt-build-script.tpl:170/67 symlink melt/generated source code warmelt-macro
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-macro.cc" ]; then
      meltbuild_info making stage0 warmelt-macro symlinking sources melt-build-script.tpl:172/68
...
##  stage0 melt-build-script.tpl:179/69 symlink stamp warmelt-macro
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-macro+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-macro symlinking timestamp melt-build-script.tpl:181/70
...
## manually generate the stage0 warmelt-macro+meltbuild.mk file  melt-build-script.tpl:188/71
  ...
  echo "# generated " melt-build-script.tpl:192/72 >> $MELT_ZERO_GENERATED_MACRO_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-macro melt-build-script.tpl:196/73' >> $MELT_ZERO_GENERATED_MACRO_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_MACRO_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-macro melt-build-script.tpl:204/74'  >> $MELT_ZERO_GENERATED_MACRO_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:217/75 generated stagezero makedep $MELT_ZERO_GENERATED_MACRO_BUILDMK
  ls -l $MELT_ZERO_GENERATED_MACRO_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:221/76 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:231/77 stage0 warmelt-macro did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:233/78 stage0 warmelt-macro module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-macro.meltmod-$MELT_ZERO_GENERATED_MACRO_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:235/79 stage0 warmelt-macro fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-macro.meltmod-$MELT_ZERO_GENERATED_MACRO_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:238/80 successfully build stage0 warmelt-macro
# end stage0  melt-build-script.tpl:239/81 base  warmelt-macro

  meltbuild_info making stage0 warmelt-moremacro  melt-build-script.tpl:163/82

##  stage0 melt-build-script.tpl:165/83 symlink descriptor file warmelt-moremacro
...
##  stage0 melt-build-script.tpl:170/84 symlink melt/generated source code warmelt-moremacro
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-moremacro.cc" ]; then
      meltbuild_info making stage0 warmelt-moremacro symlinking sources melt-build-script.tpl:172/85
...
##  stage0 melt-build-script.tpl:179/86 symlink stamp warmelt-moremacro
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-moremacro+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-moremacro symlinking timestamp melt-build-script.tpl:181/87
...
## manually generate the stage0 warmelt-moremacro+meltbuild.mk file  melt-build-script.tpl:188/88
  ...
  echo "# generated " melt-build-script.tpl:192/89 >> $MELT_ZERO_GENERATED_MOREMACRO_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-moremacro melt-build-script.tpl:196/90' >> $MELT_ZERO_GENERATED_MOREMACRO_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_MOREMACRO_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-moremacro melt-build-script.tpl:204/91'  >> $MELT_ZERO_GENERATED_MOREMACRO_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:217/92 generated stagezero makedep $MELT_ZERO_GENERATED_MOREMACRO_BUILDMK
  ls -l $MELT_ZERO_GENERATED_MOREMACRO_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:221/93 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:231/94 stage0 warmelt-moremacro did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:233/95 stage0 warmelt-moremacro module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-moremacro.meltmod-$MELT_ZERO_GENERATED_MOREMACRO_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:235/96 stage0 warmelt-moremacro fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-moremacro.meltmod-$MELT_ZERO_GENERATED_MOREMACRO_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:238/97 successfully build stage0 warmelt-moremacro
# end stage0  melt-build-script.tpl:239/98 base  warmelt-moremacro

  meltbuild_info making stage0 warmelt-normal  melt-build-script.tpl:163/99

##  stage0 melt-build-script.tpl:165/100 symlink descriptor file warmelt-normal
...
##  stage0 melt-build-script.tpl:170/101 symlink melt/generated source code warmelt-normal
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-normal.cc" ]; then
      meltbuild_info making stage0 warmelt-normal symlinking sources melt-build-script.tpl:172/102
...
##  stage0 melt-build-script.tpl:179/103 symlink stamp warmelt-normal
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-normal+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-normal symlinking timestamp melt-build-script.tpl:181/104
...
## manually generate the stage0 warmelt-normal+meltbuild.mk file  melt-build-script.tpl:188/105
  ...
  echo "# generated " melt-build-script.tpl:192/106 >> $MELT_ZERO_GENERATED_NORMAL_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-normal melt-build-script.tpl:196/107' >> $MELT_ZERO_GENERATED_NORMAL_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_NORMAL_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-normal melt-build-script.tpl:204/108'  >> $MELT_ZERO_GENERATED_NORMAL_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:217/109 generated stagezero makedep $MELT_ZERO_GENERATED_NORMAL_BUILDMK
  ls -l $MELT_ZERO_GENERATED_NORMAL_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:221/110 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:231/111 stage0 warmelt-normal did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:233/112 stage0 warmelt-normal module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-normal.meltmod-$MELT_ZERO_GENERATED_NORMAL_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:235/113 stage0 warmelt-normal fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-normal.meltmod-$MELT_ZERO_GENERATED_NORMAL_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:238/114 successfully build stage0 warmelt-normal
# end stage0  melt-build-script.tpl:239/115 base  warmelt-normal

  meltbuild_info making stage0 warmelt-normatch  melt-build-script.tpl:163/116

##  stage0 melt-build-script.tpl:165/117 symlink descriptor file warmelt-normatch
...
##  stage0 melt-build-script.tpl:170/118 symlink melt/generated source code warmelt-normatch
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-normatch.cc" ]; then
      meltbuild_info making stage0 warmelt-normatch symlinking sources melt-build-script.tpl:172/119
...
##  stage0 melt-build-script.tpl:179/120 symlink stamp warmelt-normatch
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-normatch+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-normatch symlinking timestamp melt-build-script.tpl:181/121
...
## manually generate the stage0 warmelt-normatch+meltbuild.mk file  melt-build-script.tpl:188/122
  ...
  echo "# generated " melt-build-script.tpl:192/123 >> $MELT_ZERO_GENERATED_NORMATCH_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-normatch melt-build-script.tpl:196/124' >> $MELT_ZERO_GENERATED_NORMATCH_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_NORMATCH_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-normatch melt-build-script.tpl:204/125'  >> $MELT_ZERO_GENERATED_NORMATCH_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:217/126 generated stagezero makedep $MELT_ZERO_GENERATED_NORMATCH_BUILDMK
  ls -l $MELT_ZERO_GENERATED_NORMATCH_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:221/127 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:231/128 stage0 warmelt-normatch did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:233/129 stage0 warmelt-normatch module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-normatch.meltmod-$MELT_ZERO_GENERATED_NORMATCH_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:235/130 stage0 warmelt-normatch fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-normatch.meltmod-$MELT_ZERO_GENERATED_NORMATCH_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:238/131 successfully build stage0 warmelt-normatch
# end stage0  melt-build-script.tpl:239/132 base  warmelt-normatch

  meltbuild_info making stage0 warmelt-genobj  melt-build-script.tpl:163/133

##  stage0 melt-build-script.tpl:165/134 symlink descriptor file warmelt-genobj
...
##  stage0 melt-build-script.tpl:170/135 symlink melt/generated source code warmelt-genobj
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-genobj.cc" ]; then
      meltbuild_info making stage0 warmelt-genobj symlinking sources melt-build-script.tpl:172/136
...
##  stage0 melt-build-script.tpl:179/137 symlink stamp warmelt-genobj
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-genobj+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-genobj symlinking timestamp melt-build-script.tpl:181/138
...
## manually generate the stage0 warmelt-genobj+meltbuild.mk file  melt-build-script.tpl:188/139
  ...
  echo "# generated " melt-build-script.tpl:192/140 >> $MELT_ZERO_GENERATED_GENOBJ_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-genobj melt-build-script.tpl:196/141' >> $MELT_ZERO_GENERATED_GENOBJ_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_GENOBJ_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-genobj melt-build-script.tpl:204/142'  >> $MELT_ZERO_GENERATED_GENOBJ_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:217/143 generated stagezero makedep $MELT_ZERO_GENERATED_GENOBJ_BUILDMK
  ls -l $MELT_ZERO_GENERATED_GENOBJ_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:221/144 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:231/145 stage0 warmelt-genobj did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:233/146 stage0 warmelt-genobj module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-genobj.meltmod-$MELT_ZERO_GENERATED_GENOBJ_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:235/147 stage0 warmelt-genobj fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-genobj.meltmod-$MELT_ZERO_GENERATED_GENOBJ_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:238/148 successfully build stage0 warmelt-genobj
# end stage0  melt-build-script.tpl:239/149 base  warmelt-genobj

  meltbuild_info making stage0 warmelt-outobj  melt-build-script.tpl:163/150

##  stage0 melt-build-script.tpl:165/151 symlink descriptor file warmelt-outobj
...
##  stage0 melt-build-script.tpl:170/152 symlink melt/generated source code warmelt-outobj
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-outobj.cc" ]; then
      meltbuild_info making stage0 warmelt-outobj symlinking sources melt-build-script.tpl:172/153
...
##  stage0 melt-build-script.tpl:179/154 symlink stamp warmelt-outobj
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-outobj+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-outobj symlinking timestamp melt-build-script.tpl:181/155
...
## manually generate the stage0 warmelt-outobj+meltbuild.mk file  melt-build-script.tpl:188/156
  ...
  echo "# generated " melt-build-script.tpl:192/157 >> $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-outobj melt-build-script.tpl:196/158' >> $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-outobj melt-build-script.tpl:204/159'  >> $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:217/160 generated stagezero makedep $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK
  ls -l $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:221/161 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:231/162 stage0 warmelt-outobj did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:233/163 stage0 warmelt-outobj module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-outobj.meltmod-$MELT_ZERO_GENERATED_OUTOBJ_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:235/164 stage0 warmelt-outobj fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-outobj.meltmod-$MELT_ZERO_GENERATED_OUTOBJ_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:238/165 successfully build stage0 warmelt-outobj
# end stage0  melt-build-script.tpl:239/166 base  warmelt-outobj

  meltbuild_info making stage0 warmelt-hooks  melt-build-script.tpl:163/167

##  stage0 melt-build-script.tpl:165/168 symlink descriptor file warmelt-hooks
...
##  stage0 melt-build-script.tpl:170/169 symlink melt/generated source code warmelt-hooks
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-hooks.cc" ]; then
      meltbuild_info making stage0 warmelt-hooks symlinking sources melt-build-script.tpl:172/170
...
##  stage0 melt-build-script.tpl:179/171 symlink stamp warmelt-hooks
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-hooks+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-hooks symlinking timestamp melt-build-script.tpl:181/172
...
## manually generate the stage0 warmelt-hooks+meltbuild.mk file  melt-build-script.tpl:188/173
  ...
  echo "# generated " melt-build-script.tpl:192/174 >> $MELT_ZERO_GENERATED_HOOKS_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-hooks melt-build-script.tpl:196/175' >> $MELT_ZERO_GENERATED_HOOKS_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_HOOKS_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-hooks melt-build-script.tpl:204/176'  >> $MELT_ZERO_GENERATED_HOOKS_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:217/177 generated stagezero makedep $MELT_ZERO_GENERATED_HOOKS_BUILDMK
  ls -l $MELT_ZERO_GENERATED_HOOKS_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:221/178 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:231/179 stage0 warmelt-hooks did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:233/180 stage0 warmelt-hooks module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-hooks.meltmod-$MELT_ZERO_GENERATED_HOOKS_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:235/181 stage0 warmelt-hooks fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-hooks.meltmod-$MELT_ZERO_GENERATED_HOOKS_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:238/182 successfully build stage0 warmelt-hooks
# end stage0  melt-build-script.tpl:239/183 base  warmelt-hooks

  meltbuild_info making stage0 warmelt-modes  melt-build-script.tpl:163/184

##  stage0 melt-build-script.tpl:165/185 symlink descriptor file warmelt-modes
...
##  stage0 melt-build-script.tpl:170/186 symlink melt/generated source code warmelt-modes
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-modes.cc" ]; then
      meltbuild_info making stage0 warmelt-modes symlinking sources melt-build-script.tpl:172/187
...
##  stage0 melt-build-script.tpl:179/188 symlink stamp warmelt-modes
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-modes+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-modes symlinking timestamp melt-build-script.tpl:181/189
...
## manually generate the stage0 warmelt-modes+meltbuild.mk file  melt-build-script.tpl:188/190
  ...
  echo "# generated " melt-build-script.tpl:192/191 >> $MELT_ZERO_GENERATED_MODES_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-modes melt-build-script.tpl:196/192' >> $MELT_ZERO_GENERATED_MODES_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_MODES_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-modes melt-build-script.tpl:204/193'  >> $MELT_ZERO_GENERATED_MODES_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:217/194 generated stagezero makedep $MELT_ZERO_GENERATED_MODES_BUILDMK
  ls -l $MELT_ZERO_GENERATED_MODES_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:221/195 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:231/196 stage0 warmelt-modes did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:233/197 stage0 warmelt-modes module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-modes.meltmod-$MELT_ZERO_GENERATED_MODES_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:235/198 stage0 warmelt-modes fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-modes.meltmod-$MELT_ZERO_GENERATED_MODES_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:238/199 successfully build stage0 warmelt-modes
# end stage0  melt-build-script.tpl:239/200 base  warmelt-modes

} ################ end of function meltbuild_do_stage_zero melt-build-script.tpl:241/201
################################################################

## stage0 stamp file melt-build-script.tpl:244/202
melt_stagezero_stamp=$GCCMELT_STAGE_ZERO/$GCCMELT_STAGE_ZERO.stamp

## test if stage0 should be skipped then do it  melt-build-script.tpl:247/203
if [ ! -f "$melt_stagezero_stamp" -o "$melt_stagezero_stamp" -ot "$GCCMELT_RUNTIME_DEPENDENCY" ]; then
   meltbuild_do_stage_zero
    ...
    echo MELT stagezero stampfile $GCCMELT_STAGE_ZERO.stamp for MELT $MELTGCCBUILTIN_VERSION_STRING from melt-build-script.tpl:251/204 >  $melt_stagezero_stamptemp
    echo $GCCMELT_RUNTIME_DEPENDENCY_MD5SUM $GCCMELT_RUNTIME_DEPENDENCY >> $melt_stagezero_stamptemp

#  stagezero stamp melt-build-script.tpl:254/205 base  warmelt-first
...
#  stagezero stamp melt-build-script.tpl:254/206 base  warmelt-base
...
#  stagezero stamp melt-build-script.tpl:254/207 base  warmelt-debug
...
#  stagezero stamp melt-build-script.tpl:254/208 base  warmelt-macro
...
#  stagezero stamp melt-build-script.tpl:254/209 base  warmelt-moremacro
...
#  stagezero stamp melt-build-script.tpl:254/210 base  warmelt-normal
...
#  stagezero stamp melt-build-script.tpl:254/211 base  warmelt-normatch
...
#  stagezero stamp melt-build-script.tpl:254/212 base  warmelt-genobj
...
#  stagezero stamp melt-build-script.tpl:254/213 base  warmelt-outobj
...
#  stagezero stamp melt-build-script.tpl:254/214 base  warmelt-hooks
...
#  stagezero stamp melt-build-script.tpl:254/215 base  warmelt-modes
   ...
   meltbuild_info melt-build-script.tpl:260/216 skipped stage0 because of stamp file $melt_stagezero_stamp
fi

meltbuild_info melt-build-script.tpl:263/217 times after stagezero at `date '+%x %H:%M:%S'`: ;  times >&2


################################################################
## function to run MELT to emit C++ code  melt-build-script.tpl:267/218
function meltbuild_emit () {
	...
	for meltcsecfil in $meltstage/$meltbase+[0-9][0-9].cc ; do
		...
		: # at  melt-build-script.tpl:323/219
	    else
	...
	meltbuild_info $meltfrom skips emission of C++ code with  @$meltargs stage $meltstage prevstage $meltprevstage skipreason $GCCMELT_SKIPEMITC  melt-build-script.tpl:330/220 
	ls -l $meltprevstage/$meltbase*
	meltbuild_info $meltfrom symlinking previous stage $meltprevstage  melt-build-script.tpl:332/221 
	...
	meltbuild_info $meltfrom symlinked previous stage $meltprevstage/$meltbase melt-build-script.tpl:336/222 
    fi
...
################################################################
################################################################
#################@ before our stages melt-build-script.tpl:344/223 
### Our stages  
...
################################################################
#### function to do a stage melt-build-script.tpl:353/224
function meltbuild_do_stage () {
    ...
    local meltstamp
    local meltstamptmp
####in meltbuild_do_stage melt-build-script.tpl:366/225
    meltbuild_notice "$meltcurstagedir+" starting  stage $meltcurstagedir flavor $meltcurflavor from $meltfrom
####in meltbuild_do_stage melt-build-script.tpl:368/226
    ...
    #in meltbuild_do_stage melt-build-script.tpl:378/227 base warmelt-first
    meltbuild_info melt-build-script.tpl:379/228 from $meltfrom generating C++ code of warmelt-first in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:381/229 emit C++ code for warmelt-first
    meltbuild_emit melt-build-script.tpl:382/230-$meltfrom \
	translateinit \
	warmelt-first \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:395/231 checksum C++ code for warmelt-first
    meltchecksum_cumul_FIRST=$(cat "$meltcurstagedir"/warmelt-first.cc "$meltcurstagedir"/warmelt-first+[0-9][0-9].cc | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:398/232 perhaps compiling C++ code for warmelt-first
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:400/233-$meltfrom compiling module warmelt-first in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:402/234-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	...
	|| ( meltbuild_info melt-build-script.tpl:409/235-$meltfrom recompiling bad module warmelt-first in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:411/236-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    ...
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-first" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-first" ; \
	    meltbuild_error  melt-build-script.tpl:418/237-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:421/238-$meltfrom NOT compiling module warmelt-first "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:427/239 done base warmelt-first


    #in meltbuild_do_stage melt-build-script.tpl:378/240 base warmelt-base
    meltbuild_info melt-build-script.tpl:379/241 from $meltfrom generating C++ code of warmelt-base in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:381/242 emit C++ code for warmelt-base
    meltbuild_emit melt-build-script.tpl:382/243-$meltfrom \
	translatefile \
	warmelt-base \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:395/244 checksum C++ code for warmelt-base
    meltchecksum_cumul_BASE=$(cat "$meltcurstagedir"/warmelt-base.cc "$meltcurstagedir"/warmelt-base+[0-9][0-9].cc | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:398/245 perhaps compiling C++ code for warmelt-base
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:400/246-$meltfrom compiling module warmelt-base in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:402/247-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:409/248-$meltfrom recompiling bad module warmelt-base in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:411/249-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-base" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-base" ; \
	    meltbuild_error  melt-build-script.tpl:418/250-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:421/251-$meltfrom NOT compiling module warmelt-base "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:427/252 done base warmelt-base


    #in meltbuild_do_stage melt-build-script.tpl:378/253 base warmelt-debug
    meltbuild_info melt-build-script.tpl:379/254 from $meltfrom generating C++ code of warmelt-debug in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:381/255 emit C++ code for warmelt-debug
    meltbuild_emit melt-build-script.tpl:382/256-$meltfrom \
	translatefile \
	warmelt-debug \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:395/257 checksum C++ code for warmelt-debug
    meltchecksum_cumul_DEBUG=$(cat "$meltcurstagedir"/warmelt-debug.cc "$meltcurstagedir"/warmelt-debug+[0-9][0-9].cc | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:398/258 perhaps compiling C++ code for warmelt-debug
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:400/259-$meltfrom compiling module warmelt-debug in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:402/260-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:409/261-$meltfrom recompiling bad module warmelt-debug in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:411/262-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-debug" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-debug" ; \
	    meltbuild_error  melt-build-script.tpl:418/263-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:421/264-$meltfrom NOT compiling module warmelt-debug "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:427/265 done base warmelt-debug


    #in meltbuild_do_stage melt-build-script.tpl:378/266 base warmelt-macro
    meltbuild_info melt-build-script.tpl:379/267 from $meltfrom generating C++ code of warmelt-macro in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:381/268 emit C++ code for warmelt-macro
    meltbuild_emit melt-build-script.tpl:382/269-$meltfrom \
	translatefile \
	warmelt-macro \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:395/270 checksum C++ code for warmelt-macro
    meltchecksum_cumul_MACRO=$(cat "$meltcurstagedir"/warmelt-macro.cc "$meltcurstagedir"/warmelt-macro+[0-9][0-9].cc | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:398/271 perhaps compiling C++ code for warmelt-macro
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:400/272-$meltfrom compiling module warmelt-macro in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:402/273-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:409/274-$meltfrom recompiling bad module warmelt-macro in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:411/275-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-macro" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-macro" ; \
	    meltbuild_error  melt-build-script.tpl:418/276-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:421/277-$meltfrom NOT compiling module warmelt-macro "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:427/278 done base warmelt-macro


    #in meltbuild_do_stage melt-build-script.tpl:378/279 base warmelt-moremacro
    meltbuild_info melt-build-script.tpl:379/280 from $meltfrom generating C++ code of warmelt-moremacro in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:381/281 emit C++ code for warmelt-moremacro
    meltbuild_emit melt-build-script.tpl:382/282-$meltfrom \
	translatefile \
	warmelt-moremacro \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:395/283 checksum C++ code for warmelt-moremacro
    ...
    #in meltbuild_do_stage melt-build-script.tpl:398/284 perhaps compiling C++ code for warmelt-moremacro
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:400/285-$meltfrom compiling module warmelt-moremacro in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:402/286-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:409/287-$meltfrom recompiling bad module warmelt-moremacro in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:411/288-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-moremacro" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-moremacro" ; \
	    meltbuild_error  melt-build-script.tpl:418/289-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:421/290-$meltfrom NOT compiling module warmelt-moremacro "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:427/291 done base warmelt-moremacro


    #in meltbuild_do_stage melt-build-script.tpl:378/292 base warmelt-normal
    meltbuild_info melt-build-script.tpl:379/293 from $meltfrom generating C++ code of warmelt-normal in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:381/294 emit C++ code for warmelt-normal
    meltbuild_emit melt-build-script.tpl:382/295-$meltfrom \
	translatefile \
	warmelt-normal \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:395/296 checksum C++ code for warmelt-normal
    ...
    #in meltbuild_do_stage melt-build-script.tpl:398/297 perhaps compiling C++ code for warmelt-normal
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:400/298-$meltfrom compiling module warmelt-normal in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:402/299-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:409/300-$meltfrom recompiling bad module warmelt-normal in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:411/301-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-normal" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-normal" ; \
	    meltbuild_error  melt-build-script.tpl:418/302-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:421/303-$meltfrom NOT compiling module warmelt-normal "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:427/304 done base warmelt-normal


    #in meltbuild_do_stage melt-build-script.tpl:378/305 base warmelt-normatch
    meltbuild_info melt-build-script.tpl:379/306 from $meltfrom generating C++ code of warmelt-normatch in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:381/307 emit C++ code for warmelt-normatch
    meltbuild_emit melt-build-script.tpl:382/308-$meltfrom \
	translatefile \
	warmelt-normatch \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:395/309 checksum C++ code for warmelt-normatch
    ...
    #in meltbuild_do_stage melt-build-script.tpl:398/310 perhaps compiling C++ code for warmelt-normatch
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:400/311-$meltfrom compiling module warmelt-normatch in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:402/312-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:409/313-$meltfrom recompiling bad module warmelt-normatch in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:411/314-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-normatch" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-normatch" ; \
	    meltbuild_error  melt-build-script.tpl:418/315-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:421/316-$meltfrom NOT compiling module warmelt-normatch "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:427/317 done base warmelt-normatch


    #in meltbuild_do_stage melt-build-script.tpl:378/318 base warmelt-genobj
    meltbuild_info melt-build-script.tpl:379/319 from $meltfrom generating C++ code of warmelt-genobj in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:381/320 emit C++ code for warmelt-genobj
    meltbuild_emit melt-build-script.tpl:382/321-$meltfrom \
	translatefile \
	warmelt-genobj \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:395/322 checksum C++ code for warmelt-genobj
    ...
    #in meltbuild_do_stage melt-build-script.tpl:398/323 perhaps compiling C++ code for warmelt-genobj
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:400/324-$meltfrom compiling module warmelt-genobj in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:402/325-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:409/326-$meltfrom recompiling bad module warmelt-genobj in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:411/327-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-genobj" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-genobj" ; \
	    meltbuild_error  melt-build-script.tpl:418/328-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:421/329-$meltfrom NOT compiling module warmelt-genobj "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:427/330 done base warmelt-genobj


    #in meltbuild_do_stage melt-build-script.tpl:378/331 base warmelt-outobj
    meltbuild_info melt-build-script.tpl:379/332 from $meltfrom generating C++ code of warmelt-outobj in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:381/333 emit C++ code for warmelt-outobj
    meltbuild_emit melt-build-script.tpl:382/334-$meltfrom \
	translatefile \
	warmelt-outobj \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:395/335 checksum C++ code for warmelt-outobj
    ...
    #in meltbuild_do_stage melt-build-script.tpl:398/336 perhaps compiling C++ code for warmelt-outobj
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:400/337-$meltfrom compiling module warmelt-outobj in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:402/338-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:409/339-$meltfrom recompiling bad module warmelt-outobj in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:411/340-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-outobj" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-outobj" ; \
	    meltbuild_error  melt-build-script.tpl:418/341-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:421/342-$meltfrom NOT compiling module warmelt-outobj "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:427/343 done base warmelt-outobj


    #in meltbuild_do_stage melt-build-script.tpl:378/344 base warmelt-hooks
    meltbuild_info melt-build-script.tpl:379/345 from $meltfrom generating C++ code of warmelt-hooks in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:381/346 emit C++ code for warmelt-hooks
    meltbuild_emit melt-build-script.tpl:382/347-$meltfrom \
	translatefile \
	warmelt-hooks \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:395/348 checksum C++ code for warmelt-hooks
    meltchecksum_cumul_HOOKS=$(cat "$meltcurstagedir"/warmelt-hooks.cc "$meltcurstagedir"/warmelt-hooks+[0-9][0-9].cc | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:398/349 perhaps compiling C++ code for warmelt-hooks
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:400/350-$meltfrom compiling module warmelt-hooks in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:402/351-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:409/352-$meltfrom recompiling bad module warmelt-hooks in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:411/353-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-hooks" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-hooks" ; \
	    meltbuild_error  melt-build-script.tpl:418/354-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:421/355-$meltfrom NOT compiling module warmelt-hooks "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:427/356 done base warmelt-hooks


    #in meltbuild_do_stage melt-build-script.tpl:378/357 base warmelt-modes
    meltbuild_info melt-build-script.tpl:379/358 from $meltfrom generating C++ code of warmelt-modes in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:381/359 emit C++ code for warmelt-modes
    meltbuild_emit melt-build-script.tpl:382/360-$meltfrom \
	translatefile \
	warmelt-modes \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:395/361 checksum C++ code for warmelt-modes
    meltchecksum_cumul_MODES=$(cat "$meltcurstagedir"/warmelt-modes.cc "$meltcurstagedir"/warmelt-modes+[0-9][0-9].cc | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:398/362 perhaps compiling C++ code for warmelt-modes
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:400/363-$meltfrom compiling module warmelt-modes in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:402/364-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:409/365-$meltfrom recompiling bad module warmelt-modes in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:411/366-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-modes" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-modes" ; \
	    meltbuild_error  melt-build-script.tpl:418/367-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:421/368-$meltfrom NOT compiling module warmelt-modes "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:427/369 done base warmelt-modes


    #in meltbuild_do_stage melt-build-script.tpl:430/370 generating the stampfile
    ...
    #in meltbuild_do_stage melt-build-script.tpl:442/371 ending
...
}			#### end meltbuild_do_stage melt-build-script.tpl:445/372
################################################################

##### possibly run all our stages  melt-build-script.tpl:448/373

#@  melt-build-script.tpl:450/374 stagedir meltbuild-stage1
GCCMELT_SKIPEMITC=
if [ ! -f meltbuild-stage1/meltbuild-stage1.stamp -o meltbuild-stage1/meltbuild-stage1.stamp -ot $GCCMELT_RUNTIME_DEPENDENCY \
 ...
 -o meltbuild-stage1/meltbuild-stage1.stamp -ot $GCCMELT_MELTSOURCEDIR/warmelt-modes.melt \
    ...
    echo '+++++++++++++++++++++++++++++++++++++++++++++++++++++++++'
    meltbuild_info  melt-build-script.tpl:457/375 '++++++++++++++++' building stage meltbuild-stage1 '++++++++++++++++'
    ## building stage meltbuild-stage1 previous $GCCMELT_STAGE_ZERO  melt-build-script.tpl:458/376
    meltbuild_do_stage  melt-build-script.tpl:459/377 meltbuild-stage1 quicklybuilt $GCCMELT_STAGE_ZERO $GCCMELT_ZERO_FLAVOR "$GCCMELT_EMIT_OPTION_STAGE1"
else
    meltbuild_info  melt-build-script.tpl:461/378 skipping stage meltbuild-stage1
fi

##  melt-build-script.tpl:464/379
GCCMELT_LASTSTAGE=meltbuild-stage1


#@  melt-build-script.tpl:450/380 stagedir meltbuild-stage2
GCCMELT_SKIPEMITC=
if [ ! -f meltbuild-stage2/meltbuild-stage2.stamp -o meltbuild-stage2/meltbuild-stage2.stamp -ot $GCCMELT_RUNTIME_DEPENDENCY \
 ...
 -o meltbuild-stage2/meltbuild-stage2.stamp -ot $GCCMELT_MELTSOURCEDIR/warmelt-modes.melt \
    ...
    echo ; echo ; echo ; echo ; echo ; echo ; echo ; echo
    echo '+++++++++++++++++++++++++++++++++++++++++++++++++++++++++'
    meltbuild_info  melt-build-script.tpl:457/381 '++++++++++++++++' building stage meltbuild-stage2 '++++++++++++++++'
    ## building stage meltbuild-stage2 previous meltbuild-stage1  melt-build-script.tpl:458/382
    meltbuild_do_stage  melt-build-script.tpl:459/383 meltbuild-stage2 quicklybuilt meltbuild-stage1 quicklybuilt "$GCCMELT_EMIT_OPTION_STAGE2"
else
    meltbuild_info  melt-build-script.tpl:461/384 skipping stage meltbuild-stage2
fi

##  melt-build-script.tpl:464/385
GCCMELT_LASTSTAGE=meltbuild-stage2


#@  melt-build-script.tpl:450/386 stagedir meltbuild-stage3
GCCMELT_SKIPEMITC=
if [ ! -f meltbuild-stage3/meltbuild-stage3.stamp -o meltbuild-stage3/meltbuild-stage3.stamp -ot $GCCMELT_RUNTIME_DEPENDENCY \
 ...
 -o meltbuild-stage3/meltbuild-stage3.stamp -ot $GCCMELT_MELTSOURCEDIR/warmelt-modes.melt \
    ...
    echo ; echo ; echo ; echo ; echo ; echo ; echo ; echo
    echo '+++++++++++++++++++++++++++++++++++++++++++++++++++++++++'
    meltbuild_info  melt-build-script.tpl:457/387 '++++++++++++++++' building stage meltbuild-stage3 '++++++++++++++++'
    ## building stage meltbuild-stage3 previous meltbuild-stage2  melt-build-script.tpl:458/388
    meltbuild_do_stage  melt-build-script.tpl:459/389 meltbuild-stage3 quicklybuilt meltbuild-stage2 quicklybuilt "$GCCMELT_EMIT_OPTION_STAGE3"
else
    meltbuild_info  melt-build-script.tpl:461/390 skipping stage meltbuild-stage3
fi

##  melt-build-script.tpl:464/391
...
meltbuild_info melt-build-script.tpl:472/392 last stage $GCCMELT_LASTSTAGE

################################################################
################################################################
###########@ before generating meltbuild-sources melt-build-script.tpl:476/393
...
#@ from  melt-build-script.tpl:485/394  compiling the modules
[ -d meltbuild-modules ] || mkdir meltbuild-modules

################################################################
function meltbuild_emit_translator_sources () {

  ## meltbuild_emit_source  melt-build-script.tpl:491/395 base warmelt-first
  meltbuild_info melt-build-script.tpl:492/396 generating C++ code of warmelt-first in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:493/397 \
      translateinit \
      warmelt-first \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:491/398 base warmelt-base
  meltbuild_info melt-build-script.tpl:492/399 generating C++ code of warmelt-base in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:493/400 \
      translatefile \
      warmelt-base \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:491/401 base warmelt-debug
  meltbuild_info melt-build-script.tpl:492/402 generating C++ code of warmelt-debug in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:493/403 \
      translatefile \
      warmelt-debug \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:491/404 base warmelt-macro
  meltbuild_info melt-build-script.tpl:492/405 generating C++ code of warmelt-macro in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:493/406 \
      translatefile \
      warmelt-macro \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:491/407 base warmelt-moremacro
  meltbuild_info melt-build-script.tpl:492/408 generating C++ code of warmelt-moremacro in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:493/409 \
      translatefile \
      warmelt-moremacro \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:491/410 base warmelt-normal
  meltbuild_info melt-build-script.tpl:492/411 generating C++ code of warmelt-normal in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:493/412 \
      translatefile \
      warmelt-normal \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:491/413 base warmelt-normatch
  meltbuild_info melt-build-script.tpl:492/414 generating C++ code of warmelt-normatch in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:493/415 \
      translatefile \
      warmelt-normatch \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:491/416 base warmelt-genobj
  meltbuild_info melt-build-script.tpl:492/417 generating C++ code of warmelt-genobj in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:493/418 \
      translatefile \
      warmelt-genobj \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:491/419 base warmelt-outobj
  meltbuild_info melt-build-script.tpl:492/420 generating C++ code of warmelt-outobj in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:493/421 \
      translatefile \
      warmelt-outobj \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:491/422 base warmelt-hooks
  meltbuild_info melt-build-script.tpl:492/423 generating C++ code of warmelt-hooks in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:493/424 \
      translatefile \
      warmelt-hooks \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:491/425 base warmelt-modes
  meltbuild_info melt-build-script.tpl:492/426 generating C++ code of warmelt-modes in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:493/427 \
      translatefile \
      warmelt-modes \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
...
function meltbuild_compile_translator_modules () {
  ...
  # in meltbuild_compile_translator_sources quicklybuilt melt-build-script.tpl:508/428
  meltbuild_info melt-build-script.tpl:509/429 compiling translator quicklybuilt


   #@ melt-build-script.tpl:512/430 flavor quicklybuilt base warmelt-first
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/431 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
 ...
 || meltbuild_error  melt-build-script.tpl:521/432 in meltbuild-modules failed to compile translator warmelt-first quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/433 flavor quicklybuilt base warmelt-base
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/434 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:521/435 in meltbuild-modules failed to compile translator warmelt-base quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/436 flavor quicklybuilt base warmelt-debug
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/437 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:521/438 in meltbuild-modules failed to compile translator warmelt-debug quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/439 flavor quicklybuilt base warmelt-macro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/440 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:521/441 in meltbuild-modules failed to compile translator warmelt-macro quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/442 flavor quicklybuilt base warmelt-moremacro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/443 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:521/444 in meltbuild-modules failed to compile translator warmelt-moremacro quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/445 flavor quicklybuilt base warmelt-normal
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/446 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:521/447 in meltbuild-modules failed to compile translator warmelt-normal quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/448 flavor quicklybuilt base warmelt-normatch
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/449 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:521/450 in meltbuild-modules failed to compile translator warmelt-normatch quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/451 flavor quicklybuilt base warmelt-genobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/452 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:521/453 in meltbuild-modules failed to compile translator warmelt-genobj quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/454 flavor quicklybuilt base warmelt-outobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/455 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:521/456 in meltbuild-modules failed to compile translator warmelt-outobj quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/457 flavor quicklybuilt base warmelt-hooks
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/458 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:521/459 in meltbuild-modules failed to compile translator warmelt-hooks quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/460 flavor quicklybuilt base warmelt-modes
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/461 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:521/462 in meltbuild-modules failed to compile translator warmelt-modes quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS




  # in meltbuild_compile_translator_sources optimized melt-build-script.tpl:508/463
  meltbuild_info melt-build-script.tpl:509/464 compiling translator optimized


   #@ melt-build-script.tpl:512/465 flavor optimized base warmelt-first
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/466 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     ...
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-first \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-first \
 || meltbuild_error  melt-build-script.tpl:521/467 in meltbuild-modules failed to compile translator warmelt-first optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/468 flavor optimized base warmelt-base
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/469 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-base \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-base \
 || meltbuild_error  melt-build-script.tpl:521/470 in meltbuild-modules failed to compile translator warmelt-base optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/471 flavor optimized base warmelt-debug
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/472 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-debug \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-debug \
 || meltbuild_error  melt-build-script.tpl:521/473 in meltbuild-modules failed to compile translator warmelt-debug optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/474 flavor optimized base warmelt-macro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/475 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-macro \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-macro \
 || meltbuild_error  melt-build-script.tpl:521/476 in meltbuild-modules failed to compile translator warmelt-macro optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/477 flavor optimized base warmelt-moremacro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/478 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-moremacro \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-moremacro \
 || meltbuild_error  melt-build-script.tpl:521/479 in meltbuild-modules failed to compile translator warmelt-moremacro optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/480 flavor optimized base warmelt-normal
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/481 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normal \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normal \
 || meltbuild_error  melt-build-script.tpl:521/482 in meltbuild-modules failed to compile translator warmelt-normal optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/483 flavor optimized base warmelt-normatch
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/484 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normatch \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normatch \
 || meltbuild_error  melt-build-script.tpl:521/485 in meltbuild-modules failed to compile translator warmelt-normatch optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/486 flavor optimized base warmelt-genobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/487 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-genobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-genobj \
 || meltbuild_error  melt-build-script.tpl:521/488 in meltbuild-modules failed to compile translator warmelt-genobj optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/489 flavor optimized base warmelt-outobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/490 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-outobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-outobj \
 || meltbuild_error  melt-build-script.tpl:521/491 in meltbuild-modules failed to compile translator warmelt-outobj optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/492 flavor optimized base warmelt-hooks
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/493 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-hooks \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-hooks \
 || meltbuild_error  melt-build-script.tpl:521/494 in meltbuild-modules failed to compile translator warmelt-hooks optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/495 flavor optimized base warmelt-modes
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/496 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-modes \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-modes \
 || meltbuild_error  melt-build-script.tpl:521/497 in meltbuild-modules failed to compile translator warmelt-modes optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS




  # in meltbuild_compile_translator_sources debugnoline melt-build-script.tpl:508/498
  meltbuild_info melt-build-script.tpl:509/499 compiling translator debugnoline


   #@ melt-build-script.tpl:512/500 flavor debugnoline base warmelt-first
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/501 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     ...
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-first \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-first \
 || meltbuild_error  melt-build-script.tpl:521/502 in meltbuild-modules failed to compile translator warmelt-first debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/503 flavor debugnoline base warmelt-base
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/504 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-base \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-base \
 || meltbuild_error  melt-build-script.tpl:521/505 in meltbuild-modules failed to compile translator warmelt-base debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/506 flavor debugnoline base warmelt-debug
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/507 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-debug \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-debug \
 || meltbuild_error  melt-build-script.tpl:521/508 in meltbuild-modules failed to compile translator warmelt-debug debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/509 flavor debugnoline base warmelt-macro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/510 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-macro \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-macro \
 || meltbuild_error  melt-build-script.tpl:521/511 in meltbuild-modules failed to compile translator warmelt-macro debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/512 flavor debugnoline base warmelt-moremacro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/513 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-moremacro \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-moremacro \
 || meltbuild_error  melt-build-script.tpl:521/514 in meltbuild-modules failed to compile translator warmelt-moremacro debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/515 flavor debugnoline base warmelt-normal
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/516 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normal \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normal \
 || meltbuild_error  melt-build-script.tpl:521/517 in meltbuild-modules failed to compile translator warmelt-normal debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/518 flavor debugnoline base warmelt-normatch
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/519 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normatch \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normatch \
 || meltbuild_error  melt-build-script.tpl:521/520 in meltbuild-modules failed to compile translator warmelt-normatch debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/521 flavor debugnoline base warmelt-genobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/522 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-genobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-genobj \
 || meltbuild_error  melt-build-script.tpl:521/523 in meltbuild-modules failed to compile translator warmelt-genobj debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/524 flavor debugnoline base warmelt-outobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/525 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-outobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-outobj \
 || meltbuild_error  melt-build-script.tpl:521/526 in meltbuild-modules failed to compile translator warmelt-outobj debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/527 flavor debugnoline base warmelt-hooks
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/528 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-hooks \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-hooks \
 || meltbuild_error  melt-build-script.tpl:521/529 in meltbuild-modules failed to compile translator warmelt-hooks debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:512/530 flavor debugnoline base warmelt-modes
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:514/531 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-modes \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-modes \
 || meltbuild_error  melt-build-script.tpl:521/532 in meltbuild-modules failed to compile translator warmelt-modes debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS
...
#################@ melt-build-script.tpl:529/533 
function meltbuild_symlink_melt_translator_sources () {


### symlinking the MELT translator code in meltbuild-sources for warmelt-first from melt-build-script.tpl:534/534

meltbuild_info melt-build-script.tpl:536/535 putting MELT translator code of warmelt-first in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-base from melt-build-script.tpl:534/536

meltbuild_info melt-build-script.tpl:536/537 putting MELT translator code of warmelt-base in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-debug from melt-build-script.tpl:534/538

meltbuild_info melt-build-script.tpl:536/539 putting MELT translator code of warmelt-debug in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-macro from melt-build-script.tpl:534/540

meltbuild_info melt-build-script.tpl:536/541 putting MELT translator code of warmelt-macro in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-moremacro from melt-build-script.tpl:534/542

meltbuild_info melt-build-script.tpl:536/543 putting MELT translator code of warmelt-moremacro in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-normal from melt-build-script.tpl:534/544

meltbuild_info melt-build-script.tpl:536/545 putting MELT translator code of warmelt-normal in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-normatch from melt-build-script.tpl:534/546

meltbuild_info melt-build-script.tpl:536/547 putting MELT translator code of warmelt-normatch in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-genobj from melt-build-script.tpl:534/548

meltbuild_info melt-build-script.tpl:536/549 putting MELT translator code of warmelt-genobj in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-outobj from melt-build-script.tpl:534/550

meltbuild_info melt-build-script.tpl:536/551 putting MELT translator code of warmelt-outobj in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-hooks from melt-build-script.tpl:534/552

meltbuild_info melt-build-script.tpl:536/553 putting MELT translator code of warmelt-hooks in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-modes from melt-build-script.tpl:534/554

meltbuild_info melt-build-script.tpl:536/555 putting MELT translator code of warmelt-modes in meltbuild-sources
...
################@ final translator melt-build-script.tpl:545/556 
...
if [ ! -f $melt_final_translator_stamp -o $melt_final_translator_stamp -ot $GCCMELT_RUNTIME_DEPENDENCY \
 ...
 -o $melt_final_translator_stamp -ot $GCCMELT_LASTSTAGE/$GCCMELT_LASTSTAGE.stamp ]; then
    meltbuild_notice 'Emit Translator Source'  melt-build-script.tpl:551/557 emit then translate the MELT translator 
    meltbuild_info melt-build-script.tpl:552/558 emit then translate the compile translator for  $melt_final_translator_stamp
...
#@  melt-build-script.tpl:560/569 
    ...
    meltbuild_info melt-build-script.tpl:571/570 skip final translation of translator stamp  $melt_final_translator_stamp
fi

################################################################
#@ melt-build-script.tpl:575/571 making the meltbuild-common.args file to make life easier
# I would often use that meltbuild-common.args for testing, etc.
meltcommon_args=meltbuild-common.args
meltbuild_info melt-build-script.tpl:578/572 making $meltcommon_args
meltcommon_argstemp=$meltcommon_args-tmp$$
echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:580/573"' > $meltcommon_argstemp
...
meltbuild_info melt-build-script.tpl:589/574 $meltcommon_args is
cat $meltcommon_args < /dev/null >&2


################
### the warmelt modules lists  melt-build-script.tpl:594/575
...
if [ ! -f meltbuild-sources/warmelt.quicklybuilt.modlis \
  ...
  #  melt-build-script.tpl:598/576 warmelt module list quicklybuilt
...
if [ ! -f meltbuild-sources/warmelt.optimized.modlis \
  ...
  #  melt-build-script.tpl:598/577 warmelt module list optimized
...
if [ ! -f meltbuild-sources/warmelt.debugnoline.modlis \
  ...
  #  melt-build-script.tpl:598/578 warmelt module list debugnoline
...
################################################################
#@ melt-build-script.tpl:609/579
if [ "$melt_overall_goal" = "translator" ]; then
    meltbuild_info melt-build-script.tpl:611/580 done translation overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

################################################################
################################################################
### the warmelt modules lists melt-build-script.tpl:617/581

if [ ! -f "meltbuild-sources/warmelt.quicklybuilt.modlis" \
    -o "meltbuild-sources/warmelt.quicklybuilt.modlis" -ot $melt_final_translator_stamp  ]; then
  #  melt-build-script.tpl:621/582 warmelt module list quicklybuilt
  meltbuild_info  melt-build-script.tpl:622/583 generating warmelt module list  "meltbuild-sources/warmelt.quicklybuilt.modlis"
  melt_modlis_temp="meltbuild-sources/warmelt.quicklybuilt.modlis-tmp$$"
  ...
  #@  melt-build-script.tpl:629/584
  $GCCMELT_MOVE_IF_CHANGE $melt_modlis_temp  "meltbuild-sources/warmelt.quicklybuilt.modlis"
else
  meltbuild_info  melt-build-script.tpl:632/585 keeping warmelt module list  "meltbuild-sources/warmelt.quicklybuilt.modlis"  
fi

if [ ! -f "meltbuild-sources/warmelt.optimized.modlis" \
    -o "meltbuild-sources/warmelt.optimized.modlis" -ot $melt_final_translator_stamp  ]; then
  #  melt-build-script.tpl:621/586 warmelt module list optimized
  meltbuild_info  melt-build-script.tpl:622/587 generating warmelt module list  "meltbuild-sources/warmelt.optimized.modlis"
  melt_modlis_temp="meltbuild-sources/warmelt.optimized.modlis-tmp$$"
  ...
  #@  melt-build-script.tpl:629/588
  $GCCMELT_MOVE_IF_CHANGE $melt_modlis_temp  "meltbuild-sources/warmelt.optimized.modlis"
else
  meltbuild_info  melt-build-script.tpl:632/589 keeping warmelt module list  "meltbuild-sources/warmelt.optimized.modlis"  
fi

if [ ! -f "meltbuild-sources/warmelt.debugnoline.modlis" \
    -o "meltbuild-sources/warmelt.debugnoline.modlis" -ot $melt_final_translator_stamp  ]; then
  #  melt-build-script.tpl:621/590 warmelt module list debugnoline
  meltbuild_info  melt-build-script.tpl:622/591 generating warmelt module list  "meltbuild-sources/warmelt.debugnoline.modlis"
  melt_modlis_temp="meltbuild-sources/warmelt.debugnoline.modlis-tmp$$"
  ...
  #@  melt-build-script.tpl:629/592
  $GCCMELT_MOVE_IF_CHANGE $melt_modlis_temp  "meltbuild-sources/warmelt.debugnoline.modlis"
else
  meltbuild_info  melt-build-script.tpl:632/593 keeping warmelt module list  "meltbuild-sources/warmelt.debugnoline.modlis"  
fi
...
################################################################
######################### REGENERATION #########################
#@ melt-build-script.tpl:639/594
if [ "$melt_overall_goal" = "regenerate" ]; then
    meltbuild_notice regenerating runtime support melt-build-script.tpl:641/595 
    ...
    echo ' -DGCCMELT_REGENERATING  -DGCCMELT_FROM_ARG="melt-build-script.tpl:645/596"' > $meltregen_argstemp
   ...
   meltbuild_info melt-build-script.tpl:655/597 $meltregen_args  is
   cat $meltregen_args < /dev/null >&2
    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltregen_args \
	|| meltbuild_error melt-build-script.tpl:658/598 failed with arguments @$meltregen_args
    meltbuild_info melt-build-script.tpl:659/599 done regenerate overall goal
    exit 0
fi
...
########################### LIBRARY ############################
################
#@ melt-build-script.tpl:669/600 before library libmelt* modules
################################################################
meltbuild_info melt-build-script.tpl:671/601 before library GCCMELT_SKIPEMITC=$GCCMELT_SKIPEMITC.

meltbuild_info melt-build-script.tpl:673/602 times before library at `date '+%x %H:%M:%S'`: ;  times >&2
 
melt_final_library_stamp=meltbuild-final-library.stamp

function meltbuild_do_library () {
  meltbuild_notice 'start doing library'  melt-build-script.tpl:678/603 doing library 
  
  
    ## meltbuild_do_library libmelt-ana-base melt-build-script.tpl:681/604
    meltbuild_info melt-build-script.tpl:682/605 doing library libmelt-ana-base
    ...
    ## meltbuild_do_library libmelt-ana-base melt-build-script.tpl:686/606
    if [ ! -f meltbuild-sources/libmelt-ana-base.cc -o  ! -f meltbuild-sources/libmelt-ana-base+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:692/607 emit library C++ code for libmelt-ana-base
        meltbuild_emit melt-build-script.tpl:693/608 \
  	  translatefile \
  	  libmelt-ana-base \
  	  meltbuild-sources \
  	  meltbuild-modules \
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:700/609 failed to generate C++ code of library libmelt-ana-base
    else
        meltbuild_info melt-build-script.tpl:702/610 DONT emit library C++ code for libmelt-ana-base
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-base.meltmod-$meltlib_ANA_BASE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:710/611 compiling library module for libmelt-ana-base quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:712/612 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:719/613 in meltbuild-modules failure to compile library libmelt-ana-base quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:721/614 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base ; \
  	       meltbuild_error  melt-build-script.tpl:728/615 in meltbuild-modules failed to compile library libmelt-ana-base quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:731/616 not compiling library module for libmelt-ana-base quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-base.meltmod-$meltlib_ANA_BASE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:710/617 compiling library module for libmelt-ana-base optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:712/618 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base \
  	  || ( meltbuild_notice melt-build-script.tpl:719/619 in meltbuild-modules failure to compile library libmelt-ana-base optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:721/620 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base ; \
  	       meltbuild_error  melt-build-script.tpl:728/621 in meltbuild-modules failed to compile library libmelt-ana-base optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:731/622 not compiling library module for libmelt-ana-base optimized
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-base.meltmod-$meltlib_ANA_BASE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:710/623 compiling library module for libmelt-ana-base debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:712/624 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base \
  	  || ( meltbuild_notice melt-build-script.tpl:719/625 in meltbuild-modules failure to compile library libmelt-ana-base debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:721/626 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base ; \
  	       meltbuild_error  melt-build-script.tpl:728/627 in meltbuild-modules failed to compile library libmelt-ana-base debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:731/628 not compiling library module for libmelt-ana-base debugnoline
    fi
   
  
  
    ## meltbuild_do_library libmelt-ana-tree melt-build-script.tpl:681/629
    meltbuild_info melt-build-script.tpl:682/630 doing library libmelt-ana-tree
    ...
    ## meltbuild_do_library libmelt-ana-tree melt-build-script.tpl:686/631
   ...
   -o meltbuild-sources/libmelt-ana-base+meltdesc.c -ot meltbuild-sources/libmelt-ana-tree+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:692/632 emit library C++ code for libmelt-ana-tree
        meltbuild_emit melt-build-script.tpl:693/633 \
  	  translatefile \
  	  libmelt-ana-tree \
  	  meltbuild-sources \
  	  meltbuild-modules \
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:700/634 failed to generate C++ code of library libmelt-ana-tree
    else
        meltbuild_info melt-build-script.tpl:702/635 DONT emit library C++ code for libmelt-ana-tree
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-tree.meltmod-$meltlib_ANA_TREE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:710/636 compiling library module for libmelt-ana-tree quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:712/637 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:719/638 in meltbuild-modules failure to compile library libmelt-ana-tree quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:721/639 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree ; \
  	       meltbuild_error  melt-build-script.tpl:728/640 in meltbuild-modules failed to compile library libmelt-ana-tree quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:731/641 not compiling library module for libmelt-ana-tree quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-tree.meltmod-$meltlib_ANA_TREE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:710/642 compiling library module for libmelt-ana-tree optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:712/643 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree \
  	  || ( meltbuild_notice melt-build-script.tpl:719/644 in meltbuild-modules failure to compile library libmelt-ana-tree optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:721/645 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree ; \
  	       meltbuild_error  melt-build-script.tpl:728/646 in meltbuild-modules failed to compile library libmelt-ana-tree optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:731/647 not compiling library module for libmelt-ana-tree optimized
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-tree.meltmod-$meltlib_ANA_TREE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:710/648 compiling library module for libmelt-ana-tree debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:712/649 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree \
  	  || ( meltbuild_notice melt-build-script.tpl:719/650 in meltbuild-modules failure to compile library libmelt-ana-tree debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:721/651 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree ; \
  	       meltbuild_error  melt-build-script.tpl:728/652 in meltbuild-modules failed to compile library libmelt-ana-tree debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:731/653 not compiling library module for libmelt-ana-tree debugnoline
    fi
   
  
  
    ## meltbuild_do_library libmelt-ana-gimple melt-build-script.tpl:681/654
    meltbuild_info melt-build-script.tpl:682/655 doing library libmelt-ana-gimple
    ...
    ## meltbuild_do_library libmelt-ana-gimple melt-build-script.tpl:686/656
   ...
   -o meltbuild-sources/libmelt-ana-tree+meltdesc.c -ot meltbuild-sources/libmelt-ana-gimple+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:692/657 emit library C++ code for libmelt-ana-gimple
        meltbuild_emit melt-build-script.tpl:693/658 \
  	  translatefile \
  	  libmelt-ana-gimple \
  	  meltbuild-sources \
  	  meltbuild-modules \
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:700/659 failed to generate C++ code of library libmelt-ana-gimple
    else
        meltbuild_info melt-build-script.tpl:702/660 DONT emit library C++ code for libmelt-ana-gimple
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-gimple.meltmod-$meltlib_ANA_GIMPLE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:710/661 compiling library module for libmelt-ana-gimple quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:712/662 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:719/663 in meltbuild-modules failure to compile library libmelt-ana-gimple quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:721/664 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple ; \
  	       meltbuild_error  melt-build-script.tpl:728/665 in meltbuild-modules failed to compile library libmelt-ana-gimple quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:731/666 not compiling library module for libmelt-ana-gimple quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-gimple.meltmod-$meltlib_ANA_GIMPLE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:710/667 compiling library module for libmelt-ana-gimple optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:712/668 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple \
  	  || ( meltbuild_notice melt-build-script.tpl:719/669 in meltbuild-modules failure to compile library libmelt-ana-gimple optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:721/670 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple ; \
  	       meltbuild_error  melt-build-script.tpl:728/671 in meltbuild-modules failed to compile library libmelt-ana-gimple optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:731/672 not compiling library module for libmelt-ana-gimple optimized
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-gimple.meltmod-$meltlib_ANA_GIMPLE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:710/673 compiling library module for libmelt-ana-gimple debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:712/674 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple \
  	  || ( meltbuild_notice melt-build-script.tpl:719/675 in meltbuild-modules failure to compile library libmelt-ana-gimple debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:721/676 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple ; \
  	       meltbuild_error  melt-build-script.tpl:728/677 in meltbuild-modules failed to compile library libmelt-ana-gimple debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:731/678 not compiling library module for libmelt-ana-gimple debugnoline
    fi
   
  
    ## meltbuild_do_library  melt-build-script.tpl:735/679
  ...
  meltbuild_info melt-build-script.tpl:748/680 times after library at `date '+%x %H:%M:%S'`: ;  times >&2
} ## end function meltbuild_do_library  melt-build-script.tpl:749/681


function meltbuild_do_an_extra () {
  xtrabase=$1
  meltbuild_notice 'start doing an extra'  melt-build-script.tpl:754/682 doing an xtra $xtrabase
  ...
  if [ ! -f meltbuild-sources/$xtrabase.cc -o  ! -f meltbuild-sources/$xtrabase+meltdesc.c \
  	 ...
  	 ; then
      meltbuild_info melt-build-script.tpl:765/683 emit extra C++ code for $xtrabase
      meltbuild_emit melt-build-script.tpl:766/684 \
  	  translatefile \
  	  $xtrabase \
  	  meltbuild-sources \
  	  meltbuild-modules \
    ...
    "" \
  	  || meltbuild_error melt-build-script.tpl:773/685 failed to generate C++ code of $xtrabase
  else
      meltbuild_info melt-build-script.tpl:775/686 DONT emit extra C++ code for $xtrabase
  fi

  
  # do_an_extra flavor quicklybuilt  melt-build-script.tpl:779/687      
  if [ ! -f meltbuild-modules/$xtrabase.meltmod-$meltlib__cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:784/688 compiling extra module for $xtrabase quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:786/689 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:793/690 in meltbuild-modules failure to compile extra $xtrabase quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:795/691 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/$xtrabase \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/$xtrabase ; \
  	       meltbuild_error  melt-build-script.tpl:802/692 in meltbuild-modules failed to compile library $xtrabase quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
      meltbuild_info melt-build-script.tpl:805/693 not compiling extra module for $xtrabase quicklybuilt
  fi
  
  # do_an_extra flavor optimized  melt-build-script.tpl:779/694      
  if [ ! -f meltbuild-modules/$xtrabase.meltmod-$meltlib__cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:784/695 compiling extra module for $xtrabase optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:786/696 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/$xtrabase \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/$xtrabase \
  	  || ( meltbuild_notice melt-build-script.tpl:793/697 in meltbuild-modules failure to compile extra $xtrabase optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:795/698 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/$xtrabase \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/$xtrabase ; \
  	       meltbuild_error  melt-build-script.tpl:802/699 in meltbuild-modules failed to compile library $xtrabase optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
      meltbuild_info melt-build-script.tpl:805/700 not compiling extra module for $xtrabase optimized
  fi
  
  # do_an_extra flavor debugnoline  melt-build-script.tpl:779/701      
  if [ ! -f meltbuild-modules/$xtrabase.meltmod-$meltlib__cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:784/702 compiling extra module for $xtrabase debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:786/703 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/$xtrabase \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/$xtrabase \
  	  || ( meltbuild_notice melt-build-script.tpl:793/704 in meltbuild-modules failure to compile extra $xtrabase debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:795/705 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/$xtrabase \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/$xtrabase ; \
  	       meltbuild_error  melt-build-script.tpl:802/706 in meltbuild-modules failed to compile library $xtrabase debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
      meltbuild_info melt-build-script.tpl:805/707 not compiling extra module for $xtrabase debugnoline
  fi
...
if [ ! -f  "$melt_final_library_stamp" \
 ...
 -o "$melt_final_library_stamp" -ot "$GCCMELT_MELTSOURCEDIR/libmelt-ana-gimple.melt" \
    ...
    meltbuild_info melt-build-script.tpl:815/708 building MELT library
    meltbuild_do_library
    
    ## do an extra xtramelt-probe  melt-build-script.tpl:818/709 
    meltbuild_do_an_extra xtramelt-probe
    
    ## do an extra xtramelt-ana-simple  melt-build-script.tpl:818/710 
    meltbuild_do_an_extra xtramelt-ana-simple
    
    ## do an extra xtramelt-playground  melt-build-script.tpl:818/711 
    meltbuild_do_an_extra xtramelt-playground
    
else
    meltbuild_info melt-build-script.tpl:822/712 not building MELT library because of libstamp  "$melt_final_library_stamp"
fi

################################################################
#@ melt-build-script.tpl:826/713
if [ "$melt_overall_goal" = "library" ]; then
    meltbuild_info melt-build-script.tpl:828/714 done library overall goal with stamp  $melt_final_translator_stamp
    meltbuild_notice 'Done library' melt-build-script.tpl:829/715 library overall goal 
    exit 0
fi

################################################################
################################################################
### the modules lists melt-build-script.tpl:835/716
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis" \
  ...
  #  melt-build-script.tpl:840/717 module list quicklybuilt
  meltbuild_info  melt-build-script.tpl:841/718 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"
  ...
  echo "# MELT translator modules:" >> $melt_modlis_temp
  #  melt-build-script.tpl:845/719 module list quicklybuilt translator
  ...
  #  melt-build-script.tpl:849/720 module list quicklybuilt library
  ...
  #  melt-build-script.tpl:854/721 module list quicklybuilt extra, with mode condition
 echo "# MELT extra modules with mode condition:" >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-probe\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-probe.melt ] || meltbuild_error  melt-build-script.tpl:858/722 missing or empty meltbuild-sources/xtramelt-probe.melt
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-probe.quicklybuilt\n", $2);}} END{printf("# %d MELT modes in xtramelt-probe\n", nbmod);}' meltbuild-sources/xtramelt-probe.melt | sort -u >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-ana-simple\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-ana-simple.melt ] || meltbuild_error  melt-build-script.tpl:858/723 missing or empty meltbuild-sources/xtramelt-ana-simple.melt
 ...
 [ -s  meltbuild-sources/xtramelt-playground.melt ] || meltbuild_error  melt-build-script.tpl:858/724 missing or empty meltbuild-sources/xtramelt-playground.melt
 ...
 echo "# end MELT module list $MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis" >> $melt_modlis_temp
  ...
  meltbuild_info  melt-build-script.tpl:864/725 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" \
  ...
  #  melt-build-script.tpl:840/726 module list optimized
  meltbuild_info  melt-build-script.tpl:841/727 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"
  ...
  echo "# MELT translator modules:" >> $melt_modlis_temp
  #  melt-build-script.tpl:845/728 module list optimized translator
  ...
  #  melt-build-script.tpl:849/729 module list optimized library
  echo "# MELT library modules:" >> $melt_modlis_temp
  ...
  #  melt-build-script.tpl:854/730 module list optimized extra, with mode condition
 echo "# MELT extra modules with mode condition:" >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-probe\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-probe.melt ] || meltbuild_error  melt-build-script.tpl:858/731 missing or empty meltbuild-sources/xtramelt-probe.melt
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-probe.optimized\n", $2);}} END{printf("# %d MELT modes in xtramelt-probe\n", nbmod);}' meltbuild-sources/xtramelt-probe.melt | sort -u >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-ana-simple\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-ana-simple.melt ] || meltbuild_error  melt-build-script.tpl:858/732 missing or empty meltbuild-sources/xtramelt-ana-simple.melt
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-ana-simple.optimized\n", $2);}} END{printf("# %d MELT modes in xtramelt-ana-simple\n", nbmod);}' meltbuild-sources/xtramelt-ana-simple.melt | sort -u >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-playground\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-playground.melt ] || meltbuild_error  melt-build-script.tpl:858/733 missing or empty meltbuild-sources/xtramelt-playground.melt
 ...
 echo "# end MELT module list $MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" >> $melt_modlis_temp
  ...
  meltbuild_info  melt-build-script.tpl:864/734 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" \
  ...
  #  melt-build-script.tpl:840/735 module list debugnoline
  meltbuild_info  melt-build-script.tpl:841/736 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"
  ...
  echo "# MELT translator modules:" >> $melt_modlis_temp
  #  melt-build-script.tpl:845/737 module list debugnoline translator
  ...
  #  melt-build-script.tpl:849/738 module list debugnoline library
  echo "# MELT library modules:" >> $melt_modlis_temp
  ...
  #  melt-build-script.tpl:854/739 module list debugnoline extra, with mode condition
 echo "# MELT extra modules with mode condition:" >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-probe\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-probe.melt ] || meltbuild_error  melt-build-script.tpl:858/740 missing or empty meltbuild-sources/xtramelt-probe.melt
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-probe.debugnoline\n", $2);}} END{printf("# %d MELT modes in xtramelt-probe\n", nbmod);}' meltbuild-sources/xtramelt-probe.melt | sort -u >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-ana-simple\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-ana-simple.melt ] || meltbuild_error  melt-build-script.tpl:858/741 missing or empty meltbuild-sources/xtramelt-ana-simple.melt
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-ana-simple.debugnoline\n", $2);}} END{printf("# %d MELT modes in xtramelt-ana-simple\n", nbmod);}' meltbuild-sources/xtramelt-ana-simple.melt | sort -u >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-playground\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-playground.melt ] || meltbuild_error  melt-build-script.tpl:858/742 missing or empty meltbuild-sources/xtramelt-playground.melt
 ...
 echo "# end MELT module list $MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" >> $melt_modlis_temp
  ...
  meltbuild_info  melt-build-script.tpl:864/743 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"  
fi


#@ melt-build-script.tpl:868/744
...
################################################################
#@ melt-build-script.tpl:874/745 module lists
if [ "$melt_overall_goal" = "modlists" ]; then
    meltbuild_info melt-build-script.tpl:876/746 done modlists overall goal with stamp  $melt_final_library_stamp
    exit 0
fi
...
########################### EXTRA ############################
################
#@ melt-build-script.tpl:884/747 before extra libmelt* modules
################################################################
meltbuild_info melt-build-script.tpl:886/748 before extra GCCMELT_SKIPEMITC=$GCCMELT_SKIPEMITC.

meltbuild_info melt-build-script.tpl:888/749 times before extras at `date '+%x %H:%M:%S'`: ;  times >&2
...
function meltbuild_do_extras () {
  meltbuild_notice 'start doing extras'  melt-build-script.tpl:895/750 doing extras 
  
  
    ## meltbuild_do_extras xtramelt-probe melt-build-script.tpl:898/751
    meltbuild_info melt-build-script.tpl:899/752 doing extra xtramelt-probe
    ...
    ## meltbuild_do_extras xtramelt-probe melt-build-script.tpl:903/753
    if [ ! -f meltbuild-sources/xtramelt-probe.cc -o  ! -f meltbuild-sources/xtramelt-probe+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:908/754 emit extra C++ code for xtramelt-probe
        meltbuild_emit melt-build-script.tpl:909/755 \
  	  translatefile \
  	  xtramelt-probe \
  	  meltbuild-sources \
  	  meltbuild-modules \
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:916/756 failed to generate C++ code of extra xtramelt-probe
    else
        meltbuild_info melt-build-script.tpl:918/757 DONT emit extra C++ code for xtramelt-probe
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltextra_PROBE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:926/758 compiling extra module for xtramelt-probe quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:928/759 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:935/760 in meltbuild-modules failure to compile extra xtramelt-probe quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:937/761 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe ; \
  	       meltbuild_error  melt-build-script.tpl:944/762 in meltbuild-modules failed to compile extra xtramelt-probe quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:947/763 not compiling extra module for xtramelt-probe quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltextra_PROBE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:926/764 compiling extra module for xtramelt-probe optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:928/765 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
  	  || ( meltbuild_notice melt-build-script.tpl:935/766 in meltbuild-modules failure to compile extra xtramelt-probe optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:937/767 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe ; \
  	       meltbuild_error  melt-build-script.tpl:944/768 in meltbuild-modules failed to compile extra xtramelt-probe optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:947/769 not compiling extra module for xtramelt-probe optimized
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltextra_PROBE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:926/770 compiling extra module for xtramelt-probe debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:928/771 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
  	  || ( meltbuild_notice melt-build-script.tpl:935/772 in meltbuild-modules failure to compile extra xtramelt-probe debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:937/773 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe ; \
  	       meltbuild_error  melt-build-script.tpl:944/774 in meltbuild-modules failed to compile extra xtramelt-probe debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:947/775 not compiling extra module for xtramelt-probe debugnoline
    fi
   
   ## meltbuild_do_extras after build xtramelt-probe melt-build-script.tpl:950/776
   
   
  
    ## meltbuild_do_extras xtramelt-ana-simple melt-build-script.tpl:898/777
    meltbuild_info melt-build-script.tpl:899/778 doing extra xtramelt-ana-simple
    ...
    ## meltbuild_do_extras xtramelt-ana-simple melt-build-script.tpl:903/779
    if [ ! -f meltbuild-sources/xtramelt-ana-simple.cc -o  ! -f meltbuild-sources/xtramelt-ana-simple+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:908/780 emit extra C++ code for xtramelt-ana-simple
        meltbuild_emit melt-build-script.tpl:909/781 \
  	  translatefile \
  	  xtramelt-ana-simple \
  	  meltbuild-sources \
  	  meltbuild-modules \
  	  warmelt-first.optimized:warmelt-base.optimized:warmelt-debug.optimized:warmelt-macro.optimized:warmelt-moremacro.optimized:warmelt-normal.optimized:warmelt-normatch.optimized:warmelt-genobj.optimized:warmelt-outobj.optimized:warmelt-hooks.optimized:warmelt-modes.optimized:libmelt-ana-base.optimized:libmelt-ana-tree.optimized:libmelt-ana-gimple.optimized \
      "" \
  	  || meltbuild_error melt-build-script.tpl:916/782 failed to generate C++ code of extra xtramelt-ana-simple
    else
        meltbuild_info melt-build-script.tpl:918/783 DONT emit extra C++ code for xtramelt-ana-simple
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltextra_ANA_SIMPLE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:926/784 compiling extra module for xtramelt-ana-simple quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:928/785 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:935/786 in meltbuild-modules failure to compile extra xtramelt-ana-simple quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:937/787 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:944/788 in meltbuild-modules failed to compile extra xtramelt-ana-simple quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:947/789 not compiling extra module for xtramelt-ana-simple quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltextra_ANA_SIMPLE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:926/790 compiling extra module for xtramelt-ana-simple optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:928/791 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
  	  || ( meltbuild_notice melt-build-script.tpl:935/792 in meltbuild-modules failure to compile extra xtramelt-ana-simple optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:937/793 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:944/794 in meltbuild-modules failed to compile extra xtramelt-ana-simple optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:947/795 not compiling extra module for xtramelt-ana-simple optimized
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltextra_ANA_SIMPLE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:926/796 compiling extra module for xtramelt-ana-simple debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:928/797 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
  	  || ( meltbuild_notice melt-build-script.tpl:935/798 in meltbuild-modules failure to compile extra xtramelt-ana-simple debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:937/799 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:944/800 in meltbuild-modules failed to compile extra xtramelt-ana-simple debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:947/801 not compiling extra module for xtramelt-ana-simple debugnoline
    fi
   
   ## meltbuild_do_extras after build xtramelt-ana-simple melt-build-script.tpl:950/802
   
   
  
    ## meltbuild_do_extras xtramelt-playground melt-build-script.tpl:898/803
    meltbuild_info melt-build-script.tpl:899/804 doing extra xtramelt-playground
    ...
    ## meltbuild_do_extras xtramelt-playground melt-build-script.tpl:903/805
    if [ ! -f meltbuild-sources/xtramelt-playground.cc -o  ! -f meltbuild-sources/xtramelt-playground+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:908/806 emit extra C++ code for xtramelt-playground
        meltbuild_emit melt-build-script.tpl:909/807 \
  	  translatefile \
  	  xtramelt-playground \
  	  meltbuild-sources \
  	  meltbuild-modules \
  	  warmelt-first.optimized:warmelt-base.optimized:warmelt-debug.optimized:warmelt-macro.optimized:warmelt-moremacro.optimized:warmelt-normal.optimized:warmelt-normatch.optimized:warmelt-genobj.optimized:warmelt-outobj.optimized:warmelt-hooks.optimized:warmelt-modes.optimized:libmelt-ana-base.optimized:libmelt-ana-tree.optimized:libmelt-ana-gimple.optimized \
      "" \
  	  || meltbuild_error melt-build-script.tpl:916/808 failed to generate C++ code of extra xtramelt-playground
    else
        meltbuild_info melt-build-script.tpl:918/809 DONT emit extra C++ code for xtramelt-playground
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltextra_PLAYGROUND_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:926/810 compiling extra module for xtramelt-playground quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:928/811 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:935/812 in meltbuild-modules failure to compile extra xtramelt-playground quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:937/813 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:944/814 in meltbuild-modules failed to compile extra xtramelt-playground quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:947/815 not compiling extra module for xtramelt-playground quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltextra_PLAYGROUND_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:926/816 compiling extra module for xtramelt-playground optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:928/817 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
  	  || ( meltbuild_notice melt-build-script.tpl:935/818 in meltbuild-modules failure to compile extra xtramelt-playground optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:937/819 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:944/820 in meltbuild-modules failed to compile extra xtramelt-playground optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:947/821 not compiling extra module for xtramelt-playground optimized
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltextra_PLAYGROUND_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:926/822 compiling extra module for xtramelt-playground debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:928/823 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
  	  || ( meltbuild_notice melt-build-script.tpl:935/824 in meltbuild-modules failure to compile extra xtramelt-playground debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:937/825 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:944/826 in meltbuild-modules failed to compile extra xtramelt-playground debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:947/827 not compiling extra module for xtramelt-playground debugnoline
    fi
   
   ## meltbuild_do_extras after build xtramelt-playground melt-build-script.tpl:950/828
   
   
 
   ## meltbuild_do_extras timestamping  melt-build-script.tpl:954/829
   ...
   ## meltbuild_do_extras end extra xtramelt-probe melt-build-script.tpl:964/830
   ...
   ## meltbuild_do_extras end extra xtramelt-ana-simple melt-build-script.tpl:964/831
   ...
   ## meltbuild_do_extras end extra xtramelt-playground melt-build-script.tpl:964/832
 
   

    ## meltbuild_do_extras final  melt-build-script.tpl:968/833
    echo "///end stamp $melt_final_extra_stamp"  >> $meltextrastamptemp
    $GCCMELT_MOVE_IF_CHANGE $meltextrastamptemp  $melt_final_extra_stamp
  meltbuild_info melt-build-script.tpl:971/834 times after extras at `date '+%x %H:%M:%S'`: ;  times >&2
} ## end function meltbuild_do_extras  melt-build-script.tpl:972/835

 ## building extras melt-build-script.tpl:974/836
if [ ! -f  "$melt_final_extra_stamp" \
 ...
 -o "$melt_final_extra_stamp" -ot "$GCCMELT_MELTSOURCEDIR/xtramelt-playground.melt" \
    ...
    meltbuild_info melt-build-script.tpl:980/837 building MELT extras
    meltbuild_do_extras
else
    meltbuild_info melt-build-script.tpl:983/838 not building MELT extra because of xtrastamp  "$melt_final_extra_stamp"
fi
 ## done building extras melt-build-script.tpl:985/839


################################################################
################################################################
#@ melt-build-script.tpl:990/840 runtime self check

##  melt-build-script.tpl:992/841 FIXME: should skip that when cross-compiler MELT plugin..

if [ -z "$GCCMELT_RUNTIME_CC" ]; then 
    meltbuild_error melt-build-script.tpl:995/842 failed because no GCCMELT_RUNTIME_CC shell variable
    exit 1
fi
...
if [ ! -f $meltcheckruntime_stamp -o $meltcheckruntime_stamp -ot "$GCCMELT_RUNTIME_ARGS" \
    ...
    #@ melt-build-script.tpl:1003/843 checkruntime
    if [ -f melt-no-check-runtime -o -n "$MELTGCC_NO_CHECK_RUNTIME" -o ! -f melt-runtime.ii ]; then
	meltbuild_info melt-build-script.tpl:1005/844 skipping check of MELT runtime
    else
	meltcheckruntime_args=meltbuild-checkruntime.args 
	meltcheckruntime_argstemp=$meltcheckruntime_args-tmp$$
	echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:1009/845"' ' -DGCCMELT_CHECKMELTRUNTIME' > $meltcheckruntime_argstemp
	...
	[ -f "$meltcheckruntime_args" ] || meltbuild_error  melt-build-script.tpl:1020/846 missing check runtime args  "$meltcheckruntime_args"
	meltbuild_info melt-build-script.tpl:1021/847 $meltcheckruntime_args  is
	...
	if [ -n "$MELTGCCBUILTIN_BUILD_WITH_CXX" ]; then
		...
		|| meltbuild_error melt-build-script.tpl:1025/848 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	else
	    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltcheckruntime_args \
		|| meltbuild_error melt-build-script.tpl:1028/849 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	fi
	meltbuild_info melt-build-script.tpl:1030/850 done check runtime with $meltcheckruntime_args
    fi

   #@ melt-build-script.tpl:1033/851 checkhello
    meltcheckhelloworld_args=meltbuild-checkhelloworld.args 
    meltcheckhelloworld_argstemp=$meltcheckhelloworld_args-tmp$$
    echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:1036/852" -DGCCMELT_CHECKHELLO' > $meltcheckhelloworld_argstemp
    ...
    [ -f "$meltcheckhelloworld_args" ] || meltbuild_error  melt-build-script.tpl:1050/853 missing check helloworld args  "$meltcheckhelloworld_args"
   meltbuild_info melt-build-script.tpl:1051/854 $meltcheckhelloworld_args  is
   cat $meltcheckhelloworld_args < /dev/null >&2
    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltcheckhelloworld_args \
	|| meltbuild_error melt-build-script.tpl:1054/855 running helloworld failed with arguments @$meltcheckhelloworld_args
   meltbuild_info melt-build-script.tpl:1055/856 done check helloworld with $meltcheckhelloworld_args
   #@ melt-build-script.tpl:1056/857 runtime stamp
    meltcheckruntime_stamptemp=$meltcheckruntime_stamp-tmp$$
    [ -f "$GCCMELT_RUNTIME_CC" ] || meltbuild_error melt-build-script.tpl:1058/858 missing MELT runtime C++ file $GCCMELT_RUNTIME_CC
    ...
    [ -f "$melt_final_translator_stamp" ] || meltbuild_error melt-build-script.tpl:1063/859 missing final translator stamp "$melt_final_translator_stamp"
    [ -f "$melt_final_library_stamp" ] || meltbuild_error melt-build-script.tpl:1064/860 missing final library stamp "$melt_final_library_stamp"
    ...
    echo
    #@ melt-build-script.tpl:1069/861 justcount
    meltjustcount_args=meltbuild-justcount.args
    meltjustcount_argstemp=$meltjustcount_args-tmp$$
    echo  ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:1072/862" -DGCCMELT_JUSTCOUNT -fexceptions melt-runtime.ii ' > $meltjustcount_argstemp
    ...
    [ -f "$meltjustcount_args" ] || meltbuild_error  melt-build-script.tpl:1083/863 missing check justcount args  "$meltjustcount_args"
   meltbuild_info melt-build-script.tpl:1084/864 $meltjustcount_args  is
   cat $meltjustcount_args < /dev/null >&2
   echo
   $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltjustcount_args \
	|| meltbuild_error melt-build-script.tpl:1088/865 running justcount failed with arguments @$meltjustcount_args
   meltbuild_info melt-build-script.tpl:1089/866 done check justcount with $meltjustcount_args
   echo

   $GCCMELT_MOVE_IF_CHANGE  $meltcheckruntime_stamptemp $meltcheckruntime_stamp
   meltbuild_info melt-build-script.tpl:1093/867 done check runtime  $meltcheckruntime_stamp
    
else
    meltbuild_info melt-build-script.tpl:1096/868 keeping runtime checks  $meltcheckruntime_stamp
fi

if [ "$melt_overall_goal" = "checkruntime" ]; then
    meltbuild_info melt-build-script.tpl:1100/869 done checkruntime overall goal with stamp  $meltcheckruntime_stamp
    exit 0
fi

################################################################
#@ melt-build-script.tpl:1105/870
if [ "$melt_overall_goal" = "applications" ]; then
    meltbuild_info melt-build-script.tpl:1107/871 done applications overall goal with stamp  $meltcheckruntime_stamp
    exit 0
fi

################################################################
################################################################
### the generated documentation meltgendoc.texi melt-build-script.tpl:1113/872
...
if [   ! -f meltgendoc.texi  -o meltbuild-sources/warmelt-first.melt -nt meltgendoc.texi  \
 ...
 -o meltbuild-sources/libmelt-ana-gimple.melt -nt meltgendoc.texi   ]; then
   meltbuild_info melt-build-script.tpl:1117/873 generating meltgendoc.texi
   meltgen_args=meltbuild-gendoc.args-tmp$$
   echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:1119/874"' > $meltgen_args
...
meltbuild_arg "module-makefile=\"$GCCMELT_MODULE_MK\""  >>  $meltgen_args
   ...
   meltbuild_info melt-build-script.tpl:1133/875  meltbuild-gendoc.args is
   cat meltbuild-gendoc.args < /dev/null >&2
   $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @meltbuild-gendoc.args \
     || meltbuild_error melt-build-script.tpl:1136/876  "$GCCMELT_CC1PLUS" failed with arguments @meltbuild-gendoc.args
else
   meltbuild_info melt-build-script.tpl:1138/877 keeping meltgendoc.texi
fi

################
meltbuild_info melt-build-script.tpl:1142/878 successfully done with times at `date '+%x %H:%M:%S'`: ; times >&2

################################################################
#@ melt-build-script.tpl:1145/879
if [ "$melt_overall_goal" = "gendoc" ]; then
    meltbuild_info melt-build-script.tpl:1147/880 done gendoc overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

## #@ melt-build-script.tpl:1151/881 if we get here something is wrong in this script
meltbuild_error  melt-build-script.tpl:1152/882 unexpected MELT overall goal "$melt_overall_goal" buggy melt-build-script.tpl
#@ eof melt-build-script.tpl:1153/883 end of generated melt-build-script.sh
