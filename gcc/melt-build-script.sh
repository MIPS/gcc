...
#@#@#
#@#@# It has been AutoGen-ed  September 14, 2014 at 10:22:09 AM by AutoGen 5.18.3
...
if [ ! -f "$GCCMELT_RUNTIME_DEPENDENCY" ]; then
    meltbuild_error  melt-build-script.tpl:113/6 missing MELT runtime dependency "$GCCMELT_RUNTIME_DEPENDENCY" 
fi

if [ -z "$GCCMELT_CC1PLUS" ]; then
   meltbuild_error  melt-build-script.tpl:117/7 missing GCCMELT_CC1PLUS
fi

if [ ! -f meltrunsup.h ]; then 
    meltbuild_symlink $GCCMELT_MELTSOURCEDIR/generated/meltrunsup.h meltrunsup.h 
    meltbuild_info  melt-build-script.tpl:122/8 symlinking meltrunsup.h header
fi
...
case $melt_overall_goal in
    ...
    gendoc) ;;
    regenerate) ;;
    *) meltbuild_error  melt-build-script.tpl:135/9 bad MELT overall goal "$melt_overall_goal:" \
...
## The base name of the MELT translator files melt-build-script.tpl:144/10
...
case $GCCMELT_ZERO_FLAVOR in
    ...
    debugnoline) ;;
    quicklybuilt) ;;
    *) meltbuild_error  melt-build-script.tpl:152/11 bad zero flavor $GCCMELT_ZERO_FLAVOR ;;
esac


## our stage0 melt-build-script.tpl:156/12

[ -d $GCCMELT_STAGE_ZERO ] || mkdir  $GCCMELT_STAGE_ZERO


function meltbuild_do_stage_zero () {
meltbuild_notice STAGE0+  melt-build-script.tpl:162/13 starting stage zero


  meltbuild_info making stage0 warmelt-first  melt-build-script.tpl:165/14

##  stage0 melt-build-script.tpl:167/15 symlink descriptor file warmelt-first
...
##  stage0 melt-build-script.tpl:172/16 symlink melt/generated source code warmelt-first
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-first.cc" ]; then
      meltbuild_info making stage0 warmelt-first symlinking sources melt-build-script.tpl:174/17
...
##  stage0 melt-build-script.tpl:181/18 symlink stamp warmelt-first
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-first+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-first symlinking timestamp melt-build-script.tpl:183/19
...
## manually generate the stage0 warmelt-first+meltbuild.mk file  melt-build-script.tpl:190/20
  ...
  echo "# generated " melt-build-script.tpl:194/21 >> $MELT_ZERO_GENERATED_FIRST_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-first melt-build-script.tpl:198/22' >> $MELT_ZERO_GENERATED_FIRST_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_FIRST_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-first melt-build-script.tpl:206/23'  >> $MELT_ZERO_GENERATED_FIRST_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:219/24 generated stagezero makedep $MELT_ZERO_GENERATED_FIRST_BUILDMK
  ls -l $MELT_ZERO_GENERATED_FIRST_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:223/25 \
      ...
      || meltbuild_error  melt-build-script.tpl:233/26 stage0 warmelt-first did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:235/27 stage0 warmelt-first module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-first.meltmod-$MELT_ZERO_GENERATED_FIRST_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:237/28 stage0 warmelt-first fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-first.meltmod-$MELT_ZERO_GENERATED_FIRST_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:240/29 successfully build stage0 warmelt-first
# end stage0  melt-build-script.tpl:241/30 base  warmelt-first

  meltbuild_info making stage0 warmelt-base  melt-build-script.tpl:165/31

##  stage0 melt-build-script.tpl:167/32 symlink descriptor file warmelt-base
...
##  stage0 melt-build-script.tpl:172/33 symlink melt/generated source code warmelt-base
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-base.cc" ]; then
      meltbuild_info making stage0 warmelt-base symlinking sources melt-build-script.tpl:174/34
...
##  stage0 melt-build-script.tpl:181/35 symlink stamp warmelt-base
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-base+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-base symlinking timestamp melt-build-script.tpl:183/36
...
## manually generate the stage0 warmelt-base+meltbuild.mk file  melt-build-script.tpl:190/37
  ...
  echo "# generated " melt-build-script.tpl:194/38 >> $MELT_ZERO_GENERATED_BASE_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-base melt-build-script.tpl:198/39' >> $MELT_ZERO_GENERATED_BASE_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_BASE_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-base melt-build-script.tpl:206/40'  >> $MELT_ZERO_GENERATED_BASE_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:219/41 generated stagezero makedep $MELT_ZERO_GENERATED_BASE_BUILDMK
  ls -l $MELT_ZERO_GENERATED_BASE_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:223/42 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:233/43 stage0 warmelt-base did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:235/44 stage0 warmelt-base module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-base.meltmod-$MELT_ZERO_GENERATED_BASE_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:237/45 stage0 warmelt-base fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-base.meltmod-$MELT_ZERO_GENERATED_BASE_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:240/46 successfully build stage0 warmelt-base
# end stage0  melt-build-script.tpl:241/47 base  warmelt-base

  meltbuild_info making stage0 warmelt-debug  melt-build-script.tpl:165/48

##  stage0 melt-build-script.tpl:167/49 symlink descriptor file warmelt-debug
...
##  stage0 melt-build-script.tpl:172/50 symlink melt/generated source code warmelt-debug
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-debug.cc" ]; then
      meltbuild_info making stage0 warmelt-debug symlinking sources melt-build-script.tpl:174/51
...
##  stage0 melt-build-script.tpl:181/52 symlink stamp warmelt-debug
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-debug+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-debug symlinking timestamp melt-build-script.tpl:183/53
...
## manually generate the stage0 warmelt-debug+meltbuild.mk file  melt-build-script.tpl:190/54
  ...
  echo "# generated " melt-build-script.tpl:194/55 >> $MELT_ZERO_GENERATED_DEBUG_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-debug melt-build-script.tpl:198/56' >> $MELT_ZERO_GENERATED_DEBUG_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_DEBUG_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-debug melt-build-script.tpl:206/57'  >> $MELT_ZERO_GENERATED_DEBUG_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:219/58 generated stagezero makedep $MELT_ZERO_GENERATED_DEBUG_BUILDMK
  ls -l $MELT_ZERO_GENERATED_DEBUG_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:223/59 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:233/60 stage0 warmelt-debug did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:235/61 stage0 warmelt-debug module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-debug.meltmod-$MELT_ZERO_GENERATED_DEBUG_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:237/62 stage0 warmelt-debug fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-debug.meltmod-$MELT_ZERO_GENERATED_DEBUG_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:240/63 successfully build stage0 warmelt-debug
# end stage0  melt-build-script.tpl:241/64 base  warmelt-debug

  meltbuild_info making stage0 warmelt-macro  melt-build-script.tpl:165/65

##  stage0 melt-build-script.tpl:167/66 symlink descriptor file warmelt-macro
...
##  stage0 melt-build-script.tpl:172/67 symlink melt/generated source code warmelt-macro
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-macro.cc" ]; then
      meltbuild_info making stage0 warmelt-macro symlinking sources melt-build-script.tpl:174/68
...
##  stage0 melt-build-script.tpl:181/69 symlink stamp warmelt-macro
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-macro+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-macro symlinking timestamp melt-build-script.tpl:183/70
...
## manually generate the stage0 warmelt-macro+meltbuild.mk file  melt-build-script.tpl:190/71
  ...
  echo "# generated " melt-build-script.tpl:194/72 >> $MELT_ZERO_GENERATED_MACRO_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-macro melt-build-script.tpl:198/73' >> $MELT_ZERO_GENERATED_MACRO_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_MACRO_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-macro melt-build-script.tpl:206/74'  >> $MELT_ZERO_GENERATED_MACRO_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:219/75 generated stagezero makedep $MELT_ZERO_GENERATED_MACRO_BUILDMK
  ls -l $MELT_ZERO_GENERATED_MACRO_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:223/76 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:233/77 stage0 warmelt-macro did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:235/78 stage0 warmelt-macro module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-macro.meltmod-$MELT_ZERO_GENERATED_MACRO_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:237/79 stage0 warmelt-macro fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-macro.meltmod-$MELT_ZERO_GENERATED_MACRO_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:240/80 successfully build stage0 warmelt-macro
# end stage0  melt-build-script.tpl:241/81 base  warmelt-macro

  meltbuild_info making stage0 warmelt-moremacro  melt-build-script.tpl:165/82

##  stage0 melt-build-script.tpl:167/83 symlink descriptor file warmelt-moremacro
...
##  stage0 melt-build-script.tpl:172/84 symlink melt/generated source code warmelt-moremacro
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-moremacro.cc" ]; then
      meltbuild_info making stage0 warmelt-moremacro symlinking sources melt-build-script.tpl:174/85
...
##  stage0 melt-build-script.tpl:181/86 symlink stamp warmelt-moremacro
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-moremacro+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-moremacro symlinking timestamp melt-build-script.tpl:183/87
...
## manually generate the stage0 warmelt-moremacro+meltbuild.mk file  melt-build-script.tpl:190/88
  ...
  echo "# generated " melt-build-script.tpl:194/89 >> $MELT_ZERO_GENERATED_MOREMACRO_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-moremacro melt-build-script.tpl:198/90' >> $MELT_ZERO_GENERATED_MOREMACRO_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_MOREMACRO_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-moremacro melt-build-script.tpl:206/91'  >> $MELT_ZERO_GENERATED_MOREMACRO_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:219/92 generated stagezero makedep $MELT_ZERO_GENERATED_MOREMACRO_BUILDMK
  ls -l $MELT_ZERO_GENERATED_MOREMACRO_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:223/93 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:233/94 stage0 warmelt-moremacro did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:235/95 stage0 warmelt-moremacro module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-moremacro.meltmod-$MELT_ZERO_GENERATED_MOREMACRO_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:237/96 stage0 warmelt-moremacro fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-moremacro.meltmod-$MELT_ZERO_GENERATED_MOREMACRO_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:240/97 successfully build stage0 warmelt-moremacro
# end stage0  melt-build-script.tpl:241/98 base  warmelt-moremacro

  meltbuild_info making stage0 warmelt-normal  melt-build-script.tpl:165/99

##  stage0 melt-build-script.tpl:167/100 symlink descriptor file warmelt-normal
...
##  stage0 melt-build-script.tpl:172/101 symlink melt/generated source code warmelt-normal
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-normal.cc" ]; then
      meltbuild_info making stage0 warmelt-normal symlinking sources melt-build-script.tpl:174/102
...
##  stage0 melt-build-script.tpl:181/103 symlink stamp warmelt-normal
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-normal+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-normal symlinking timestamp melt-build-script.tpl:183/104
...
## manually generate the stage0 warmelt-normal+meltbuild.mk file  melt-build-script.tpl:190/105
  ...
  echo "# generated " melt-build-script.tpl:194/106 >> $MELT_ZERO_GENERATED_NORMAL_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-normal melt-build-script.tpl:198/107' >> $MELT_ZERO_GENERATED_NORMAL_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_NORMAL_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-normal melt-build-script.tpl:206/108'  >> $MELT_ZERO_GENERATED_NORMAL_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:219/109 generated stagezero makedep $MELT_ZERO_GENERATED_NORMAL_BUILDMK
  ls -l $MELT_ZERO_GENERATED_NORMAL_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:223/110 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:233/111 stage0 warmelt-normal did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:235/112 stage0 warmelt-normal module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-normal.meltmod-$MELT_ZERO_GENERATED_NORMAL_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:237/113 stage0 warmelt-normal fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-normal.meltmod-$MELT_ZERO_GENERATED_NORMAL_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:240/114 successfully build stage0 warmelt-normal
# end stage0  melt-build-script.tpl:241/115 base  warmelt-normal

  meltbuild_info making stage0 warmelt-normatch  melt-build-script.tpl:165/116

##  stage0 melt-build-script.tpl:167/117 symlink descriptor file warmelt-normatch
...
##  stage0 melt-build-script.tpl:172/118 symlink melt/generated source code warmelt-normatch
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-normatch.cc" ]; then
      meltbuild_info making stage0 warmelt-normatch symlinking sources melt-build-script.tpl:174/119
...
##  stage0 melt-build-script.tpl:181/120 symlink stamp warmelt-normatch
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-normatch+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-normatch symlinking timestamp melt-build-script.tpl:183/121
...
## manually generate the stage0 warmelt-normatch+meltbuild.mk file  melt-build-script.tpl:190/122
  ...
  echo "# generated " melt-build-script.tpl:194/123 >> $MELT_ZERO_GENERATED_NORMATCH_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-normatch melt-build-script.tpl:198/124' >> $MELT_ZERO_GENERATED_NORMATCH_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_NORMATCH_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-normatch melt-build-script.tpl:206/125'  >> $MELT_ZERO_GENERATED_NORMATCH_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:219/126 generated stagezero makedep $MELT_ZERO_GENERATED_NORMATCH_BUILDMK
  ls -l $MELT_ZERO_GENERATED_NORMATCH_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:223/127 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:233/128 stage0 warmelt-normatch did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:235/129 stage0 warmelt-normatch module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-normatch.meltmod-$MELT_ZERO_GENERATED_NORMATCH_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:237/130 stage0 warmelt-normatch fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-normatch.meltmod-$MELT_ZERO_GENERATED_NORMATCH_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:240/131 successfully build stage0 warmelt-normatch
# end stage0  melt-build-script.tpl:241/132 base  warmelt-normatch

  meltbuild_info making stage0 warmelt-genobj  melt-build-script.tpl:165/133

##  stage0 melt-build-script.tpl:167/134 symlink descriptor file warmelt-genobj
...
##  stage0 melt-build-script.tpl:172/135 symlink melt/generated source code warmelt-genobj
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-genobj.cc" ]; then
      meltbuild_info making stage0 warmelt-genobj symlinking sources melt-build-script.tpl:174/136
...
##  stage0 melt-build-script.tpl:181/137 symlink stamp warmelt-genobj
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-genobj+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-genobj symlinking timestamp melt-build-script.tpl:183/138
...
## manually generate the stage0 warmelt-genobj+meltbuild.mk file  melt-build-script.tpl:190/139
  ...
  echo "# generated " melt-build-script.tpl:194/140 >> $MELT_ZERO_GENERATED_GENOBJ_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-genobj melt-build-script.tpl:198/141' >> $MELT_ZERO_GENERATED_GENOBJ_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_GENOBJ_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-genobj melt-build-script.tpl:206/142'  >> $MELT_ZERO_GENERATED_GENOBJ_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:219/143 generated stagezero makedep $MELT_ZERO_GENERATED_GENOBJ_BUILDMK
  ls -l $MELT_ZERO_GENERATED_GENOBJ_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:223/144 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:233/145 stage0 warmelt-genobj did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:235/146 stage0 warmelt-genobj module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-genobj.meltmod-$MELT_ZERO_GENERATED_GENOBJ_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:237/147 stage0 warmelt-genobj fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-genobj.meltmod-$MELT_ZERO_GENERATED_GENOBJ_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:240/148 successfully build stage0 warmelt-genobj
# end stage0  melt-build-script.tpl:241/149 base  warmelt-genobj

  meltbuild_info making stage0 warmelt-outobj  melt-build-script.tpl:165/150

##  stage0 melt-build-script.tpl:167/151 symlink descriptor file warmelt-outobj
...
##  stage0 melt-build-script.tpl:172/152 symlink melt/generated source code warmelt-outobj
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-outobj.cc" ]; then
      meltbuild_info making stage0 warmelt-outobj symlinking sources melt-build-script.tpl:174/153
...
##  stage0 melt-build-script.tpl:181/154 symlink stamp warmelt-outobj
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-outobj+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-outobj symlinking timestamp melt-build-script.tpl:183/155
...
## manually generate the stage0 warmelt-outobj+meltbuild.mk file  melt-build-script.tpl:190/156
  ...
  echo "# generated " melt-build-script.tpl:194/157 >> $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-outobj melt-build-script.tpl:198/158' >> $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-outobj melt-build-script.tpl:206/159'  >> $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:219/160 generated stagezero makedep $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK
  ls -l $MELT_ZERO_GENERATED_OUTOBJ_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:223/161 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:233/162 stage0 warmelt-outobj did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:235/163 stage0 warmelt-outobj module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-outobj.meltmod-$MELT_ZERO_GENERATED_OUTOBJ_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:237/164 stage0 warmelt-outobj fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-outobj.meltmod-$MELT_ZERO_GENERATED_OUTOBJ_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:240/165 successfully build stage0 warmelt-outobj
# end stage0  melt-build-script.tpl:241/166 base  warmelt-outobj

  meltbuild_info making stage0 warmelt-hooks  melt-build-script.tpl:165/167

##  stage0 melt-build-script.tpl:167/168 symlink descriptor file warmelt-hooks
...
##  stage0 melt-build-script.tpl:172/169 symlink melt/generated source code warmelt-hooks
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-hooks.cc" ]; then
      meltbuild_info making stage0 warmelt-hooks symlinking sources melt-build-script.tpl:174/170
...
##  stage0 melt-build-script.tpl:181/171 symlink stamp warmelt-hooks
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-hooks+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-hooks symlinking timestamp melt-build-script.tpl:183/172
...
## manually generate the stage0 warmelt-hooks+meltbuild.mk file  melt-build-script.tpl:190/173
  ...
  echo "# generated " melt-build-script.tpl:194/174 >> $MELT_ZERO_GENERATED_HOOKS_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-hooks melt-build-script.tpl:198/175' >> $MELT_ZERO_GENERATED_HOOKS_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_HOOKS_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-hooks melt-build-script.tpl:206/176'  >> $MELT_ZERO_GENERATED_HOOKS_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:219/177 generated stagezero makedep $MELT_ZERO_GENERATED_HOOKS_BUILDMK
  ls -l $MELT_ZERO_GENERATED_HOOKS_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:223/178 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:233/179 stage0 warmelt-hooks did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:235/180 stage0 warmelt-hooks module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-hooks.meltmod-$MELT_ZERO_GENERATED_HOOKS_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:237/181 stage0 warmelt-hooks fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-hooks.meltmod-$MELT_ZERO_GENERATED_HOOKS_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:240/182 successfully build stage0 warmelt-hooks
# end stage0  melt-build-script.tpl:241/183 base  warmelt-hooks

  meltbuild_info making stage0 warmelt-modes  melt-build-script.tpl:165/184

##  stage0 melt-build-script.tpl:167/185 symlink descriptor file warmelt-modes
...
##  stage0 melt-build-script.tpl:172/186 symlink melt/generated source code warmelt-modes
  if [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-modes.cc" ]; then
      meltbuild_info making stage0 warmelt-modes symlinking sources melt-build-script.tpl:174/187
...
##  stage0 melt-build-script.tpl:181/188 symlink stamp warmelt-modes
  if  [ ! -f "$GCCMELT_STAGE_ZERO/warmelt-modes+melttime.h" ]; then
      meltbuild_info making stage0 warmelt-modes symlinking timestamp melt-build-script.tpl:183/189
...
## manually generate the stage0 warmelt-modes+meltbuild.mk file  melt-build-script.tpl:190/190
  ...
  echo "# generated " melt-build-script.tpl:194/191 >> $MELT_ZERO_GENERATED_MODES_BUILDMK-tmp$$
  ...
  echo '# zerostage objects of warmelt-modes melt-build-script.tpl:198/192' >> $MELT_ZERO_GENERATED_MODES_BUILDMK-tmp$$
  ...
  echo >> $MELT_ZERO_GENERATED_MODES_BUILDMK-tmp$$
  echo '# zerostage module of warmelt-modes melt-build-script.tpl:206/193'  >> $MELT_ZERO_GENERATED_MODES_BUILDMK-tmp$$
...
##
  ...
  meltbuild_info melt-build-script.tpl:219/194 generated stagezero makedep $MELT_ZERO_GENERATED_MODES_BUILDMK
  ls -l $MELT_ZERO_GENERATED_MODES_BUILDMK >&2

  $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
      GCCMELT_FROM=stagezero-melt-build-script.tpl:223/195 \
      GCCMELT_COMPILER="$GCCMELT_COMPILER" \
      GCCMELTGEN_BUILD=$GCCMELT_STAGE_ZERO/ \
      GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
      GCCMELT_MODULE_FLAVOR=$GCCMELT_ZERO_FLAVOR \
      ...
      GCCMELT_MODULE_DEPENDENCIES="$GCCMELT_CC1PLUS_DEPENDENCIES" \
      || meltbuild_error  melt-build-script.tpl:233/196 stage0 warmelt-modes did not build "(with $GCCMELT_MAKE  -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER cflags $GCCMELT_COMPILER_FLAGS

  meltbuild_info melt-build-script.tpl:235/197 stage0 warmelt-modes module 
  ls -l "$GCCMELT_STAGE_ZERO/warmelt-modes.meltmod-$MELT_ZERO_GENERATED_MODES_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so" >&2 \
      || meltbuild_error  melt-build-script.tpl:237/198 stage0 warmelt-modes fail to build \
      "$GCCMELT_STAGE_ZERO/warmelt-modes.meltmod-$MELT_ZERO_GENERATED_MODES_CUMULMD5.$GCCMELT_ZERO_FLAVOR.so"

  meltbuild_info melt-build-script.tpl:240/199 successfully build stage0 warmelt-modes
# end stage0  melt-build-script.tpl:241/200 base  warmelt-modes

} ################ end of function meltbuild_do_stage_zero melt-build-script.tpl:243/201
################################################################

## stage0 stamp file melt-build-script.tpl:246/202
melt_stagezero_stamp=$GCCMELT_STAGE_ZERO/$GCCMELT_STAGE_ZERO.stamp

## test if stage0 should be skipped then do it  melt-build-script.tpl:249/203
if [ ! -f "$melt_stagezero_stamp" -o "$melt_stagezero_stamp" -ot "$GCCMELT_RUNTIME_DEPENDENCY" ]; then
   meltbuild_do_stage_zero
    ...
    echo MELT stagezero stampfile $GCCMELT_STAGE_ZERO.stamp for MELT $MELTGCCBUILTIN_VERSION_STRING from melt-build-script.tpl:253/204 >  $melt_stagezero_stamptemp
    echo $GCCMELT_RUNTIME_DEPENDENCY_MD5SUM $GCCMELT_RUNTIME_DEPENDENCY >> $melt_stagezero_stamptemp

#  stagezero stamp melt-build-script.tpl:256/205 base  warmelt-first
...
#  stagezero stamp melt-build-script.tpl:256/206 base  warmelt-base
...
#  stagezero stamp melt-build-script.tpl:256/207 base  warmelt-debug
...
#  stagezero stamp melt-build-script.tpl:256/208 base  warmelt-macro
...
#  stagezero stamp melt-build-script.tpl:256/209 base  warmelt-moremacro
...
#  stagezero stamp melt-build-script.tpl:256/210 base  warmelt-normal
...
#  stagezero stamp melt-build-script.tpl:256/211 base  warmelt-normatch
...
#  stagezero stamp melt-build-script.tpl:256/212 base  warmelt-genobj
...
#  stagezero stamp melt-build-script.tpl:256/213 base  warmelt-outobj
...
#  stagezero stamp melt-build-script.tpl:256/214 base  warmelt-hooks
...
#  stagezero stamp melt-build-script.tpl:256/215 base  warmelt-modes
   ...
   meltbuild_info melt-build-script.tpl:262/216 skipped stage0 because of stamp file $melt_stagezero_stamp
fi

meltbuild_info melt-build-script.tpl:265/217 times after stagezero at `date '+%x %H:%M:%S'`: ;  times >&2


################################################################
## function to run MELT to emit C++ code  melt-build-script.tpl:269/218
function meltbuild_emit () {
	...
	for meltcsecfil in $meltstage/$meltbase+[0-9][0-9].cc ; do
		...
		: # at  melt-build-script.tpl:325/219
	    else
	...
	meltbuild_info $meltfrom skips emission of C++ code with  @$meltargs stage $meltstage prevstage $meltprevstage skipreason $GCCMELT_SKIPEMITC  melt-build-script.tpl:332/220 
	ls -l $meltprevstage/$meltbase*
	meltbuild_info $meltfrom symlinking previous stage $meltprevstage  melt-build-script.tpl:334/221 
	...
	meltbuild_info $meltfrom symlinked previous stage $meltprevstage/$meltbase melt-build-script.tpl:338/222 
    fi
...
################################################################
################################################################
#################@ before our stages melt-build-script.tpl:346/223 
### Our stages  
...
################################################################
#### function to do a stage melt-build-script.tpl:355/224
...
####in meltbuild_do_stage melt-build-script.tpl:370/226
    ...
    #in meltbuild_do_stage melt-build-script.tpl:380/227 base warmelt-first
    meltbuild_info melt-build-script.tpl:381/228 from $meltfrom generating C++ code of warmelt-first in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:383/229 emit C++ code for warmelt-first
    meltbuild_emit melt-build-script.tpl:384/230-$meltfrom \
	translateinit \
	warmelt-first \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:397/231 checksum C++ code for warmelt-first
    meltchecksum_cumul_FIRST=$(cat "$meltcurstagedir"/warmelt-first.cc "$meltcurstagedir"/warmelt-first+[0-9][0-9].cc | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:400/232 perhaps compiling C++ code for warmelt-first
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:402/233-$meltfrom compiling module warmelt-first in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:404/234-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	...
	|| ( meltbuild_info melt-build-script.tpl:411/235-$meltfrom recompiling bad module warmelt-first in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:413/236-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    ...
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-first" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-first" ; \
	    meltbuild_error  melt-build-script.tpl:420/237-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:423/238-$meltfrom NOT compiling module warmelt-first "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:429/239 done base warmelt-first


    #in meltbuild_do_stage melt-build-script.tpl:380/240 base warmelt-base
    meltbuild_info melt-build-script.tpl:381/241 from $meltfrom generating C++ code of warmelt-base in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:383/242 emit C++ code for warmelt-base
    meltbuild_emit melt-build-script.tpl:384/243-$meltfrom \
	translatefile \
	warmelt-base \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:397/244 checksum C++ code for warmelt-base
    meltchecksum_cumul_BASE=$(cat "$meltcurstagedir"/warmelt-base.cc "$meltcurstagedir"/warmelt-base+[0-9][0-9].cc | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:400/245 perhaps compiling C++ code for warmelt-base
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:402/246-$meltfrom compiling module warmelt-base in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:404/247-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:411/248-$meltfrom recompiling bad module warmelt-base in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:413/249-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-base" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-base" ; \
	    meltbuild_error  melt-build-script.tpl:420/250-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:423/251-$meltfrom NOT compiling module warmelt-base "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:429/252 done base warmelt-base


    #in meltbuild_do_stage melt-build-script.tpl:380/253 base warmelt-debug
    meltbuild_info melt-build-script.tpl:381/254 from $meltfrom generating C++ code of warmelt-debug in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:383/255 emit C++ code for warmelt-debug
    meltbuild_emit melt-build-script.tpl:384/256-$meltfrom \
	translatefile \
	warmelt-debug \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:397/257 checksum C++ code for warmelt-debug
    meltchecksum_cumul_DEBUG=$(cat "$meltcurstagedir"/warmelt-debug.cc "$meltcurstagedir"/warmelt-debug+[0-9][0-9].cc | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:400/258 perhaps compiling C++ code for warmelt-debug
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:402/259-$meltfrom compiling module warmelt-debug in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:404/260-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:411/261-$meltfrom recompiling bad module warmelt-debug in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:413/262-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-debug" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-debug" ; \
	    meltbuild_error  melt-build-script.tpl:420/263-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:423/264-$meltfrom NOT compiling module warmelt-debug "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:429/265 done base warmelt-debug


    #in meltbuild_do_stage melt-build-script.tpl:380/266 base warmelt-macro
    meltbuild_info melt-build-script.tpl:381/267 from $meltfrom generating C++ code of warmelt-macro in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:383/268 emit C++ code for warmelt-macro
    meltbuild_emit melt-build-script.tpl:384/269-$meltfrom \
	translatefile \
	warmelt-macro \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:397/270 checksum C++ code for warmelt-macro
    meltchecksum_cumul_MACRO=$(cat "$meltcurstagedir"/warmelt-macro.cc "$meltcurstagedir"/warmelt-macro+[0-9][0-9].cc | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:400/271 perhaps compiling C++ code for warmelt-macro
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:402/272-$meltfrom compiling module warmelt-macro in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:404/273-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:411/274-$meltfrom recompiling bad module warmelt-macro in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:413/275-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-macro" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-macro" ; \
	    meltbuild_error  melt-build-script.tpl:420/276-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:423/277-$meltfrom NOT compiling module warmelt-macro "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:429/278 done base warmelt-macro


    #in meltbuild_do_stage melt-build-script.tpl:380/279 base warmelt-moremacro
    meltbuild_info melt-build-script.tpl:381/280 from $meltfrom generating C++ code of warmelt-moremacro in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:383/281 emit C++ code for warmelt-moremacro
    meltbuild_emit melt-build-script.tpl:384/282-$meltfrom \
	translatefile \
	warmelt-moremacro \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:397/283 checksum C++ code for warmelt-moremacro
    ...
    #in meltbuild_do_stage melt-build-script.tpl:400/284 perhaps compiling C++ code for warmelt-moremacro
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:402/285-$meltfrom compiling module warmelt-moremacro in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:404/286-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:411/287-$meltfrom recompiling bad module warmelt-moremacro in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:413/288-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-moremacro" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-moremacro" ; \
	    meltbuild_error  melt-build-script.tpl:420/289-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:423/290-$meltfrom NOT compiling module warmelt-moremacro "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:429/291 done base warmelt-moremacro


    #in meltbuild_do_stage melt-build-script.tpl:380/292 base warmelt-normal
    meltbuild_info melt-build-script.tpl:381/293 from $meltfrom generating C++ code of warmelt-normal in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:383/294 emit C++ code for warmelt-normal
    meltbuild_emit melt-build-script.tpl:384/295-$meltfrom \
	translatefile \
	warmelt-normal \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:397/296 checksum C++ code for warmelt-normal
    ...
    #in meltbuild_do_stage melt-build-script.tpl:400/297 perhaps compiling C++ code for warmelt-normal
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:402/298-$meltfrom compiling module warmelt-normal in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:404/299-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:411/300-$meltfrom recompiling bad module warmelt-normal in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:413/301-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-normal" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-normal" ; \
	    meltbuild_error  melt-build-script.tpl:420/302-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:423/303-$meltfrom NOT compiling module warmelt-normal "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:429/304 done base warmelt-normal


    #in meltbuild_do_stage melt-build-script.tpl:380/305 base warmelt-normatch
    meltbuild_info melt-build-script.tpl:381/306 from $meltfrom generating C++ code of warmelt-normatch in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:383/307 emit C++ code for warmelt-normatch
    meltbuild_emit melt-build-script.tpl:384/308-$meltfrom \
	translatefile \
	warmelt-normatch \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:397/309 checksum C++ code for warmelt-normatch
    ...
    #in meltbuild_do_stage melt-build-script.tpl:400/310 perhaps compiling C++ code for warmelt-normatch
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:402/311-$meltfrom compiling module warmelt-normatch in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:404/312-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:411/313-$meltfrom recompiling bad module warmelt-normatch in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:413/314-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-normatch" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-normatch" ; \
	    meltbuild_error  melt-build-script.tpl:420/315-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:423/316-$meltfrom NOT compiling module warmelt-normatch "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:429/317 done base warmelt-normatch


    #in meltbuild_do_stage melt-build-script.tpl:380/318 base warmelt-genobj
    meltbuild_info melt-build-script.tpl:381/319 from $meltfrom generating C++ code of warmelt-genobj in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:383/320 emit C++ code for warmelt-genobj
    meltbuild_emit melt-build-script.tpl:384/321-$meltfrom \
	translatefile \
	warmelt-genobj \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:397/322 checksum C++ code for warmelt-genobj
    ...
    #in meltbuild_do_stage melt-build-script.tpl:400/323 perhaps compiling C++ code for warmelt-genobj
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:402/324-$meltfrom compiling module warmelt-genobj in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:404/325-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:411/326-$meltfrom recompiling bad module warmelt-genobj in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:413/327-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-genobj" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-genobj" ; \
	    meltbuild_error  melt-build-script.tpl:420/328-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:423/329-$meltfrom NOT compiling module warmelt-genobj "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:429/330 done base warmelt-genobj


    #in meltbuild_do_stage melt-build-script.tpl:380/331 base warmelt-outobj
    meltbuild_info melt-build-script.tpl:381/332 from $meltfrom generating C++ code of warmelt-outobj in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:383/333 emit C++ code for warmelt-outobj
    meltbuild_emit melt-build-script.tpl:384/334-$meltfrom \
	translatefile \
	warmelt-outobj \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:397/335 checksum C++ code for warmelt-outobj
    ...
    #in meltbuild_do_stage melt-build-script.tpl:400/336 perhaps compiling C++ code for warmelt-outobj
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:402/337-$meltfrom compiling module warmelt-outobj in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:404/338-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:411/339-$meltfrom recompiling bad module warmelt-outobj in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:413/340-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-outobj" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-outobj" ; \
	    meltbuild_error  melt-build-script.tpl:420/341-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:423/342-$meltfrom NOT compiling module warmelt-outobj "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:429/343 done base warmelt-outobj


    #in meltbuild_do_stage melt-build-script.tpl:380/344 base warmelt-hooks
    meltbuild_info melt-build-script.tpl:381/345 from $meltfrom generating C++ code of warmelt-hooks in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:383/346 emit C++ code for warmelt-hooks
    meltbuild_emit melt-build-script.tpl:384/347-$meltfrom \
	translatefile \
	warmelt-hooks \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:397/348 checksum C++ code for warmelt-hooks
    meltchecksum_cumul_HOOKS=$(cat "$meltcurstagedir"/warmelt-hooks.cc "$meltcurstagedir"/warmelt-hooks+[0-9][0-9].cc | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:400/349 perhaps compiling C++ code for warmelt-hooks
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:402/350-$meltfrom compiling module warmelt-hooks in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:404/351-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:411/352-$meltfrom recompiling bad module warmelt-hooks in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:413/353-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-hooks" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-hooks" ; \
	    meltbuild_error  melt-build-script.tpl:420/354-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:423/355-$meltfrom NOT compiling module warmelt-hooks "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:429/356 done base warmelt-hooks


    #in meltbuild_do_stage melt-build-script.tpl:380/357 base warmelt-modes
    meltbuild_info melt-build-script.tpl:381/358 from $meltfrom generating C++ code of warmelt-modes in $meltcurstagedir

    #in meltbuild_do_stage melt-build-script.tpl:383/359 emit C++ code for warmelt-modes
    meltbuild_emit melt-build-script.tpl:384/360-$meltfrom \
	translatefile \
	warmelt-modes \
	"$meltcurstagedir" \
	"$meltprevstagedir" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:397/361 checksum C++ code for warmelt-modes
    meltchecksum_cumul_MODES=$(cat "$meltcurstagedir"/warmelt-modes.cc "$meltcurstagedir"/warmelt-modes+[0-9][0-9].cc | $MD5SUM | cut -b 1-32)

    #in meltbuild_do_stage melt-build-script.tpl:400/362 perhaps compiling C++ code for warmelt-modes
    if [ -z "$GCCMELT_SKIPEMITC" ]; then
	meltbuild_info melt-build-script.tpl:402/363-$meltfrom compiling module warmelt-modes in "$meltcurstagedir"
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:404/364-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
	...
	|| ( meltbuild_info melt-build-script.tpl:411/365-$meltfrom recompiling bad module warmelt-modes in "$meltcurstagedir" ; \
	$GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
	    GCCMELT_FROM="melt-build-script.tpl:413/366-$meltfrom" \
	    GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
	    GCCMELT_MODULE_FLAVOR="$meltcurflavor" \
	    GCCMELT_COMPILER="$GCCMELT_COMPILER" \
	    GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
	    GCCMELT_MODULE_SOURCEBASE="$meltcurstagedir/warmelt-modes" \
	    GCCMELT_MODULE_BINARYBASE="$meltcurstagedir/warmelt-modes" ; \
	    meltbuild_error  melt-build-script.tpl:420/367-$meltfrom in "$meltcurstagedir/" \
	...
	meltbuild_info melt-build-script.tpl:423/368-$meltfrom NOT compiling module warmelt-modes "in" \
    ...
    #in meltbuild_do_stage melt-build-script.tpl:429/369 done base warmelt-modes


    #in meltbuild_do_stage melt-build-script.tpl:432/370 generating the stampfile
    ...
    #in meltbuild_do_stage melt-build-script.tpl:444/371 ending
...
}			#### end meltbuild_do_stage melt-build-script.tpl:447/372
################################################################

##### possibly run all our stages  melt-build-script.tpl:450/373

#@  melt-build-script.tpl:452/374 stagedir meltbuild-stage1
GCCMELT_SKIPEMITC=
if [ ! -f meltbuild-stage1/meltbuild-stage1.stamp -o meltbuild-stage1/meltbuild-stage1.stamp -ot $GCCMELT_RUNTIME_DEPENDENCY \
 ...
 -o meltbuild-stage1/meltbuild-stage1.stamp -ot $GCCMELT_MELTSOURCEDIR/warmelt-modes.melt \
    ...
    echo '+++++++++++++++++++++++++++++++++++++++++++++++++++++++++'
    meltbuild_info  melt-build-script.tpl:459/375 '++++++++++++++++' building stage meltbuild-stage1 '++++++++++++++++'
    ## building stage meltbuild-stage1 previous $GCCMELT_STAGE_ZERO  melt-build-script.tpl:460/376
    meltbuild_do_stage  melt-build-script.tpl:461/377 meltbuild-stage1 quicklybuilt $GCCMELT_STAGE_ZERO $GCCMELT_ZERO_FLAVOR "$GCCMELT_EMIT_OPTION_STAGE1"
else
    meltbuild_info  melt-build-script.tpl:463/378 skipping stage meltbuild-stage1
fi

##  melt-build-script.tpl:466/379
GCCMELT_LASTSTAGE=meltbuild-stage1


#@  melt-build-script.tpl:452/380 stagedir meltbuild-stage2
GCCMELT_SKIPEMITC=
if [ ! -f meltbuild-stage2/meltbuild-stage2.stamp -o meltbuild-stage2/meltbuild-stage2.stamp -ot $GCCMELT_RUNTIME_DEPENDENCY \
 ...
 -o meltbuild-stage2/meltbuild-stage2.stamp -ot $GCCMELT_MELTSOURCEDIR/warmelt-modes.melt \
    ...
    echo ; echo ; echo ; echo ; echo ; echo ; echo ; echo
    echo '+++++++++++++++++++++++++++++++++++++++++++++++++++++++++'
    meltbuild_info  melt-build-script.tpl:459/381 '++++++++++++++++' building stage meltbuild-stage2 '++++++++++++++++'
    ## building stage meltbuild-stage2 previous meltbuild-stage1  melt-build-script.tpl:460/382
    meltbuild_do_stage  melt-build-script.tpl:461/383 meltbuild-stage2 quicklybuilt meltbuild-stage1 quicklybuilt "$GCCMELT_EMIT_OPTION_STAGE2"
else
    meltbuild_info  melt-build-script.tpl:463/384 skipping stage meltbuild-stage2
fi

##  melt-build-script.tpl:466/385
GCCMELT_LASTSTAGE=meltbuild-stage2


#@  melt-build-script.tpl:452/386 stagedir meltbuild-stage3
GCCMELT_SKIPEMITC=
if [ ! -f meltbuild-stage3/meltbuild-stage3.stamp -o meltbuild-stage3/meltbuild-stage3.stamp -ot $GCCMELT_RUNTIME_DEPENDENCY \
 ...
 -o meltbuild-stage3/meltbuild-stage3.stamp -ot $GCCMELT_MELTSOURCEDIR/warmelt-modes.melt \
    ...
    echo ; echo ; echo ; echo ; echo ; echo ; echo ; echo
    echo '+++++++++++++++++++++++++++++++++++++++++++++++++++++++++'
    meltbuild_info  melt-build-script.tpl:459/387 '++++++++++++++++' building stage meltbuild-stage3 '++++++++++++++++'
    ## building stage meltbuild-stage3 previous meltbuild-stage2  melt-build-script.tpl:460/388
    meltbuild_do_stage  melt-build-script.tpl:461/389 meltbuild-stage3 quicklybuilt meltbuild-stage2 quicklybuilt "$GCCMELT_EMIT_OPTION_STAGE3"
else
    meltbuild_info  melt-build-script.tpl:463/390 skipping stage meltbuild-stage3
fi

##  melt-build-script.tpl:466/391
...
meltbuild_info melt-build-script.tpl:474/392 last stage $GCCMELT_LASTSTAGE

################################################################
################################################################
###########@ before generating meltbuild-sources melt-build-script.tpl:478/393
...
#@ from  melt-build-script.tpl:487/394  compiling the modules
[ -d meltbuild-modules ] || mkdir meltbuild-modules

################################################################
function meltbuild_emit_translator_sources () {

  ## meltbuild_emit_source  melt-build-script.tpl:493/395 base warmelt-first
  meltbuild_info melt-build-script.tpl:494/396 generating C++ code of warmelt-first in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:495/397 \
      translateinit \
      warmelt-first \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:493/398 base warmelt-base
  meltbuild_info melt-build-script.tpl:494/399 generating C++ code of warmelt-base in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:495/400 \
      translatefile \
      warmelt-base \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:493/401 base warmelt-debug
  meltbuild_info melt-build-script.tpl:494/402 generating C++ code of warmelt-debug in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:495/403 \
      translatefile \
      warmelt-debug \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:493/404 base warmelt-macro
  meltbuild_info melt-build-script.tpl:494/405 generating C++ code of warmelt-macro in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:495/406 \
      translatefile \
      warmelt-macro \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:493/407 base warmelt-moremacro
  meltbuild_info melt-build-script.tpl:494/408 generating C++ code of warmelt-moremacro in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:495/409 \
      translatefile \
      warmelt-moremacro \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:493/410 base warmelt-normal
  meltbuild_info melt-build-script.tpl:494/411 generating C++ code of warmelt-normal in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:495/412 \
      translatefile \
      warmelt-normal \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:493/413 base warmelt-normatch
  meltbuild_info melt-build-script.tpl:494/414 generating C++ code of warmelt-normatch in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:495/415 \
      translatefile \
      warmelt-normatch \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:493/416 base warmelt-genobj
  meltbuild_info melt-build-script.tpl:494/417 generating C++ code of warmelt-genobj in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:495/418 \
      translatefile \
      warmelt-genobj \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:493/419 base warmelt-outobj
  meltbuild_info melt-build-script.tpl:494/420 generating C++ code of warmelt-outobj in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:495/421 \
      translatefile \
      warmelt-outobj \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:493/422 base warmelt-hooks
  meltbuild_info melt-build-script.tpl:494/423 generating C++ code of warmelt-hooks in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:495/424 \
      translatefile \
      warmelt-hooks \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
  ...
  ## meltbuild_emit_source  melt-build-script.tpl:493/425 base warmelt-modes
  meltbuild_info melt-build-script.tpl:494/426 generating C++ code of warmelt-modes in meltbuild-sources
  meltbuild_emit melt-build-script.tpl:495/427 \
      translatefile \
      warmelt-modes \
      meltbuild-sources \
      "$GCCMELT_LASTSTAGE" \
...
function meltbuild_compile_translator_modules () {
  ...
  # in meltbuild_compile_translator_sources quicklybuilt melt-build-script.tpl:510/428
  meltbuild_info melt-build-script.tpl:511/429 compiling translator quicklybuilt


   #@ melt-build-script.tpl:514/430 flavor quicklybuilt base warmelt-first
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/431 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
 ...
 || meltbuild_error  melt-build-script.tpl:523/432 in meltbuild-modules failed to compile translator warmelt-first quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/433 flavor quicklybuilt base warmelt-base
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/434 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:523/435 in meltbuild-modules failed to compile translator warmelt-base quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/436 flavor quicklybuilt base warmelt-debug
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/437 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:523/438 in meltbuild-modules failed to compile translator warmelt-debug quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/439 flavor quicklybuilt base warmelt-macro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/440 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:523/441 in meltbuild-modules failed to compile translator warmelt-macro quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/442 flavor quicklybuilt base warmelt-moremacro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/443 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:523/444 in meltbuild-modules failed to compile translator warmelt-moremacro quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/445 flavor quicklybuilt base warmelt-normal
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/446 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:523/447 in meltbuild-modules failed to compile translator warmelt-normal quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/448 flavor quicklybuilt base warmelt-normatch
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/449 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:523/450 in meltbuild-modules failed to compile translator warmelt-normatch quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/451 flavor quicklybuilt base warmelt-genobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/452 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:523/453 in meltbuild-modules failed to compile translator warmelt-genobj quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/454 flavor quicklybuilt base warmelt-outobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/455 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:523/456 in meltbuild-modules failed to compile translator warmelt-outobj quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/457 flavor quicklybuilt base warmelt-hooks
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/458 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:523/459 in meltbuild-modules failed to compile translator warmelt-hooks quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/460 flavor quicklybuilt base warmelt-modes
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/461 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=quicklybuilt \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
 ...
 || meltbuild_error  melt-build-script.tpl:523/462 in meltbuild-modules failed to compile translator warmelt-modes quicklybuilt make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS




  # in meltbuild_compile_translator_sources optimized melt-build-script.tpl:510/463
  meltbuild_info melt-build-script.tpl:511/464 compiling translator optimized


   #@ melt-build-script.tpl:514/465 flavor optimized base warmelt-first
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/466 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     ...
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-first \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-first \
 || meltbuild_error  melt-build-script.tpl:523/467 in meltbuild-modules failed to compile translator warmelt-first optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/468 flavor optimized base warmelt-base
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/469 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-base \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-base \
 || meltbuild_error  melt-build-script.tpl:523/470 in meltbuild-modules failed to compile translator warmelt-base optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/471 flavor optimized base warmelt-debug
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/472 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-debug \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-debug \
 || meltbuild_error  melt-build-script.tpl:523/473 in meltbuild-modules failed to compile translator warmelt-debug optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/474 flavor optimized base warmelt-macro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/475 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-macro \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-macro \
 || meltbuild_error  melt-build-script.tpl:523/476 in meltbuild-modules failed to compile translator warmelt-macro optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/477 flavor optimized base warmelt-moremacro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/478 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-moremacro \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-moremacro \
 || meltbuild_error  melt-build-script.tpl:523/479 in meltbuild-modules failed to compile translator warmelt-moremacro optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/480 flavor optimized base warmelt-normal
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/481 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normal \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normal \
 || meltbuild_error  melt-build-script.tpl:523/482 in meltbuild-modules failed to compile translator warmelt-normal optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/483 flavor optimized base warmelt-normatch
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/484 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normatch \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normatch \
 || meltbuild_error  melt-build-script.tpl:523/485 in meltbuild-modules failed to compile translator warmelt-normatch optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/486 flavor optimized base warmelt-genobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/487 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-genobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-genobj \
 || meltbuild_error  melt-build-script.tpl:523/488 in meltbuild-modules failed to compile translator warmelt-genobj optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/489 flavor optimized base warmelt-outobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/490 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-outobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-outobj \
 || meltbuild_error  melt-build-script.tpl:523/491 in meltbuild-modules failed to compile translator warmelt-outobj optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/492 flavor optimized base warmelt-hooks
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/493 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-hooks \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-hooks \
 || meltbuild_error  melt-build-script.tpl:523/494 in meltbuild-modules failed to compile translator warmelt-hooks optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/495 flavor optimized base warmelt-modes
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/496 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=optimized \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-modes \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-modes \
 || meltbuild_error  melt-build-script.tpl:523/497 in meltbuild-modules failed to compile translator warmelt-modes optimized make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS




  # in meltbuild_compile_translator_sources debugnoline melt-build-script.tpl:510/498
  meltbuild_info melt-build-script.tpl:511/499 compiling translator debugnoline


   #@ melt-build-script.tpl:514/500 flavor debugnoline base warmelt-first
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/501 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     ...
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-first \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-first \
 || meltbuild_error  melt-build-script.tpl:523/502 in meltbuild-modules failed to compile translator warmelt-first debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/503 flavor debugnoline base warmelt-base
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/504 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-base \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-base \
 || meltbuild_error  melt-build-script.tpl:523/505 in meltbuild-modules failed to compile translator warmelt-base debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/506 flavor debugnoline base warmelt-debug
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/507 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-debug \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-debug \
 || meltbuild_error  melt-build-script.tpl:523/508 in meltbuild-modules failed to compile translator warmelt-debug debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/509 flavor debugnoline base warmelt-macro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/510 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-macro \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-macro \
 || meltbuild_error  melt-build-script.tpl:523/511 in meltbuild-modules failed to compile translator warmelt-macro debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/512 flavor debugnoline base warmelt-moremacro
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/513 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-moremacro \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-moremacro \
 || meltbuild_error  melt-build-script.tpl:523/514 in meltbuild-modules failed to compile translator warmelt-moremacro debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/515 flavor debugnoline base warmelt-normal
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/516 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normal \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normal \
 || meltbuild_error  melt-build-script.tpl:523/517 in meltbuild-modules failed to compile translator warmelt-normal debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/518 flavor debugnoline base warmelt-normatch
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/519 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-normatch \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-normatch \
 || meltbuild_error  melt-build-script.tpl:523/520 in meltbuild-modules failed to compile translator warmelt-normatch debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/521 flavor debugnoline base warmelt-genobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/522 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-genobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-genobj \
 || meltbuild_error  melt-build-script.tpl:523/523 in meltbuild-modules failed to compile translator warmelt-genobj debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/524 flavor debugnoline base warmelt-outobj
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/525 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-outobj \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-outobj \
 || meltbuild_error  melt-build-script.tpl:523/526 in meltbuild-modules failed to compile translator warmelt-outobj debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/527 flavor debugnoline base warmelt-hooks
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/528 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-hooks \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-hooks \
 || meltbuild_error  melt-build-script.tpl:523/529 in meltbuild-modules failed to compile translator warmelt-hooks debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS

   #@ melt-build-script.tpl:514/530 flavor debugnoline base warmelt-modes
   $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
     GCCMELT_FROM=melt-build-script.tpl:516/531 \
     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
     GCCMELT_MODULE_FLAVOR=debugnoline \
     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/warmelt-modes \
     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/warmelt-modes \
 || meltbuild_error  melt-build-script.tpl:523/532 in meltbuild-modules failed to compile translator warmelt-modes debugnoline make "($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler "$GCCMELT_COMPILER" cflags $GCCMELT_COMPILER_FLAGS
...
#################@ melt-build-script.tpl:531/533 
function meltbuild_symlink_melt_translator_sources () {


### symlinking the MELT translator code in meltbuild-sources for warmelt-first from melt-build-script.tpl:536/534

meltbuild_info melt-build-script.tpl:538/535 putting MELT translator code of warmelt-first in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-base from melt-build-script.tpl:536/536

meltbuild_info melt-build-script.tpl:538/537 putting MELT translator code of warmelt-base in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-debug from melt-build-script.tpl:536/538

meltbuild_info melt-build-script.tpl:538/539 putting MELT translator code of warmelt-debug in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-macro from melt-build-script.tpl:536/540

meltbuild_info melt-build-script.tpl:538/541 putting MELT translator code of warmelt-macro in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-moremacro from melt-build-script.tpl:536/542

meltbuild_info melt-build-script.tpl:538/543 putting MELT translator code of warmelt-moremacro in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-normal from melt-build-script.tpl:536/544

meltbuild_info melt-build-script.tpl:538/545 putting MELT translator code of warmelt-normal in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-normatch from melt-build-script.tpl:536/546

meltbuild_info melt-build-script.tpl:538/547 putting MELT translator code of warmelt-normatch in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-genobj from melt-build-script.tpl:536/548

meltbuild_info melt-build-script.tpl:538/549 putting MELT translator code of warmelt-genobj in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-outobj from melt-build-script.tpl:536/550

meltbuild_info melt-build-script.tpl:538/551 putting MELT translator code of warmelt-outobj in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-hooks from melt-build-script.tpl:536/552

meltbuild_info melt-build-script.tpl:538/553 putting MELT translator code of warmelt-hooks in meltbuild-sources
...
### symlinking the MELT translator code in meltbuild-sources for warmelt-modes from melt-build-script.tpl:536/554

meltbuild_info melt-build-script.tpl:538/555 putting MELT translator code of warmelt-modes in meltbuild-sources
...
################@ final translator melt-build-script.tpl:547/556 
...
if [ ! -f $melt_final_translator_stamp -o $melt_final_translator_stamp -ot $GCCMELT_RUNTIME_DEPENDENCY \
 ...
 -o $melt_final_translator_stamp -ot $GCCMELT_LASTSTAGE/$GCCMELT_LASTSTAGE.stamp ]; then
    meltbuild_notice 'Emit Translator Source'  melt-build-script.tpl:553/557 emit then translate the MELT translator 
    meltbuild_info melt-build-script.tpl:554/558 emit then translate the compile translator for  $melt_final_translator_stamp
...
#@  melt-build-script.tpl:562/569 
    ...
    meltbuild_info melt-build-script.tpl:573/570 skip final translation of translator stamp  $melt_final_translator_stamp
fi

################################################################
#@ melt-build-script.tpl:577/571 making the meltbuild-common.args file to make life easier
# I would often use that meltbuild-common.args for testing, etc.
meltcommon_args=meltbuild-common.args
meltbuild_info melt-build-script.tpl:580/572 making $meltcommon_args
meltcommon_argstemp=$meltcommon_args-tmp$$
echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:582/573"' > $meltcommon_argstemp
...
meltbuild_info melt-build-script.tpl:591/574 $meltcommon_args is
cat $meltcommon_args < /dev/null >&2


################
### the warmelt modules lists  melt-build-script.tpl:596/575
...
if [ ! -f meltbuild-sources/warmelt.quicklybuilt.modlis \
  ...
  #  melt-build-script.tpl:600/576 warmelt module list quicklybuilt
...
if [ ! -f meltbuild-sources/warmelt.optimized.modlis \
  ...
  #  melt-build-script.tpl:600/577 warmelt module list optimized
...
if [ ! -f meltbuild-sources/warmelt.debugnoline.modlis \
  ...
  #  melt-build-script.tpl:600/578 warmelt module list debugnoline
...
################################################################
#@ melt-build-script.tpl:611/579
if [ "$melt_overall_goal" = "translator" ]; then
    meltbuild_info melt-build-script.tpl:613/580 done translation overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

################################################################
################################################################
### the warmelt modules lists melt-build-script.tpl:619/581

if [ ! -f "meltbuild-sources/warmelt.quicklybuilt.modlis" \
    -o "meltbuild-sources/warmelt.quicklybuilt.modlis" -ot $melt_final_translator_stamp  ]; then
  #  melt-build-script.tpl:623/582 warmelt module list quicklybuilt
  meltbuild_info  melt-build-script.tpl:624/583 generating warmelt module list  "meltbuild-sources/warmelt.quicklybuilt.modlis"
  melt_modlis_temp="meltbuild-sources/warmelt.quicklybuilt.modlis-tmp$$"
  ...
  #@  melt-build-script.tpl:631/584
  $GCCMELT_MOVE_IF_CHANGE $melt_modlis_temp  "meltbuild-sources/warmelt.quicklybuilt.modlis"
else
  meltbuild_info  melt-build-script.tpl:634/585 keeping warmelt module list  "meltbuild-sources/warmelt.quicklybuilt.modlis"  
fi

if [ ! -f "meltbuild-sources/warmelt.optimized.modlis" \
    -o "meltbuild-sources/warmelt.optimized.modlis" -ot $melt_final_translator_stamp  ]; then
  #  melt-build-script.tpl:623/586 warmelt module list optimized
  meltbuild_info  melt-build-script.tpl:624/587 generating warmelt module list  "meltbuild-sources/warmelt.optimized.modlis"
  melt_modlis_temp="meltbuild-sources/warmelt.optimized.modlis-tmp$$"
  ...
  #@  melt-build-script.tpl:631/588
  $GCCMELT_MOVE_IF_CHANGE $melt_modlis_temp  "meltbuild-sources/warmelt.optimized.modlis"
else
  meltbuild_info  melt-build-script.tpl:634/589 keeping warmelt module list  "meltbuild-sources/warmelt.optimized.modlis"  
fi

if [ ! -f "meltbuild-sources/warmelt.debugnoline.modlis" \
    -o "meltbuild-sources/warmelt.debugnoline.modlis" -ot $melt_final_translator_stamp  ]; then
  #  melt-build-script.tpl:623/590 warmelt module list debugnoline
  meltbuild_info  melt-build-script.tpl:624/591 generating warmelt module list  "meltbuild-sources/warmelt.debugnoline.modlis"
  melt_modlis_temp="meltbuild-sources/warmelt.debugnoline.modlis-tmp$$"
  ...
  #@  melt-build-script.tpl:631/592
  $GCCMELT_MOVE_IF_CHANGE $melt_modlis_temp  "meltbuild-sources/warmelt.debugnoline.modlis"
else
  meltbuild_info  melt-build-script.tpl:634/593 keeping warmelt module list  "meltbuild-sources/warmelt.debugnoline.modlis"  
fi
...
################################################################
######################### REGENERATION #########################
#@ melt-build-script.tpl:641/594
if [ "$melt_overall_goal" = "regenerate" ]; then
    meltbuild_notice regenerating runtime support melt-build-script.tpl:643/595 
    ...
    echo ' -DGCCMELT_REGENERATING  -DGCCMELT_FROM_ARG="melt-build-script.tpl:647/596"' > $meltregen_argstemp
   ...
   meltbuild_info melt-build-script.tpl:657/597 $meltregen_args  is
   cat $meltregen_args < /dev/null >&2
    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltregen_args \
	|| meltbuild_error melt-build-script.tpl:660/598 failed with arguments @$meltregen_args
    meltbuild_info melt-build-script.tpl:661/599 done regenerate overall goal
    exit 0
fi
...
########################### LIBRARY ############################
################
#@ melt-build-script.tpl:671/600 before library libmelt* modules
################################################################
meltbuild_info melt-build-script.tpl:673/601 before library GCCMELT_SKIPEMITC=$GCCMELT_SKIPEMITC.

meltbuild_info melt-build-script.tpl:675/602 times before library at `date '+%x %H:%M:%S'`: ;  times >&2
 
melt_final_library_stamp=meltbuild-final-library.stamp

function meltbuild_do_library () {
  meltbuild_notice 'start doing library'  melt-build-script.tpl:680/603 doing library 
  
  
    ## meltbuild_do_library libmelt-ana-base melt-build-script.tpl:683/604
    meltbuild_info melt-build-script.tpl:684/605 doing library libmelt-ana-base
    ...
    ## meltbuild_do_library libmelt-ana-base melt-build-script.tpl:688/606
    if [ ! -f meltbuild-sources/libmelt-ana-base.cc -o  ! -f meltbuild-sources/libmelt-ana-base+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:694/607 emit library C++ code for libmelt-ana-base
        meltbuild_emit melt-build-script.tpl:695/608 \
  	  translatefile \
  	  libmelt-ana-base \
  	  meltbuild-sources \
  	  meltbuild-modules \
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:702/609 failed to generate C++ code of library libmelt-ana-base
    else
        meltbuild_info melt-build-script.tpl:704/610 DONT emit library C++ code for libmelt-ana-base
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-base.meltmod-$meltlib_ANA_BASE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:712/611 compiling library module for libmelt-ana-base quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:714/612 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:721/613 in meltbuild-modules failure to compile library libmelt-ana-base quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:723/614 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base ; \
  	       meltbuild_error  melt-build-script.tpl:730/615 in meltbuild-modules failed to compile library libmelt-ana-base quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:733/616 not compiling library module for libmelt-ana-base quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-base.meltmod-$meltlib_ANA_BASE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:712/617 compiling library module for libmelt-ana-base optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:714/618 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base \
  	  || ( meltbuild_notice melt-build-script.tpl:721/619 in meltbuild-modules failure to compile library libmelt-ana-base optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:723/620 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base ; \
  	       meltbuild_error  melt-build-script.tpl:730/621 in meltbuild-modules failed to compile library libmelt-ana-base optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:733/622 not compiling library module for libmelt-ana-base optimized
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-base.meltmod-$meltlib_ANA_BASE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:712/623 compiling library module for libmelt-ana-base debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:714/624 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base \
  	  || ( meltbuild_notice melt-build-script.tpl:721/625 in meltbuild-modules failure to compile library libmelt-ana-base debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:723/626 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base ; \
  	       meltbuild_error  melt-build-script.tpl:730/627 in meltbuild-modules failed to compile library libmelt-ana-base debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:733/628 not compiling library module for libmelt-ana-base debugnoline
    fi
   
  
  
    ## meltbuild_do_library libmelt-ana-tree melt-build-script.tpl:683/629
    meltbuild_info melt-build-script.tpl:684/630 doing library libmelt-ana-tree
    ...
    ## meltbuild_do_library libmelt-ana-tree melt-build-script.tpl:688/631
   ...
   -o meltbuild-sources/libmelt-ana-base+meltdesc.c -ot meltbuild-sources/libmelt-ana-tree+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:694/632 emit library C++ code for libmelt-ana-tree
        meltbuild_emit melt-build-script.tpl:695/633 \
  	  translatefile \
  	  libmelt-ana-tree \
  	  meltbuild-sources \
  	  meltbuild-modules \
      ...
      "_libmelt-treecode.melt" \
  	  || meltbuild_error melt-build-script.tpl:702/634 failed to generate C++ code of library libmelt-ana-tree
    else
        meltbuild_info melt-build-script.tpl:704/635 DONT emit library C++ code for libmelt-ana-tree
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-tree.meltmod-$meltlib_ANA_TREE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:712/636 compiling library module for libmelt-ana-tree quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:714/637 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:721/638 in meltbuild-modules failure to compile library libmelt-ana-tree quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:723/639 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree ; \
  	       meltbuild_error  melt-build-script.tpl:730/640 in meltbuild-modules failed to compile library libmelt-ana-tree quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:733/641 not compiling library module for libmelt-ana-tree quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-tree.meltmod-$meltlib_ANA_TREE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:712/642 compiling library module for libmelt-ana-tree optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:714/643 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree \
  	  || ( meltbuild_notice melt-build-script.tpl:721/644 in meltbuild-modules failure to compile library libmelt-ana-tree optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:723/645 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree ; \
  	       meltbuild_error  melt-build-script.tpl:730/646 in meltbuild-modules failed to compile library libmelt-ana-tree optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:733/647 not compiling library module for libmelt-ana-tree optimized
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-tree.meltmod-$meltlib_ANA_TREE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:712/648 compiling library module for libmelt-ana-tree debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:714/649 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree \
  	  || ( meltbuild_notice melt-build-script.tpl:721/650 in meltbuild-modules failure to compile library libmelt-ana-tree debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:723/651 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree ; \
  	       meltbuild_error  melt-build-script.tpl:730/652 in meltbuild-modules failed to compile library libmelt-ana-tree debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:733/653 not compiling library module for libmelt-ana-tree debugnoline
    fi
   
  
  
    ## meltbuild_do_library libmelt-ana-gimple melt-build-script.tpl:683/654
    meltbuild_info melt-build-script.tpl:684/655 doing library libmelt-ana-gimple
    ...
    ## meltbuild_do_library libmelt-ana-gimple melt-build-script.tpl:688/656
   ...
   -o meltbuild-sources/libmelt-ana-tree+meltdesc.c -ot meltbuild-sources/libmelt-ana-gimple+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:694/657 emit library C++ code for libmelt-ana-gimple
        meltbuild_emit melt-build-script.tpl:695/658 \
  	  translatefile \
  	  libmelt-ana-gimple \
  	  meltbuild-sources \
  	  meltbuild-modules \
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:702/659 failed to generate C++ code of library libmelt-ana-gimple
    else
        meltbuild_info melt-build-script.tpl:704/660 DONT emit library C++ code for libmelt-ana-gimple
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-gimple.meltmod-$meltlib_ANA_GIMPLE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:712/661 compiling library module for libmelt-ana-gimple quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:714/662 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:721/663 in meltbuild-modules failure to compile library libmelt-ana-gimple quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:723/664 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple ; \
  	       meltbuild_error  melt-build-script.tpl:730/665 in meltbuild-modules failed to compile library libmelt-ana-gimple quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:733/666 not compiling library module for libmelt-ana-gimple quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-gimple.meltmod-$meltlib_ANA_GIMPLE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:712/667 compiling library module for libmelt-ana-gimple optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:714/668 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple \
  	  || ( meltbuild_notice melt-build-script.tpl:721/669 in meltbuild-modules failure to compile library libmelt-ana-gimple optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:723/670 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple ; \
  	       meltbuild_error  melt-build-script.tpl:730/671 in meltbuild-modules failed to compile library libmelt-ana-gimple optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:733/672 not compiling library module for libmelt-ana-gimple optimized
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-gimple.meltmod-$meltlib_ANA_GIMPLE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:712/673 compiling library module for libmelt-ana-gimple debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:714/674 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple \
  	  || ( meltbuild_notice melt-build-script.tpl:721/675 in meltbuild-modules failure to compile library libmelt-ana-gimple debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:723/676 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple ; \
  	       meltbuild_error  melt-build-script.tpl:730/677 in meltbuild-modules failed to compile library libmelt-ana-gimple debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:733/678 not compiling library module for libmelt-ana-gimple debugnoline
    fi
   
  
    ## meltbuild_do_library  melt-build-script.tpl:737/679
  ...
  meltbuild_info melt-build-script.tpl:750/680 times after library at `date '+%x %H:%M:%S'`: ;  times >&2
} ## end function meltbuild_do_library  melt-build-script.tpl:751/681


function meltbuild_do_an_extra () {
  xtrabase=$1
  meltbuild_notice 'start doing an extra'  melt-build-script.tpl:756/682 doing an xtra $xtrabase
  ...
  if [ ! -f meltbuild-sources/$xtrabase.cc -o  ! -f meltbuild-sources/$xtrabase+meltdesc.c \
  	 ...
  	 ; then
      meltbuild_info melt-build-script.tpl:767/683 emit extra C++ code for $xtrabase
      meltbuild_emit melt-build-script.tpl:768/684 \
  	  translatefile \
  	  $xtrabase \
  	  meltbuild-sources \
  	  meltbuild-modules \
    ...
    "" \
  	  || meltbuild_error melt-build-script.tpl:775/685 failed to generate C++ code of $xtrabase
  else
      meltbuild_info melt-build-script.tpl:777/686 DONT emit extra C++ code for $xtrabase
  fi

  
  # do_an_extra flavor quicklybuilt  melt-build-script.tpl:781/687      
  if [ ! -f meltbuild-modules/$xtrabase.meltmod-$meltlib__cumulmd5.quicklybuilt.so \
      ...
      meltbuild_info melt-build-script.tpl:786/688 compiling extra module for $xtrabase quicklybuilt
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:788/689 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:795/690 in meltbuild-modules failure to compile extra $xtrabase quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:797/691 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/$xtrabase \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/$xtrabase ; \
  	       meltbuild_error  melt-build-script.tpl:804/692 in meltbuild-modules failed to compile library $xtrabase quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
      meltbuild_info melt-build-script.tpl:807/693 not compiling extra module for $xtrabase quicklybuilt
  fi
  
  # do_an_extra flavor optimized  melt-build-script.tpl:781/694      
  if [ ! -f meltbuild-modules/$xtrabase.meltmod-$meltlib__cumulmd5.optimized.so \
      ...
      meltbuild_info melt-build-script.tpl:786/695 compiling extra module for $xtrabase optimized
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:788/696 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/$xtrabase \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/$xtrabase \
  	  || ( meltbuild_notice melt-build-script.tpl:795/697 in meltbuild-modules failure to compile extra $xtrabase optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:797/698 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/$xtrabase \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/$xtrabase ; \
  	       meltbuild_error  melt-build-script.tpl:804/699 in meltbuild-modules failed to compile library $xtrabase optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
      meltbuild_info melt-build-script.tpl:807/700 not compiling extra module for $xtrabase optimized
  fi
  
  # do_an_extra flavor debugnoline  melt-build-script.tpl:781/701      
  if [ ! -f meltbuild-modules/$xtrabase.meltmod-$meltlib__cumulmd5.debugnoline.so \
      ...
      meltbuild_info melt-build-script.tpl:786/702 compiling extra module for $xtrabase debugnoline
      $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:788/703 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/$xtrabase \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/$xtrabase \
  	  || ( meltbuild_notice melt-build-script.tpl:795/704 in meltbuild-modules failure to compile extra $xtrabase debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:797/705 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/$xtrabase \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/$xtrabase ; \
  	       meltbuild_error  melt-build-script.tpl:804/706 in meltbuild-modules failed to compile library $xtrabase debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
      meltbuild_info melt-build-script.tpl:807/707 not compiling extra module for $xtrabase debugnoline
  fi
...
if [ ! -f  "$melt_final_library_stamp" \
 ...
 -o "$melt_final_library_stamp" -ot "$GCCMELT_MELTSOURCEDIR/libmelt-ana-gimple.melt" \
    ...
    meltbuild_info melt-build-script.tpl:817/708 building MELT library
    meltbuild_do_library
    
    ## do an extra xtramelt-ana-simple  melt-build-script.tpl:820/709 
    meltbuild_do_an_extra xtramelt-ana-simple
    
    ## do an extra xtramelt-playground  melt-build-script.tpl:820/710 
    meltbuild_do_an_extra xtramelt-playground
    
else
    meltbuild_info melt-build-script.tpl:824/711 not building MELT library because of libstamp  "$melt_final_library_stamp"
fi

################################################################
#@ melt-build-script.tpl:828/712
if [ "$melt_overall_goal" = "library" ]; then
    meltbuild_info melt-build-script.tpl:830/713 done library overall goal with stamp  $melt_final_translator_stamp
    meltbuild_notice 'Done library' melt-build-script.tpl:831/714 library overall goal 
    exit 0
fi

################################################################
################################################################
### the modules lists melt-build-script.tpl:837/715
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis" \
  ...
  #  melt-build-script.tpl:842/716 module list quicklybuilt
  meltbuild_info  melt-build-script.tpl:843/717 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"
  ...
  echo "# MELT translator modules:" >> $melt_modlis_temp
  #  melt-build-script.tpl:847/718 module list quicklybuilt translator
  ...
  #  melt-build-script.tpl:851/719 module list quicklybuilt library
  ...
  #  melt-build-script.tpl:856/720 module list quicklybuilt extra, with mode condition
 echo "# MELT extra modules with mode condition:" >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-ana-simple\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-ana-simple.melt ] || meltbuild_error  melt-build-script.tpl:860/721 missing or empty meltbuild-sources/xtramelt-ana-simple.melt
 ...
 [ -s  meltbuild-sources/xtramelt-playground.melt ] || meltbuild_error  melt-build-script.tpl:860/722 missing or empty meltbuild-sources/xtramelt-playground.melt
 ...
 echo "# end MELT module list $MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis" >> $melt_modlis_temp
  ...
  meltbuild_info  melt-build-script.tpl:866/723 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" \
  ...
  #  melt-build-script.tpl:842/724 module list optimized
  meltbuild_info  melt-build-script.tpl:843/725 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"
  ...
  echo "# MELT translator modules:" >> $melt_modlis_temp
  #  melt-build-script.tpl:847/726 module list optimized translator
  ...
  #  melt-build-script.tpl:851/727 module list optimized library
  echo "# MELT library modules:" >> $melt_modlis_temp
  ...
  #  melt-build-script.tpl:856/728 module list optimized extra, with mode condition
 echo "# MELT extra modules with mode condition:" >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-ana-simple\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-ana-simple.melt ] || meltbuild_error  melt-build-script.tpl:860/729 missing or empty meltbuild-sources/xtramelt-ana-simple.melt
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-ana-simple.optimized\n", $2);}} END{printf("# %d MELT modes in xtramelt-ana-simple\n", nbmod);}' meltbuild-sources/xtramelt-ana-simple.melt | sort -u >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-playground\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-playground.melt ] || meltbuild_error  melt-build-script.tpl:860/730 missing or empty meltbuild-sources/xtramelt-playground.melt
 ...
 echo "# end MELT module list $MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" >> $melt_modlis_temp
  ...
  meltbuild_info  melt-build-script.tpl:866/731 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" \
  ...
  #  melt-build-script.tpl:842/732 module list debugnoline
  meltbuild_info  melt-build-script.tpl:843/733 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"
  ...
  echo "# MELT translator modules:" >> $melt_modlis_temp
  #  melt-build-script.tpl:847/734 module list debugnoline translator
  ...
  #  melt-build-script.tpl:851/735 module list debugnoline library
  echo "# MELT library modules:" >> $melt_modlis_temp
  ...
  #  melt-build-script.tpl:856/736 module list debugnoline extra, with mode condition
 echo "# MELT extra modules with mode condition:" >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-ana-simple\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-ana-simple.melt ] || meltbuild_error  melt-build-script.tpl:860/737 missing or empty meltbuild-sources/xtramelt-ana-simple.melt
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-ana-simple.debugnoline\n", $2);}} END{printf("# %d MELT modes in xtramelt-ana-simple\n", nbmod);}' meltbuild-sources/xtramelt-ana-simple.melt | sort -u >> $melt_modlis_temp
 
 printf '# MELT extra module xtramelt-playground\n' >> $melt_modlis_temp
 [ -s  meltbuild-sources/xtramelt-playground.melt ] || meltbuild_error  melt-build-script.tpl:860/738 missing or empty meltbuild-sources/xtramelt-playground.melt
 ...
 echo "# end MELT module list $MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" >> $melt_modlis_temp
  ...
  meltbuild_info  melt-build-script.tpl:866/739 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"  
fi


#@ melt-build-script.tpl:870/740
...
################################################################
#@ melt-build-script.tpl:876/741 module lists
if [ "$melt_overall_goal" = "modlists" ]; then
    meltbuild_info melt-build-script.tpl:878/742 done modlists overall goal with stamp  $melt_final_library_stamp
    exit 0
fi
...
########################### EXTRA ############################
################
#@ melt-build-script.tpl:886/743 before extra libmelt* modules
################################################################
meltbuild_info melt-build-script.tpl:888/744 before extra GCCMELT_SKIPEMITC=$GCCMELT_SKIPEMITC.

meltbuild_info melt-build-script.tpl:890/745 times before extras at `date '+%x %H:%M:%S'`: ;  times >&2
...
function meltbuild_do_extras () {
  meltbuild_notice 'start doing extras'  melt-build-script.tpl:897/746 doing extras 
  
  
    ## meltbuild_do_extras xtramelt-ana-simple melt-build-script.tpl:900/747
    meltbuild_info melt-build-script.tpl:901/748 doing extra xtramelt-ana-simple
    ...
    ## meltbuild_do_extras xtramelt-ana-simple melt-build-script.tpl:905/749
    if [ ! -f meltbuild-sources/xtramelt-ana-simple.cc -o  ! -f meltbuild-sources/xtramelt-ana-simple+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:910/750 emit extra C++ code for xtramelt-ana-simple
        meltbuild_emit melt-build-script.tpl:911/751 \
  	  translatefile \
  	  xtramelt-ana-simple \
  	  meltbuild-sources \
  	  meltbuild-modules \
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:918/752 failed to generate C++ code of extra xtramelt-ana-simple
    else
        meltbuild_info melt-build-script.tpl:920/753 DONT emit extra C++ code for xtramelt-ana-simple
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltextra_ANA_SIMPLE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:928/754 compiling extra module for xtramelt-ana-simple quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:930/755 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:937/756 in meltbuild-modules failure to compile extra xtramelt-ana-simple quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:939/757 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:946/758 in meltbuild-modules failed to compile extra xtramelt-ana-simple quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:949/759 not compiling extra module for xtramelt-ana-simple quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltextra_ANA_SIMPLE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:928/760 compiling extra module for xtramelt-ana-simple optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:930/761 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
  	  || ( meltbuild_notice melt-build-script.tpl:937/762 in meltbuild-modules failure to compile extra xtramelt-ana-simple optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:939/763 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:946/764 in meltbuild-modules failed to compile extra xtramelt-ana-simple optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:949/765 not compiling extra module for xtramelt-ana-simple optimized
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltextra_ANA_SIMPLE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:928/766 compiling extra module for xtramelt-ana-simple debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:930/767 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
  	  || ( meltbuild_notice melt-build-script.tpl:937/768 in meltbuild-modules failure to compile extra xtramelt-ana-simple debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:939/769 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:946/770 in meltbuild-modules failed to compile extra xtramelt-ana-simple debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:949/771 not compiling extra module for xtramelt-ana-simple debugnoline
    fi
   
   ## meltbuild_do_extras after build xtramelt-ana-simple melt-build-script.tpl:952/772
   
   
  
    ## meltbuild_do_extras xtramelt-playground melt-build-script.tpl:900/773
    meltbuild_info melt-build-script.tpl:901/774 doing extra xtramelt-playground
    ...
    ## meltbuild_do_extras xtramelt-playground melt-build-script.tpl:905/775
    if [ ! -f meltbuild-sources/xtramelt-playground.cc -o  ! -f meltbuild-sources/xtramelt-playground+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:910/776 emit extra C++ code for xtramelt-playground
        meltbuild_emit melt-build-script.tpl:911/777 \
  	  translatefile \
  	  xtramelt-playground \
  	  meltbuild-sources \
  	  meltbuild-modules \
  	  warmelt-first.optimized:warmelt-base.optimized:warmelt-debug.optimized:warmelt-macro.optimized:warmelt-moremacro.optimized:warmelt-normal.optimized:warmelt-normatch.optimized:warmelt-genobj.optimized:warmelt-outobj.optimized:warmelt-hooks.optimized:warmelt-modes.optimized:libmelt-ana-base.optimized:libmelt-ana-tree.optimized:libmelt-ana-gimple.optimized \
      "" \
  	  || meltbuild_error melt-build-script.tpl:918/778 failed to generate C++ code of extra xtramelt-playground
    else
        meltbuild_info melt-build-script.tpl:920/779 DONT emit extra C++ code for xtramelt-playground
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltextra_PLAYGROUND_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:928/780 compiling extra module for xtramelt-playground quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:930/781 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:937/782 in meltbuild-modules failure to compile extra xtramelt-playground quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:939/783 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:946/784 in meltbuild-modules failed to compile extra xtramelt-playground quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:949/785 not compiling extra module for xtramelt-playground quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltextra_PLAYGROUND_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:928/786 compiling extra module for xtramelt-playground optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:930/787 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
  	  || ( meltbuild_notice melt-build-script.tpl:937/788 in meltbuild-modules failure to compile extra xtramelt-playground optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:939/789 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:946/790 in meltbuild-modules failed to compile extra xtramelt-playground optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:949/791 not compiling extra module for xtramelt-playground optimized
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltextra_PLAYGROUND_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:928/792 compiling extra module for xtramelt-playground debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:930/793 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
  	  || ( meltbuild_notice melt-build-script.tpl:937/794 in meltbuild-modules failure to compile extra xtramelt-playground debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:939/795 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:946/796 in meltbuild-modules failed to compile extra xtramelt-playground debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:949/797 not compiling extra module for xtramelt-playground debugnoline
    fi
   
   ## meltbuild_do_extras after build xtramelt-playground melt-build-script.tpl:952/798
   
   
 
   ## meltbuild_do_extras timestamping  melt-build-script.tpl:956/799
   ...
   ## meltbuild_do_extras end extra xtramelt-ana-simple melt-build-script.tpl:966/800
   ...
   ## meltbuild_do_extras end extra xtramelt-playground melt-build-script.tpl:966/801
 
   

    ## meltbuild_do_extras final  melt-build-script.tpl:970/802
    echo "///end stamp $melt_final_extra_stamp"  >> $meltextrastamptemp
    $GCCMELT_MOVE_IF_CHANGE $meltextrastamptemp  $melt_final_extra_stamp
  meltbuild_info melt-build-script.tpl:973/803 times after extras at `date '+%x %H:%M:%S'`: ;  times >&2
} ## end function meltbuild_do_extras  melt-build-script.tpl:974/804

 ## building extras melt-build-script.tpl:976/805
if [ ! -f  "$melt_final_extra_stamp" \
 ...
 -o "$melt_final_extra_stamp" -ot "$GCCMELT_MELTSOURCEDIR/xtramelt-playground.melt" \
    ...
    meltbuild_info melt-build-script.tpl:982/806 building MELT extras
    meltbuild_do_extras
else
    meltbuild_info melt-build-script.tpl:985/807 not building MELT extra because of xtrastamp  "$melt_final_extra_stamp"
fi
 ## done building extras melt-build-script.tpl:987/808


################################################################
################################################################
#@ melt-build-script.tpl:992/809 runtime self check

##  melt-build-script.tpl:994/810 FIXME: should skip that when cross-compiler MELT plugin..

if [ -z "$GCCMELT_RUNTIME_CC" ]; then 
    meltbuild_error melt-build-script.tpl:997/811 failed because no GCCMELT_RUNTIME_CC shell variable
    exit 1
fi
...
if [ ! -f $meltcheckruntime_stamp -o $meltcheckruntime_stamp -ot "$GCCMELT_RUNTIME_ARGS" \
    ...
    #@ melt-build-script.tpl:1005/812 checkruntime
    if [ -f melt-no-check-runtime -o -n "$MELTGCC_NO_CHECK_RUNTIME" -o ! -f melt-runtime.ii ]; then
	meltbuild_info melt-build-script.tpl:1007/813 skipping check of MELT runtime
    else
	meltcheckruntime_args=meltbuild-checkruntime.args 
	meltcheckruntime_argstemp=$meltcheckruntime_args-tmp$$
	echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:1011/814"' ' -DGCCMELT_CHECKMELTRUNTIME' > $meltcheckruntime_argstemp
	...
	[ -f "$meltcheckruntime_args" ] || meltbuild_error  melt-build-script.tpl:1022/815 missing check runtime args  "$meltcheckruntime_args"
	meltbuild_info melt-build-script.tpl:1023/816 $meltcheckruntime_args  is
	...
	if [ -n "$MELTGCCBUILTIN_BUILD_WITH_CXX" ]; then
		...
		|| meltbuild_error melt-build-script.tpl:1027/817 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	else
	    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltcheckruntime_args \
		|| meltbuild_error melt-build-script.tpl:1030/818 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	fi
	meltbuild_info melt-build-script.tpl:1032/819 done check runtime with $meltcheckruntime_args
    fi

   #@ melt-build-script.tpl:1035/820 checkhello
    meltcheckhelloworld_args=meltbuild-checkhelloworld.args 
    meltcheckhelloworld_argstemp=$meltcheckhelloworld_args-tmp$$
    echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:1038/821" -DGCCMELT_CHECKHELLO' > $meltcheckhelloworld_argstemp
    ...
    [ -f "$meltcheckhelloworld_args" ] || meltbuild_error  melt-build-script.tpl:1052/822 missing check helloworld args  "$meltcheckhelloworld_args"
   meltbuild_info melt-build-script.tpl:1053/823 $meltcheckhelloworld_args  is
   cat $meltcheckhelloworld_args < /dev/null >&2
    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltcheckhelloworld_args \
	|| meltbuild_error melt-build-script.tpl:1056/824 running helloworld failed with arguments @$meltcheckhelloworld_args
   meltbuild_info melt-build-script.tpl:1057/825 done check helloworld with $meltcheckhelloworld_args
   #@ melt-build-script.tpl:1058/826 runtime stamp
    meltcheckruntime_stamptemp=$meltcheckruntime_stamp-tmp$$
    [ -f "$GCCMELT_RUNTIME_CC" ] || meltbuild_error melt-build-script.tpl:1060/827 missing MELT runtime C++ file $GCCMELT_RUNTIME_CC
    ...
    [ -f "$melt_final_translator_stamp" ] || meltbuild_error melt-build-script.tpl:1065/828 missing final translator stamp "$melt_final_translator_stamp"
    [ -f "$melt_final_library_stamp" ] || meltbuild_error melt-build-script.tpl:1066/829 missing final library stamp "$melt_final_library_stamp"
    ...
    echo
    #@ melt-build-script.tpl:1071/830 justcount
    meltjustcount_args=meltbuild-justcount.args
    meltjustcount_argstemp=$meltjustcount_args-tmp$$
    echo  ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:1074/831" -DGCCMELT_JUSTCOUNT -fexceptions melt-runtime.ii ' > $meltjustcount_argstemp
    ...
    [ -f "$meltjustcount_args" ] || meltbuild_error  melt-build-script.tpl:1085/832 missing check justcount args  "$meltjustcount_args"
   meltbuild_info melt-build-script.tpl:1086/833 $meltjustcount_args  is
   cat $meltjustcount_args < /dev/null >&2
   echo
   $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltjustcount_args \
	|| meltbuild_error melt-build-script.tpl:1090/834 running justcount failed with arguments @$meltjustcount_args
   meltbuild_info melt-build-script.tpl:1091/835 done check justcount with $meltjustcount_args
   echo

   $GCCMELT_MOVE_IF_CHANGE  $meltcheckruntime_stamptemp $meltcheckruntime_stamp
   meltbuild_info melt-build-script.tpl:1095/836 done check runtime  $meltcheckruntime_stamp
    
else
    meltbuild_info melt-build-script.tpl:1098/837 keeping runtime checks  $meltcheckruntime_stamp
fi

if [ "$melt_overall_goal" = "checkruntime" ]; then
    meltbuild_info melt-build-script.tpl:1102/838 done checkruntime overall goal with stamp  $meltcheckruntime_stamp
    exit 0
fi

################################################################
#@ melt-build-script.tpl:1107/839
if [ "$melt_overall_goal" = "applications" ]; then
    meltbuild_info melt-build-script.tpl:1109/840 done applications overall goal with stamp  $meltcheckruntime_stamp
    exit 0
fi

################################################################
################################################################
### the generated documentation meltgendoc.texi melt-build-script.tpl:1115/841
...
if [   ! -f meltgendoc.texi  -o meltbuild-sources/warmelt-first.melt -nt meltgendoc.texi  \
 ...
 -o meltbuild-sources/libmelt-ana-gimple.melt -nt meltgendoc.texi   ]; then
   meltbuild_info melt-build-script.tpl:1119/842 generating meltgendoc.texi
   meltgen_args=meltbuild-gendoc.args-tmp$$
   echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:1121/843"' > $meltgen_args
...
meltbuild_arg "module-makefile=\"$GCCMELT_MODULE_MK\""  >>  $meltgen_args
   ...
   meltbuild_info melt-build-script.tpl:1135/844  meltbuild-gendoc.args is
   cat meltbuild-gendoc.args < /dev/null >&2
   $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @meltbuild-gendoc.args \
     || meltbuild_error melt-build-script.tpl:1138/845  "$GCCMELT_CC1PLUS" failed with arguments @meltbuild-gendoc.args
else
   meltbuild_info melt-build-script.tpl:1140/846 keeping meltgendoc.texi
fi

################
meltbuild_info melt-build-script.tpl:1144/847 successfully done with times at `date '+%x %H:%M:%S'`: ; times >&2

################################################################
#@ melt-build-script.tpl:1147/848
if [ "$melt_overall_goal" = "gendoc" ]; then
    meltbuild_info melt-build-script.tpl:1149/849 done gendoc overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

## #@ melt-build-script.tpl:1153/850 if we get here something is wrong in this script
meltbuild_error  melt-build-script.tpl:1154/851 unexpected MELT overall goal "$melt_overall_goal" buggy melt-build-script.tpl
#@ eof melt-build-script.tpl:1155/852 end of generated melt-build-script.sh
