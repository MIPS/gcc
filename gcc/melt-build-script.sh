...
#@#@#
#@#@# It has been AutoGen-ed  October 18, 2013 at 11:35:53 AM by AutoGen 5.18.1
...
meltbuild_arg "module-makefile=\"$GCCMELT_MODULE_MK\""  >>  $meltgen_args
   ...
   $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @meltbuild-gendoc.args \
     || meltbuild_error melt-build-script.tpl:876/705  "$GCCMELT_CC1PLUS" failed with arguments @meltbuild-gendoc.args
else
