...
#@#@#
#@#@# It has been AutoGen-ed  April  1, 2014 at 02:06:50 PM by AutoGen 5.18.1
...
########################### LIBRARY ############################
################
#@ melt-build-script.tpl:660/600 before library libmelt* modules
################################################################
meltbuild_info melt-build-script.tpl:662/601 before library GCCMELT_SKIPEMITC=$GCCMELT_SKIPEMITC.

meltbuild_info melt-build-script.tpl:664/602 times before libraries at `date '+%x %H:%M:%S'`: ;  times >&2
 
melt_final_library_stamp=meltbuild-final-library.stamp

function meltbuild_do_libraries () {
  meltbuild_notice 'start doing libraries'  melt-build-script.tpl:669/603 doing libraries 
  
  
    ## meltbuild_do_libraries libmelt-ana-base melt-build-script.tpl:672/604
    meltbuild_info melt-build-script.tpl:673/605 doing library libmelt-ana-base
    ...
    ## meltbuild_do_libraries libmelt-ana-base melt-build-script.tpl:677/606
    if [ ! -f meltbuild-sources/libmelt-ana-base.cc -o  ! -f meltbuild-sources/libmelt-ana-base+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:683/607 emit library C++ code for libmelt-ana-base
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:691/609 failed to generate C++ code of library libmelt-ana-base
    else
        meltbuild_info melt-build-script.tpl:693/610 DONT emit library C++ code for libmelt-ana-base
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-base.meltmod-$meltlib_ANA_BASE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:701/611 compiling library module for libmelt-ana-base quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:710/613 in meltbuild-modules failure to compile library libmelt-ana-base quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     ...
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base ; \
  	       meltbuild_error  melt-build-script.tpl:719/615 in meltbuild-modules failed to compile library libmelt-ana-base quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:722/616 not compiling library module for libmelt-ana-base quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-base.meltmod-$meltlib_ANA_BASE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:701/617 compiling library module for libmelt-ana-base optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  ...
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base \
  	  || ( meltbuild_notice melt-build-script.tpl:710/619 in meltbuild-modules failure to compile library libmelt-ana-base optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     ...
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base ; \
  	       meltbuild_error  melt-build-script.tpl:719/621 in meltbuild-modules failed to compile library libmelt-ana-base optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:722/622 not compiling library module for libmelt-ana-base optimized
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-base.meltmod-$meltlib_ANA_BASE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:701/623 compiling library module for libmelt-ana-base debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  ...
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base \
  	  || ( meltbuild_notice melt-build-script.tpl:710/625 in meltbuild-modules failure to compile library libmelt-ana-base debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     ...
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-base \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-base ; \
  	       meltbuild_error  melt-build-script.tpl:719/627 in meltbuild-modules failed to compile library libmelt-ana-base debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:722/628 not compiling library module for libmelt-ana-base debugnoline
    fi
   
  
  
    ## meltbuild_do_libraries libmelt-ana-tree melt-build-script.tpl:672/629
    meltbuild_info melt-build-script.tpl:673/630 doing library libmelt-ana-tree
    ...
    ## meltbuild_do_libraries libmelt-ana-tree melt-build-script.tpl:677/631
   ...
   -o meltbuild-sources/libmelt-ana-base+meltdesc.c -ot meltbuild-sources/libmelt-ana-tree+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:683/632 emit library C++ code for libmelt-ana-tree
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:691/634 failed to generate C++ code of library libmelt-ana-tree
    else
        meltbuild_info melt-build-script.tpl:693/635 DONT emit library C++ code for libmelt-ana-tree
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-tree.meltmod-$meltlib_ANA_TREE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:701/636 compiling library module for libmelt-ana-tree quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:710/638 in meltbuild-modules failure to compile library libmelt-ana-tree quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     ...
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree ; \
  	       meltbuild_error  melt-build-script.tpl:719/640 in meltbuild-modules failed to compile library libmelt-ana-tree quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:722/641 not compiling library module for libmelt-ana-tree quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-tree.meltmod-$meltlib_ANA_TREE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:701/642 compiling library module for libmelt-ana-tree optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  ...
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree \
  	  || ( meltbuild_notice melt-build-script.tpl:710/644 in meltbuild-modules failure to compile library libmelt-ana-tree optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     ...
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree ; \
  	       meltbuild_error  melt-build-script.tpl:719/646 in meltbuild-modules failed to compile library libmelt-ana-tree optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:722/647 not compiling library module for libmelt-ana-tree optimized
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-tree.meltmod-$meltlib_ANA_TREE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:701/648 compiling library module for libmelt-ana-tree debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  ...
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree \
  	  || ( meltbuild_notice melt-build-script.tpl:710/650 in meltbuild-modules failure to compile library libmelt-ana-tree debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     ...
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-tree \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-tree ; \
  	       meltbuild_error  melt-build-script.tpl:719/652 in meltbuild-modules failed to compile library libmelt-ana-tree debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:722/653 not compiling library module for libmelt-ana-tree debugnoline
    fi
   
  
  
    ## meltbuild_do_libraries libmelt-ana-gimple melt-build-script.tpl:672/654
    meltbuild_info melt-build-script.tpl:673/655 doing library libmelt-ana-gimple
    ...
    ## meltbuild_do_libraries libmelt-ana-gimple melt-build-script.tpl:677/656
   ...
   -o meltbuild-sources/libmelt-ana-tree+meltdesc.c -ot meltbuild-sources/libmelt-ana-gimple+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:683/657 emit library C++ code for libmelt-ana-gimple
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:691/659 failed to generate C++ code of library libmelt-ana-gimple
    else
        meltbuild_info melt-build-script.tpl:693/660 DONT emit library C++ code for libmelt-ana-gimple
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-gimple.meltmod-$meltlib_ANA_GIMPLE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:701/661 compiling library module for libmelt-ana-gimple quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:710/663 in meltbuild-modules failure to compile library libmelt-ana-gimple quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     ...
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple ; \
  	       meltbuild_error  melt-build-script.tpl:719/665 in meltbuild-modules failed to compile library libmelt-ana-gimple quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:722/666 not compiling library module for libmelt-ana-gimple quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-gimple.meltmod-$meltlib_ANA_GIMPLE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:701/667 compiling library module for libmelt-ana-gimple optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  ...
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple \
  	  || ( meltbuild_notice melt-build-script.tpl:710/669 in meltbuild-modules failure to compile library libmelt-ana-gimple optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     ...
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple ; \
  	       meltbuild_error  melt-build-script.tpl:719/671 in meltbuild-modules failed to compile library libmelt-ana-gimple optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:722/672 not compiling library module for libmelt-ana-gimple optimized
    fi
    ...
    if [ ! -f meltbuild-modules/libmelt-ana-gimple.meltmod-$meltlib_ANA_GIMPLE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:701/673 compiling library module for libmelt-ana-gimple debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  ...
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple \
  	  || ( meltbuild_notice melt-build-script.tpl:710/675 in meltbuild-modules failure to compile library libmelt-ana-gimple debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     ...
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/libmelt-ana-gimple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/libmelt-ana-gimple ; \
  	       meltbuild_error  melt-build-script.tpl:719/677 in meltbuild-modules failed to compile library libmelt-ana-gimple debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:722/678 not compiling library module for libmelt-ana-gimple debugnoline
    fi
   
  
    ## meltbuild_do_libraries  melt-build-script.tpl:726/679
  ...
  meltbuild_info melt-build-script.tpl:739/680 times after libraries at `date '+%x %H:%M:%S'`: ;  times >&2
} ## end function meltbuild_do_libraries  melt-build-script.tpl:740/681
...
if [ ! -f  "$melt_final_library_stamp" \
 ...
 -o "$melt_final_library_stamp" -ot "$GCCMELT_MELTSOURCEDIR/libmelt-ana-gimple.melt" \
    ...
    meltbuild_info melt-build-script.tpl:747/682 building MELT libraries
    meltbuild_do_libraries
else
    meltbuild_info melt-build-script.tpl:750/683 not building MELT libraries because of applstamp  "$melt_final_library_stamp"
fi

################################################################
#@ melt-build-script.tpl:754/684
if [ "$melt_overall_goal" = "libraries" ]; then
    meltbuild_info melt-build-script.tpl:756/685 done libraries overall goal with stamp  $melt_final_translator_stamp
    meltbuild_notice 'Done libraries' melt-build-script.tpl:757/686 libraries overall goal 
    exit 0
fi

################################################################
################################################################
### the modules lists melt-build-script.tpl:763/687
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis" \
  ...
  #  melt-build-script.tpl:768/688 module list quicklybuilt
  meltbuild_info  melt-build-script.tpl:769/689 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:783/691 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" \
  ...
  #  melt-build-script.tpl:768/692 module list optimized
  meltbuild_info  melt-build-script.tpl:769/693 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:783/695 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" \
  ...
  #  melt-build-script.tpl:768/696 module list debugnoline
  meltbuild_info  melt-build-script.tpl:769/697 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"
  ...
  meltbuild_info  melt-build-script.tpl:783/699 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"  
fi


#@ melt-build-script.tpl:787/700
...
################################################################
#@ melt-build-script.tpl:793/701 module lists
if [ "$melt_overall_goal" = "modlists" ]; then
    meltbuild_info melt-build-script.tpl:795/702 done modlists overall goal with stamp  $melt_final_library_stamp
    exit 0
fi
...
########################### EXTRA ############################
################
#@ melt-build-script.tpl:803/703 before extra libmelt* modules
################################################################
meltbuild_info melt-build-script.tpl:805/704 before extra GCCMELT_SKIPEMITC=$GCCMELT_SKIPEMITC.

meltbuild_info melt-build-script.tpl:807/705 times before extras at `date '+%x %H:%M:%S'`: ;  times >&2
...
function meltbuild_do_extras () {
  meltbuild_notice 'start doing extras'  melt-build-script.tpl:814/706 doing extras 
  
  
    ## meltbuild_do_extras xtramelt-probe melt-build-script.tpl:817/707
    meltbuild_info melt-build-script.tpl:818/708 doing extra xtramelt-probe
    ...
    ## meltbuild_do_extras xtramelt-probe melt-build-script.tpl:822/709
    if [ ! -f meltbuild-sources/xtramelt-probe.cc -o  ! -f meltbuild-sources/xtramelt-probe+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:827/710 emit library C++ code for xtramelt-probe
        meltbuild_emit melt-build-script.tpl:828/711 \
  	  translatefile \
  	  xtramelt-probe \
  	  meltbuild-sources \
  	  meltbuild-modules \
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:835/712 failed to generate C++ code of extra xtramelt-probe
    else
        meltbuild_info melt-build-script.tpl:837/713 DONT emit extra C++ code for xtramelt-probe
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.quicklybuilt.so \
        -o meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.quicklybuilt.so -ot  meltbuild-final-translator.stamp \
        -o  meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.quicklybuilt.so -ot  meltbuild-sources/xtramelt-probe.cc \
        -o  meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.quicklybuilt.so -ot  meltbuild-sources/xtramelt-probe+meltdesc.c ]; then
        meltbuild_info melt-build-script.tpl:845/714 compiling extra module for xtramelt-probe quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:847/715 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:854/716 in meltbuild-modules failure to compile extra xtramelt-probe quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:856/717 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe ; \
  	       meltbuild_error  melt-build-script.tpl:863/718 in meltbuild-modules failed to compile library xtramelt-probe quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:866/719 not compiling library module for xtramelt-probe quicklybuilt
    fi
   
    if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.optimized.so \
        -o meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.optimized.so -ot  meltbuild-final-translator.stamp \
        -o  meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.optimized.so -ot  meltbuild-sources/xtramelt-probe.cc \
        -o  meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.optimized.so -ot  meltbuild-sources/xtramelt-probe+meltdesc.c ]; then
        meltbuild_info melt-build-script.tpl:845/720 compiling extra module for xtramelt-probe optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:847/721 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
  	  || ( meltbuild_notice melt-build-script.tpl:854/722 in meltbuild-modules failure to compile extra xtramelt-probe optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:856/723 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe ; \
  	       meltbuild_error  melt-build-script.tpl:863/724 in meltbuild-modules failed to compile library xtramelt-probe optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:866/725 not compiling library module for xtramelt-probe optimized
    fi
   
    if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.debugnoline.so \
        -o meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.debugnoline.so -ot  meltbuild-final-translator.stamp \
        -o  meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.debugnoline.so -ot  meltbuild-sources/xtramelt-probe.cc \
        -o  meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.debugnoline.so -ot  meltbuild-sources/xtramelt-probe+meltdesc.c ]; then
        meltbuild_info melt-build-script.tpl:845/726 compiling extra module for xtramelt-probe debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:847/727 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
  	  || ( meltbuild_notice melt-build-script.tpl:854/728 in meltbuild-modules failure to compile extra xtramelt-probe debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:856/729 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe ; \
  	       meltbuild_error  melt-build-script.tpl:863/730 in meltbuild-modules failed to compile library xtramelt-probe debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:866/731 not compiling library module for xtramelt-probe debugnoline
    fi
   
  
  
    ## meltbuild_do_extras xtramelt-ana-simple melt-build-script.tpl:817/732
    meltbuild_info melt-build-script.tpl:818/733 doing extra xtramelt-ana-simple
    ...
    ## meltbuild_do_extras xtramelt-ana-simple melt-build-script.tpl:822/734
    if [ ! -f meltbuild-sources/xtramelt-ana-simple.cc -o  ! -f meltbuild-sources/xtramelt-ana-simple+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:827/735 emit library C++ code for xtramelt-ana-simple
        meltbuild_emit melt-build-script.tpl:828/736 \
  	  translatefile \
  	  xtramelt-ana-simple \
  	  meltbuild-sources \
  	  meltbuild-modules \
  	  warmelt-first.optimized:warmelt-base.optimized:warmelt-debug.optimized:warmelt-macro.optimized:warmelt-moremacro.optimized:warmelt-normal.optimized:warmelt-normatch.optimized:warmelt-genobj.optimized:warmelt-outobj.optimized:warmelt-hooks.optimized:warmelt-modes.optimized:libmelt-ana-base.optimized:libmelt-ana-tree.optimized:libmelt-ana-gimple.optimized \
      "" \
  	  || meltbuild_error melt-build-script.tpl:835/737 failed to generate C++ code of extra xtramelt-ana-simple
    else
        meltbuild_info melt-build-script.tpl:837/738 DONT emit extra C++ code for xtramelt-ana-simple
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.quicklybuilt.so \
        -o meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.quicklybuilt.so -ot  meltbuild-final-translator.stamp \
        -o  meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.quicklybuilt.so -ot  meltbuild-sources/xtramelt-ana-simple.cc \
        -o  meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.quicklybuilt.so -ot  meltbuild-sources/xtramelt-ana-simple+meltdesc.c ]; then
        meltbuild_info melt-build-script.tpl:845/739 compiling extra module for xtramelt-ana-simple quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:847/740 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:854/741 in meltbuild-modules failure to compile extra xtramelt-ana-simple quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:856/742 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:863/743 in meltbuild-modules failed to compile library xtramelt-ana-simple quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:866/744 not compiling library module for xtramelt-ana-simple quicklybuilt
    fi
   
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.optimized.so \
        -o meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.optimized.so -ot  meltbuild-final-translator.stamp \
        -o  meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.optimized.so -ot  meltbuild-sources/xtramelt-ana-simple.cc \
        -o  meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.optimized.so -ot  meltbuild-sources/xtramelt-ana-simple+meltdesc.c ]; then
        meltbuild_info melt-build-script.tpl:845/745 compiling extra module for xtramelt-ana-simple optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:847/746 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
  	  || ( meltbuild_notice melt-build-script.tpl:854/747 in meltbuild-modules failure to compile extra xtramelt-ana-simple optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:856/748 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:863/749 in meltbuild-modules failed to compile library xtramelt-ana-simple optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:866/750 not compiling library module for xtramelt-ana-simple optimized
    fi
   
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.debugnoline.so \
        -o meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.debugnoline.so -ot  meltbuild-final-translator.stamp \
        -o  meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.debugnoline.so -ot  meltbuild-sources/xtramelt-ana-simple.cc \
        -o  meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.debugnoline.so -ot  meltbuild-sources/xtramelt-ana-simple+meltdesc.c ]; then
        meltbuild_info melt-build-script.tpl:845/751 compiling extra module for xtramelt-ana-simple debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:847/752 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
  	  || ( meltbuild_notice melt-build-script.tpl:854/753 in meltbuild-modules failure to compile extra xtramelt-ana-simple debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:856/754 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:863/755 in meltbuild-modules failed to compile library xtramelt-ana-simple debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:866/756 not compiling library module for xtramelt-ana-simple debugnoline
    fi
   
  
  
    ## meltbuild_do_extras xtramelt-playground melt-build-script.tpl:817/757
    meltbuild_info melt-build-script.tpl:818/758 doing extra xtramelt-playground
    ...
    ## meltbuild_do_extras xtramelt-playground melt-build-script.tpl:822/759
    if [ ! -f meltbuild-sources/xtramelt-playground.cc -o  ! -f meltbuild-sources/xtramelt-playground+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:827/760 emit library C++ code for xtramelt-playground
        meltbuild_emit melt-build-script.tpl:828/761 \
  	  translatefile \
  	  xtramelt-playground \
  	  meltbuild-sources \
  	  meltbuild-modules \
  	  warmelt-first.optimized:warmelt-base.optimized:warmelt-debug.optimized:warmelt-macro.optimized:warmelt-moremacro.optimized:warmelt-normal.optimized:warmelt-normatch.optimized:warmelt-genobj.optimized:warmelt-outobj.optimized:warmelt-hooks.optimized:warmelt-modes.optimized:libmelt-ana-base.optimized:libmelt-ana-tree.optimized:libmelt-ana-gimple.optimized \
      "" \
  	  || meltbuild_error melt-build-script.tpl:835/762 failed to generate C++ code of extra xtramelt-playground
    else
        meltbuild_info melt-build-script.tpl:837/763 DONT emit extra C++ code for xtramelt-playground
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.quicklybuilt.so \
        -o meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.quicklybuilt.so -ot  meltbuild-final-translator.stamp \
        -o  meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.quicklybuilt.so -ot  meltbuild-sources/xtramelt-playground.cc \
        -o  meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.quicklybuilt.so -ot  meltbuild-sources/xtramelt-playground+meltdesc.c ]; then
        meltbuild_info melt-build-script.tpl:845/764 compiling extra module for xtramelt-playground quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:847/765 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:854/766 in meltbuild-modules failure to compile extra xtramelt-playground quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:856/767 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:863/768 in meltbuild-modules failed to compile library xtramelt-playground quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:866/769 not compiling library module for xtramelt-playground quicklybuilt
    fi
   
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.optimized.so \
        -o meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.optimized.so -ot  meltbuild-final-translator.stamp \
        -o  meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.optimized.so -ot  meltbuild-sources/xtramelt-playground.cc \
        -o  meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.optimized.so -ot  meltbuild-sources/xtramelt-playground+meltdesc.c ]; then
        meltbuild_info melt-build-script.tpl:845/770 compiling extra module for xtramelt-playground optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:847/771 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
  	  || ( meltbuild_notice melt-build-script.tpl:854/772 in meltbuild-modules failure to compile extra xtramelt-playground optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:856/773 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:863/774 in meltbuild-modules failed to compile library xtramelt-playground optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:866/775 not compiling library module for xtramelt-playground optimized
    fi
   
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.debugnoline.so \
        -o meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.debugnoline.so -ot  meltbuild-final-translator.stamp \
        -o  meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.debugnoline.so -ot  meltbuild-sources/xtramelt-playground.cc \
        -o  meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.debugnoline.so -ot  meltbuild-sources/xtramelt-playground+meltdesc.c ]; then
        meltbuild_info melt-build-script.tpl:845/776 compiling extra module for xtramelt-playground debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:847/777 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
  	  || ( meltbuild_notice melt-build-script.tpl:854/778 in meltbuild-modules failure to compile extra xtramelt-playground debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:856/779 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:863/780 in meltbuild-modules failed to compile library xtramelt-playground debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:866/781 not compiling library module for xtramelt-playground debugnoline
    fi
   
  
    ## meltbuild_do_extras  melt-build-script.tpl:870/782
    ...
    $MD5SUM meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.quicklybuilt.so >> $meltextrastamptemp
   
    $MD5SUM meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.optimized.so >> $meltextrastamptemp
   
    $MD5SUM meltbuild-modules/xtramelt-probe.meltmod-$meltlib_PROBE_cumulmd5.debugnoline.so >> $meltextrastamptemp
    ...
    $MD5SUM meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.quicklybuilt.so >> $meltextrastamptemp
   
    $MD5SUM meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.optimized.so >> $meltextrastamptemp
   
    $MD5SUM meltbuild-modules/xtramelt-ana-simple.meltmod-$meltlib_ANA_SIMPLE_cumulmd5.debugnoline.so >> $meltextrastamptemp
    ...
    $MD5SUM meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.quicklybuilt.so >> $meltextrastamptemp
   
    $MD5SUM meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.optimized.so >> $meltextrastamptemp
   
    $MD5SUM meltbuild-modules/xtramelt-playground.meltmod-$meltlib_PLAYGROUND_cumulmd5.debugnoline.so >> $meltextrastamptemp
   
  
    echo "///end stamp $melt_final_extra_stamp"  >> $meltextrastamptemp
    $GCCMELT_MOVE_IF_CHANGE $meltextrastamptemp  $melt_final_extra_stamp
  meltbuild_info melt-build-script.tpl:883/783 times after extras at `date '+%x %H:%M:%S'`: ;  times >&2
} ## end function meltbuild_do_extras  melt-build-script.tpl:884/784


################################################################
#@ melt-build-script.tpl:888/785 runtime self check

##  melt-build-script.tpl:890/786 FIXME: should skip that when cross-compiler MELT plugin..

if [ -z "$GCCMELT_RUNTIME_CC" ]; then 
    meltbuild_error melt-build-script.tpl:893/787 failed because no GCCMELT_RUNTIME_CC shell variable
    exit 1
fi
...
if [ ! -f $meltcheckruntime_stamp -o $meltcheckruntime_stamp -ot "$GCCMELT_RUNTIME_ARGS" \
    ...
    #@ melt-build-script.tpl:901/788 checkruntime
    if [ -f melt-no-check-runtime -o -n "$MELTGCC_NO_CHECK_RUNTIME" -o ! -f melt-runtime.i ]; then
	meltbuild_info melt-build-script.tpl:903/789 skipping check of MELT runtime
    else
	meltcheckruntime_args=meltbuild-checkruntime.args 
	meltcheckruntime_argstemp=$meltcheckruntime_args-tmp$$
	echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:907/790"' ' -DGCCMELT_CHECKMELTRUNTIME' > $meltcheckruntime_argstemp
	...
	[ -f "$meltcheckruntime_args" ] || meltbuild_error  melt-build-script.tpl:920/791 missing check runtime args  "$meltcheckruntime_args"
	meltbuild_info melt-build-script.tpl:921/792 $meltcheckruntime_args  is
	...
	if [ -n "$MELTGCCBUILTIN_BUILD_WITH_CXX" ]; then
		...
		|| meltbuild_error melt-build-script.tpl:925/793 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	else
	    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltcheckruntime_args \
		|| meltbuild_error melt-build-script.tpl:928/794 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	fi
	meltbuild_info melt-build-script.tpl:930/795 done check runtime with $meltcheckruntime_args
    fi

   #@ melt-build-script.tpl:933/796 checkhello
    meltcheckhelloworld_args=meltbuild-checkhelloworld.args 
    meltcheckhelloworld_argstemp=$meltcheckhelloworld_args-tmp$$
    echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:936/797"' > $meltcheckhelloworld_argstemp
    ...
    [ -f "$meltcheckhelloworld_args" ] || meltbuild_error  melt-build-script.tpl:950/798 missing check helloworld args  "$meltcheckhelloworld_args"
   meltbuild_info melt-build-script.tpl:951/799 $meltcheckhelloworld_args  is
   cat $meltcheckhelloworld_args < /dev/null >&2
    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltcheckhelloworld_args \
	|| meltbuild_error melt-build-script.tpl:954/800 running helloworld failed with arguments @$meltcheckhelloworld_args
   meltbuild_info melt-build-script.tpl:955/801 done check helloworld with $meltcheckhelloworld_args
   #@ melt-build-script.tpl:956/802 runtime stamp
    meltcheckruntime_stamptemp=$meltcheckruntime_stamp-tmp$$
    [ -f "$GCCMELT_RUNTIME_CC" ] || meltbuild_error melt-build-script.tpl:958/803 missing MELT runtime C++ file $GCCMELT_RUNTIME_CC
    ...
    [ -f "$melt_final_translator_stamp" ] || meltbuild_error melt-build-script.tpl:963/804 missing final translator stamp "$melt_final_translator_stamp"
    [ -f "$melt_final_library_stamp" ] || meltbuild_error melt-build-script.tpl:964/805 missing final library stamp "$melt_final_library_stamp"
    ...
    meltbuild_info melt-build-script.tpl:968/806 done check runtime  $meltcheckruntime_stamp
else
    meltbuild_info melt-build-script.tpl:970/807 keeping runtime checks  $meltcheckruntime_stamp
fi

if [ "$melt_overall_goal" = "checkruntime" ]; then
    meltbuild_info melt-build-script.tpl:974/808 done checkruntime overall goal with stamp  $meltcheckruntime_stamp
    exit 0
fi

################################################################
################################################################
### the generated documentation meltgendoc.texi melt-build-script.tpl:980/809
...
if [   ! -f meltgendoc.texi  -o meltbuild-sources/warmelt-first.melt -nt meltgendoc.texi  \
 ...
 -o meltbuild-sources/libmelt-ana-gimple.melt -nt meltgendoc.texi   ]; then
   meltbuild_info melt-build-script.tpl:984/810 generating meltgendoc.texi
   meltgen_args=meltbuild-gendoc.args-tmp$$
   echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:986/811"' > $meltgen_args
...
meltbuild_arg "module-makefile=\"$GCCMELT_MODULE_MK\""  >>  $meltgen_args
   ...
   meltbuild_info melt-build-script.tpl:1000/812  meltbuild-gendoc.args is
   cat meltbuild-gendoc.args < /dev/null >&2
   $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @meltbuild-gendoc.args \
     || meltbuild_error melt-build-script.tpl:1003/813  "$GCCMELT_CC1PLUS" failed with arguments @meltbuild-gendoc.args
else
   meltbuild_info melt-build-script.tpl:1005/814 keeping meltgendoc.texi
fi

################
meltbuild_info melt-build-script.tpl:1009/815 successfully done with times at `date '+%x %H:%M:%S'`: ; times >&2

################################################################
#@ melt-build-script.tpl:1012/816
if [ "$melt_overall_goal" = "gendoc" ]; then
    meltbuild_info melt-build-script.tpl:1014/817 done gendoc overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

## #@ melt-build-script.tpl:1018/818 if we get here something is wrong in this script
meltbuild_error  melt-build-script.tpl:1019/819 unexpected MELT overall goal "$melt_overall_goal" buggy melt-build-script.tpl
#@ eof melt-build-script.tpl:1020/820 end of generated melt-build-script.sh
