...
#@#@#
#@#@# It has been AutoGen-ed  July  6, 2013 at 10:03:13 AM by AutoGen 5.17.3
...
if [ ! -f $meltcheckruntime_stamp -o $meltcheckruntime_stamp -ot "$GCCMELT_RUNTIME_ARGS" \
	...
	echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:728/690"' ' -DGCCMELT_CHECKMELTRUNTIME' > $meltcheckruntime_argstemp
