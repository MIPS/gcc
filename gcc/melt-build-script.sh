...
#@#@#
#@#@# It has been AutoGen-ed  August 28, 2014 at 09:29:25 PM by AutoGen 5.18.3
...
if [ ! -f  "$melt_final_library_stamp" \
 ...
 -o "$melt_final_library_stamp" -ot "$GCCMELT_MELTSOURCEDIR/libmelt-ana-gimple.melt" \
    ...
    meltbuild_info melt-build-script.tpl:756/682 building MELT library
    meltbuild_do_library
else
    meltbuild_info melt-build-script.tpl:759/683 not building MELT library because of libstamp  "$melt_final_library_stamp"
fi

################################################################
#@ melt-build-script.tpl:763/684
if [ "$melt_overall_goal" = "library" ]; then
    meltbuild_info melt-build-script.tpl:765/685 done library overall goal with stamp  $melt_final_translator_stamp
    meltbuild_notice 'Done library' melt-build-script.tpl:766/686 library overall goal 
    exit 0
fi

################################################################
################################################################
### the modules lists melt-build-script.tpl:772/687
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis" \
  ...
  #  melt-build-script.tpl:777/688 module list quicklybuilt
  meltbuild_info  melt-build-script.tpl:778/689 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis"
  ...
  echo "# MELT translator modules:" >> $melt_modlis_temp
  #  melt-build-script.tpl:782/690 module list quicklybuilt translator
  ...
  #  melt-build-script.tpl:786/691 module list quicklybuilt library
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" \
  ...
  #  melt-build-script.tpl:777/694 module list optimized
  meltbuild_info  melt-build-script.tpl:778/695 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"
  ...
  echo "# MELT translator modules:" >> $melt_modlis_temp
  #  melt-build-script.tpl:782/696 module list optimized translator
  ...
  #  melt-build-script.tpl:786/697 module list optimized library
  echo "# MELT library modules:" >> $melt_modlis_temp
  ...
  #  melt-build-script.tpl:791/698 module list optimized extra, with mode condition
 echo "# MELT extra modules with mode condition:" >> $melt_modlis_temp
 
 printf '#xtraMELTmod xtramelt-probe\n' >> $melt_modlis_temp
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-probe.optimized\n", $2);}} END{printf("# %d MELT modes in xtramelt-probeoptimized\n", nbmod);}' meltbuild-sources/xtramelt-probe.melt | sort -u >> $melt_modlis_temp
 
 printf '#xtraMELTmod xtramelt-ana-simple\n' >> $melt_modlis_temp
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-ana-simple.optimized\n", $2);}} END{printf("# %d MELT modes in xtramelt-ana-simpleoptimized\n", nbmod);}' meltbuild-sources/xtramelt-ana-simple.melt | sort -u >> $melt_modlis_temp
 
 printf '#xtraMELTmod xtramelt-playground\n' >> $melt_modlis_temp
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-playground.optimized\n", $2);}} END{printf("# %d MELT modes in xtramelt-playgroundoptimized\n", nbmod);}' meltbuild-sources/xtramelt-playground.melt | sort -u >> $melt_modlis_temp
 
 echo "# MELT module list eof $MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" >> $melt_modlis_temp
  $GCCMELT_MOVE_IF_CHANGE $melt_modlis_temp  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"
else
  meltbuild_info  melt-build-script.tpl:800/699 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" \
  ...
  #  melt-build-script.tpl:777/700 module list debugnoline
  meltbuild_info  melt-build-script.tpl:778/701 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"
  ...
  echo "# MELT translator modules:" >> $melt_modlis_temp
  #  melt-build-script.tpl:782/702 module list debugnoline translator
  ...
  #  melt-build-script.tpl:786/703 module list debugnoline library
  echo "# MELT library modules:" >> $melt_modlis_temp
  ...
  #  melt-build-script.tpl:791/704 module list debugnoline extra, with mode condition
 echo "# MELT extra modules with mode condition:" >> $melt_modlis_temp
 
 printf '#xtraMELTmod xtramelt-probe\n' >> $melt_modlis_temp
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-probe.debugnoline\n", $2);}} END{printf("# %d MELT modes in xtramelt-probedebugnoline\n", nbmod);}' meltbuild-sources/xtramelt-probe.melt | sort -u >> $melt_modlis_temp
 
 printf '#xtraMELTmod xtramelt-ana-simple\n' >> $melt_modlis_temp
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-ana-simple.debugnoline\n", $2);}} END{printf("# %d MELT modes in xtramelt-ana-simpledebugnoline\n", nbmod);}' meltbuild-sources/xtramelt-ana-simple.melt | sort -u >> $melt_modlis_temp
 
 printf '#xtraMELTmod xtramelt-playground\n' >> $melt_modlis_temp
 $GAWK '-F\"' '/\(install_melt_mode /{if (length($2)>1) {nbmod++;printf("?%s xtramelt-playground.debugnoline\n", $2);}} END{printf("# %d MELT modes in xtramelt-playgrounddebugnoline\n", nbmod);}' meltbuild-sources/xtramelt-playground.melt | sort -u >> $melt_modlis_temp
 
 echo "# MELT module list eof $MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" >> $melt_modlis_temp
  $GCCMELT_MOVE_IF_CHANGE $melt_modlis_temp  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"
else
  meltbuild_info  melt-build-script.tpl:800/705 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"  
fi


#@ melt-build-script.tpl:804/706
...
################################################################
#@ melt-build-script.tpl:810/707 module lists
if [ "$melt_overall_goal" = "modlists" ]; then
    meltbuild_info melt-build-script.tpl:812/708 done modlists overall goal with stamp  $melt_final_library_stamp
    exit 0
fi
...
########################### EXTRA ############################
################
#@ melt-build-script.tpl:820/709 before extra libmelt* modules
################################################################
meltbuild_info melt-build-script.tpl:822/710 before extra GCCMELT_SKIPEMITC=$GCCMELT_SKIPEMITC.

meltbuild_info melt-build-script.tpl:824/711 times before extras at `date '+%x %H:%M:%S'`: ;  times >&2
...
function meltbuild_do_extras () {
  meltbuild_notice 'start doing extras'  melt-build-script.tpl:831/712 doing extras 
  
  
    ## meltbuild_do_extras xtramelt-probe melt-build-script.tpl:834/713
    meltbuild_info melt-build-script.tpl:835/714 doing extra xtramelt-probe
    ...
    ## meltbuild_do_extras xtramelt-probe melt-build-script.tpl:839/715
    if [ ! -f meltbuild-sources/xtramelt-probe.cc -o  ! -f meltbuild-sources/xtramelt-probe+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:844/716 emit extra C++ code for xtramelt-probe
        meltbuild_emit melt-build-script.tpl:845/717 \
  	  translatefile \
  	  xtramelt-probe \
  	  meltbuild-sources \
  	  meltbuild-modules \
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:852/718 failed to generate C++ code of extra xtramelt-probe
    else
        meltbuild_info melt-build-script.tpl:854/719 DONT emit extra C++ code for xtramelt-probe
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltextra_PROBE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:862/720 compiling extra module for xtramelt-probe quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:864/721 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:871/722 in meltbuild-modules failure to compile extra xtramelt-probe quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:873/723 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe ; \
  	       meltbuild_error  melt-build-script.tpl:880/724 in meltbuild-modules failed to compile extra xtramelt-probe quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:883/725 not compiling extra module for xtramelt-probe quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltextra_PROBE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:862/726 compiling extra module for xtramelt-probe optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:864/727 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
  	  || ( meltbuild_notice melt-build-script.tpl:871/728 in meltbuild-modules failure to compile extra xtramelt-probe optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:873/729 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe ; \
  	       meltbuild_error  melt-build-script.tpl:880/730 in meltbuild-modules failed to compile extra xtramelt-probe optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:883/731 not compiling extra module for xtramelt-probe optimized
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltextra_PROBE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:862/732 compiling extra module for xtramelt-probe debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:864/733 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
  	  || ( meltbuild_notice melt-build-script.tpl:871/734 in meltbuild-modules failure to compile extra xtramelt-probe debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:873/735 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe ; \
  	       meltbuild_error  melt-build-script.tpl:880/736 in meltbuild-modules failed to compile extra xtramelt-probe debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:883/737 not compiling extra module for xtramelt-probe debugnoline
    fi
   
   ## meltbuild_do_extras after build xtramelt-probe melt-build-script.tpl:886/738
   
   
  
    ## meltbuild_do_extras xtramelt-ana-simple melt-build-script.tpl:834/739
    meltbuild_info melt-build-script.tpl:835/740 doing extra xtramelt-ana-simple
    ...
    ## meltbuild_do_extras xtramelt-ana-simple melt-build-script.tpl:839/741
    if [ ! -f meltbuild-sources/xtramelt-ana-simple.cc -o  ! -f meltbuild-sources/xtramelt-ana-simple+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:844/742 emit extra C++ code for xtramelt-ana-simple
        meltbuild_emit melt-build-script.tpl:845/743 \
  	  translatefile \
  	  xtramelt-ana-simple \
  	  meltbuild-sources \
  	  meltbuild-modules \
  	  warmelt-first.optimized:warmelt-base.optimized:warmelt-debug.optimized:warmelt-macro.optimized:warmelt-moremacro.optimized:warmelt-normal.optimized:warmelt-normatch.optimized:warmelt-genobj.optimized:warmelt-outobj.optimized:warmelt-hooks.optimized:warmelt-modes.optimized:libmelt-ana-base.optimized:libmelt-ana-tree.optimized:libmelt-ana-gimple.optimized \
      "" \
  	  || meltbuild_error melt-build-script.tpl:852/744 failed to generate C++ code of extra xtramelt-ana-simple
    else
        meltbuild_info melt-build-script.tpl:854/745 DONT emit extra C++ code for xtramelt-ana-simple
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltextra_ANA_SIMPLE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:862/746 compiling extra module for xtramelt-ana-simple quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:864/747 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:871/748 in meltbuild-modules failure to compile extra xtramelt-ana-simple quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:873/749 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:880/750 in meltbuild-modules failed to compile extra xtramelt-ana-simple quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:883/751 not compiling extra module for xtramelt-ana-simple quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltextra_ANA_SIMPLE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:862/752 compiling extra module for xtramelt-ana-simple optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:864/753 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
  	  || ( meltbuild_notice melt-build-script.tpl:871/754 in meltbuild-modules failure to compile extra xtramelt-ana-simple optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:873/755 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:880/756 in meltbuild-modules failed to compile extra xtramelt-ana-simple optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:883/757 not compiling extra module for xtramelt-ana-simple optimized
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltextra_ANA_SIMPLE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:862/758 compiling extra module for xtramelt-ana-simple debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:864/759 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
  	  || ( meltbuild_notice melt-build-script.tpl:871/760 in meltbuild-modules failure to compile extra xtramelt-ana-simple debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:873/761 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:880/762 in meltbuild-modules failed to compile extra xtramelt-ana-simple debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:883/763 not compiling extra module for xtramelt-ana-simple debugnoline
    fi
   
   ## meltbuild_do_extras after build xtramelt-ana-simple melt-build-script.tpl:886/764
   
   
  
    ## meltbuild_do_extras xtramelt-playground melt-build-script.tpl:834/765
    meltbuild_info melt-build-script.tpl:835/766 doing extra xtramelt-playground
    ...
    ## meltbuild_do_extras xtramelt-playground melt-build-script.tpl:839/767
    if [ ! -f meltbuild-sources/xtramelt-playground.cc -o  ! -f meltbuild-sources/xtramelt-playground+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:844/768 emit extra C++ code for xtramelt-playground
        meltbuild_emit melt-build-script.tpl:845/769 \
  	  translatefile \
  	  xtramelt-playground \
  	  meltbuild-sources \
  	  meltbuild-modules \
  	  warmelt-first.optimized:warmelt-base.optimized:warmelt-debug.optimized:warmelt-macro.optimized:warmelt-moremacro.optimized:warmelt-normal.optimized:warmelt-normatch.optimized:warmelt-genobj.optimized:warmelt-outobj.optimized:warmelt-hooks.optimized:warmelt-modes.optimized:libmelt-ana-base.optimized:libmelt-ana-tree.optimized:libmelt-ana-gimple.optimized \
      "" \
  	  || meltbuild_error melt-build-script.tpl:852/770 failed to generate C++ code of extra xtramelt-playground
    else
        meltbuild_info melt-build-script.tpl:854/771 DONT emit extra C++ code for xtramelt-playground
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltextra_PLAYGROUND_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:862/772 compiling extra module for xtramelt-playground quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:864/773 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:871/774 in meltbuild-modules failure to compile extra xtramelt-playground quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:873/775 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:880/776 in meltbuild-modules failed to compile extra xtramelt-playground quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:883/777 not compiling extra module for xtramelt-playground quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltextra_PLAYGROUND_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:862/778 compiling extra module for xtramelt-playground optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:864/779 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
  	  || ( meltbuild_notice melt-build-script.tpl:871/780 in meltbuild-modules failure to compile extra xtramelt-playground optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:873/781 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:880/782 in meltbuild-modules failed to compile extra xtramelt-playground optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:883/783 not compiling extra module for xtramelt-playground optimized
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltextra_PLAYGROUND_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:862/784 compiling extra module for xtramelt-playground debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:864/785 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
  	  || ( meltbuild_notice melt-build-script.tpl:871/786 in meltbuild-modules failure to compile extra xtramelt-playground debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:873/787 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:880/788 in meltbuild-modules failed to compile extra xtramelt-playground debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:883/789 not compiling extra module for xtramelt-playground debugnoline
    fi
   
   ## meltbuild_do_extras after build xtramelt-playground melt-build-script.tpl:886/790
   
   
 
   ## meltbuild_do_extras timestamping  melt-build-script.tpl:890/791
   ...
   ## meltbuild_do_extras end extra xtramelt-probe melt-build-script.tpl:900/792
   ...
   ## meltbuild_do_extras end extra xtramelt-ana-simple melt-build-script.tpl:900/793
   ...
   ## meltbuild_do_extras end extra xtramelt-playground melt-build-script.tpl:900/794
 
   

    ## meltbuild_do_extras final  melt-build-script.tpl:904/795
    echo "///end stamp $melt_final_extra_stamp"  >> $meltextrastamptemp
    $GCCMELT_MOVE_IF_CHANGE $meltextrastamptemp  $melt_final_extra_stamp
  meltbuild_info melt-build-script.tpl:907/796 times after extras at `date '+%x %H:%M:%S'`: ;  times >&2
} ## end function meltbuild_do_extras  melt-build-script.tpl:908/797

 ## building extras melt-build-script.tpl:910/798
if [ ! -f  "$melt_final_extra_stamp" \
 ...
 -o "$melt_final_extra_stamp" -ot "$GCCMELT_MELTSOURCEDIR/xtramelt-playground.melt" \
    ...
    meltbuild_info melt-build-script.tpl:916/799 building MELT extras
    meltbuild_do_extras
else
    meltbuild_info melt-build-script.tpl:919/800 not building MELT extra because of xtrastamp  "$melt_final_extra_stamp"
fi
 ## done building extras melt-build-script.tpl:921/801


################################################################
################################################################
#@ melt-build-script.tpl:926/802 runtime self check

##  melt-build-script.tpl:928/803 FIXME: should skip that when cross-compiler MELT plugin..

if [ -z "$GCCMELT_RUNTIME_CC" ]; then 
    meltbuild_error melt-build-script.tpl:931/804 failed because no GCCMELT_RUNTIME_CC shell variable
    exit 1
fi
...
if [ ! -f $meltcheckruntime_stamp -o $meltcheckruntime_stamp -ot "$GCCMELT_RUNTIME_ARGS" \
    ...
    #@ melt-build-script.tpl:939/805 checkruntime
    if [ -f melt-no-check-runtime -o -n "$MELTGCC_NO_CHECK_RUNTIME" -o ! -f melt-runtime.ii ]; then
	meltbuild_info melt-build-script.tpl:941/806 skipping check of MELT runtime
    else
	meltcheckruntime_args=meltbuild-checkruntime.args 
	meltcheckruntime_argstemp=$meltcheckruntime_args-tmp$$
	echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:945/807"' ' -DGCCMELT_CHECKMELTRUNTIME' > $meltcheckruntime_argstemp
	...
	[ -f "$meltcheckruntime_args" ] || meltbuild_error  melt-build-script.tpl:956/808 missing check runtime args  "$meltcheckruntime_args"
	meltbuild_info melt-build-script.tpl:957/809 $meltcheckruntime_args  is
	...
	if [ -n "$MELTGCCBUILTIN_BUILD_WITH_CXX" ]; then
		...
		|| meltbuild_error melt-build-script.tpl:961/810 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	else
	    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltcheckruntime_args \
		|| meltbuild_error melt-build-script.tpl:964/811 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	fi
	meltbuild_info melt-build-script.tpl:966/812 done check runtime with $meltcheckruntime_args
    fi

   #@ melt-build-script.tpl:969/813 checkhello
    meltcheckhelloworld_args=meltbuild-checkhelloworld.args 
    meltcheckhelloworld_argstemp=$meltcheckhelloworld_args-tmp$$
    echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:972/814" -DGCCMELT_CHECKHELLO' > $meltcheckhelloworld_argstemp
    ...
    [ -f "$meltcheckhelloworld_args" ] || meltbuild_error  melt-build-script.tpl:986/815 missing check helloworld args  "$meltcheckhelloworld_args"
   meltbuild_info melt-build-script.tpl:987/816 $meltcheckhelloworld_args  is
   cat $meltcheckhelloworld_args < /dev/null >&2
    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltcheckhelloworld_args \
	|| meltbuild_error melt-build-script.tpl:990/817 running helloworld failed with arguments @$meltcheckhelloworld_args
   meltbuild_info melt-build-script.tpl:991/818 done check helloworld with $meltcheckhelloworld_args
   #@ melt-build-script.tpl:992/819 runtime stamp
    meltcheckruntime_stamptemp=$meltcheckruntime_stamp-tmp$$
    [ -f "$GCCMELT_RUNTIME_CC" ] || meltbuild_error melt-build-script.tpl:994/820 missing MELT runtime C++ file $GCCMELT_RUNTIME_CC
    ...
    [ -f "$melt_final_translator_stamp" ] || meltbuild_error melt-build-script.tpl:999/821 missing final translator stamp "$melt_final_translator_stamp"
    [ -f "$melt_final_library_stamp" ] || meltbuild_error melt-build-script.tpl:1000/822 missing final library stamp "$melt_final_library_stamp"
    ...
    echo
    #@ melt-build-script.tpl:1005/823 justcount
    meltjustcount_args=meltbuild-justcount.args
    meltjustcount_argstemp=$meltjustcount_args-tmp$$
    echo  ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:1008/824" -DGCCMELT_JUSTCOUNT -fexceptions melt-runtime.ii ' > $meltjustcount_argstemp
    ...
    [ -f "$meltjustcount_args" ] || meltbuild_error  melt-build-script.tpl:1019/825 missing check justcount args  "$meltjustcount_args"
   meltbuild_info melt-build-script.tpl:1020/826 $meltjustcount_args  is
   cat $meltjustcount_args < /dev/null >&2
   echo
   $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltjustcount_args \
	|| meltbuild_error melt-build-script.tpl:1024/827 running justcount failed with arguments @$meltjustcount_args
   meltbuild_info melt-build-script.tpl:1025/828 done check justcount with $meltjustcount_args
   echo

   $GCCMELT_MOVE_IF_CHANGE  $meltcheckruntime_stamptemp $meltcheckruntime_stamp
   meltbuild_info melt-build-script.tpl:1029/829 done check runtime  $meltcheckruntime_stamp
    
else
    meltbuild_info melt-build-script.tpl:1032/830 keeping runtime checks  $meltcheckruntime_stamp
fi

if [ "$melt_overall_goal" = "checkruntime" ]; then
    meltbuild_info melt-build-script.tpl:1036/831 done checkruntime overall goal with stamp  $meltcheckruntime_stamp
    exit 0
fi

################################################################
#@ melt-build-script.tpl:1041/832
if [ "$melt_overall_goal" = "applications" ]; then
    meltbuild_info melt-build-script.tpl:1043/833 done applications overall goal with stamp  $meltcheckruntime_stamp
    exit 0
fi

################################################################
################################################################
### the generated documentation meltgendoc.texi melt-build-script.tpl:1049/834
...
if [   ! -f meltgendoc.texi  -o meltbuild-sources/warmelt-first.melt -nt meltgendoc.texi  \
 ...
 -o meltbuild-sources/libmelt-ana-gimple.melt -nt meltgendoc.texi   ]; then
   meltbuild_info melt-build-script.tpl:1053/835 generating meltgendoc.texi
   meltgen_args=meltbuild-gendoc.args-tmp$$
   echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:1055/836"' > $meltgen_args
...
meltbuild_arg "module-makefile=\"$GCCMELT_MODULE_MK\""  >>  $meltgen_args
   ...
   meltbuild_info melt-build-script.tpl:1069/837  meltbuild-gendoc.args is
   cat meltbuild-gendoc.args < /dev/null >&2
   $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @meltbuild-gendoc.args \
     || meltbuild_error melt-build-script.tpl:1072/838  "$GCCMELT_CC1PLUS" failed with arguments @meltbuild-gendoc.args
else
   meltbuild_info melt-build-script.tpl:1074/839 keeping meltgendoc.texi
fi

################
meltbuild_info melt-build-script.tpl:1078/840 successfully done with times at `date '+%x %H:%M:%S'`: ; times >&2

################################################################
#@ melt-build-script.tpl:1081/841
if [ "$melt_overall_goal" = "gendoc" ]; then
    meltbuild_info melt-build-script.tpl:1083/842 done gendoc overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

## #@ melt-build-script.tpl:1087/843 if we get here something is wrong in this script
meltbuild_error  melt-build-script.tpl:1088/844 unexpected MELT overall goal "$melt_overall_goal" buggy melt-build-script.tpl
#@ eof melt-build-script.tpl:1089/845 end of generated melt-build-script.sh
