...
#@#@#
#@#@# It has been AutoGen-ed  April  3, 2014 at 11:13:06 AM by AutoGen 5.18.1
...
if [ ! -f  "$melt_final_library_stamp" \
 ...
 -o "$melt_final_library_stamp" -ot "$GCCMELT_MELTSOURCEDIR/libmelt-ana-gimple.melt" \
    ...
    meltbuild_info melt-build-script.tpl:750/683 not building MELT libraries because of libstamp  "$melt_final_library_stamp"
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.quicklybuilt.modlis" \
  ...
  echo "# MELT translator modules:" >> $melt_modlis_temp
  #  melt-build-script.tpl:773/690 module list quicklybuilt translator
  ...
  #  melt-build-script.tpl:777/691 module list quicklybuilt library
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis" \
  ...
  #  melt-build-script.tpl:768/694 module list optimized
  meltbuild_info  melt-build-script.tpl:769/695 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"
  ...
  echo "# MELT translator modules:" >> $melt_modlis_temp
  #  melt-build-script.tpl:773/696 module list optimized translator
  ...
  #  melt-build-script.tpl:777/697 module list optimized library
  echo "# MELT library modules:" >> $melt_modlis_temp
  ...
  #  melt-build-script.tpl:782/698 module list optimized extra, with mode condition
 echo "# MELT extra modules with mode condition:" >> $melt_modlis_temp
 
 printf '#xtra xtramelt-probe\n' >> $melt_modlis_temp
 awk -F\" '/\(install_melt_mode /{if (length($2)>1) printf("?%s xtramelt-probe.optimized\n", $2);}' meltbuild-sources/xtramelt-probe.melt | sort -u >> $melt_modlis_temp
 
 printf '#xtra xtramelt-ana-simple\n' >> $melt_modlis_temp
 awk -F\" '/\(install_melt_mode /{if (length($2)>1) printf("?%s xtramelt-ana-simple.optimized\n", $2);}' meltbuild-sources/xtramelt-ana-simple.melt | sort -u >> $melt_modlis_temp
 
 printf '#xtra xtramelt-playground\n' >> $melt_modlis_temp
 awk -F\" '/\(install_melt_mode /{if (length($2)>1) printf("?%s xtramelt-playground.optimized\n", $2);}' meltbuild-sources/xtramelt-playground.melt | sort -u >> $melt_modlis_temp
 
  $GCCMELT_MOVE_IF_CHANGE $melt_modlis_temp  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"
else
  meltbuild_info  melt-build-script.tpl:790/699 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.optimized.modlis"  
fi
...
if [ ! -f "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis" \
  ...
  #  melt-build-script.tpl:768/700 module list debugnoline
  meltbuild_info  melt-build-script.tpl:769/701 generating module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"
  ...
  echo "# MELT translator modules:" >> $melt_modlis_temp
  #  melt-build-script.tpl:773/702 module list debugnoline translator
  ...
  #  melt-build-script.tpl:777/703 module list debugnoline library
  echo "# MELT library modules:" >> $melt_modlis_temp
  ...
  #  melt-build-script.tpl:782/704 module list debugnoline extra, with mode condition
 echo "# MELT extra modules with mode condition:" >> $melt_modlis_temp
 
 printf '#xtra xtramelt-probe\n' >> $melt_modlis_temp
 awk -F\" '/\(install_melt_mode /{if (length($2)>1) printf("?%s xtramelt-probe.debugnoline\n", $2);}' meltbuild-sources/xtramelt-probe.melt | sort -u >> $melt_modlis_temp
 
 printf '#xtra xtramelt-ana-simple\n' >> $melt_modlis_temp
 awk -F\" '/\(install_melt_mode /{if (length($2)>1) printf("?%s xtramelt-ana-simple.debugnoline\n", $2);}' meltbuild-sources/xtramelt-ana-simple.melt | sort -u >> $melt_modlis_temp
 
 printf '#xtra xtramelt-playground\n' >> $melt_modlis_temp
 awk -F\" '/\(install_melt_mode /{if (length($2)>1) printf("?%s xtramelt-playground.debugnoline\n", $2);}' meltbuild-sources/xtramelt-playground.melt | sort -u >> $melt_modlis_temp
 
  $GCCMELT_MOVE_IF_CHANGE $melt_modlis_temp  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"
else
  meltbuild_info  melt-build-script.tpl:790/705 keeping module list  "meltbuild-sources/$MELTGCCBUILTIN_DEFAULT_MODLIS.debugnoline.modlis"  
fi


#@ melt-build-script.tpl:794/706
...
################################################################
#@ melt-build-script.tpl:800/707 module lists
if [ "$melt_overall_goal" = "modlists" ]; then
    meltbuild_info melt-build-script.tpl:802/708 done modlists overall goal with stamp  $melt_final_library_stamp
    exit 0
fi
...
########################### EXTRA ############################
################
#@ melt-build-script.tpl:810/709 before extra libmelt* modules
################################################################
meltbuild_info melt-build-script.tpl:812/710 before extra GCCMELT_SKIPEMITC=$GCCMELT_SKIPEMITC.

meltbuild_info melt-build-script.tpl:814/711 times before extras at `date '+%x %H:%M:%S'`: ;  times >&2
...
function meltbuild_do_extras () {
  meltbuild_notice 'start doing extras'  melt-build-script.tpl:821/712 doing extras 
  
  
    ## meltbuild_do_extras xtramelt-probe melt-build-script.tpl:824/713
    meltbuild_info melt-build-script.tpl:825/714 doing extra xtramelt-probe
    ...
    ## meltbuild_do_extras xtramelt-probe melt-build-script.tpl:829/715
    if [ ! -f meltbuild-sources/xtramelt-probe.cc -o  ! -f meltbuild-sources/xtramelt-probe+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:834/716 emit extra C++ code for xtramelt-probe
        meltbuild_emit melt-build-script.tpl:835/717 \
  	  translatefile \
  	  xtramelt-probe \
  	  meltbuild-sources \
  	  meltbuild-modules \
      ...
      "" \
  	  || meltbuild_error melt-build-script.tpl:842/718 failed to generate C++ code of extra xtramelt-probe
    else
        meltbuild_info melt-build-script.tpl:844/719 DONT emit extra C++ code for xtramelt-probe
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltextra_PROBE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:852/720 compiling extra module for xtramelt-probe quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:854/721 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:861/722 in meltbuild-modules failure to compile extra xtramelt-probe quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:863/723 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe ; \
  	       meltbuild_error  melt-build-script.tpl:870/724 in meltbuild-modules failed to compile extra xtramelt-probe quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:873/725 not compiling extra module for xtramelt-probe quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltextra_PROBE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:852/726 compiling extra module for xtramelt-probe optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:854/727 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
  	  || ( meltbuild_notice melt-build-script.tpl:861/728 in meltbuild-modules failure to compile extra xtramelt-probe optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:863/729 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe ; \
  	       meltbuild_error  melt-build-script.tpl:870/730 in meltbuild-modules failed to compile extra xtramelt-probe optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:873/731 not compiling extra module for xtramelt-probe optimized
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-probe.meltmod-$meltextra_PROBE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:852/732 compiling extra module for xtramelt-probe debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:854/733 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe \
  	  || ( meltbuild_notice melt-build-script.tpl:861/734 in meltbuild-modules failure to compile extra xtramelt-probe debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:863/735 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-probe \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-probe ; \
  	       meltbuild_error  melt-build-script.tpl:870/736 in meltbuild-modules failed to compile extra xtramelt-probe debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:873/737 not compiling extra module for xtramelt-probe debugnoline
    fi
   
   ## meltbuild_do_extras after build xtramelt-probe melt-build-script.tpl:876/738
   
   
  
    ## meltbuild_do_extras xtramelt-ana-simple melt-build-script.tpl:824/739
    meltbuild_info melt-build-script.tpl:825/740 doing extra xtramelt-ana-simple
    ...
    ## meltbuild_do_extras xtramelt-ana-simple melt-build-script.tpl:829/741
    if [ ! -f meltbuild-sources/xtramelt-ana-simple.cc -o  ! -f meltbuild-sources/xtramelt-ana-simple+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:834/742 emit extra C++ code for xtramelt-ana-simple
        meltbuild_emit melt-build-script.tpl:835/743 \
  	  translatefile \
  	  xtramelt-ana-simple \
  	  meltbuild-sources \
  	  meltbuild-modules \
  	  warmelt-first.optimized:warmelt-base.optimized:warmelt-debug.optimized:warmelt-macro.optimized:warmelt-moremacro.optimized:warmelt-normal.optimized:warmelt-normatch.optimized:warmelt-genobj.optimized:warmelt-outobj.optimized:warmelt-hooks.optimized:warmelt-modes.optimized:libmelt-ana-base.optimized:libmelt-ana-tree.optimized:libmelt-ana-gimple.optimized \
      "" \
  	  || meltbuild_error melt-build-script.tpl:842/744 failed to generate C++ code of extra xtramelt-ana-simple
    else
        meltbuild_info melt-build-script.tpl:844/745 DONT emit extra C++ code for xtramelt-ana-simple
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltextra_ANA_SIMPLE_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:852/746 compiling extra module for xtramelt-ana-simple quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:854/747 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:861/748 in meltbuild-modules failure to compile extra xtramelt-ana-simple quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:863/749 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:870/750 in meltbuild-modules failed to compile extra xtramelt-ana-simple quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:873/751 not compiling extra module for xtramelt-ana-simple quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltextra_ANA_SIMPLE_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:852/752 compiling extra module for xtramelt-ana-simple optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:854/753 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
  	  || ( meltbuild_notice melt-build-script.tpl:861/754 in meltbuild-modules failure to compile extra xtramelt-ana-simple optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:863/755 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:870/756 in meltbuild-modules failed to compile extra xtramelt-ana-simple optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:873/757 not compiling extra module for xtramelt-ana-simple optimized
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-ana-simple.meltmod-$meltextra_ANA_SIMPLE_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:852/758 compiling extra module for xtramelt-ana-simple debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:854/759 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple \
  	  || ( meltbuild_notice melt-build-script.tpl:861/760 in meltbuild-modules failure to compile extra xtramelt-ana-simple debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:863/761 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-ana-simple \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-ana-simple ; \
  	       meltbuild_error  melt-build-script.tpl:870/762 in meltbuild-modules failed to compile extra xtramelt-ana-simple debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:873/763 not compiling extra module for xtramelt-ana-simple debugnoline
    fi
   
   ## meltbuild_do_extras after build xtramelt-ana-simple melt-build-script.tpl:876/764
   
   
  
    ## meltbuild_do_extras xtramelt-playground melt-build-script.tpl:824/765
    meltbuild_info melt-build-script.tpl:825/766 doing extra xtramelt-playground
    ...
    ## meltbuild_do_extras xtramelt-playground melt-build-script.tpl:829/767
    if [ ! -f meltbuild-sources/xtramelt-playground.cc -o  ! -f meltbuild-sources/xtramelt-playground+meltdesc.c \
        ...
        meltbuild_info melt-build-script.tpl:834/768 emit extra C++ code for xtramelt-playground
        meltbuild_emit melt-build-script.tpl:835/769 \
  	  translatefile \
  	  xtramelt-playground \
  	  meltbuild-sources \
  	  meltbuild-modules \
  	  warmelt-first.optimized:warmelt-base.optimized:warmelt-debug.optimized:warmelt-macro.optimized:warmelt-moremacro.optimized:warmelt-normal.optimized:warmelt-normatch.optimized:warmelt-genobj.optimized:warmelt-outobj.optimized:warmelt-hooks.optimized:warmelt-modes.optimized:libmelt-ana-base.optimized:libmelt-ana-tree.optimized:libmelt-ana-gimple.optimized \
      "" \
  	  || meltbuild_error melt-build-script.tpl:842/770 failed to generate C++ code of extra xtramelt-playground
    else
        meltbuild_info melt-build-script.tpl:844/771 DONT emit extra C++ code for xtramelt-playground
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltextra_PLAYGROUND_cumulmd5.quicklybuilt.so \
        ...
        meltbuild_info melt-build-script.tpl:852/772 compiling extra module for xtramelt-playground quicklybuilt
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:854/773 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=quicklybuilt \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  ...
  	  || ( meltbuild_notice melt-build-script.tpl:861/774 in meltbuild-modules failure to compile extra xtramelt-playground quicklybuilt ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:863/775 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=quicklybuilt \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:870/776 in meltbuild-modules failed to compile extra xtramelt-playground quicklybuilt \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:873/777 not compiling extra module for xtramelt-playground quicklybuilt
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltextra_PLAYGROUND_cumulmd5.optimized.so \
        ...
        meltbuild_info melt-build-script.tpl:852/778 compiling extra module for xtramelt-playground optimized
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:854/779 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=optimized \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
  	  || ( meltbuild_notice melt-build-script.tpl:861/780 in meltbuild-modules failure to compile extra xtramelt-playground optimized ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:863/781 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=optimized \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:870/782 in meltbuild-modules failed to compile extra xtramelt-playground optimized \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:873/783 not compiling extra module for xtramelt-playground optimized
    fi
    ...
    if [ ! -f meltbuild-modules/xtramelt-playground.meltmod-$meltextra_PLAYGROUND_cumulmd5.debugnoline.so \
        ...
        meltbuild_info melt-build-script.tpl:852/784 compiling extra module for xtramelt-playground debugnoline
        $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  	  GCCMELT_FROM=melt-build-script.tpl:854/785 \
  	  GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  	  GCCMELT_MODULE_FLAVOR=debugnoline \
  	  GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  	  GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS" \
  	  GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  	  GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground \
  	  || ( meltbuild_notice melt-build-script.tpl:861/786 in meltbuild-modules failure to compile extra xtramelt-playground debugnoline ; \
  	       $GCCMELT_MAKE -f $GCCMELT_MODULE_MK melt_module \
  			     GCCMELT_FROM=melt-build-script.tpl:863/787 \
  			     GCCMELT_MODULE_WORKSPACE=meltbuild-workdir \
  			     GCCMELT_MODULE_FLAVOR=debugnoline \
  			     GCCMELT_COMPILER="$GCCMELT_COMPILER" \
  			     GCCMELT_CFLAGS="$GCCMELT_COMPILER_FLAGS -DMELTGCC_NOLINENUMBERING" \
  			     GCCMELT_MODULE_SOURCEBASE=meltbuild-sources/xtramelt-playground \
  			     GCCMELT_MODULE_BINARYBASE=meltbuild-modules/xtramelt-playground ; \
  	       meltbuild_error  melt-build-script.tpl:870/788 in meltbuild-modules failed to compile extra xtramelt-playground debugnoline \
  				"($GCCMELT_MAKE -f $GCCMELT_MODULE_MK)" compiler $GCCMELT_COMPILER_FLAGS cflags $GCCMELT_COMPILER_FLAGS )
  	       else
        meltbuild_info melt-build-script.tpl:873/789 not compiling extra module for xtramelt-playground debugnoline
    fi
   
   ## meltbuild_do_extras after build xtramelt-playground melt-build-script.tpl:876/790
   
   
 
   ## meltbuild_do_extras timestamping  melt-build-script.tpl:880/791
   ...
   ## meltbuild_do_extras end extra xtramelt-probe melt-build-script.tpl:890/792
   ...
   ## meltbuild_do_extras end extra xtramelt-ana-simple melt-build-script.tpl:890/793
   ...
   ## meltbuild_do_extras end extra xtramelt-playground melt-build-script.tpl:890/794
 
   

    ## meltbuild_do_extras final  melt-build-script.tpl:894/795
    echo "///end stamp $melt_final_extra_stamp"  >> $meltextrastamptemp
    $GCCMELT_MOVE_IF_CHANGE $meltextrastamptemp  $melt_final_extra_stamp
  meltbuild_info melt-build-script.tpl:897/796 times after extras at `date '+%x %H:%M:%S'`: ;  times >&2
} ## end function meltbuild_do_extras  melt-build-script.tpl:898/797

 ## building extras melt-build-script.tpl:900/798
if [ ! -f  "$melt_final_extra_stamp" \
 ...
 -o "$melt_final_extra_stamp" -ot "$GCCMELT_MELTSOURCEDIR/xtramelt-playground.melt" \
    ...
    meltbuild_info melt-build-script.tpl:906/799 building MELT extras
    meltbuild_do_extras
else
    meltbuild_info melt-build-script.tpl:909/800 not building MELT extra because of xtrastamp  "$melt_final_extra_stamp"
fi
 ## done building extras melt-build-script.tpl:911/801


################################################################
################################################################
#@ melt-build-script.tpl:916/802 runtime self check

##  melt-build-script.tpl:918/803 FIXME: should skip that when cross-compiler MELT plugin..

if [ -z "$GCCMELT_RUNTIME_CC" ]; then 
    meltbuild_error melt-build-script.tpl:921/804 failed because no GCCMELT_RUNTIME_CC shell variable
    exit 1
fi
...
if [ ! -f $meltcheckruntime_stamp -o $meltcheckruntime_stamp -ot "$GCCMELT_RUNTIME_ARGS" \
    ...
    #@ melt-build-script.tpl:929/805 checkruntime
    if [ -f melt-no-check-runtime -o -n "$MELTGCC_NO_CHECK_RUNTIME" -o ! -f melt-runtime.i ]; then
	meltbuild_info melt-build-script.tpl:931/806 skipping check of MELT runtime
    else
	meltcheckruntime_args=meltbuild-checkruntime.args 
	meltcheckruntime_argstemp=$meltcheckruntime_args-tmp$$
	echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:935/807"' ' -DGCCMELT_CHECKMELTRUNTIME' > $meltcheckruntime_argstemp
	...
	[ -f "$meltcheckruntime_args" ] || meltbuild_error  melt-build-script.tpl:947/808 missing check runtime args  "$meltcheckruntime_args"
	meltbuild_info melt-build-script.tpl:948/809 $meltcheckruntime_args  is
	...
	if [ -n "$MELTGCCBUILTIN_BUILD_WITH_CXX" ]; then
		...
		|| meltbuild_error melt-build-script.tpl:952/810 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	else
	    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltcheckruntime_args \
		|| meltbuild_error melt-build-script.tpl:955/811 failed  $GCCMELT_CC1PLUS with arguments @$meltcheckruntime_args
	fi
	meltbuild_info melt-build-script.tpl:957/812 done check runtime with $meltcheckruntime_args
    fi

   #@ melt-build-script.tpl:960/813 checkhello
    meltcheckhelloworld_args=meltbuild-checkhelloworld.args 
    meltcheckhelloworld_argstemp=$meltcheckhelloworld_args-tmp$$
    echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:963/814"' > $meltcheckhelloworld_argstemp
    ...
    [ -f "$meltcheckhelloworld_args" ] || meltbuild_error  melt-build-script.tpl:977/815 missing check helloworld args  "$meltcheckhelloworld_args"
   meltbuild_info melt-build-script.tpl:978/816 $meltcheckhelloworld_args  is
   cat $meltcheckhelloworld_args < /dev/null >&2
    $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @$meltcheckhelloworld_args \
	|| meltbuild_error melt-build-script.tpl:981/817 running helloworld failed with arguments @$meltcheckhelloworld_args
   meltbuild_info melt-build-script.tpl:982/818 done check helloworld with $meltcheckhelloworld_args
   #@ melt-build-script.tpl:983/819 runtime stamp
    meltcheckruntime_stamptemp=$meltcheckruntime_stamp-tmp$$
    [ -f "$GCCMELT_RUNTIME_CC" ] || meltbuild_error melt-build-script.tpl:985/820 missing MELT runtime C++ file $GCCMELT_RUNTIME_CC
    ...
    [ -f "$melt_final_translator_stamp" ] || meltbuild_error melt-build-script.tpl:990/821 missing final translator stamp "$melt_final_translator_stamp"
    [ -f "$melt_final_library_stamp" ] || meltbuild_error melt-build-script.tpl:991/822 missing final library stamp "$melt_final_library_stamp"
    ...
    meltbuild_info melt-build-script.tpl:995/823 done check runtime  $meltcheckruntime_stamp
else
    meltbuild_info melt-build-script.tpl:997/824 keeping runtime checks  $meltcheckruntime_stamp
fi

if [ "$melt_overall_goal" = "checkruntime" ]; then
    meltbuild_info melt-build-script.tpl:1001/825 done checkruntime overall goal with stamp  $meltcheckruntime_stamp
    exit 0
fi

################################################################
################################################################
### the generated documentation meltgendoc.texi melt-build-script.tpl:1007/826
...
if [   ! -f meltgendoc.texi  -o meltbuild-sources/warmelt-first.melt -nt meltgendoc.texi  \
 ...
 -o meltbuild-sources/libmelt-ana-gimple.melt -nt meltgendoc.texi   ]; then
   meltbuild_info melt-build-script.tpl:1011/827 generating meltgendoc.texi
   meltgen_args=meltbuild-gendoc.args-tmp$$
   echo ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:1013/828"' > $meltgen_args
...
meltbuild_arg "module-makefile=\"$GCCMELT_MODULE_MK\""  >>  $meltgen_args
   ...
   meltbuild_info melt-build-script.tpl:1027/829  meltbuild-gendoc.args is
   cat meltbuild-gendoc.args < /dev/null >&2
   $GCCMELT_CC1PLUS_PREFIX $GCCMELT_CC1PLUS @meltbuild-gendoc.args \
     || meltbuild_error melt-build-script.tpl:1030/830  "$GCCMELT_CC1PLUS" failed with arguments @meltbuild-gendoc.args
else
   meltbuild_info melt-build-script.tpl:1032/831 keeping meltgendoc.texi
fi

################
meltbuild_info melt-build-script.tpl:1036/832 successfully done with times at `date '+%x %H:%M:%S'`: ; times >&2

################################################################
#@ melt-build-script.tpl:1039/833
if [ "$melt_overall_goal" = "gendoc" ]; then
    meltbuild_info melt-build-script.tpl:1041/834 done gendoc overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

## #@ melt-build-script.tpl:1045/835 if we get here something is wrong in this script
meltbuild_error  melt-build-script.tpl:1046/836 unexpected MELT overall goal "$melt_overall_goal" buggy melt-build-script.tpl
#@ eof melt-build-script.tpl:1047/837 end of generated melt-build-script.sh
