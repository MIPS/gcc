...
#@#@#
#@#@# It has been AutoGen-ed  July 30, 2013 at 03:42:25 PM by AutoGen 5.18
...
meltbuild_arg "module-makefile=\"$GCCMELT_MODULE_MK\""  >>  $meltgen_args
   ...
   meltbuild_info melt-build-script.tpl:844/718  meltbuild-gendoc.args is
   cat meltbuild-gendoc.args < /dev/null >&2
   $GCCMELT_CC1_PREFIX $GCCMELT_CC1 @meltbuild-gendoc.args \
     || meltbuild_error melt-build-script.tpl:847/719 failed with arguments @meltbuild-gendoc.args
else
   meltbuild_info melt-build-script.tpl:849/720 keeping meltgendoc.texi
fi

################
meltbuild_info melt-build-script.tpl:853/721 successfully done with times at `date '+%x %H:%M:%S'`: ; times >&2

################################################################
#@ melt-build-script.tpl:856/722
if [ "$melt_overall_goal" = "gendoc" ]; then
    meltbuild_info melt-build-script.tpl:858/723 done gendoc overall goal with stamp  $melt_final_translator_stamp
    exit 0
fi

## #@ melt-build-script.tpl:862/724 if we get here something is wrong in this script
meltbuild_error  melt-build-script.tpl:863/725 unexpected MELT overall goal "$melt_overall_goal" buggy melt-build-script.tpl
#@ eof melt-build-script.tpl:864/726 end of generated melt-build-script.sh
