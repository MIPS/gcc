...
#@#@#
#@#@# It has been AutoGen-ed  August 27, 2014 at 09:14:59 PM by AutoGen 5.18.3
...
if [ ! -f $meltcheckruntime_stamp -o $meltcheckruntime_stamp -ot "$GCCMELT_RUNTIME_ARGS" \
   ...
   #@ melt-build-script.tpl:991/819 runtime stamp
    ...
    echo  ' -DGCCMELT_FROM_ARG="melt-build-script.tpl:1007/824" -DGCCMELT_JUSTCOUNT -fexceptions melt-runtime.i ' > $meltjustcount_argstemp
