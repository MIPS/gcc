...
#define ggc_alloc_vec_entrytreemelt_st(n) ((struct entrytreemelt_st*) (ggc_internal_vec_alloc_stat (sizeof (struct entrytreemelt_st), n MEM_STAT_INFO)))
    ...
    default:
      fatal_error
	("MELT corruption: forward invalid p=%p discr=%p magic=%d [%s]",
...
/*code generated by generate_runtypesupport_predefined_hooks for 143 predefined */
...
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_ALL_IPA_PASSES_END */
  ...
  melthook_ptr_t melthkp =
    (melthook_ptr_t) MELT_PREDEF (HOOK_ALL_IPA_PASSES_END);
...
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_ALL_IPA_PASSES_START */
#ifndef MELT_SKIP_HOOK_PREDEFINED_CODE
  melthook_ptr_t melthkp =
    (melthook_ptr_t) MELT_PREDEF (HOOK_ALL_IPA_PASSES_START);
  ...
  melthooksig_HOOK_ALL_IPA_PASSES_START_t
...
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_EARLY_GIMPLE_PASSES_END */
#ifndef MELT_SKIP_HOOK_PREDEFINED_CODE
  melthook_ptr_t melthkp =
    (melthook_ptr_t) MELT_PREDEF (HOOK_EARLY_GIMPLE_PASSES_END);
  ...
  melthooksig_HOOK_EARLY_GIMPLE_PASSES_END_t
...
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_EARLY_GIMPLE_PASSES_START */
#ifndef MELT_SKIP_HOOK_PREDEFINED_CODE
  melthook_ptr_t melthkp =
    (melthook_ptr_t) MELT_PREDEF (HOOK_EARLY_GIMPLE_PASSES_START);
  ...
  /*checkhook ishook */
    melt_assertmsg
    (" check predefhook HOOK_EARLY_GIMPLE_PASSES_START is hook",
     melt_magic_discr ((melt_ptr_t) melthkp) == MELTOBMAG_HOOK);
  /* check hook routine HOOK_EARLY_GIMPLE_PASSES_START */
  melthooksig_HOOK_EARLY_GIMPLE_PASSES_START_t
...
void
melthookproc_HOOK_FINISH_DECL (tree meltin_TFNDECL_p0)
...
void
melthookproc_HOOK_FINISH_TYPE (tree meltin_TFNDECL_p0)
...
/*predefined hook definition HOOK_INTERN_KEYWORD #118*/
melt_ptr_t
...
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_INTERN_KEYWORD */
  ...
  typedef melt_ptr_t melthooksig_HOOK_INTERN_KEYWORD_t (melt_ptr_t,
							melt_ptr_t);
  /*checkhook exist */
...
/*predefined hook definition HOOK_INTERN_SYMBOL #119*/
melt_ptr_t
...
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_INTERN_SYMBOL */
  ...
  typedef melt_ptr_t melthooksig_HOOK_INTERN_SYMBOL_t (melt_ptr_t,
						       melt_ptr_t);
  /*checkhook exist */
...
/*predefined hook definition HOOK_LOW_DEBUG_VALUE_AT #120*/
void
...
/*predefined hook definition HOOK_MELT_ATTRIBUTE_DEFINER #121*/
void
melthookproc_HOOK_MELT_ATTRIBUTE_DEFINER (tree meltin_DECL_p0,
					  tree meltin_NAME_p1,
					  melt_ptr_t meltin_ATTRSEQ_p2,
					  const char *meltin_FILELOC_p3,
					  long meltin_LINENO_p4)
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_MELT_ATTRIBUTE_DEFINER */
#ifndef MELT_SKIP_HOOK_PREDEFINED_CODE
  melthook_ptr_t melthkp =
    (melthook_ptr_t) MELT_PREDEF (HOOK_MELT_ATTRIBUTE_DEFINER);
  typedef void melthooksig_HOOK_MELT_ATTRIBUTE_DEFINER_t (melt_ptr_t, tree,
							  tree, melt_ptr_t,
							  const char *, long);
  /*checkhook exist */
  ...
  melthooksig_HOOK_MELT_ATTRIBUTE_DEFINER_t
...
/*predefined hook definition HOOK_NAMED_KEYWORD #122*/
melt_ptr_t
...
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_NAMED_KEYWORD */
  ...
  typedef melt_ptr_t melthooksig_HOOK_NAMED_KEYWORD_t (melt_ptr_t,
						       const char *, long);
  /*checkhook exist */
...
/*predefined hook definition HOOK_NAMED_SYMBOL #123*/
melt_ptr_t
...
/*predefined hook definition HOOK_OVERRIDE_GATE #124*/
void
...
/*predefined hook definition HOOK_PASS_EXECUTION #125*/
void
...
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_PASS_EXECUTION */
  ...
  typedef void melthooksig_HOOK_PASS_EXECUTION_t (melt_ptr_t, const char *,
						  long);
  /*checkhook exist */
...
/*predefined hook definition HOOK_POLL_INPUTS #126*/
long
...
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_POLL_INPUTS */
  ...
  typedef long melthooksig_HOOK_POLL_INPUTS_t (melt_ptr_t, long);
  /*checkhook exist */
...
/*predefined hook definition HOOK_PRE_GENERICIZE #127*/
void
melthookproc_HOOK_PRE_GENERICIZE (tree meltin_TFNDECL_p0)
...
/*predefined hook definition HOOK_RTL_EXECUTE #128*/
long
melthookproc_HOOK_RTL_EXECUTE ()
...
/*predefined hook definition HOOK_RTL_GATE #129*/
long
...
/*predefined hook definition HOOK_SIMPLE_IPA_EXECUTE #130*/
long
melthookproc_HOOK_SIMPLE_IPA_EXECUTE ()
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_SIMPLE_IPA_EXECUTE */
#ifndef MELT_SKIP_HOOK_PREDEFINED_CODE
  melthook_ptr_t melthkp =
    (melthook_ptr_t) MELT_PREDEF (HOOK_SIMPLE_IPA_EXECUTE);
...
/*predefined hook definition HOOK_SIMPLE_IPA_GATE #131*/
long
melthookproc_HOOK_SIMPLE_IPA_GATE ()
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_SIMPLE_IPA_GATE */
#ifndef MELT_SKIP_HOOK_PREDEFINED_CODE
  melthook_ptr_t melthkp =
    (melthook_ptr_t) MELT_PREDEF (HOOK_SIMPLE_IPA_GATE);
...
/*predefined hook definition HOOK_START_UNIT #132*/
void
...
/*predefined hook definition HOOK_FRESH_ENVIRONMENT_REFERENCE_MAKER #133*/
melt_ptr_t
...
/*predefined hook definition HOOK_SYMBOL_IMPORTER #134*/
melt_ptr_t
melthookproc_HOOK_SYMBOL_IMPORTER (const char *meltin_SYMNAMESTR_p0,
				   const char *meltin_MODULENAMESTR_p1,
				   melt_ptr_t meltin_PARENV_p2)
{				/* code emitted by generate_runtypesupport_predefined_hooks for HOOK_SYMBOL_IMPORTER */
#ifndef MELT_SKIP_HOOK_PREDEFINED_CODE
  melthook_ptr_t melthkp =
    (melthook_ptr_t) MELT_PREDEF (HOOK_SYMBOL_IMPORTER);
  typedef melt_ptr_t melthooksig_HOOK_SYMBOL_IMPORTER_t (melt_ptr_t,
							 const char *,
							 const char *,
							 melt_ptr_t);
  /*checkhook exist */
...
/*predefined hook definition HOOK_VALUE_EXPORTER #135*/
void
...
/*predefined hook definition HOOK_MACRO_EXPORTER #136*/
void
...
/* end of code generated by generate_runtypesupport_predefined_hooks for 143 predefined */

/*** End of code file meltbuild-sources/generated/meltrunsup-inc.c generated on 2013 Jun 11
 * by GCC MELT 4.8.0 20130314 (experimental) [melt-branch revision 199935] MELT_0.9.9-rc2p . ***/
