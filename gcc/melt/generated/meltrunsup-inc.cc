...
long melthookproc_HOOK_SIMPLE_IPA_GATE()
{
    ...
    /*checkhook exist*/
    melt_assertmsg (" check predefhook HOOK_SIMPLE_IPA_GATE exists",
                    melthkp != NULL);
    /*checkhook ishook*/
    melt_assertmsg (" check predefhook HOOK_SIMPLE_IPA_GATE is hook",
                    melt_magic_discr ((melt_ptr_t) melthkp) == MELTOBMAG_HOOK);
...
/*** End of code file meltbuild-sources/generated/meltrunsup-inc.cc generated on 2013 Jul 12
 * by GCC MELT 4.9.0 20130712 (experimental) [melt-branch revision 200918] MELT_0.9.9-post . ***/
