...
/* predefined class CLASS_SYSTEM_DATA index 34 */ enum
{
  ...
  MELTFIELD_SYSDATA_PRE_GENERICIZE = 17 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_OPTION_SET = 18 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_PASSEXEC_HOOK = 19 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_MELTPASS_AFTER_HOOK = 20 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_MELTPRAGMAS = 21 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_FINISHTYPE_HOOK = 22 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_FINISHDECL_HOOK = 23 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_ALL_PASSES_START_HOOK = 24 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_ALL_PASSES_END_HOOK = 25 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_EARLY_GIMPLE_PASSES_START_HOOK =
    26 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_EARLY_GIMPLE_PASSES_END_HOOK =
    27 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_INCHANNEL_DATA = 28 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_ALARM_HOOK = 29 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_CHILD_HOOK = 30 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_SRC_LOC_FILE_DICT = 31 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA___SPARE1 = 32 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA___SPARE2 = 33 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA___SPARE3 = 34 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA___SPARE4 = 35 /*in CLASS_SYSTEM_DATA */ ,
  MELTLENGTH_CLASS_SYSTEM_DATA = 36
};
/** end of code generated by generate_runtypesupport_predef_fields **/


/* declarations generated by generate_runtypesupport_predefined_hooks for 134 predefined */
...
/*predefined hook declaration HOOK_FINISH_TYPE #112*/
MELT_EXTERN void melthookproc_HOOK_FINISH_TYPE (tree meltin_TFNDECL_p0);

/*predefined hook declaration HOOK_FINISH_UNIT #113*/
MELT_EXTERN void melthookproc_HOOK_FINISH_UNIT ();

/*predefined hook declaration HOOK_GIMPLE_EXECUTE #114*/
MELT_EXTERN long melthookproc_HOOK_GIMPLE_EXECUTE ();

/*predefined hook declaration HOOK_GIMPLE_GATE #115*/
MELT_EXTERN long melthookproc_HOOK_GIMPLE_GATE ();

/*predefined hook declaration HOOK_INTERN_KEYWORD #116*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_INTERN_KEYWORD (melt_ptr_t
							 meltin_KEYWV_p0);

/*predefined hook declaration HOOK_INTERN_SYMBOL #117*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_INTERN_SYMBOL (melt_ptr_t
							meltin_SYMBV_p0);

/*predefined hook declaration HOOK_LOW_DEBUG_VALUE_AT #118*/
...
/*predefined hook declaration HOOK_NAMED_KEYWORD #119*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_NAMED_KEYWORD (const char
							*meltin_NAM_p0,
							long
							meltin_CREATE_p1);

/*predefined hook declaration HOOK_NAMED_SYMBOL #120*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_NAMED_SYMBOL (const char
						       *meltin_NAM_p0,
						       long meltin_CREATE_p1);

/*predefined hook declaration HOOK_OVERRIDE_GATE #121*/
MELT_EXTERN void melthookproc_HOOK_OVERRIDE_GATE (long meltin_BEFOREGATE_p0,
						  long *meltout_AFTERGATE_o0);

/*predefined hook declaration HOOK_PASS_EXECUTION #122*/
MELT_EXTERN void melthookproc_HOOK_PASS_EXECUTION (const char
						   *meltin_PASSNAME_p0,
						   long meltin_PASSNUM_p1);

/*predefined hook declaration HOOK_PRE_GENERICIZE #123*/
MELT_EXTERN void melthookproc_HOOK_PRE_GENERICIZE (tree meltin_TFNDECL_p0);

/*predefined hook declaration HOOK_RTL_EXECUTE #124*/
MELT_EXTERN long melthookproc_HOOK_RTL_EXECUTE ();

/*predefined hook declaration HOOK_RTL_GATE #125*/
MELT_EXTERN long melthookproc_HOOK_RTL_GATE ();

/*predefined hook declaration HOOK_SIMPLE_IPA_EXECUTE #126*/
MELT_EXTERN long melthookproc_HOOK_SIMPLE_IPA_EXECUTE ();

/*predefined hook declaration HOOK_SIMPLE_IPA_GATE #127*/
MELT_EXTERN long melthookproc_HOOK_SIMPLE_IPA_GATE ();

/*predefined hook declaration HOOK_START_UNIT #128*/
MELT_EXTERN void melthookproc_HOOK_START_UNIT ();
/* end of declarations generated by generate_runtypesupport_predefined_hooks for 134 predefined */

/*** End of declaration file meltbuild-sources/generated/meltrunsup.h generated on 2013 May 30
