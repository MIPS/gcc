...
/* predefined class CLASS_SYSTEM_DATA index 34 */ enum
{
  ...
  MELTFIELD_SYSDATA_OBSOLETE1 = 3 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_OBSOLETE2 = 4 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_OBSOLETE3 = 5 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_SYMBOLDICT = 6 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_KEYWDICT = 7 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_OBSOLETE4 = 8 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_PASS_DICT = 9 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_EXIT_FINALIZER = 10 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_MELTATTR_DEFINER = 11 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_PATMACRO_EXPORTER = 12 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_DEBUGMSG = 13 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_STDOUT = 14 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_STDERR = 15 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_DUMPFILE = 16 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_OPTION_SET = 17 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_MELTPASS_AFTER_HOOK = 18 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_MELTPRAGMAS = 19 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_INCHANNEL_DATA = 20 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_ALARM_HOOK = 21 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_CHILD_HOOK = 22 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_SRC_LOC_FILE_DICT = 23 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA___SPARE1 = 24 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA___SPARE2 = 25 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA___SPARE3 = 26 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA___SPARE4 = 27 /*in CLASS_SYSTEM_DATA */ ,
  MELTLENGTH_CLASS_SYSTEM_DATA = 28
};
/** end of code generated by generate_runtypesupport_predef_fields **/


/* declarations generated by generate_runtypesupport_predefined_hooks for 140 predefined */
...
/*predefined hook declaration HOOK_SYMBOL_IMPORTER #131*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_SYMBOL_IMPORTER (const char
...
/*predefined hook declaration HOOK_VALUE_EXPORTER #132*/
MELT_EXTERN void melthookproc_HOOK_VALUE_EXPORTER (melt_ptr_t meltin_SYM_p0,
						   melt_ptr_t meltin_VAL_p1,
						   melt_ptr_t
						   meltin_CONTENV_p2);

/*predefined hook declaration HOOK_MACRO_EXPORTER #133*/
MELT_EXTERN void melthookproc_HOOK_MACRO_EXPORTER (melt_ptr_t meltin_SYM_p0,
						   melt_ptr_t meltin_VAL_p1,
						   melt_ptr_t
						   meltin_CONTENV_p2);

/*predefined hook declaration HOOK_PATMACRO_EXPORTER #134*/
MELT_EXTERN void melthookproc_HOOK_PATMACRO_EXPORTER (melt_ptr_t
						      meltin_SYM_p0,
						      melt_ptr_t
						      meltin_MACVAL_p1,
						      melt_ptr_t
						      ...
						      melt_ptr_t
						      meltin_CONTENV_p3);
/* end of declarations generated by generate_runtypesupport_predefined_hooks for 140 predefined */

/*** End of declaration file meltbuild-sources/generated/meltrunsup.h generated on 2013 Jun 10
