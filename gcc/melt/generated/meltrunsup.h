...
struct GTY((variable_size)) meltbucketlongs_st /* when MELTOBMAG_BUCKETLONGS */
{
    ...
    // in file warmelt-base.melt line 2772
...
// in file warmelt-base.melt line 2782
...
struct GTY((variable_size)) meltclosure_st /* when MELTOBMAG_CLOSURE */
{
    ...
    // in file warmelt-base.melt line 2550
...
// in file warmelt-base.melt line 2556
...
struct GTY(( mark_hook ("melt_mark_decay"))) meltdecay_st /* when MELTOBMAG_DECAY */
{
    ...
    // in file warmelt-base.melt line 2449
    melt_ptr_t val;
...
struct GTY(()) meltdouble_st /* when MELTOBMAG_DOUBLE */
{
    ...
    // in file warmelt-base.melt line 3242
    double GTY ((skip)) val ;
...
struct GTY((variable_size)) melthook_st /* when MELTOBMAG_HOOK */
{
    ...
    // in file warmelt-base.melt line 2694
...
struct GTY(()) meltint_st /* when MELTOBMAG_INT */
{
    ...
    // in file warmelt-base.melt line 3209
    long val;

}; /* end meltint_st */
/* decl. chunk */
/* decl VALDESC_INT in warmelt-base.melt */
// in file warmelt-base.melt line 3213
...
struct GTY((variable_size)) meltjsonobject_st /* when MELTOBMAG_JSONOBJECT */
{
    ...
    // in file warmelt-base.melt line 2885
...
// in file warmelt-base.melt line 2893
    ...
    if (melt_magic_discr(vjob) == MELTOBMAG_JSONOBJECT)
        {
            ...
            if (rk<0)
                rk += (int)sz;
            if (rk>=0 && rk < (int) sz)
                return ((struct meltjsonobject_st*)vjob)->jsob_entab[rk].jsonob_name;
        };
    return NULL;
}
    ...
    if (melt_magic_discr(vjob) == MELTOBMAG_JSONOBJECT)
        {
            ...
            if (rk<0)
                rk += (int)sz;
            if (rk>=0 && rk < (int) sz)
                return ((struct meltjsonobject_st*)vjob)->jsob_entab[rk].jsonob_val;
        };
    return NULL;
}

// in file warmelt-base.melt line 2948
...
struct GTY(()) meltlist_st /* when MELTOBMAG_LIST */
{
    ...
    // in file warmelt-base.melt line 3151
...
// in file warmelt-base.melt line 3156
...
struct GTY(()) meltmapobjects_st /* when MELTOBMAG_MAPOBJECTS */
{
    ...
    // in file warmelt-base.melt line 2212
    unsigned count;
    unsigned char lenix;
    unsigned meltmap_hash;
    melt_ptr_t meltmap_aux;
...
// in file warmelt-base.melt line 2225
...
struct GTY(()) meltmapstrings_st /* when MELTOBMAG_MAPSTRINGS */
{
    ...
    // in file warmelt-base.melt line 2333
    unsigned count;
    unsigned char lenix;
    unsigned meltmap_hash;
    melt_ptr_t meltmap_aux;
...
struct GTY(()) meltmixint_st /* when MELTOBMAG_MIXINT */
{
    ...
    // in file warmelt-base.melt line 3275
    melt_ptr_t ptrval;
    long intval;
...
struct GTY(()) meltmixloc_st /* when MELTOBMAG_MIXLOC */
{
    ...
    // in file warmelt-base.melt line 3306
    melt_ptr_t ptrval;
    long intval;
    location_t locval;
...
struct GTY((variable_size)) meltmultiple_st /* when MELTOBMAG_MULTIPLE */
{
    ...
    // in file warmelt-base.melt line 2483
    unsigned nbval;
    melt_ptr_t GTY ((length ("%h.nbval"))) tabval[MELT_FLEXIBLE_DIM];
...
// in file warmelt-base.melt line 2488
...
struct GTY(( chain_next ("%h.tl"))) meltpair_st /* when MELTOBMAG_PAIR */
{
    ...
    // in file warmelt-base.melt line 3118
    melt_ptr_t hd;
...
struct GTY(()) meltreal_st /* when MELTOBMAG_REAL */
{
    ...
    // in file warmelt-base.melt line 3382
    REAL_VALUE_TYPE val;
...
struct GTY((variable_size)) meltroutine_st /* when MELTOBMAG_ROUTINE */
{
    ...
    // in file warmelt-base.melt line 2619
...
// in file warmelt-base.melt line 2627
#ifndef meltroutine_ptr_t_TYPEDEFINED
typedef struct meltroutine_st *meltroutine_ptr_t;
#define  meltroutine_ptr_t_TYPEDEFINED
...
struct GTY(( mark_hook ("melt_mark_specialdata"))) meltspecialdata_st /* when MELTOBMAG_SPECIAL_DATA */
{
    ...
    // in file warmelt-base.melt line 3410
    int meltspec_mark;
...
struct GTY((variable_size)) meltstring_st /* when MELTOBMAG_STRING */
{
    ...
    // in file warmelt-base.melt line 3005
    unsigned slen;
...
// in file warmelt-base.melt line 3010
...
static inline struct meltjsonobject_st* meltcast_meltjsonobject_st(melt_ptr_t p)
{
    if (p && melt_magic_discr(p) == MELTOBMAG_JSONOBJECT)
        return (struct meltjsonobject_st*) p;
    return NULL;
} /* end meltcast_meltjsonobject_st*/
...
union meltparam_un /* generated union for MELT parameters */
{
    ...
    melt_basicblockptr_t meltbp_bb; /*argument param.*/

    melt_basicblockptr_t *meltbp_bbptr; /*result param.*/
    /*ctype #2 CTYPE_BITMAP*/
    melt_bitmapptr_t meltbp_bitmap; /*argument param.*/

    melt_bitmapptr_t *meltbp_bitmapptr; /*result param.*/
    ...
    /*ctype #5 CTYPE_EDGE*/
    melt_edgeptr_t meltbp_edge; /*argument param.*/

    melt_edgeptr_t *meltbp_edgeptr; /*result param.*/
    ...
    melt_gimpleseqptr_t meltbp_gimpleseq; /*argument param.*/

    melt_gimpleseqptr_t *meltbp_gimpleseqptr; /*result param.*/
    /*ctype #8 CTYPE_LONG*/
    long meltbp_long; /*argument param.*/

    long *meltbp_longptr; /*result param.*/
    /*ctype #9 CTYPE_LOOP*/
    melt_loopptr_t meltbp_loop; /*argument param.*/

    melt_loopptr_t *meltbp_loopptr; /*result param.*/
    /*ctype #10 CTYPE_RTVEC*/
    melt_rtvecptr_t meltbp_rtvec; /*argument param.*/

    melt_rtvecptr_t *meltbp_rtvecptr; /*result param.*/
    /*ctype #11 CTYPE_RTX*/
    melt_rtxptr_t meltbp_rtx; /*argument param.*/

    melt_rtxptr_t *meltbp_rtxptr; /*result param.*/
    /*ctype #12 CTYPE_TREE*/
...
melt_ptr_t meltgc_new_basicblock(meltobject_ptr_t discr, melt_basicblockptr_t val);
void meltgc_basicblock_updatebox(melt_ptr_t boxp, melt_basicblockptr_t val);

static inline melt_basicblockptr_t melt_basicblock_content(melt_ptr_t box_p)
{
    if (melt_magic_discr(box_p) == MELTOBMAG_BASICBLOCK)
        return ((struct meltbasicblock_st*)box_p)->val;
    return (melt_basicblockptr_t)0;
} /* end generated melt_basicblock_content */

/*runtypesupport gtyctype #2 CTYPE_BITMAP*/
melt_ptr_t meltgc_new_bitmap(meltobject_ptr_t discr, melt_bitmapptr_t val);
void meltgc_bitmap_updatebox(melt_ptr_t boxp, melt_bitmapptr_t val);

static inline melt_bitmapptr_t melt_bitmap_content(melt_ptr_t box_p)
{
    if (melt_magic_discr(box_p) == MELTOBMAG_BITMAP)
        return ((struct meltbitmap_st*)box_p)->val;
    return (melt_bitmapptr_t)0;
} /* end generated melt_bitmap_content */

/*runtypesupport gtyctype #3 CTYPE_EDGE*/
melt_ptr_t meltgc_new_edge(meltobject_ptr_t discr, melt_edgeptr_t val);
void meltgc_edge_updatebox(melt_ptr_t boxp, melt_edgeptr_t val);

static inline melt_edgeptr_t melt_edge_content(melt_ptr_t box_p)
{
    if (melt_magic_discr(box_p) == MELTOBMAG_EDGE)
        return ((struct meltedge_st*)box_p)->val;
    return (melt_edgeptr_t)0;
...
melt_ptr_t meltgc_new_gimpleseq(meltobject_ptr_t discr, melt_gimpleseqptr_t val);
void meltgc_gimpleseq_updatebox(melt_ptr_t boxp, melt_gimpleseqptr_t val);

static inline melt_gimpleseqptr_t melt_gimpleseq_content(melt_ptr_t box_p)
{
    if (melt_magic_discr(box_p) == MELTOBMAG_GIMPLESEQ)
        return ((struct meltgimpleseq_st*)box_p)->val;
    return (melt_gimpleseqptr_t)0;
} /* end generated melt_gimpleseq_content */

/*runtypesupport gtyctype #6 CTYPE_LOOP*/
melt_ptr_t meltgc_new_loop(meltobject_ptr_t discr, melt_loopptr_t val);
void melt_loop_updatebox(melt_ptr_t boxp, melt_loopptr_t val);

static inline melt_loopptr_t melt_loop_content(melt_ptr_t box_p)
{
    if (melt_magic_discr(box_p) == MELTOBMAG_LOOP)
        return ((struct meltloop_st*)box_p)->val;
    return (melt_loopptr_t)0;
} /* end generated melt_loop_content */

/*runtypesupport gtyctype #7 CTYPE_RTVEC*/
melt_ptr_t meltgc_new_rtvec(meltobject_ptr_t discr, melt_rtvecptr_t val);
void meltgc_rtvec_updatebox(melt_ptr_t boxp, melt_rtvecptr_t val);

static inline melt_rtvecptr_t melt_rtvec_content(melt_ptr_t box_p)
{
    if (melt_magic_discr(box_p) == MELTOBMAG_RTVEC)
        return ((struct meltrtvec_st*)box_p)->val;
    return (melt_rtvecptr_t)0;
} /* end generated melt_rtvec_content */

/*runtypesupport gtyctype #8 CTYPE_RTX*/
melt_ptr_t meltgc_new_rtx(meltobject_ptr_t discr, melt_rtxptr_t val);
void meltgc_rtx_updatebox(melt_ptr_t boxp, melt_rtxptr_t val);

static inline melt_rtxptr_t melt_rtx_content(melt_ptr_t box_p)
{
    if (melt_magic_discr(box_p) == MELTOBMAG_RTX)
        return ((struct meltrtx_st*)box_p)->val;
    return (melt_rtxptr_t)0;
...
static inline melt_ptr_t /* Map getter for CTYPE_BASIC_BLOCK*/ melt_get_mapbasicblocks (melt_ptr_t map_p, melt_basicblockptr_t attr)
{
    if (!map_p || !attr
...
static inline void /* Map putter for CTYPE_BASIC_BLOCK*/ melt_put_mapbasicblocks (melt_ptr_t map_p, melt_basicblockptr_t attr, melt_ptr_t valu_p)
{
...
static inline void /* Map remover for CTYPE_BASIC_BLOCK*/ melt_remove_mapbasicblocks (melt_ptr_t map_p, melt_basicblockptr_t attr)
{
    if (!map_p || !attr
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPBASICBLOCKS)
        return;
...
static inline melt_basicblockptr_t/* Map nth attr for CTYPE_BASIC_BLOCK*/ melt_nthattr_mapbasicblocks (struct meltmapbasicblocks_st* map_s, int ix)
{
    melt_basicblockptr_t at = 0;
    if (!map_s
            || melt_magic_discr ((melt_ptr_t) map_s) != MELTOBMAG_MAPBASICBLOCKS)
        return 0;
...
/* map hash access for CTYPE_BASIC_BLOCK */
static inline unsigned melt_hash_mapbasicblocks (melt_ptr_t map_p)
{
    if (melt_magic_discr (map_p) == MELTOBMAG_MAPBASICBLOCKS)
        return ((struct meltmapbasicblocks_st*)map_p)->meltmap_hash;
    return 0;
}
...
static inline melt_ptr_t /* Map getter for CTYPE_BITMAP*/ melt_get_mapbitmaps (melt_ptr_t map_p, melt_bitmapptr_t attr)
{
    if (!map_p || !attr
...
static inline void /* Map putter for CTYPE_BITMAP*/ melt_put_mapbitmaps (melt_ptr_t map_p, melt_bitmapptr_t attr, melt_ptr_t valu_p)
{
    if (!map_p || !attr || !valu_p
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPBITMAPS)
        return;
...
static inline void /* Map remover for CTYPE_BITMAP*/ melt_remove_mapbitmaps (melt_ptr_t map_p, melt_bitmapptr_t attr)
{
    if (!map_p || !attr
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPBITMAPS)
        return;
...
static inline melt_bitmapptr_t/* Map nth attr for CTYPE_BITMAP*/ melt_nthattr_mapbitmaps (struct meltmapbitmaps_st* map_s, int ix)
{
    melt_bitmapptr_t at = 0;
    if (!map_s
            || melt_magic_discr ((melt_ptr_t) map_s) != MELTOBMAG_MAPBITMAPS)
        return 0;
    at = map_s->entab[ix].e_at;
...
/* map hash access for CTYPE_BITMAP */
static inline unsigned melt_hash_mapbitmaps (melt_ptr_t map_p)
{
    if (melt_magic_discr (map_p) == MELTOBMAG_MAPBITMAPS)
        return ((struct meltmapbitmaps_st*)map_p)->meltmap_hash;
    return 0;
}
...
static inline melt_ptr_t /* Map getter for CTYPE_EDGE*/ melt_get_mapedges (melt_ptr_t map_p, melt_edgeptr_t attr)
{
    if (!map_p || !attr
...
static inline void /* Map putter for CTYPE_EDGE*/ melt_put_mapedges (melt_ptr_t map_p, melt_edgeptr_t attr, melt_ptr_t valu_p)
{
    if (!map_p || !attr || !valu_p
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPEDGES)
        return;
...
static inline void /* Map remover for CTYPE_EDGE*/ melt_remove_mapedges (melt_ptr_t map_p, melt_edgeptr_t attr)
{
    if (!map_p || !attr
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPEDGES)
        return;
...
static inline melt_edgeptr_t/* Map nth attr for CTYPE_EDGE*/ melt_nthattr_mapedges (struct meltmapedges_st* map_s, int ix)
{
    melt_edgeptr_t at = 0;
    if (!map_s
            || melt_magic_discr ((melt_ptr_t) map_s) != MELTOBMAG_MAPEDGES)
...
/* map hash access for CTYPE_EDGE */
static inline unsigned melt_hash_mapedges (melt_ptr_t map_p)
{
    if (melt_magic_discr (map_p) == MELTOBMAG_MAPEDGES)
        return ((struct meltmapedges_st*)map_p)->meltmap_hash;
    return 0;
}
...
/* map hash access for CTYPE_GIMPLE */
static inline unsigned melt_hash_mapgimples (melt_ptr_t map_p)
{
    if (melt_magic_discr (map_p) == MELTOBMAG_MAPGIMPLES)
        return ((struct meltmapgimples_st*)map_p)->meltmap_hash;
    return 0;
}
...
static inline melt_ptr_t /* Map getter for CTYPE_GIMPLE_SEQ*/ melt_get_mapgimpleseqs (melt_ptr_t map_p, melt_gimpleseqptr_t attr)
{
    if (!map_p || !attr
...
static inline void /* Map putter for CTYPE_GIMPLE_SEQ*/ melt_put_mapgimpleseqs (melt_ptr_t map_p, melt_gimpleseqptr_t attr, melt_ptr_t valu_p)
{
    if (!map_p || !attr || !valu_p
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPGIMPLESEQS)
        return;
...
static inline void /* Map remover for CTYPE_GIMPLE_SEQ*/ melt_remove_mapgimpleseqs (melt_ptr_t map_p, melt_gimpleseqptr_t attr)
{
    if (!map_p || !attr
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPGIMPLESEQS)
        return;
...
static inline melt_gimpleseqptr_t/* Map nth attr for CTYPE_GIMPLE_SEQ*/ melt_nthattr_mapgimpleseqs (struct meltmapgimpleseqs_st* map_s, int ix)
{
    melt_gimpleseqptr_t at = 0;
    if (!map_s
            || melt_magic_discr ((melt_ptr_t) map_s) != MELTOBMAG_MAPGIMPLESEQS)
        return 0;
    at = map_s->entab[ix].e_at;
...
/* map hash access for CTYPE_GIMPLE_SEQ */
static inline unsigned melt_hash_mapgimpleseqs (melt_ptr_t map_p)
{
    if (melt_magic_discr (map_p) == MELTOBMAG_MAPGIMPLESEQS)
        return ((struct meltmapgimpleseqs_st*)map_p)->meltmap_hash;
    return 0;
}
...
static inline melt_ptr_t /* Map getter for CTYPE_LOOP*/ melt_get_maploops (melt_ptr_t map_p, melt_loopptr_t attr)
{
    if (!map_p || !attr
...
static inline void /* Map putter for CTYPE_LOOP*/ melt_put_maploops (melt_ptr_t map_p, melt_loopptr_t attr, melt_ptr_t valu_p)
{
    if (!map_p || !attr || !valu_p
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPLOOPS)
        return;
...
static inline void /* Map remover for CTYPE_LOOP*/ melt_remove_maploops (melt_ptr_t map_p, melt_loopptr_t attr)
{
    if (!map_p || !attr
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPLOOPS)
        return;
...
static inline melt_loopptr_t/* Map nth attr for CTYPE_LOOP*/ melt_nthattr_maploops (struct meltmaploops_st* map_s, int ix)
{
    melt_loopptr_t at = 0;
    if (!map_s
            || melt_magic_discr ((melt_ptr_t) map_s) != MELTOBMAG_MAPLOOPS)
...
/* map hash access for CTYPE_LOOP */
static inline unsigned melt_hash_maploops (melt_ptr_t map_p)
{
    if (melt_magic_discr (map_p) == MELTOBMAG_MAPLOOPS)
        return ((struct meltmaploops_st*)map_p)->meltmap_hash;
    return 0;
}
...
static inline melt_ptr_t /* Map getter for CTYPE_RTVEC*/ melt_get_maprtvecs (melt_ptr_t map_p, melt_rtvecptr_t attr)
{
    if (!map_p || !attr
...
static inline void /* Map putter for CTYPE_RTVEC*/ melt_put_maprtvecs (melt_ptr_t map_p, melt_rtvecptr_t attr, melt_ptr_t valu_p)
{
    if (!map_p || !attr || !valu_p
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPRTVECS)
        return;
...
static inline void /* Map remover for CTYPE_RTVEC*/ melt_remove_maprtvecs (melt_ptr_t map_p, melt_rtvecptr_t attr)
{
    if (!map_p || !attr
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPRTVECS)
        return;
...
static inline melt_rtvecptr_t/* Map nth attr for CTYPE_RTVEC*/ melt_nthattr_maprtvecs (struct meltmaprtvecs_st* map_s, int ix)
{
    melt_rtvecptr_t at = 0;
    if (!map_s
            || melt_magic_discr ((melt_ptr_t) map_s) != MELTOBMAG_MAPRTVECS)
        return 0;
    at = map_s->entab[ix].e_at;
...
/* map hash access for CTYPE_RTVEC */
static inline unsigned melt_hash_maprtvecs (melt_ptr_t map_p)
{
    if (melt_magic_discr (map_p) == MELTOBMAG_MAPRTVECS)
        return ((struct meltmaprtvecs_st*)map_p)->meltmap_hash;
    return 0;
}
...
static inline melt_ptr_t /* Map getter for CTYPE_RTX*/ melt_get_maprtxs (melt_ptr_t map_p, melt_rtxptr_t attr)
{
    if (!map_p || !attr
...
static inline void /* Map putter for CTYPE_RTX*/ melt_put_maprtxs (melt_ptr_t map_p, melt_rtxptr_t attr, melt_ptr_t valu_p)
{
    if (!map_p || !attr || !valu_p
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPRTXS)
        return;
...
static inline void /* Map remover for CTYPE_RTX*/ melt_remove_maprtxs (melt_ptr_t map_p, melt_rtxptr_t attr)
{
    if (!map_p || !attr
            || melt_magic_discr ((melt_ptr_t) map_p) != MELTOBMAG_MAPRTXS)
        return;
...
static inline melt_rtxptr_t/* Map nth attr for CTYPE_RTX*/ melt_nthattr_maprtxs (struct meltmaprtxs_st* map_s, int ix)
{
    melt_rtxptr_t at = 0;
    if (!map_s
            || melt_magic_discr ((melt_ptr_t) map_s) != MELTOBMAG_MAPRTXS)
...
/* map hash access for CTYPE_RTX */
static inline unsigned melt_hash_maprtxs (melt_ptr_t map_p)
{
    if (melt_magic_discr (map_p) == MELTOBMAG_MAPRTXS)
        return ((struct meltmaprtxs_st*)map_p)->meltmap_hash;
    return 0;
}
...
/* map hash access for CTYPE_TREE */
static inline unsigned melt_hash_maptrees (melt_ptr_t map_p)
{
    if (melt_magic_discr (map_p) == MELTOBMAG_MAPTREES)
        return ((struct meltmaptrees_st*)map_p)->meltmap_hash;
    return 0;
}
...
/* predefined class CLASS_CTYPE_GTY index 7 */ enum
{
    ...
    MELTFIELD_CTYPG_MAPHASHFUN = 34 /*in CLASS_CTYPE_GTY*/,
...
/* predefined class CLASS_GCC_PRAGMA index 16 */ enum
{
    ...
    MELTFIELD_GCCPRAGMA_SPACE = 3 /*in CLASS_GCC_PRAGMA*/,
    MELTFIELD_GCCPRAGMA_DATA = 4 /*in CLASS_GCC_PRAGMA*/,
    MELTLENGTH_CLASS_GCC_PRAGMA = 5
} ;
...
/* predefined class CLASS_SYSTEM_DATA index 34 */ enum
{
    ...
    MELTFIELD_SYSDATA_STDOUT = 6 /*in CLASS_SYSTEM_DATA*/,
    MELTFIELD_SYSDATA_STDERR = 7 /*in CLASS_SYSTEM_DATA*/,
    MELTFIELD_SYSDATA_DUMPFILE = 8 /*in CLASS_SYSTEM_DATA*/,
    MELTFIELD_SYSDATA_SRC_LOC_FILE_DICT = 9 /*in CLASS_SYSTEM_DATA*/,
    MELTFIELD_SYSDATA___SPARE1 = 10 /*in CLASS_SYSTEM_DATA*/,
    MELTFIELD_SYSDATA___SPARE2 = 11 /*in CLASS_SYSTEM_DATA*/,
    MELTFIELD_SYSDATA___SPARE3 = 12 /*in CLASS_SYSTEM_DATA*/,
    MELTFIELD_SYSDATA___SPARE4 = 13 /*in CLASS_SYSTEM_DATA*/,
    MELTLENGTH_CLASS_SYSTEM_DATA = 14
} ;
/** end of code generated by generate_runtypesupport_predef_fields **/


/* declarations generated by generate_runtypesupport_predefined_hooks for 161 predefined */

/*predefined hook declaration HOOK_ALL_IPA_PASSES_END #112*/
MELT_EXTERN void melthookproc_HOOK_ALL_IPA_PASSES_END();

/*predefined hook declaration HOOK_ALL_IPA_PASSES_START #113*/
MELT_EXTERN void melthookproc_HOOK_ALL_IPA_PASSES_START();

/*predefined hook declaration HOOK_ALL_PASSES_END #114*/
MELT_EXTERN void melthookproc_HOOK_ALL_PASSES_END();

/*predefined hook declaration HOOK_ALL_PASSES_START #115*/
MELT_EXTERN void melthookproc_HOOK_ALL_PASSES_START();

/*predefined hook declaration HOOK_EARLY_GIMPLE_PASSES_END #116*/
MELT_EXTERN void melthookproc_HOOK_EARLY_GIMPLE_PASSES_END();

/*predefined hook declaration HOOK_EARLY_GIMPLE_PASSES_START #117*/
MELT_EXTERN void melthookproc_HOOK_EARLY_GIMPLE_PASSES_START();

/*predefined hook declaration HOOK_EXIT_FINALIZER #118*/
...
/*predefined hook declaration HOOK_FRESH_ENVIRONMENT_REFERENCE_MAKER #122*/
...
/*predefined hook declaration HOOK_GIMPLE_EXECUTE #123*/
MELT_EXTERN long melthookproc_HOOK_GIMPLE_EXECUTE();

/*predefined hook declaration HOOK_GIMPLE_GATE #124*/
...
/*predefined hook declaration HOOK_HANDLE_SIGCHLD #127*/
MELT_EXTERN void melthookproc_HOOK_HANDLE_SIGCHLD();

/*predefined hook declaration HOOK_HANDLE_SIGIO #128*/
MELT_EXTERN void melthookproc_HOOK_HANDLE_SIGIO();

/*predefined hook declaration HOOK_INTERN_KEYWORD #129*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_INTERN_KEYWORD(melt_ptr_t meltin_KEYWV_p0);

/*predefined hook declaration HOOK_INTERN_SYMBOL #130*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_INTERN_SYMBOL(melt_ptr_t meltin_SYMBV_p0);

/*predefined hook declaration HOOK_INSTALL_ATTRIBUTES #131*/
MELT_EXTERN void melthookproc_HOOK_INSTALL_ATTRIBUTES();

/*predefined hook declaration HOOK_LOW_DEBUG_VALUE_AT #132*/
...
/*predefined hook declaration HOOK_LOW_STDERR_VALUE_AT #133*/
...
/*predefined hook declaration HOOK_MACRO_EXPORTER #134*/
...
/*predefined hook declaration HOOK_PATMACRO_EXPORTER #142*/
...
/*predefined hook declaration HOOK_POLL_INPUTS #143*/
...
/*predefined hook declaration HOOK_REGISTER_PRAGMAS #146*/
MELT_EXTERN void melthookproc_HOOK_REGISTER_PRAGMAS();

/*predefined hook declaration HOOK_RTL_EXECUTE #147*/
MELT_EXTERN long melthookproc_HOOK_RTL_EXECUTE();

/*predefined hook declaration HOOK_RTL_GATE #148*/
MELT_EXTERN long melthookproc_HOOK_RTL_GATE();

/*predefined hook declaration HOOK_SIMPLE_IPA_EXECUTE #149*/
MELT_EXTERN long melthookproc_HOOK_SIMPLE_IPA_EXECUTE();

/*predefined hook declaration HOOK_SORT_COMPARE_LESS #150*/
...
/*predefined hook declaration HOOK_START_UNIT #151*/
MELT_EXTERN void melthookproc_HOOK_START_UNIT();

/*predefined hook declaration HOOK_SYMBOL_IMPORTER #152*/
...
/*predefined hook declaration HOOK_VALUE_EXPORTER #153*/
...
/*** End of declaration file meltbuild-sources/generated/meltrunsup.h generated on 2016 May 04
