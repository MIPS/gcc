...
/* predefined class CLASS_SYSTEM_DATA index 34 */ enum
{
  ...
  MELTFIELD_SYSDATA_UNIT_STARTER = 18 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_UNIT_FINISHER = 19 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_OPTION_SET = 20 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_PASSEXEC_HOOK = 21 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_MELTPASS_AFTER_HOOK = 22 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_MELTPRAGMAS = 23 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_FINISHTYPE_HOOK = 24 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_FINISHDECL_HOOK = 25 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_ALL_PASSES_START_HOOK = 26 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_ALL_PASSES_END_HOOK = 27 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_ALL_IPA_PASSES_START_HOOK = 28 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_ALL_IPA_PASSES_END_HOOK = 29 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_EARLY_GIMPLE_PASSES_START_HOOK =
    30 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_EARLY_GIMPLE_PASSES_END_HOOK =
    31 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_INCHANNEL_DATA = 32 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_ALARM_HOOK = 33 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_CHILD_HOOK = 34 /*in CLASS_SYSTEM_DATA */ ,
  MELTFIELD_SYSDATA_SRC_LOC_FILE_DICT = 35 /*in CLASS_SYSTEM_DATA */ ,
...
/* declarations generated by generate_runtypesupport_predefined_hooks for 121 predefined */

/*predefined hook declaration HOOK_ALL_PASSES_START #106*/
MELT_EXTERN void melthookproc_HOOK_ALL_PASSES_START ();

/*predefined hook declaration HOOK_ALL_PASSES_END #107*/
MELT_EXTERN void melthookproc_HOOK_ALL_PASSES_END ();

/*predefined hook declaration HOOK_FINISH_UNIT #108*/
MELT_EXTERN void melthookproc_HOOK_FINISH_UNIT ();

/*predefined hook declaration HOOK_INTERN_KEYWORD #109*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_INTERN_KEYWORD (melt_ptr_t
							 meltin_KEYWV_p0);

/*predefined hook declaration HOOK_INTERN_SYMBOL #110*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_INTERN_SYMBOL (melt_ptr_t
							meltin_SYMBV_p0);

/*predefined hook declaration HOOK_LOW_DEBUG_VALUE_AT #111*/
...
/*predefined hook declaration HOOK_NAMED_KEYWORD #112*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_NAMED_KEYWORD (const char
							*meltin_NAM_p0,
							long
							meltin_CREATE_p1);

/*predefined hook declaration HOOK_NAMED_SYMBOL #113*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_NAMED_SYMBOL (const char
						       *meltin_NAM_p0,
						       long meltin_CREATE_p1);

/*predefined hook declaration HOOK_OVERRIDE_GATE #114*/
MELT_EXTERN void melthookproc_HOOK_OVERRIDE_GATE (long meltin_BEFOREGATE_p0,
						  long *meltout_AFTERGATE_o0);

/*predefined hook declaration HOOK_START_UNIT #115*/
MELT_EXTERN void melthookproc_HOOK_START_UNIT ();
/* end of declarations generated by generate_runtypesupport_predefined_hooks for 121 predefined */

/*** End of declaration file meltbuild-sources/generated/meltrunsup.h generated on 2013 May 23
