...
/* declarations generated by generate_runtypesupport_predefined_hooks for 133 predefined */
...
/*predefined hook declaration HOOK_FINISH_UNIT #112*/
MELT_EXTERN void melthookproc_HOOK_FINISH_UNIT ();

/*predefined hook declaration HOOK_GIMPLE_EXECUTE #113*/
MELT_EXTERN long melthookproc_HOOK_GIMPLE_EXECUTE ();

/*predefined hook declaration HOOK_GIMPLE_GATE #114*/
MELT_EXTERN long melthookproc_HOOK_GIMPLE_GATE ();

/*predefined hook declaration HOOK_INTERN_KEYWORD #115*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_INTERN_KEYWORD (melt_ptr_t
							 meltin_KEYWV_p0);

/*predefined hook declaration HOOK_INTERN_SYMBOL #116*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_INTERN_SYMBOL (melt_ptr_t
							meltin_SYMBV_p0);

/*predefined hook declaration HOOK_LOW_DEBUG_VALUE_AT #117*/
...
/*predefined hook declaration HOOK_NAMED_KEYWORD #118*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_NAMED_KEYWORD (const char
							*meltin_NAM_p0,
							long
							meltin_CREATE_p1);

/*predefined hook declaration HOOK_NAMED_SYMBOL #119*/
MELT_EXTERN melt_ptr_t melthookproc_HOOK_NAMED_SYMBOL (const char
						       *meltin_NAM_p0,
						       long meltin_CREATE_p1);

/*predefined hook declaration HOOK_OVERRIDE_GATE #120*/
MELT_EXTERN void melthookproc_HOOK_OVERRIDE_GATE (long meltin_BEFOREGATE_p0,
						  long *meltout_AFTERGATE_o0);

/*predefined hook declaration HOOK_PASS_EXECUTION #121*/
MELT_EXTERN void melthookproc_HOOK_PASS_EXECUTION (const char
						   *meltin_PASSNAME_p0,
						   long meltin_PASSNUM_p1);

/*predefined hook declaration HOOK_PRE_GENERICIZE #122*/
MELT_EXTERN void melthookproc_HOOK_PRE_GENERICIZE (tree meltin_TFNDECL_p0);

/*predefined hook declaration HOOK_RTL_EXECUTE #123*/
MELT_EXTERN long melthookproc_HOOK_RTL_EXECUTE ();

/*predefined hook declaration HOOK_RTL_GATE #124*/
MELT_EXTERN long melthookproc_HOOK_RTL_GATE ();

/*predefined hook declaration HOOK_SIMPLE_IPA_EXECUTE #125*/
MELT_EXTERN long melthookproc_HOOK_SIMPLE_IPA_EXECUTE ();

/*predefined hook declaration HOOK_SIMPLE_IPA_GATE #126*/
MELT_EXTERN long melthookproc_HOOK_SIMPLE_IPA_GATE ();

/*predefined hook declaration HOOK_START_UNIT #127*/
MELT_EXTERN void melthookproc_HOOK_START_UNIT ();
/* end of declarations generated by generate_runtypesupport_predefined_hooks for 133 predefined */

/*** End of declaration file meltbuild-sources/generated/meltrunsup.h generated on 2013 May 29
