 ...
 /*_#IS_MULTIPLE__L1*/ meltfnum[0] =
   ...
   /*_#IS_LIST__L3*/ meltfnum[2] =
	...
	/*_.NAMED_NAME__V13*/ meltfptr[12] = NULL;;
			...
			{
			  MELT_LOCATION
			    ("warmelt-base.melt:2993:/ cond.else");
			  ...
			  /*anyblock */
			  {
			    ...
			    {
			      /*^locexp */
			      melt_assert_failed (("invalid variadic argument to COMPLETE_SEQUENCE_AS_LIST"), ("warmelt-base.melt") ? ("warmelt-base.melt") : __FILE__, (2993) ? (2993) : __LINE__, __FUNCTION__);
			      ;
			    }
			    ;
...
{
  long
    current_blocklevel_signals_meltrout_29_WARMELTmiBASE_MELT_PREDEFINED_GET_melt
    = melt_blocklevel_signals;
...
/*anyblock*/
 ...
 /*_#IS_STRING__L1*/ meltfnum[0] =
      (melt_magic_discr ((melt_ptr_t) ( /*_.NAMV__V2*/ meltfptr[1])) ==
       MELTOBMAG_STRING);;
   ...
   /*_.PREDEFSTR_CHK__V4*/ meltfptr[3] =
	    ...
	    melt_fetch_predefined (melt_predefined_index_by_name
				   (melt_string_str
				    ((melt_ptr_t)
				     ( /*_.NAMV__V2*/ meltfptr[1]))));;
	  /*^compute */
	  /*_._IFELSE___V3*/ meltfptr[2] =
	    /*_.PREDEFSTR_CHK__V4*/ meltfptr[3];;
	  /*epilog */
   ...
   /*_#IS_A__L2*/ meltfnum[1] =
	    melt_is_instance_of ((melt_ptr_t) ( /*_.NAMV__V2*/ meltfptr[1]),
		...
		/*cond */ if (
		  ...
		  )		/*then */
		  {
		    ...
		    /*^getslot */
		    {
		      melt_ptr_t slot = NULL, obj = NULL;
		      obj =
			(melt_ptr_t) ( /*_.NAMV__V2*/ meltfptr[1]) /*=obj*/ ;
		      melt_object_get_field (slot, obj, 1, "NAMED_NAME");
     ...
     /*_#IS_INTEGERBOX__L3*/ meltfnum[2] =
		  (melt_magic_discr
		   ((melt_ptr_t) ( /*_.NAMV__V2*/ meltfptr[1])) ==
		   MELTOBMAG_INT);;
...
meltrout_30_WARMELTmiBASE_SYMBOL_CNAME (meltclosure_ptr_t meltclosp_,
					...
					union meltparam_un * meltxrestab_)
{
  long current_blocklevel_signals_meltrout_30_WARMELTmiBASE_SYMBOL_CNAME_melt
    = melt_blocklevel_signals;
...
/*anyblock*/
 ...
 /*_#IS_A__L1*/ meltfnum[0] =
      melt_is_instance_of ((melt_ptr_t) ( /*_.SY__V2*/ meltfptr[1]),
    ...
    /*_.CSYM_URANK__V7*/ meltfptr[6] = NULL;;
	  ...
	  /*apply */
	  {
	    ...
	    argtab[1].meltbp_aptr =
	      (melt_ptr_t *) & /*_.CSYM_URANK__V7*/ meltfptr[6];
	    /*_.ADD2OUT__V8*/ meltfptr[7] =
	      melt_apply ((meltclosure_ptr_t)
			  (( /*!ADD2OUT */ meltfrout->tabval[3])),
			  (melt_ptr_t) ( /*_.SBUF__V5*/ meltfptr[4]),
   ...
   /*_.STRBUF2STRING__V9*/ meltfptr[8] =
	    (meltgc_new_stringdup
	     ((meltobject_ptr_t)
	      ...
	      melt_strbuf_str ((melt_ptr_t) ( /*_.SBUF__V5*/ meltfptr[4]))));;
	  /*^compute */
		...
		/*cond */ if (
		  ...
		  )		/*then */
		  {
		    ...
		    /*^getslot */
		    {
		      melt_ptr_t slot = NULL, obj = NULL;
		      obj =
			(melt_ptr_t) ( /*_.SY__V2*/ meltfptr[1]) /*=obj*/ ;
		      melt_object_get_field (slot, obj, 1, "NAMED_NAME");
       ...
       /*_.SBUF__V17*/ meltfptr[7] =
			...
			)	/*then */
			{
			  ...
			  /*^getslot */
			  {
			    melt_ptr_t slot = NULL, obj = NULL;
			    obj =
			      (melt_ptr_t) ( /*_.SY__V2*/ meltfptr[1])
			      /*=obj*/ ;
...
meltlabend_rout:
  ...
  MELT_TRACE_EXIT_LOCATION ();
  melt_blocklevel_signals =
    current_blocklevel_signals_meltrout_30_WARMELTmiBASE_SYMBOL_CNAME_melt;
  melt_topframe = (struct melt_callframe_st *) meltfram__.mcfr_prev;
  return (melt_ptr_t) ( /*_._RETVAL___V1*/ meltfptr[0]);
#undef meltcallcount
#undef meltfram__
