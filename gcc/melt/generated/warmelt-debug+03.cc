/* GCC MELT GENERATED C++ FILE warmelt-debug+03.cc - DO NOT EDIT - see http://gcc-melt.org/ */
...
/**** warmelt-debug+03.cc declarations ****/
...
class Melt_InitialClassyFrame_WARMELTmiDEBUG_h969425190; // forward declaration fromline 6588
typedef Melt_InitialClassyFrame_WARMELTmiDEBUG_h969425190 Melt_InitialFrame;
...
typedef Melt_InitialClassyFrame_WARMELTmiDEBUG_h969425190 /*opaqueinitialclassy*/ meltinitial_frame_t;
...
/**** warmelt-debug+03.cc implementations ****/




melt_ptr_t MELT_MODULE_VISIBILITY
meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE(meltclosure_ptr_t meltclosp_, melt_ptr_t meltfirstargp_, const melt_argdescr_cell_t meltxargdescr_[], union meltparam_un *meltxargtab_,
...
//// emitted by output_curframe_declstruct_init using OUTPUT_CURFRAME_DECLSTRUCT @warmelt-outobj.melt:1501
    ...
    /* start of frame for routine meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE fromline 1715 */

    /** start of frame for meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE of CLASS_PROCROUTINEOBJ from 1518**/

    /*curframdeclclassy*/ class MeltFrame_meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE// fromline 1531
    ...
    public: /* fromline 1535*/
        ...
        MeltFrame_meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE(meltclosure_ptr_t clos) //the closure constructor fromline 1593
        ...
        MeltFrame_meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE() //the constructor fromline 1605
            : Melt_CallFrameWithValues<8> (
        ...
        MeltFrame_meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE(const char*fil, int lin) //the constructor fromline 1619
            : Melt_CallFrameWithValues<8> (fil,lin, sizeof(MeltFrame_meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE)) {};
        MeltFrame_meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE(const char*fil, int lin, meltclosure_ptr_t clos) //the closure constructor fromline 1624
    ...
    /** end of frame for meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE fromline 1660**/

    /* end of frame for routine meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE fromline 1719 */

    /* classy proc frame meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE */
    MeltFrame_meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE
    meltfram__ /*declfrastruct fromline 1743*/
    /*classyprocarg meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE fromline 1748*/
#if ENABLE_CHECKING
...
#define meltframe meltfram__
    ...
    /*getarg#0*/
    MELT_LOCATION("warmelt-debug.melt:1602:/ getarg");
    /*_.VAL__V2*/
    meltfptr[1] = (melt_ptr_t) meltfirstargp_;

    /*getarg#1*/
    /*^getarg*/
    if (meltxargdescr_[0] != MELTBPAR_CSTRING) goto meltlab_endgetargs;
    /*_?*/
...
meltlab_endgetargs:
    ...
    /*anyblock*/
    {
        ...
        MELT_LOCATION("warmelt-debug.melt:1604:/ quasiblock");
        ...
        /*_.SBUF__V3*/
        meltfptr[2] =
            (melt_ptr_t) meltgc_new_strbuf((meltobject_ptr_t)((/*!DISCR_STRBUF*/ meltfrout->tabval[0])), (const char*)0);;
        /*^compute*/
        /*_.OCCMAP__V4*/
        meltfptr[3] =
            (meltgc_new_mapobjects( (meltobject_ptr_t) ((/*!DISCR_MAP_OBJECTS*/ meltfrout->tabval[1])), (50)));;
        /*^compute*/
        /*_.BOXEDMAXDEPTH__V5*/
        meltfptr[4] =
            (meltgc_new_int((meltobject_ptr_t)((/*!DISCR_INTEGER*/ meltfrout->tabval[2])), (14)));;

        MELT_CHECK_SIGNAL();
        ;
        MELT_LOCATION("warmelt-debug.melt:1608:/ quasiblock");
        ...
        {
            melt_ptr_t newobj = 0;
            melt_raw_object_create(newobj,(melt_ptr_t)((/*!CLASS_DEBUG_OUTPUT_INFORMATION*/ meltfrout->tabval[3])), (3), "CLASS_DEBUG_OUTPUT_INFORMATION");
            /*_.INST__V7*/
            meltfptr[6] =
                newobj;
        };
        ...
        /*^putslot*/
        /*putslot*/
        melt_assertmsg("checkobj putslot  _ @DBGI_OUT", melt_magic_discr((melt_ptr_t)(/*_.INST__V7*/ meltfptr[6])) == MELTOBMAG_OBJECT);
        melt_putfield_object((/*_.INST__V7*/ meltfptr[6]), (0), (/*_.SBUF__V3*/ meltfptr[2]), "DBGI_OUT");
        ;
        /*^putslot*/
        /*putslot*/
        melt_assertmsg("checkobj putslot  _ @DBGI_OCCMAP", melt_magic_discr((melt_ptr_t)(/*_.INST__V7*/ meltfptr[6])) == MELTOBMAG_OBJECT);
        melt_putfield_object((/*_.INST__V7*/ meltfptr[6]), (1), (/*_.OCCMAP__V4*/ meltfptr[3]), "DBGI_OCCMAP");
        ;
        /*^putslot*/
        /*putslot*/
        melt_assertmsg("checkobj putslot  _ @DBGI_MAXDEPTH", melt_magic_discr((melt_ptr_t)(/*_.INST__V7*/ meltfptr[6])) == MELTOBMAG_OBJECT);
        melt_putfield_object((/*_.INST__V7*/ meltfptr[6]), (2), (/*_.BOXEDMAXDEPTH__V5*/ meltfptr[4]), "DBGI_MAXDEPTH");
        ;
        /*^touchobj*/

        melt_dbgtrace_written_object (/*_.INST__V7*/ meltfptr[6], "newly made instance");
        ;
        /*_.DBGI__V6*/
        meltfptr[5] = /*_.INST__V7*/ meltfptr[6];;

        {
            MELT_LOCATION("warmelt-debug.melt:1613:/ locexp");
            /*_#DBGCOUNTER__L2*/
            meltfnum[1]= ++melt_dbgcounter;
        }
        ;

        {
            MELT_LOCATION("warmelt-debug.melt:1614:/ locexp");
            melt_putnum(stderr,( "!*!#"), (/*_#DBGCOUNTER__L2*/ meltfnum[1]), ( "/"));
        }
        ;
        /*_#THE_FRAMEDEPTH__L3*/
        meltfnum[2] =
            (melt_curframdepth());;
        /*^compute*/
        /*_#miI__L4*/
        ...
        {
            MELT_LOCATION("warmelt-debug.melt:1615:/ locexp");
            melt_putnum(stderr,( ""), (/*_#miI__L4*/ meltfnum[3]), ( ":"));
        }
        ;

        {
            MELT_LOCATION("warmelt-debug.melt:1616:/ locexp");
        ...
        MELT_LOCATION("warmelt-debug.melt:1617:/ cond");
        /*cond*/
        ...
        MELT_CHECK_SIGNAL();
        ;
        MELT_LOCATION("warmelt-debug.melt:1618:/ msend");
        /*msend*/
        {
            ...
            /*_.DBG_OUTPUT__V8*/
            meltfptr[7] = meltgc_send((melt_ptr_t)(/*_.VAL__V2*/ meltfptr[1]), (melt_ptr_t)((/*!DBG_OUTPUT*/ meltfrout->tabval[4])), (MELTBPARSTR_PTR MELTBPARSTR_LONG ""), argtab, "", (union meltparam_un*)0);
        }
        ;

        {
            MELT_LOCATION("warmelt-debug.melt:1619:/ locexp");
            melt_putstrbuf(stderr,(melt_ptr_t)(/*_.SBUF__V3*/ meltfptr[2]));
        }
        ;

        {
            MELT_LOCATION("warmelt-debug.melt:1620:/ locexp");
            melt_newlineflush(stderr);
        }
        ;

        MELT_LOCATION("warmelt-debug.melt:1604:/ clear");
        /*clear*/ /*_#DBGCOUNTER__L2*/
        meltfnum[1] = 0 ;
        /*^clear*/
        /*clear*/ /*_.SBUF__V3*/
        meltfptr[2] = 0 ;
        ...
        meltfptr[3] = 0 ;
        /*^clear*/
        /*clear*/ /*_.BOXEDMAXDEPTH__V5*/
        meltfptr[4] = 0 ;
        /*^clear*/
        /*clear*/ /*_.DBGI__V6*/
        meltfptr[5] = 0 ;
        /*^clear*/
        /*clear*/ /*_#THE_FRAMEDEPTH__L3*/
        meltfnum[2] = 0 ;
        /*^clear*/
        /*clear*/ /*_#miI__L4*/
        meltfnum[3] = 0 ;
...
meltlabend_rout:
    ...
    melt_blocklevel_signals = current_blocklevel_signals_meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE_melt;
    return (melt_ptr_t)(/*noretval*/ NULL);
#undef meltcallcount
#undef meltfram__
#undef MELTFRAM_NBVARNUM
#undef MELTFRAM_NBVARPTR
} /*end meltrout_55_WARMELTmiDEBUG_DISPLAY_DEBUG_MESSAGE*/
