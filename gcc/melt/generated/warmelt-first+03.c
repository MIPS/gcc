...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:4234:/ getarg");
...
/*anyblock*/
  {
   ...
   /*_.BND__V17*/ meltfptr[15] =
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:4234:/ locexp");
...
/*anyblock*/
 ...
 /*_.PROCLIST__V9*/ meltfptr[8] =
    ...
    MELT_LOCATION ("warmelt-first.melt:4262:/ loop");
    /*loop */
    {
	...
	/*cond */ if ( /*_.BND__V18*/ meltfptr[17])	/*then */
	  {
	    ...
	    /*anyblock */
	    {
	      ...
	      MELT_LOCATION ("warmelt-first.melt:4269:/ putxtraresult");
...
/*anyblock*/
 ...
 /*_#NOT__L5*/ meltfnum[4] =
  ...
  /*_.BINDMAP__V12*/ meltfptr[10] = slot;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:4286:/ getslot");
    {
      melt_ptr_t slot = NULL, obj = NULL;
 ...
 /*_#NOT__L8*/ meltfnum[7] =
	...
	/*anyblock */
	{
	  ...
	  ;
	  MELT_LOCATION ("warmelt-first.melt:4289:/ quasiblock");
   ...
   /*_#IS_OBJECT__L10*/ meltfnum[8] =
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:4293:/ locexp");
...
/*anyblock*/
  ...
  /*_.BINDERV__V9*/ meltfptr[8] = slot;
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-first.melt:4305:/ loop");
    /*loop */
    {
   ...
   /*_.OLDBINDING__V18*/ meltfptr[16] =
	...
	MELT_LOCATION ("warmelt-first.melt:4315:/ getslot");
	{
	  melt_ptr_t slot = NULL, obj = NULL;
	  obj = (melt_ptr_t) ( /*_.ENV__V2*/ meltfptr[1]) /*=obj*/ ;
	  melt_object_get_field (slot, obj, 1, "ENV_PREV");
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:4330:/ getarg");
...
/*anyblock*/
 ...
 /*_#NOT__L2*/ meltfnum[1] =
   ...
   /*_.DISCRIM__V5*/ meltfptr[4] =
	  ...
	  MELT_LOCATION ("warmelt-first.melt:4335:/ getslot");
	  {
	    melt_ptr_t slot = NULL, obj = NULL;
...
/* we warned when secondary results are expected but not returned. */
  ...
  /*_.IF___V4*/ meltfptr[3] = NULL;;
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-first.melt:4338:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_A__L3*/ meltfnum[2] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:4338:/ cond.else");
 ...
 /*_#IS_A__L4*/ meltfnum[2] =
   ...
   /*_#MAPOBJECT_COUNT__L5*/ meltfnum[4] =
	  ...
	  {
	    MELT_LOCATION ("warmelt-first.melt:4343:/ locexp");
	...
	/*anyblock */
	{
	  ...
	  MELT_LOCATION ("warmelt-first.melt:4346:/ quasiblock");
   ...
   /*_.CURMENVDISCR__V13*/ meltfptr[5] =
	  ...
	  MELT_LOCATION ("warmelt-first.melt:4348:/ getslot");
	  {
	    melt_ptr_t slot = NULL, obj = NULL;
	    obj =
...
/*anyblock*/
  {
    ...
    MELT_LOCATION ("warmelt-first.melt:4386:/ cond");
    /*cond */ if (
		   /*ifisa */
		   melt_is_instance_of ((melt_ptr_t)
  ...
  /*_.REFERENCED_VALUE__V2*/ meltfptr[1] = NULL;;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:4384:/ quasiblock");
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:4738:/ getarg");
...
/*anyblock*/
  {
    ...
    MELT_LOCATION ("warmelt-first.melt:4739:/ quasiblock");
 ...
 /*_#IS_CLOSURE__L3*/ meltfnum[2] =
      (melt_magic_discr ((melt_ptr_t) ( /*_.DBGMSGFUN__V4*/ meltfptr[3])) ==
       MELTOBMAG_CLOSURE);;
    MELT_LOCATION ("warmelt-first.melt:4740:/ cond");
	...
	/*anyblock */
	{
	  ...
	  MELT_CHECK_SIGNAL ();
	  ;
	  MELT_LOCATION ("warmelt-first.melt:4741:/ apply");
	  /*apply */
	  {
	  ...
	  MELT_LOCATION ("warmelt-first.melt:4740:/ clear");
  ...
  /*_.IF___V5*/ meltfptr[4] = NULL;;
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:4738:/ locexp");
      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
      if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	melt_warn_for_no_expected_secondary_results ();
