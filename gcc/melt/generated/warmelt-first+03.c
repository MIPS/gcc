...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:4235:/ getarg");
...
/*anyblock*/
  {
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-first.melt:4238:/ loop");
    /*loop */
    {
   ...
   /*_.BND__V17*/ meltfptr[15] =
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:4235:/ locexp");
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:4257:/ getarg");
 /*_.ENV__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
...
/*anyblock*/
 ...
 /*_.PROCLIST__V9*/ meltfptr[8] =
    ...
    MELT_LOCATION ("warmelt-first.melt:4263:/ loop");
    /*loop */
    {
   ...
   /*_.BND__V18*/ meltfptr[17] =
	...
	/*cond */ if ( /*_.BND__V18*/ meltfptr[17])	/*then */
	  {
	    ...
	    /*anyblock */
	    {
	      ...
	      MELT_LOCATION ("warmelt-first.melt:4270:/ putxtraresult");
	...
	;
	MELT_LOCATION ("warmelt-first.melt:4272:/ getslot");
	{
	  melt_ptr_t slot = NULL, obj = NULL;
	  obj = (melt_ptr_t) ( /*_.ENV__V2*/ meltfptr[1]) /*=obj*/ ;
	  melt_object_get_field (slot, obj, 1, "ENV_PREV");
...
/*anyblock*/
 ...
 /*_#NOT__L8*/ meltfnum[7] =
	...
	/*anyblock */
	{
	  ...
	  {
	    MELT_LOCATION ("warmelt-first.melt:4291:/ locexp");
...
/*anyblock*/
  ...
  /*_.BINDERV__V9*/ meltfptr[8] = slot;
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-first.melt:4305:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_OBJECT__L3*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:4305:/ cond.else");
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-first.melt:4306:/ loop");
    /*loop */
    {
...
#endif /*MELT_HAVE_DEBUG */
	;
	MELT_LOCATION ("warmelt-first.melt:4310:/ quasiblock");
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:4331:/ getarg");
...
/*anyblock*/
 ...
 /*_#NOT__L2*/ meltfnum[1] =
   ...
   /*_.DISCRIM__V5*/ meltfptr[4] =
	  ...
	  MELT_LOCATION ("warmelt-first.melt:4336:/ getslot");
	  {
	    melt_ptr_t slot = NULL, obj = NULL;
   ...
   /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
	  ...
	  {
	    MELT_LOCATION ("warmelt-first.melt:4337:/ locexp");
	    /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
	    if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	      melt_warn_for_no_expected_secondary_results ();
  ...
  /*_.IF___V4*/ meltfptr[3] = NULL;;
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-first.melt:4339:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_A__L3*/ meltfnum[2] =
	melt_is_instance_of ((melt_ptr_t)
			     ...
			     (melt_ptr_t) (( /*!CLASS_REFERENCE */ meltfrout->
					    tabval[1])));;
      MELT_LOCATION ("warmelt-first.melt:4339:/ cond");
	...
	{
	  MELT_LOCATION ("warmelt-first.melt:4339:/ cond.else");
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-first.melt:4340:/ quasiblock");
 ...
 /*_#IS_A__L4*/ meltfnum[2] =
   ...
   /*_#MAPOBJECT_COUNT__L5*/ meltfnum[4] =
	...
	;
      ...
      {
	MELT_LOCATION ("warmelt-first.melt:4341:/ cond.else");
...
meltlab_endgetargs:;
/*body*/
  MELT_LOCATION ("warmelt-first.melt:4380:/ block");
/*anyblock*/
  {
  ...
  /*_.REFERENCED_VALUE__V2*/ meltfptr[1] = NULL;;
    ...
    ;
    MELT_LOCATION ("warmelt-first.melt:4380:/ quasiblock");
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-first.melt:4739:/ getarg");
...
/*anyblock*/
  {
    ...
    MELT_LOCATION ("warmelt-first.melt:4740:/ quasiblock");
 ...
 /*_#IS_CLOSURE__L3*/ meltfnum[2] =
      (melt_magic_discr ((melt_ptr_t) ( /*_.DBGMSGFUN__V4*/ meltfptr[3])) ==
       MELTOBMAG_CLOSURE);;
    MELT_LOCATION ("warmelt-first.melt:4741:/ cond");
	...
	/*anyblock */
	{
	  ...
	  MELT_CHECK_SIGNAL ();
	  ;
	  MELT_LOCATION ("warmelt-first.melt:4742:/ apply");
	  /*apply */
	  {
	  ...
	  MELT_LOCATION ("warmelt-first.melt:4741:/ clear");
  ...
  /*_.IF___V5*/ meltfptr[4] = NULL;;
    ...
    {
      MELT_LOCATION ("warmelt-first.melt:4739:/ locexp");
      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
      if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	melt_warn_for_no_expected_secondary_results ();
