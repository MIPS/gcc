...
class Melt_InitialClassyFrame_WARMELTmiHOOKS_h319183813; // forward declaration fromline 6541
...
typedef Melt_InitialClassyFrame_WARMELTmiHOOKS_h319183813 /*opaqueinitialclassy*/ meltinitial_frame_t;
