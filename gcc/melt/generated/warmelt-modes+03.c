...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4249:/ getarg");
...
/*anyblock*/
 ...
 /*_.CUREAD__V4*/ meltfptr[3] =
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-modes.melt:4253:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_LIST__L1*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-modes.melt:4253:/ cond.else");
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-modes.melt:4254:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#MELT_NEED_DBG__L3*/ meltfnum[0] =
    ...
    MELT_CHECK_SIGNAL ();
    ;
    MELT_LOCATION ("warmelt-modes.melt:4256:/ apply");
    /*apply */
    {
    ...
    {
      MELT_LOCATION ("warmelt-modes.melt:4249:/ locexp");
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4285:/ getarg");
 ...
 /*_#IS_STRING__L3*/ meltfnum[0] =
   ...
   /*_#IS_STRING__L4*/ meltfnum[1] =
     ...
     /*_.MAKE_STRING_NAKEDBASENAME__V16*/ meltfptr[15] =
		...
		;
		MELT_LOCATION ("warmelt-modes.melt:4309:/ quasiblock");
   ...
   /*_#MELT_NEED_DBG__L5*/ meltfnum[1] =
      ...
      /*cond */ if ( /*_#MELT_NEED_DBG__L5*/ meltfnum[1])	/*then */
	{
     ...
     /*_#THE_MELTCALLCOUNT__L6*/ meltfnum[5] =
	    ...
	    MELT_CHECK_SIGNAL ();
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4312:/ apply");
	    /*apply */
	    {
...
/* we warned when secondary results are expected but not returned. */
 ...
 /*_#IS_STRING__L12*/ meltfnum[10] =
   ...
   /*_.READ_FILE__V27*/ meltfptr[24] =
	  ...
	  MELT_CHECK_SIGNAL ();
	  ;
	  MELT_LOCATION ("warmelt-modes.melt:4323:/ apply");
	  /*apply */
	  {
	    union meltparam_un argtab[1];
	    memset (&argtab, 0, sizeof (argtab));
   ...
   /*_#IS_LIST__L13*/ meltfnum[8] =
	  ...
	  /*cond */ if ( /*_#IS_LIST__L13*/ meltfnum[8])	/*then */
		...
		MELT_CHECK_SIGNAL ();
		;
		MELT_LOCATION ("warmelt-modes.melt:4325:/ apply");
		/*apply */
		{
		  union meltparam_un argtab[1];
		  memset (&argtab, 0, sizeof (argtab));
   ...
   /*_#MELT_NEED_DBG__L14*/ meltfnum[9] =
      ...
      /*cond */ if ( /*_#MELT_NEED_DBG__L14*/ meltfnum[9])	/*then */
	{
     ...
     /*_#THE_MELTCALLCOUNT__L15*/ meltfnum[8] =
	    ...
	    MELT_CHECK_SIGNAL ();
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4335:/ apply");
	    /*apply */
	    {
	      union meltparam_un argtab[5];
	      memset (&argtab, 0, sizeof (argtab));
 ...
 /*_#IS_MULTIPLE__L16*/ meltfnum[8] =
	...
	/*_#THE_MELTCALLCOUNT__L19*/ meltfnum[18] =
			...
			MELT_CHECK_SIGNAL ();
			;
			MELT_LOCATION ("warmelt-modes.melt:4350:/ apply");
			/*apply */
			{
	...
	/*_#THE_MELTCALLCOUNT__L21*/ meltfnum[17] =
			...
			MELT_CHECK_SIGNAL ();
			;
			MELT_LOCATION ("warmelt-modes.melt:4353:/ apply");
			/*apply */
			{
			  union meltparam_un argtab[9];
			  memset (&argtab, 0, sizeof (argtab));
   ...
   /*_#IS_STRING__L22*/ meltfnum[17] =
	 ...
	 /*_#THE_MELTCALLCOUNT__L24*/ meltfnum[23] =
			...
			MELT_CHECK_SIGNAL ();
			;
			MELT_LOCATION ("warmelt-modes.melt:4358:/ apply");
			/*apply */
			{
			  union meltparam_un argtab[9];
			  memset (&argtab, 0, sizeof (argtab));
	...
	/*_.IF___V52*/ meltfptr[51] = NULL;;
	 ...
	 /*_#THE_MELTCALLCOUNT__L26*/ meltfnum[18] =
			...
			MELT_CHECK_SIGNAL ();
			;
			MELT_LOCATION ("warmelt-modes.melt:4361:/ apply");
			/*apply */
			{
			  union meltparam_un argtab[9];
			  memset (&argtab, 0, sizeof (argtab));
	...
	/*_.IF___V56*/ meltfptr[52] = NULL;;
...
#if MELT_HAVE_DEBUG
		MELT_LOCATION ("warmelt-modes.melt:4365:/ cppif.then");
		/*^block */
		/*anyblock */
		{
	 ...
	 /*_#THE_MELTCALLCOUNT__L28*/ meltfnum[23] =
			...
			MELT_CHECK_SIGNAL ();
			;
			MELT_LOCATION ("warmelt-modes.melt:4365:/ apply");
			/*apply */
			{
			  union meltparam_un argtab[5];
			  memset (&argtab, 0, sizeof (argtab));
	...
	/*_.IF___V61*/ meltfptr[47] = NULL;;
		...
		/*anyblock */
		{
		  ...
		  /*cond */ if (( /*nil */ NULL))	/*then */
			...
			{
			  /*^locexp */
			  melt_assert_failed (("translateinitmodule_flavored bad flavor"), ("warmelt-modes.melt") ? ("warmelt-modes.melt") : __FILE__, (4367) ? (4367) : __LINE__, __FUNCTION__);
			  ;
			}
			;
    ...
    MELT_LOCATION ("warmelt-modes.melt:4285:/ quasiblock");


    /*_.RETVAL___V1*/ meltfptr[0] = /*_.LET___V3*/ meltfptr[2];;

    {
      MELT_LOCATION ("warmelt-modes.melt:4285:/ locexp");
      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
      if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	melt_warn_for_no_expected_secondary_results ();
...
/*anyblock*/
  {
    ...
    {
      MELT_LOCATION ("warmelt-modes.melt:4327:/ locexp");
      inform (UNKNOWN_LOCATION, "MELT INFORM [#%ld]: %s - %s",
	      melt_dbgcounter, ("reading from file"),
	      melt_string_str ((melt_ptr_t) ( /*_.CURARG__V2*/ meltfptr[1])));
    }
 ...
 /*_.CUREAD__V4*/ meltfptr[3] =
   ...
   /*_#IS_LIST__L1*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-modes.melt:4330:/ cond.else");
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-modes.melt:4332:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#MELT_NEED_DBG__L3*/ meltfnum[0] =
      ...
      /*cond */ if ( /*_#MELT_NEED_DBG__L3*/ meltfnum[0])	/*then */
	{
     ...
     /*_#THE_MELTCALLCOUNT__L4*/ meltfnum[3] =
	    ...
	    MELT_CHECK_SIGNAL ();
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4332:/ apply");
	    /*apply */
	    {
	      union meltparam_un argtab[5];
	      memset (&argtab, 0, sizeof (argtab));
    ...
    MELT_CHECK_SIGNAL ();
    ;
    MELT_LOCATION ("warmelt-modes.melt:4333:/ apply");
    /*apply */
    {
      union meltparam_un argtab[1];
      memset (&argtab, 0, sizeof (argtab));
...
/*anyblock*/
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-modes.melt:4377:/ blockmultialloc");
    /*multiallocblock */
    {
 ...
 /*_.TUPLREC___V9*/ meltfptr[5] =
	...
	(meltobject_ptr_t) (((melt_ptr_t) (MELT_PREDEF (DISCR_MULTIPLE))));
      ...
      /*^putuple */
      /*putupl#4 */
      melt_assertmsg ("putupl [:4377] #4 checktup",
		      melt_magic_discr ((melt_ptr_t)
					( /*_.TUPLREC___V9*/ meltfptr[5])) ==
		      MELTOBMAG_MULTIPLE);
      melt_assertmsg ("putupl [:4377] #4 checkoff",
		      (0 >= 0
		       && 0 <
	...
	(melt_ptr_t) (( /*!konst_3 */ meltfrout->tabval[3]));
      ...
      /*^putuple */
      /*putupl#5 */
      melt_assertmsg ("putupl [:4377] #5 checktup",
		      melt_magic_discr ((melt_ptr_t)
					( /*_.TUPLREC___V9*/ meltfptr[5])) ==
		      MELTOBMAG_MULTIPLE);
      melt_assertmsg ("putupl [:4377] #5 checkoff",
		      (1 >= 0
		       && 1 <
		       melt_multiple_length ((melt_ptr_t)
					     ( /*_.TUPLREC___V9*/
	...
	(melt_ptr_t) (( /*!konst_4 */ meltfrout->tabval[4]));
      ...
      /*^putuple */
      /*putupl#6 */
      melt_assertmsg ("putupl [:4377] #6 checktup",
		      melt_magic_discr ((melt_ptr_t)
					( /*_.TUPLREC___V9*/ meltfptr[5])) ==
		      MELTOBMAG_MULTIPLE);
      melt_assertmsg ("putupl [:4377] #6 checkoff",
		      (2 >= 0
		       && 2 <
		       melt_multiple_length ((melt_ptr_t)
					     ( /*_.TUPLREC___V9*/
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4394:/ getarg");
 /*_.CMD__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
...
/*anyblock*/
  {
   ...
   /*_#MELT_NEED_DBG__L1*/ meltfnum[0] =
    ...
    {
      MELT_LOCATION ("warmelt-modes.melt:4394:/ locexp");
      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
      if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	melt_warn_for_no_expected_secondary_results ();
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4412:/ getarg");
 /*_.CMD__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4430:/ getarg");
 /*_.CMD__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
...
/*anyblock*/
  {
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-modes.melt:4431:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#MELT_NEED_DBG__L1*/ meltfnum[0] =
    ...
    MELT_CHECK_SIGNAL ();
    ;
    MELT_LOCATION ("warmelt-modes.melt:4430:/ quasiblock");
...
meltlab_endgetargs:;
/*body*/
  MELT_LOCATION ("warmelt-modes.melt:4507:/ block");
/*anyblock*/
  {
...
/* we warned when secondary results are expected but not returned. */
    ...
    ;
    MELT_LOCATION ("warmelt-modes.melt:4514:/ loop");
    /*loop */
    {
   ...
   /*_#BUCKETLONG_COUNT__L5*/ meltfnum[1] =
	...
	/*cond */ if ( /*_#BUCKETLONG_COUNT__L5*/ meltfnum[1])	/*then */
	  ...
	  {
	    MELT_LOCATION ("warmelt-modes.melt:4520:/ cond.else");
	...
	/*_.ALARMH_PERIOD__V37*/ meltfptr[36] = NULL;;
	 ...
	 /*_.BUCKETLONG_PUT__V39*/ meltfptr[38] =
			    meltgc_longsbucket_put ((melt_ptr_t)
						    ...
						    /*_.NEXTALHD__V19*/
						    meltfptr[18]);;
			  MELT_LOCATION ("warmelt-modes.melt:4538:/ compute");
	...
	/*cond */ if ( /*_.REFERENCED_VALUE__V41*/ meltfptr[38])	/*then */
	  {
		...
		)		/*then */
		{
	      ...
	      ;
	      MELT_LOCATION ("warmelt-modes.melt:4543:/ again");
	      /*again */
	      {
...
meltlab_endgetargs:;
/*body*/
  MELT_LOCATION ("warmelt-modes.melt:4519:/ block");
/*anyblock*/
  {
   ...
   /*_#I__L5*/ meltfnum[1] =
	...
	/*_#I__L10*/ meltfnum[9] =
       ...
       /*_#FIRSTDELAY__L9*/ meltfnum[8] = 0;;
		  ...
		  ;
		  MELT_LOCATION ("warmelt-modes.melt:4592:/ compute");
...
/* we warned when secondary results are expected but not returned. */
    ...
    /*citerblock BLOCK_SIGNALS */
    {
      ...
      MELT_LOCATION ("warmelt-modes.melt:4606:/ quasiblock");
   ...
   /*_#__L8*/ meltfnum[6] =
     ...
     /*_.BUCKETLONG_PUT__V24*/ meltfptr[23] =
		    meltgc_longsbucket_put ((melt_ptr_t) /*_.NEWBUCK__V16*/
					    ...
					    meltfptr[17]);;
		  MELT_LOCATION ("warmelt-modes.melt:4622:/ compute");
		  /*_.NEWBUCK__V16*/ meltfptr[11] =
...
meltlab_endgetargs:;
/*body*/
  MELT_LOCATION ("warmelt-modes.melt:4632:/ block");
/*anyblock*/
  {
  ...
  /*_.CHPH__V19*/ meltfptr[10] = NULL;
	for (meltcit2__EACHBUCKLONG_ix = 0;
     ...
     /*_#IS_A__L9*/ meltfnum[5] =
		...
		{
		  MELT_LOCATION ("warmelt-modes.melt:4655:/ cond.else");
   ...
   /*_.BUCKETLONG_REMOVE__V40*/ meltfptr[36] =
...
#if MELT_HAVE_DEBUG
		      MELT_LOCATION ("warmelt-modes.melt:4722:/ cppif.then");
		      /*^block */
		      /*anyblock */
		      {
	...
	/*_#MELT_NEED_DBG__L22*/ meltfnum[18] =
	 ...
	 /*_.IF___V45*/ meltfptr[44] = NULL;;
			...
			;
			MELT_LOCATION
			  ("warmelt-modes.melt:4722:/ quasiblock");
	...
	/*_#MELT_NEED_DBG__L24*/ meltfnum[22] =
	 ...
	 /*_.IF___V51*/ meltfptr[44] = NULL;;
			...
			;
			MELT_LOCATION
			  ("warmelt-modes.melt:4728:/ quasiblock");
	...
	/*_#MELT_NEED_DBG__L26*/ meltfnum[18] =
	 ...
	 /*_.IF___V59*/ meltfptr[45] = NULL;;
			...
			;
			MELT_LOCATION
			  ("warmelt-modes.melt:4735:/ quasiblock");
 ...
 /*_#IS_CLOSURE__L4*/ meltfnum[2] =
   ...
   /*_#I__L5*/ meltfnum[1] =
     ...
     /*_#PIDISBAD__L6*/ meltfnum[5] = 0;;
		...
		{
		  MELT_LOCATION ("warmelt-modes.melt:4751:/ locexp");
	...
	/*_.IF___V12*/ meltfptr[11] = NULL;;
		  ...
		  ;
		  MELT_LOCATION ("warmelt-modes.melt:4755:/ quasiblock");
	...
	/*_.REFERENCED_VALUE__V25*/ meltfptr[21] = slot;
       ...
       /*_.REFERENCED_VALUE__V25*/ meltfptr[21] = NULL;;
		  ...
		  /*cond */ if ( /*_.REFERENCED_VALUE__V25*/ meltfptr[21])	/*then */
		    ...
		    {
		      MELT_LOCATION ("warmelt-modes.melt:4766:/ cond.else");
	...
	/*_#IS_BUCKETLONG__L11*/ meltfnum[6] =
      ...
      /*_.BUCKETLONG_PUT__V30*/ meltfptr[28] =
		    meltgc_longsbucket_put ((melt_ptr_t) /*_.BUCK__V26*/
					    ...
					    (melt_ptr_t) /*_.CHPH__V19*/
					    meltfptr[18]);;
		  MELT_LOCATION ("warmelt-modes.melt:4770:/ compute");
		  /*_.BUCK__V26*/ meltfptr[22] =
		...
		MELT_CHECK_SIGNAL ();
		;
		MELT_LOCATION ("warmelt-modes.melt:4776:/ quasiblock");


		/*_.RETVAL___V1*/ meltfptr[0] = /*_.CHPH__V19*/ meltfptr[18];;

		{
		  MELT_LOCATION ("warmelt-modes.melt:4776:/ locexp");
		  /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
		  if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
		    melt_warn_for_no_expected_secondary_results ();
...
/*anyblock*/
  {
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-modes.melt:4786:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#MELT_NEED_DBG__L1*/ meltfnum[0] =
...
#endif /*MELT_HAVE_DEBUG */
	;;
      MELT_LOCATION ("warmelt-modes.melt:4786:/ cond");
      /*cond */ if ( /*_#MELT_NEED_DBG__L1*/ meltfnum[0])	/*then */
	{
	  /*^cond.then */
	  /*^block */
	...
	{
	  MELT_LOCATION ("warmelt-modes.melt:4787:/ cond.else");
	  ...
	  /*anyblock */
	  {
	    ...
	    {
	      /*^locexp */
	      melt_assert_failed (("@$@unimplemented unregister_child_process_handler"), ("warmelt-modes.melt") ? ("warmelt-modes.melt") : __FILE__, (4787) ? (4787) : __LINE__, __FUNCTION__);
	      ;
	    }
	    ;
