...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4297:/ getarg");
...
/*anyblock*/
  {
    ...
    {
      MELT_LOCATION ("warmelt-modes.melt:4298:/ locexp");
    ...
    ;
    MELT_LOCATION ("warmelt-modes.melt:4299:/ quasiblock");
 ...
 /*_.CUREAD__V4*/ meltfptr[3] =
   ...
   /*_#IS_LIST_OR_NULL__L2*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-modes.melt:4302:/ cond.else");
   ...
   /*_#MELT_NEED_DBG__L3*/ meltfnum[0] =
      ...
      /*cond */ if ( /*_#MELT_NEED_DBG__L3*/ meltfnum[0])	/*then */
	{
     ...
     /*_#MELT_CALLCOUNT__L4*/ meltfnum[3] =
	    ...
	    MELT_CHECK_SIGNAL ();
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4303:/ apply");
	    /*apply */
	    {
    ...
    /*_.IF___V10*/ meltfptr[9] = NULL;;
      ...
      ;
      MELT_LOCATION ("warmelt-modes.melt:4303:/ quasiblock");
    ...
    MELT_CHECK_SIGNAL ();
    ;
    MELT_LOCATION ("warmelt-modes.melt:4304:/ apply");
    /*apply */
    {
    ...
    {
      MELT_LOCATION ("warmelt-modes.melt:4297:/ locexp");
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4333:/ getarg");
...
/* we warned when secondary results are expected but not returned. */
 ...
 /*_#IS_STRING__L3*/ meltfnum[0] =
	...
	/*_.BASNAM__V14*/ meltfptr[9] = /*_.OUTARG__V13*/ meltfptr[5];;
      ...
      {
	MELT_LOCATION ("warmelt-modes.melt:4353:/ cond.else");
...
/* we warned when secondary results are expected but not returned. */
   ...
   /*_#MELT_NEED_DBG__L5*/ meltfnum[1] =
      ...
      /*cond */ if ( /*_#MELT_NEED_DBG__L5*/ meltfnum[1])	/*then */
	{
     ...
     /*_#MELT_CALLCOUNT__L6*/ meltfnum[5] =
	    ...
	    MELT_CHECK_SIGNAL ();
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4360:/ apply");
	    /*apply */
	    {
 ...
 /*_#STRING_DYNLOADED_SUFFIXED__L7*/ meltfnum[5] =
   ...
   /*_.RETVAL___V1*/ meltfptr[0] = NULL;;
	  ...
	  {
	    MELT_LOCATION ("warmelt-modes.melt:4367:/ locexp");
	    /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
	    if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	      melt_warn_for_no_expected_secondary_results ();
/* we warned when secondary results are expected but not returned. */
 ...
 /*_#IS_STRING__L12*/ meltfnum[10] =
   ...
   /*_#IS_LIST__L13*/ meltfnum[8] =
	  ...
	  /*cond */ if ( /*_#IS_LIST__L13*/ meltfnum[8])	/*then */
		...
		MELT_CHECK_SIGNAL ();
		;
		MELT_LOCATION ("warmelt-modes.melt:4373:/ apply");
		/*apply */
		{
		  union meltparam_un argtab[1];
		  memset (&argtab, 0, sizeof (argtab));
   ...
   /*_#MELT_NEED_DBG__L14*/ meltfnum[9] =
      ...
      /*cond */ if ( /*_#MELT_NEED_DBG__L14*/ meltfnum[9])	/*then */
	{
     ...
     /*_#MELT_CALLCOUNT__L15*/ meltfnum[8] =
	    ...
	    MELT_CHECK_SIGNAL ();
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4383:/ apply");
	    /*apply */
	    {
	      union meltparam_un argtab[5];
	      memset (&argtab, 0, sizeof (argtab));
    ...
    /*_.IF___V34*/ meltfptr[31] = NULL;;
      ...
      ;
      MELT_LOCATION ("warmelt-modes.melt:4383:/ quasiblock");
    ...
    MELT_CHECK_SIGNAL ();
    ;
    MELT_LOCATION ("warmelt-modes.melt:4386:/ apply");
    /*apply */
    {
	...
	/*_.OUTBASE__V39*/ meltfptr[38] = /*_.OUTARG__V13*/ meltfptr[5];;
      ...
      {
	MELT_LOCATION ("warmelt-modes.melt:4391:/ cond.else");
 ...
 /*_#IS_MULTIPLE__L16*/ meltfnum[8] =
   ...
   /*_#IS_STRING__L22*/ meltfnum[17] =
	    (melt_magic_discr ((melt_ptr_t) ( /*_.FLAVOR__V2*/ meltfptr[1]))
	     == MELTOBMAG_STRING);;
	  MELT_LOCATION ("warmelt-modes.melt:4405:/ cond");
	...
	/*_.IF___V52*/ meltfptr[51] = NULL;;
...
#if MELT_HAVE_DEBUG
		MELT_LOCATION ("warmelt-modes.melt:4409:/ cppif.then");
		/*^block */
		/*anyblock */
		{
...
#endif /*MELT_HAVE_DEBUG */
		    ;;
		  MELT_LOCATION ("warmelt-modes.melt:4409:/ cond");
	 ...
	 /*_#MELT_CALLCOUNT__L26*/ meltfnum[18] =
			...
			MELT_CHECK_SIGNAL ();
			;
			MELT_LOCATION ("warmelt-modes.melt:4409:/ apply");
			/*apply */
			{
			  union meltparam_un argtab[9];
			  memset (&argtab, 0, sizeof (argtab));
	...
	/*_.IF___V61*/ meltfptr[47] = NULL;;
		...
		{
		  MELT_LOCATION ("warmelt-modes.melt:4414:/ locexp");
		  error ("MELT ERROR MSG [#%ld]::: %s", melt_dbgcounter,
...
#if MELT_HAVE_DEBUG
		MELT_LOCATION ("warmelt-modes.melt:4415:/ cppif.then");
		/*^block */
		/*anyblock */
		{
		  ...
		  /*cond */ if (( /*nil */ NULL))	/*then */
		    ...
		    {
		      MELT_LOCATION ("warmelt-modes.melt:4415:/ cond.else");
			...
			{
			  /*^locexp */
			  melt_assert_failed (("translateinitmodule_flavored bad flavor"), ("warmelt-modes.melt") ? ("warmelt-modes.melt") : __FILE__, (4415) ? (4415) : __LINE__, __FUNCTION__);
			  ;
			}
			;
...
/*anyblock*/
 ...
 /*_.CUREAD__V4*/ meltfptr[3] =
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-modes.melt:4378:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_LIST__L1*/ meltfnum[0] =
	(melt_magic_discr ((melt_ptr_t) (( /*~RLIST */ meltfclos->tabval[0])))
	 == MELTOBMAG_LIST);;
      MELT_LOCATION ("warmelt-modes.melt:4378:/ cond");
      /*cond */ if ( /*_#IS_LIST__L1*/ meltfnum[0])	/*then */
	{
	  /*^cond.then */
	  /*_.IFELSE___V6*/ meltfptr[5] = ( /*nil */ NULL);;
	...
	{
	  MELT_LOCATION ("warmelt-modes.melt:4378:/ cond.else");
      ...
      MELT_LOCATION ("warmelt-modes.melt:4378:/ clear");
	     /*clear *//*_#IS_LIST__L1*/ meltfnum[0] = 0;
      /*^clear */
	     /*clear *//*_.IFELSE___V6*/ meltfptr[5] = 0;
    }
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-modes.melt:4379:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#IS_LIST_OR_NULL__L2*/ meltfnum[0] =
	...
	{
	  MELT_LOCATION ("warmelt-modes.melt:4379:/ cond.else");
   ...
   /*_#MELT_NEED_DBG__L3*/ meltfnum[0] =
      ...
      /*cond */ if ( /*_#MELT_NEED_DBG__L3*/ meltfnum[0])	/*then */
	{
     ...
     /*_#MELT_CALLCOUNT__L4*/ meltfnum[3] =
	    ...
	    MELT_CHECK_SIGNAL ();
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4380:/ apply");
	    /*apply */
	    {
	      union meltparam_un argtab[5];
	      memset (&argtab, 0, sizeof (argtab));
    ...
    MELT_CHECK_SIGNAL ();
    ;
    MELT_LOCATION ("warmelt-modes.melt:4381:/ apply");
    /*apply */
    {
      union meltparam_un argtab[1];
      memset (&argtab, 0, sizeof (argtab));
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4422:/ getarg");
...
/*anyblock*/
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-modes.melt:4425:/ blockmultialloc");
    /*multiallocblock */
    {
 ...
 /*_.TUPLREC___V9*/ meltfptr[5] =
	...
	(meltobject_ptr_t) (((melt_ptr_t) (MELT_PREDEF (DISCR_MULTIPLE))));
      ...
      /*^putuple */
      /*putupl#4 */
      melt_assertmsg ("putupl [:4425] #4 checktup",
		      melt_magic_discr ((melt_ptr_t)
					( /*_.TUPLREC___V9*/ meltfptr[5])) ==
		      MELTOBMAG_MULTIPLE);
      melt_assertmsg ("putupl [:4425] #4 checkoff",
		      (0 >= 0
		       && 0 <
	...
	(melt_ptr_t) (( /*!konst_3 */ meltfrout->tabval[3]));
      ...
      /*^putuple */
      /*putupl#5 */
      melt_assertmsg ("putupl [:4425] #5 checktup",
		      melt_magic_discr ((melt_ptr_t)
					( /*_.TUPLREC___V9*/ meltfptr[5])) ==
		      MELTOBMAG_MULTIPLE);
      melt_assertmsg ("putupl [:4425] #5 checkoff",
		      (1 >= 0
		       && 1 <
		       melt_multiple_length ((melt_ptr_t)
					     ( /*_.TUPLREC___V9*/
	...
	(melt_ptr_t) (( /*!konst_4 */ meltfrout->tabval[4]));
      ...
      /*^putuple */
      /*putupl#6 */
      melt_assertmsg ("putupl [:4425] #6 checktup",
		      melt_magic_discr ((melt_ptr_t)
					( /*_.TUPLREC___V9*/ meltfptr[5])) ==
		      MELTOBMAG_MULTIPLE);
      melt_assertmsg ("putupl [:4425] #6 checkoff",
		      (2 >= 0
		       && 2 <
		       melt_multiple_length ((melt_ptr_t)
					     ( /*_.TUPLREC___V9*/
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4442:/ getarg");
 /*_.CMD__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
   ...
   /*_#MELT_NEED_DBG__L1*/ meltfnum[0] =
      ...
      /*cond */ if ( /*_#MELT_NEED_DBG__L1*/ meltfnum[0])	/*then */
	{
     ...
     /*_#MELT_CALLCOUNT__L2*/ meltfnum[1] =
	    ...
	    MELT_CHECK_SIGNAL ();
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4443:/ apply");
	    /*apply */
	    {
	      union meltparam_un argtab[9];
	      memset (&argtab, 0, sizeof (argtab));
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4460:/ getarg");
 /*_.CMD__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-modes.melt:4461:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#MELT_NEED_DBG__L1*/ meltfnum[0] =
      ...
      /*cond */ if ( /*_#MELT_NEED_DBG__L1*/ meltfnum[0])	/*then */
	{
     ...
     /*_#MELT_CALLCOUNT__L2*/ meltfnum[1] =
	    ...
	    MELT_CHECK_SIGNAL ();
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4461:/ apply");
	    /*apply */
	    {
	      union meltparam_un argtab[9];
	      memset (&argtab, 0, sizeof (argtab));
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4478:/ getarg");
 /*_.CMD__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4497:/ getarg");
...
/* we warned when secondary results are expected but not returned. */
 ...
 /*_#NOT__L10*/ meltfnum[1] =
   ...
   /*_.NEWINBUCK__V17*/ meltfptr[16] =
	  ...
	  MELT_LOCATION ("warmelt-modes.melt:4537:/ compute");
...
meltlab_endgetargs:;
/*body*/
  MELT_LOCATION ("warmelt-modes.melt:4555:/ block");
/*anyblock*/
  {
...
/* we warned when secondary results are expected but not returned. */
    ...
    ;
    MELT_LOCATION ("warmelt-modes.melt:4562:/ loop");
    /*loop */
    {
	...
	/*anyblock */
	{
     ...
     /*_#IS_BUCKETLONG__L4*/ meltfnum[2] =
	  ...
	  /*cond */ if ( /*_#IS_BUCKETLONG__L4*/ meltfnum[2])	/*then */
	    ...
	    {
	      MELT_LOCATION ("warmelt-modes.melt:4563:/ cond.else");
   ...
   /*_.BUCKETLONG_REMOVE__V28*/ meltfptr[26] =
	  meltgc_longsbucket_remove ((melt_ptr_t) /*_.ALARMBUCK__V2*/
				     meltfptr[1],
				     ( /*_#NEXTIM__L6*/ meltfnum[2]));;
	MELT_LOCATION ("warmelt-modes.melt:4576:/ compute");
	...
	/*_.ALARMH_PERIOD__V37*/ meltfptr[36] = NULL;;
	 ...
	 /*_.BUCKETLONG_PUT__V39*/ meltfptr[38] =
			    meltgc_longsbucket_put ((melt_ptr_t)
						    ...
						    /*_.NEXTALHD__V19*/
						    meltfptr[18]);;
			  MELT_LOCATION ("warmelt-modes.melt:4586:/ compute");
	...
	/*cond */ if ( /*_.REFERENCED_VALUE__V41*/ meltfptr[38])	/*then */
	  {
		...
		)		/*then */
		{
	      ...
	      ;
	      MELT_LOCATION ("warmelt-modes.melt:4591:/ again");
	      /*again */
	      {
 ...
 /*_#I__L17*/ meltfnum[12] =
   ...
   /*_#I__L19*/ meltfnum[2] =
	  ...
	  /*cond */ if ( /*_#I__L19*/ meltfnum[2])	/*then */
	    ...
	    {
	      MELT_LOCATION ("warmelt-modes.melt:4602:/ cond.else");
...
meltlab_endgetargs:;
/*body*/
  MELT_LOCATION ("warmelt-modes.melt:4567:/ block");
/*anyblock*/
  {
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4612:/ getarg");
 /*_.CLOS__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
   ...
   /*_#I__L5*/ meltfnum[1] =
	...
	/*_#I__L10*/ meltfnum[9] =
       ...
       /*_#FIRSTDELAY__L9*/ meltfnum[8] = 0;;
		  ...
		  ;
		  MELT_LOCATION ("warmelt-modes.melt:4640:/ compute");
		...
		{
		  MELT_LOCATION ("warmelt-modes.melt:4641:/ locexp");
		  /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
		  if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
		    melt_warn_for_no_expected_secondary_results ();
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4645:/ getarg");
...
/*anyblock*/
  {
   ...
   /*_#MELT_NEED_DBG__L1*/ meltfnum[0] =
    ...
    /*_.IF___V4*/ meltfptr[3] = NULL;;
      ...
      ;
      MELT_LOCATION ("warmelt-modes.melt:4647:/ quasiblock");
	...
	/*anyblock */
	{
     ...
     /*_#IS_A__L4*/ meltfnum[0] =
		...
		/*_.IFELSE___V12*/ meltfptr[11] = ( /*nil */ NULL);;
	      ...
	      {
		MELT_LOCATION ("warmelt-modes.melt:4650:/ cond.else");
   ...
   /*_#__L8*/ meltfnum[6] =
     ...
     /*_.BUCKETLONG_PUT__V24*/ meltfptr[23] =
		    meltgc_longsbucket_put ((melt_ptr_t) /*_.NEWBUCK__V16*/
					    ...
					    meltfptr[17]);;
		  MELT_LOCATION ("warmelt-modes.melt:4670:/ compute");
		  /*_.NEWBUCK__V16*/ meltfptr[11] =
...
meltlab_endgetargs:;
/*body*/
  MELT_LOCATION ("warmelt-modes.melt:4680:/ block");
/*anyblock*/
  {


#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-modes.melt:4681:/ cppif.then");
    /*^block */
    /*anyblock */
    {
...
#endif /*MELT_HAVE_DEBUG */
    ;
    MELT_LOCATION ("warmelt-modes.melt:4682:/ quasiblock");
...
/* we warned when secondary results are expected but not returned. */
  ...
  /*_#PIDSTAT__L5*/ meltfnum[4] = 0;;
	...
	{
	  MELT_LOCATION ("warmelt-modes.melt:4697:/ cond.else");
  ...
  /*_.CHPH__V19*/ meltfptr[10] = NULL;
	for (meltcit2__EACHBUCKLONG_ix = 0;
     ...
     /*_#IS_A__L9*/ meltfnum[5] =
		...
		{
		  MELT_LOCATION ("warmelt-modes.melt:4703:/ cond.else");
	    ...
	    /*anyblock */
	    {
	      ...
	      MELT_CHECK_SIGNAL ();
	      ;
	      MELT_LOCATION ("warmelt-modes.melt:4705:/ cond");
	      /*cond */ if (
			     /*ifisa */
			     melt_is_instance_of ((melt_ptr_t)
						  ( /*_.CHPH__V19*/
	 ...
	 /*_#PIDSTAT__L5*/ meltfnum[4] = 0L;
	   ...
	   /*_#PIDSTAT__L5*/ meltfnum[4] = pstatus;
		...
		/*anyblock */
		{
		  ...
		  {
		    MELT_LOCATION ("warmelt-modes.melt:4719:/ locexp");
  ...
  /*_#TERMSIG__L18*/ meltfnum[17] = 0;;
...
#if MELT_HAVE_DEBUG
	  MELT_LOCATION ("warmelt-modes.melt:4739:/ cppif.then");
	  /*^block */
	  /*anyblock */
	  {
    ...
    /*_#MELT_NEED_DBG__L19*/ meltfnum[18] =
...
#endif /*MELT_HAVE_DEBUG */
	      ;;
	    MELT_LOCATION ("warmelt-modes.melt:4739:/ cond");
      ...
      /*_#MELT_CALLCOUNT__L20*/ meltfnum[19] =
		  ...
		  MELT_CHECK_SIGNAL ();
		  ;
		  MELT_LOCATION ("warmelt-modes.melt:4739:/ apply");
		  /*apply */
		  {
		    union meltparam_un argtab[9];
		    memset (&argtab, 0, sizeof (argtab));
		  ...
		  MELT_LOCATION ("warmelt-modes.melt:4739:/ clear");
     ...
     /*_.IF___V36*/ meltfptr[35] = NULL;;
	    ...
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4739:/ quasiblock");
	  ...
	  /*citerblock BLOCK_SIGNALS */
	  {
	    ...
	    MELT_LOCATION ("warmelt-modes.melt:4743:/ quasiblock");
   ...
   /*_.BUCKETLONG_REMOVE__V40*/ meltfptr[36] =
	      meltgc_longsbucket_remove ((melt_ptr_t) /*_.CBUCK__V39*/
					 meltfptr[35],
					 ( /*_#CURPID__L14*/ meltfnum[0]));;
	    MELT_LOCATION ("warmelt-modes.melt:4745:/ compute");
...
#if MELT_HAVE_DEBUG
		      MELT_LOCATION ("warmelt-modes.melt:4770:/ cppif.then");
		      /*^block */
		      /*anyblock */
		      {
	...
	/*_#MELT_NEED_DBG__L22*/ meltfnum[18] =
...
#endif /*MELT_HAVE_DEBUG */
			  ;;
			MELT_LOCATION ("warmelt-modes.melt:4770:/ cond");
	 ...
	 /*_.IF___V45*/ meltfptr[44] = NULL;;
			...
			;
			MELT_LOCATION
			  ("warmelt-modes.melt:4770:/ quasiblock");
			...
			MELT_LOCATION ("warmelt-modes.melt:4770:/ clear");
		  ...
		  /*clear *//*_.PROGN___V47*/ meltfptr[45] = 0;
		      ...
		      MELT_CHECK_SIGNAL ();
		      ;
		      MELT_LOCATION ("warmelt-modes.melt:4772:/ apply");
		      /*apply */
		      {
			union meltparam_un argtab[1];
			memset (&argtab, 0, sizeof (argtab));
			...
			/*_.CURCLOS__V48*/ meltfptr[44] =
		      ...
		      ;
		      MELT_LOCATION ("warmelt-modes.melt:4768:/ quasiblock");
	...
	/*_#MELT_NEED_DBG__L24*/ meltfnum[22] =
	 ...
	 /*_.IF___V51*/ meltfptr[44] = NULL;;
			...
			;
			MELT_LOCATION
			  ("warmelt-modes.melt:4776:/ quasiblock");
	...
	/*_#MELT_NEED_DBG__L26*/ meltfnum[18] =
	 ...
	 /*_.IF___V59*/ meltfptr[45] = NULL;;
			...
			;
			MELT_LOCATION
			  ("warmelt-modes.melt:4783:/ quasiblock");
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4788:/ getarg");
 /*_.CLOS__V2*/ meltfptr[1] = (melt_ptr_t) meltfirstargp_;
 ...
 /*_#IS_CLOSURE__L4*/ meltfnum[2] =
   ...
   /*_#I__L5*/ meltfnum[1] =
	  ...
	  /*cond */ if ( /*_#I__L5*/ meltfnum[1])	/*then */
		...
		MELT_LOCATION ("warmelt-modes.melt:4795:/ quasiblock");
...
#if MELT_HAVE_DEBUG
		MELT_LOCATION ("warmelt-modes.melt:4803:/ cppif.then");
		/*^block */
		/*anyblock */
		{
...
/* we warned when secondary results are expected but not returned. */
	...
	/*_.IF___V22*/ meltfptr[21] = NULL;;
		  ...
		  ;
		  MELT_LOCATION ("warmelt-modes.melt:4811:/ quasiblock");
		...
		/*citerblock BLOCK_SIGNALS */
		{
		  ...
		  MELT_LOCATION ("warmelt-modes.melt:4814:/ quasiblock");
...
#if MELT_HAVE_DEBUG
		  MELT_LOCATION ("warmelt-modes.melt:4817:/ cppif.then");
		  /*^block */
		  /*anyblock */
		  {
	...
	/*_#IS_BUCKETLONG__L11*/ meltfnum[6] =
		      (melt_magic_discr
		       ...
		       MELTOBMAG_BUCKETLONGS);;
		    MELT_LOCATION ("warmelt-modes.melt:4817:/ cond");
			...
			/*_.IFELSE___V29*/ meltfptr[28] = ( /*nil */ NULL);;
		      ...
		      {
			MELT_LOCATION ("warmelt-modes.melt:4817:/ cond.else");
		    ...
		    MELT_LOCATION ("warmelt-modes.melt:4817:/ clear");
      ...
      /*_.BUCKETLONG_PUT__V30*/ meltfptr[28] =
		    meltgc_longsbucket_put ((melt_ptr_t) /*_.BUCK__V26*/
					    ...
					    (melt_ptr_t) /*_.CHPH__V19*/
					    meltfptr[18]);;
		  MELT_LOCATION ("warmelt-modes.melt:4818:/ compute");
		  /*_.BUCK__V26*/ meltfptr[22] =
		  ...
		  MELT_CHECK_SIGNAL ();
		  ;
		  MELT_LOCATION ("warmelt-modes.melt:4819:/ cond");
		  /*cond */ if (
				 /*ifisa */
				 melt_is_instance_of ((melt_ptr_t)
						      (( /*!CHILDPROC_BUCKET_REFERENCE */ meltfrout->tabval[4])),
		...
		MELT_CHECK_SIGNAL ();
		;
		MELT_LOCATION ("warmelt-modes.melt:4824:/ quasiblock");


		/*_.RETVAL___V1*/ meltfptr[0] = /*_.CHPH__V19*/ meltfptr[18];;

		{
		  MELT_LOCATION ("warmelt-modes.melt:4824:/ locexp");
		  /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
		  if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
		    melt_warn_for_no_expected_secondary_results ();
...
/*getargs*/
  ...
  /*getarg#0 */
  MELT_LOCATION ("warmelt-modes.melt:4832:/ getarg");
...
/*anyblock*/
  {
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-modes.melt:4834:/ cppif.then");
    /*^block */
    /*anyblock */
    {
   ...
   /*_#MELT_NEED_DBG__L1*/ meltfnum[0] =
...
#endif /*MELT_HAVE_DEBUG */
	;;
      MELT_LOCATION ("warmelt-modes.melt:4834:/ cond");
      /*cond */ if ( /*_#MELT_NEED_DBG__L1*/ meltfnum[0])	/*then */
	{
	  /*^cond.then */
	  /*^block */
     ...
     /*_#MELT_CALLCOUNT__L2*/ meltfnum[1] =
	    ...
	    MELT_CHECK_SIGNAL ();
	    ;
	    MELT_LOCATION ("warmelt-modes.melt:4834:/ apply");
	    /*apply */
	    {
	      union meltparam_un argtab[5];
	      memset (&argtab, 0, sizeof (argtab));
	    ...
	    MELT_LOCATION ("warmelt-modes.melt:4834:/ clear");
	       /*clear *//*_#MELT_CALLCOUNT__L2*/ meltfnum[1] = 0;
	    /*^clear */
	       /*clear *//*_.MELT_DEBUG_FUN__V5*/ meltfptr[4] = 0;
	  }
    ...
    /*_.IF___V4*/ meltfptr[3] = NULL;;
      ...
      ;
      MELT_LOCATION ("warmelt-modes.melt:4834:/ quasiblock");
...
#if MELT_HAVE_DEBUG
    MELT_LOCATION ("warmelt-modes.melt:4835:/ cppif.then");
    /*^block */
    /*anyblock */
    {
	...
	{
	  MELT_LOCATION ("warmelt-modes.melt:4835:/ cond.else");
	  ...
	  /*anyblock */
	  {
	    ...
	    {
	      /*^locexp */
	      melt_assert_failed (("@$@unimplemented unregister_child_process_handler"), ("warmelt-modes.melt") ? ("warmelt-modes.melt") : __FILE__, (4835) ? (4835) : __LINE__, __FUNCTION__);
	      ;
	    }
	    ;
    ...
    MELT_CHECK_SIGNAL ();
    ;
    MELT_LOCATION ("warmelt-modes.melt:4832:/ quasiblock");


    /*_.RETVAL___V1*/ meltfptr[0] = /*_.IFCPP___V7*/ meltfptr[3];;

    {
      MELT_LOCATION ("warmelt-modes.melt:4832:/ locexp");
      /*ochecknores compilobj_nrep_return */
#if MELT_HAVE_DEBUG
      if (meltxresdescr_ && meltxresdescr_[0] && meltxrestab_)
	melt_warn_for_no_expected_secondary_results ();
