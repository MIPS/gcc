...
/*anyblock*/
  ...
  /*_.INST__V12*/ meltfptr[11] =
   ...
   /*_#MELT_NEED_DBG__L3*/ meltfnum[0] =
    ...
    MELT_LOCATION ("warmelt-normal.melt:1236:/ putxtraresult");
  ...
  /*_.LOCA_LOCATION__V15*/ meltfptr[14] = slot;
      ...
      else
	{
	  ...
	  /*anyblock */
	  {
	    ...
	    {
	      /*^locexp */
	      melt_assert_failed (("normexp_src_catchall unimplemented normexp for src"), ("warmelt-normal.melt") ? ("warmelt-normal.melt") : __FILE__, (1289) ? (1289) : __LINE__, __FUNCTION__);
	      ;
	    }
	    ;
 ...
 /*_#NOT__L8*/ meltfnum[7] =
  ...
  /*_._IF___V22*/ meltfptr[21] = NULL;;
   ...
   /*_#MELT_NEED_DBG__L9*/ meltfnum[8] =
    ...
    MELT_LOCATION ("warmelt-normal.melt:1432:/ putxtraresult");
    if (!meltxrestab_ || !meltxresdescr_)
      goto meltlabend_rout;
    if (meltxresdescr_[0] != MELTBPAR_PTR)
      goto meltlabend_rout;
...
/*anyblock*/
  {
   ...
   /*_#IS_LIST_OR_NULL__L6*/ meltfnum[1] =
	...
	{
	  MELT_LOCATION ("warmelt-normal.melt:1385:/ cond.else");
 ...
 /*_#IS_A__L7*/ meltfnum[2] =
   ...
   /*_#NULL__L10*/ meltfnum[8] =
    ...
    /*_.INST__V29*/ meltfptr[28] =
	  ...
	  ;
	  MELT_LOCATION ("warmelt-normal.melt:1412:/ compute");
...
/*anyblock*/
 ...
 /*_#IS_LIST__L2*/ meltfnum[0] =
  ...
  /*_#_IF___L3*/ meltfnum[2] = 0;;
	...
	/*anyblock */
	{
	  ...
	  ;
	  MELT_LOCATION ("warmelt-normal.melt:1454:/ blockmultialloc");
	  /*multiallocblock */
	  {
 ...
 /*_.TUPLREC___V15*/ meltfptr[14] =
	    ...
	    /*^putuple */
	    /*putupl#4 */
	    melt_assertmsg ("putupl [:1454] #4 checktup",
			    melt_magic_discr ((melt_ptr_t)
					      ( /*_.TUPLREC___V15*/
					       meltfptr[14])) ==
			    MELTOBMAG_MULTIPLE);
	    melt_assertmsg ("putupl [:1454] #4 checkoff",
			    (0 >= 0
			     && 0 <
	 ...
	 /*_#MELT_NEED_DBG__L13*/ meltfnum[12] =
	   ...
	   /*_#MELT_CALLCOUNT__L14*/ meltfnum[13] =
				...
				;;
			      ...
			      ;
			      MELT_LOCATION
				("warmelt-normal.melt:1483:/ apply");
			      /*apply */
			      {
				union meltparam_un argtab[5];
				memset (&argtab, 0, sizeof (argtab));
...
/* we warned when secondary results are expected but not returned. */
	...
	/*_#NIX__L16*/ meltfnum[12]++)
...
#if MELT_HAVE_DEBUG
			    MELT_LOCATION
			      ("warmelt-normal.melt:1496:/ cppif.then");
			    /*^block */
			    /*anyblock */
			    {
	  ...
	  /*_#IS_NOT_OBJECT__L17*/ meltfnum[16] =
				...
				{
				  MELT_LOCATION
				    ("warmelt-normal.melt:1496:/ cond.else");
	...
	/*_#plI__L20*/ meltfnum[18] =
			    ...
			    {
			      MELT_LOCATION
				("warmelt-normal.melt:1497:/ locexp");
			      meltgc_multiple_put_nth ((melt_ptr_t)
						       ( /*_.GROWNTUP__V31*/
							meltfptr[25]),
						       ( /*_#plI__L20*/
	 ...
	 /*_#MELT_NEED_DBG__L21*/ meltfnum[16] =
	   ...
	   /*_#MELT_CALLCOUNT__L22*/ meltfnum[17] =
				...
				;;
			      ...
			      ;
			      MELT_LOCATION
				("warmelt-normal.melt:1513:/ apply");
			      /*apply */
			      {
				union meltparam_un argtab[5];
				memset (&argtab, 0, sizeof (argtab));
				...
				/*_.MELT_DEBUG_FUN__V43*/ meltfptr[42];;
			      ...
			      MELT_LOCATION
				("warmelt-normal.melt:1513:/ clear");
...
/*anyblock*/
 ...
 /*_.DIS__V10*/ meltfptr[6] =
  ...
  /*_.NAMED_NAME__V13*/ meltfptr[11] = NULL;;
	...
	{
	  MELT_LOCATION ("warmelt-normal.melt:1543:/ cond.else");
	...
	/*anyblock */
	{
	  ...
	  /*anyblock */
	  {
		...
		/*anyblock */
		{
		  ...
		  {
		    /*^locexp */
		    melt_assert_failed (("normbind_definedvalbind check no procs"), ("warmelt-normal.melt") ? ("warmelt-normal.melt") : __FILE__, (1688) ? (1688) : __LINE__, __FUNCTION__);
		    ;
		  }
		  ;
  ...
  /*_#eqeq__L10*/ meltfnum[0] =
	  ...
	  /*cond */ if ( /*_#eqeq__L10*/ meltfnum[0])	/*then */
		...
		/*_#SYIX__L9*/ meltfnum[4] = /*_#SETQ___L11*/ meltfnum[10] =
		  -9999;;
		MELT_LOCATION ("warmelt-normal.melt:1714:/ compute");
   ...
   /*_#IS_A__L14*/ meltfnum[12] =
      ...
      else
	{
	  ...
	  /*anyblock */
	  {
	    ...
	    {
	      /*^locexp */
	      melt_assert_failed (("normbind_constructbind should have ourlocsym"), ("warmelt-normal.melt") ? ("warmelt-normal.melt") : __FILE__, (1717) ? (1717) : __LINE__, __FUNCTION__);
	      ;
	    }
	    ;
