...
class Melt_InitialClassyFrame_WARMELTmiOUTOBJ_h347435318; // forward declaration fromline 6542
typedef Melt_InitialClassyFrame_WARMELTmiOUTOBJ_h347435318 Melt_InitialFrame;
...
typedef Melt_InitialClassyFrame_WARMELTmiOUTOBJ_h347435318 /*opaqueinitialclassy*/ meltinitial_frame_t;
                    ...
                    /*cond*/ if (/*_#eqeq__L12*/ meltfnum[11]) /*then*/
                    ...
                    else    /*^cond.else*/
                        {
                            ...
                            /*anyblock*/
                            {
                                ...
                                MELT_CHECK_SIGNAL();
                                ;
                                MELT_LOCATION("warmelt-outobj.melt:2801:/ msend");
                                /*msend*/
                                {
                                    union meltparam_un argtab[3];
                                    memset(&argtab, 0, sizeof(argtab));
...
#define meltframe meltfram__
    ...
    /*getarg#0*/
    MELT_LOCATION("warmelt-outobj.melt:2950:/ getarg");
...
#define meltframe meltfram__
    ...
    /*getarg#0*/
    MELT_LOCATION("warmelt-outobj.melt:2976:/ getarg");
...
#if MELT_HAVE_DEBUG
        MELT_LOCATION("warmelt-outobj.melt:3049:/ cppif.then");
        /*^block*/
        /*anyblock*/
        {
                ...
                /*anyblock*/
                {
                    ...
                    /*anyblock*/
                    {
                        ...
                        /*cond*/ if (/*_#IS_LIST__L18*/ meltfnum[10]) /*then*/
                            ...
                            {
                                MELT_LOCATION("warmelt-outobj.melt:3188:/ cond.else");
...
meltlab_endgetargs:
    ...
    /*anyblock*/
    {
        ...
        MELT_CHECK_SIGNAL();
        ;
        MELT_LOCATION("warmelt-outobj.melt:3308:/ apply");
        /*apply*/
        {
            union meltparam_un argtab[1];
            memset(&argtab, 0, sizeof(argtab));
