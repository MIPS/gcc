...
build_objc_string_object (tree string)
{
  ...
  if (constructor)
    return build_c_cast (objc_id_type, constructor);
...
{
/* APPLE LOCAL begin MERGE FIXME Radar #3677258 re-implement objc speedup */
#if 0
...
#endif
/* APPLE LOCAL end MERGE FIXME Radar #3677258 re-implement objc speedup */
  tree chain;
