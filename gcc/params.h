...
#define MAX_CALLS_FOR_GLOBAL_VAR \
  PARAM_VALUE (PARAM_MAX_CALLS_GLOBAL_VAR)
#define MAX_CLOBBERED_VARS_FOR_GLOBAL_VAR \
  PARAM_VALUE (PARAM_MAX_CLOBBERED_VARS_GLOBAL_VAR)
#endif /* ! GCC_PARAMS_H */
