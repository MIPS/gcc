...
static void count_stack_refs (rtx *, void *);
static void count_stack_writes (rtx, rtx, void *);

static void
count_stack_refs (rtx *dest, void *data)
{
  rtx x = *dest;
  int *count = (int *) data;
  int regno;
...
static void
count_stack_writes (rtx dest, rtx setter ATTRIBUTE_UNUSED, void *data)
{
...
static void
print_costs_bb (FILE *file, rtx insn)
{
  basic_block bb;
...
rest_of_compilation (void)
{
  ...
  open_dump_file (DFI_costs, current_function_decl);
  close_dump_file (DFI_costs, print_costs_bb, get_insns ());
