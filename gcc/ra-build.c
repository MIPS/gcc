...
static void insn_clobbers_mem_1 (rtx, rtx, void *);
static int insn_clobbers_mem (rtx);
...
static void
insn_clobbers_mem_1 (rtx dest, rtx setter ATTRIBUTE_UNUSED, void *data)
{
...
static int
ATTRIBUTE_UNUSED
rematerializable_stack_arg_p (rtx insn, rtx src)
{
  rtx mem;
