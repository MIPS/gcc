...
/* A logical OR of two ranges is executed when we are walking forward with
   ...
   the result of the OR is the Union of the 2 ranges, [0,4][21,255].  */
bool
