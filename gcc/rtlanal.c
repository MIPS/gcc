...
static void note_uses_1 (rtx *, void (*fun) (rtx *, void *), void *, int);
...
void
note_uses_partial (rtx *pbody, void (*fun)(rtx *, void *), void *data)
{
  note_uses_1 (pbody, fun, data, 1);
}

static void
note_uses_1 (rtx *pbody, void (*fun) (rtx *, void *), void *data, int partial)
{
  rtx body = *pbody;
  int i;
