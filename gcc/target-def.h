...
#define TARGET_VECTORIZE_BUILTIN_VECT_PATTERN_RECOG 0
#define TARGET_VECTORIZE_BUILTIN_EXTRACT_EVEN 0
#define TARGET_VECTORIZE_BUILTIN_EXTRACT_ODD 0

#define TARGET_VECTORIZE                                                \
  {TARGET_VECTORIZE_BUILTIN_MASK_FOR_LOAD,				\
   TARGET_VECTORIZE_BUILTIN_MUL_WIDEN_EVEN,				\
   TARGET_VECTORIZE_BUILTIN_MUL_WIDEN_ODD,				\
   TARGET_VECTORIZE_BUILTIN_EXTRACT_EVEN,    \
   TARGET_VECTORIZE_BUILTIN_EXTRACT_ODD,    \
