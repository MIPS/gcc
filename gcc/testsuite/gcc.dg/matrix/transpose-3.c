...
/* The inner most dimension escapes. 
   The two external dimensinos are flattened 
...
/*--------------------------------------------------------------------------*/
/* { dg-final-use { scan-ipa-dump-times "Flattened 2 dimensions" 1 "mreorg"  } } */
/* { dg-final-use { scan-ipa-dump-times "Transposed" 2 "mreorg"  } } */
/* { dg-final-use { cleanup-ipa-dump "mreorg" } } */
