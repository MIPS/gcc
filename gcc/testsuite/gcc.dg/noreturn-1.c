...
foo4(void)
{
  exit(0); /* { dg-warning "candidate for attribute `noreturn'" "detect noreturn candidate" } */
}
...
foo8(void)
{
  foo7(); /* { dg-warning "`noreturn' function does return" "detect return from tail call" } */
}
