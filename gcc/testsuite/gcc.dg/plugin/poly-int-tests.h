...
test_helper ()
{
  ...
  ASSERT_MAY_NE (p1::make (1, 2, 3), 0);
  ASSERT_MUST_EQ (p1::make (1, 2, 3) - p1::make (1, 0, 0), 0);
  ASSERT_MUST_EQ (p1::make (1, 2, 3) - p1::make (1, 2, 0), 0);
  ASSERT_MUST_EQ (p1::make (1, 2, 3) - p1::make (1, 2, 3), 0);

  ASSERT_MAY_NE (p2::make (1, 2, 3), 0);
  ASSERT_MAY_NE (p2::make (1, 2, 3) - p2::make (1, 0, 0), 0);
  ASSERT_MUST_EQ (p2::make (1, 2, 3) - p2::make (1, 2, 0), 0);
  ASSERT_MUST_EQ (p2::make (1, 2, 3) - p2::make (1, 2, 3), 0);

  ASSERT_MAY_NE (p3::make (1, 2, 3), 0);
  ASSERT_MAY_NE (p3::make (1, 2, 3) - p3::make (1, 0, 0), 0);
  ASSERT_MAY_NE (p3::make (1, 2, 3) - p3::make (1, 2, 0), 0);
  ASSERT_MUST_EQ (p3::make (1, 2, 3) - p3::make (1, 2, 3), 0);
}
...
test_constants ()
{
  ...
  /* Basic tests of must and may_ne.  */
  ASSERT_MUST_EQ (zero, ch::make (0));
  ASSERT_MAY_NE (one, ch::make (0));
  ASSERT_MAY_NE (two, ch::make (0));
  ASSERT_MUST_EQ (ch::make (0), zero);
  ASSERT_MAY_NE (ch::make (0), one);
  ASSERT_MAY_NE (ch::make (0), two);
  ASSERT_MUST_EQ (zero, zero);
  ASSERT_MAY_NE (one, zero);
  ASSERT_MAY_NE (two, zero);

  ASSERT_MAY_NE (zero, ch::make (1));
  ASSERT_MUST_EQ (one, ch::make (1));
  ASSERT_MAY_NE (two, ch::make (1));
  ASSERT_MAY_NE (ch::make (1), zero);
  ASSERT_MUST_EQ (ch::make (1), one);
  ASSERT_MAY_NE (ch::make (1), two);
  ASSERT_MAY_NE (zero, one);
  ASSERT_MUST_EQ (one, one);
  ASSERT_MAY_NE (two, one);

  ASSERT_MAY_NE (zero, ch::make (2));
  ASSERT_MAY_NE (one, ch::make (2));
  ASSERT_MUST_EQ (two, ch::make (2));
  ASSERT_MAY_NE (ch::make (2), zero);
  ASSERT_MAY_NE (ch::make (2), one);
  ASSERT_MUST_EQ (ch::make (2), two);
  ASSERT_MAY_NE (zero, two);
  ASSERT_MAY_NE (one, two);
  ASSERT_MUST_EQ (two, two);

  ASSERT_MAY_NE (zero, two_uc);
  ASSERT_MAY_NE (one, two_uc);
  ASSERT_MUST_EQ (two, two_uc);
  ASSERT_MAY_NE (two_uc, zero);
  ASSERT_MAY_NE (two_uc, one);
  ASSERT_MUST_EQ (two_uc, two);
}
...
test_plus_equals ()
{
  ...
  add_cm += 14;
  ASSERT_MUST_EQ (add_cm, ph::make (31, 11, 9));

  /* Test += on T.  */
  T add_pm = ph::make (100, 44, 11);
  add_pm += ph::make (1, 2, 3);
  ASSERT_MUST_EQ (add_pm, ph::make (101, 46, 14));
}
...
test_minus_equals ()
{
  ...
  sub_cm -= 76;
  ASSERT_MUST_EQ (sub_cm, ph::make (6, 13, 61));

  /* Test -= on T.  */
  T sub_pm = ph::make (82, 13, 61);
  sub_pm -= ph::make (19, 12, 14);
  ASSERT_MUST_EQ (sub_pm, ph::make (63, 1, 47));
}
...
test_times_equals ()
{
  ...
  mul_cm *= 3;
  ASSERT_MUST_EQ (mul_cm, ph::make (33, 66, 99));
}
...
test_shl_equals ()
{
  ...
  shl_cm <<= 2;
  ASSERT_MUST_EQ (shl_cm, ph::make (40, 44, 52));
}
...
test_addition ()
{
  ...
  /* Test +.  */
  ASSERT_MUST_EQ (ph::make (55, 43, 30) + 1,
		  ph::make (56, 43, 30));
  ASSERT_MUST_EQ (100 + ph::make (5, 15, 26),
		  ph::make (105, 15, 26));
  ASSERT_MUST_EQ (ph::make (7, 100, 41) + ph::make (96, 9, 21),
		  ph::make (103, 109, 62));

  /* Test wi::add.  */
  ASSERT_MUST_EQ (wi::add (ph::make (55, 43, 30), 1),
		  ph::make (56, 43, 30));
  ASSERT_MUST_EQ (wi::add (100, ph::make (5, 15, 26)),
		  ph::make (105, 15, 26));
  ASSERT_MUST_EQ (wi::add (ph::make (7, 100, 41), ph::make (96, 9, 21)),
		  ph::make (103, 109, 62));
}
...
test_subtraction ()
{
  ...
  ASSERT_MUST_EQ (ph::make (64, 49, 36) - 42,
		  rph::make (22, 49, 36));
  ASSERT_MUST_EQ (11 - ph::make (9, 3, 4),
		  rph::make (2, -3, -4));
  ASSERT_MUST_EQ (ph::make (100, 200, 300) - ph::make (99, 197, 305),
		  rph::make (1, 3, -5));

  /* Test wi::sub.  Primitive Cs promote to widest_int; use iph to capture
     this.  */
  ASSERT_MUST_EQ (wi::sub (ph::make (64, 49, 36), 42),
		  iph::make (22, 49, 36));
  ASSERT_MUST_EQ (wi::sub (11, ph::make (9, 3, 4)),
		  iph::make (2, -3, -4));
  ASSERT_MUST_EQ (wi::sub (ph::make (100, 200, 300), ph::make (99, 197, 305)),
		  iph::make (1, 3, -5));
}
...
test_negation ()
{
  ...
  /* Test unary -.  */
  ASSERT_MUST_EQ (-ph::make (10, 20, 30),
		  rph::make (-10, -20, -30));

  /* Test wi::neg.  */
  ASSERT_MUST_EQ (wi::neg (ph::make (10, 20, 30)),
		  iph::make (-10, -20, -30));
}
...
test_multiplication ()
{
  ...
  /* Test *.  */
  ASSERT_MUST_EQ (ph::make (5, 20, 25) * 10,
		  ph::make (50, 200, 250));
  ASSERT_MUST_EQ (111 * ph::make (7, 6, 5),
		  ph::make (777, 666, 555));

  /* Test wi::mul.  */
  ASSERT_MUST_EQ (wi::mul (ph::make (5, 20, 25), 10),
		  ph::make (50, 200, 250));
  ASSERT_MUST_EQ (wi::mul (111, ph::make (7, 6, 5)),
		  ph::make (777, 666, 555));
}
...
test_may_ne ()
{
  ...
  /* Test may_ne (T, C).  */
  ASSERT_EQ (may_ne (ph::make (1, 0, 2), ch::make (1)), N == 3);
  ASSERT_EQ (may_ne (ph::make (-11, -2, 0), ch::make (-11)), N >= 2);
  ASSERT_TRUE (may_ne (ph::make (199, 0, 0), ch::make (200)));

  /* Test may_ne (C, T).  */
  ASSERT_EQ (may_ne (ch::make (-22), ph::make (-22, 0, -1)), N == 3);
  ASSERT_EQ (may_ne (ch::make (5), ph::make (5, 4, 0)), N >= 2);
  ASSERT_TRUE (may_ne (ch::make (-3), ph::make (-4, 0, 0)));

  /* Test may_ne (T, T).  */
  ASSERT_EQ (may_ne (ph::make (1, 3, 5),
		     ph::make (1, 3, 6)), N == 3);
  ASSERT_EQ (may_ne (ph::make (1, 3, 5),
		     ph::make (1, 4, 5)), N >= 2);
  ASSERT_TRUE (may_ne (ph::make (1, 3, 5),
		       ph::make (0, 3, 5)));
}
...
test_must_eq ()
{
  ...
  /* Test must_eq (T, C).  */
  ASSERT_EQ (must_eq (ph::make (1, 0, 2), ch::make (1)), N <= 2);
  ASSERT_EQ (must_eq (ph::make (-11, -2, 0), ch::make (-11)), N == 1);
  ASSERT_FALSE (must_eq (ph::make (199, 0, 0), ch::make (200)));

  /* Test must_eq (C, T).  */
  ASSERT_EQ (must_eq (ch::make (-22), ph::make (-22, 0, -1)), N <= 2);
  ASSERT_EQ (must_eq (ch::make (5), ph::make (5, 4, 0)), N == 1);
  ASSERT_FALSE (must_eq (ch::make (-3), ph::make (-4, 0, 0)));

  /* Test must_eq (T, T).  */
  ASSERT_EQ (must_eq (ph::make (1, 3, 5),
		      ph::make (1, 3, 6)), N <= 2);
  ASSERT_EQ (must_eq (ph::make (1, 3, 5),
		      ph::make (1, 4, 5)), N == 1);
  ASSERT_FALSE (must_eq (ph::make (1, 3, 5),
			 ph::make (0, 3, 5)));
}
...
test_force_align_up ()
{
  ...
  /* Test force_align_up.  */
  ASSERT_MUST_EQ (force_align_up (ph::make (41, 32, 16), 16),
		  ph::make (48, 32, 16));
  ASSERT_MUST_EQ (force_align_up (ph::make (-39, -64, -32), 32),
		  ph::make (-32, -64, -32));
  ASSERT_MUST_EQ (force_align_up (ph::make (17, 0, 0), 16),
		  ch::make (32));
  ASSERT_MUST_EQ (force_align_up (ph::make (16, 0, 0), 16),
		  ch::make (16));
  ASSERT_MUST_EQ (force_align_up (ph::make (15, 0, 0), 16),
		  ch::make (16));
  ASSERT_MUST_EQ (force_align_up (ph::make (-17, 0, 0), 16),
		  ch::make (-16));
  ASSERT_MUST_EQ (force_align_up (ph::make (-16, 0, 0), 16),
...
test_force_align_down ()
{
  ...
  ASSERT_MUST_EQ (force_align_down (ph::make (41, 32, 16), 16),
		  ph::make (32, 32, 16));
  ASSERT_MUST_EQ (force_align_down (ph::make (-39, -64, -32), 32),
		  ph::make (-64, -64, -32));
  ASSERT_MUST_EQ (force_align_down (ph::make (17, 0, 0), 16),
		  ch::make (16));
  ASSERT_MUST_EQ (force_align_down (ph::make (16, 0, 0), 16),
		  ch::make (16));
  ASSERT_MUST_EQ (force_align_down (ph::make (15, 0, 0), 16),
		  ch::make (0));
  ASSERT_MUST_EQ (force_align_down (ph::make (-17, 0, 0), 16),
		  ch::make (-32));
  ASSERT_MUST_EQ (force_align_down (ph::make (-16, 0, 0), 16),
...
test_aligned_lower_bound ()
{
  ...
  ASSERT_MUST_EQ (aligned_lower_bound (ph::make (17, 63, 33), 16),
		  ph::make (16, 48, 32));
  ASSERT_MUST_EQ (aligned_lower_bound (ph::make (11, -33, 64), 32),
		  ph::make (0, -64, 64));
  ASSERT_MUST_EQ (aligned_lower_bound (ph::make (-9, 16, -31), 8),
		  ph::make (-16, 16, -32));
  ASSERT_MUST_EQ (aligned_lower_bound (ph::make (-8, -12, 16), 4),
		  ph::make (-8, -12, 16));
}
...
test_aligned_upper_bound ()
{
  ...
  ASSERT_MUST_EQ (aligned_upper_bound (ph::make (17, 63, 33), 16),
		  ph::make (32, 64, 48));
  ASSERT_MUST_EQ (aligned_upper_bound (ph::make (11, -33, 64), 32),
		  ph::make (32, -32, 64));
  ASSERT_MUST_EQ (aligned_upper_bound (ph::make (-9, 16, -31), 8),
		  ph::make (-8, 16, -24));
  ASSERT_MUST_EQ (aligned_upper_bound (ph::make (-8, -12, 16), 4),
		  ph::make (-8, -12, 16));
}
...
test_can_ior_p ()
{
  ...
  ASSERT_MUST_EQ (ior, ph::make (0x97, 0x60, 0xa0));
  ASSERT_EQ (can_ior_p (ph::make (9, 96, 48), 28, &ior), N <= 2);
  if (N <= 2)
    ASSERT_MUST_EQ (ior, ph::make (29, 96, 0));
...
test_may_le ()
{
  ...
  /* Test may_le (T, C).  */
  ASSERT_FALSE (may_le (ph::make (7, 5, 4), ch::make (6)));
  ASSERT_FALSE (may_le (ph::make (7, 0, 0), ch::make (6)));
  ASSERT_TRUE (may_le (ph::make (60, 1, 2), ch::make (60)));
  ASSERT_TRUE (may_le (ph::make (60, 0, 0), ch::make (60)));
  ASSERT_TRUE (may_le (ph::make (30, 9, 4), ch::make (31)));
  ASSERT_TRUE (may_le (ph::make (30, 0, 0), ch::make (31)));

  /* Test may_le (C, T).  */
  ASSERT_TRUE (may_le (ch::make (6), ph::make (7, 5, 4)));
  ASSERT_TRUE (may_le (ch::make (6), ph::make (7, 0, 0)));
  ASSERT_TRUE (may_le (ch::make (60), ph::make (60, 1, 2)));
  ASSERT_TRUE (may_le (ch::make (60), ph::make (60, 0, 0)));
  ASSERT_EQ (may_le (ch::make (31), ph::make (30, 9, 4)), N >= 2);
  ASSERT_EQ (may_le (ch::make (31), ph::make (30, 0, 4)), N == 3);
  ASSERT_FALSE (may_le (ch::make (31), ph::make (30, 0, 0)));

  /* Test may_le (T, T).  */
  ASSERT_EQ (may_le (ph::make (3, 14, 99), ph::make (2, 15, 100)), N >= 2);
  ASSERT_EQ (may_le (ph::make (3, 14, 99), ph::make (2, 13, 100)), N == 3);
  ASSERT_EQ (may_le (ph::make (3, 14, 99), ph::make (2, 15, 98)), N >= 2);
  ASSERT_FALSE (may_le (ph::make (3, 14, 99), ph::make (2, 14, 99)));
  ASSERT_FALSE (may_le (ph::make (3, 14, 99), ph::make (2, 13, 98)));
  ASSERT_TRUE (may_le (ph::make (2, 14, 99), ph::make (2, 15, 100)));
  ASSERT_TRUE (may_le (ph::make (2, 14, 99), ph::make (2, 14, 99)));
  ASSERT_TRUE (may_le (ph::make (2, 14, 99), ph::make (2, 13, 98)));
  ASSERT_TRUE (may_le (ph::make (1, 14, 99), ph::make (2, 15, 100)));
  ASSERT_TRUE (may_le (ph::make (1, 14, 99), ph::make (2, 14, 99)));
  ASSERT_TRUE (may_le (ph::make (1, 14, 99), ph::make (2, 13, 98)));
}

/* Test may_lt for both signed and unsigned C.  */
...
test_may_lt ()
{
  ...
  /* Test may_lt (T, C).  */
  ASSERT_FALSE (may_lt (ph::make (7, 5, 4), ch::make (6)));
  ASSERT_FALSE (may_lt (ph::make (7, 0, 0), ch::make (6)));
  ASSERT_FALSE (may_lt (ph::make (60, 1, 2), ch::make (60)));
  ASSERT_FALSE (may_lt (ph::make (60, 0, 0), ch::make (60)));
  ASSERT_TRUE (may_lt (ph::make (30, 9, 4), ch::make (31)));
  ASSERT_TRUE (may_lt (ph::make (30, 0, 0), ch::make (31)));

  /* Test may_lt (C, T).  */
  ASSERT_TRUE (may_lt (ch::make (6), ph::make (7, 5, 4)));
  ASSERT_TRUE (may_lt (ch::make (6), ph::make (7, 0, 0)));
  ASSERT_EQ (may_lt (ch::make (60), ph::make (60, 1, 2)), N >= 2);
  ASSERT_EQ (may_lt (ch::make (60), ph::make (60, 0, 2)), N == 3);
  ASSERT_FALSE (may_lt (ch::make (60), ph::make (60, 0, 0)));
  ASSERT_EQ (may_lt (ch::make (31), ph::make (30, 9, 4)), N >= 2);
  ASSERT_EQ (may_lt (ch::make (31), ph::make (30, 0, 4)), N == 3);
  ASSERT_FALSE (may_lt (ch::make (31), ph::make (30, 0, 0)));

  /* Test may_lt (T, T).  */
  ASSERT_EQ (may_lt (ph::make (3, 14, 99), ph::make (2, 15, 100)), N >= 2);
  ASSERT_EQ (may_lt (ph::make (3, 14, 99), ph::make (2, 13, 100)), N == 3);
  ASSERT_EQ (may_lt (ph::make (3, 14, 99), ph::make (2, 15, 98)), N >= 2);
  ASSERT_FALSE (may_lt (ph::make (3, 14, 99), ph::make (2, 14, 99)));
  ASSERT_FALSE (may_lt (ph::make (3, 14, 99), ph::make (2, 13, 98)));
  ASSERT_EQ (may_lt (ph::make (2, 14, 99), ph::make (2, 15, 100)), N >= 2);
  ASSERT_EQ (may_lt (ph::make (2, 14, 99), ph::make (2, 13, 100)), N == 3);
  ASSERT_EQ (may_lt (ph::make (2, 14, 99), ph::make (2, 15, 98)), N >= 2);
  ASSERT_FALSE (may_lt (ph::make (2, 14, 99), ph::make (2, 14, 99)));
  ASSERT_FALSE (may_lt (ph::make (2, 14, 99), ph::make (2, 13, 98)));
  ASSERT_TRUE (may_lt (ph::make (1, 14, 99), ph::make (2, 15, 100)));
  ASSERT_TRUE (may_lt (ph::make (1, 14, 99), ph::make (2, 14, 99)));
  ASSERT_TRUE (may_lt (ph::make (1, 14, 99), ph::make (2, 13, 98)));
}

/* Test may_ge for both signed and unsigned C.  */
...
test_may_ge ()
{
  ...
  /* Test may_ge (T, C).  */
  ASSERT_TRUE (may_ge (ph::make (7, 5, 4), ch::make (6)));
  ASSERT_TRUE (may_ge (ph::make (7, 0, 0), ch::make (6)));
  ASSERT_TRUE (may_ge (ph::make (60, 1, 2), ch::make (60)));
  ASSERT_TRUE (may_ge (ph::make (60, 0, 0), ch::make (60)));
  ASSERT_EQ (may_ge (ph::make (30, 9, 4), ch::make (31)), N >= 2);
  ASSERT_EQ (may_ge (ph::make (30, 0, 4), ch::make (31)), N == 3);
  ASSERT_FALSE (may_ge (ph::make (30, 0, 0), ch::make (31)));

  /* Test may_ge (C, T).  */
  ASSERT_FALSE (may_ge (ch::make (6), ph::make (7, 5, 4)));
  ASSERT_FALSE (may_ge (ch::make (6), ph::make (7, 0, 0)));
  ASSERT_TRUE (may_ge (ch::make (60), ph::make (60, 1, 2)));
  ASSERT_TRUE (may_ge (ch::make (60), ph::make (60, 0, 0)));
  ASSERT_TRUE (may_ge (ch::make (31), ph::make (30, 9, 4)));
  ASSERT_TRUE (may_ge (ch::make (31), ph::make (30, 0, 0)));

  /* Test may_ge (T, T).  */
  ASSERT_TRUE (may_ge (ph::make (3, 14, 99), ph::make (2, 15, 100)));
  ASSERT_TRUE (may_ge (ph::make (3, 14, 99), ph::make (2, 14, 99)));
  ASSERT_TRUE (may_ge (ph::make (3, 14, 99), ph::make (2, 13, 98)));
  ASSERT_TRUE (may_ge (ph::make (2, 14, 99), ph::make (2, 15, 100)));
  ASSERT_TRUE (may_ge (ph::make (2, 14, 99), ph::make (2, 14, 99)));
  ASSERT_TRUE (may_ge (ph::make (2, 14, 99), ph::make (2, 13, 98)));
  ASSERT_FALSE (may_ge (ph::make (1, 14, 99), ph::make (2, 15, 100)));
  ASSERT_FALSE (may_ge (ph::make (1, 14, 99), ph::make (2, 14, 99)));
  ASSERT_EQ (may_ge (ph::make (1, 14, 99), ph::make (2, 15, 98)), N == 3);
  ASSERT_EQ (may_ge (ph::make (1, 14, 99), ph::make (2, 13, 100)), N >= 2);
  ASSERT_EQ (may_ge (ph::make (1, 14, 99), ph::make (2, 13, 98)), N >= 2);
}

/* Test may_gt for both signed and unsigned C.  */
...
test_may_gt ()
{
  ...
  /* Test may_gt (T, C).  */
  ASSERT_TRUE (may_gt (ph::make (7, 5, 4), ch::make (6)));
  ASSERT_TRUE (may_gt (ph::make (7, 0, 0), ch::make (6)));
  ASSERT_EQ (may_gt (ph::make (60, 1, 2), ch::make (60)), N >= 2);
  ASSERT_EQ (may_gt (ph::make (60, 0, 2), ch::make (60)), N == 3);
  ASSERT_FALSE (may_gt (ph::make (60, 0, 0), ch::make (60)));
  ASSERT_EQ (may_gt (ph::make (30, 9, 4), ch::make (31)), N >= 2);
  ASSERT_EQ (may_gt (ph::make (30, 0, 4), ch::make (31)), N == 3);
  ASSERT_FALSE (may_gt (ph::make (30, 0, 0), ch::make (31)));

  /* Test may_gt (C, T).  */
  ASSERT_FALSE (may_gt (ch::make (6), ph::make (7, 5, 4)));
  ASSERT_FALSE (may_gt (ch::make (6), ph::make (7, 0, 0)));
  ASSERT_FALSE (may_gt (ch::make (60), ph::make (60, 1, 2)));
  ASSERT_FALSE (may_gt (ch::make (60), ph::make (60, 0, 0)));
  ASSERT_TRUE (may_gt (ch::make (31), ph::make (30, 9, 4)));
  ASSERT_TRUE (may_gt (ch::make (31), ph::make (30, 0, 0)));

  /* Test may_gt (T, T).  */
  ASSERT_TRUE (may_gt (ph::make (3, 14, 99), ph::make (2, 15, 100)));
  ASSERT_TRUE (may_gt (ph::make (3, 14, 99), ph::make (2, 14, 99)));
  ASSERT_TRUE (may_gt (ph::make (3, 14, 99), ph::make (2, 13, 98)));
  ASSERT_FALSE (may_gt (ph::make (2, 14, 99), ph::make (2, 15, 100)));
  ASSERT_FALSE (may_gt (ph::make (2, 14, 99), ph::make (2, 14, 99)));
  ASSERT_EQ (may_gt (ph::make (2, 14, 99), ph::make (2, 15, 98)), N == 3);
  ASSERT_EQ (may_gt (ph::make (2, 14, 99), ph::make (2, 13, 100)), N >= 2);
  ASSERT_EQ (may_gt (ph::make (2, 14, 99), ph::make (2, 13, 98)), N >= 2);
  ASSERT_FALSE (may_gt (ph::make (1, 14, 99), ph::make (2, 15, 100)));
  ASSERT_FALSE (may_gt (ph::make (1, 14, 99), ph::make (2, 14, 99)));
  ASSERT_EQ (may_gt (ph::make (1, 14, 99), ph::make (2, 15, 98)), N == 3);
  ASSERT_EQ (may_gt (ph::make (1, 14, 99), ph::make (2, 13, 100)), N >= 2);
  ASSERT_EQ (may_gt (ph::make (1, 14, 99), ph::make (2, 13, 98)), N >= 2);
}

/* Test must_gt for both signed and unsigned C.  */
...
test_must_gt ()
{
  ...
  /* Test must_gt (T, C).  */
  ASSERT_TRUE (must_gt (ph::make (7, 5, 4), ch::make (6)));
  ASSERT_TRUE (must_gt (ph::make (7, 0, 0), ch::make (6)));
  ASSERT_FALSE (must_gt (ph::make (60, 1, 2), ch::make (60)));
  ASSERT_FALSE (must_gt (ph::make (60, 0, 0), ch::make (60)));
  ASSERT_FALSE (must_gt (ph::make (30, 9, 4), ch::make (31)));
  ASSERT_FALSE (must_gt (ph::make (30, 0, 0), ch::make (31)));

  /* Test must_gt (C, T).  */
  ASSERT_FALSE (must_gt (ch::make (6), ph::make (7, 5, 4)));
  ASSERT_FALSE (must_gt (ch::make (6), ph::make (7, 0, 0)));
  ASSERT_FALSE (must_gt (ch::make (60), ph::make (60, 1, 2)));
  ASSERT_FALSE (must_gt (ch::make (60), ph::make (60, 0, 0)));
  ASSERT_EQ (must_gt (ch::make (31), ph::make (30, 9, 4)), N == 1);
  ASSERT_EQ (must_gt (ch::make (31), ph::make (30, 0, 4)), N <= 2);
  ASSERT_TRUE (must_gt (ch::make (31), ph::make (30, 0, 0)));

  /* Test must_gt (T, T).  */
  ASSERT_EQ (must_gt (ph::make (3, 14, 99), ph::make (2, 15, 100)), N == 1);
  ASSERT_EQ (must_gt (ph::make (3, 14, 99), ph::make (2, 13, 100)), N <= 2);
  ASSERT_EQ (must_gt (ph::make (3, 14, 99), ph::make (2, 15, 98)), N == 1);
  ASSERT_TRUE (must_gt (ph::make (3, 14, 99), ph::make (2, 14, 99)));
  ASSERT_TRUE (must_gt (ph::make (3, 14, 99), ph::make (2, 13, 98)));
  ASSERT_FALSE (must_gt (ph::make (2, 14, 99), ph::make (2, 15, 100)));
  ASSERT_FALSE (must_gt (ph::make (2, 14, 99), ph::make (2, 14, 99)));
  ASSERT_FALSE (must_gt (ph::make (2, 14, 99), ph::make (2, 13, 98)));
  ASSERT_FALSE (must_gt (ph::make (1, 14, 99), ph::make (2, 15, 100)));
  ASSERT_FALSE (must_gt (ph::make (1, 14, 99), ph::make (2, 14, 99)));
  ASSERT_FALSE (must_gt (ph::make (1, 14, 99), ph::make (2, 13, 98)));
}

/* Test must_ge for both signed and unsigned C.  */
...
test_must_ge ()
{
  ...
  /* Test must_ge (T, C).  */
  ASSERT_TRUE (must_ge (ph::make (7, 5, 4), ch::make (6)));
  ASSERT_TRUE (must_ge (ph::make (7, 0, 0), ch::make (6)));
  ASSERT_TRUE (must_ge (ph::make (60, 1, 2), ch::make (60)));
  ASSERT_TRUE (must_ge (ph::make (60, 0, 0), ch::make (60)));
  ASSERT_FALSE (must_ge (ph::make (30, 9, 4), ch::make (31)));
  ASSERT_FALSE (must_ge (ph::make (30, 0, 0), ch::make (31)));

  /* Test must_ge (C, T).  */
  ASSERT_FALSE (must_ge (ch::make (6), ph::make (7, 5, 4)));
  ASSERT_FALSE (must_ge (ch::make (6), ph::make (7, 0, 0)));
  ASSERT_EQ (must_ge (ch::make (60), ph::make (60, 1, 2)), N == 1);
  ASSERT_EQ (must_ge (ch::make (60), ph::make (60, 0, 2)), N <= 2);
  ASSERT_TRUE (must_ge (ch::make (60), ph::make (60, 0, 0)));
  ASSERT_EQ (must_ge (ch::make (31), ph::make (30, 9, 4)), N == 1);
  ASSERT_EQ (must_ge (ch::make (31), ph::make (30, 0, 4)), N <= 2);
  ASSERT_TRUE (must_ge (ch::make (31), ph::make (30, 0, 0)));

  /* Test must_ge (T, T).  */
  ASSERT_EQ (must_ge (ph::make (3, 14, 99), ph::make (2, 15, 100)), N == 1);
  ASSERT_EQ (must_ge (ph::make (3, 14, 99), ph::make (2, 13, 100)), N <= 2);
  ASSERT_EQ (must_ge (ph::make (3, 14, 99), ph::make (2, 15, 98)), N == 1);
  ASSERT_TRUE (must_ge (ph::make (3, 14, 99), ph::make (2, 14, 99)));
  ASSERT_TRUE (must_ge (ph::make (3, 14, 99), ph::make (2, 13, 98)));
  ASSERT_EQ (must_ge (ph::make (2, 14, 99), ph::make (2, 15, 100)), N == 1);
  ASSERT_EQ (must_ge (ph::make (2, 14, 99), ph::make (2, 13, 100)), N <= 2);
  ASSERT_EQ (must_ge (ph::make (2, 14, 99), ph::make (2, 15, 98)), N == 1);
  ASSERT_TRUE (must_ge (ph::make (2, 14, 99), ph::make (2, 14, 99)));
  ASSERT_TRUE (must_ge (ph::make (2, 14, 99), ph::make (2, 13, 98)));
  ASSERT_FALSE (must_ge (ph::make (1, 14, 99), ph::make (2, 15, 100)));
  ASSERT_FALSE (must_ge (ph::make (1, 14, 99), ph::make (2, 14, 99)));
  ASSERT_FALSE (must_ge (ph::make (1, 14, 99), ph::make (2, 13, 98)));
}

/* Test must_lt for both signed and unsigned C.  */
...
test_must_lt ()
{
  ...
  /* Test must_lt (T, C).  */
  ASSERT_FALSE (must_lt (ph::make (7, 5, 4), ch::make (6)));
  ASSERT_FALSE (must_lt (ph::make (7, 0, 0), ch::make (6)));
  ASSERT_FALSE (must_lt (ph::make (60, 1, 2), ch::make (60)));
  ASSERT_FALSE (must_lt (ph::make (60, 0, 0), ch::make (60)));
  ASSERT_EQ (must_lt (ph::make (30, 9, 4), ch::make (31)), N == 1);
  ASSERT_EQ (must_lt (ph::make (30, 0, 4), ch::make (31)), N <= 2);
  ASSERT_TRUE (must_lt (ph::make (30, 0, 0), ch::make (31)));

  /* Test must_lt (C, T).  */
  ASSERT_TRUE (must_lt (ch::make (6), ph::make (7, 5, 4)));
  ASSERT_TRUE (must_lt (ch::make (6), ph::make (7, 0, 0)));
  ASSERT_FALSE (must_lt (ch::make (60), ph::make (60, 1, 2)));
  ASSERT_FALSE (must_lt (ch::make (60), ph::make (60, 0, 0)));
  ASSERT_FALSE (must_lt (ch::make (31), ph::make (30, 9, 4)));
  ASSERT_FALSE (must_lt (ch::make (31), ph::make (30, 0, 0)));

  /* Test must_lt (T, T).  */
  ASSERT_FALSE (must_lt (ph::make (3, 14, 99), ph::make (2, 15, 100)));
  ASSERT_FALSE (must_lt (ph::make (3, 14, 99), ph::make (2, 14, 99)));
  ASSERT_FALSE (must_lt (ph::make (3, 14, 99), ph::make (2, 13, 98)));
  ASSERT_FALSE (must_lt (ph::make (2, 14, 99), ph::make (2, 15, 100)));
  ASSERT_FALSE (must_lt (ph::make (2, 14, 99), ph::make (2, 14, 99)));
  ASSERT_FALSE (must_lt (ph::make (2, 14, 99), ph::make (2, 13, 98)));
  ASSERT_TRUE (must_lt (ph::make (1, 14, 99), ph::make (2, 15, 100)));
  ASSERT_TRUE (must_lt (ph::make (1, 14, 99), ph::make (2, 14, 99)));
  ASSERT_EQ (must_lt (ph::make (1, 14, 99), ph::make (2, 15, 98)), N <= 2);
  ASSERT_EQ (must_lt (ph::make (1, 14, 99), ph::make (2, 13, 100)), N == 1);
  ASSERT_EQ (must_lt (ph::make (1, 14, 99), ph::make (2, 13, 98)), N == 1);
}

/* Test must_le for both signed and unsigned C.  */
...
test_must_le ()
{
  ...
  /* Test must_le (T, C).  */
  ASSERT_FALSE (must_le (ph::make (7, 5, 4), ch::make (6)));
  ASSERT_FALSE (must_le (ph::make (7, 0, 0), ch::make (6)));
  ASSERT_EQ (must_le (ph::make (60, 1, 2), ch::make (60)), N == 1);
  ASSERT_EQ (must_le (ph::make (60, 0, 2), ch::make (60)), N <= 2);
  ASSERT_TRUE (must_le (ph::make (60, 0, 0), ch::make (60)));
  ASSERT_EQ (must_le (ph::make (30, 9, 4), ch::make (31)), N == 1);
  ASSERT_EQ (must_le (ph::make (30, 0, 4), ch::make (31)), N <= 2);
  ASSERT_TRUE (must_le (ph::make (30, 0, 0), ch::make (31)));

  /* Test must_le (C, T).  */
  ASSERT_TRUE (must_le (ch::make (6), ph::make (7, 5, 4)));
  ASSERT_TRUE (must_le (ch::make (6), ph::make (7, 0, 0)));
  ASSERT_TRUE (must_le (ch::make (60), ph::make (60, 1, 2)));
  ASSERT_TRUE (must_le (ch::make (60), ph::make (60, 0, 0)));
  ASSERT_FALSE (must_le (ch::make (31), ph::make (30, 9, 4)));
  ASSERT_FALSE (must_le (ch::make (31), ph::make (30, 0, 0)));

  /* Test must_le (T, T).  */
  ASSERT_FALSE (must_le (ph::make (3, 14, 99), ph::make (2, 15, 100)));
  ASSERT_FALSE (must_le (ph::make (3, 14, 99), ph::make (2, 14, 99)));
  ASSERT_FALSE (must_le (ph::make (3, 14, 99), ph::make (2, 13, 98)));
  ASSERT_TRUE (must_le (ph::make (2, 14, 99), ph::make (2, 15, 100)));
  ASSERT_TRUE (must_le (ph::make (2, 14, 99), ph::make (2, 14, 99)));
  ASSERT_EQ (must_le (ph::make (2, 14, 99), ph::make (2, 15, 98)), N <= 2);
  ASSERT_EQ (must_le (ph::make (2, 14, 99), ph::make (2, 13, 100)), N == 1);
  ASSERT_EQ (must_le (ph::make (2, 14, 99), ph::make (2, 13, 98)), N == 1);
  ASSERT_TRUE (must_le (ph::make (1, 14, 99), ph::make (2, 15, 100)));
  ASSERT_TRUE (must_le (ph::make (1, 14, 99), ph::make (2, 14, 99)));
  ASSERT_EQ (must_le (ph::make (1, 14, 99), ph::make (2, 15, 98)), N <= 2);
  ASSERT_EQ (must_le (ph::make (1, 14, 99), ph::make (2, 13, 100)), N == 1);
  ASSERT_EQ (must_le (ph::make (1, 14, 99), ph::make (2, 13, 98)), N == 1);
}
...
test_ordered_min ()
{
  ...
  ASSERT_MUST_EQ (ordered_min (ph::make (4, 0, 0), ch::make (5)),
		  ch::make (4));
  ASSERT_MUST_EQ (ordered_min (ph::make (12, 0, 0), ch::make (11)),
		  ch::make (11));
  ASSERT_MUST_EQ (ordered_min (ph::make (12, 6, 4), ch::make (11)),
		  ch::make (11));

  /* Test ordered_min (C, T).  */
  ASSERT_MUST_EQ (ordered_min (ch::make (5), ph::make (4, 0, 0)),
		  ch::make (4));
  ASSERT_MUST_EQ (ordered_min (ch::make (11), ph::make (12, 0, 0)),
		  ch::make (11));
  ASSERT_MUST_EQ (ordered_min (ch::make (11), ph::make (12, 6, 4)),
		  ch::make (11));

  /* Test ordered_min (T, T).  */
  ASSERT_MUST_EQ (ordered_min (ph::make (4, 6, 14), ph::make (5, 6, 19)),
		  ph::make (4, 6, 14));
  ASSERT_MUST_EQ (ordered_min (ph::make (4, 9, 17), ph::make (3, 9, 0)),
		  ph::make (3, 9, 0));
  ASSERT_MUST_EQ (ordered_min (ph::make (-4, -5, 12), ph::make (-3, -5, 12)),
		  ph::make (-4, -5, 12));
  ASSERT_MUST_EQ (ordered_min (ph::make (4, -9, 6), ph::make (4, -8, 6)),
		  ph::make (4, -9, 6));
  ASSERT_MUST_EQ (ordered_min (ph::make (5, -1, -14), ph::make (5, -1, -16)),
		  ph::make (5, -1, -16));
}
...
test_ordered_max ()
{
  ...
  ASSERT_MUST_EQ (ordered_max (ph::make (4, 0, 0), ch::make (5)),
		  ch::make (5));
  ASSERT_MUST_EQ (ordered_max (ph::make (12, 0, 0), ch::make (11)),
		  ch::make (12));
  ASSERT_MUST_EQ (ordered_max (ph::make (12, 6, 4), ch::make (11)),
		  ph::make (12, 6, 4));

  /* Test ordered_max (C, T).  */
  ASSERT_MUST_EQ (ordered_max (ch::make (5), ph::make (4, 0, 0)),
		  ch::make (5));
  ASSERT_MUST_EQ (ordered_max (ch::make (11), ph::make (12, 0, 0)),
		  ch::make (12));
  ASSERT_MUST_EQ (ordered_max (ch::make (11), ph::make (12, 6, 4)),
		  ph::make (12, 6, 4));

  /* Test ordered_max (T, T).  */
  ASSERT_MUST_EQ (ordered_max (ph::make (4, 6, 14), ph::make (5, 6, 19)),
		  ph::make (5, 6, 19));
  ASSERT_MUST_EQ (ordered_max (ph::make (4, 9, 17), ph::make (3, 9, 0)),
		  ph::make (4, 9, 17));
  ASSERT_MUST_EQ (ordered_max (ph::make (-4, -5, 12), ph::make (-3, -5, 12)),
		  ph::make (-3, -5, 12));
  ASSERT_MUST_EQ (ordered_max (ph::make (4, -9, 6), ph::make (4, -8, 6)),
		  ph::make (4, -8, 6));
  ASSERT_MUST_EQ (ordered_max (ph::make (5, -1, -14), ph::make (5, -1, -16)),
		  ph::make (5, -1, -14));
}
...
test_lower_bound ()
{
  ...
  ASSERT_MUST_EQ (lower_bound (ph::make (7, 2, 15), ch::make (4)),
		  ch::make (4));
  ASSERT_MUST_EQ (lower_bound (ph::make (100, 5, 50), ch::make (200)),
		  ch::make (100));

  /* Test lower_bound (C, T).  */
  ASSERT_MUST_EQ (lower_bound (ch::make (4), ph::make (7, 2, 15)),
		  ch::make (4));
  ASSERT_MUST_EQ (lower_bound (ch::make (200), ph::make (100, 5, 50)),
		  ch::make (100));

  /* Test lower_bound (T, T).  */
  ASSERT_MUST_EQ (lower_bound (ph::make (7, 2, 15), ph::make (5, 19, 14)),
		  ph::make (5, 2, 14));
  ASSERT_MUST_EQ (lower_bound (ph::make (100, 5, 50), ph::make (200, 0, 80)),
		  ph::make (100, 0, 50));
}
...
test_upper_bound ()
{
  ...
  ASSERT_MUST_EQ (upper_bound (ph::make (7, 2, 15), ch::make (4)),
		  ph::make (7, 2, 15));
  ASSERT_MUST_EQ (upper_bound (ph::make (100, 5, 50), ch::make (200)),
		  ph::make (200, 5, 50));

  /* Test upper_bound (C, T).  */
  ASSERT_MUST_EQ (upper_bound (ch::make (4), ph::make (7, 2, 15)),
		  ph::make (7, 2, 15));
  ASSERT_MUST_EQ (upper_bound (ch::make (200), ph::make (100, 5, 50)),
		  ph::make (200, 5, 50));

  /* Test upper_bound (T, T).  */
  ASSERT_MUST_EQ (upper_bound (ph::make (7, 2, 15), ph::make (5, 19, 14)),
		  ph::make (7, 19, 15));
  ASSERT_MUST_EQ (upper_bound (ph::make (100, 5, 50), ph::make (200, 0, 80)),
		  ph::make (200, 5, 80));
}
...
test_force_align_up_and_div ()
{
  ...
  ASSERT_MUST_EQ (force_align_up_and_div (ph::make (17, 0, 0), 16),
		  ch::make (2));
  ASSERT_MUST_EQ (force_align_up_and_div (ph::make (16, 0, 0), 16),
		  ch::make (1));
  ASSERT_MUST_EQ (force_align_up_and_div (ph::make (15, 0, 0), 16),
		  ch::make (1));
  ASSERT_MUST_EQ (force_align_up_and_div (ph::make (-17, 0, 0), 16),
		  ch::make (C (-16) / 16));
  ASSERT_MUST_EQ (force_align_up_and_div (ph::make (-16, 0, 0), 16),
...
test_force_align_down_and_div ()
{
  ...
  ASSERT_MUST_EQ (force_align_down_and_div (ph::make (17, 0, 0), 16),
		  ch::make (1));
  ASSERT_MUST_EQ (force_align_down_and_div (ph::make (16, 0, 0), 16),
		  ch::make (1));
  ASSERT_MUST_EQ (force_align_down_and_div (ph::make (15, 0, 0), 16),
		  ch::make (0));
  ASSERT_MUST_EQ (force_align_down_and_div (ph::make (-17, 0, 0), 16),
		  ch::make (C (-32) / 16));
  ASSERT_MUST_EQ (force_align_down_and_div (ph::make (-16, 0, 0), 16),
...
test_multiple_p_with_result ()
{
  ...
  ASSERT_MUST_EQ (multiple, ch::make (3));
  ...
  ASSERT_MUST_EQ (multiple, ch::make (N <= 2 ? 4 : 3));
  ASSERT_EQ (multiple_p (30, ph::make (6, 6, 6), &multiple), N == 1);
  ASSERT_MUST_EQ (multiple, ch::make (N == 1 ? 5 : N == 2 ? 4 : 3));
  ...
  ASSERT_EQ (multiple_p (ph::make (44, 0, 0),
			 ...
			 &multiple), N <= 2);
  if (N <= 2)
    ASSERT_MUST_EQ (multiple, ch::make (4));
  ASSERT_EQ (multiple_p (ph::make (30, 0, 0),
			 ph::make (6, 6, 6),
			 &multiple), N == 1);
  if (N == 1)
    ASSERT_MUST_EQ (multiple, ch::make (5));
  ASSERT_TRUE (multiple_p (ph::make (0, 0, 0),
			   ph::make (5, 4, 11),
			   &multiple));
  ASSERT_MUST_EQ (multiple, ch::make (0));
  ...
  ASSERT_TRUE (multiple_p (ph::make (120, 0, 90),
			   ph::make (12, 0, 9),
			   &multiple));
  ASSERT_MUST_EQ (multiple, ch::make (10));
  ASSERT_EQ (multiple_p (ph::make (110, 1, 22),
			 ph::make (10, 0, 2),
			 &multiple), N == 1);
  ASSERT_MUST_EQ (multiple, ch::make (N == 1 ? 11 : 10));
  ASSERT_EQ (multiple_p (ph::make (120, -1, 22),
			 ph::make (10, 0, 2),
			 &multiple), N == 1);
  ASSERT_MUST_EQ (multiple, ch::make (N == 1 ? 12 : 10));
  ASSERT_EQ (multiple_p (ph::make (130, 0, 26),
			 ph::make (10, 1, 2),
			 &multiple), N == 1);
  ASSERT_MUST_EQ (multiple, ch::make (N == 1 ? 13 : 10));
  ASSERT_EQ (multiple_p (ph::make (140, 0, 28),
			 ph::make (10, -1, 2),
			 &multiple), N == 1);
  ASSERT_MUST_EQ (multiple, ch::make (N == 1 ? 14 : 10));
  ASSERT_FALSE (multiple_p (ph::make (89, 0, 0),
			    ph::make (11, 0, 0),
			    &multiple));
  ASSERT_TRUE (multiple_p (ph::make (88, 0, 0),
			   ph::make (11, 0, 0),
			   &multiple));
  ASSERT_MUST_EQ (multiple, ch::make (8));
  ASSERT_FALSE (multiple_p (ph::make (87, 0, 0),
			    ph::make (11, 0, 0),
			    &multiple));
  ASSERT_TRUE (multiple_p (ph::make (35, 63, 0),
			   ph::make (5, 9, 0),
			   &multiple));
  ASSERT_MUST_EQ (multiple, ch::make (7));
  ASSERT_TRUE (multiple_p (ph::make (0, 0, 0),
			   ph::make (11, -24, 25),
			   &multiple));
  ASSERT_MUST_EQ (multiple, ch::make (0));
...
test_exact_div ()
{
  ...
  /* Test exact_div (T, C).  */
  ASSERT_MUST_EQ (exact_div (ph::make (15, 0, 0), 5),
		  ch::make (3));
  ASSERT_MUST_EQ (exact_div (ph::make (44, 0, 55), 11),
		  ph::make (4, 0, 5));
  ASSERT_MUST_EQ (exact_div (ph::make (30, 30, 0), 6),
		  ph::make (5, 5, 0));
  ASSERT_MUST_EQ (exact_div (ph::make (30, 35, 45), 5),
		  ph::make (6, 7, 9));
  ASSERT_MUST_EQ (exact_div (ph::make (0, 0, 0), 5),
		  ch::make (0));

  /* Test exact_div (T, T).  */
  ASSERT_MUST_EQ (exact_div (ph::make (15, 0, 0),
			     ph::make (5, 0, 0)),
		  ch::make (3));
  ASSERT_MUST_EQ (exact_div (ph::make (44, 0, 55),
			     ph::make (11, 0, 0)),
		  ph::make (4, 0, 5));
  ASSERT_MUST_EQ (exact_div (ph::make (30, 30, 0),
			     ph::make (6, 0, 0)),
		  ph::make (5, 5, 0));
  ASSERT_MUST_EQ (exact_div (ph::make (30, 35, 45),
			     ph::make (5, 0, 0)),
		  ph::make (6, 7, 9));
  ASSERT_MUST_EQ (exact_div (ph::make (0, 0, 0),
			     ph::make (5, 0, 0)),
		  ch::make (0));
  ASSERT_MUST_EQ (exact_div (ph::make (15, 0, 0),
			     ph::make (5, 0, 0)),
  ...
  ASSERT_MUST_EQ (exact_div (ph::make (0, 0, 0),
			     ph::make (5, 4, 11)),
		  ch::make (0));
  ASSERT_MUST_EQ (exact_div (ph::make (5, 15, 25),
			     ph::make (1, 3, 5)),
		  ch::make (5));
  ASSERT_MUST_EQ (exact_div (ph::make (120, 0, 90),
			     ph::make (12, 0, 9)),
		  ch::make (10));
  ASSERT_MUST_EQ (exact_div (ph::make (88, 0, 0),
			     ph::make (11, 0, 0)),
		  ch::make (8));
  ASSERT_MUST_EQ (exact_div (ph::make (35, 63, 0),
			     ph::make (5, 9, 0)),
		  ch::make (7));
  ASSERT_MUST_EQ (exact_div (ph::make (0, 0, 0),
			     ph::make (11, -24, 25)),
...
test_can_div_trunc_p_const ()
{
  ...
  ASSERT_TRUE (can_div_trunc_p (ph::make (8, 44, 28),
				...
				&const_quot, &rem));
  ASSERT_EQ (const_quot, C (4));
  ASSERT_MUST_EQ (rem, ch::make (0));
  ASSERT_TRUE (can_div_trunc_p (ph::make (9, 23, 30),
				ph::make (4, 8, 12),
				&const_quot, &rem));
  ASSERT_EQ (const_quot, C (2));
  ASSERT_MUST_EQ (rem, ph::make (1, 7, 6));
  ASSERT_EQ (can_div_trunc_p (ph::make (15, 25, 40),
			      ph::make (4, 8, 10),
			      &const_quot, &rem), N <= 2);
  ASSERT_EQ (const_quot, C (N <= 2 ? 3 : 2));
  if (N <= 2)
    ASSERT_MUST_EQ (rem, ph::make (3, 1, 0));
  ASSERT_EQ (can_div_trunc_p (ph::make (43, 79, 80),
			      ph::make (4, 8, 10),
			      &const_quot, &rem), N == 1);
  ASSERT_EQ (const_quot, C (N == 1 ? 10 : N == 2 ? 3 : 2));
  if (N == 1)
    ASSERT_MUST_EQ (rem, ch::make (3));
  ASSERT_TRUE (can_div_trunc_p (ph::make (3, 4, 5),
				ph::make (4, 5, 6),
				&const_quot, &rem));
  ASSERT_EQ (const_quot, C (0));
  ASSERT_MUST_EQ (rem, ph::make (3, 4, 5));
  ASSERT_TRUE (can_div_trunc_p (ph::make (3, 4, 6),
				ph::make (4, 5, 6),
				&const_quot, &rem));
  ASSERT_EQ (const_quot, C (0));
  ASSERT_MUST_EQ (rem, ph::make (3, 4, 6));
  ASSERT_TRUE (can_div_trunc_p (ph::make (3, 5, 5),
				ph::make (4, 5, 6),
				&const_quot, &rem));
  ASSERT_EQ (const_quot, C (0));
  ASSERT_MUST_EQ (rem, ph::make (3, 5, 5));
  ASSERT_TRUE (can_div_trunc_p (ph::make (56, 0, 11),
				ph::make (11, 0, 2),
				&const_quot, &rem));
  ASSERT_EQ (const_quot, C (5));
  ASSERT_MUST_EQ (rem, ph::make (1, 0, 1));
  ASSERT_EQ (can_div_trunc_p (ph::make (66, 1, 12),
			      ph::make (11, 0, 2),
			      &const_quot, &rem), N == 1);
  ASSERT_EQ (const_quot, C (N == 1 ? 6 : 5));
  ...
  ASSERT_TRUE (can_div_trunc_p (ph::make (89, 0, 0),
				...
				&const_quot, &rem));
  ASSERT_EQ (const_quot, C (8));
  ASSERT_MUST_EQ (rem, ch::make (1));
  ASSERT_EQ (can_div_trunc_p (ph::make (101, 0, 1),
			      ph::make (11, 0, 0),
			      &const_quot, &rem), N <= 2);
  ASSERT_EQ (const_quot, C (N <= 2 ? 9 : 8));
  if (N <= 2)
    ASSERT_MUST_EQ (rem, ch::make (2));
  ASSERT_TRUE (can_div_trunc_p (ph::make (0, 0, 0),
				ph::make (4, 5, 6),
				&const_quot, &rem));
  ASSERT_EQ (const_quot, C (0));
...
test_ranges_may_overlap_p ()
{
  ...
  ASSERT_TRUE (ranges_may_overlap_p (ph::make (4, 1, 2),
				     ch::make (-1),
				     ph::make (500, 3, 5),
				     ch::make (1)));
  ASSERT_FALSE (ranges_may_overlap_p (ph::make (100, 1, 5),
				      ch::make (-1),
				      ph::make (50, 1, 5),
				      ch::make (50)));
  ASSERT_EQ (ranges_may_overlap_p (ph::make (100, 1, 5),
				   ch::make (-1),
				   ph::make (50, 0, 6),
				   ch::make (50)), N == 3);
  ASSERT_EQ (ranges_may_overlap_p (ph::make (100, 1, 5),
				   ...
				   ph::make (50, 2, 0),
				   ch::make (50)), N >= 2);
  ASSERT_TRUE (ranges_may_overlap_p (ph::make (500, 3, 5),
				     ch::make (1),
				     ph::make (4, 1, 2),
				     ch::make (-1)));
  ASSERT_FALSE (ranges_may_overlap_p (ph::make (50, 1, 5),
				      ch::make (50),
				      ph::make (100, 1, 5),
				      ch::make (-1)));
  ASSERT_FALSE (ranges_may_overlap_p (ph::make (10, 2, 3),
				      ch::make (0),
				      ch::make (0),
				      ph::make (20, 30, 40)));
  ASSERT_EQ (ranges_may_overlap_p (ph::make (10, 2, 3),
				   ph::make (0, 1, 1),
				   ph::make (0, 1, 1),
				   ph::make (20, 30, 40)), N >= 2);
  ASSERT_FALSE (ranges_may_overlap_p (ch::make (0),
				      ph::make (20, 30, 40),
				      ph::make (10, 2, 3),
				      ch::make (0)));
  ASSERT_EQ (ranges_may_overlap_p (ph::make (0, 1, 1),
				   ph::make (20, 30, 40),
				   ph::make (10, 2, 3),
				   ph::make (0, 1, 0)), N >= 2);
  ASSERT_TRUE (ranges_may_overlap_p (ph::make (8, 10, 15),
				     ph::make (2, 6, 20),
				     ch::make (7),
				     ch::make (2)));
  ASSERT_FALSE (ranges_may_overlap_p (ph::make (8, 10, 15),
				      ph::make (2, 6, 20),
				      ch::make (6),
				      ph::make (2, 10, 15)));
  ASSERT_EQ (ranges_may_overlap_p (ph::make (8, 10, 15),
				   ph::make (2, 6, 20),
				   ch::make (6),
				   ph::make (0, 0, 16)), N == 3);
  ASSERT_EQ (ranges_may_overlap_p (ph::make (8, 10, 15),
				   ...
				   ch::make (6),
				   ph::make (0, 11, 0)), N >= 2);
  ASSERT_FALSE (ranges_may_overlap_p (ph::make (80, 4, 5),
				      ph::make (10, 6, 7),
				      ph::make (100, 10, 12),
				      ph::make (20, 1, 2)));
  ASSERT_EQ (ranges_may_overlap_p (ph::make (80, 4, 5),
				   ph::make (10, 6, 7),
				   ph::make (100, 10, 11),
				   ph::make (0, 0, 2)), N == 3);
  ASSERT_EQ (ranges_may_overlap_p (ph::make (80, 5, 5),
				   ph::make (0, 6, 0),
				   ph::make (100, 10, 12),
				   ph::make (20, 1, 2)), N >= 2);
}
...
test_ranges_must_overlap_p ()
{
  ...
  ASSERT_FALSE (ranges_must_overlap_p (ph::make (5, 1, 2),
				       ch::make (-1),
				       ch::make (4),
				       ch::make (2)));
  ASSERT_FALSE (ranges_must_overlap_p (ch::make (9),
				       ph::make (2, 3, 4),
				       ch::make (10),
				       ch::make (-1)));
  ASSERT_FALSE (ranges_must_overlap_p (ph::make (10, 2, 3),
				       ch::make (0),
				       ch::make (0),
				       ph::make (20, 30, 40)));
  ASSERT_FALSE (ranges_must_overlap_p (ph::make (10, 2, 3),
				       ...
				       ph::make (0, 1, 1),
				       ph::make (20, 30, 40)));
  ASSERT_FALSE (ranges_must_overlap_p (ch::make (0),
				       ph::make (20, 30, 40),
				       ph::make (10, 2, 3),
				       ch::make (0)));
  ASSERT_FALSE (ranges_must_overlap_p (ph::make (0, 1, 1),
				       ph::make (20, 30, 40),
				       ph::make (10, 2, 3),
				       ph::make (0, 1, 0)));
  ASSERT_EQ (ranges_must_overlap_p (ph::make (5, 1, 2),
				    ch::make (1),
				    ch::make (4),
				    ch::make (2)), N == 1);
  ASSERT_TRUE (ranges_must_overlap_p (ph::make (5, 1, 2),
				      ch::make (1),
				      ph::make (4, 1, 2),
				      ch::make (2)));
  ASSERT_TRUE (ranges_must_overlap_p (ch::make (9),
				      ph::make (2, 3, 4),
				      ch::make (10),
				      ch::make (1)));
  ASSERT_FALSE (ranges_must_overlap_p (ph::make (10, 11, 12),
				       ph::make (20, 30, 40),
				       ch::make (30),
				       ch::make (1)));
  ASSERT_TRUE (ranges_must_overlap_p (ph::make (10, 11, 12),
				      ph::make (20, 30, 40),
				      ph::make (29, 41, 52),
				      ch::make (1)));
  ASSERT_EQ (ranges_must_overlap_p (ph::make (10, 11, 12),
				    ph::make (20, 30, 40),
				    ph::make (29, 41, 53),
				    ch::make (1)), N <= 2);
  ASSERT_EQ (ranges_must_overlap_p (ph::make (10, 11, 12),
				    ...
				    ph::make (29, 42, 52),
				    ch::make (1)), N == 1);
  ASSERT_TRUE (ranges_must_overlap_p (ph::make (29, 41, 52),
				      ch::make (1),
				      ph::make (10, 11, 12),
				      ph::make (20, 30, 40)));
  ASSERT_EQ (ranges_must_overlap_p (ph::make (29, 41, 53),
				    ch::make (1),
				    ph::make (10, 11, 12),
				    ph::make (20, 30, 40)), N <= 2);
  ASSERT_EQ (ranges_must_overlap_p (ph::make (29, 42, 52),
				    ch::make (1),
				    ph::make (10, 11, 12),
				    ph::make (20, 30, 40)), N == 1);
  ASSERT_TRUE (ranges_must_overlap_p (ph::make (10, 0, 20),
				      ph::make (4, 4, 4),
				      ph::make (7, 3, 20),
				      ph::make (4, 4, 4)));
}
...
test_signed_negation ()
{
  ...
  /* Test unary -.  */
  ASSERT_MUST_EQ (-ph::make (-11, 22, -33),
		  rph::make (11, -22, 33));

  /* Test wi::neg.  */
  ASSERT_MUST_EQ (wi::neg (ph::make (-11, 22, -33)),
		  iph::make (11, -22, 33));
}
...
test_signed_may_le ()
{
  ...
  ASSERT_EQ (may_le (ph::make (-2, 4, -2),
		     ph::make (-3, -5, -1)), N == 3);
  ASSERT_EQ (may_le (ph::make (-2, -6, 0),
		     ph::make (-3, 0, 100)), N >= 2);
  ASSERT_FALSE (may_le (ph::make (-2, 5, 1),
			ph::make (-3, 4, 0)));
}

/* Test may_lt for signed C.  */
...
test_signed_may_lt ()
{
  ...
  /* Test may_lt (T, C).  */
  ASSERT_EQ (may_lt (ph::make (3, 5, -1), ch::make (2)), N == 3);
  ASSERT_EQ (may_lt (ph::make (40, -10, 60), ch::make (15)), N >= 2);
  ASSERT_TRUE (may_lt (ph::make (-18, 0, 0), ch::make (18)));
  ASSERT_EQ (may_lt (ph::make (-2, -2, -2), ch::make (-2)), N >= 2);

  /* Test may_lt (C, T).  */
  ASSERT_EQ (may_lt (ch::make (4), ph::make (3, 5, -1)), N >= 2);
  ...
  ASSERT_EQ (may_lt (ph::make (-3, 4, -2),
		     ph::make (-3, -5, -1)), N == 3);
  ASSERT_EQ (may_lt (ph::make (-3, -6, 0),
		     ph::make (-3, 0, 100)), N >= 2);
  ASSERT_FALSE (may_lt (ph::make (-3, 5, 1),
			ph::make (-3, 4, 0)));
}

/* Test may_ge for signed C.  */
...
test_signed_may_ge ()
{
  ...
  /* Test may_ge (T, C).  */
  ASSERT_EQ (may_ge (ph::make (3, 5, -1), ch::make (4)), N >= 2);
  ASSERT_EQ (may_ge (ph::make (40, -10, 60), ch::make (41)), N == 3);
  ASSERT_TRUE (may_ge (ph::make (11, 0, 0), ch::make (-15)));
  ...
  ASSERT_EQ (may_ge (ph::make (-3, -5, -1),
		     ph::make (-2, 4, -2)), N == 3);
  ASSERT_EQ (may_ge (ph::make (-3, 0, 100),
		     ph::make (-2, -6, 0)), N >= 2);
  ASSERT_FALSE (may_ge (ph::make (-3, 4, 0),
			ph::make (-2, 5, 1)));
}

/* Test may_gt for signed C.  */
...
test_signed_may_gt ()
{
  ...
  /* Test may_gt (T, C).  */
  ASSERT_EQ (may_gt (ph::make (3, 5, -1), ch::make (4)), N >= 2);
  ...
  ASSERT_TRUE (may_gt (ch::make (18), ph::make (-18, 0, 0)));
  ASSERT_EQ (may_gt (ch::make (-2), ph::make (-2, -2, -2)), N >= 2);

  /* Test may_gt (T, T).  */
  ASSERT_EQ (may_gt (ph::make (-3, -5, -1),
		     ph::make (-3, 4, -2)), N == 3);
  ASSERT_EQ (may_gt (ph::make (-3, 0, 100),
		     ph::make (-3, -6, 0)), N >= 2);
  ASSERT_FALSE (may_gt (ph::make (-3, 4, 0),
			ph::make (-3, 5, 1)));
}

/* Test must_gt for signed C.  */
...
test_signed_must_gt ()
{
  ...
  ASSERT_EQ (must_gt (ph::make (-2, 4, -2),
		      ph::make (-3, -5, -1)), N <= 2);
  ASSERT_EQ (must_gt (ph::make (-2, -6, 0),
		     ph::make (-3, 0, 100)), N == 1);
  ASSERT_TRUE (must_gt (ph::make (-2, 5, 1),
			ph::make (-3, 4, 0)));
}

/* Test must_ge for signed C.  */
...
test_signed_must_ge ()
{
  ...
  /* Test must_ge (T, C).  */
  ASSERT_EQ (must_ge (ph::make (3, 5, -1), ch::make (2)), N <= 2);
  ASSERT_EQ (must_ge (ph::make (40, -10, 60), ch::make (15)), N == 1);
  ASSERT_FALSE (must_ge (ph::make (-18, 0, 0), ch::make (18)));
  ASSERT_EQ (must_ge (ph::make (-2, -2, -2), ch::make (-2)), N == 1);

  /* Test must_ge (C, T).  */
  ASSERT_EQ (must_ge (ch::make (4), ph::make (3, 5, -1)), N == 1);
  ...
  ASSERT_EQ (must_ge (ph::make (-3, 4, -2),
		      ph::make (-3, -5, -1)), N <= 2);
  ASSERT_EQ (must_ge (ph::make (-3, -6, 0),
		      ph::make (-3, 0, 100)), N == 1);
  ASSERT_TRUE (must_ge (ph::make (-3, 5, 1),
			ph::make (-3, 4, 0)));
}

/* Test must_lt for signed C.  */
...
test_signed_must_lt ()
{
  ...
  /* Test must_lt (T, C).  */
  ASSERT_EQ (must_lt (ph::make (3, 5, -1), ch::make (4)), N == 1);
  ASSERT_EQ (must_lt (ph::make (40, -10, 60), ch::make (41)), N <= 2);
  ASSERT_FALSE (must_lt (ph::make (11, 0, 0), ch::make (-15)));
  ...
  ASSERT_EQ (must_lt (ph::make (-3, -5, -1),
		      ph::make (-2, 4, -2)), N <= 2);
  ASSERT_EQ (must_lt (ph::make (-3, 0, 100),
		      ph::make (-2, -6, 0)), N == 1);
  ASSERT_TRUE (must_lt (ph::make (-3, 4, 0),
			ph::make (-2, 5, 1)));
}

/* Test must_le for signed C.  */
...
test_signed_must_le ()
{
  ...
  /* Test must_le (T, C).  */
  ASSERT_EQ (must_le (ph::make (3, 5, -1), ch::make (4)), N == 1);
  ...
  ASSERT_FALSE (must_le (ch::make (18), ph::make (-18, 0, 0)));
  ASSERT_EQ (must_le (ch::make (-2), ph::make (-2, -2, -2)), N == 1);

  /* Test must_le (T, T).  */
  ASSERT_EQ (must_le (ph::make (-3, -5, -1),
		      ph::make (-3, 4, -2)), N <= 2);
  ASSERT_EQ (must_le (ph::make (-3, 0, 100),
		      ph::make (-3, -6, 0)), N == 1);
  ASSERT_TRUE (must_le (ph::make (-3, 4, 0),
			ph::make (-3, 5, 1)));
}
...
test_signed_ordered_min ()
{
  ...
  /* Test ordered_min (T, C).  */
  ASSERT_MUST_EQ (ordered_min (ph::make (4, -12, -14), ch::make (5)),
		  ph::make (4, -12, -14));

  /* Test ordered_min (C, T).  */
  ASSERT_MUST_EQ (ordered_min (ch::make (9), ph::make (9, -90, -77)),
		  ph::make (9, -90, -77));

  /* Test ordered_min (T, T).  */
  ASSERT_MUST_EQ (ordered_min (ph::make (4, 9, 17), ph::make (4, -1, 17)),
		  ph::make (4, -1, 17));
}
...
test_signed_ordered_max ()
{
  ...
  /* Test ordered_max (T, C).  */
  ASSERT_MUST_EQ (ordered_max (ph::make (4, -12, -14), ch::make (5)),
		  ch::make (5));

  /* Test ordered_max (C, T).  */
  ASSERT_MUST_EQ (ordered_max (ch::make (9), ph::make (9, -90, -77)),
		  ch::make (9));

  /* Test ordered_max (T, T).  */
  ASSERT_MUST_EQ (ordered_max (ph::make (4, 9, 17), ph::make (4, -1, 17)),
		  ph::make (4, 9, 17));
}
...
test_signed_lower_bound ()
{
  ...
  /* Test lower_bound (T, C).  */
  ASSERT_MUST_EQ (lower_bound (ph::make (4, -1, 3), ch::make (5)),
		  ph::make (4, -1, 0));
  ASSERT_MUST_EQ (lower_bound (ph::make (6, 5, -14), ch::make (-11)),
		  ph::make (-11, 0, -14));

  /* Test lower_bound (C, T).  */
  ASSERT_MUST_EQ (lower_bound (ch::make (5), ph::make (4, -1, 3)),
		  ph::make (4, -1, 0));
  ASSERT_MUST_EQ (lower_bound (ch::make (-11), ph::make (6, 5, -14)),
		  ph::make (-11, 0, -14));

  /* Test lower_bound (T, T).  */
  ASSERT_MUST_EQ (lower_bound (ph::make (4, -1, 3), ph::make (5, 7, -2)),
		  ph::make (4, -1, -2));
  ASSERT_MUST_EQ (lower_bound (ph::make (6, 5, -14), ph::make (-11, 4, 3)),
		  ph::make (-11, 4, -14));
}
...
test_signed_upper_bound ()
{
  ...
  /* Test upper_bound (T, C).  */
  ASSERT_MUST_EQ (upper_bound (ph::make (4, -1, 3), ch::make (5)),
		  ph::make (5, 0, 3));
  ASSERT_MUST_EQ (upper_bound (ph::make (6, 5, -14), ch::make (-11)),
		  ph::make (6, 5, 0));

  /* Test upper_bound (C, T).  */
  ASSERT_MUST_EQ (upper_bound (ch::make (5), ph::make (4, -1, 3)),
		  ph::make (5, 0, 3));
  ASSERT_MUST_EQ (upper_bound (ch::make (-11), ph::make (6, 5, -14)),
		  ph::make (6, 5, 0));

  /* Test upper_bound (T, T).  */
  ASSERT_MUST_EQ (upper_bound (ph::make (4, -1, 3), ph::make (5, 7, -2)),
		  ph::make (5, 7, 3));
  ASSERT_MUST_EQ (upper_bound (ph::make (6, 5, -14), ph::make (-11, 4, 3)),
		  ph::make (6, 5, 3));
}
...
test_signed_multiple_p_with_result ()
{
  ...
  ASSERT_MUST_EQ (multiple, ph::make (-5, 4, 0));
  ASSERT_TRUE (multiple_p (ph::make (63, 0, -14), -7, &multiple));
  ASSERT_MUST_EQ (multiple, ph::make (-9, 0, 2));
  ...
  ASSERT_MUST_EQ (multiple, ph::make (-10, -2, 1));
  ASSERT_EQ (multiple_p (ph::make (-120, -24, 11), 12, &multiple), N <= 2);
  if (N <= 2)
    ASSERT_MUST_EQ (multiple, ph::make (-10, -2, 0));
  ...
  ASSERT_MUST_EQ (multiple, ch::make (-9));
  ...
  ASSERT_MUST_EQ (multiple, ch::make (N == 1 ? -10 : 10));

  /* Test multiple_p (T, T) -> T.  */
  ASSERT_TRUE (multiple_p (ph::make (-40, 80, -200),
			   ph::make (2, -4, 10),
			   &multiple));
  ASSERT_MUST_EQ (multiple, ch::make (-20));
  ASSERT_EQ (multiple_p (ph::make (-20, 40, 100),
			 ph::make (2, -4, 10),
			 &multiple), N <= 2);
  if (N <= 2)
...
test_signed_exact_div ()
{
  ...
  /* Test exact_div (T, C).  */
  ASSERT_MUST_EQ (exact_div (ph::make (-45, 36, 0), 9),
		  ph::make (-5, 4, 0));
  ASSERT_MUST_EQ (exact_div (ph::make (63, 0, -14), -7),
		  ph::make (-9, 0, 2));
  ASSERT_MUST_EQ (exact_div (ph::make (-120, 0, 0), -12),
		  ch::make (10));
  ASSERT_MUST_EQ (exact_div (ph::make (-120, -24, 12), 12),
		  ph::make (-10, -2, 1));

  /* Test exact_div (T, T).  */
  ASSERT_MUST_EQ (exact_div (ph::make (-40, 80, -200),
			     ph::make (2, -4, 10)),
		  ch::make (-20));
  ASSERT_MUST_EQ (exact_div (ph::make (-30, 0, 0),
			     ph::make (-6, 0, 0)),
		  ch::make (5));
}
...
test_signed_can_div_trunc_p_const ()
{
  ...
  ASSERT_EQ (can_div_trunc_p (ph::make (-5, 2, 0),
			      ph::make (-3, 2, 0),
			      &const_quot, &rem), N == 1);
  ASSERT_MUST_EQ (const_quot, N == 1 ? 1 : -5);
  if (N == 1)
    ASSERT_MUST_EQ (rem, ch::make (-2));
  /* Similarly for the third coefficient.  */
  ASSERT_EQ (can_div_trunc_p (ph::make (-5, -5, 2),
			      ph::make (-3, -3, 2),
			      &const_quot, &rem), N <= 2);
  ASSERT_MUST_EQ (const_quot, N <= 2 ? 1 : -5);
  if (N <= 2)
    ASSERT_MUST_EQ (rem, ph::make (-2, -2, 0));
  /* (-15 + 3x) / (-12 + 2x) != 1 when x == 7.  */
  ASSERT_EQ (can_div_trunc_p (ph::make (-15, 3, 0),
			      ph::make (-12, 2, 0),
			      &const_quot, &rem), N == 1);
  ...
  ASSERT_TRUE (can_div_trunc_p (ph::make (-21, -18, -14),
				...
				&const_quot, &rem));
  ASSERT_EQ (const_quot, -4);
  ASSERT_MUST_EQ (rem, ph::make (-1, -2, -2));
  ASSERT_TRUE (can_div_trunc_p (ph::make (18, 9, 13),
				ph::make (-8, -4, -5),
				&const_quot, &rem));
  ASSERT_EQ (const_quot, -2);
  ASSERT_MUST_EQ (rem, ph::make (2, 1, 3));
}
...
/* Test may_le for unsigned C.  */

template<unsigned int N, typename C, typename T>
static void
test_unsigned_may_le ()
{
  typedef coeff_helper<C> ch;
  typedef poly_helper<T> ph;
...
/* Test may_lt for unsigned C.  */

template<unsigned int N, typename C, typename T>
static void
test_unsigned_may_lt ()
{
  typedef coeff_helper<C> ch;
  typedef poly_helper<T> ph;

  /* Test may_lt (T, C).  */
  ASSERT_FALSE (may_lt (ph::make (3, 5, -1), ch::make (2)));
  ASSERT_FALSE (may_lt (ph::make (40, -10, 60), ch::make (15)));
  ASSERT_FALSE (may_lt (ph::make (-18, 0, 0), ch::make (18)));
  ASSERT_FALSE (may_lt (ph::make (-2, -2, -2), ch::make (-2)));
...
/* Test may_ge for unsigned C.  */

template<unsigned int N, typename C, typename T>
static void
test_unsigned_may_ge ()
{
  typedef coeff_helper<C> ch;
  typedef poly_helper<T> ph;
  ...
  /* Test may_ge (T, C).  */
  ASSERT_EQ (may_ge (ph::make (3, 5, -1), ch::make (4)), N >= 2);
  ASSERT_EQ (may_ge (ph::make (40, -10, 60), ch::make (41)), N >= 2);
  ASSERT_FALSE (may_ge (ph::make (11, 0, 0), ch::make (-15)));
...
/* Test may_gt for unsigned C.  */

template<unsigned int N, typename C, typename T>
static void
test_unsigned_may_gt ()
{
  typedef coeff_helper<C> ch;
  typedef poly_helper<T> ph;
  ...
  ASSERT_FALSE (may_gt (ch::make (18), ph::make (-18, 0, 0)));
  ASSERT_FALSE (may_gt (ch::make (-2), ph::make (-2, -2, -2)));
...
/* Test must_gt for unsigned C.  */

template<unsigned int N, typename C, typename T>
static void
test_unsigned_must_gt ()
{
  typedef coeff_helper<C> ch;
  typedef poly_helper<T> ph;
...
/* Test must_ge for unsigned C.  */

template<unsigned int N, typename C, typename T>
static void
test_unsigned_must_ge ()
{
  typedef coeff_helper<C> ch;
  typedef poly_helper<T> ph;

  /* Test must_ge (T, C).  */
  ASSERT_TRUE (must_ge (ph::make (3, 5, -1), ch::make (2)));
  ASSERT_TRUE (must_ge (ph::make (40, -10, 60), ch::make (15)));
  ASSERT_TRUE (must_ge (ph::make (-18, 0, 0), ch::make (18)));
  ASSERT_TRUE (must_ge (ph::make (-2, -2, -2), ch::make (-2)));
...
/* Test must_lt for unsigned C.  */

template<unsigned int N, typename C, typename T>
static void
test_unsigned_must_lt ()
{
  typedef coeff_helper<C> ch;
  typedef poly_helper<T> ph;
  ...
  /* Test must_lt (T, C).  */
  ASSERT_EQ (must_lt (ph::make (3, 5, -1), ch::make (4)), N == 1);
  ASSERT_EQ (must_lt (ph::make (40, -10, 60), ch::make (41)), N == 1);
  ASSERT_TRUE (must_lt (ph::make (11, 0, 0), ch::make (-15)));
...
/* Test must_le for unsigned C.  */

template<unsigned int N, typename C, typename T>
static void
test_unsigned_must_le ()
{
  typedef coeff_helper<C> ch;
  typedef poly_helper<T> ph;
  ...
  ASSERT_TRUE (must_le (ch::make (18), ph::make (-18, 0, 0)));
  ASSERT_TRUE (must_le (ch::make (-2), ph::make (-2, -2, -2)));
...
test_unsigned_ordered_min ()
{
  ...
  /* Test ordered_min (T, C).  */
  ASSERT_MUST_EQ (ordered_min (ph::make (5, -12, -14), ch::make (5)),
		  ch::make (5));
...
test_unsigned_ordered_max ()
{
  ...
  /* Test ordered_max (T, C).  */
  ASSERT_MUST_EQ (ordered_max (ph::make (5, -12, -14), ch::make (5)),
		  ph::make (5, -12, -14));
...
test_hwi ()
{
  ...
  ASSERT_MUST_EQ (common_multiple (ph::make (8, 24, 16), 6),
		  ph::make (24, 72, 48));
  ASSERT_MUST_EQ (common_multiple (ph::make (30, 0, 0), 45),
		  ch::make (90));
  if (N >= 2)
    ASSERT_MUST_EQ (common_multiple (ph::make (18, 15, 0), 12),
		    ph::make (72, 60, 0));
  if (N == 3)
    ASSERT_MUST_EQ (common_multiple (ph::make (18, 15, 4), 12),
		    ph::make (216, 180, 48));

  /* Test common_multiple (C, T).  */
  ASSERT_MUST_EQ (common_multiple (6, ph::make (8, 24, 16)),
		  ph::make (24, 72, 48));
  ASSERT_MUST_EQ (common_multiple (45, ph::make (30, 0, 0)),
		  ch::make (90));
  if (N >= 2)
    ASSERT_MUST_EQ (common_multiple (12, ph::make (18, 15, 0)),
		    ph::make (72, 60, 0));
  if (N == 3)
    ASSERT_MUST_EQ (common_multiple (12, ph::make (18, 15, 4)),
		    ph::make (216, 180, 48));

  /* Test force_common_multiple.  */
  ASSERT_MUST_EQ (force_common_multiple (ph::make (30, 0, 0),
					 ph::make (25, 0, 0)),
		  ph::make (150, 0, 0));
  if (N >= 2)
    {
      ASSERT_MUST_EQ (force_common_multiple (ph::make (16, 24, 0),
					     ph::make (24, 36, 0)),
		      ph::make (48, 72, 0));
      ASSERT_MUST_EQ (force_common_multiple (ph::make (16, 24, 0),
					     ph::make (12, 0, 0)),
		      ph::make (48, 72, 0));
      ASSERT_MUST_EQ (force_common_multiple (ph::make (15, 0, 0),
					     ph::make (21, 9, 0)),
		      ph::make (105, 45, 0));
    }
  if (N == 3)
    {
      ASSERT_MUST_EQ (force_common_multiple (ph::make (33, 99, 66),
					     ph::make (22, 66, 44)),
		      ph::make (66, 198, 132));
      ASSERT_MUST_EQ (force_common_multiple (ph::make (30, 0, 45),
					     ph::make (12, 0, 18)),
		      ph::make (60, 0, 90));
      ASSERT_MUST_EQ (force_common_multiple (ph::make (40, 0, 50),
					     ph::make (8, 0, 0)),
		      ph::make (160, 0, 200));
      ASSERT_MUST_EQ (force_common_multiple (ph::make (6, 0, 0),
					     ph::make (10, 0, 15)),
		      ph::make (60, 0, 90));
      ASSERT_MUST_EQ (force_common_multiple (ph::make (20, 40, 30),
					     ph::make (15, 0, 0)),
		      ph::make (60, 120, 90));
      ASSERT_MUST_EQ (force_common_multiple (ph::make (9, 0, 0),
					     ph::make (90, 81, 27)),
		      ph::make (90, 81, 27));
    }
}
...
test_to_shwi (const C &srcv, int delta, HOST_WIDE_INT destv)
{
  ...
  ASSERT_MUST_EQ (shwi, ps64h::make (destv,
				     destv - delta,
				     destv - delta * 2));
  ...
  if (N == 1)
    ASSERT_MUST_EQ (shwi, destv);
  ASSERT_EQ (ph::make (srcv - delta,
		       srcv,
		       srcv + delta).to_shwi (&shwi), N <= 2);
  if (N <= 2)
    ASSERT_MUST_EQ (shwi, ps64h::make (destv - delta,
				       destv,
				       destv /* ignored */));
...
test_to_uhwi (const C &srcv, int delta, unsigned HOST_WIDE_INT destv)
{
  ...
  ASSERT_MUST_EQ (uhwi, pu64h::make (destv,
				     destv - delta,
				     destv - delta * 2));
  ...
  if (N == 1)
    ASSERT_MUST_EQ (uhwi, destv);
  ASSERT_EQ (ph::make (srcv - delta,
		       srcv,
		       srcv + delta).to_uhwi (&uhwi), N <= 2);
  if (N <= 2)
    ASSERT_MUST_EQ (uhwi, pu64h::make (destv - delta,
				       destv,
				       destv /* ignored */));
...
test_force_hwi (const C &mask66)
{
  ...
  /* Test force_shwi.  */
  ASSERT_MUST_EQ (ph::make (mask66, mask65, mask64).force_shwi (),
		  ps64h::make (HOST_WIDE_INT_M1,
			       HOST_WIDE_INT_M1,
			       HOST_WIDE_INT_M1));
  ASSERT_MUST_EQ (ph::make (mask65, mask64, mask63).force_shwi (),
		  ps64h::make (HOST_WIDE_INT_M1,
			       HOST_WIDE_INT_M1,
			       HOST_WIDE_INT_MAX));
  ASSERT_MUST_EQ (ph::make (mask64, mask63, mask62).force_shwi (),
		  ps64h::make (HOST_WIDE_INT_M1,
			       HOST_WIDE_INT_MAX,
			       HOST_WIDE_INT_MAX / 2));
  ASSERT_MUST_EQ (ph::make (mask63, mask62, mask61).force_shwi (),
		  ps64h::make (HOST_WIDE_INT_MAX,
			       HOST_WIDE_INT_MAX / 2,
			       HOST_WIDE_INT_MAX / 4));

  /* Test force_uhwi.  */
  ASSERT_MUST_EQ (ph::make (mask66, mask65, mask64).force_uhwi (),
		  pu64h::make (HOST_WIDE_INT_M1U,
			       HOST_WIDE_INT_M1U,
			       HOST_WIDE_INT_M1U));
  ASSERT_MUST_EQ (ph::make (mask65, mask64, mask63).force_uhwi (),
		  pu64h::make (HOST_WIDE_INT_M1U,
			       HOST_WIDE_INT_M1U,
			       HOST_WIDE_INT_M1U >> 1));
  ASSERT_MUST_EQ (ph::make (mask64, mask63, mask62).force_uhwi (),
		  pu64h::make (HOST_WIDE_INT_M1U,
			       HOST_WIDE_INT_M1U >> 1,
			       HOST_WIDE_INT_M1U >> 2));
  ASSERT_MUST_EQ (ph::make (mask63, mask62, mask61).force_uhwi (),
...
test_wide_int_from ()
{
  ...
  T p_8_3_1 = ph::make (wi::uhwi (8, 3),
			wi::uhwi (3, 3),
			wi::uhwi (1, 3));
  ASSERT_MUST_EQ (T::from (pu8h::make (0xf8,0x23,0x81), 3, SIGNED),
		  p_8_3_1);
  ASSERT_MUST_EQ (T::from (pu8h::make (0xf8,0x23,0x81), 3, UNSIGNED),
		  p_8_3_1);
  ...
  T p_f8_23_81 = ph::make (wi::uhwi (0xf8, 8),
			   wi::uhwi (0x23, 8),
			   wi::uhwi (0x81, 8));
  ASSERT_MUST_EQ (T::from (pu8h::make (0xf8,0x23,0x81), 8, SIGNED),
		  p_f8_23_81);
  ASSERT_MUST_EQ (T::from (pu8h::make (0xf8,0x23,0x81), 8, UNSIGNED),
		  p_f8_23_81);
  ...
  T p_fff8_0023_ff81 = ph::make (wi::uhwi (0xfff8, 16),
				 wi::uhwi (0x0023, 16),
				 wi::uhwi (0xff81, 16));
  ASSERT_MUST_EQ (T::from (pu8h::make (0xf8,0x23,0x81), 16, SIGNED),
		  p_fff8_0023_ff81);
...
test_wide_int_sext ()
{
  ...
  ASSERT_MUST_EQ (wi::sext (ph::make (wi::shwi (16, 12),
				      wi::shwi (63, 12),
				      wi::shwi (14, 12)), 5),
		  ph::make (wi::shwi (-16, 12),
			    wi::shwi (-1, 12),
			    wi::shwi (14, 12)));
  ASSERT_MUST_EQ (wi::sext (ph::make (wi::shwi (1024, 12),
				      wi::shwi (1023, 12),
				      wi::shwi (1200, 12)), 11),
...
test_wide_int_zext ()
{
  ...
  ASSERT_MUST_EQ (wi::zext (ph::make (wi::uhwi (16, 12),
				      wi::uhwi (63, 12),
				      wi::uhwi (14, 12)), 5),
		  ph::make (wi::uhwi (16, 12),
			    wi::uhwi (31, 12),
			    wi::uhwi (14, 12)));
  ASSERT_MUST_EQ (wi::zext (ph::make (wi::uhwi (1024, 12),
				      wi::uhwi (1023, 12),
				      wi::uhwi (3248, 12)), 11),
...
test_wide_int_add ()
{
  ...
  bool overflow;
  ASSERT_MUST_EQ (wi::add (ph::make (wi::uhwi (15, 4),
				     wi::uhwi (4, 4),
				     wi::uhwi (2, 4)),
			   ph::make (wi::uhwi (1, 4),
				     wi::uhwi (0, 4),
  ...
  ASSERT_MUST_EQ (wi::add (ph::make (wi::uhwi (30, 5),
				     wi::uhwi (6, 5),
				     wi::uhwi (11, 5)),
			   ph::make (wi::uhwi (1, 5),
				     wi::uhwi (26, 5),
  ...
  ASSERT_MUST_EQ (wi::add (ph::make (wi::uhwi (1, 6),
				     wi::uhwi (63, 6),
				     wi::uhwi (50, 6)),
  ...
  ASSERT_MUST_EQ (wi::add (ph::make (wi::shwi (7, 4),
				     wi::shwi (7, 4),
				     wi::shwi (-8, 4)),
			   ph::make (wi::shwi (1, 4),
				     wi::shwi (0, 4),
		  ...
		  ph::make (wi::shwi (-8, 4),
			    ...
			    wi::shwi (-8, 4)));
  ASSERT_TRUE (overflow);
  ASSERT_MUST_EQ (wi::add (ph::make (wi::shwi (-1, 5),
				     wi::shwi (6, 5),
				     wi::shwi (11, 5)),
		  ...
		  ph::make (wi::shwi (14, 5),
			    ...
			    wi::shwi (-4, 5)));
  ASSERT_EQ (overflow, N >= 2);
  ASSERT_MUST_EQ (wi::add (ph::make (wi::shwi (4, 6),
				     wi::shwi (0, 6),
				     wi::shwi (-1, 6)),
...
test_wide_int_sub ()
{
  ...
  bool overflow;
  ASSERT_MUST_EQ (wi::sub (ph::make (wi::uhwi (0, 4),
				     wi::uhwi (4, 4),
				     wi::uhwi (2, 4)),
			   ph::make (wi::uhwi (1, 4),
				     wi::uhwi (0, 4),
		  ...
		  ph::make (wi::uhwi (15, 4),
			    ...
			    wi::uhwi (2, 4)));
  ASSERT_TRUE (overflow);
  ASSERT_MUST_EQ (wi::sub (ph::make (wi::uhwi (30, 5),
				     wi::uhwi (29, 5),
				     wi::uhwi (11, 5)),
			   ph::make (wi::uhwi (1, 5),
				     wi::uhwi (31, 5),
		  ...
		  ph::make (wi::uhwi (29, 5),
			    ...
			    wi::uhwi (2, 5)));
  ASSERT_EQ (overflow, N >= 2);
  ASSERT_MUST_EQ (wi::sub (ph::make (wi::uhwi (0, 6),
				     wi::uhwi (63, 6),
				     wi::uhwi (0, 6)),
			   ph::make (wi::uhwi (0, 6),
				     wi::uhwi (0, 6),
  ...
  ASSERT_MUST_EQ (wi::sub (ph::make (wi::shwi (-8, 4),
				     wi::shwi (5, 4),
				     wi::shwi (-7, 4)),
			   ph::make (wi::shwi (1, 4),
				     wi::shwi (0, 4),
		  ...
		  ph::make (wi::shwi (7, 4),
			    ...
			    wi::shwi (-7, 4)));
  ASSERT_TRUE (overflow);
  ASSERT_MUST_EQ (wi::sub (ph::make (wi::shwi (-1, 5),
				     wi::shwi (-7, 5),
				     wi::shwi (0, 5)),
			   ph::make (wi::shwi (15, 5),
				     wi::shwi (11, 5),
		  ...
		  ph::make (wi::shwi (-16, 5),
			    ...
			    wi::shwi (15, 5)));
  ASSERT_EQ (overflow, N >= 2);
  ASSERT_MUST_EQ (wi::sub (ph::make (wi::shwi (-32, 6),
				     wi::shwi (-1, 6),
				     wi::shwi (0, 6)),
			   ph::make (wi::shwi (-32, 6),
				     wi::shwi (-32, 6),
...
test_wide_int_mul ()
{
  ...
  bool overflow;
  ASSERT_MUST_EQ (wi::mul (ph::make (wi::uhwi (4, 4),
				     wi::uhwi (3, 4),
				     wi::uhwi (2, 4)), 4,
			   UNSIGNED, &overflow),
		  ph::make (wi::uhwi (0, 4),
			    ...
			    wi::uhwi (8, 4)));
  ASSERT_TRUE (overflow);
  ASSERT_MUST_EQ (wi::mul (ph::make (wi::uhwi (15, 5),
				     wi::uhwi (31, 5),
				     wi::uhwi (7, 5)), 2,
			   UNSIGNED, &overflow),
		  ph::make (wi::uhwi (30, 5),
			    ...
			    wi::uhwi (14, 5)));
  ASSERT_EQ (overflow, N >= 2);
  ASSERT_MUST_EQ (wi::mul (ph::make (wi::uhwi (1, 6),
				     wi::uhwi (0, 6),
				     wi::uhwi (2, 6)), 63,
			   UNSIGNED, &overflow),
  ...
  ASSERT_MUST_EQ (wi::mul (ph::make (wi::shwi (-1, 4),
				     wi::shwi (1, 4),
				     wi::shwi (0, 4)), -8,
			   SIGNED, &overflow),
		  ph::make (wi::shwi (-8, 4),
			    ...
			    wi::shwi (0, 4)));
  ASSERT_TRUE (overflow);
  ASSERT_MUST_EQ (wi::mul (ph::make (wi::shwi (2, 5),
				     wi::shwi (-3, 5),
				     wi::shwi (1, 5)), 6,
			   SIGNED, &overflow),
		  ph::make (wi::shwi (12, 5),
			    ...
			    wi::shwi (6, 5)));
  ASSERT_EQ (overflow, N >= 2);
  ASSERT_MUST_EQ (wi::mul (ph::make (wi::shwi (5, 6),
				     wi::shwi (-6, 6),
				     wi::shwi (7, 6)), -5,
			   SIGNED, &overflow),
...
test_wide_int_neg ()
{
  ...
  ASSERT_MUST_EQ (wi::neg (ph::make (wi::shwi (-8, 4),
		  ...
		  ph::make (wi::shwi (-8, 4),
			    ...
			    wi::shwi (7, 4)));
  ASSERT_TRUE (overflow);
  ASSERT_MUST_EQ (wi::neg (ph::make (wi::shwi (-15, 5),
				     wi::shwi (-16, 5),
		  ...
		  ph::make (wi::shwi (15, 5),
			    ...
			    wi::shwi (-15, 5)));
  ASSERT_EQ (overflow, N >= 2);
  ASSERT_MUST_EQ (wi::neg (ph::make (wi::shwi (-28, 6),
				     wi::shwi (30, 6),
...
test_fixed_int (void)
{
  ...
  /* Test signed case.  */
  ASSERT_MUST_EQ (T::from (pih::make (-100, 200, -300), SIGNED),
		  ph::make (-100, 200, -300));
  ASSERT_MAY_NE (T::from (pih::make (-100, 200, -300), SIGNED),
		 ph::make (-100U, 200U, -300U));

  /* Test unsigned case.  */
  ASSERT_MAY_NE (T::from (pih::make (-100, 200, -300), UNSIGNED),
		 ph::make (-100, 200, -300));
  ASSERT_MUST_EQ (T::from (pih::make (-100, 200, -300), UNSIGNED),
		  ph::make (-100U, 200U, -300U));
...
test_type_promotions ()
{
  ...
  ASSERT_MUST_EQ (pu16h::make (0xffff, 0xfffe, 0xfffd)
		  + pu16h::make (4, 10, 17),
  ...
  ASSERT_MUST_EQ (pu16h::make (1, 2, 3) - pu16h::make (100, 200, 300),
		  ps64h::make (-99, -198, -297));

  /* Same for unary -.  */
  ASSERT_MUST_EQ (-pu16h::make (0x8000, 0x9000, 0xa000),
  ...
  ASSERT_MUST_EQ (aligned, ps64h::make (a - 16, b, c));

  /* Likewise for can_align_down.  */
  ASSERT_TRUE (can_align_down (ps64h::make (a - 31, b, c), 16U, &aligned));
  ASSERT_MUST_EQ (aligned, ps64h::make (a - 32, b, c));

  /* Same for the force_* routines.  */
  ASSERT_MUST_EQ (force_align_up (ps64h::make (a - 31, b, c), 16U),
		  ps64h::make (a - 16, b, c));
  ASSERT_MUST_EQ (force_align_down (ps64h::make (a - 31, b, c), 16U),
		  ps64h::make (a - 32, b, c));

  /* Same for the aligned_*_bound routines.  */
  ASSERT_MUST_EQ (aligned_upper_bound (ps64h::make (a - 31, b - 33, c - 55),
				       16U),
		  ps64h::make (a - 16, b - 32, c - 48));
  ASSERT_MUST_EQ (aligned_lower_bound (ps64h::make (a - 31, b - 33, c - 55),
				       16U),
...
test_shwi ()
{
  ...
  mult = ph::make (wi::shwi (80, 16),
		   wi::shwi (-10, 16),
		   wi::shwi (70, 16)) * 3;
  ASSERT_MUST_EQ (mult, ph::make (wi::shwi (240, 16),
				  wi::shwi (-30, 16),
				  wi::shwi (210, 16)));
}
...
test_uhwi ()
{
  ...
  mult = ph::make (wi::uhwi (80, 16),
		   wi::uhwi (-10, 16),
		   wi::uhwi (70, 16)) * 3;
  ASSERT_MUST_EQ (mult, ph::make (wi::uhwi (240, 16),
				  wi::uhwi (-30, 16),
				  wi::uhwi (210, 16)));
}
...
test_signed ()
{
  ...
  test_signed_may_le<N, C, T> ();
  test_signed_may_lt<N, C, T> ();
  test_signed_may_ge<N, C, T> ();
  test_signed_may_gt<N, C, T> ();
  test_signed_must_gt<N, C, T> ();
  test_signed_must_ge<N, C, T> ();
  test_signed_must_lt<N, C, T> ();
  test_signed_must_le<N, C, T> ();
...
{
  test_ordered<N, C, RC, T> ();
  test_unsigned_may_le<N, C, T> ();
  test_unsigned_may_lt<N, C, T> ();
  test_unsigned_may_ge<N, C, T> ();
  test_unsigned_may_gt<N, C, T> ();
  test_unsigned_must_gt<N, C, T> ();
  test_unsigned_must_ge<N, C, T> ();
  test_unsigned_must_lt<N, C, T> ();
  test_unsigned_must_le<N, C, T> ();
