...
**	ret
*/
TEST_UNIFORM_ZS (abd_w0_f16_m_tied1, svfloat16_t, __fp16,
		 z0 = svabd_n_f16_m (p0, z0, x0),
		 z0 = svabd_m (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_w0_f16_m_untied, svfloat16_t, __fp16,
		 z0 = svabd_n_f16_m (p0, z1, x0),
		 z0 = svabd_m (p0, z1, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_w0_f16_z_tied1, svfloat16_t, __fp16,
		 z0 = svabd_n_f16_z (p0, z0, x0),
		 z0 = svabd_z (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_w0_f16_z_untied, svfloat16_t, __fp16,
		 z0 = svabd_n_f16_z (p0, z1, x0),
		 z0 = svabd_z (p0, z1, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_w0_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svabd_n_f16_x (p0, z0, x0),
		 z0 = svabd_x (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_w0_f16_x_untied, svfloat16_t, __fp16,
		 z1 = svabd_n_f16_x (p0, z0, x0),
		 z1 = svabd_x (p0, z0, x0))
...
**	ptrue	(p[0-7])\.h[^\n]*
**	fabd	z1\.h, \1/m, z1\.h, z0\.h
**	ret
*/
TEST_UNIFORM_Z (ptrue_abd_f16_x_tied2, svfloat16_t,
		z1 = svabd_f16_x (svptrue_b16 (), z0, z1),
		z1 = svabd_x (svptrue_b16 (), z0, z1))
...
TEST_UNIFORM_Z (ptrue_abd_f16_x_untied, svfloat16_t,
		z2 = svabd_f16_x (svptrue_b16 (), z0, z1),
		z2 = svabd_x (svptrue_b16 (), z0, z1))

/*
** ptrue_abd_w0_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), w0
**	fabd	z0\.h, \1/m, z0\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_abd_w0_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svabd_n_f16_x (svptrue_b16 (), z0, x0),
		 z0 = svabd_x (svptrue_b16 (), z0, x0))

/*
** ptrue_abd_w0_f16_x_untied:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	z1\.h, w0
**	fabd	z1\.h, \1/m, z1\.h, z0\.h
**	ret
*/
TEST_UNIFORM_ZS (ptrue_abd_w0_f16_x_untied, svfloat16_t, __fp16,
		 z1 = svabd_n_f16_x (svptrue_b16 (), z0, x0),
...
TEST_UNIFORM_Z (ptrue_abd_2_f16_x_untied, svfloat16_t,
		z1 = svabd_n_f16_x (svptrue_b16 (), z0, 2),
		z1 = svabd_x (svptrue_b16 (), z0, 2))

/*
** ptrue_b8_abd_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	fabd	z0\.h, \1/m, z0\.h, z1\.h
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_abd_f16_x_tied1, svfloat16_t,
		z0 = svabd_f16_x (svptrue_b8 (), z0, z1),
		z0 = svabd_x (svptrue_b8 (), z0, z1))

/*
** ptrue_b8_abd_f16_x_tied2:
**	ptrue	(p[0-7])\.h[^\n]*
**	fabd	z1\.h, \1/m, z1\.h, z0\.h
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_abd_f16_x_tied2, svfloat16_t,
		z1 = svabd_f16_x (svptrue_b8 (), z0, z1),
		z1 = svabd_x (svptrue_b8 (), z0, z1))

/*
** ptrue_b8_abd_f16_x_untied:
**	ptrue	(p[0-7])\.h[^\n]*
**	movprfx	z2, z0
**	fabd	z2\.h, \1/m, z2\.h, z1\.h
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_abd_f16_x_untied, svfloat16_t,
		z2 = svabd_f16_x (svptrue_b8 (), z0, z1),
