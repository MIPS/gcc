...
TEST_UNIFORM_ZS (ptrue_abd_w0_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svabd_n_f16_x (svptrue_b16 (), z1, x0),
		 z0 = svabd_x (svptrue_b16 (), z1, x0))
...
TEST_UNIFORM_ZS (ptrue_abd_h4_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svabd_n_f16_x (svptrue_b16 (), z0, d4),
		 z0 = svabd_x (svptrue_b16 (), z0, d4))
...
TEST_UNIFORM_ZS (ptrue_abd_h4_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svabd_n_f16_x (svptrue_b16 (), z1, d4),
		 z0 = svabd_x (svptrue_b16 (), z1, d4))
...
TEST_UNIFORM_Z (ptrue_b8_abd_f16_x_tied2, svfloat16_t,
		z0 = svabd_f16_x (svptrue_b8 (), z1, z0),
...
TEST_UNIFORM_Z (ptrue_b8_abd_f16_x_untied, svfloat16_t,
		z0 = svabd_f16_x (svptrue_b8 (), z1, z2),
