...
**	ret
*/
TEST_UNIFORM_ZS (abd_d4_f64_m_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d4_f64_m_untied, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d4_f64_z_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d4_f64_z_untied, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d4_f64_x_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d4_f64_x_untied, svfloat64_t, double,
...
TEST_UNIFORM_ZS (ptrue_abd_x0_f64_x_untied, svfloat64_t, double,
		 z0 = svabd_n_f64_x (svptrue_b64 (), z1, x0),
		 z0 = svabd_x (svptrue_b64 (), z1, x0))

/*
** ptrue_abd_d4_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), d4
**	fabd	z0\.d, \1/m, z0\.d, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_abd_d4_f64_x_tied1, svfloat64_t, double,
		 z0 = svabd_n_f64_x (svptrue_b64 (), z0, d4),
		 z0 = svabd_x (svptrue_b64 (), z0, d4))

/*
** ptrue_abd_d4_f64_x_untied:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	z0\.d, d4
**	fabd	z0\.d, \1/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_abd_d4_f64_x_untied, svfloat64_t, double,
		 z0 = svabd_n_f64_x (svptrue_b64 (), z1, d4),
		 z0 = svabd_x (svptrue_b64 (), z1, d4))
...
TEST_UNIFORM_Z (ptrue_b8_abd_f64_x_tied2, svfloat64_t,
		z0 = svabd_f64_x (svptrue_b8 (), z1, z0),
...
TEST_UNIFORM_Z (ptrue_b8_abd_f64_x_untied, svfloat64_t,
		z0 = svabd_f64_x (svptrue_b8 (), z1, z2),
