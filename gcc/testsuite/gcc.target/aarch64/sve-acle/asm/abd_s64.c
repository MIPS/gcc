...
**	ret
*/
TEST_UNIFORM_ZS (abd_d4_s64_m_tied1, svint64_t, int64_t,
		 z0 = svabd_n_s64_m (p0, z0, d4),
		 z0 = svabd_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d4_s64_m_untied, svint64_t, int64_t,
		 z0 = svabd_n_s64_m (p0, z1, d4),
		 z0 = svabd_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d4_s64_z_tied1, svint64_t, int64_t,
		 z0 = svabd_n_s64_z (p0, z0, d4),
		 z0 = svabd_z (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d4_s64_z_untied, svint64_t, int64_t,
		 z0 = svabd_n_s64_z (p0, z1, d4),
		 z0 = svabd_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d4_s64_x_tied1, svint64_t, int64_t,
		 z0 = svabd_n_s64_x (p0, z0, d4),
		 z0 = svabd_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d4_s64_x_untied, svint64_t, int64_t,
		 z0 = svabd_n_s64_x (p0, z1, d4),
		 z0 = svabd_x (p0, z1, d4))
