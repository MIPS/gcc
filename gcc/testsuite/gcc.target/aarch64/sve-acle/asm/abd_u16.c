...
**	ret
*/
TEST_UNIFORM_ZS (abd_h0_u16_m_tied1, svuint16_t, uint16_t,
		 z1 = svabd_n_u16_m (p0, z1, d0),
		 z1 = svabd_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_h0_u16_m_untied, svuint16_t, uint16_t,
		 z1 = svabd_n_u16_m (p0, z2, d0),
		 z1 = svabd_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_h0_u16_z_tied1, svuint16_t, uint16_t,
		 z1 = svabd_n_u16_z (p0, z1, d0),
		 z1 = svabd_z (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_h0_u16_z_untied, svuint16_t, uint16_t,
		 z1 = svabd_n_u16_z (p0, z2, d0),
		 z1 = svabd_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_h0_u16_x_tied1, svuint16_t, uint16_t,
		 z1 = svabd_n_u16_x (p0, z1, d0),
		 z1 = svabd_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_h0_u16_x_untied, svuint16_t, uint16_t,
		 z2 = svabd_n_u16_x (p0, z1, d0),
		 z2 = svabd_x (p0, z1, d0))
