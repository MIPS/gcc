...
**	ret
*/
TEST_UNIFORM_ZS (abd_x0_u64_m_tied1, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (abd_x0_u64_m_untied, svuint64_t, uint64_t,
...
** abd_d0_u64_m_tied1:
**	mov	(z[0-9]+\.d), d0
**	uabd	z1\.d, p0/m, z1\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (abd_d0_u64_m_tied1, svuint64_t, uint64_t,
		 z1 = svabd_n_u64_m (p0, z1, d0),
		 z1 = svabd_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d0_u64_m_untied, svuint64_t, uint64_t,
		 z1 = svabd_n_u64_m (p0, z2, d0),
		 z1 = svabd_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_x0_u64_z_tied1, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (abd_x0_u64_z_untied, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d0_u64_z_tied1, svuint64_t, uint64_t,
		 z1 = svabd_n_u64_z (p0, z1, d0),
		 z1 = svabd_z (p0, z1, d0))
...
**	mov	(z[0-9]+\.d), d0
**	movprfx	z1\.d, p0/z, \1
**	uabd	z1\.d, p0/m, z1\.d, z2\.d
**	ret
*/
TEST_UNIFORM_ZS (abd_d0_u64_z_untied, svuint64_t, uint64_t,
		 z1 = svabd_n_u64_z (p0, z2, d0),
		 z1 = svabd_z (p0, z2, d0))
...
TEST_UNIFORM_Z (abd_u64_x_tied2, svuint64_t,
		z1 = svabd_u64_x (p0, z0, z1),
		z1 = svabd_x (p0, z0, z1))

/*
** abd_u64_x_untied:
**	movprfx	z2, z0
**	uabd	z2\.d, p0/m, z2\.d, z1\.d
**	ret
*/
TEST_UNIFORM_Z (abd_u64_x_untied, svuint64_t,
		z2 = svabd_u64_x (p0, z0, z1),
		z2 = svabd_x (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_x0_u64_x_tied1, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (abd_x0_u64_x_untied, svuint64_t, uint64_t,
		 z1 = svabd_n_u64_x (p0, z0, x0),
		 z1 = svabd_x (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d0_u64_x_tied1, svuint64_t, uint64_t,
		 z1 = svabd_n_u64_x (p0, z1, d0),
		 z1 = svabd_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (abd_d0_u64_x_untied, svuint64_t, uint64_t,
		 z2 = svabd_n_u64_x (p0, z1, d0),
		 z2 = svabd_x (p0, z1, d0))
