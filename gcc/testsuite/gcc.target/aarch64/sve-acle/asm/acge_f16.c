...
**	ret
*/
TEST_COMPARE_ZS (acge_w0_f16, svfloat16_t, float16_t,
		 p0 = svacge_n_f16 (p1, z0, x0),
		 p0 = svacge (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (acge_h4_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (acge_0_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (acge_1_f16, svfloat16_t, float16_t,
