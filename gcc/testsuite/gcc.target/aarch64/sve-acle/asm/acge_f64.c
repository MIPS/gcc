...
**	ret
*/
TEST_COMPARE_ZS (acge_x0_f64, svfloat64_t, float64_t,
		 p0 = svacge_n_f64 (p1, z0, x0),
		 p0 = svacge (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (acge_d4_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (acge_0_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (acge_1_f64, svfloat64_t, float64_t,
