...
**	ret
*/
TEST_COMPARE_ZS (acgt_w0_f16, svfloat16_t, float16_t,
		 p0 = svacgt_n_f16 (p1, z0, x0),
		 p0 = svacgt (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (acgt_h4_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (acgt_0_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (acgt_1_f16, svfloat16_t, float16_t,
