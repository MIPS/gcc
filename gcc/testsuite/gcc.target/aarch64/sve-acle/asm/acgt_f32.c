...
**	ret
*/
TEST_COMPARE_ZS (acgt_w0_f32, svfloat32_t, float32_t,
		 p0 = svacgt_n_f32 (p1, z0, x0),
		 p0 = svacgt (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (acgt_s4_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (acgt_0_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (acgt_1_f32, svfloat32_t, float32_t,
