...
**	ret
*/
TEST_COMPARE_ZS (acgt_x0_f64, svfloat64_t, float64_t,
		 p0 = svacgt_n_f64 (p1, z0, x0),
		 p0 = svacgt (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (acgt_d4_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (acgt_0_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (acgt_1_f64, svfloat64_t, float64_t,
