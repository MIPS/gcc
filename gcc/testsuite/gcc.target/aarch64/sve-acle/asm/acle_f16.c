...
**	ret
*/
TEST_COMPARE_ZS (acle_w0_f16, svfloat16_t, float16_t,
		 p0 = svacle_n_f16 (p1, z0, x0),
		 p0 = svacle (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (acle_h4_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (acle_0_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (acle_1_f16, svfloat16_t, float16_t,
