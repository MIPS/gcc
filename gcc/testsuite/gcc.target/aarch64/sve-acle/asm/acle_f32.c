...
**	ret
*/
TEST_COMPARE_ZS (acle_w0_f32, svfloat32_t, float32_t,
		 p0 = svacle_n_f32 (p1, z0, x0),
		 p0 = svacle (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (acle_s4_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (acle_0_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (acle_1_f32, svfloat32_t, float32_t,
