...
**	ret
*/
TEST_COMPARE_ZS (acle_x0_f64, svfloat64_t, float64_t,
		 p0 = svacle_n_f64 (p1, z0, x0),
		 p0 = svacle (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (acle_d4_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (acle_0_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (acle_1_f64, svfloat64_t, float64_t,
