...
**	ret
*/
TEST_COMPARE_ZS (aclt_w0_f16, svfloat16_t, float16_t,
		 p0 = svaclt_n_f16 (p1, z0, x0),
		 p0 = svaclt (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (aclt_h4_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (aclt_0_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (aclt_1_f16, svfloat16_t, float16_t,
