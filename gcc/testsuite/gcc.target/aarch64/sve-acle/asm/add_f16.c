...
/*
** ptrue_b8_add_f16_x_tied1:
**	fadd	z0\.h, (z0\.h, z1\.h||z1\.h, z0\.h)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_add_f16_x_tied1, svfloat16_t,
		z0 = svadd_f16_x (svptrue_b8 (), z0, z1),
		z0 = svadd_x (svptrue_b8 (), z0, z1))

/*
** ptrue_b8_add_f16_x_tied2:
**	fadd	z1\.h, (z1\.h, z0\.h|z0\.h, z1\.h)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_add_f16_x_tied2, svfloat16_t,
		z1 = svadd_f16_x (svptrue_b8 (), z0, z1),
		z1 = svadd_x (svptrue_b8 (), z0, z1))

/*
** ptrue_b8_add_f16_x_untied:
**	fadd	z2\.h, (z0\.h, z1\.h|z1\.h, z0\.h)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_add_f16_x_untied, svfloat16_t,
