...
**	ret
*/
TEST_UNIFORM_Z (add_2_f32_x_tied, svfloat32_t,
...
/*
** ptrue_add_2_f32_x_z0:
**	fmov	(z[0-9]+\.s), #2\.0(e\+0)?
**	fadd	z0\.s, (z0\.s, \1|\1, z0\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_add_2_f32_x_z0, svfloat32_t,
		z0 = svadd_n_f32_x (svptrue_b32 (), z0, 2),
		z0 = svadd_x (svptrue_b32 (), z0, 2))

/*
** ptrue_add_2_f32_x_z1:
**	fmov	(z[0-9]+\.s), #2\.0(e\+0)?
**	fadd	z1\.s, (z0\.s, \1|\1, z0\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_add_2_f32_x_z1, svfloat32_t,
		z1 = svadd_n_f32_x (svptrue_b32 (), z0, 2),
		z1 = svadd_x (svptrue_b32 (), z0, 2))

/*
** ptrue_b16_add_f32_x_z0:
**	fadd	z0\.s, (z0\.s, z1\.s||z1\.s, z0\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b16_add_f32_x_z0, svfloat32_t,
		z0 = svadd_f32_x (svptrue_b16 (), z0, z1),
		z0 = svadd_x (svptrue_b16 (), z0, z1))

/*
** ptrue_b16_add_f32_x_z1:
**	fadd	z1\.s, (z1\.s, z0\.s|z0\.s, z1\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b16_add_f32_x_z1, svfloat32_t,
		z1 = svadd_f32_x (svptrue_b16 (), z0, z1),
		z1 = svadd_x (svptrue_b16 (), z0, z1))

/*
** ptrue_b16_add_f32_x_z2:
**	fadd	z2\.s, (z0\.s, z1\.s|z1\.s, z0\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b16_add_f32_x_z2, svfloat32_t,
		z2 = svadd_f32_x (svptrue_b16 (), z0, z1),
		z2 = svadd_x (svptrue_b16 (), z0, z1))

/*
** ptrue_b8_add_f32_x_z0:
**	fadd	z0\.s, (z0\.s, z1\.s||z1\.s, z0\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_add_f32_x_z0, svfloat32_t,
		z0 = svadd_f32_x (svptrue_b8 (), z0, z1),
		z0 = svadd_x (svptrue_b8 (), z0, z1))

/*
** ptrue_b8_add_f32_x_z1:
**	fadd	z1\.s, (z1\.s, z0\.s|z0\.s, z1\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_add_f32_x_z1, svfloat32_t,
		z1 = svadd_f32_x (svptrue_b8 (), z0, z1),
		z1 = svadd_x (svptrue_b8 (), z0, z1))

/*
** ptrue_b8_add_f32_x_z2:
**	fadd	z2\.s, (z0\.s, z1\.s|z1\.s, z0\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_add_f32_x_z2, svfloat32_t,
		z2 = svadd_f32_x (svptrue_b8 (), z0, z1),
