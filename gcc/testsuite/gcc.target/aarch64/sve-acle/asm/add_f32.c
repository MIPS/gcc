...
/*
** ptrue_b16_add_f32_x_tied1:
**	fadd	z0\.s, (z0\.s, z1\.s||z1\.s, z0\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b16_add_f32_x_tied1, svfloat32_t,
		z0 = svadd_f32_x (svptrue_b16 (), z0, z1),
		z0 = svadd_x (svptrue_b16 (), z0, z1))

/*
** ptrue_b16_add_f32_x_tied2:
**	fadd	z1\.s, (z1\.s, z0\.s|z0\.s, z1\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b16_add_f32_x_tied2, svfloat32_t,
		z1 = svadd_f32_x (svptrue_b16 (), z0, z1),
		z1 = svadd_x (svptrue_b16 (), z0, z1))

/*
** ptrue_b16_add_f32_x_untied:
**	fadd	z2\.s, (z0\.s, z1\.s|z1\.s, z0\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b16_add_f32_x_untied, svfloat32_t,
		z2 = svadd_f32_x (svptrue_b16 (), z0, z1),
		z2 = svadd_x (svptrue_b16 (), z0, z1))

/*
** ptrue_b8_add_f32_x_tied1:
**	fadd	z0\.s, (z0\.s, z1\.s||z1\.s, z0\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_add_f32_x_tied1, svfloat32_t,
		z0 = svadd_f32_x (svptrue_b8 (), z0, z1),
		z0 = svadd_x (svptrue_b8 (), z0, z1))

/*
** ptrue_b8_add_f32_x_tied2:
**	fadd	z1\.s, (z1\.s, z0\.s|z0\.s, z1\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_add_f32_x_tied2, svfloat32_t,
		z1 = svadd_f32_x (svptrue_b8 (), z0, z1),
		z1 = svadd_x (svptrue_b8 (), z0, z1))

/*
** ptrue_b8_add_f32_x_untied:
**	fadd	z2\.s, (z0\.s, z1\.s|z1\.s, z0\.s)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_add_f32_x_untied, svfloat32_t,
