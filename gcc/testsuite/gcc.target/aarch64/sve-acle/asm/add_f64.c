...
TEST_UNIFORM_ZS (ptrue_add_d4_f64_x_tied1, svfloat64_t, double,
		 z1 = svadd_n_f64_x (svptrue_b64 (), z1, d4),
		 z1 = svadd_x (svptrue_b64 (), z1, d4))
...
TEST_UNIFORM_ZS (ptrue_add_d4_f64_x_untied, svfloat64_t, double,
		 z2 = svadd_n_f64_x (svptrue_b64 (), z1, d4),
		 z2 = svadd_x (svptrue_b64 (), z1, d4))
