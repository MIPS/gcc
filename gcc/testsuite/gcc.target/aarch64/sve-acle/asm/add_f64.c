...
**	ret
*/
TEST_UNIFORM_ZS (add_d4_f64_m_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (add_d4_f64_m_untied, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (add_d4_f64_z_tied1, svfloat64_t, double,
		 z0 = svadd_n_f64_z (p0, z0, d4),
		 z0 = svadd_z (p0, z0, d4))

/*
** add_d4_f64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), d4
**	movprfx	z0\.d, p0/z, z1\.d
**	fadd	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (add_d4_f64_z_untied, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (add_d4_f64_x_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (add_d4_f64_x_untied, svfloat64_t, double,
...
TEST_UNIFORM_ZS (ptrue_add_x0_f64_x_untied, svfloat64_t, double,
		 z0 = svadd_n_f64_x (svptrue_b64 (), z1, x0),
		 z0 = svadd_x (svptrue_b64 (), z1, x0))

/*
** ptrue_add_d4_f64_x_tied1:
**	mov	(z[0-9]+\.d), d4
**	fadd	z0\.d, (z0\.d, \1|\1, z0\.d)
**	ret
*/
TEST_UNIFORM_ZS (ptrue_add_d4_f64_x_tied1, svfloat64_t, double,
		 z0 = svadd_n_f64_x (svptrue_b64 (), z0, d4),
		 z0 = svadd_x (svptrue_b64 (), z0, d4))

/*
** ptrue_add_d4_f64_x_untied:
**	mov	(z[0-9]+\.d), d4
**	fadd	z0\.d, (z1\.d, \1|\1, z1\.d)
**	ret
*/
TEST_UNIFORM_ZS (ptrue_add_d4_f64_x_untied, svfloat64_t, double,
		 z0 = svadd_n_f64_x (svptrue_b64 (), z1, d4),
		 z0 = svadd_x (svptrue_b64 (), z1, d4))
...
/*
** ptrue_b32_add_f64_x_tied1:
**	fadd	z0\.d, (z0\.d, z1\.d||z1\.d, z0\.d)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b32_add_f64_x_tied1, svfloat64_t,
		z0 = svadd_f64_x (svptrue_b32 (), z0, z1),
		z0 = svadd_x (svptrue_b32 (), z0, z1))

/*
** ptrue_b32_add_f64_x_tied2:
**	fadd	z0\.d, (z0\.d, z1\.d|z1\.d, z0\.d)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b32_add_f64_x_tied2, svfloat64_t,
		z0 = svadd_f64_x (svptrue_b32 (), z1, z0),
		z0 = svadd_x (svptrue_b32 (), z1, z0))

/*
** ptrue_b32_add_f64_x_untied:
**	fadd	z0\.d, (z1\.d, z2\.d|z2\.d, z1\.d)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b32_add_f64_x_untied, svfloat64_t,
		z0 = svadd_f64_x (svptrue_b32 (), z1, z2),
		z0 = svadd_x (svptrue_b32 (), z1, z2))

/*
** ptrue_b16_add_f64_x_tied1:
**	fadd	z0\.d, (z0\.d, z1\.d||z1\.d, z0\.d)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b16_add_f64_x_tied1, svfloat64_t,
		z0 = svadd_f64_x (svptrue_b16 (), z0, z1),
		z0 = svadd_x (svptrue_b16 (), z0, z1))

/*
** ptrue_b16_add_f64_x_tied2:
**	fadd	z0\.d, (z0\.d, z1\.d|z1\.d, z0\.d)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b16_add_f64_x_tied2, svfloat64_t,
		z0 = svadd_f64_x (svptrue_b16 (), z1, z0),
		z0 = svadd_x (svptrue_b16 (), z1, z0))

/*
** ptrue_b16_add_f64_x_untied:
**	fadd	z0\.d, (z1\.d, z2\.d|z2\.d, z1\.d)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b16_add_f64_x_untied, svfloat64_t,
		z0 = svadd_f64_x (svptrue_b16 (), z1, z2),
		z0 = svadd_x (svptrue_b16 (), z1, z2))

/*
** ptrue_b8_add_f64_x_tied1:
**	fadd	z0\.d, (z0\.d, z1\.d||z1\.d, z0\.d)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_add_f64_x_tied1, svfloat64_t,
		z0 = svadd_f64_x (svptrue_b8 (), z0, z1),
		z0 = svadd_x (svptrue_b8 (), z0, z1))

/*
** ptrue_b8_add_f64_x_tied2:
**	fadd	z0\.d, (z0\.d, z1\.d|z1\.d, z0\.d)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_add_f64_x_tied2, svfloat64_t,
		z0 = svadd_f64_x (svptrue_b8 (), z1, z0),
		z0 = svadd_x (svptrue_b8 (), z1, z0))

/*
** ptrue_b8_add_f64_x_untied:
**	fadd	z0\.d, (z1\.d, z2\.d|z2\.d, z1\.d)
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_add_f64_x_untied, svfloat64_t,
		z0 = svadd_f64_x (svptrue_b8 (), z1, z2),
		z0 = svadd_x (svptrue_b8 (), z1, z2))
