...
**	ret
*/
TEST_UNIFORM_Z (add_2_f64_x, svfloat64_t,
...
**	ret
*/
TEST_UNIFORM_Z (add_2_f64_x_prfx, svfloat64_t,
...
**	ret
*/
TEST_UNIFORM_Z (ptrue_add_2_f64_x, svfloat64_t,
		z0 = svadd_n_f64_x (svptrue_b64 (), z0, 2),
		z0 = svadd_x (svptrue_b64 (), z0, 2))

/*
** ptrue_add_2_f64_x_prfx:
**	fmov	(z[0-9]+\.d), #2\.0(e\+0)?
**	fadd	z0\.d, (z1\.d, \1|\1, z1\.d)
**	ret
*/
TEST_UNIFORM_Z (ptrue_add_2_f64_x_prfx, svfloat64_t,
