...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s16_m_tied1, svint16_t, int16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s16_m_untied, svint16_t, int16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_h4_s16_m_tied1, svint16_t, int16_t,
		 z0 = svadd_n_s16_m (p0, z0, d4),
		 z0 = svadd_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_h4_s16_m_untied, svint16_t, int16_t,
		 z0 = svadd_n_s16_m (p0, z1, d4),
		 z0 = svadd_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s16_z_tied1, svint16_t, int16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_h4_s16_z_tied1, svint16_t, int16_t,
		 z0 = svadd_n_s16_z (p0, z0, d4),
		 z0 = svadd_z (p0, z0, d4))

/*
** add_h4_s16_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.h), h4
**	movprfx	z0\.h, p0/z, z1\.h
**	add	z0\.h, p0/m, z0\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (add_h4_s16_z_untied, svint16_t, int16_t,
		 z0 = svadd_n_s16_z (p0, z1, d4),
		 z0 = svadd_z (p0, z1, d4))
