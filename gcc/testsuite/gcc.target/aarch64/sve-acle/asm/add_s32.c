...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s32_m_tied1, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s32_m_untied, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_s4_s32_m_tied1, svint32_t, int32_t,
		 z0 = svadd_n_s32_m (p0, z0, d4),
		 z0 = svadd_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_s4_s32_m_untied, svint32_t, int32_t,
		 z0 = svadd_n_s32_m (p0, z1, d4),
		 z0 = svadd_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s32_z_tied1, svint32_t, int32_t,
		 z0 = svadd_n_s32_z (p0, z0, x0),
		 z0 = svadd_z (p0, z0, x0))

/*
** add_w0_s32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), w0
**	movprfx	z0\.s, p0/z, z1\.s
**	add	z0\.s, p0/m, z0\.s, \1
**	ret
...
**	ret
*/
TEST_UNIFORM_ZS (add_s4_s32_z_tied1, svint32_t, int32_t,
		 z0 = svadd_n_s32_z (p0, z0, d4),
		 z0 = svadd_z (p0, z0, d4))

/*
** add_s4_s32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s4
**	movprfx	z0\.s, p0/z, z1\.s
**	add	z0\.s, p0/m, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (add_s4_s32_z_untied, svint32_t, int32_t,
		 z0 = svadd_n_s32_z (p0, z1, d4),
		 z0 = svadd_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s32_x_tied1, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s32_x_untied, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_s4_s32_x_tied1, svint32_t, int32_t,
		 z0 = svadd_n_s32_x (p0, z0, d4),
		 z0 = svadd_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_s4_s32_x_untied, svint32_t, int32_t,
		 z0 = svadd_n_s32_x (p0, z1, d4),
		 z0 = svadd_x (p0, z1, d4))
