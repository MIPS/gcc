...
**	ret
*/
TEST_UNIFORM_ZS (add_s0_s32_m_tied1, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_s0_s32_m_untied, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_s0_s32_z_tied1, svint32_t, int32_t,
		 z1 = svadd_n_s32_z (p0, z1, d0),
		 z1 = svadd_z (p0, z1, d0))

/*
** add_s0_s32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s0
...
**	ret
*/
TEST_UNIFORM_ZS (add_s0_s32_x_tied1, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_s0_s32_x_untied, svint32_t, int32_t,
