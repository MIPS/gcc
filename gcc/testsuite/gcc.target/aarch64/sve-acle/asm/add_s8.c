...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s8_m_tied1, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s8_m_untied, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_b4_s8_m_tied1, svint8_t, int8_t,
		 z0 = svadd_n_s8_m (p0, z0, d4),
		 z0 = svadd_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_b4_s8_m_untied, svint8_t, int8_t,
		 z0 = svadd_n_s8_m (p0, z1, d4),
		 z0 = svadd_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s8_z_tied1, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_b4_s8_z_tied1, svint8_t, int8_t,
		 z0 = svadd_n_s8_z (p0, z0, d4),
		 z0 = svadd_z (p0, z0, d4))

/*
** add_b4_s8_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.b), b4
**	movprfx	z0\.b, p0/z, z1\.b
**	add	z0\.b, p0/m, z0\.b, \1
**	ret
*/
TEST_UNIFORM_ZS (add_b4_s8_z_untied, svint8_t, int8_t,
		 z0 = svadd_n_s8_z (p0, z1, d4),
		 z0 = svadd_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s8_x_tied1, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_s8_x_untied, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_b4_s8_x_tied1, svint8_t, int8_t,
		 z0 = svadd_n_s8_x (p0, z0, d4),
		 z0 = svadd_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_b4_s8_x_untied, svint8_t, int8_t,
		 z0 = svadd_n_s8_x (p0, z1, d4),
		 z0 = svadd_x (p0, z1, d4))
