...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_u32_m_tied1, svuint32_t, uint32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_u32_m_untied, svuint32_t, uint32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_s4_u32_m_tied1, svuint32_t, uint32_t,
		 z1 = svadd_n_u32_m (p0, z1, d4),
		 z1 = svadd_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_s4_u32_m_untied, svuint32_t, uint32_t,
		 z1 = svadd_n_u32_m (p0, z2, d4),
		 z1 = svadd_m (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_u32_z_tied1, svuint32_t, uint32_t,
		 z0 = svadd_n_u32_z (p0, z0, x0),
		 z0 = svadd_z (p0, z0, x0))

/*
** add_w0_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), w0
**	movprfx	z0\.s, p0/z, z1\.s
**	add	z0\.s, p0/m, z0\.s, \1
**	ret
...
**	ret
*/
TEST_UNIFORM_ZS (add_s4_u32_z_tied1, svuint32_t, uint32_t,
		 z1 = svadd_n_u32_z (p0, z1, d4),
		 z1 = svadd_z (p0, z1, d4))

/*
** add_s4_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s4
**	movprfx	z1\.s, p0/z, z2\.s
**	add	z1\.s, p0/m, z1\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (add_s4_u32_z_untied, svuint32_t, uint32_t,
		 z1 = svadd_n_u32_z (p0, z2, d4),
		 z1 = svadd_z (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_u32_x_tied1, svuint32_t, uint32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_w0_u32_x_untied, svuint32_t, uint32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_s4_u32_x_tied1, svuint32_t, uint32_t,
		 z1 = svadd_n_u32_x (p0, z1, d4),
		 z1 = svadd_x (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_s4_u32_x_untied, svuint32_t, uint32_t,
		 z2 = svadd_n_u32_x (p0, z1, d4),
		 z2 = svadd_x (p0, z1, d4))
