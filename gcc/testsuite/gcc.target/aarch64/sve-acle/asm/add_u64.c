...
**	ret
*/
TEST_UNIFORM_Z (add_u64_m, svuint64_t,
...
**	ret
*/
TEST_UNIFORM_Z (add_u64_m_prfx, svuint64_t,
		z0 = svadd_u64_m (p0, z1, z2),
		z0 = svadd_m (p0, z1, z2))

/* Bad RA choice: no preferred output sequence.  */
TEST_UNIFORM_Z (add_u64_m_bad_ra, svuint64_t,
		z1 = svadd_u64_m (p0, z0, z1),
		z1 = svadd_m (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_ZS (add_x0_u64_m, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_x0_u64_m_prfx, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_d0_u64_m, svuint64_t, uint64_t,
		 z1 = svadd_n_u64_m (p0, z1, d0),
		 z1 = svadd_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (add_d0_u64_m_prfx, svuint64_t, uint64_t,
		 z1 = svadd_n_u64_m (p0, z2, d0),
		 z1 = svadd_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_Z (add_1_u64_m, svuint64_t,
...
**	ret
*/
TEST_UNIFORM_Z (add_1_u64_m_prfx, svuint64_t,
...
**	ret
*/
TEST_UNIFORM_Z (add_u64_z_tied, svuint64_t,
...
**	ret
*/
TEST_UNIFORM_Z (add_u64_z_rev, svuint64_t,
		z1 = svadd_u64_z (p0, z0, z1),
		z1 = svadd_z (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_ZS (add_x0_u64_z_tied, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_x0_u64_z_untied, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_d0_u64_z_tied, svuint64_t, uint64_t,
		 z1 = svadd_n_u64_z (p0, z1, d0),
		 z1 = svadd_z (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (add_d0_u64_z_untied, svuint64_t, uint64_t,
		 z1 = svadd_n_u64_z (p0, z2, d0),
		 z1 = svadd_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_Z (add_u64_x_z0, svuint64_t,
...
**	ret
*/
TEST_UNIFORM_Z (add_u64_x_z1, svuint64_t,
		z1 = svadd_u64_x (p0, z0, z1),
		z1 = svadd_x (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_Z (add_u64_x_z2, svuint64_t,
		z2 = svadd_u64_x (p0, z0, z1),
		z2 = svadd_x (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_ZS (add_x0_u64_x_z0, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_x0_u64_x_z1, svuint64_t, uint64_t,
		 z1 = svadd_n_u64_x (p0, z0, x0),
		 z1 = svadd_x (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (add_d0_u64_x_z1, svuint64_t, uint64_t,
		 z1 = svadd_n_u64_x (p0, z1, d0),
		 z1 = svadd_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (add_d0_u64_x_z2, svuint64_t, uint64_t,
		 z2 = svadd_n_u64_x (p0, z1, d0),
		 z2 = svadd_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_Z (add_1_u64_x, svuint64_t,
...
**	ret
*/
TEST_UNIFORM_Z (add_1_u64_x_prfx, svuint64_t,
