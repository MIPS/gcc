...
**	ret
*/
TEST_UNIFORM_ZS (add_d4_u64_m_tied1, svuint64_t, uint64_t,
		 z1 = svadd_n_u64_m (p0, z1, d4),
		 z1 = svadd_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_d4_u64_m_untied, svuint64_t, uint64_t,
		 z1 = svadd_n_u64_m (p0, z2, d4),
		 z1 = svadd_m (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_d4_u64_z_tied1, svuint64_t, uint64_t,
		 z1 = svadd_n_u64_z (p0, z1, d4),
		 z1 = svadd_z (p0, z1, d4))

/*
** add_d4_u64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), d4
**	movprfx	z1\.d, p0/z, z2\.d
**	add	z1\.d, p0/m, z1\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (add_d4_u64_z_untied, svuint64_t, uint64_t,
		 z1 = svadd_n_u64_z (p0, z2, d4),
		 z1 = svadd_z (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_d4_u64_x_tied1, svuint64_t, uint64_t,
		 z1 = svadd_n_u64_x (p0, z1, d4),
		 z1 = svadd_x (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (add_d4_u64_x_untied, svuint64_t, uint64_t,
		 z2 = svadd_n_u64_x (p0, z1, d4),
		 z2 = svadd_x (p0, z1, d4))
