...
**	ret
*/
TEST_UNIFORM_ZS (add_b0_u8_m_tied1, svuint8_t, uint8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_b0_u8_m_untied, svuint8_t, uint8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_b0_u8_z_tied1, svuint8_t, uint8_t,
		 z1 = svadd_n_u8_z (p0, z1, d0),
		 z1 = svadd_z (p0, z1, d0))

/*
** add_b0_u8_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.b), b0
...
**	ret
*/
TEST_UNIFORM_ZS (add_b0_u8_x_tied1, svuint8_t, uint8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (add_b0_u8_x_untied, svuint8_t, uint8_t,
