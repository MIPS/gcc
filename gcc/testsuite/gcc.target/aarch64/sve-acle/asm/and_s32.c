...
**	ret
*/
TEST_UNIFORM_ZS (and_s4_s32_m_tied1, svint32_t, int32_t,
		 z1 = svand_n_s32_m (p0, z1, d4),
		 z1 = svand_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (and_s4_s32_m_untied, svint32_t, int32_t,
		 z1 = svand_n_s32_m (p0, z2, d4),
		 z1 = svand_m (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (and_s4_s32_z_tied1, svint32_t, int32_t,
		 z1 = svand_n_s32_z (p0, z1, d4),
		 z1 = svand_z (p0, z1, d4))

/*
** and_s4_s32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s4
**	movprfx	z1\.s, p0/z, z2\.s
**	and	z1\.s, p0/m, z1\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (and_s4_s32_z_untied, svint32_t, int32_t,
		 z1 = svand_n_s32_z (p0, z2, d4),
		 z1 = svand_z (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (and_s4_s32_x_tied1, svint32_t, int32_t,
		 z1 = svand_n_s32_x (p0, z1, d4),
		 z1 = svand_x (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (and_s4_s32_x_untied, svint32_t, int32_t,
		 z2 = svand_n_s32_x (p0, z1, d4),
		 z2 = svand_x (p0, z1, d4))
