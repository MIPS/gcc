...
**	ret
*/
TEST_UNIFORM_ZS (and_x0_s64_m_tied1, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (and_x0_s64_m_untied, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (and_d0_s64_m_tied1, svint64_t, int64_t,
		 z1 = svand_n_s64_m (p0, z1, d0),
		 z1 = svand_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_d0_s64_m_untied, svint64_t, int64_t,
		 z1 = svand_n_s64_m (p0, z2, d0),
		 z1 = svand_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_x0_s64_z_tied1, svint64_t, int64_t,
		 z0 = svand_n_s64_z (p0, z0, x0),
		 z0 = svand_z (p0, z0, x0))

/*
** and_x0_s64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), x0
**	movprfx	z0\.d, p0/z, z1\.d
**	and	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (and_x0_s64_z_untied, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (and_d0_s64_z_tied1, svint64_t, int64_t,
		 z1 = svand_n_s64_z (p0, z1, d0),
		 z1 = svand_z (p0, z1, d0))

/*
** and_d0_s64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), d0
**	movprfx	z1\.d, p0/z, z2\.d
**	and	z1\.d, p0/m, z1\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (and_d0_s64_z_untied, svint64_t, int64_t,
		 z1 = svand_n_s64_z (p0, z2, d0),
		 z1 = svand_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_x0_s64_x_tied1, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (and_x0_s64_x_untied, svint64_t, int64_t,
		 z1 = svand_n_s64_x (p0, z0, x0),
		 z1 = svand_x (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_d0_s64_x_tied1, svint64_t, int64_t,
		 z1 = svand_n_s64_x (p0, z1, d0),
		 z1 = svand_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_d0_s64_x_untied, svint64_t, int64_t,
		 z2 = svand_n_s64_x (p0, z1, d0),
		 z2 = svand_x (p0, z1, d0))
