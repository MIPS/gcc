...
**	ret
*/
TEST_UNIFORM_ZS (and_h4_u16_m_tied1, svuint16_t, uint16_t,
		 z1 = svand_n_u16_m (p0, z1, d4),
		 z1 = svand_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (and_h4_u16_m_untied, svuint16_t, uint16_t,
		 z1 = svand_n_u16_m (p0, z2, d4),
		 z1 = svand_m (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (and_h4_u16_z_tied1, svuint16_t, uint16_t,
		 z1 = svand_n_u16_z (p0, z1, d4),
		 z1 = svand_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (and_h4_u16_x_tied1, svuint16_t, uint16_t,
		 z1 = svand_n_u16_x (p0, z1, d4),
		 z1 = svand_x (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (and_h4_u16_x_untied, svuint16_t, uint16_t,
		 z2 = svand_n_u16_x (p0, z1, d4),
		 z2 = svand_x (p0, z1, d4))
