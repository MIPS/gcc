...
**	ret
*/
TEST_UNIFORM_ZS (and_s0_u32_m_tied1, svuint32_t, uint32_t,
		 z1 = svand_n_u32_m (p0, z1, d0),
		 z1 = svand_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_s0_u32_m_untied, svuint32_t, uint32_t,
		 z1 = svand_n_u32_m (p0, z2, d0),
		 z1 = svand_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_s0_u32_z_tied1, svuint32_t, uint32_t,
		 z1 = svand_n_u32_z (p0, z1, d0),
		 z1 = svand_z (p0, z1, d0))

/*
** and_s0_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s0
**	movprfx	z1\.s, p0/z, z2\.s
**	and	z1\.s, p0/m, z1\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (and_s0_u32_z_untied, svuint32_t, uint32_t,
		 z1 = svand_n_u32_z (p0, z2, d0),
		 z1 = svand_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_s0_u32_x_tied1, svuint32_t, uint32_t,
		 z1 = svand_n_u32_x (p0, z1, d0),
		 z1 = svand_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_s0_u32_x_untied, svuint32_t, uint32_t,
		 z2 = svand_n_u32_x (p0, z1, d0),
		 z2 = svand_x (p0, z1, d0))
