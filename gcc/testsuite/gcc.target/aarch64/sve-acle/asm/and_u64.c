...
** and_d0_u64_m_tied1:
**	mov	(z[0-9]+\.d), d0
**	and	z1\.d, p0/m, z1\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (and_d0_u64_m_tied1, svuint64_t, uint64_t,
		 z1 = svand_n_u64_m (p0, z1, d0),
		 z1 = svand_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_d0_u64_m_untied, svuint64_t, uint64_t,
		 z1 = svand_n_u64_m (p0, z2, d0),
		 z1 = svand_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_d0_u64_z_tied1, svuint64_t, uint64_t,
		 z1 = svand_n_u64_z (p0, z1, d0),
		 z1 = svand_z (p0, z1, d0))

/*
** and_d0_u64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), d0
**	movprfx	z1\.d, p0/z, z2\.d
**	and	z1\.d, p0/m, z1\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (and_d0_u64_z_untied, svuint64_t, uint64_t,
		 z1 = svand_n_u64_z (p0, z2, d0),
		 z1 = svand_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_d0_u64_x_tied1, svuint64_t, uint64_t,
		 z1 = svand_n_u64_x (p0, z1, d0),
		 z1 = svand_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_d0_u64_x_untied, svuint64_t, uint64_t,
		 z2 = svand_n_u64_x (p0, z1, d0),
		 z2 = svand_x (p0, z1, d0))
