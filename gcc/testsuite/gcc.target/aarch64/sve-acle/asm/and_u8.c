...
**	ret
*/
TEST_UNIFORM_ZS (and_b0_u8_m_tied1, svuint8_t, uint8_t,
		 z1 = svand_n_u8_m (p0, z1, d0),
		 z1 = svand_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_b0_u8_m_untied, svuint8_t, uint8_t,
		 z1 = svand_n_u8_m (p0, z2, d0),
		 z1 = svand_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_b0_u8_z_tied1, svuint8_t, uint8_t,
		 z1 = svand_n_u8_z (p0, z1, d0),
		 z1 = svand_z (p0, z1, d0))

/*
** and_b0_u8_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.b), b0
**	movprfx	z1\.b, p0/z, z2\.b
**	and	z1\.b, p0/m, z1\.b, \1
**	ret
*/
TEST_UNIFORM_ZS (and_b0_u8_z_untied, svuint8_t, uint8_t,
		 z1 = svand_n_u8_z (p0, z2, d0),
		 z1 = svand_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_b0_u8_x_tied1, svuint8_t, uint8_t,
		 z1 = svand_n_u8_x (p0, z1, d0),
		 z1 = svand_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (and_b0_u8_x_untied, svuint8_t, uint8_t,
		 z2 = svand_n_u8_x (p0, z1, d0),
		 z2 = svand_x (p0, z1, d0))
