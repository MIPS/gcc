...
**	ret
*/
TEST_UNIFORM_Z (asr_s16_m_tied1, svint16_t,
		z0 = svasr_s16_m (p0, z0, z1),
		z0 = svasr_m (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s16_m_tied2, svint16_t,
		z0 = svasr_s16_m (p0, z1, z0),
		z0 = svasr_m (p0, z1, z0))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s16_m_untied, svint16_t,
		z0 = svasr_s16_m (p0, z1, z2),
		z0 = svasr_m (p0, z1, z2))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s16_z_tied1, svint16_t,
		z0 = svasr_s16_z (p0, z0, z1),
		z0 = svasr_z (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s16_z_tied2, svint16_t,
		z0 = svasr_s16_z (p0, z1, z0),
		z0 = svasr_z (p0, z1, z0))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s16_z_untied, svint16_t,
		z0 = svasr_s16_z (p0, z1, z2),
		z0 = svasr_z (p0, z1, z2))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s16_x_tied1, svint16_t,
		z0 = svasr_s16_x (p0, z0, z1),
		z0 = svasr_x (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s16_x_tied2, svint16_t,
		z0 = svasr_s16_x (p0, z1, z0),
		z0 = svasr_x (p0, z1, z0))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s16_x_untied, svint16_t,
		z0 = svasr_s16_x (p0, z1, z2),
		z0 = svasr_x (p0, z1, z2))
