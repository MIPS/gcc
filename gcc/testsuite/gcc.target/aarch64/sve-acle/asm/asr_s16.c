...
/*
** asr_s16_m_tied1:
**	asr	z0\.h, p0/m, z0\.h, z16\.h
**	ret
*/
TEST_DUAL_Z (asr_s16_m_tied1, svint16_t, svuint16_t,
	     z0 = svasr_s16_m (p0, z0, z16),
...
**	mov	(z[0-9]+)\.d, z16\.d
**	movprfx	z16, z0
**	asr	z16\.h, p0/m, z16\.h, \1\.h
**	ret
*/
TEST_DUAL_Z (asr_s16_m_tied2, svint16_t, svuint16_t,
	     z16_res = svasr_s16_m (p0, z0, z16),
...
TEST_DUAL_Z (asr_s16_z_tied1, svint16_t, svuint16_t,
	     z0 = svasr_s16_z (p0, z0, z16),
	     z0 = svasr_z (p0, z0, z16))

/*
** asr_s16_z_tied2:
**	movprfx	z16\.h, p0/z, z16\.h
**	asrr	z16\.h, p0/m, z16\.h, z0\.h
**	ret
*/
TEST_DUAL_Z (asr_s16_z_tied2, svint16_t, svuint16_t,
	     z16_res = svasr_s16_z (p0, z0, z16),
