...
**	ret
*/
TEST_UNIFORM_Z (asr_s64_m_tied1, svint64_t,
		z0 = svasr_s64_m (p0, z0, z1),
		z0 = svasr_m (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s64_m_tied2, svint64_t,
		z0 = svasr_s64_m (p0, z1, z0),
		z0 = svasr_m (p0, z1, z0))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s64_m_untied, svint64_t,
		z0 = svasr_s64_m (p0, z1, z2),
		z0 = svasr_m (p0, z1, z2))
...
**	ret
*/
TEST_UNIFORM_ZS (asr_x0_s64_m_tied1, svint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (asr_x0_s64_m_untied, svint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (asr_d4_s64_m_tied1, svint64_t, uint64_t,
		 z0 = svasr_n_s64_m (p0, z0, d4),
		 z0 = svasr_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (asr_d4_s64_m_untied, svint64_t, uint64_t,
		 z0 = svasr_n_s64_m (p0, z1, d4),
		 z0 = svasr_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s64_z_tied1, svint64_t,
		z0 = svasr_s64_z (p0, z0, z1),
		z0 = svasr_z (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s64_z_tied2, svint64_t,
		z0 = svasr_s64_z (p0, z1, z0),
		z0 = svasr_z (p0, z1, z0))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s64_z_untied, svint64_t,
		z0 = svasr_s64_z (p0, z1, z2),
		z0 = svasr_z (p0, z1, z2))
...
**	ret
*/
TEST_UNIFORM_ZS (asr_x0_s64_z_tied1, svint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (asr_x0_s64_z_untied, svint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (asr_d4_s64_z_tied1, svint64_t, uint64_t,
		 z0 = svasr_n_s64_z (p0, z0, d4),
		 z0 = svasr_z (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (asr_d4_s64_z_untied, svint64_t, uint64_t,
		 z0 = svasr_n_s64_z (p0, z1, d4),
		 z0 = svasr_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s64_x_tied1, svint64_t,
		z0 = svasr_s64_x (p0, z0, z1),
		z0 = svasr_x (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s64_x_tied2, svint64_t,
		z0 = svasr_s64_x (p0, z1, z0),
		z0 = svasr_x (p0, z1, z0))
...
**	ret
*/
TEST_UNIFORM_Z (asr_s64_x_untied, svint64_t,
		z0 = svasr_s64_x (p0, z1, z2),
		z0 = svasr_x (p0, z1, z2))
...
**	ret
*/
TEST_UNIFORM_ZS (asr_x0_s64_x_tied1, svint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (asr_x0_s64_x_untied, svint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (asr_d4_s64_x_tied1, svint64_t, uint64_t,
		 z0 = svasr_n_s64_x (p0, z0, d4),
		 z0 = svasr_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (asr_d4_s64_x_untied, svint64_t, uint64_t,
		 z0 = svasr_n_s64_x (p0, z1, d4),
		 z0 = svasr_x (p0, z1, d4))
