...
/*
** asr_s8_m_tied1:
**	asr	z0\.b, p0/m, z0\.b, z16\.b
**	ret
*/
TEST_DUAL_Z (asr_s8_m_tied1, svint8_t, svuint8_t,
	     z0 = svasr_s8_m (p0, z0, z16),
...
**	mov	(z[0-9]+)\.d, z16\.d
**	movprfx	z16, z0
**	asr	z16\.b, p0/m, z16\.b, \1\.b
**	ret
*/
TEST_DUAL_Z (asr_s8_m_tied2, svint8_t, svuint8_t,
	     z16_res = svasr_s8_m (p0, z0, z16),
