...
/*
** asr_wide_s8_m_tied1:
**	asr	z0\.b, p0/m, z0\.b, z16\.d
**	ret
*/
TEST_WIDE_Z (asr_wide_s8_m_tied1, svint8_t,
	     z0 = svasr_wide_s8_m (p0, z0, z16),
...
**	mov	(z[0-9]+\.d), z16\.d
**	movprfx	z16, z0
**	asr	z16\.b, p0/m, z16\.b, \1
**	ret
*/
TEST_WIDE_Z (asr_wide_s8_m_tied2, svint8_t,
	     z16_res = svasr_wide_s8_m (p0, z0, z16),
...
TEST_WIDE_Z (asr_wide_s8_z_tied2, svint8_t,
	     z16_res = svasr_wide_s8_z (p0, z0, z16),
...
TEST_WIDE_Z (asr_wide_s8_x_tied1, svint8_t,
	     z0 = svasr_wide_s8_x (p0, z0, z16),
	     z0 = svasr_wide_x (p0, z0, z16))

/*
** asr_wide_s8_x_tied2:
**	asr	z16\.b, z0\.b, z16\.d
**	ret
*/
TEST_WIDE_Z (asr_wide_s8_x_tied2, svint8_t,
	     z16_res = svasr_wide_s8_x (p0, z0, z16),
