...
**	ret
*/
TEST_UNIFORM_ZS (bic_d4_s64_m_tied1, svint64_t, int64_t,
		 z0 = svbic_n_s64_m (p0, z0, d4),
		 z0 = svbic_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (bic_d4_s64_m_untied, svint64_t, int64_t,
		 z0 = svbic_n_s64_m (p0, z1, d4),
		 z0 = svbic_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (bic_d4_s64_z_tied1, svint64_t, int64_t,
		 z0 = svbic_n_s64_z (p0, z0, d4),
		 z0 = svbic_z (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (bic_d4_s64_z_untied, svint64_t, int64_t,
		 z0 = svbic_n_s64_z (p0, z1, d4),
		 z0 = svbic_z (p0, z1, d4))
