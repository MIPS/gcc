...
**	ret
*/
TEST_UNIFORM_ZS (bic_b4_s8_m_tied1, svint8_t, int8_t,
		 z0 = svbic_n_s8_m (p0, z0, d4),
		 z0 = svbic_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (bic_b4_s8_m_untied, svint8_t, int8_t,
		 z0 = svbic_n_s8_m (p0, z1, d4),
		 z0 = svbic_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (bic_b4_s8_z_tied1, svint8_t, int8_t,
		 z0 = svbic_n_s8_z (p0, z0, d4),
		 z0 = svbic_z (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (bic_b4_s8_z_untied, svint8_t, int8_t,
		 z0 = svbic_n_s8_z (p0, z1, d4),
		 z0 = svbic_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (bic_b4_s8_x_tied1, svint8_t, int8_t,
		 z0 = svbic_n_s8_x (p0, z0, d4),
		 z0 = svbic_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (bic_b4_s8_x_untied, svint8_t, int8_t,
		 z0 = svbic_n_s8_x (p0, z1, d4),
		 z0 = svbic_x (p0, z1, d4))
