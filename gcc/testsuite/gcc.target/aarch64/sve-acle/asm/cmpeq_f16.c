...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_w0_f16, svfloat16_t, float16_t,
		 p0 = svcmpeq_n_f16 (p1, z0, x0),
		 p0 = svcmpeq (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_h4_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_0_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_1_f16, svfloat16_t, float16_t,
