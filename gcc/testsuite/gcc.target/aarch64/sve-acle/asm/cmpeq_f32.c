...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_w0_f32, svfloat32_t, float32_t,
		 p0 = svcmpeq_n_f32 (p1, z0, x0),
		 p0 = svcmpeq (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_s4_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_0_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_1_f32, svfloat32_t, float32_t,
