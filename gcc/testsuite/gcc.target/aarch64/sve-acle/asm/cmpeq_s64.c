...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_x0_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_d4_s64, svint64_t, int64_t,
		 p0 = svcmpeq_n_s64 (p1, z0, d4),
		 p0 = svcmpeq (p1, z0, d4))
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_0_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_1_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_15_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_16_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_m1_s64, svint64_t, int64_t,
		 p0 = svcmpeq_n_s64 (p1, z0, -1),
		 p0 = svcmpeq (p1, z0, -1))
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_m16_s64, svint64_t, int64_t,
		 p0 = svcmpeq_n_s64 (p1, z0, -16),
		 p0 = svcmpeq (p1, z0, -16))
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_m17_s64, svint64_t, int64_t,
