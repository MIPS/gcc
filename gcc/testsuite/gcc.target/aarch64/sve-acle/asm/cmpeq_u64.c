...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_x0_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_d4_u64, svuint64_t, uint64_t,
		 p0 = svcmpeq_n_u64 (p1, z0, d4),
		 p0 = svcmpeq (p1, z0, d4))
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_0_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_1_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_15_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_16_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_m1_u64, svuint64_t, uint64_t,
		 p0 = svcmpeq_n_u64 (p1, z0, -1),
		 p0 = svcmpeq (p1, z0, -1))
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_m16_u64, svuint64_t, uint64_t,
		 p0 = svcmpeq_n_u64 (p1, z0, -16),
		 p0 = svcmpeq (p1, z0, -16))
...
**	ret
*/
TEST_COMPARE_ZS (cmpeq_m17_u64, svuint64_t, uint64_t,
