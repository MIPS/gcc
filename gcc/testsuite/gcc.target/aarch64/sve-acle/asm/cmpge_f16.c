...
**	ret
*/
TEST_COMPARE_ZS (cmpge_w0_f16, svfloat16_t, float16_t,
		 p0 = svcmpge_n_f16 (p1, z0, x0),
		 p0 = svcmpge (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_h4_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_0_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_1_f16, svfloat16_t, float16_t,
