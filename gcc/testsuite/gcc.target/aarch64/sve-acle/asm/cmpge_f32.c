...
**	ret
*/
TEST_COMPARE_ZS (cmpge_w0_f32, svfloat32_t, float32_t,
		 p0 = svcmpge_n_f32 (p1, z0, x0),
		 p0 = svcmpge (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_s4_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_0_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_1_f32, svfloat32_t, float32_t,
