...
**	ret
*/
TEST_COMPARE_ZS (cmpge_x0_f64, svfloat64_t, float64_t,
		 p0 = svcmpge_n_f64 (p1, z0, x0),
		 p0 = svcmpge (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_d4_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_0_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_1_f64, svfloat64_t, float64_t,
