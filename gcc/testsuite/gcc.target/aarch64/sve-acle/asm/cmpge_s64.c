...
**	ret
*/
TEST_COMPARE_ZS (cmpge_x0_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_d4_s64, svint64_t, int64_t,
		 p0 = svcmpge_n_s64 (p1, z0, d4),
		 p0 = svcmpge (p1, z0, d4))
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_0_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_1_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_15_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_16_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_m1_s64, svint64_t, int64_t,
		 p0 = svcmpge_n_s64 (p1, z0, -1),
		 p0 = svcmpge (p1, z0, -1))
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_m16_s64, svint64_t, int64_t,
		 p0 = svcmpge_n_s64 (p1, z0, -16),
		 p0 = svcmpge (p1, z0, -16))
...
**	ret
*/
TEST_COMPARE_ZS (cmpge_m17_s64, svint64_t, int64_t,
