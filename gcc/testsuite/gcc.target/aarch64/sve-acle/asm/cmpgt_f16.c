...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_w0_f16, svfloat16_t, float16_t,
		 p0 = svcmpgt_n_f16 (p1, z0, x0),
		 p0 = svcmpgt (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_h4_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_0_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_1_f16, svfloat16_t, float16_t,
