...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_x0_f64, svfloat64_t, float64_t,
		 p0 = svcmpgt_n_f64 (p1, z0, x0),
		 p0 = svcmpgt (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_d4_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_0_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_1_f64, svfloat64_t, float64_t,
