...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_x0_s16, svint16_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_d4_s16, svint16_t, int64_t,
		 p0 = svcmpgt_n_s16 (p1, z0, d4),
		 p0 = svcmpgt (p1, z0, d4))
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_0_s16, svint16_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_1_s16, svint16_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_15_s16, svint16_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_16_s16, svint16_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_m1_s16, svint16_t, int64_t,
		 p0 = svcmpgt_n_s16 (p1, z0, -1),
		 p0 = svcmpgt (p1, z0, -1))
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_m16_s16, svint16_t, int64_t,
		 p0 = svcmpgt_n_s16 (p1, z0, -16),
		 p0 = svcmpgt (p1, z0, -16))
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_m17_s16, svint16_t, int64_t,
