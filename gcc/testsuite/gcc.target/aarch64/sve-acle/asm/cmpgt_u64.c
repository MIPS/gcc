...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_x0_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_d4_u64, svuint64_t, uint64_t,
		 p0 = svcmpgt_n_u64 (p1, z0, d4),
		 p0 = svcmpgt (p1, z0, d4))
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_0_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_1_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_15_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_16_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_127_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_128_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpgt_m1_u64, svuint64_t, uint64_t,
		 p0 = svcmpgt_n_u64 (p1, z0, -1),
		 p0 = svcmpgt (p1, z0, -1))
