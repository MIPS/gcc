...
**	ret
*/
TEST_COMPARE_ZS (cmple_w0_f16, svfloat16_t, float16_t,
		 p0 = svcmple_n_f16 (p1, z0, x0),
		 p0 = svcmple (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmple_h4_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_0_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_1_f16, svfloat16_t, float16_t,
