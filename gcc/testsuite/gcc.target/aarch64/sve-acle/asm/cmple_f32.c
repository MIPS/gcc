...
**	ret
*/
TEST_COMPARE_ZS (cmple_w0_f32, svfloat32_t, float32_t,
		 p0 = svcmple_n_f32 (p1, z0, x0),
		 p0 = svcmple (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmple_s4_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_0_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_1_f32, svfloat32_t, float32_t,
