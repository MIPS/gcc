...
**	ret
*/
TEST_COMPARE_ZS (cmple_x0_f64, svfloat64_t, float64_t,
		 p0 = svcmple_n_f64 (p1, z0, x0),
		 p0 = svcmple (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmple_d4_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_0_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_1_f64, svfloat64_t, float64_t,
