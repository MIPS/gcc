...
**	ret
*/
TEST_COMPARE_ZS (cmple_x0_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_d4_s64, svint64_t, int64_t,
		 p0 = svcmple_n_s64 (p1, z0, d4),
		 p0 = svcmple (p1, z0, d4))
...
**	ret
*/
TEST_COMPARE_ZS (cmple_0_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_1_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_15_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_16_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_m1_s64, svint64_t, int64_t,
		 p0 = svcmple_n_s64 (p1, z0, -1),
		 p0 = svcmple (p1, z0, -1))
...
**	ret
*/
TEST_COMPARE_ZS (cmple_m16_s64, svint64_t, int64_t,
		 p0 = svcmple_n_s64 (p1, z0, -16),
		 p0 = svcmple (p1, z0, -16))
...
**	ret
*/
TEST_COMPARE_ZS (cmple_m17_s64, svint64_t, int64_t,
