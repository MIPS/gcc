...
**	ret
*/
TEST_COMPARE_ZS (cmple_x0_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_d4_u64, svuint64_t, uint64_t,
		 p0 = svcmple_n_u64 (p1, z0, d4),
		 p0 = svcmple (p1, z0, d4))
...
**	ret
*/
TEST_COMPARE_ZS (cmple_0_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_1_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_15_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_16_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_127_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_128_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmple_m1_u64, svuint64_t, uint64_t,
		 p0 = svcmple_n_u64 (p1, z0, -1),
		 p0 = svcmple (p1, z0, -1))
