...
**	ret
*/
TEST_COMPARE_ZS (cmplt_w0_f16, svfloat16_t, float16_t,
		 p0 = svcmplt_n_f16 (p1, z0, x0),
		 p0 = svcmplt (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_h4_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_0_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_1_f16, svfloat16_t, float16_t,
