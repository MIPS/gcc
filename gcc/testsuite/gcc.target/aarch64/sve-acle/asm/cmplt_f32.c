...
**	ret
*/
TEST_COMPARE_ZS (cmplt_w0_f32, svfloat32_t, float32_t,
		 p0 = svcmplt_n_f32 (p1, z0, x0),
		 p0 = svcmplt (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_s4_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_0_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_1_f32, svfloat32_t, float32_t,
