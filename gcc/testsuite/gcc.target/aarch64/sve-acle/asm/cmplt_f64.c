...
**	ret
*/
TEST_COMPARE_ZS (cmplt_x0_f64, svfloat64_t, float64_t,
		 p0 = svcmplt_n_f64 (p1, z0, x0),
		 p0 = svcmplt (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_d4_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_0_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_1_f64, svfloat64_t, float64_t,
