...
**	ret
*/
TEST_COMPARE_ZS (cmplt_x0_s32, svint32_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_d4_s32, svint32_t, int64_t,
		 p0 = svcmplt_n_s32 (p1, z0, d4),
		 p0 = svcmplt (p1, z0, d4))
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_0_s32, svint32_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_1_s32, svint32_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_15_s32, svint32_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_16_s32, svint32_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_m1_s32, svint32_t, int64_t,
		 p0 = svcmplt_n_s32 (p1, z0, -1),
		 p0 = svcmplt (p1, z0, -1))
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_m16_s32, svint32_t, int64_t,
		 p0 = svcmplt_n_s32 (p1, z0, -16),
		 p0 = svcmplt (p1, z0, -16))
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_m17_s32, svint32_t, int64_t,
