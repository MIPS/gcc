...
**	ret
*/
TEST_COMPARE_ZS (cmplt_x0_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_d4_u64, svuint64_t, uint64_t,
		 p0 = svcmplt_n_u64 (p1, z0, d4),
		 p0 = svcmplt (p1, z0, d4))
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_0_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_1_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_15_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_16_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_127_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_128_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmplt_m1_u64, svuint64_t, uint64_t,
		 p0 = svcmplt_n_u64 (p1, z0, -1),
		 p0 = svcmplt (p1, z0, -1))
