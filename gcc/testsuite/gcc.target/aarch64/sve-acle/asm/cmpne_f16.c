...
**	ret
*/
TEST_COMPARE_ZS (cmpne_w0_f16, svfloat16_t, float16_t,
		 p0 = svcmpne_n_f16 (p1, z0, x0),
		 p0 = svcmpne (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_h4_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_0_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_1_f16, svfloat16_t, float16_t,
