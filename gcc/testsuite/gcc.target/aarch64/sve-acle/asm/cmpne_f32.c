...
**	ret
*/
TEST_COMPARE_ZS (cmpne_w0_f32, svfloat32_t, float32_t,
		 p0 = svcmpne_n_f32 (p1, z0, x0),
		 p0 = svcmpne (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_s4_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_0_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_1_f32, svfloat32_t, float32_t,
