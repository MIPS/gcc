...
**	ret
*/
TEST_COMPARE_ZS (cmpne_x0_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_d4_s64, svint64_t, int64_t,
		 p0 = svcmpne_n_s64 (p1, z0, d4),
		 p0 = svcmpne (p1, z0, d4))
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_0_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_1_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_15_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_16_s64, svint64_t, int64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_m1_s64, svint64_t, int64_t,
		 p0 = svcmpne_n_s64 (p1, z0, -1),
		 p0 = svcmpne (p1, z0, -1))
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_m16_s64, svint64_t, int64_t,
		 p0 = svcmpne_n_s64 (p1, z0, -16),
		 p0 = svcmpne (p1, z0, -16))
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_m17_s64, svint64_t, int64_t,
