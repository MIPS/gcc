...
**	ret
*/
TEST_COMPARE_ZS (cmpne_x0_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_d4_u64, svuint64_t, uint64_t,
		 p0 = svcmpne_n_u64 (p1, z0, d4),
		 p0 = svcmpne (p1, z0, d4))
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_0_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_1_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_15_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_16_u64, svuint64_t, uint64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_m1_u64, svuint64_t, uint64_t,
		 p0 = svcmpne_n_u64 (p1, z0, -1),
		 p0 = svcmpne (p1, z0, -1))
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_m16_u64, svuint64_t, uint64_t,
		 p0 = svcmpne_n_u64 (p1, z0, -16),
		 p0 = svcmpne (p1, z0, -16))
...
**	ret
*/
TEST_COMPARE_ZS (cmpne_m17_u64, svuint64_t, uint64_t,
