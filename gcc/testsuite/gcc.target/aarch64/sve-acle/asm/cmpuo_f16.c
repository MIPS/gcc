...
**	ret
*/
TEST_COMPARE_ZS (cmpuo_w0_f16, svfloat16_t, float16_t,
		 p0 = svcmpuo_n_f16 (p1, z0, x0),
		 p0 = svcmpuo (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmpuo_h4_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpuo_0_f16, svfloat16_t, float16_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpuo_1_f16, svfloat16_t, float16_t,
