...
**	ret
*/
TEST_COMPARE_ZS (cmpuo_w0_f32, svfloat32_t, float32_t,
		 p0 = svcmpuo_n_f32 (p1, z0, x0),
		 p0 = svcmpuo (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmpuo_s4_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpuo_0_f32, svfloat32_t, float32_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpuo_1_f32, svfloat32_t, float32_t,
