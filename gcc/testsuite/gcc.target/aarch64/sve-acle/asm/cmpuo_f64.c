...
**	ret
*/
TEST_COMPARE_ZS (cmpuo_x0_f64, svfloat64_t, float64_t,
		 p0 = svcmpuo_n_f64 (p1, z0, x0),
		 p0 = svcmpuo (p1, z0, x0))
...
**	ret
*/
TEST_COMPARE_ZS (cmpuo_d4_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpuo_0_f64, svfloat64_t, float64_t,
...
**	ret
*/
TEST_COMPARE_ZS (cmpuo_1_f64, svfloat64_t, float64_t,
