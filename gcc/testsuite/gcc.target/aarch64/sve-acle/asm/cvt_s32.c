...
/*
** cvt_s32_f16_m_tied1:
**	fcvtzs	z0\.s, p0/m, z16\.h
**	ret
*/
TEST_DUAL_Z (cvt_s32_f16_m_tied1, svint32_t, svfloat16_t,
	     z0 = svcvt_s32_f16_m (z0, p0, z16),
	     z0 = svcvt_s32_m (z0, p0, z16))

/*
** cvt_s32_f16_m_tied2:
**	mov	(z[0-9]+)\.d, z16\.d
**	movprfx	z16, z0
**	fcvtzs	z16\.s, p0/m, \1\.h
**	ret
*/
TEST_DUAL_Z (cvt_s32_f16_m_tied2, svint32_t, svfloat16_t,
	     z16_res = svcvt_s32_f16_m (z0, p0, z16),
	     z16_res = svcvt_s32_m (z0, p0, z16))
...
TEST_DUAL_Z (cvt_s32_f16_m_untied, svint32_t, svfloat16_t,
	     z0 = svcvt_s32_f16_m (z1, p0, z16),
	     z0 = svcvt_s32_m (z1, p0, z16))

/*
** cvt_s32_f32_m_tied1:
**	fcvtzs	z0\.s, p0/m, z16\.s
**	ret
*/
TEST_DUAL_Z (cvt_s32_f32_m_tied1, svint32_t, svfloat32_t,
	     z0 = svcvt_s32_f32_m (z0, p0, z16),
	     z0 = svcvt_s32_m (z0, p0, z16))
...
**	mov	(z[0-9]+)\.d, z16\.d
**	movprfx	z16, z0
**	fcvtzs	z16\.s, p0/m, \1\.s
**	ret
*/
TEST_DUAL_Z (cvt_s32_f32_m_tied2, svint32_t, svfloat32_t,
	     z16_res = svcvt_s32_f32_m (z0, p0, z16),
	     z16_res = svcvt_s32_m (z0, p0, z16))
...
TEST_DUAL_Z (cvt_s32_f32_m_untied, svint32_t, svfloat32_t,
	     z0 = svcvt_s32_f32_m (z1, p0, z16),
	     z0 = svcvt_s32_m (z1, p0, z16))

/*
** cvt_s32_f64_m_tied1:
**	fcvtzs	z0\.s, p0/m, z16\.d
**	ret
*/
TEST_DUAL_Z (cvt_s32_f64_m_tied1, svint32_t, svfloat64_t,
	     z0 = svcvt_s32_f64_m (z0, p0, z16),
	     z0 = svcvt_s32_m (z0, p0, z16))
...
TEST_DUAL_Z (cvt_s32_f64_m_tied2, svint32_t, svfloat64_t,
	     z16_res = svcvt_s32_f64_m (z0, p0, z16),
	     z16_res = svcvt_s32_m (z0, p0, z16))
...
TEST_DUAL_Z (cvt_s32_f16_z_tied1, svint32_t, svfloat16_t,
	     z16_res = svcvt_s32_f16_z (p0, z16),
	     z16_res = svcvt_s32_z (p0, z16))
...
TEST_DUAL_Z (cvt_s32_f16_z_untied, svint32_t, svfloat16_t,
	     z0 = svcvt_s32_f16_z (p0, z16),
	     z0 = svcvt_s32_z (p0, z16))
...
TEST_DUAL_Z (cvt_s32_f32_z_tied1, svint32_t, svfloat32_t,
	     z16_res = svcvt_s32_f32_z (p0, z16),
	     z16_res = svcvt_s32_z (p0, z16))
...
TEST_DUAL_Z (cvt_s32_f64_z_tied1, svint32_t, svfloat64_t,
	     z16_res = svcvt_s32_f64_z (p0, z16),
	     z16_res = svcvt_s32_z (p0, z16))
...
TEST_DUAL_Z (cvt_s32_f64_z_untied, svint32_t, svfloat64_t,
	     z0 = svcvt_s32_f64_z (p0, z16),
	     z0 = svcvt_s32_z (p0, z16))

/*
** cvt_s32_f16_x_tied1:
**	fcvtzs	z16\.s, p0/m, z16\.h
**	ret
*/
TEST_DUAL_Z (cvt_s32_f16_x_tied1, svint32_t, svfloat16_t,
	     z16_res = svcvt_s32_f16_x (p0, z16),
	     z16_res = svcvt_s32_x (p0, z16))
...
TEST_DUAL_Z (cvt_s32_f16_x_untied, svint32_t, svfloat16_t,
	     z0 = svcvt_s32_f16_x (p0, z16),
	     z0 = svcvt_s32_x (p0, z16))
...
TEST_DUAL_Z (cvt_s32_f32_x_tied1, svint32_t, svfloat32_t,
	     z16_res = svcvt_s32_f32_x (p0, z16),
	     z16_res = svcvt_s32_x (p0, z16))
...
TEST_DUAL_Z (cvt_s32_f32_x_untied, svint32_t, svfloat32_t,
	     z0 = svcvt_s32_f32_x (p0, z16),
	     z0 = svcvt_s32_x (p0, z16))

/*
** cvt_s32_f64_x_tied1:
**	fcvtzs	z16\.s, p0/m, z16\.d
**	ret
*/
TEST_DUAL_Z (cvt_s32_f64_x_tied1, svint32_t, svfloat64_t,
	     z16_res = svcvt_s32_f64_x (p0, z16),
	     z16_res = svcvt_s32_x (p0, z16))
