...
/*
** cvt_u32_f16_m_tied1:
**	fcvtzu	z0\.s, p0/m, z6\.h
**	ret
*/
TEST_DUAL_Z (cvt_u32_f16_m_tied1, svuint32_t, svfloat16_t,
	     z0 = svcvt_u32_f16_m (z0, p0, z6),
	     z0 = svcvt_u32_m (z0, p0, z6))

/*
** cvt_u32_f16_m_tied2:
**	mov	(z[0-9]+)\.d, z6\.d
**	movprfx	z6, z0
**	fcvtzu	z6\.s, p0/m, \1\.h
**	ret
*/
TEST_DUAL_Z (cvt_u32_f16_m_tied2, svuint32_t, svfloat16_t,
	     z6_res = svcvt_u32_f16_m (z0, p0, z6),
	     z6_res = svcvt_u32_m (z0, p0, z6))
...
TEST_DUAL_Z (cvt_u32_f16_m_untied, svuint32_t, svfloat16_t,
	     z0 = svcvt_u32_f16_m (z1, p0, z6),
	     z0 = svcvt_u32_m (z1, p0, z6))

/*
** cvt_u32_f32_m_tied1:
**	fcvtzu	z0\.s, p0/m, z6\.s
**	ret
*/
TEST_DUAL_Z (cvt_u32_f32_m_tied1, svuint32_t, svfloat32_t,
	     z0 = svcvt_u32_f32_m (z0, p0, z6),
	     z0 = svcvt_u32_m (z0, p0, z6))
...
TEST_DUAL_Z (cvt_u32_f32_m_untied, svuint32_t, svfloat32_t,
	     z0 = svcvt_u32_f32_m (z1, p0, z6),
	     z0 = svcvt_u32_m (z1, p0, z6))

/*
** cvt_u32_f64_m_tied1:
**	fcvtzu	z0\.s, p0/m, z6\.d
**	ret
*/
TEST_DUAL_Z (cvt_u32_f64_m_tied1, svuint32_t, svfloat64_t,
	     z0 = svcvt_u32_f64_m (z0, p0, z6),
	     z0 = svcvt_u32_m (z0, p0, z6))
...
TEST_DUAL_Z (cvt_u32_f64_m_tied2, svuint32_t, svfloat64_t,
	     z6_res = svcvt_u32_f64_m (z0, p0, z6),
	     z6_res = svcvt_u32_m (z0, p0, z6))
...
TEST_DUAL_Z (cvt_u32_f16_z_tied1, svuint32_t, svfloat16_t,
	     z6_res = svcvt_u32_f16_z (p0, z6),
	     z6_res = svcvt_u32_z (p0, z6))
...
TEST_DUAL_Z (cvt_u32_f16_z_untied, svuint32_t, svfloat16_t,
	     z0 = svcvt_u32_f16_z (p0, z6),
	     z0 = svcvt_u32_z (p0, z6))
...
TEST_DUAL_Z (cvt_u32_f64_z_untied, svuint32_t, svfloat64_t,
	     z0 = svcvt_u32_f64_z (p0, z6),
	     z0 = svcvt_u32_z (p0, z6))

/*
** cvt_u32_f16_x_tied1:
**	fcvtzu	z6\.s, p0/m, z6\.h
**	ret
*/
TEST_DUAL_Z (cvt_u32_f16_x_tied1, svuint32_t, svfloat16_t,
	     z6_res = svcvt_u32_f16_x (p0, z6),
	     z6_res = svcvt_u32_x (p0, z6))
...
TEST_DUAL_Z (cvt_u32_f16_x_untied, svuint32_t, svfloat16_t,
	     z0 = svcvt_u32_f16_x (p0, z6),
	     z0 = svcvt_u32_x (p0, z6))

/*
** cvt_u32_f32_x_tied1:
**	fcvtzu	z6\.s, p0/m, z6\.s
**	ret
*/
TEST_DUAL_Z (cvt_u32_f32_x_tied1, svuint32_t, svfloat32_t,
	     z6_res = svcvt_u32_f32_x (p0, z6),
	     z6_res = svcvt_u32_x (p0, z6))
...
TEST_DUAL_Z (cvt_u32_f32_x_untied, svuint32_t, svfloat32_t,
	     z0 = svcvt_u32_f32_x (p0, z6),
	     z0 = svcvt_u32_x (p0, z6))

/*
** cvt_u32_f64_x_tied1:
**	fcvtzu	z6\.s, p0/m, z6\.d
**	ret
*/
TEST_DUAL_Z (cvt_u32_f64_x_tied1, svuint32_t, svfloat64_t,
	     z6_res = svcvt_u32_f64_x (p0, z6),
	     z6_res = svcvt_u32_x (p0, z6))
