...
**	ret
*/
TEST_UNIFORM_ZS (div_h0_f16_m_tied1, svfloat16_t, __fp16,
		 z1 = svdiv_n_f16_m (p0, z1, d0),
		 z1 = svdiv_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (div_h0_f16_m_untied, svfloat16_t, __fp16,
		 z1 = svdiv_n_f16_m (p0, z2, d0),
		 z1 = svdiv_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (div_h0_f16_z_tied1, svfloat16_t, __fp16,
		 z1 = svdiv_n_f16_z (p0, z1, d0),
		 z1 = svdiv_z (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (div_h0_f16_z_untied, svfloat16_t, __fp16,
		 z1 = svdiv_n_f16_z (p0, z2, d0),
		 z1 = svdiv_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (div_h0_f16_x_tied1, svfloat16_t, __fp16,
		 z1 = svdiv_n_f16_x (p0, z1, d0),
		 z1 = svdiv_x (p0, z1, d0))

/*
** div_h0_f16_x_untied:
**	mov	z2\.h, h0
**	fdivr	z2\.h, p0/m, z2\.h, z1\.h
**	ret
*/
TEST_UNIFORM_ZS (div_h0_f16_x_untied, svfloat16_t, __fp16,
		 z2 = svdiv_n_f16_x (p0, z1, d0),
		 z2 = svdiv_x (p0, z1, d0))
...
**	ptrue	(p[0-7])\.h[^\n]*
**	fdivr	z1\.h, \1/m, z1\.h, z0\.h
**	ret
*/
TEST_UNIFORM_Z (ptrue_div_f16_x_tied2, svfloat16_t,
		z1 = svdiv_f16_x (svptrue_b16 (), z0, z1),
		z1 = svdiv_x (svptrue_b16 (), z0, z1))
...
TEST_UNIFORM_Z (ptrue_div_f16_x_untied, svfloat16_t,
		z2 = svdiv_f16_x (svptrue_b16 (), z0, z1),
		z2 = svdiv_x (svptrue_b16 (), z0, z1))
...
TEST_UNIFORM_ZS (ptrue_div_w0_f16_x_untied, svfloat16_t, __fp16,
		 z1 = svdiv_n_f16_x (svptrue_b16 (), z0, x0),
		 z1 = svdiv_x (svptrue_b16 (), z0, x0))

/*
** ptrue_div_h0_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), h0
**	fdiv	z1\.h, \1/m, z1\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_div_h0_f16_x_tied1, svfloat16_t, __fp16,
		 z1 = svdiv_n_f16_x (svptrue_b16 (), z1, d0),
		 z1 = svdiv_x (svptrue_b16 (), z1, d0))

/*
** ptrue_div_h0_f16_x_untied:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	z2\.h, h0
**	fdivr	z2\.h, \1/m, z2\.h, z1\.h
**	ret
*/
TEST_UNIFORM_ZS (ptrue_div_h0_f16_x_untied, svfloat16_t, __fp16,
		 z2 = svdiv_n_f16_x (svptrue_b16 (), z1, d0),
		 z2 = svdiv_x (svptrue_b16 (), z1, d0))
...
TEST_UNIFORM_Z (ptrue_div_1_f16_x_tied1, svfloat16_t,
		z1 = svdiv_n_f16_x (svptrue_b16 (), z1, 1),
		z1 = svdiv_x (svptrue_b16 (), z1, 1))

/*
** ptrue_b8_div_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	fdiv	z0\.h, \1/m, z0\.h, z1\.h
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_div_f16_x_tied1, svfloat16_t,
		z0 = svdiv_f16_x (svptrue_b8 (), z0, z1),
		z0 = svdiv_x (svptrue_b8 (), z0, z1))

/*
** ptrue_b8_div_f16_x_tied2:
**	ptrue	(p[0-7])\.h[^\n]*
**	fdivr	z1\.h, \1/m, z1\.h, z0\.h
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_div_f16_x_tied2, svfloat16_t,
		z1 = svdiv_f16_x (svptrue_b8 (), z0, z1),
		z1 = svdiv_x (svptrue_b8 (), z0, z1))

/*
** ptrue_b8_div_f16_x_untied:
**	ptrue	(p[0-7])\.h[^\n]*
**	movprfx	z2, z0
**	fdiv	z2\.h, \1/m, z2\.h, z1\.h
**	ret
*/
TEST_UNIFORM_Z (ptrue_b8_div_f16_x_untied, svfloat16_t,
		z2 = svdiv_f16_x (svptrue_b8 (), z0, z1),
