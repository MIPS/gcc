...
TEST_UNIFORM_ZS (div_s4_s32_z_tied1, svint32_t, int32_t,
		 z1 = svdiv_n_s32_z (p0, z1, d4),
		 z1 = svdiv_z (p0, z1, d4))

/*
** div_s4_s32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s4
