...
**	ret
*/
TEST_UNIFORM_ZS (div_s4_u32_m_tied1, svuint32_t, uint32_t,
		 z0 = svdiv_n_u32_m (p0, z0, d4),
		 z0 = svdiv_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (div_s4_u32_m_untied, svuint32_t, uint32_t,
		 z0 = svdiv_n_u32_m (p0, z1, d4),
		 z0 = svdiv_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (div_s4_u32_z_tied1, svuint32_t, uint32_t,
		 z0 = svdiv_n_u32_z (p0, z0, d4),
		 z0 = svdiv_z (p0, z0, d4))

/*
** div_s4_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s4
**	movprfx	z0\.s, p0/z, z1\.s
**	udiv	z0\.s, p0/m, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (div_s4_u32_z_untied, svuint32_t, uint32_t,
		 z0 = svdiv_n_u32_z (p0, z1, d4),
		 z0 = svdiv_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (div_s4_u32_x_tied1, svuint32_t, uint32_t,
		 z0 = svdiv_n_u32_x (p0, z0, d4),
		 z0 = svdiv_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (div_s4_u32_x_untied, svuint32_t, uint32_t,
		 z0 = svdiv_n_u32_x (p0, z1, d4),
		 z0 = svdiv_x (p0, z1, d4))
