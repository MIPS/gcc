...
TEST_UNIFORM_ZS (ptrue_divr_w0_f32_x_untied, svfloat32_t, float,
		 z0 = svdivr_n_f32_x (svptrue_b32 (), z1, x0),
		 z0 = svdivr_x (svptrue_b32 (), z1, x0))
...
TEST_UNIFORM_ZS (ptrue_divr_s4_f32_x_tied1, svfloat32_t, float,
		 z0 = svdivr_n_f32_x (svptrue_b32 (), z0, d4),
		 z0 = svdivr_x (svptrue_b32 (), z0, d4))
...
TEST_UNIFORM_ZS (ptrue_divr_s4_f32_x_untied, svfloat32_t, float,
		 z0 = svdivr_n_f32_x (svptrue_b32 (), z1, d4),
		 z0 = svdivr_x (svptrue_b32 (), z1, d4))
...
TEST_UNIFORM_Z (ptrue_b8_divr_f32_x_tied2, svfloat32_t,
		z0 = svdivr_f32_x (svptrue_b8 (), z1, z0),
...
TEST_UNIFORM_Z (ptrue_b8_divr_f32_x_untied, svfloat32_t,
		z0 = svdivr_f32_x (svptrue_b8 (), z1, z2),
