...
**	ret
*/
TEST_UNIFORM_ZS (divr_d4_u64_m_tied1, svuint64_t, uint64_t,
		 z0 = svdivr_n_u64_m (p0, z0, d4),
		 z0 = svdivr_m (p0, z0, d4))

/*
** divr_d4_u64_m_untied:
**	mov	(z[0-9]+\.d), d4
**	movprfx	z0, z1
**	udivr	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (divr_d4_u64_m_untied, svuint64_t, uint64_t,
		 z0 = svdivr_n_u64_m (p0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (divr_d4_u64_z_tied1, svuint64_t, uint64_t,
		 z0 = svdivr_n_u64_z (p0, z0, d4),
		 z0 = svdivr_z (p0, z0, d4))

/*
** divr_d4_u64_z_untied:
**	mov	(z[0-9]+\.d), d4
** (
**	movprfx	z0\.d, p0/z, z1\.d
**	udivr	z0\.d, p0/m, z0\.d, \1
...
**	ret
*/
TEST_UNIFORM_ZS (divr_d4_u64_z_untied, svuint64_t, uint64_t,
		 z0 = svdivr_n_u64_z (p0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (divr_d4_u64_x_tied1, svuint64_t, uint64_t,
		 z0 = svdivr_n_u64_x (p0, z0, d4),
		 z0 = svdivr_x (p0, z0, d4))

/*
** divr_d4_u64_x_untied:
**	mov	z0\.d, d4
**	udiv	z0\.d, p0/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (divr_d4_u64_x_untied, svuint64_t, uint64_t,
		 z0 = svdivr_n_u64_x (p0, z1, d4),
