...
**	ret
*/
TEST_UNIFORM_ZS (dup_d4_f64, svfloat64_t, double,
		z0 = svdup_n_f64 (d4),
		z0 = svdup_f64 (d4))
...
TEST_UNIFORM_ZS (dup_x0_f64_m, svfloat64_t, double,
		z0 = svdup_n_f64_m (z1, p0, x0),
		z0 = svdup_f64_m (z1, p0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (dup_d4_f64_m, svfloat64_t, double,
...
TEST_UNIFORM_ZS (dup_x0_f64_z, svfloat64_t, double,
		z0 = svdup_n_f64_z (p0, x0),
		z0 = svdup_f64_z (p0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (dup_d4_f64_z, svfloat64_t, double,
...
TEST_UNIFORM_ZS (dup_x0_f64_x, svfloat64_t, double,
		z0 = svdup_n_f64_x (p0, x0),
		z0 = svdup_f64_x (p0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (dup_d4_f64_x, svfloat64_t, double,
