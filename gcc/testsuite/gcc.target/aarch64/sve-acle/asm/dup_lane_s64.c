...
**	ret
*/
TEST_UNIFORM_ZS (dup_lane_x0_s64_tied1, svint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (dup_lane_x0_s64_untied, svint64_t, uint64_t,
		 z0 = svdup_lane_s64 (z1, x0),
		 z0 = svdup_lane (z1, x0))

/*
** dup_lane_d4_s64_tied1:
**	mov	(z[0-9]+\.d), d4
**	tbl	z0\.d, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (dup_lane_d4_s64_tied1, svint64_t, uint64_t,
		 z0 = svdup_lane_s64 (z0, d4),
		 z0 = svdup_lane (z0, d4))

/*
** dup_lane_d4_s64_untied:
**	mov	(z[0-9]+\.d), d4
**	tbl	z0\.d, z1\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (dup_lane_d4_s64_untied, svint64_t, uint64_t,
		 z0 = svdup_lane_s64 (z1, d4),
		 z0 = svdup_lane (z1, d4))
