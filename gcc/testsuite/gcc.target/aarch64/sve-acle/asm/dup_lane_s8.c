...
**	ret
*/
TEST_UNIFORM_ZS (dup_lane_w0_s8_tied1, svint8_t, uint8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (dup_lane_w0_s8_untied, svint8_t, uint8_t,
		 z0 = svdup_lane_s8 (z1, x0),
		 z0 = svdup_lane (z1, x0))

/*
** dup_lane_b4_s8_tied1:
**	mov	(z[0-9]+\.b), b4
**	tbl	z0\.b, z0\.b, \1
**	ret
*/
TEST_UNIFORM_ZS (dup_lane_b4_s8_tied1, svint8_t, uint8_t,
		 z0 = svdup_lane_s8 (z0, d4),
		 z0 = svdup_lane (z0, d4))

/*
** dup_lane_b4_s8_untied:
**	mov	(z[0-9]+\.b), b4
**	tbl	z0\.b, z1\.b, \1
**	ret
*/
TEST_UNIFORM_ZS (dup_lane_b4_s8_untied, svint8_t, uint8_t,
		 z0 = svdup_lane_s8 (z1, d4),
		 z0 = svdup_lane (z1, d4))
