...
**	ret
*/
TEST_UNIFORM_ZS (dup_lane_w0_u32_tied1, svuint32_t, uint32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (dup_lane_w0_u32_untied, svuint32_t, uint32_t,
		 z0 = svdup_lane_u32 (z1, x0),
		 z0 = svdup_lane (z1, x0))

/*
** dup_lane_s4_u32_tied1:
**	mov	(z[0-9]+\.s), s4
**	tbl	z0\.s, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (dup_lane_s4_u32_tied1, svuint32_t, uint32_t,
		 z0 = svdup_lane_u32 (z0, d4),
		 z0 = svdup_lane (z0, d4))

/*
** dup_lane_s4_u32_untied:
**	mov	(z[0-9]+\.s), s4
**	tbl	z0\.s, z1\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (dup_lane_s4_u32_untied, svuint32_t, uint32_t,
		 z0 = svdup_lane_u32 (z1, d4),
		 z0 = svdup_lane (z1, d4))
