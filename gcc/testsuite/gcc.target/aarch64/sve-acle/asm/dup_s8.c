...
**	ret
*/
TEST_UNIFORM_ZS (dup_b0_s8, svint8_t, int8_t,
		 z1 = svdup_n_s8 (d0),
		 z1 = svdup_s8 (d0))
...
**	ret
*/
TEST_UNIFORM_ZS (dup_b0_s8_m, svint8_t, int8_t,
		z1 = svdup_n_s8_m (z0, p0, d0),
		z1 = svdup_s8_m (z0, p0, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (dup_b0_s8_z, svint8_t, int8_t,
		z1 = svdup_n_s8_z (p0, d0),
		z1 = svdup_s8_z (p0, d0))
