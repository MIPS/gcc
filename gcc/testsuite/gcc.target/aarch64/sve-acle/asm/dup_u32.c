...
**	ret
*/
TEST_UNIFORM_ZS (dup_s0_u32, svuint32_t, uint32_t,
		 z1 = svdup_n_u32 (d0),
		 z1 = svdup_u32 (d0))
...
**	ret
*/
TEST_UNIFORM_ZS (dup_s0_u32_m, svuint32_t, uint32_t,
		z1 = svdup_n_u32_m (z0, p0, d0),
		z1 = svdup_u32_m (z0, p0, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (dup_s0_u32_z, svuint32_t, uint32_t,
		z1 = svdup_n_u32_z (p0, d0),
		z1 = svdup_u32_z (p0, d0))
