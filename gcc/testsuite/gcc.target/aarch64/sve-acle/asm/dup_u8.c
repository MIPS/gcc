...
**	ret
*/
TEST_UNIFORM_ZS (dup_w0_u8, svuint8_t, uint8_t,
		 z0 = svdup_n_u8 (x0),
		 z0 = svdup_u8 (x0))
...
**	ret
*/
TEST_UNIFORM_ZS (dup_b4_u8, svuint8_t, uint8_t,
		 z0 = svdup_n_u8 (d4),
		 z0 = svdup_u8 (d4))
...
**	ret
*/
TEST_UNIFORM_ZS (dup_w0_u8_m, svuint8_t, uint8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (dup_b4_u8_m, svuint8_t, uint8_t,
		z0 = svdup_n_u8_m (z1, p0, d4),
		z0 = svdup_u8_m (z1, p0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (dup_w0_u8_z, svuint8_t, uint8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (dup_b4_u8_z, svuint8_t, uint8_t,
		z0 = svdup_n_u8_z (p0, d4),
		z0 = svdup_u8_z (p0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (dup_w0_u8_x, svuint8_t, uint8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (dup_b4_u8_x, svuint8_t, uint8_t,
		z0 = svdup_n_u8_x (p0, d4),
		z0 = svdup_u8_x (p0, d4))
