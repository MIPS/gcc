...
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_s16_m_tied1, svint16_t, int16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_s16_m_untied, svint16_t, int16_t,
...
** eor_h0_s16_m_tied1:
**	mov	(z[0-9]+\.h), h0
**	eor	z1\.h, p0/m, z1\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (eor_h0_s16_m_tied1, svint16_t, int16_t,
		 z1 = sveor_n_s16_m (p0, z1, d0),
		 z1 = sveor_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_h0_s16_m_untied, svint16_t, int16_t,
		 z1 = sveor_n_s16_m (p0, z2, d0),
		 z1 = sveor_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_s16_z_tied1, svint16_t, int16_t,
		 z0 = sveor_n_s16_z (p0, z0, x0),
		 z0 = sveor_z (p0, z0, x0))

/*
** eor_w0_s16_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.h), w0
**	movprfx	z0\.h, p0/z, z1\.h
**	eor	z0\.h, p0/m, z0\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_s16_z_untied, svint16_t, int16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (eor_h0_s16_z_tied1, svint16_t, int16_t,
		 z1 = sveor_n_s16_z (p0, z1, d0),
		 z1 = sveor_z (p0, z1, d0))

/*
** eor_h0_s16_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.h), h0
**	movprfx	z1\.h, p0/z, z2\.h
**	eor	z1\.h, p0/m, z1\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (eor_h0_s16_z_untied, svint16_t, int16_t,
		 z1 = sveor_n_s16_z (p0, z2, d0),
		 z1 = sveor_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_s16_x_tied1, svint16_t, int16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_s16_x_untied, svint16_t, int16_t,
		 z1 = sveor_n_s16_x (p0, z0, x0),
		 z1 = sveor_x (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_h0_s16_x_tied1, svint16_t, int16_t,
		 z1 = sveor_n_s16_x (p0, z1, d0),
		 z1 = sveor_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_h0_s16_x_untied, svint16_t, int16_t,
		 z2 = sveor_n_s16_x (p0, z1, d0),
		 z2 = sveor_x (p0, z1, d0))
