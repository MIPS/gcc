...
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_s32_m_tied1, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_s32_m_untied, svint32_t, int32_t,
...
** eor_s4_s32_m_tied1:
**	mov	(z[0-9]+\.s), s4
**	eor	z1\.s, p0/m, z1\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (eor_s4_s32_m_tied1, svint32_t, int32_t,
		 z1 = sveor_n_s32_m (p0, z1, d4),
		 z1 = sveor_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_s4_s32_m_untied, svint32_t, int32_t,
		 z1 = sveor_n_s32_m (p0, z2, d4),
		 z1 = sveor_m (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_s32_z_tied1, svint32_t, int32_t,
		 z0 = sveor_n_s32_z (p0, z0, x0),
		 z0 = sveor_z (p0, z0, x0))

/*
** eor_w0_s32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), w0
**	movprfx	z0\.s, p0/z, z1\.s
**	eor	z0\.s, p0/m, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_s32_z_untied, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (eor_s4_s32_z_tied1, svint32_t, int32_t,
		 z1 = sveor_n_s32_z (p0, z1, d4),
		 z1 = sveor_z (p0, z1, d4))

/*
** eor_s4_s32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s4
**	movprfx	z1\.s, p0/z, z2\.s
**	eor	z1\.s, p0/m, z1\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (eor_s4_s32_z_untied, svint32_t, int32_t,
		 z1 = sveor_n_s32_z (p0, z2, d4),
		 z1 = sveor_z (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_s32_x_tied1, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (eor_s4_s32_x_tied1, svint32_t, int32_t,
		 z1 = sveor_n_s32_x (p0, z1, d4),
		 z1 = sveor_x (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_s4_s32_x_untied, svint32_t, int32_t,
		 z2 = sveor_n_s32_x (p0, z1, d4),
		 z2 = sveor_x (p0, z1, d4))
