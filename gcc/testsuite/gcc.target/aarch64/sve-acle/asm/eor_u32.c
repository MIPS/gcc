...
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_u32_m_tied1, svuint32_t, uint32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_u32_m_untied, svuint32_t, uint32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (eor_s0_u32_m_tied1, svuint32_t, uint32_t,
		 z1 = sveor_n_u32_m (p0, z1, d0),
		 z1 = sveor_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_s0_u32_m_untied, svuint32_t, uint32_t,
		 z1 = sveor_n_u32_m (p0, z2, d0),
		 z1 = sveor_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_u32_z_tied1, svuint32_t, uint32_t,
		 z0 = sveor_n_u32_z (p0, z0, x0),
		 z0 = sveor_z (p0, z0, x0))

/*
** eor_w0_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), w0
**	movprfx	z0\.s, p0/z, z1\.s
**	eor	z0\.s, p0/m, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (eor_w0_u32_z_untied, svuint32_t, uint32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (eor_s0_u32_z_tied1, svuint32_t, uint32_t,
		 z1 = sveor_n_u32_z (p0, z1, d0),
		 z1 = sveor_z (p0, z1, d0))

/*
** eor_s0_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s0
**	movprfx	z1\.s, p0/z, z2\.s
**	eor	z1\.s, p0/m, z1\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (eor_s0_u32_z_untied, svuint32_t, uint32_t,
		 z1 = sveor_n_u32_z (p0, z2, d0),
		 z1 = sveor_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_s0_u32_x_tied1, svuint32_t, uint32_t,
		 z1 = sveor_n_u32_x (p0, z1, d0),
		 z1 = sveor_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_s0_u32_x_untied, svuint32_t, uint32_t,
		 z2 = sveor_n_u32_x (p0, z1, d0),
		 z2 = sveor_x (p0, z1, d0))
