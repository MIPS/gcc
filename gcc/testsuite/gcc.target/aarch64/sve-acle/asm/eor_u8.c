...
**	ret
*/
TEST_UNIFORM_ZS (eor_b0_u8_m_tied1, svuint8_t, uint8_t,
		 z1 = sveor_n_u8_m (p0, z1, d0),
		 z1 = sveor_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_b0_u8_m_untied, svuint8_t, uint8_t,
		 z1 = sveor_n_u8_m (p0, z2, d0),
		 z1 = sveor_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_b0_u8_z_tied1, svuint8_t, uint8_t,
		 z1 = sveor_n_u8_z (p0, z1, d0),
		 z1 = sveor_z (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_b0_u8_z_untied, svuint8_t, uint8_t,
		 z1 = sveor_n_u8_z (p0, z2, d0),
		 z1 = sveor_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_b0_u8_x_tied1, svuint8_t, uint8_t,
		 z1 = sveor_n_u8_x (p0, z1, d0),
		 z1 = sveor_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (eor_b0_u8_x_untied, svuint8_t, uint8_t,
		 z2 = sveor_n_u8_x (p0, z1, d0),
		 z2 = sveor_x (p0, z1, d0))
