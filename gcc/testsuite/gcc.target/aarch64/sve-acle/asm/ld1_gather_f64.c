...
/*
** ld1_gather_d4_f64_offset:
**	fmov	(x[0-9]+), d4
**	ld1d	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_ZS (ld1_gather_d4_f64_offset, svfloat64_t, svuint64_t,
		     z0_res = svld1_gather_u64base_offset_f64 (p0, z0, d4),
		     z0_res = svld1_gather_offset_f64 (p0, z0, d4))
...
/*
** ld1_gather_d4_f64_s64offset:
**	fmov	(x[0-9]+), d4
**	ld1d	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1_gather_d4_f64_s64offset, svfloat64_t, float64_t, svint64_t,
		     z0_res = svld1_gather_s64offset_f64 (p0, d4, z0),
...
/*
** ld1_gather_d4_f64_u64offset:
**	fmov	(x[0-9]+), d4
**	ld1d	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1_gather_d4_f64_u64offset, svfloat64_t, float64_t, svuint64_t,
		     z0_res = svld1_gather_u64offset_f64 (p0, d4, z0),
		     z0_res = svld1_gather_offset (p0, d4, z0))
...
/*
** ld1_gather_d4_f64_s64index:
**	fmov	(x[0-9]+), d4
**	ld1d	z0\.d, p0/z, \[\1, z0\.d, lsl 3\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1_gather_d4_f64_s64index, svfloat64_t, float64_t, svint64_t,
		     z0_res = svld1_gather_s64index_f64 (p0, d4, z0),
...
/*
** ld1_gather_d4_f64_u64index:
**	fmov	(x[0-9]+), d4
**	ld1d	z0\.d, p0/z, \[\1, z0\.d, lsl 3\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1_gather_d4_f64_u64index, svfloat64_t, float64_t, svuint64_t,
		     z0_res = svld1_gather_u64index_f64 (p0, d4, z0),
		     z0_res = svld1_gather_index (p0, d4, z0))
