...
/*
** ld1sb_gather_d4_u64_offset:
**	fmov	(x[0-9]+), d4
**	ld1sb	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_ZS (ld1sb_gather_d4_u64_offset, svuint64_t, svuint64_t,
		     z0_res = svld1sb_gather_u64base_offset_u64 (p0, z0, d4),
		     z0_res = svld1sb_gather_offset_u64 (p0, z0, d4))
...
/*
** ld1sb_gather_d4_u64_s64offset:
**	fmov	(x[0-9]+), d4
**	ld1sb	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sb_gather_d4_u64_s64offset, svuint64_t, int8_t, svint64_t,
		     z0_res = svld1sb_gather_s64offset_u64 (p0, d4, z0),
		     z0_res = svld1sb_gather_offset_u64 (p0, d4, z0))
...
/*
** ld1sb_gather_d4_u64_u64offset:
**	fmov	(x[0-9]+), d4
**	ld1sb	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sb_gather_d4_u64_u64offset, svuint64_t, int8_t, svuint64_t,
		     z0_res = svld1sb_gather_u64offset_u64 (p0, d4, z0),
		     z0_res = svld1sb_gather_offset_u64 (p0, d4, z0))
