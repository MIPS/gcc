...
/*
** ld1sh_gather_d4_s32_offset:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.s, p0/z, \[\1, z0\.s, uxtw\]
**	ret
*/
TEST_LOAD_GATHER_ZS (ld1sh_gather_d4_s32_offset, svint32_t, svuint32_t,
		     z0_res = svld1sh_gather_u32base_offset_s32 (p0, z0, d4),
		     z0_res = svld1sh_gather_offset_s32 (p0, z0, d4))
...
/*
** ld1sh_gather_d4_s32_s32offset:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.s, p0/z, \[\1, z0\.s, sxtw\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sh_gather_d4_s32_s32offset, svint32_t, int16_t, svint32_t,
		     z0_res = svld1sh_gather_s32offset_s32 (p0, d4, z0),
		     z0_res = svld1sh_gather_offset_s32 (p0, d4, z0))
...
/*
** ld1sh_gather_d4_s32_u32offset:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.s, p0/z, \[\1, z0\.s, uxtw\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sh_gather_d4_s32_u32offset, svint32_t, int16_t, svuint32_t,
		     z0_res = svld1sh_gather_u32offset_s32 (p0, d4, z0),
		     z0_res = svld1sh_gather_offset_s32 (p0, d4, z0))
...
/*
** ld1sh_gather_d4_s32_s32index:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.s, p0/z, \[\1, z0\.s, sxtw 1\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sh_gather_d4_s32_s32index, svint32_t, int16_t, svint32_t,
		     z0_res = svld1sh_gather_s32index_s32 (p0, d4, z0),
		     z0_res = svld1sh_gather_index_s32 (p0, d4, z0))
...
/*
** ld1sh_gather_d4_s32_u32index:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.s, p0/z, \[\1, z0\.s, uxtw 1\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sh_gather_d4_s32_u32index, svint32_t, int16_t, svuint32_t,
		     z0_res = svld1sh_gather_u32index_s32 (p0, d4, z0),
		     z0_res = svld1sh_gather_index_s32 (p0, d4, z0))
