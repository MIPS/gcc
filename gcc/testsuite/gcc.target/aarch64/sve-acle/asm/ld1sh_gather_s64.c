...
/*
** ld1sh_gather_d4_s64_offset:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_ZS (ld1sh_gather_d4_s64_offset, svint64_t, svuint64_t,
		     z0_res = svld1sh_gather_u64base_offset_s64 (p0, z0, d4),
		     z0_res = svld1sh_gather_offset_s64 (p0, z0, d4))
...
/*
** ld1sh_gather_d4_s64_s64offset:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sh_gather_d4_s64_s64offset, svint64_t, int16_t, svint64_t,
		     z0_res = svld1sh_gather_s64offset_s64 (p0, d4, z0),
		     z0_res = svld1sh_gather_offset_s64 (p0, d4, z0))
...
/*
** ld1sh_gather_d4_s64_u64offset:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sh_gather_d4_s64_u64offset, svint64_t, int16_t, svuint64_t,
		     z0_res = svld1sh_gather_u64offset_s64 (p0, d4, z0),
		     z0_res = svld1sh_gather_offset_s64 (p0, d4, z0))
...
/*
** ld1sh_gather_d4_s64_s64index:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.d, p0/z, \[\1, z0\.d, lsl 1\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sh_gather_d4_s64_s64index, svint64_t, int16_t, svint64_t,
		     z0_res = svld1sh_gather_s64index_s64 (p0, d4, z0),
		     z0_res = svld1sh_gather_index_s64 (p0, d4, z0))
...
/*
** ld1sh_gather_d4_s64_u64index:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.d, p0/z, \[\1, z0\.d, lsl 1\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sh_gather_d4_s64_u64index, svint64_t, int16_t, svuint64_t,
		     z0_res = svld1sh_gather_u64index_s64 (p0, d4, z0),
		     z0_res = svld1sh_gather_index_s64 (p0, d4, z0))
