...
/*
** ld1sh_gather_d4_u64_offset:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_ZS (ld1sh_gather_d4_u64_offset, svuint64_t, svuint64_t,
		     z0_res = svld1sh_gather_u64base_offset_u64 (p0, z0, d4),
		     z0_res = svld1sh_gather_offset_u64 (p0, z0, d4))
...
/*
** ld1sh_gather_d4_u64_s64offset:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sh_gather_d4_u64_s64offset, svuint64_t, int16_t, svint64_t,
		     z0_res = svld1sh_gather_s64offset_u64 (p0, d4, z0),
		     z0_res = svld1sh_gather_offset_u64 (p0, d4, z0))
...
/*
** ld1sh_gather_d4_u64_u64offset:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sh_gather_d4_u64_u64offset, svuint64_t, int16_t, svuint64_t,
		     z0_res = svld1sh_gather_u64offset_u64 (p0, d4, z0),
		     z0_res = svld1sh_gather_offset_u64 (p0, d4, z0))
...
/*
** ld1sh_gather_d4_u64_s64index:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.d, p0/z, \[\1, z0\.d, lsl 1\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sh_gather_d4_u64_s64index, svuint64_t, int16_t, svint64_t,
		     z0_res = svld1sh_gather_s64index_u64 (p0, d4, z0),
		     z0_res = svld1sh_gather_index_u64 (p0, d4, z0))
...
/*
** ld1sh_gather_d4_u64_u64index:
**	fmov	(x[0-9]+), d4
**	ld1sh	z0\.d, p0/z, \[\1, z0\.d, lsl 1\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ld1sh_gather_d4_u64_u64index, svuint64_t, int16_t, svuint64_t,
		     z0_res = svld1sh_gather_u64index_u64 (p0, d4, z0),
		     z0_res = svld1sh_gather_index_u64 (p0, d4, z0))
