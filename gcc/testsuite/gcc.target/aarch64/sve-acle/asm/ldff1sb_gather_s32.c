...
/*
** ldff1sb_gather_d4_s32_offset:
**	fmov	(x[0-9]+), d4
**	ldff1sb	z0\.s, p0/z, \[\1, z0\.s, uxtw\]
**	ret
*/
TEST_LOAD_GATHER_ZS (ldff1sb_gather_d4_s32_offset, svint32_t, svuint32_t,
		     z0_res = svldff1sb_gather_u32base_offset_s32 (p0, z0, d4),
		     z0_res = svldff1sb_gather_offset_s32 (p0, z0, d4))
...
/*
** ldff1sb_gather_d4_s32_s32offset:
**	fmov	(x[0-9]+), d4
**	ldff1sb	z0\.s, p0/z, \[\1, z0\.s, sxtw\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ldff1sb_gather_d4_s32_s32offset, svint32_t, int8_t, svint32_t,
		     z0_res = svldff1sb_gather_s32offset_s32 (p0, d4, z0),
		     z0_res = svldff1sb_gather_offset_s32 (p0, d4, z0))
...
/*
** ldff1sb_gather_d4_s32_u32offset:
**	fmov	(x[0-9]+), d4
**	ldff1sb	z0\.s, p0/z, \[\1, z0\.s, uxtw\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ldff1sb_gather_d4_s32_u32offset, svint32_t, int8_t, svuint32_t,
		     z0_res = svldff1sb_gather_u32offset_s32 (p0, d4, z0),
		     z0_res = svldff1sb_gather_offset_s32 (p0, d4, z0))
