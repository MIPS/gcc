...
/*
** ldff1sb_gather_d4_s64_offset:
**	fmov	(x[0-9]+), d4
**	ldff1sb	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_ZS (ldff1sb_gather_d4_s64_offset, svint64_t, svuint64_t,
		     z0_res = svldff1sb_gather_u64base_offset_s64 (p0, z0, d4),
		     z0_res = svldff1sb_gather_offset_s64 (p0, z0, d4))
...
/*
** ldff1sb_gather_d4_s64_s64offset:
**	fmov	(x[0-9]+), d4
**	ldff1sb	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ldff1sb_gather_d4_s64_s64offset, svint64_t, int8_t, svint64_t,
		     z0_res = svldff1sb_gather_s64offset_s64 (p0, d4, z0),
		     z0_res = svldff1sb_gather_offset_s64 (p0, d4, z0))
...
/*
** ldff1sb_gather_d4_s64_u64offset:
**	fmov	(x[0-9]+), d4
**	ldff1sb	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ldff1sb_gather_d4_s64_u64offset, svint64_t, int8_t, svuint64_t,
		     z0_res = svldff1sb_gather_u64offset_s64 (p0, d4, z0),
		     z0_res = svldff1sb_gather_offset_s64 (p0, d4, z0))
