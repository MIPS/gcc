...
/*
** ldff1sh_gather_d4_u32_offset:
**	fmov	(x[0-9]+), d4
**	ldff1sh	z0\.s, p0/z, \[\1, z0\.s, uxtw\]
**	ret
*/
TEST_LOAD_GATHER_ZS (ldff1sh_gather_d4_u32_offset, svuint32_t, svuint32_t,
		     z0_res = svldff1sh_gather_u32base_offset_u32 (p0, z0, d4),
		     z0_res = svldff1sh_gather_offset_u32 (p0, z0, d4))
...
/*
** ldff1sh_gather_d4_u32_s32offset:
**	fmov	(x[0-9]+), d4
**	ldff1sh	z0\.s, p0/z, \[\1, z0\.s, sxtw\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ldff1sh_gather_d4_u32_s32offset, svuint32_t, int16_t, svint32_t,
		     z0_res = svldff1sh_gather_s32offset_u32 (p0, d4, z0),
		     z0_res = svldff1sh_gather_offset_u32 (p0, d4, z0))
...
/*
** ldff1sh_gather_d4_u32_u32offset:
**	fmov	(x[0-9]+), d4
**	ldff1sh	z0\.s, p0/z, \[\1, z0\.s, uxtw\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ldff1sh_gather_d4_u32_u32offset, svuint32_t, int16_t, svuint32_t,
		     z0_res = svldff1sh_gather_u32offset_u32 (p0, d4, z0),
		     z0_res = svldff1sh_gather_offset_u32 (p0, d4, z0))
...
/*
** ldff1sh_gather_d4_u32_s32index:
**	fmov	(x[0-9]+), d4
**	ldff1sh	z0\.s, p0/z, \[\1, z0\.s, sxtw 1\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ldff1sh_gather_d4_u32_s32index, svuint32_t, int16_t, svint32_t,
		     z0_res = svldff1sh_gather_s32index_u32 (p0, d4, z0),
		     z0_res = svldff1sh_gather_index_u32 (p0, d4, z0))
...
/*
** ldff1sh_gather_d4_u32_u32index:
**	fmov	(x[0-9]+), d4
**	ldff1sh	z0\.s, p0/z, \[\1, z0\.s, uxtw 1\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ldff1sh_gather_d4_u32_u32index, svuint32_t, int16_t, svuint32_t,
		     z0_res = svldff1sh_gather_u32index_u32 (p0, d4, z0),
		     z0_res = svldff1sh_gather_index_u32 (p0, d4, z0))
