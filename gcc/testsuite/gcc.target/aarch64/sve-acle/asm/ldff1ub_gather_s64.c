...
/*
** ldff1ub_gather_d4_s64_offset:
**	fmov	(x[0-9]+), d4
**	ldff1b	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_ZS (ldff1ub_gather_d4_s64_offset, svint64_t, svuint64_t,
		     z0_res = svldff1ub_gather_u64base_offset_s64 (p0, z0, d4),
		     z0_res = svldff1ub_gather_offset_s64 (p0, z0, d4))
...
/*
** ldff1ub_gather_d4_s64_s64offset:
**	fmov	(x[0-9]+), d4
**	ldff1b	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ldff1ub_gather_d4_s64_s64offset, svint64_t, uint8_t, svint64_t,
		     z0_res = svldff1ub_gather_s64offset_s64 (p0, d4, z0),
		     z0_res = svldff1ub_gather_offset_s64 (p0, d4, z0))
...
/*
** ldff1ub_gather_d4_s64_u64offset:
**	fmov	(x[0-9]+), d4
**	ldff1b	z0\.d, p0/z, \[\1, z0\.d\]
**	ret
*/
TEST_LOAD_GATHER_SZ (ldff1ub_gather_d4_s64_u64offset, svint64_t, uint8_t, svuint64_t,
		     z0_res = svldff1ub_gather_u64offset_s64 (p0, d4, z0),
		     z0_res = svldff1ub_gather_offset_s64 (p0, d4, z0))
