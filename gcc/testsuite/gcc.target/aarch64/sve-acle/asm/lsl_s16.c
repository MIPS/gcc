...
TEST_UNIFORM_ZS (lsl_d4_s16_z_tied1, svint16_t, uint64_t,
		 z1 = svlsl_n_s16_z (p0, z1, d4),
		 z1 = svlsl_z (p0, z1, d4))

/*
** lsl_d4_s16_z_untied: { xfail *-*-* }
**	mov	(z[0-9d]+\.d), d4
