...
/*
** lsl_s32_m_tied1:
**	lsl	z0\.s, p0/m, z0\.s, z16\.s
**	ret
*/
TEST_DUAL_Z (lsl_s32_m_tied1, svint32_t, svuint32_t,
	     z0 = svlsl_s32_m (p0, z0, z16),
...
**	mov	(z[0-9]+)\.d, z16\.d
**	movprfx	z16, z0
**	lsl	z16\.s, p0/m, z16\.s, \1\.s
**	ret
*/
TEST_DUAL_Z (lsl_s32_m_tied2, svint32_t, svuint32_t,
	     z16_res = svlsl_s32_m (p0, z0, z16),
