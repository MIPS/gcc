...
**	mov	(z[0-9]+\.d), z6\.d
**	movprfx	z6, z0
**	lsl	z6\.d, p0/m, z6\.d, \1
**	ret
*/
TEST_DUAL_Z (lsl_s64_m_tied2, svint64_t, svuint64_t,
	     z6_res = svlsl_s64_m (p0, z0, z6),
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_s64_m_tied1, svint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_s64_m_untied, svint64_t, uint64_t,
...
TEST_DUAL_Z (lsl_s64_z_tied1, svint64_t, svuint64_t,
	     z0 = svlsl_s64_z (p0, z0, z6),
	     z0 = svlsl_z (p0, z0, z6))

/*
** lsl_s64_z_tied2:
**	movprfx	z6\.d, p0/z, z6\.d
**	lslr	z6\.d, p0/m, z6\.d, z0\.d
**	ret
*/
TEST_DUAL_Z (lsl_s64_z_tied2, svint64_t, svuint64_t,
	     z6_res = svlsl_s64_z (p0, z0, z6),
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_s64_z_tied1, svint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_s64_z_untied, svint64_t, uint64_t,
...
**	ret
*/
TEST_DUAL_Z (lsl_s64_x_tied2, svint64_t, svuint64_t,
	     z6_res = svlsl_s64_x (p0, z0, z6),
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_s64_x_tied1, svint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_s64_x_untied, svint64_t, uint64_t,
