...
TEST_UNIFORM_ZS (lsl_d4_s8_z_tied1, svint8_t, uint64_t,
		 z1 = svlsl_n_s8_z (p0, z1, d4),
		 z1 = svlsl_z (p0, z1, d4))

/*
** lsl_d4_s8_z_untied: { xfail *-*-* }
**	mov	(z[0-9d]+\.d), d4
