...
TEST_UNIFORM_ZS (lsl_d4_u32_z_tied1, svuint32_t, uint64_t,
		 z1 = svlsl_n_u32_z (p0, z1, d4),
		 z1 = svlsl_z (p0, z1, d4))

/*
** lsl_d4_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9d]+\.d), d4
