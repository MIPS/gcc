...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_u64_m_tied1, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_u64_m_untied, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_u64_z_tied1, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_u64_z_untied, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_u64_x_tied1, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_u64_x_untied, svuint64_t, uint64_t,
