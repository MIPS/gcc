...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_u8_m_tied1, svuint8_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_u8_m_untied, svuint8_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_d4_u8_m_tied1, svuint8_t, uint64_t,
		 z0 = svlsl_n_u8_m (p0, z0, d4),
		 z0 = svlsl_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_d4_u8_m_untied, svuint8_t, uint64_t,
		 z0 = svlsl_n_u8_m (p0, z1, d4),
		 z0 = svlsl_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_u8_z_tied1, svuint8_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_u8_z_untied, svuint8_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_d4_u8_z_tied1, svuint8_t, uint64_t,
		 z0 = svlsl_n_u8_z (p0, z0, d4),
		 z0 = svlsl_z (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_d4_u8_z_untied, svuint8_t, uint64_t,
		 z0 = svlsl_n_u8_z (p0, z1, d4),
		 z0 = svlsl_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_u8_x_tied1, svuint8_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_x0_u8_x_untied, svuint8_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_d4_u8_x_tied1, svuint8_t, uint64_t,
		 z0 = svlsl_n_u8_x (p0, z0, d4),
		 z0 = svlsl_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsl_d4_u8_x_untied, svuint8_t, uint64_t,
		 z0 = svlsl_n_u8_x (p0, z1, d4),
		 z0 = svlsl_x (p0, z1, d4))
