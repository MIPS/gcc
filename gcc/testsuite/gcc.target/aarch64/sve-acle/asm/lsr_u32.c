...
**	ret
*/
TEST_UNIFORM_ZS (lsr_x0_u32_m_tied1, svuint32_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_x0_u32_m_untied, svuint32_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_d4_u32_m_tied1, svuint32_t, uint64_t,
		 z0 = svlsr_n_u32_m (p0, z0, d4),
		 z0 = svlsr_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_d4_u32_m_untied, svuint32_t, uint64_t,
		 z0 = svlsr_n_u32_m (p0, z1, d4),
		 z0 = svlsr_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_x0_u32_z_tied1, svuint32_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_x0_u32_z_untied, svuint32_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_d4_u32_z_tied1, svuint32_t, uint64_t,
		 z0 = svlsr_n_u32_z (p0, z0, d4),
		 z0 = svlsr_z (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_d4_u32_z_untied, svuint32_t, uint64_t,
		 z0 = svlsr_n_u32_z (p0, z1, d4),
		 z0 = svlsr_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_x0_u32_x_tied1, svuint32_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_x0_u32_x_untied, svuint32_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_d4_u32_x_tied1, svuint32_t, uint64_t,
		 z0 = svlsr_n_u32_x (p0, z0, d4),
		 z0 = svlsr_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_d4_u32_x_untied, svuint32_t, uint64_t,
		 z0 = svlsr_n_u32_x (p0, z1, d4),
		 z0 = svlsr_x (p0, z1, d4))
