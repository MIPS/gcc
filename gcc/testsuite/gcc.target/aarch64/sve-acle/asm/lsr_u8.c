...
**	ret
*/
TEST_UNIFORM_ZS (lsr_x0_u8_m_tied1, svuint8_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_x0_u8_m_untied, svuint8_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_d4_u8_m_tied1, svuint8_t, uint64_t,
		 z0 = svlsr_n_u8_m (p0, z0, d4),
		 z0 = svlsr_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_d4_u8_m_untied, svuint8_t, uint64_t,
		 z0 = svlsr_n_u8_m (p0, z1, d4),
		 z0 = svlsr_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_x0_u8_z_tied1, svuint8_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_x0_u8_z_untied, svuint8_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_d4_u8_z_tied1, svuint8_t, uint64_t,
		 z0 = svlsr_n_u8_z (p0, z0, d4),
		 z0 = svlsr_z (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_d4_u8_z_untied, svuint8_t, uint64_t,
		 z0 = svlsr_n_u8_z (p0, z1, d4),
		 z0 = svlsr_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_x0_u8_x_tied1, svuint8_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_x0_u8_x_untied, svuint8_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_d4_u8_x_tied1, svuint8_t, uint64_t,
		 z0 = svlsr_n_u8_x (p0, z0, d4),
		 z0 = svlsr_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (lsr_d4_u8_x_untied, svuint8_t, uint64_t,
		 z0 = svlsr_n_u8_x (p0, z1, d4),
		 z0 = svlsr_x (p0, z1, d4))
