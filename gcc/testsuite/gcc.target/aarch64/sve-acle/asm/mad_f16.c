...
**	ret
*/
TEST_UNIFORM_ZS (mad_h4_f16_m_tied1, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_h4_f16_m_tied2, svfloat16_t, __fp16,
		 z0 = svmad_n_f16_m (p0, z1, z0, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_h4_f16_m_untied, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_h4_f16_z_tied1, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_h4_f16_z_tied2, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_h4_f16_z_untied, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_h4_f16_x_tied1, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_h4_f16_x_tied2, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_h4_f16_x_untied, svfloat16_t, __fp16,
...
** (
**	movprfx	z0, z1
**	fmad	z0\.h, \1/m, z2\.h, z3\.h
** |
**	movprfx	z0, z2
**	fmad	z0\.h, \1/m, z1\.h, z3\.h
** |
**	movprfx	z0, z3
**	fmla	z0\.h, \1/m, z1\.h, z2\.h
** )
...
/*
** ptrue_mad_w0_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), w0
**	fmad	z0\.h, \1/m, z1\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mad_w0_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svmad_n_f16_x (svptrue_b16 (), z0, z1, x0),
		 z0 = svmad_x (svptrue_b16 (), z0, z1, x0))

/*
** ptrue_mad_w0_f16_x_tied2:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), w0
**	fmad	z0\.h, \1/m, z1\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mad_w0_f16_x_tied2, svfloat16_t, __fp16,
		 z0 = svmad_n_f16_x (svptrue_b16 (), z1, z0, x0),
		 z0 = svmad_x (svptrue_b16 (), z1, z0, x0))

/*
** ptrue_mad_w0_f16_x_untied:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	z0\.h, w0
**	fmla	z0\.h, \1/m, z1\.h, z2\.h
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mad_w0_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svmad_n_f16_x (svptrue_b16 (), z1, z2, x0),
		 z0 = svmad_x (svptrue_b16 (), z1, z2, x0))

/*
** ptrue_mad_h4_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), h4
**	fmad	z0\.h, \1/m, z1\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mad_h4_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svmad_n_f16_x (svptrue_b16 (), z0, z1, d4),
		 z0 = svmad_x (svptrue_b16 (), z0, z1, d4))

/*
** ptrue_mad_h4_f16_x_tied2:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), h4
**	fmad	z0\.h, \1/m, z1\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mad_h4_f16_x_tied2, svfloat16_t, __fp16,
		 z0 = svmad_n_f16_x (svptrue_b16 (), z1, z0, d4),
		 z0 = svmad_x (svptrue_b16 (), z1, z0, d4))

/*
** ptrue_mad_h4_f16_x_untied:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	z0\.h, h4
**	fmla	z0\.h, \1/m, z1\.h, z2\.h
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mad_h4_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svmad_n_f16_x (svptrue_b16 (), z1, z2, d4),
		 z0 = svmad_x (svptrue_b16 (), z1, z2, d4))
