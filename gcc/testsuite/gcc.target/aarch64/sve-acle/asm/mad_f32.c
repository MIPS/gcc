...
**	ret
*/
TEST_UNIFORM_ZS (mad_s4_f32_m_tied1, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s4_f32_m_tied2, svfloat32_t, float,
		 z0 = svmad_n_f32_m (p0, z1, z0, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s4_f32_m_untied, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s4_f32_z_tied1, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s4_f32_z_tied2, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s4_f32_z_untied, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s4_f32_x_tied1, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s4_f32_x_tied2, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s4_f32_x_untied, svfloat32_t, float,
...
** (
**	movprfx	z0, z1
**	fmad	z0\.s, \1/m, z2\.s, z3\.s
** |
**	movprfx	z0, z2
**	fmad	z0\.s, \1/m, z1\.s, z3\.s
** |
**	movprfx	z0, z3
**	fmla	z0\.s, \1/m, z1\.s, z2\.s
** )
...
/*
** ptrue_mad_w0_f32_x_tied1:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	(z[0-9]+\.s), w0
**	fmad	z0\.s, \1/m, z1\.s, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mad_w0_f32_x_tied1, svfloat32_t, float,
		 z0 = svmad_n_f32_x (svptrue_b32 (), z0, z1, x0),
		 z0 = svmad_x (svptrue_b32 (), z0, z1, x0))

/*
** ptrue_mad_w0_f32_x_tied2:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	(z[0-9]+\.s), w0
**	fmad	z0\.s, \1/m, z1\.s, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mad_w0_f32_x_tied2, svfloat32_t, float,
		 z0 = svmad_n_f32_x (svptrue_b32 (), z1, z0, x0),
		 z0 = svmad_x (svptrue_b32 (), z1, z0, x0))

/*
** ptrue_mad_w0_f32_x_untied:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	z0\.s, w0
**	fmla	z0\.s, \1/m, z1\.s, z2\.s
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mad_w0_f32_x_untied, svfloat32_t, float,
		 z0 = svmad_n_f32_x (svptrue_b32 (), z1, z2, x0),
		 z0 = svmad_x (svptrue_b32 (), z1, z2, x0))

/*
** ptrue_mad_s4_f32_x_tied1:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	(z[0-9]+\.s), s4
**	fmad	z0\.s, \1/m, z1\.s, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mad_s4_f32_x_tied1, svfloat32_t, float,
		 z0 = svmad_n_f32_x (svptrue_b32 (), z0, z1, d4),
		 z0 = svmad_x (svptrue_b32 (), z0, z1, d4))

/*
** ptrue_mad_s4_f32_x_tied2:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	(z[0-9]+\.s), s4
**	fmad	z0\.s, \1/m, z1\.s, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mad_s4_f32_x_tied2, svfloat32_t, float,
		 z0 = svmad_n_f32_x (svptrue_b32 (), z1, z0, d4),
		 z0 = svmad_x (svptrue_b32 (), z1, z0, d4))

/*
** ptrue_mad_s4_f32_x_untied:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	z0\.s, s4
**	fmla	z0\.s, \1/m, z1\.s, z2\.s
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mad_s4_f32_x_untied, svfloat32_t, float,
		 z0 = svmad_n_f32_x (svptrue_b32 (), z1, z2, d4),
		 z0 = svmad_x (svptrue_b32 (), z1, z2, d4))
