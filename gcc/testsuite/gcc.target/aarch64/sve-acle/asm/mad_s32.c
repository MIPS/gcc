...
**	ret
*/
TEST_UNIFORM_ZS (mad_s4_s32_m_tied1, svint32_t, int32_t,
		 z0 = svmad_n_s32_m (p0, z0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s4_s32_z_tied1, svint32_t, int32_t,
		 z0 = svmad_n_s32_z (p0, z0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_Z (mad_2_s32_z_tied1, svint32_t,
		z0 = svmad_n_s32_z (p0, z0, z1, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mad_2_s32_z_tied2, svint32_t,
		z0 = svmad_n_s32_z (p0, z1, z0, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mad_2_s32_z_untied, svint32_t,
		z0 = svmad_n_s32_z (p0, z1, z2, 2),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s4_s32_x_tied1, svint32_t, int32_t,
		 z0 = svmad_n_s32_x (p0, z0, z1, d4),
