...
**	ret
*/
TEST_UNIFORM_Z (mad_2_s64_z_tied1, svint64_t,
		z0 = svmad_n_s64_z (p0, z0, z1, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mad_2_s64_z_tied2, svint64_t,
		z0 = svmad_n_s64_z (p0, z1, z0, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mad_2_s64_z_untied, svint64_t,
		z0 = svmad_n_s64_z (p0, z1, z2, 2),
