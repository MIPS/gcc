...
**	ret
*/
TEST_UNIFORM_ZS (mad_d0_s64_m_tied1, svint64_t, int64_t,
		 z0 = svmad_n_s64_m (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_d0_s64_m_tied2, svint64_t, int64_t,
		 z1 = svmad_n_s64_m (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_d0_s64_m_untied, svint64_t, int64_t,
		 z1 = svmad_n_s64_m (p0, z0, z2, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_d0_s64_z_tied1, svint64_t, int64_t,
		 z0 = svmad_n_s64_z (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_d0_s64_z_tied2, svint64_t, int64_t,
		 z1 = svmad_n_s64_z (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_d0_s64_z_untied, svint64_t, int64_t,
		 z1 = svmad_n_s64_z (p0, z0, z2, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_d0_s64_x_tied1, svint64_t, int64_t,
		 z0 = svmad_n_s64_x (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_d0_s64_x_tied2, svint64_t, int64_t,
		 z1 = svmad_n_s64_x (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_d0_s64_x_untied, svint64_t, int64_t,
		 z2 = svmad_n_s64_x (p0, z0, z1, d0),
