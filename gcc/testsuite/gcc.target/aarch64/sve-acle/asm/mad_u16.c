...
**	ret
*/
TEST_UNIFORM_Z (mad_2_u16_z_tied1, svuint16_t,
		z0 = svmad_n_u16_z (p0, z0, z1, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mad_2_u16_z_tied2, svuint16_t,
		z0 = svmad_n_u16_z (p0, z1, z0, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mad_2_u16_z_untied, svuint16_t,
		z0 = svmad_n_u16_z (p0, z1, z2, 2),
