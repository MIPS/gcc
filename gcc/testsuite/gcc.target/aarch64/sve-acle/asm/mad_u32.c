...
**	ret
*/
TEST_UNIFORM_ZS (mad_s0_u32_m_tied1, svuint32_t, uint32_t,
		 z0 = svmad_n_u32_m (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s0_u32_m_tied2, svuint32_t, uint32_t,
		 z1 = svmad_n_u32_m (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s0_u32_m_untied, svuint32_t, uint32_t,
		 z1 = svmad_n_u32_m (p0, z0, z2, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s0_u32_z_tied1, svuint32_t, uint32_t,
		 z0 = svmad_n_u32_z (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s0_u32_z_tied2, svuint32_t, uint32_t,
		 z1 = svmad_n_u32_z (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s0_u32_z_untied, svuint32_t, uint32_t,
		 z1 = svmad_n_u32_z (p0, z0, z2, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s0_u32_x_tied1, svuint32_t, uint32_t,
		 z0 = svmad_n_u32_x (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s0_u32_x_tied2, svuint32_t, uint32_t,
		 z1 = svmad_n_u32_x (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mad_s0_u32_x_untied, svuint32_t, uint32_t,
		 z2 = svmad_n_u32_x (p0, z0, z1, d0),
