...
**	ret
*/
TEST_UNIFORM_ZS (max_b4_s8_m_tied1, svint8_t, int8_t,
		 z0 = svmax_n_s8_m (p0, z0, d4),
		 z0 = svmax_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (max_b4_s8_m_untied, svint8_t, int8_t,
		 z0 = svmax_n_s8_m (p0, z1, d4),
		 z0 = svmax_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (max_b4_s8_z_tied1, svint8_t, int8_t,
		 z0 = svmax_n_s8_z (p0, z0, d4),
		 z0 = svmax_z (p0, z0, d4))

/*
** max_b4_s8_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.b), b4
**	movprfx	z0\.b, p0/z, z1\.b
**	smax	z0\.b, p0/m, z0\.b, \1
**	ret
*/
TEST_UNIFORM_ZS (max_b4_s8_z_untied, svint8_t, int8_t,
		 z0 = svmax_n_s8_z (p0, z1, d4),
		 z0 = svmax_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (max_b4_s8_x_tied1, svint8_t, int8_t,
		 z0 = svmax_n_s8_x (p0, z0, d4),
		 z0 = svmax_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (max_b4_s8_x_untied, svint8_t, int8_t,
		 z0 = svmax_n_s8_x (p0, z1, d4),
		 z0 = svmax_x (p0, z1, d4))
