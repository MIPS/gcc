...
**	ret
*/
TEST_UNIFORM_ZS (max_h4_u16_m_tied1, svuint16_t, uint16_t,
		 z1 = svmax_n_u16_m (p0, z1, d4),
		 z1 = svmax_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (max_h4_u16_m_untied, svuint16_t, uint16_t,
		 z1 = svmax_n_u16_m (p0, z2, d4),
		 z1 = svmax_m (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (max_h4_u16_z_tied1, svuint16_t, uint16_t,
		 z1 = svmax_n_u16_z (p0, z1, d4),
		 z1 = svmax_z (p0, z1, d4))

/*
** max_h4_u16_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.h), h4
**	movprfx	z1\.h, p0/z, z2\.h
**	umax	z1\.h, p0/m, z1\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (max_h4_u16_z_untied, svuint16_t, uint16_t,
		 z1 = svmax_n_u16_z (p0, z2, d4),
		 z1 = svmax_z (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (max_h4_u16_x_tied1, svuint16_t, uint16_t,
		 z1 = svmax_n_u16_x (p0, z1, d4),
		 z1 = svmax_x (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (max_h4_u16_x_untied, svuint16_t, uint16_t,
		 z2 = svmax_n_u16_x (p0, z1, d4),
		 z2 = svmax_x (p0, z1, d4))
