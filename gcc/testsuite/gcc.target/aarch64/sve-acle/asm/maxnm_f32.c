...
/*
** maxnm_w0_f32_m_tied1:
**	mov	(z[0-9]+\.s), w0
**	fmaxnm	z0\.s, p0/m, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (maxnm_w0_f32_m_tied1, svfloat32_t, float,
		 z0 = svmaxnm_n_f32_m (p0, z0, x0),
		 z0 = svmaxnm_m (p0, z0, x0))

/*
** maxnm_w0_f32_m_untied:
**	mov	(z[0-9]+\.s), w0
**	movprfx	z0, z1
**	fmaxnm	z0\.s, p0/m, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (maxnm_w0_f32_m_untied, svfloat32_t, float,
		 z0 = svmaxnm_n_f32_m (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_s4_f32_m_tied1, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_s4_f32_m_untied, svfloat32_t, float,
...
/*
** maxnm_w0_f32_z_tied1:
**	mov	(z[0-9]+\.s), w0
**	movprfx	z0\.s, p0/z, z0\.s
**	fmaxnm	z0\.s, p0/m, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (maxnm_w0_f32_z_tied1, svfloat32_t, float,
		 z0 = svmaxnm_n_f32_z (p0, z0, x0),
		 z0 = svmaxnm_z (p0, z0, x0))

/*
** maxnm_w0_f32_z_untied:
**	mov	(z[0-9]+\.s), w0
** (
**	movprfx	z0\.s, p0/z, z1\.s
**	fmaxnm	z0\.s, p0/m, z0\.s, \1
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_w0_f32_z_untied, svfloat32_t, float,
		 z0 = svmaxnm_n_f32_z (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_s4_f32_z_tied1, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_s4_f32_z_untied, svfloat32_t, float,
...
/*
** maxnm_w0_f32_x_tied1:
**	mov	(z[0-9]+\.s), w0
**	fmaxnm	z0\.s, p0/m, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (maxnm_w0_f32_x_tied1, svfloat32_t, float,
		 z0 = svmaxnm_n_f32_x (p0, z0, x0),
		 z0 = svmaxnm_x (p0, z0, x0))

/*
** maxnm_w0_f32_x_untied:
**	mov	z0\.s, w0
**	fmaxnm	z0\.s, p0/m, z0\.s, z1\.s
**	ret
*/
TEST_UNIFORM_ZS (maxnm_w0_f32_x_untied, svfloat32_t, float,
		 z0 = svmaxnm_n_f32_x (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_s4_f32_x_tied1, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_s4_f32_x_untied, svfloat32_t, float,
...
/*
** ptrue_maxnm_w0_f32_x_tied1:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	(z[0-9]+\.s), w0
**	fmaxnm	z0\.s, \1/m, z0\.s, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_maxnm_w0_f32_x_tied1, svfloat32_t, float,
		 z0 = svmaxnm_n_f32_x (svptrue_b32 (), z0, x0),
		 z0 = svmaxnm_x (svptrue_b32 (), z0, x0))

/*
** ptrue_maxnm_w0_f32_x_untied:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	z0\.s, w0
**	fmaxnm	z0\.s, \1/m, z0\.s, z1\.s
**	ret
*/
TEST_UNIFORM_ZS (ptrue_maxnm_w0_f32_x_untied, svfloat32_t, float,
		 z0 = svmaxnm_n_f32_x (svptrue_b32 (), z1, x0),
		 z0 = svmaxnm_x (svptrue_b32 (), z1, x0))

/*
** ptrue_maxnm_s4_f32_x_tied1:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	(z[0-9]+\.s), s4
**	fmaxnm	z0\.s, \1/m, z0\.s, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_maxnm_s4_f32_x_tied1, svfloat32_t, float,
		 z0 = svmaxnm_n_f32_x (svptrue_b32 (), z0, d4),
		 z0 = svmaxnm_x (svptrue_b32 (), z0, d4))

/*
** ptrue_maxnm_s4_f32_x_untied:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	z0\.s, s4
**	fmaxnm	z0\.s, \1/m, z0\.s, z1\.s
**	ret
*/
TEST_UNIFORM_ZS (ptrue_maxnm_s4_f32_x_untied, svfloat32_t, float,
		 z0 = svmaxnm_n_f32_x (svptrue_b32 (), z1, d4),
		 z0 = svmaxnm_x (svptrue_b32 (), z1, d4))

/*
** ptrue_maxnm_0_f32_x_tied1:
**	ptrue	(p[0-7])\.s[^\n]*
**	fmaxnm	z0\.s, \1/m, z0\.s, #0\.0
**	ret
*/
