...
/*
** maxnm_x0_f64_m_tied1:
**	mov	(z[0-9]+\.d), x0
**	fmaxnm	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (maxnm_x0_f64_m_tied1, svfloat64_t, double,
		 z0 = svmaxnm_n_f64_m (p0, z0, x0),
		 z0 = svmaxnm_m (p0, z0, x0))

/*
** maxnm_x0_f64_m_untied:
**	mov	(z[0-9]+\.d), x0
**	movprfx	z0, z1
**	fmaxnm	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (maxnm_x0_f64_m_untied, svfloat64_t, double,
		 z0 = svmaxnm_n_f64_m (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_d4_f64_m_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_d4_f64_m_untied, svfloat64_t, double,
...
/*
** maxnm_x0_f64_z_tied1:
**	mov	(z[0-9]+\.d), x0
**	movprfx	z0\.d, p0/z, z0\.d
**	fmaxnm	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (maxnm_x0_f64_z_tied1, svfloat64_t, double,
		 z0 = svmaxnm_n_f64_z (p0, z0, x0),
		 z0 = svmaxnm_z (p0, z0, x0))

/*
** maxnm_x0_f64_z_untied:
**	mov	(z[0-9]+\.d), x0
** (
**	movprfx	z0\.d, p0/z, z1\.d
**	fmaxnm	z0\.d, p0/m, z0\.d, \1
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_x0_f64_z_untied, svfloat64_t, double,
		 z0 = svmaxnm_n_f64_z (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_d4_f64_z_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_d4_f64_z_untied, svfloat64_t, double,
...
/*
** maxnm_x0_f64_x_tied1:
**	mov	(z[0-9]+\.d), x0
**	fmaxnm	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (maxnm_x0_f64_x_tied1, svfloat64_t, double,
		 z0 = svmaxnm_n_f64_x (p0, z0, x0),
		 z0 = svmaxnm_x (p0, z0, x0))

/*
** maxnm_x0_f64_x_untied:
**	mov	z0\.d, x0
**	fmaxnm	z0\.d, p0/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (maxnm_x0_f64_x_untied, svfloat64_t, double,
		 z0 = svmaxnm_n_f64_x (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_d4_f64_x_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (maxnm_d4_f64_x_untied, svfloat64_t, double,
...
/*
** ptrue_maxnm_x0_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), x0
**	fmaxnm	z0\.d, \1/m, z0\.d, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_maxnm_x0_f64_x_tied1, svfloat64_t, double,
		 z0 = svmaxnm_n_f64_x (svptrue_b64 (), z0, x0),
		 z0 = svmaxnm_x (svptrue_b64 (), z0, x0))

/*
** ptrue_maxnm_x0_f64_x_untied:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	z0\.d, x0
**	fmaxnm	z0\.d, \1/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_maxnm_x0_f64_x_untied, svfloat64_t, double,
		 z0 = svmaxnm_n_f64_x (svptrue_b64 (), z1, x0),
		 z0 = svmaxnm_x (svptrue_b64 (), z1, x0))

/*
** ptrue_maxnm_d4_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), d4
**	fmaxnm	z0\.d, \1/m, z0\.d, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_maxnm_d4_f64_x_tied1, svfloat64_t, double,
		 z0 = svmaxnm_n_f64_x (svptrue_b64 (), z0, d4),
		 z0 = svmaxnm_x (svptrue_b64 (), z0, d4))

/*
** ptrue_maxnm_d4_f64_x_untied:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	z0\.d, d4
**	fmaxnm	z0\.d, \1/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_maxnm_d4_f64_x_untied, svfloat64_t, double,
		 z0 = svmaxnm_n_f64_x (svptrue_b64 (), z1, d4),
		 z0 = svmaxnm_x (svptrue_b64 (), z1, d4))

/*
** ptrue_maxnm_0_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	fmaxnm	z0\.d, \1/m, z0\.d, #0\.0
**	ret
*/
