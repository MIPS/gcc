...
/*
** ptrue_min_x0_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), x0
**	fmin	z0\.d, \1/m, z0\.d, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_min_x0_f64_x_tied1, svfloat64_t, double,
		 z0 = svmin_n_f64_x (svptrue_b64 (), z0, x0),
		 z0 = svmin_x (svptrue_b64 (), z0, x0))

/*
** ptrue_min_x0_f64_x_untied:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	z0\.d, x0
**	fmin	z0\.d, \1/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_min_x0_f64_x_untied, svfloat64_t, double,
		 z0 = svmin_n_f64_x (svptrue_b64 (), z1, x0),
		 z0 = svmin_x (svptrue_b64 (), z1, x0))

/*
** ptrue_min_d4_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), d4
**	fmin	z0\.d, \1/m, z0\.d, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_min_d4_f64_x_tied1, svfloat64_t, double,
		 z0 = svmin_n_f64_x (svptrue_b64 (), z0, d4),
		 z0 = svmin_x (svptrue_b64 (), z0, d4))

/*
** ptrue_min_d4_f64_x_untied:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	z0\.d, d4
**	fmin	z0\.d, \1/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_min_d4_f64_x_untied, svfloat64_t, double,
		 z0 = svmin_n_f64_x (svptrue_b64 (), z1, d4),
		 z0 = svmin_x (svptrue_b64 (), z1, d4))

/*
** ptrue_min_0_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	fmin	z0\.d, \1/m, z0\.d, #0\.0
**	ret
*/
