...
TEST_UNIFORM_ZS (min_d4_s64_z_tied1, svint64_t, int64_t,
		 z1 = svmin_n_s64_z (p0, z1, d4),
		 z1 = svmin_z (p0, z1, d4))

/*
** min_d4_s64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), d4
