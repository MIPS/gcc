...
TEST_UNIFORM_ZS (min_s4_u32_z_tied1, svuint32_t, uint32_t,
		 z1 = svmin_n_u32_z (p0, z1, d4),
		 z1 = svmin_z (p0, z1, d4))

/*
** min_s4_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s4
