...
/*
** minnm_w0_f16_m_tied1:
**	mov	(z[0-9]+\.h), w0
**	fminnm	z0\.h, p0/m, z0\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (minnm_w0_f16_m_tied1, svfloat16_t, __fp16,
		 z0 = svminnm_n_f16_m (p0, z0, x0),
		 z0 = svminnm_m (p0, z0, x0))

/*
** minnm_w0_f16_m_untied:
**	mov	(z[0-9]+\.h), w0
**	movprfx	z0, z1
**	fminnm	z0\.h, p0/m, z0\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (minnm_w0_f16_m_untied, svfloat16_t, __fp16,
		 z0 = svminnm_n_f16_m (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_h4_f16_m_tied1, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_h4_f16_m_untied, svfloat16_t, __fp16,
...
/*
** minnm_w0_f16_z_tied1:
**	mov	(z[0-9]+\.h), w0
**	movprfx	z0\.h, p0/z, z0\.h
**	fminnm	z0\.h, p0/m, z0\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (minnm_w0_f16_z_tied1, svfloat16_t, __fp16,
		 z0 = svminnm_n_f16_z (p0, z0, x0),
		 z0 = svminnm_z (p0, z0, x0))

/*
** minnm_w0_f16_z_untied:
**	mov	(z[0-9]+\.h), w0
** (
**	movprfx	z0\.h, p0/z, z1\.h
**	fminnm	z0\.h, p0/m, z0\.h, \1
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_w0_f16_z_untied, svfloat16_t, __fp16,
		 z0 = svminnm_n_f16_z (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_h4_f16_z_tied1, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_h4_f16_z_untied, svfloat16_t, __fp16,
...
/*
** minnm_w0_f16_x_tied1:
**	mov	(z[0-9]+\.h), w0
**	fminnm	z0\.h, p0/m, z0\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (minnm_w0_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svminnm_n_f16_x (p0, z0, x0),
		 z0 = svminnm_x (p0, z0, x0))

/*
** minnm_w0_f16_x_untied:
**	mov	z0\.h, w0
**	fminnm	z0\.h, p0/m, z0\.h, z1\.h
**	ret
*/
TEST_UNIFORM_ZS (minnm_w0_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svminnm_n_f16_x (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_h4_f16_x_tied1, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_h4_f16_x_untied, svfloat16_t, __fp16,
...
/*
** ptrue_minnm_w0_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), w0
**	fminnm	z0\.h, \1/m, z0\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_minnm_w0_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svminnm_n_f16_x (svptrue_b16 (), z0, x0),
		 z0 = svminnm_x (svptrue_b16 (), z0, x0))

/*
** ptrue_minnm_w0_f16_x_untied:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	z0\.h, w0
**	fminnm	z0\.h, \1/m, z0\.h, z1\.h
**	ret
*/
TEST_UNIFORM_ZS (ptrue_minnm_w0_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svminnm_n_f16_x (svptrue_b16 (), z1, x0),
		 z0 = svminnm_x (svptrue_b16 (), z1, x0))

/*
** ptrue_minnm_h4_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), h4
**	fminnm	z0\.h, \1/m, z0\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_minnm_h4_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svminnm_n_f16_x (svptrue_b16 (), z0, d4),
		 z0 = svminnm_x (svptrue_b16 (), z0, d4))

/*
** ptrue_minnm_h4_f16_x_untied:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	z0\.h, h4
**	fminnm	z0\.h, \1/m, z0\.h, z1\.h
**	ret
*/
TEST_UNIFORM_ZS (ptrue_minnm_h4_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svminnm_n_f16_x (svptrue_b16 (), z1, d4),
		 z0 = svminnm_x (svptrue_b16 (), z1, d4))

/*
** ptrue_minnm_0_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	fminnm	z0\.h, \1/m, z0\.h, #0\.0
**	ret
*/
