...
/*
** minnm_x0_f64_m_tied1:
**	mov	(z[0-9]+\.d), x0
**	fminnm	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (minnm_x0_f64_m_tied1, svfloat64_t, double,
		 z0 = svminnm_n_f64_m (p0, z0, x0),
		 z0 = svminnm_m (p0, z0, x0))

/*
** minnm_x0_f64_m_untied:
**	mov	(z[0-9]+\.d), x0
**	movprfx	z0, z1
**	fminnm	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (minnm_x0_f64_m_untied, svfloat64_t, double,
		 z0 = svminnm_n_f64_m (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_d4_f64_m_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_d4_f64_m_untied, svfloat64_t, double,
...
/*
** minnm_x0_f64_z_tied1:
**	mov	(z[0-9]+\.d), x0
**	movprfx	z0\.d, p0/z, z0\.d
**	fminnm	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (minnm_x0_f64_z_tied1, svfloat64_t, double,
		 z0 = svminnm_n_f64_z (p0, z0, x0),
		 z0 = svminnm_z (p0, z0, x0))

/*
** minnm_x0_f64_z_untied:
**	mov	(z[0-9]+\.d), x0
** (
**	movprfx	z0\.d, p0/z, z1\.d
**	fminnm	z0\.d, p0/m, z0\.d, \1
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_x0_f64_z_untied, svfloat64_t, double,
		 z0 = svminnm_n_f64_z (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_d4_f64_z_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_d4_f64_z_untied, svfloat64_t, double,
...
/*
** minnm_x0_f64_x_tied1:
**	mov	(z[0-9]+\.d), x0
**	fminnm	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (minnm_x0_f64_x_tied1, svfloat64_t, double,
		 z0 = svminnm_n_f64_x (p0, z0, x0),
		 z0 = svminnm_x (p0, z0, x0))

/*
** minnm_x0_f64_x_untied:
**	mov	z0\.d, x0
**	fminnm	z0\.d, p0/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (minnm_x0_f64_x_untied, svfloat64_t, double,
		 z0 = svminnm_n_f64_x (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_d4_f64_x_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (minnm_d4_f64_x_untied, svfloat64_t, double,
...
/*
** ptrue_minnm_x0_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), x0
**	fminnm	z0\.d, \1/m, z0\.d, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_minnm_x0_f64_x_tied1, svfloat64_t, double,
		 z0 = svminnm_n_f64_x (svptrue_b64 (), z0, x0),
		 z0 = svminnm_x (svptrue_b64 (), z0, x0))

/*
** ptrue_minnm_x0_f64_x_untied:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	z0\.d, x0
**	fminnm	z0\.d, \1/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_minnm_x0_f64_x_untied, svfloat64_t, double,
		 z0 = svminnm_n_f64_x (svptrue_b64 (), z1, x0),
		 z0 = svminnm_x (svptrue_b64 (), z1, x0))

/*
** ptrue_minnm_d4_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), d4
**	fminnm	z0\.d, \1/m, z0\.d, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_minnm_d4_f64_x_tied1, svfloat64_t, double,
		 z0 = svminnm_n_f64_x (svptrue_b64 (), z0, d4),
		 z0 = svminnm_x (svptrue_b64 (), z0, d4))

/*
** ptrue_minnm_d4_f64_x_untied:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	z0\.d, d4
**	fminnm	z0\.d, \1/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_minnm_d4_f64_x_untied, svfloat64_t, double,
		 z0 = svminnm_n_f64_x (svptrue_b64 (), z1, d4),
		 z0 = svminnm_x (svptrue_b64 (), z1, d4))

/*
** ptrue_minnm_0_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	fminnm	z0\.d, \1/m, z0\.d, #0\.0
**	ret
*/
