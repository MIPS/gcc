...
** (
**	movprfx	z0, z1
**	fmla	z0\.d, \1/m, z2\.d, z3\.d
** |
**	movprfx	z0, z2
**	fmad	z0\.d, \1/m, z3\.d, z1\.d
** |
**	movprfx	z0, z3
**	fmad	z0\.d, \1/m, z2\.d, z1\.d
** )
...
/*
** ptrue_mla_x0_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), x0
**	fmla	z0\.d, \1/m, z1\.d, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mla_x0_f64_x_tied1, svfloat64_t, double,
		 z0 = svmla_n_f64_x (svptrue_b64 (), z0, z1, x0),
		 z0 = svmla_x (svptrue_b64 (), z0, z1, x0))

/*
** ptrue_mla_x0_f64_x_tied2:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), x0
**	fmad	z0\.d, \1/m, \2, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mla_x0_f64_x_tied2, svfloat64_t, double,
		 z0 = svmla_n_f64_x (svptrue_b64 (), z1, z0, x0),
		 z0 = svmla_x (svptrue_b64 (), z1, z0, x0))

/*
** ptrue_mla_x0_f64_x_untied:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	z0\.d, x0
**	fmad	z0\.d, \1/m, z2\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mla_x0_f64_x_untied, svfloat64_t, double,
		 z0 = svmla_n_f64_x (svptrue_b64 (), z1, z2, x0),
		 z0 = svmla_x (svptrue_b64 (), z1, z2, x0))

/*
** ptrue_mla_d4_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), d4
**	fmla	z0\.d, \1/m, z1\.d, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mla_d4_f64_x_tied1, svfloat64_t, double,
		 z0 = svmla_n_f64_x (svptrue_b64 (), z0, z1, d4),
		 z0 = svmla_x (svptrue_b64 (), z0, z1, d4))

/*
** ptrue_mla_d4_f64_x_tied2:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), d4
**	fmad	z0\.d, \1/m, \2, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mla_d4_f64_x_tied2, svfloat64_t, double,
		 z0 = svmla_n_f64_x (svptrue_b64 (), z1, z0, d4),
		 z0 = svmla_x (svptrue_b64 (), z1, z0, d4))

/*
** ptrue_mla_d4_f64_x_untied:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	z0\.d, d4
**	fmad	z0\.d, \1/m, z2\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mla_d4_f64_x_untied, svfloat64_t, double,
		 z0 = svmla_n_f64_x (svptrue_b64 (), z1, z2, d4),
		 z0 = svmla_x (svptrue_b64 (), z1, z2, d4))
