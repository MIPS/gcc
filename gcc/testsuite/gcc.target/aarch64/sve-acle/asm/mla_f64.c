...
TEST_UNIFORM_ZS (mla_d4_f64_z_tied2, svfloat64_t, double,
		 z1 = svmla_n_f64_z (p0, z0, z1, d4),
		 z1 = svmla_z (p0, z0, z1, d4))

/*
** mla_d4_f64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), d4
