...
**	ret
*/
TEST_UNIFORM_ZS (mla_h4_s16_m_tied1, svint16_t, int16_t,
		 z0 = svmla_n_s16_m (p0, z0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_h4_s16_m_tied2, svint16_t, int16_t,
		 z0 = svmla_n_s16_m (p0, z1, z0, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_h4_s16_m_untied, svint16_t, int16_t,
		 z0 = svmla_n_s16_m (p0, z1, z2, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_h4_s16_z_tied1, svint16_t, int16_t,
		 z0 = svmla_n_s16_z (p0, z0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_h4_s16_z_tied2, svint16_t, int16_t,
		 z0 = svmla_n_s16_z (p0, z1, z0, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_h4_s16_z_untied, svint16_t, int16_t,
		 z0 = svmla_n_s16_z (p0, z1, z2, d4),
...
**	ret
*/
TEST_UNIFORM_Z (mla_2_s16_z_tied1, svint16_t,
		z0 = svmla_n_s16_z (p0, z0, z1, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mla_2_s16_z_tied2, svint16_t,
		z0 = svmla_n_s16_z (p0, z1, z0, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mla_2_s16_z_untied, svint16_t,
		z0 = svmla_n_s16_z (p0, z1, z2, 2),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_h4_s16_x_tied1, svint16_t, int16_t,
		 z0 = svmla_n_s16_x (p0, z0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_h4_s16_x_tied2, svint16_t, int16_t,
		 z0 = svmla_n_s16_x (p0, z1, z0, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_h4_s16_x_untied, svint16_t, int16_t,
		 z0 = svmla_n_s16_x (p0, z1, z2, d4),
