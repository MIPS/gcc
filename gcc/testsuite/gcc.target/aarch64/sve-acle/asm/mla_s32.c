...
**	ret
*/
TEST_UNIFORM_Z (mla_2_s32_z_tied1, svint32_t,
		z0 = svmla_n_s32_z (p0, z0, z1, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mla_2_s32_z_tied2, svint32_t,
		z0 = svmla_n_s32_z (p0, z1, z0, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mla_2_s32_z_untied, svint32_t,
		z0 = svmla_n_s32_z (p0, z1, z2, 2),
