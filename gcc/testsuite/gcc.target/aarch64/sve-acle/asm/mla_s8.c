...
**	ret
*/
TEST_UNIFORM_ZS (mla_b4_s8_m_tied1, svint8_t, int8_t,
		 z0 = svmla_n_s8_m (p0, z0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_b4_s8_m_tied2, svint8_t, int8_t,
		 z0 = svmla_n_s8_m (p0, z1, z0, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_b4_s8_m_untied, svint8_t, int8_t,
		 z0 = svmla_n_s8_m (p0, z1, z2, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_b4_s8_z_tied1, svint8_t, int8_t,
		 z0 = svmla_n_s8_z (p0, z0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_b4_s8_z_tied2, svint8_t, int8_t,
		 z0 = svmla_n_s8_z (p0, z1, z0, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_b4_s8_z_untied, svint8_t, int8_t,
		 z0 = svmla_n_s8_z (p0, z1, z2, d4),
...
**	ret
*/
TEST_UNIFORM_Z (mla_2_s8_z_tied1, svint8_t,
		z0 = svmla_n_s8_z (p0, z0, z1, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mla_2_s8_z_tied2, svint8_t,
		z0 = svmla_n_s8_z (p0, z1, z0, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mla_2_s8_z_untied, svint8_t,
		z0 = svmla_n_s8_z (p0, z1, z2, 2),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_b4_s8_x_tied1, svint8_t, int8_t,
		 z0 = svmla_n_s8_x (p0, z0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_b4_s8_x_tied2, svint8_t, int8_t,
		 z0 = svmla_n_s8_x (p0, z1, z0, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_b4_s8_x_untied, svint8_t, int8_t,
		 z0 = svmla_n_s8_x (p0, z1, z2, d4),
