...
**	ret
*/
TEST_UNIFORM_ZS (mla_d4_u64_m_tied1, svuint64_t, uint64_t,
		 z0 = svmla_n_u64_m (p0, z0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_d4_u64_m_untied, svuint64_t, uint64_t,
		 z1 = svmla_n_u64_m (p0, z0, z2, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_d4_u64_z_tied1, svuint64_t, uint64_t,
		 z0 = svmla_n_u64_z (p0, z0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_d4_u64_z_tied2, svuint64_t, uint64_t,
		 z1 = svmla_n_u64_z (p0, z0, z1, d4),
		 z1 = svmla_z (p0, z0, z1, d4))

/*
** mla_d4_u64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), d4
**	movprfx	z1\.d, p0/z, z0\.d
**	mla	z1\.d, p0/m, z2\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (mla_d4_u64_z_untied, svuint64_t, uint64_t,
		 z1 = svmla_n_u64_z (p0, z0, z2, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_d4_u64_x_tied1, svuint64_t, uint64_t,
		 z0 = svmla_n_u64_x (p0, z0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_d4_u64_x_tied2, svuint64_t, uint64_t,
		 z1 = svmla_n_u64_x (p0, z0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mla_d4_u64_x_untied, svuint64_t, uint64_t,
		 z2 = svmla_n_u64_x (p0, z0, z1, d4),
