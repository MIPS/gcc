...
**	ret
*/
TEST_UNIFORM_Z (mls_2_s8_z_tied1, svint8_t,
		z0 = svmls_n_s8_z (p0, z0, z1, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mls_2_s8_z_tied2, svint8_t,
		z0 = svmls_n_s8_z (p0, z1, z0, 2),
...
**	ret
*/
TEST_UNIFORM_Z (mls_2_s8_z_untied, svint8_t,
		z0 = svmls_n_s8_z (p0, z1, z2, 2),
