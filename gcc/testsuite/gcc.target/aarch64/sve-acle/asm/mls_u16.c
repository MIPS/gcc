...
TEST_UNIFORM_ZS (mls_h4_u16_z_tied2, svuint16_t, uint16_t,
		 z1 = svmls_n_u16_z (p0, z0, z1, d4),
		 z1 = svmls_z (p0, z0, z1, d4))

/*
** mls_h4_u16_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.h), h4
