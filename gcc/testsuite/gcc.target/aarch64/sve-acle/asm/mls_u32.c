...
TEST_UNIFORM_ZS (mls_s4_u32_z_tied2, svuint32_t, uint32_t,
		 z1 = svmls_n_u32_z (p0, z0, z1, d4),
		 z1 = svmls_z (p0, z0, z1, d4))

/*
** mls_s4_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s4
