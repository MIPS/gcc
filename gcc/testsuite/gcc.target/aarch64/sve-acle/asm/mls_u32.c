...
**	ret
*/
TEST_UNIFORM_ZS (mls_s0_u32_m_tied1, svuint32_t, uint32_t,
		 z0 = svmls_n_u32_m (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_s0_u32_m_tied2, svuint32_t, uint32_t,
		 z1 = svmls_n_u32_m (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_s0_u32_m_untied, svuint32_t, uint32_t,
		 z1 = svmls_n_u32_m (p0, z0, z2, d0),
...
TEST_UNIFORM_ZS (mls_w0_u32_z_tied2, svuint32_t, uint32_t,
		 z1 = svmls_n_u32_z (p0, z0, z1, x0),
		 z1 = svmls_z (p0, z0, z1, x0))

/*
** mls_w0_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), w0
**	movprfx	z0\.s, p0/z, z1\.s
**	mls	z0\.s, p0/m, z2\.s, \1
**	ret
...
**	ret
*/
TEST_UNIFORM_ZS (mls_s0_u32_z_tied1, svuint32_t, uint32_t,
		 z0 = svmls_n_u32_z (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_s0_u32_z_tied2, svuint32_t, uint32_t,
		 z1 = svmls_n_u32_z (p0, z0, z1, d0),
		 z1 = svmls_z (p0, z0, z1, d0))

/*
** mls_s0_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s0
**	movprfx	z1\.s, p0/z, z0\.s
**	mls	z1\.s, p0/m, z2\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (mls_s0_u32_z_untied, svuint32_t, uint32_t,
		 z1 = svmls_n_u32_z (p0, z0, z2, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_s0_u32_x_tied1, svuint32_t, uint32_t,
		 z0 = svmls_n_u32_x (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_s0_u32_x_tied2, svuint32_t, uint32_t,
		 z1 = svmls_n_u32_x (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_s0_u32_x_untied, svuint32_t, uint32_t,
		 z2 = svmls_n_u32_x (p0, z0, z1, d0),
