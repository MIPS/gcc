...
**	ret
*/
TEST_UNIFORM_ZS (mls_d0_u64_m_tied1, svuint64_t, uint64_t,
		 z0 = svmls_n_u64_m (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_d0_u64_m_tied2, svuint64_t, uint64_t,
		 z1 = svmls_n_u64_m (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_d0_u64_m_untied, svuint64_t, uint64_t,
		 z1 = svmls_n_u64_m (p0, z0, z2, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_d0_u64_z_tied1, svuint64_t, uint64_t,
		 z0 = svmls_n_u64_z (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_d0_u64_z_tied2, svuint64_t, uint64_t,
		 z1 = svmls_n_u64_z (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_d0_u64_z_untied, svuint64_t, uint64_t,
		 z1 = svmls_n_u64_z (p0, z0, z2, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_d0_u64_x_tied1, svuint64_t, uint64_t,
		 z0 = svmls_n_u64_x (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_d0_u64_x_tied2, svuint64_t, uint64_t,
		 z1 = svmls_n_u64_x (p0, z0, z1, d0),
...
**	ret
*/
TEST_UNIFORM_ZS (mls_d0_u64_x_untied, svuint64_t, uint64_t,
		 z2 = svmls_n_u64_x (p0, z0, z1, d0),
