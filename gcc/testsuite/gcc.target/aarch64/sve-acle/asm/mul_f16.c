...
TEST_UNIFORM_ZS (ptrue_mul_h4_f16_x_tied1, svfloat16_t, __fp16,
		 z1 = svmul_n_f16_x (svptrue_b16 (), z1, d4),
		 z1 = svmul_x (svptrue_b16 (), z1, d4))
...
TEST_UNIFORM_ZS (ptrue_mul_h4_f16_x_untied, svfloat16_t, __fp16,
		 z2 = svmul_n_f16_x (svptrue_b16 (), z1, d4),
		 z2 = svmul_x (svptrue_b16 (), z1, d4))
