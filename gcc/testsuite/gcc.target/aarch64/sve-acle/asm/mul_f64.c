...
TEST_UNIFORM_ZS (ptrue_mul_x0_f64_x_untied, svfloat64_t, double,
		 z0 = svmul_n_f64_x (svptrue_b64 (), z1, x0),
		 z0 = svmul_x (svptrue_b64 (), z1, x0))
...
TEST_UNIFORM_ZS (ptrue_mul_d4_f64_x_tied1, svfloat64_t, double,
		 z0 = svmul_n_f64_x (svptrue_b64 (), z0, d4),
		 z0 = svmul_x (svptrue_b64 (), z0, d4))
...
TEST_UNIFORM_ZS (ptrue_mul_d4_f64_x_untied, svfloat64_t, double,
		 z0 = svmul_n_f64_x (svptrue_b64 (), z1, d4),
		 z0 = svmul_x (svptrue_b64 (), z1, d4))
