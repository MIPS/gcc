...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_f64_m_tied1, svfloat64_t, double,
		 z1 = svmul_n_f64_m (p0, z1, d4),
		 z1 = svmul_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_f64_m_untied, svfloat64_t, double,
		 z1 = svmul_n_f64_m (p0, z2, d4),
		 z1 = svmul_m (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_f64_z_tied1, svfloat64_t, double,
		 z1 = svmul_n_f64_z (p0, z1, d4),
		 z1 = svmul_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_f64_z_untied, svfloat64_t, double,
		 z1 = svmul_n_f64_z (p0, z2, d4),
		 z1 = svmul_z (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_f64_x_tied1, svfloat64_t, double,
		 z1 = svmul_n_f64_x (p0, z1, d4),
		 z1 = svmul_x (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_f64_x_untied, svfloat64_t, double,
		 z2 = svmul_n_f64_x (p0, z1, d4),
		 z2 = svmul_x (p0, z1, d4))
...
TEST_UNIFORM_ZS (ptrue_mul_d4_f64_x_tied1, svfloat64_t, double,
		 z1 = svmul_n_f64_x (svptrue_b64 (), z1, d4),
		 z1 = svmul_x (svptrue_b64 (), z1, d4))
...
TEST_UNIFORM_ZS (ptrue_mul_d4_f64_x_untied, svfloat64_t, double,
		 z2 = svmul_n_f64_x (svptrue_b64 (), z1, d4),
		 z2 = svmul_x (svptrue_b64 (), z1, d4))
