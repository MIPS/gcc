...
**	ret
*/
TEST_UNIFORM_ZS (mul_w0_s32_m_tied1, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (mul_w0_s32_m_untied, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (mul_s0_s32_m_tied1, svint32_t, int32_t,
		 z1 = svmul_n_s32_m (p0, z1, d0),
		 z1 = svmul_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_s0_s32_m_untied, svint32_t, int32_t,
		 z1 = svmul_n_s32_m (p0, z2, d0),
		 z1 = svmul_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_w0_s32_z_tied1, svint32_t, int32_t,
		 z0 = svmul_n_s32_z (p0, z0, x0),
		 z0 = svmul_z (p0, z0, x0))

/*
** mul_w0_s32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), w0
**	movprfx	z0\.s, p0/z, z1\.s
**	mul	z0\.s, p0/m, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (mul_w0_s32_z_untied, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (mul_s0_s32_z_tied1, svint32_t, int32_t,
		 z1 = svmul_n_s32_z (p0, z1, d0),
		 z1 = svmul_z (p0, z1, d0))

/*
** mul_s0_s32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s0
**	movprfx	z1\.s, p0/z, z2\.s
**	mul	z1\.s, p0/m, z1\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (mul_s0_s32_z_untied, svint32_t, int32_t,
		 z1 = svmul_n_s32_z (p0, z2, d0),
		 z1 = svmul_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_w0_s32_x_tied1, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (mul_w0_s32_x_untied, svint32_t, int32_t,
		 z1 = svmul_n_s32_x (p0, z0, x0),
		 z1 = svmul_x (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_s0_s32_x_tied1, svint32_t, int32_t,
		 z1 = svmul_n_s32_x (p0, z1, d0),
		 z1 = svmul_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_s0_s32_x_untied, svint32_t, int32_t,
		 z2 = svmul_n_s32_x (p0, z1, d0),
		 z2 = svmul_x (p0, z1, d0))
