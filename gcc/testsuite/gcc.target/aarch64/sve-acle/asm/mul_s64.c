...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_s64_m_tied1, svint64_t, int64_t,
		 z0 = svmul_n_s64_m (p0, z0, d4),
		 z0 = svmul_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_s64_m_untied, svint64_t, int64_t,
		 z0 = svmul_n_s64_m (p0, z1, d4),
		 z0 = svmul_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_s64_z_tied1, svint64_t, int64_t,
		 z0 = svmul_n_s64_z (p0, z0, d4),
		 z0 = svmul_z (p0, z0, d4))

/*
** mul_d4_s64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), d4
**	movprfx	z0\.d, p0/z, z1\.d
**	mul	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_s64_z_untied, svint64_t, int64_t,
		 z0 = svmul_n_s64_z (p0, z1, d4),
		 z0 = svmul_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_s64_x_tied1, svint64_t, int64_t,
		 z0 = svmul_n_s64_x (p0, z0, d4),
		 z0 = svmul_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_s64_x_untied, svint64_t, int64_t,
		 z0 = svmul_n_s64_x (p0, z1, d4),
		 z0 = svmul_x (p0, z1, d4))
