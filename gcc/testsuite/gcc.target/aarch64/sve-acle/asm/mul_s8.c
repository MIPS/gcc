...
**	ret
*/
TEST_UNIFORM_ZS (mul_b0_s8_m_tied1, svint8_t, int8_t,
		 z1 = svmul_n_s8_m (p0, z1, d0),
		 z1 = svmul_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_b0_s8_m_untied, svint8_t, int8_t,
		 z1 = svmul_n_s8_m (p0, z2, d0),
		 z1 = svmul_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_b0_s8_z_tied1, svint8_t, int8_t,
		 z1 = svmul_n_s8_z (p0, z1, d0),
		 z1 = svmul_z (p0, z1, d0))

/*
** mul_b0_s8_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.b), b0
**	movprfx	z1\.b, p0/z, z2\.b
**	mul	z1\.b, p0/m, z1\.b, \1
**	ret
*/
TEST_UNIFORM_ZS (mul_b0_s8_z_untied, svint8_t, int8_t,
		 z1 = svmul_n_s8_z (p0, z2, d0),
		 z1 = svmul_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_b0_s8_x_tied1, svint8_t, int8_t,
		 z1 = svmul_n_s8_x (p0, z1, d0),
		 z1 = svmul_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_b0_s8_x_untied, svint8_t, int8_t,
		 z2 = svmul_n_s8_x (p0, z1, d0),
		 z2 = svmul_x (p0, z1, d0))
