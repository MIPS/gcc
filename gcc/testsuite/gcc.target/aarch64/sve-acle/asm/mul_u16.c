...
**	ret
*/
TEST_UNIFORM_ZS (mul_w0_u16_m_tied1, svuint16_t, uint16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (mul_w0_u16_m_untied, svuint16_t, uint16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (mul_h0_u16_m_tied1, svuint16_t, uint16_t,
		 z1 = svmul_n_u16_m (p0, z1, d0),
		 z1 = svmul_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_h0_u16_m_untied, svuint16_t, uint16_t,
		 z1 = svmul_n_u16_m (p0, z2, d0),
		 z1 = svmul_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_w0_u16_z_tied1, svuint16_t, uint16_t,
		 z0 = svmul_n_u16_z (p0, z0, x0),
		 z0 = svmul_z (p0, z0, x0))

/*
** mul_w0_u16_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.h), w0
**	movprfx	z0\.h, p0/z, z1\.h
**	mul	z0\.h, p0/m, z0\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (mul_w0_u16_z_untied, svuint16_t, uint16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (mul_h0_u16_z_tied1, svuint16_t, uint16_t,
		 z1 = svmul_n_u16_z (p0, z1, d0),
		 z1 = svmul_z (p0, z1, d0))

/*
** mul_h0_u16_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.h), h0
**	movprfx	z1\.h, p0/z, z2\.h
**	mul	z1\.h, p0/m, z1\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (mul_h0_u16_z_untied, svuint16_t, uint16_t,
		 z1 = svmul_n_u16_z (p0, z2, d0),
		 z1 = svmul_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_w0_u16_x_tied1, svuint16_t, uint16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (mul_w0_u16_x_untied, svuint16_t, uint16_t,
		 z1 = svmul_n_u16_x (p0, z0, x0),
		 z1 = svmul_x (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_h0_u16_x_tied1, svuint16_t, uint16_t,
		 z1 = svmul_n_u16_x (p0, z1, d0),
		 z1 = svmul_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_h0_u16_x_untied, svuint16_t, uint16_t,
		 z2 = svmul_n_u16_x (p0, z1, d0),
		 z2 = svmul_x (p0, z1, d0))
