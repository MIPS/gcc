...
**	ret
*/
TEST_UNIFORM_ZS (mul_h4_u16_m_tied1, svuint16_t, uint16_t,
		 z1 = svmul_n_u16_m (p0, z1, d4),
		 z1 = svmul_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_h4_u16_m_untied, svuint16_t, uint16_t,
		 z1 = svmul_n_u16_m (p0, z2, d4),
		 z1 = svmul_m (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_h4_u16_z_tied1, svuint16_t, uint16_t,
		 z1 = svmul_n_u16_z (p0, z1, d4),
		 z1 = svmul_z (p0, z1, d4))

/*
** mul_h4_u16_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.h), h4
**	movprfx	z1\.h, p0/z, z2\.h
**	mul	z1\.h, p0/m, z1\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (mul_h4_u16_z_untied, svuint16_t, uint16_t,
		 z1 = svmul_n_u16_z (p0, z2, d4),
		 z1 = svmul_z (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_h4_u16_x_tied1, svuint16_t, uint16_t,
		 z1 = svmul_n_u16_x (p0, z1, d4),
		 z1 = svmul_x (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_h4_u16_x_untied, svuint16_t, uint16_t,
		 z2 = svmul_n_u16_x (p0, z1, d4),
		 z2 = svmul_x (p0, z1, d4))
