...
**	ret
*/
TEST_UNIFORM_ZS (mul_s4_u32_m_tied1, svuint32_t, uint32_t,
		 z0 = svmul_n_u32_m (p0, z0, d4),
		 z0 = svmul_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_s4_u32_m_untied, svuint32_t, uint32_t,
		 z0 = svmul_n_u32_m (p0, z1, d4),
		 z0 = svmul_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_s4_u32_z_tied1, svuint32_t, uint32_t,
		 z0 = svmul_n_u32_z (p0, z0, d4),
		 z0 = svmul_z (p0, z0, d4))

/*
** mul_s4_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s4
**	movprfx	z0\.s, p0/z, z1\.s
**	mul	z0\.s, p0/m, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (mul_s4_u32_z_untied, svuint32_t, uint32_t,
		 z0 = svmul_n_u32_z (p0, z1, d4),
		 z0 = svmul_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_s4_u32_x_tied1, svuint32_t, uint32_t,
		 z0 = svmul_n_u32_x (p0, z0, d4),
		 z0 = svmul_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_s4_u32_x_untied, svuint32_t, uint32_t,
		 z0 = svmul_n_u32_x (p0, z1, d4),
		 z0 = svmul_x (p0, z1, d4))
