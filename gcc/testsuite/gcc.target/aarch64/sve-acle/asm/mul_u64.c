...
**	ret
*/
TEST_UNIFORM_ZS (mul_x0_u64_m_tied1, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (mul_x0_u64_m_untied, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_u64_m_tied1, svuint64_t, uint64_t,
		 z1 = svmul_n_u64_m (p0, z1, d4),
		 z1 = svmul_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_u64_m_untied, svuint64_t, uint64_t,
		 z1 = svmul_n_u64_m (p0, z2, d4),
		 z1 = svmul_m (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_x0_u64_z_tied1, svuint64_t, uint64_t,
		 z0 = svmul_n_u64_z (p0, z0, x0),
		 z0 = svmul_z (p0, z0, x0))

/*
** mul_x0_u64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), x0
**	movprfx	z0\.d, p0/z, z1\.d
**	mul	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (mul_x0_u64_z_untied, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_u64_z_tied1, svuint64_t, uint64_t,
		 z1 = svmul_n_u64_z (p0, z1, d4),
		 z1 = svmul_z (p0, z1, d4))

/*
** mul_d4_u64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), d4
**	movprfx	z1\.d, p0/z, z2\.d
**	mul	z1\.d, p0/m, z1\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_u64_z_untied, svuint64_t, uint64_t,
		 z1 = svmul_n_u64_z (p0, z2, d4),
		 z1 = svmul_z (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_x0_u64_x_tied1, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (mul_x0_u64_x_untied, svuint64_t, uint64_t,
		 z1 = svmul_n_u64_x (p0, z0, x0),
		 z1 = svmul_x (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_u64_x_tied1, svuint64_t, uint64_t,
		 z1 = svmul_n_u64_x (p0, z1, d4),
		 z1 = svmul_x (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (mul_d4_u64_x_untied, svuint64_t, uint64_t,
		 z2 = svmul_n_u64_x (p0, z1, d4),
		 z2 = svmul_x (p0, z1, d4))
