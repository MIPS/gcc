...
**	ret
*/
TEST_UNIFORM_ZS (mulh_h4_s16_m_tied1, svint16_t, int16_t,
		 z0 = svmulh_n_s16_m (p0, z0, d4),
		 z0 = svmulh_m (p0, z0, d4))

/*
** mulh_h4_s16_m_untied:
**	mov	(z[0-9]+\.h), h4
**	movprfx	z0, z1
**	smulh	z0\.h, p0/m, z0\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (mulh_h4_s16_m_untied, svint16_t, int16_t,
		 z0 = svmulh_n_s16_m (p0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mulh_h4_s16_z_tied1, svint16_t, int16_t,
		 z0 = svmulh_n_s16_z (p0, z0, d4),
		 z0 = svmulh_z (p0, z0, d4))

/*
** mulh_h4_s16_z_untied:
**	mov	(z[0-9]+\.h), h4
** (
**	movprfx	z0\.h, p0/z, z1\.h
**	smulh	z0\.h, p0/m, z0\.h, \1
...
**	ret
*/
TEST_UNIFORM_ZS (mulh_h4_s16_z_untied, svint16_t, int16_t,
		 z0 = svmulh_n_s16_z (p0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_Z (mulh_2_s16_z_tied1, svint16_t,
		z0 = svmulh_n_s16_z (p0, z0, 2),
		z0 = svmulh_z (p0, z0, 2))
...
**	ret
*/
TEST_UNIFORM_Z (mulh_2_s16_z_untied, svint16_t,
		z0 = svmulh_n_s16_z (p0, z1, 2),
		z0 = svmulh_z (p0, z1, 2))
...
**	ret
*/
TEST_UNIFORM_ZS (mulh_h4_s16_x_tied1, svint16_t, int16_t,
		 z0 = svmulh_n_s16_x (p0, z0, d4),
		 z0 = svmulh_x (p0, z0, d4))

/*
** mulh_h4_s16_x_untied:
**	mov	z0\.h, h4
**	smulh	z0\.h, p0/m, z0\.h, z1\.h
**	ret
*/
TEST_UNIFORM_ZS (mulh_h4_s16_x_untied, svint16_t, int16_t,
		 z0 = svmulh_n_s16_x (p0, z1, d4),
