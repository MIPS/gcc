...
**	ret
*/
TEST_UNIFORM_ZS (mulh_s4_u32_m_tied1, svuint32_t, uint32_t,
		 z0 = svmulh_n_u32_m (p0, z0, d4),
		 z0 = svmulh_m (p0, z0, d4))

/*
** mulh_s4_u32_m_untied:
**	mov	(z[0-9]+\.s), s4
**	movprfx	z0, z1
**	umulh	z0\.s, p0/m, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (mulh_s4_u32_m_untied, svuint32_t, uint32_t,
		 z0 = svmulh_n_u32_m (p0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (mulh_s4_u32_z_tied1, svuint32_t, uint32_t,
		 z0 = svmulh_n_u32_z (p0, z0, d4),
		 z0 = svmulh_z (p0, z0, d4))

/*
** mulh_s4_u32_z_untied:
**	mov	(z[0-9]+\.s), s4
** (
**	movprfx	z0\.s, p0/z, z1\.s
**	umulh	z0\.s, p0/m, z0\.s, \1
...
**	ret
*/
TEST_UNIFORM_ZS (mulh_s4_u32_z_untied, svuint32_t, uint32_t,
		 z0 = svmulh_n_u32_z (p0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_Z (mulh_2_u32_z_tied1, svuint32_t,
		z0 = svmulh_n_u32_z (p0, z0, 2),
		z0 = svmulh_z (p0, z0, 2))
...
**	ret
*/
TEST_UNIFORM_Z (mulh_2_u32_z_untied, svuint32_t,
		z0 = svmulh_n_u32_z (p0, z1, 2),
		z0 = svmulh_z (p0, z1, 2))
...
**	ret
*/
TEST_UNIFORM_ZS (mulh_s4_u32_x_tied1, svuint32_t, uint32_t,
		 z0 = svmulh_n_u32_x (p0, z0, d4),
		 z0 = svmulh_x (p0, z0, d4))

/*
** mulh_s4_u32_x_untied:
**	mov	z0\.s, s4
**	umulh	z0\.s, p0/m, z0\.s, z1\.s
**	ret
*/
TEST_UNIFORM_ZS (mulh_s4_u32_x_untied, svuint32_t, uint32_t,
		 z0 = svmulh_n_u32_x (p0, z1, d4),
