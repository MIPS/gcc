...
**	ret
*/
TEST_UNIFORM_ZS (mulx_w0_f16_m_tied1, svfloat16_t, __fp16,
		 z0 = svmulx_n_f16_m (p0, z0, x0),
		 z0 = svmulx_m (p0, z0, x0))

/*
** mulx_w0_f16_m_untied:
**	mov	(z[0-9]+\.h), w0
**	movprfx	z0, z1
**	fmulx	z0\.h, p0/m, z0\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (mulx_w0_f16_m_untied, svfloat16_t, __fp16,
		 z0 = svmulx_n_f16_m (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_h4_f16_m_tied1, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_h4_f16_m_untied, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_w0_f16_z_tied1, svfloat16_t, __fp16,
		 z0 = svmulx_n_f16_z (p0, z0, x0),
		 z0 = svmulx_z (p0, z0, x0))

/*
** mulx_w0_f16_z_untied:
**	mov	(z[0-9]+\.h), w0
** (
**	movprfx	z0\.h, p0/z, z1\.h
**	fmulx	z0\.h, p0/m, z0\.h, \1
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_w0_f16_z_untied, svfloat16_t, __fp16,
		 z0 = svmulx_n_f16_z (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_h4_f16_z_tied1, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_h4_f16_z_untied, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_w0_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svmulx_n_f16_x (p0, z0, x0),
		 z0 = svmulx_x (p0, z0, x0))

/*
** mulx_w0_f16_x_untied:
**	mov	z0\.h, w0
**	fmulx	z0\.h, p0/m, z0\.h, z1\.h
**	ret
*/
TEST_UNIFORM_ZS (mulx_w0_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svmulx_n_f16_x (p0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_h4_f16_x_tied1, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_h4_f16_x_untied, svfloat16_t, __fp16,
...
/*
** ptrue_mulx_w0_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), w0
**	fmulx	z0\.h, \1/m, z0\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mulx_w0_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svmulx_n_f16_x (svptrue_b16 (), z0, x0),
		 z0 = svmulx_x (svptrue_b16 (), z0, x0))

/*
** ptrue_mulx_w0_f16_x_untied:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	z0\.h, w0
**	fmulx	z0\.h, \1/m, z0\.h, z1\.h
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mulx_w0_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svmulx_n_f16_x (svptrue_b16 (), z1, x0),
		 z0 = svmulx_x (svptrue_b16 (), z1, x0))

/*
** ptrue_mulx_h4_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), h4
**	fmulx	z0\.h, \1/m, z0\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mulx_h4_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svmulx_n_f16_x (svptrue_b16 (), z0, d4),
		 z0 = svmulx_x (svptrue_b16 (), z0, d4))

/*
** ptrue_mulx_h4_f16_x_untied:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	z0\.h, h4
**	fmulx	z0\.h, \1/m, z0\.h, z1\.h
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mulx_h4_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svmulx_n_f16_x (svptrue_b16 (), z1, d4),
		 z0 = svmulx_x (svptrue_b16 (), z1, d4))
