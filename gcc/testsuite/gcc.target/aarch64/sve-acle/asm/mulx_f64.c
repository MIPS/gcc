...
**	ret
*/
TEST_UNIFORM_ZS (mulx_x0_f64_m_tied1, svfloat64_t, double,
		 z0 = svmulx_n_f64_m (p0, z0, x0),
		 z0 = svmulx_m (p0, z0, x0))

/*
** mulx_x0_f64_m_untied:
**	mov	(z[0-9]+\.d), x0
**	movprfx	z0, z1
**	fmulx	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (mulx_x0_f64_m_untied, svfloat64_t, double,
		 z0 = svmulx_n_f64_m (p0, z1, x0),
		 z0 = svmulx_m (p0, z1, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_d4_f64_m_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_d4_f64_m_untied, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_x0_f64_z_tied1, svfloat64_t, double,
		 z0 = svmulx_n_f64_z (p0, z0, x0),
		 z0 = svmulx_z (p0, z0, x0))

/*
** mulx_x0_f64_z_untied:
**	mov	(z[0-9]+\.d), x0
** (
**	movprfx	z0\.d, p0/z, z1\.d
**	fmulx	z0\.d, p0/m, z0\.d, \1
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_x0_f64_z_untied, svfloat64_t, double,
		 z0 = svmulx_n_f64_z (p0, z1, x0),
		 z0 = svmulx_z (p0, z1, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_d4_f64_z_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_d4_f64_z_untied, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_x0_f64_x_tied1, svfloat64_t, double,
		 z0 = svmulx_n_f64_x (p0, z0, x0),
		 z0 = svmulx_x (p0, z0, x0))

/*
** mulx_x0_f64_x_untied:
**	mov	z0\.d, x0
**	fmulx	z0\.d, p0/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (mulx_x0_f64_x_untied, svfloat64_t, double,
		 z0 = svmulx_n_f64_x (p0, z1, x0),
		 z0 = svmulx_x (p0, z1, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_d4_f64_x_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (mulx_d4_f64_x_untied, svfloat64_t, double,
...
/*
** ptrue_mulx_x0_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), x0
**	fmulx	z0\.d, \1/m, z0\.d, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mulx_x0_f64_x_tied1, svfloat64_t, double,
		 z0 = svmulx_n_f64_x (svptrue_b64 (), z0, x0),
		 z0 = svmulx_x (svptrue_b64 (), z0, x0))

/*
** ptrue_mulx_x0_f64_x_untied:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	z0\.d, x0
**	fmulx	z0\.d, \1/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mulx_x0_f64_x_untied, svfloat64_t, double,
		 z0 = svmulx_n_f64_x (svptrue_b64 (), z1, x0),
		 z0 = svmulx_x (svptrue_b64 (), z1, x0))

/*
** ptrue_mulx_d4_f64_x_tied1:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	(z[0-9]+\.d), d4
**	fmulx	z0\.d, \1/m, z0\.d, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mulx_d4_f64_x_tied1, svfloat64_t, double,
		 z0 = svmulx_n_f64_x (svptrue_b64 (), z0, d4),
		 z0 = svmulx_x (svptrue_b64 (), z0, d4))

/*
** ptrue_mulx_d4_f64_x_untied:
**	ptrue	(p[0-7])\.d[^\n]*
**	mov	z0\.d, d4
**	fmulx	z0\.d, \1/m, z0\.d, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_mulx_d4_f64_x_untied, svfloat64_t, double,
		 z0 = svmulx_n_f64_x (svptrue_b64 (), z1, d4),
		 z0 = svmulx_x (svptrue_b64 (), z1, d4))
