...
**	ret
*/
TEST_UNIFORM_ZS (nmad_w0_f16_m_tied1, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_m (p0, z0, z1, x0),
...
**	mov	(z[0-9]+)\.d, z0\.d
**	movprfx	z0, z1
**	fnmad	z0\.h, p0/m, \2\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (nmad_w0_f16_m_tied2, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_m (p0, z1, z0, x0),
		 z0 = svnmad_m (p0, z1, z0, x0))

/*
** nmad_w0_f16_m_untied:
**	mov	(z[0-9]+\.h), w0
**	movprfx	z0, z1
**	fnmad	z0\.h, p0/m, z2\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (nmad_w0_f16_m_untied, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_m (p0, z1, z2, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_h4_f16_m_tied1, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_h4_f16_m_tied2, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_m (p0, z1, z0, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_h4_f16_m_untied, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_Z (nmad_2_f16_m_tied2, svfloat16_t,
		z0 = svnmad_n_f16_m (p0, z1, z0, 2),
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_w0_f16_z_tied1, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_z (p0, z0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_w0_f16_z_tied2, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_z (p0, z1, z0, x0),
		 z0 = svnmad_z (p0, z1, z0, x0))

/*
** nmad_w0_f16_z_untied:
**	mov	(z[0-9]+\.h), w0
** (
**	movprfx	z0\.h, p0/z, z1\.h
**	fnmad	z0\.h, p0/m, z2\.h, \1
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_w0_f16_z_untied, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_z (p0, z1, z2, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_h4_f16_z_tied1, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_h4_f16_z_tied2, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_h4_f16_z_untied, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_w0_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_x (p0, z0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_w0_f16_x_tied2, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_x (p0, z1, z0, x0),
		 z0 = svnmad_x (p0, z1, z0, x0))

/*
** nmad_w0_f16_x_untied:
**	mov	z0\.h, w0
**	fnmla	z0\.h, p0/m, z1\.h, z2\.h
**	ret
*/
TEST_UNIFORM_ZS (nmad_w0_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_x (p0, z1, z2, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_h4_f16_x_tied1, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_h4_f16_x_tied2, svfloat16_t, __fp16,
...
**	ret
*/
TEST_UNIFORM_ZS (nmad_h4_f16_x_untied, svfloat16_t, __fp16,
...
** (
**	movprfx	z0, z1
**	fnmad	z0\.h, \1/m, z2\.h, z3\.h
** |
**	movprfx	z0, z2
**	fnmad	z0\.h, \1/m, z1\.h, z3\.h
** |
**	movprfx	z0, z3
**	fnmla	z0\.h, \1/m, z1\.h, z2\.h
** )
...
/*
** ptrue_nmad_w0_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), w0
**	fnmad	z0\.h, \1/m, z1\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_nmad_w0_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_x (svptrue_b16 (), z0, z1, x0),
		 z0 = svnmad_x (svptrue_b16 (), z0, z1, x0))

/*
** ptrue_nmad_w0_f16_x_tied2:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), w0
**	fnmad	z0\.h, \1/m, z1\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_nmad_w0_f16_x_tied2, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_x (svptrue_b16 (), z1, z0, x0),
		 z0 = svnmad_x (svptrue_b16 (), z1, z0, x0))

/*
** ptrue_nmad_w0_f16_x_untied:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	z0\.h, w0
**	fnmla	z0\.h, \1/m, z1\.h, z2\.h
**	ret
*/
TEST_UNIFORM_ZS (ptrue_nmad_w0_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_x (svptrue_b16 (), z1, z2, x0),
		 z0 = svnmad_x (svptrue_b16 (), z1, z2, x0))

/*
** ptrue_nmad_h4_f16_x_tied1:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), h4
**	fnmad	z0\.h, \1/m, z1\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_nmad_h4_f16_x_tied1, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_x (svptrue_b16 (), z0, z1, d4),
		 z0 = svnmad_x (svptrue_b16 (), z0, z1, d4))

/*
** ptrue_nmad_h4_f16_x_tied2:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	(z[0-9]+\.h), h4
**	fnmad	z0\.h, \1/m, z1\.h, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_nmad_h4_f16_x_tied2, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_x (svptrue_b16 (), z1, z0, d4),
		 z0 = svnmad_x (svptrue_b16 (), z1, z0, d4))

/*
** ptrue_nmad_h4_f16_x_untied:
**	ptrue	(p[0-7])\.h[^\n]*
**	mov	z0\.h, h4
**	fnmla	z0\.h, \1/m, z1\.h, z2\.h
**	ret
*/
TEST_UNIFORM_ZS (ptrue_nmad_h4_f16_x_untied, svfloat16_t, __fp16,
		 z0 = svnmad_n_f16_x (svptrue_b16 (), z1, z2, d4),
		 z0 = svnmad_x (svptrue_b16 (), z1, z2, d4))
