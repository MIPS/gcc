...
**	ret
*/
TEST_UNIFORM_ZS (nmla_w0_f32_m_tied1, svfloat32_t, float,
		 z0 = svnmla_n_f32_m (p0, z0, z1, x0),
...
**	mov	(z[0-9]+)\.d, z0\.d
**	movprfx	z0, z1
**	fnmla	z0\.s, p0/m, \2\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (nmla_w0_f32_m_tied2, svfloat32_t, float,
		 z0 = svnmla_n_f32_m (p0, z1, z0, x0),
		 z0 = svnmla_m (p0, z1, z0, x0))

/*
** nmla_w0_f32_m_untied:
**	mov	(z[0-9]+\.s), w0
**	movprfx	z0, z1
**	fnmla	z0\.s, p0/m, z2\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (nmla_w0_f32_m_untied, svfloat32_t, float,
		 z0 = svnmla_n_f32_m (p0, z1, z2, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_s4_f32_m_tied1, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_s4_f32_m_tied2, svfloat32_t, float,
		 z0 = svnmla_n_f32_m (p0, z1, z0, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_s4_f32_m_untied, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_Z (nmla_2_f32_m_tied2, svfloat32_t,
		z0 = svnmla_n_f32_m (p0, z1, z0, 2),
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_w0_f32_z_tied1, svfloat32_t, float,
		 z0 = svnmla_n_f32_z (p0, z0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_w0_f32_z_tied2, svfloat32_t, float,
		 z0 = svnmla_n_f32_z (p0, z1, z0, x0),
		 z0 = svnmla_z (p0, z1, z0, x0))

/*
** nmla_w0_f32_z_untied:
**	mov	(z[0-9]+\.s), w0
** (
**	movprfx	z0\.s, p0/z, z1\.s
**	fnmla	z0\.s, p0/m, z2\.s, \1
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_w0_f32_z_untied, svfloat32_t, float,
		 z0 = svnmla_n_f32_z (p0, z1, z2, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_s4_f32_z_tied1, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_s4_f32_z_tied2, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_s4_f32_z_untied, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_w0_f32_x_tied1, svfloat32_t, float,
		 z0 = svnmla_n_f32_x (p0, z0, z1, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_w0_f32_x_tied2, svfloat32_t, float,
		 z0 = svnmla_n_f32_x (p0, z1, z0, x0),
		 z0 = svnmla_x (p0, z1, z0, x0))

/*
** nmla_w0_f32_x_untied:
**	mov	z0\.s, w0
**	fnmad	z0\.s, p0/m, z2\.s, z1\.s
**	ret
*/
TEST_UNIFORM_ZS (nmla_w0_f32_x_untied, svfloat32_t, float,
		 z0 = svnmla_n_f32_x (p0, z1, z2, x0),
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_s4_f32_x_tied1, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_s4_f32_x_tied2, svfloat32_t, float,
...
**	ret
*/
TEST_UNIFORM_ZS (nmla_s4_f32_x_untied, svfloat32_t, float,
...
** (
**	movprfx	z0, z1
**	fnmla	z0\.s, \1/m, z2\.s, z3\.s
** |
**	movprfx	z0, z2
**	fnmad	z0\.s, \1/m, z3\.s, z1\.s
** |
**	movprfx	z0, z3
**	fnmad	z0\.s, \1/m, z2\.s, z1\.s
** )
...
/*
** ptrue_nmla_w0_f32_x_tied1:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	(z[0-9]+\.s), w0
**	fnmla	z0\.s, \1/m, z1\.s, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_nmla_w0_f32_x_tied1, svfloat32_t, float,
		 z0 = svnmla_n_f32_x (svptrue_b32 (), z0, z1, x0),
		 z0 = svnmla_x (svptrue_b32 (), z0, z1, x0))

/*
** ptrue_nmla_w0_f32_x_tied2:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	(z[0-9]+\.s), w0
**	fnmad	z0\.s, \1/m, \2, z1\.s
**	ret
*/
TEST_UNIFORM_ZS (ptrue_nmla_w0_f32_x_tied2, svfloat32_t, float,
		 z0 = svnmla_n_f32_x (svptrue_b32 (), z1, z0, x0),
		 z0 = svnmla_x (svptrue_b32 (), z1, z0, x0))

/*
** ptrue_nmla_w0_f32_x_untied:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	z0\.s, w0
**	fnmad	z0\.s, \1/m, z2\.s, z1\.s
**	ret
*/
TEST_UNIFORM_ZS (ptrue_nmla_w0_f32_x_untied, svfloat32_t, float,
		 z0 = svnmla_n_f32_x (svptrue_b32 (), z1, z2, x0),
		 z0 = svnmla_x (svptrue_b32 (), z1, z2, x0))

/*
** ptrue_nmla_s4_f32_x_tied1:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	(z[0-9]+\.s), s4
**	fnmla	z0\.s, \1/m, z1\.s, \2
**	ret
*/
TEST_UNIFORM_ZS (ptrue_nmla_s4_f32_x_tied1, svfloat32_t, float,
		 z0 = svnmla_n_f32_x (svptrue_b32 (), z0, z1, d4),
		 z0 = svnmla_x (svptrue_b32 (), z0, z1, d4))

/*
** ptrue_nmla_s4_f32_x_tied2:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	(z[0-9]+\.s), s4
**	fnmad	z0\.s, \1/m, \2, z1\.s
**	ret
*/
TEST_UNIFORM_ZS (ptrue_nmla_s4_f32_x_tied2, svfloat32_t, float,
		 z0 = svnmla_n_f32_x (svptrue_b32 (), z1, z0, d4),
		 z0 = svnmla_x (svptrue_b32 (), z1, z0, d4))

/*
** ptrue_nmla_s4_f32_x_untied:
**	ptrue	(p[0-7])\.s[^\n]*
**	mov	z0\.s, s4
**	fnmad	z0\.s, \1/m, z2\.s, z1\.s
**	ret
*/
TEST_UNIFORM_ZS (ptrue_nmla_s4_f32_x_untied, svfloat32_t, float,
		 z0 = svnmla_n_f32_x (svptrue_b32 (), z1, z2, d4),
		 z0 = svnmla_x (svptrue_b32 (), z1, z2, d4))
