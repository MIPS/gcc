...
**	ret
*/
TEST_UNIFORM_ZS (orr_h0_s16_m_tied1, svint16_t, int16_t,
		 z1 = svorr_n_s16_m (p0, z1, d0),
		 z1 = svorr_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_h0_s16_m_untied, svint16_t, int16_t,
		 z1 = svorr_n_s16_m (p0, z2, d0),
		 z1 = svorr_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_h0_s16_z_tied1, svint16_t, int16_t,
		 z1 = svorr_n_s16_z (p0, z1, d0),
		 z1 = svorr_z (p0, z1, d0))

/*
** orr_h0_s16_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.h), h0
**	movprfx	z1\.h, p0/z, z2\.h
**	orr	z1\.h, p0/m, z1\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (orr_h0_s16_z_untied, svint16_t, int16_t,
		 z1 = svorr_n_s16_z (p0, z2, d0),
		 z1 = svorr_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_h0_s16_x_tied1, svint16_t, int16_t,
		 z1 = svorr_n_s16_x (p0, z1, d0),
		 z1 = svorr_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_h0_s16_x_untied, svint16_t, int16_t,
		 z2 = svorr_n_s16_x (p0, z1, d0),
		 z2 = svorr_x (p0, z1, d0))
