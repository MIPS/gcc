...
TEST_UNIFORM_ZS (orr_h4_s16_z_tied1, svint16_t, int16_t,
		 z1 = svorr_n_s16_z (p0, z1, d4),
		 z1 = svorr_z (p0, z1, d4))

/*
** orr_h4_s16_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.h), h4
