...
**	ret
*/
TEST_UNIFORM_ZS (orr_x0_s64_m_tied1, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_x0_s64_m_untied, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_d0_s64_m_tied1, svint64_t, int64_t,
		 z1 = svorr_n_s64_m (p0, z1, d0),
		 z1 = svorr_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_d0_s64_m_untied, svint64_t, int64_t,
		 z1 = svorr_n_s64_m (p0, z2, d0),
		 z1 = svorr_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_x0_s64_z_tied1, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_x0_s64_z_untied, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_d0_s64_z_tied1, svint64_t, int64_t,
		 z1 = svorr_n_s64_z (p0, z1, d0),
		 z1 = svorr_z (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_d0_s64_z_untied, svint64_t, int64_t,
		 z1 = svorr_n_s64_z (p0, z2, d0),
		 z1 = svorr_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_x0_s64_x_tied1, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_d0_s64_x_tied1, svint64_t, int64_t,
		 z1 = svorr_n_s64_x (p0, z1, d0),
		 z1 = svorr_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_d0_s64_x_untied, svint64_t, int64_t,
		 z2 = svorr_n_s64_x (p0, z1, d0),
		 z2 = svorr_x (p0, z1, d0))
