...
**	ret
*/
TEST_UNIFORM_ZS (orr_w0_s8_m_tied1, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_w0_s8_m_untied, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_b4_s8_m_tied1, svint8_t, int8_t,
		 z1 = svorr_n_s8_m (p0, z1, d4),
		 z1 = svorr_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_b4_s8_m_untied, svint8_t, int8_t,
		 z1 = svorr_n_s8_m (p0, z2, d4),
		 z1 = svorr_m (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_w0_s8_z_tied1, svint8_t, int8_t,
		 z0 = svorr_n_s8_z (p0, z0, x0),
		 z0 = svorr_z (p0, z0, x0))

/*
** orr_w0_s8_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.b), w0
**	movprfx	z0\.b, p0/z, z1\.b
**	orr	z0\.b, p0/m, z0\.b, \1
**	ret
*/
TEST_UNIFORM_ZS (orr_w0_s8_z_untied, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_b4_s8_z_tied1, svint8_t, int8_t,
		 z1 = svorr_n_s8_z (p0, z1, d4),
		 z1 = svorr_z (p0, z1, d4))

/*
** orr_b4_s8_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.b), b4
**	movprfx	z1\.b, p0/z, z2\.b
**	orr	z1\.b, p0/m, z1\.b, \1
**	ret
*/
TEST_UNIFORM_ZS (orr_b4_s8_z_untied, svint8_t, int8_t,
		 z1 = svorr_n_s8_z (p0, z2, d4),
		 z1 = svorr_z (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_w0_s8_x_tied1, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_w0_s8_x_untied, svint8_t, int8_t,
		 z1 = svorr_n_s8_x (p0, z0, x0),
		 z1 = svorr_x (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_b4_s8_x_tied1, svint8_t, int8_t,
		 z1 = svorr_n_s8_x (p0, z1, d4),
		 z1 = svorr_x (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_b4_s8_x_untied, svint8_t, int8_t,
		 z2 = svorr_n_s8_x (p0, z1, d4),
		 z2 = svorr_x (p0, z1, d4))
