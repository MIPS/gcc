...
**	ret
*/
TEST_UNIFORM_ZS (orr_s4_u32_m_tied1, svuint32_t, uint32_t,
		 z1 = svorr_n_u32_m (p0, z1, d4),
		 z1 = svorr_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_s4_u32_m_untied, svuint32_t, uint32_t,
		 z1 = svorr_n_u32_m (p0, z2, d4),
		 z1 = svorr_m (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_s4_u32_z_tied1, svuint32_t, uint32_t,
		 z1 = svorr_n_u32_z (p0, z1, d4),
		 z1 = svorr_z (p0, z1, d4))

/*
** orr_s4_u32_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.s), s4
**	movprfx	z1\.s, p0/z, z2\.s
**	orr	z1\.s, p0/m, z1\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (orr_s4_u32_z_untied, svuint32_t, uint32_t,
		 z1 = svorr_n_u32_z (p0, z2, d4),
		 z1 = svorr_z (p0, z2, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_s4_u32_x_tied1, svuint32_t, uint32_t,
		 z1 = svorr_n_u32_x (p0, z1, d4),
		 z1 = svorr_x (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_s4_u32_x_untied, svuint32_t, uint32_t,
		 z2 = svorr_n_u32_x (p0, z1, d4),
		 z2 = svorr_x (p0, z1, d4))
