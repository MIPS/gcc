...
**	ret
*/
TEST_UNIFORM_ZS (orr_x0_u64_m_tied1, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_x0_u64_m_untied, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_d0_u64_m_tied1, svuint64_t, uint64_t,
		 z1 = svorr_n_u64_m (p0, z1, d0),
		 z1 = svorr_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_d0_u64_m_untied, svuint64_t, uint64_t,
		 z1 = svorr_n_u64_m (p0, z2, d0),
		 z1 = svorr_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_x0_u64_z_tied1, svuint64_t, uint64_t,
		 z0 = svorr_n_u64_z (p0, z0, x0),
		 z0 = svorr_z (p0, z0, x0))

/*
** orr_x0_u64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), x0
**	movprfx	z0\.d, p0/z, z1\.d
**	orr	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (orr_x0_u64_z_untied, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_d0_u64_z_tied1, svuint64_t, uint64_t,
		 z1 = svorr_n_u64_z (p0, z1, d0),
		 z1 = svorr_z (p0, z1, d0))

/*
** orr_d0_u64_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.d), d0
**	movprfx	z1\.d, p0/z, z2\.d
**	orr	z1\.d, p0/m, z1\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (orr_d0_u64_z_untied, svuint64_t, uint64_t,
		 z1 = svorr_n_u64_z (p0, z2, d0),
		 z1 = svorr_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_x0_u64_x_tied1, svuint64_t, uint64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (orr_x0_u64_x_untied, svuint64_t, uint64_t,
		 z1 = svorr_n_u64_x (p0, z0, x0),
		 z1 = svorr_x (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_d0_u64_x_tied1, svuint64_t, uint64_t,
		 z1 = svorr_n_u64_x (p0, z1, d0),
		 z1 = svorr_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (orr_d0_u64_x_untied, svuint64_t, uint64_t,
		 z2 = svorr_n_u64_x (p0, z1, d0),
		 z2 = svorr_x (p0, z1, d0))
