...
/*
** prfd_gather_d4_s32index:
**	fmov	(x[0-9]+), d4
**	prfd	pldl2keep, p0, \[\1, z0\.s, sxtw 3\]
**	ret
*/
TEST_PREFETCH_GATHER_SZ (prfd_gather_d4_s32index, svint32_t,
			 svprfd_gather_s32index (p0, d4, z0, SV_PLDL2KEEP),
			 svprfd_gather_index (p0, d4, z0, SV_PLDL2KEEP))
...
/*
** prfd_gather_d4_u32index:
**	fmov	(x[0-9]+), d4
**	prfd	pldl3keep, p0, \[\1, z0\.s, uxtw 3\]
**	ret
*/
TEST_PREFETCH_GATHER_SZ (prfd_gather_d4_u32index, svuint32_t,
			 svprfd_gather_u32index (p0, d4, z0, SV_PLDL3KEEP),
			 svprfd_gather_index (p0, d4, z0, SV_PLDL3KEEP))
...
/*
** prfd_gather_d4_s64index:
**	fmov	(x[0-9]+), d4
**	prfd	pstl1keep, p0, \[\1, z0\.d, lsl 3\]
**	ret
*/
TEST_PREFETCH_GATHER_SZ (prfd_gather_d4_s64index, svint64_t,
			 svprfd_gather_s64index (p0, d4, z0, SV_PSTL1KEEP),
			 svprfd_gather_index (p0, d4, z0, SV_PSTL1KEEP))
...
/*
** prfd_gather_d4_u64index:
**	fmov	(x[0-9]+), d4
**	prfd	pstl2keep, p0, \[\1, z0\.d, lsl 3\]
**	ret
*/
TEST_PREFETCH_GATHER_SZ (prfd_gather_d4_u64index, svuint64_t,
			 svprfd_gather_u64index (p0, d4, z0, SV_PSTL2KEEP),
			 svprfd_gather_index (p0, d4, z0, SV_PSTL2KEEP))
