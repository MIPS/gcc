...
/*
** prfh_gather_d4_s32index:
**	fmov	(x[0-9]+), d4
**	prfh	pldl2keep, p0, \[\1, z0\.s, sxtw 1\]
**	ret
*/
TEST_PREFETCH_GATHER_SZ (prfh_gather_d4_s32index, svint32_t,
			 svprfh_gather_s32index (p0, d4, z0, SV_PLDL2KEEP),
			 svprfh_gather_index (p0, d4, z0, SV_PLDL2KEEP))
...
/*
** prfh_gather_d4_u32index:
**	fmov	(x[0-9]+), d4
**	prfh	pldl3keep, p0, \[\1, z0\.s, uxtw 1\]
**	ret
*/
TEST_PREFETCH_GATHER_SZ (prfh_gather_d4_u32index, svuint32_t,
			 svprfh_gather_u32index (p0, d4, z0, SV_PLDL3KEEP),
			 svprfh_gather_index (p0, d4, z0, SV_PLDL3KEEP))
...
/*
** prfh_gather_d4_s64index:
**	fmov	(x[0-9]+), d4
**	prfh	pstl1keep, p0, \[\1, z0\.d, lsl 1\]
**	ret
*/
TEST_PREFETCH_GATHER_SZ (prfh_gather_d4_s64index, svint64_t,
			 svprfh_gather_s64index (p0, d4, z0, SV_PSTL1KEEP),
			 svprfh_gather_index (p0, d4, z0, SV_PSTL1KEEP))
...
/*
** prfh_gather_d4_u64index:
**	fmov	(x[0-9]+), d4
**	prfh	pstl2keep, p0, \[\1, z0\.d, lsl 1\]
**	ret
*/
TEST_PREFETCH_GATHER_SZ (prfh_gather_d4_u64index, svuint64_t,
			 svprfh_gather_u64index (p0, d4, z0, SV_PSTL2KEEP),
			 svprfh_gather_index (p0, d4, z0, SV_PSTL2KEEP))
