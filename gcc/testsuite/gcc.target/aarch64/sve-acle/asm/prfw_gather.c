...
/*
** prfw_gather_d4_s32index:
**	fmov	(x[0-9]+), d4
**	prfw	pldl2keep, p0, \[\1, z0\.s, sxtw 2\]
**	ret
*/
TEST_PREFETCH_GATHER_SZ (prfw_gather_d4_s32index, svint32_t,
			 svprfw_gather_s32index (p0, d4, z0, SV_PLDL2KEEP),
			 svprfw_gather_index (p0, d4, z0, SV_PLDL2KEEP))
...
/*
** prfw_gather_d4_u32index:
**	fmov	(x[0-9]+), d4
**	prfw	pldl3keep, p0, \[\1, z0\.s, uxtw 2\]
**	ret
*/
TEST_PREFETCH_GATHER_SZ (prfw_gather_d4_u32index, svuint32_t,
			 svprfw_gather_u32index (p0, d4, z0, SV_PLDL3KEEP),
			 svprfw_gather_index (p0, d4, z0, SV_PLDL3KEEP))
...
/*
** prfw_gather_d4_s64index:
**	fmov	(x[0-9]+), d4
**	prfw	pstl1keep, p0, \[\1, z0\.d, lsl 2\]
**	ret
*/
TEST_PREFETCH_GATHER_SZ (prfw_gather_d4_s64index, svint64_t,
			 svprfw_gather_s64index (p0, d4, z0, SV_PSTL1KEEP),
			 svprfw_gather_index (p0, d4, z0, SV_PSTL1KEEP))
...
/*
** prfw_gather_d4_u64index:
**	fmov	(x[0-9]+), d4
**	prfw	pstl2keep, p0, \[\1, z0\.d, lsl 2\]
**	ret
*/
TEST_PREFETCH_GATHER_SZ (prfw_gather_d4_u64index, svuint64_t,
			 svprfw_gather_u64index (p0, d4, z0, SV_PSTL2KEEP),
			 svprfw_gather_index (p0, d4, z0, SV_PSTL2KEEP))
