...
**	ret
*/
TEST_UNIFORM_ZS (qadd_w0_s8_tied1, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (qadd_w0_s8_untied, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (qadd_b0_s8_tied1, svint8_t, int8_t,
		 z1 = svqadd_n_s8 (z1, d0),
		 z1 = svqadd (z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (qadd_b0_s8_untied, svint8_t, int8_t,
		 z1 = svqadd_n_s8 (z2, d0),
		 z1 = svqadd (z2, d0))
