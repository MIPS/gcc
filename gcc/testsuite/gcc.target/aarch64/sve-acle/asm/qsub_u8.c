...
**	ret
*/
TEST_UNIFORM_ZS (qsub_w0_u8_tied1, svuint8_t, uint8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (qsub_w0_u8_untied, svuint8_t, uint8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (qsub_b0_u8_tied1, svuint8_t, uint8_t,
		 z1 = svqsub_n_u8 (z1, d0),
		 z1 = svqsub (z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (qsub_b0_u8_untied, svuint8_t, uint8_t,
		 z1 = svqsub_n_u8 (z2, d0),
		 z1 = svqsub (z2, d0))
