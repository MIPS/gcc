...
/*
** scale_f16_m_tied1:
**	fscale	z0\.h, p0/m, z0\.h, z16\.h
**	ret
*/
TEST_DUAL_Z (scale_f16_m_tied1, svfloat16_t, svint16_t,
	     z0 = svscale_f16_m (p0, z0, z16),
	     z0 = svscale_m (p0, z0, z16))

/*
** scale_f16_m_tied2:
**	mov	(z[0-9]+)\.d, z16\.d
**	movprfx	z16, z0
**	fscale	z16\.h, p0/m, z16\.h, \1\.h
**	ret
*/
TEST_DUAL_Z (scale_f16_m_tied2, svfloat16_t, svint16_t,
	     z16_res = svscale_f16_m (p0, z0, z16),
	     z16_res = svscale_m (p0, z0, z16))
...
TEST_DUAL_Z (scale_f16_m_untied, svfloat16_t, svint16_t,
	     z0 = svscale_f16_m (p0, z1, z16),
	     z0 = svscale_m (p0, z1, z16))
...
TEST_DUAL_Z (scale_f16_z_tied1, svfloat16_t, svint16_t,
	     z0 = svscale_f16_z (p0, z0, z16),
	     z0 = svscale_z (p0, z0, z16))
...
TEST_DUAL_Z (scale_f16_z_tied2, svfloat16_t, svint16_t,
	     z16_res = svscale_f16_z (p0, z0, z16),
	     z16_res = svscale_z (p0, z0, z16))
...
TEST_DUAL_Z (scale_f16_z_untied, svfloat16_t, svint16_t,
	     z0 = svscale_f16_z (p0, z1, z16),
	     z0 = svscale_z (p0, z1, z16))
...
TEST_DUAL_Z (scale_f16_x_tied1, svfloat16_t, svint16_t,
	     z0 = svscale_f16_x (p0, z0, z16),
	     z0 = svscale_x (p0, z0, z16))
...
TEST_DUAL_Z (scale_f16_x_tied2, svfloat16_t, svint16_t,
	     z16_res = svscale_f16_x (p0, z0, z16),
	     z16_res = svscale_x (p0, z0, z16))
...
TEST_DUAL_Z (scale_f16_x_untied, svfloat16_t, svint16_t,
	     z0 = svscale_f16_x (p0, z1, z16),
	     z0 = svscale_x (p0, z1, z16))
...
**	ptrue	(p[0-7])\.h[^\n]*
**	fscale	z0\.h, \1/m, z0\.h, z16\.h
**	ret
*/
TEST_DUAL_Z (ptrue_scale_f16_x_tied1, svfloat16_t, svint16_t,
	     z0 = svscale_f16_x (svptrue_b16 (), z0, z16),
	     z0 = svscale_x (svptrue_b16 (), z0, z16))
...
**	mov	(z[0-9]+)\.d, z16\.d
**	movprfx	z16, z0
**	fscale	z16\.h, \1/m, z16\.h, \2\.h
**	ret
*/
TEST_DUAL_Z (ptrue_scale_f16_x_tied2, svfloat16_t, svint16_t,
	     z16_res = svscale_f16_x (svptrue_b16 (), z0, z16),
	     z16_res = svscale_x (svptrue_b16 (), z0, z16))
...
TEST_DUAL_Z (ptrue_scale_f16_x_untied, svfloat16_t, svint16_t,
	     z0 = svscale_f16_x (svptrue_b16 (), z1, z16),
	     z0 = svscale_x (svptrue_b16 (), z1, z16))
