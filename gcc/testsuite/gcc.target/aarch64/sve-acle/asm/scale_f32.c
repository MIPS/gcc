...
/*
** scale_f32_m_tied1:
**	fscale	z0\.s, p0/m, z0\.s, z16\.s
**	ret
*/
TEST_DUAL_Z (scale_f32_m_tied1, svfloat32_t, svint32_t,
	     z0 = svscale_f32_m (p0, z0, z16),
...
**	mov	(z[0-9]+)\.d, z16\.d
**	movprfx	z16, z0
**	fscale	z16\.s, p0/m, z16\.s, \1\.s
**	ret
*/
TEST_DUAL_Z (scale_f32_m_tied2, svfloat32_t, svint32_t,
	     z16_res = svscale_f32_m (p0, z0, z16),
...
TEST_DUAL_Z (scale_f32_z_tied2, svfloat32_t, svint32_t,
	     z16_res = svscale_f32_z (p0, z0, z16),
...
TEST_DUAL_Z (scale_f32_x_tied2, svfloat32_t, svint32_t,
	     z16_res = svscale_f32_x (p0, z0, z16),
...
**	ptrue	(p[0-7])\.s[^\n]*
**	fscale	z0\.s, \1/m, z0\.s, z16\.s
**	ret
*/
TEST_DUAL_Z (ptrue_scale_f32_x_tied1, svfloat32_t, svint32_t,
	     z0 = svscale_f32_x (svptrue_b32 (), z0, z16),
	     z0 = svscale_x (svptrue_b32 (), z0, z16))
...
**	mov	(z[0-9]+)\.d, z16\.d
**	movprfx	z16, z0
**	fscale	z16\.s, \1/m, z16\.s, \2\.s
**	ret
*/
TEST_DUAL_Z (ptrue_scale_f32_x_tied2, svfloat32_t, svint32_t,
	     z16_res = svscale_f32_x (svptrue_b32 (), z0, z16),
	     z16_res = svscale_x (svptrue_b32 (), z0, z16))
...
TEST_DUAL_Z (ptrue_scale_f32_x_untied, svfloat32_t, svint32_t,
	     z0 = svscale_f32_x (svptrue_b32 (), z1, z16),
	     z0 = svscale_x (svptrue_b32 (), z1, z16))
