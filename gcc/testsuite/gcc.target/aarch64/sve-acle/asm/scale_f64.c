...
/*
** scale_f64_m_tied1:
**	fscale	z0\.d, p0/m, z0\.d, z16\.d
**	ret
*/
TEST_DUAL_Z (scale_f64_m_tied1, svfloat64_t, svint64_t,
	     z0 = svscale_f64_m (p0, z0, z16),
...
**	mov	(z[0-9]+\.d), z16\.d
**	movprfx	z16, z0
**	fscale	z16\.d, p0/m, z16\.d, \1
**	ret
*/
TEST_DUAL_Z (scale_f64_m_tied2, svfloat64_t, svint64_t,
	     z16_res = svscale_f64_m (p0, z0, z16),
...
TEST_DUAL_Z (scale_f64_z_tied1, svfloat64_t, svint64_t,
	     z0 = svscale_f64_z (p0, z0, z16),
	     z0 = svscale_z (p0, z0, z16))

/*
** scale_f64_z_tied2:
**	mov	(z[0-9]+\.d), z16\.d
**	movprfx	z16\.d, p0/z, z0\.d
**	fscale	z16\.d, p0/m, z16\.d, \1
**	ret
*/
TEST_DUAL_Z (scale_f64_z_tied2, svfloat64_t, svint64_t,
	     z16_res = svscale_f64_z (p0, z0, z16),
...
TEST_DUAL_Z (scale_f64_x_tied2, svfloat64_t, svint64_t,
	     z16_res = svscale_f64_x (p0, z0, z16),
...
**	ptrue	(p[0-7])\.d[^\n]*
**	fscale	z0\.d, \1/m, z0\.d, z16\.d
**	ret
*/
TEST_DUAL_Z (ptrue_scale_f64_x_tied1, svfloat64_t, svint64_t,
	     z0 = svscale_f64_x (svptrue_b64 (), z0, z16),
	     z0 = svscale_x (svptrue_b64 (), z0, z16))
...
**	mov	(z[0-9]+\.d), z16\.d
**	movprfx	z16, z0
**	fscale	z16\.d, \1/m, z16\.d, \2
**	ret
*/
TEST_DUAL_Z (ptrue_scale_f64_x_tied2, svfloat64_t, svint64_t,
	     z16_res = svscale_f64_x (svptrue_b64 (), z0, z16),
	     z16_res = svscale_x (svptrue_b64 (), z0, z16))
...
TEST_DUAL_Z (ptrue_scale_f64_x_untied, svfloat64_t, svint64_t,
	     z0 = svscale_f64_x (svptrue_b64 (), z1, z16),
	     z0 = svscale_x (svptrue_b64 (), z1, z16))
