...
/*
** st1_scatter_d4_f32_offset:
**	fmov	(x[0-9]+), d4
**	st1w	z0\.s, p0, \[\1, z1\.s, uxtw\]
**	ret
*/
TEST_STORE_SCATTER_ZS (st1_scatter_d4_f32_offset, svfloat32_t, svuint32_t,
		       svst1_scatter_u32base_offset_f32 (p0, z1, d4, z0),
...
/*
** st1_scatter_d4_f32_s32offset:
**	fmov	(x[0-9]+), d4
**	st1w	z0\.s, p0, \[\1, z1\.s, sxtw\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1_scatter_d4_f32_s32offset, svfloat32_t, float32_t, svint32_t,
		       svst1_scatter_s32offset_f32 (p0, d4, z1, z0),
...
/*
** st1_scatter_d4_f32_u32offset:
**	fmov	(x[0-9]+), d4
**	st1w	z0\.s, p0, \[\1, z1\.s, uxtw\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1_scatter_d4_f32_u32offset, svfloat32_t, float32_t, svuint32_t,
		       svst1_scatter_u32offset_f32 (p0, d4, z1, z0),
		       svst1_scatter_offset (p0, d4, z1, z0))
...
/*
** st1_scatter_d4_f32_s32index:
**	fmov	(x[0-9]+), d4
**	st1w	z0\.s, p0, \[\1, z1\.s, sxtw 2\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1_scatter_d4_f32_s32index, svfloat32_t, float32_t, svint32_t,
		       svst1_scatter_s32index_f32 (p0, d4, z1, z0),
...
/*
** st1_scatter_d4_f32_u32index:
**	fmov	(x[0-9]+), d4
**	st1w	z0\.s, p0, \[\1, z1\.s, uxtw 2\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1_scatter_d4_f32_u32index, svfloat32_t, float32_t, svuint32_t,
		       svst1_scatter_u32index_f32 (p0, d4, z1, z0),
		       svst1_scatter_index (p0, d4, z1, z0))
