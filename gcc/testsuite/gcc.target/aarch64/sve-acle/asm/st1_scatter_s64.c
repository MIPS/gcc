...
/*
** st1_scatter_d4_s64_offset:
**	fmov	(x[0-9]+), d4
**	st1d	z0\.d, p0, \[\1, z1\.d\]
**	ret
*/
TEST_STORE_SCATTER_ZS (st1_scatter_d4_s64_offset, svint64_t, svuint64_t,
		       svst1_scatter_u64base_offset_s64 (p0, z1, d4, z0),
...
/*
** st1_scatter_d4_s64_s64offset:
**	fmov	(x[0-9]+), d4
**	st1d	z0\.d, p0, \[\1, z1\.d\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1_scatter_d4_s64_s64offset, svint64_t, int64_t, svint64_t,
		       svst1_scatter_s64offset_s64 (p0, d4, z1, z0),
...
/*
** st1_scatter_d4_s64_u64offset:
**	fmov	(x[0-9]+), d4
**	st1d	z0\.d, p0, \[\1, z1\.d\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1_scatter_d4_s64_u64offset, svint64_t, int64_t, svuint64_t,
		       svst1_scatter_u64offset_s64 (p0, d4, z1, z0),
		       svst1_scatter_offset (p0, d4, z1, z0))
...
/*
** st1_scatter_d4_s64_s64index:
**	fmov	(x[0-9]+), d4
**	st1d	z0\.d, p0, \[\1, z1\.d, lsl 3\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1_scatter_d4_s64_s64index, svint64_t, int64_t, svint64_t,
		       svst1_scatter_s64index_s64 (p0, d4, z1, z0),
...
/*
** st1_scatter_d4_s64_u64index:
**	fmov	(x[0-9]+), d4
**	st1d	z0\.d, p0, \[\1, z1\.d, lsl 3\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1_scatter_d4_s64_u64index, svint64_t, int64_t, svuint64_t,
		       svst1_scatter_u64index_s64 (p0, d4, z1, z0),
		       svst1_scatter_index (p0, d4, z1, z0))
