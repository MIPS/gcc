...
/*
** st1b_scatter_d4_u32_offset:
**	fmov	(x[0-9]+), d4
**	st1b	z0\.s, p0, \[\1, z1\.s, uxtw\]
**	ret
*/
TEST_STORE_SCATTER_ZS (st1b_scatter_d4_u32_offset, svuint32_t, svuint32_t,
		       svst1b_scatter_u32base_offset_u32 (p0, z1, d4, z0),
...
/*
** st1b_scatter_d4_u32_s32offset:
**	fmov	(x[0-9]+), d4
**	st1b	z0\.s, p0, \[\1, z1\.s, sxtw\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1b_scatter_d4_u32_s32offset, svuint32_t, uint8_t, svint32_t,
		       svst1b_scatter_s32offset_u32 (p0, d4, z1, z0),
...
/*
** st1b_scatter_d4_u32_u32offset:
**	fmov	(x[0-9]+), d4
**	st1b	z0\.s, p0, \[\1, z1\.s, uxtw\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1b_scatter_d4_u32_u32offset, svuint32_t, uint8_t, svuint32_t,
		       svst1b_scatter_u32offset_u32 (p0, d4, z1, z0),
		       svst1b_scatter_offset (p0, d4, z1, z0))
