...
/*
** st1b_scatter_d4_u64_offset:
**	fmov	(x[0-9]+), d4
**	st1b	z0\.d, p0, \[\1, z1\.d\]
**	ret
*/
TEST_STORE_SCATTER_ZS (st1b_scatter_d4_u64_offset, svuint64_t, svuint64_t,
		       svst1b_scatter_u64base_offset_u64 (p0, z1, d4, z0),
...
/*
** st1b_scatter_d4_u64_s64offset:
**	fmov	(x[0-9]+), d4
**	st1b	z0\.d, p0, \[\1, z1\.d\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1b_scatter_d4_u64_s64offset, svuint64_t, uint8_t, svint64_t,
		       svst1b_scatter_s64offset_u64 (p0, d4, z1, z0),
...
/*
** st1b_scatter_d4_u64_u64offset:
**	fmov	(x[0-9]+), d4
**	st1b	z0\.d, p0, \[\1, z1\.d\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1b_scatter_d4_u64_u64offset, svuint64_t, uint8_t, svuint64_t,
		       svst1b_scatter_u64offset_u64 (p0, d4, z1, z0),
		       svst1b_scatter_offset (p0, d4, z1, z0))
