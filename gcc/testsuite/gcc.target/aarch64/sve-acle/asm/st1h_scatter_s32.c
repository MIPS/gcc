...
/*
** st1h_scatter_d4_s32_offset:
**	fmov	(x[0-9]+), d4
**	st1h	z0\.s, p0, \[\1, z1\.s, uxtw\]
**	ret
*/
TEST_STORE_SCATTER_ZS (st1h_scatter_d4_s32_offset, svint32_t, svuint32_t,
		       svst1h_scatter_u32base_offset_s32 (p0, z1, d4, z0),
		       svst1h_scatter_offset (p0, z1, d4, z0))
...
/*
** st1h_scatter_d4_s32_s32offset:
**	fmov	(x[0-9]+), d4
**	st1h	z0\.s, p0, \[\1, z1\.s, sxtw\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1h_scatter_d4_s32_s32offset, svint32_t, int16_t, svint32_t,
		       svst1h_scatter_s32offset_s32 (p0, d4, z1, z0),
		       svst1h_scatter_offset (p0, d4, z1, z0))
...
/*
** st1h_scatter_d4_s32_u32offset:
**	fmov	(x[0-9]+), d4
**	st1h	z0\.s, p0, \[\1, z1\.s, uxtw\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1h_scatter_d4_s32_u32offset, svint32_t, int16_t, svuint32_t,
		       svst1h_scatter_u32offset_s32 (p0, d4, z1, z0),
		       svst1h_scatter_offset (p0, d4, z1, z0))
...
/*
** st1h_scatter_d4_s32_s32index:
**	fmov	(x[0-9]+), d4
**	st1h	z0\.s, p0, \[\1, z1\.s, sxtw 1\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1h_scatter_d4_s32_s32index, svint32_t, int16_t, svint32_t,
		       svst1h_scatter_s32index_s32 (p0, d4, z1, z0),
		       svst1h_scatter_index (p0, d4, z1, z0))
...
/*
** st1h_scatter_d4_s32_u32index:
**	fmov	(x[0-9]+), d4
**	st1h	z0\.s, p0, \[\1, z1\.s, uxtw 1\]
**	ret
*/
TEST_STORE_SCATTER_SZ (st1h_scatter_d4_s32_u32index, svint32_t, int16_t, svuint32_t,
		       svst1h_scatter_u32index_s32 (p0, d4, z1, z0),
		       svst1h_scatter_index (p0, d4, z1, z0))
