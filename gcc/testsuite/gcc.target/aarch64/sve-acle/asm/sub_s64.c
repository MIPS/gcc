...
**	ret
*/
TEST_UNIFORM_Z (sub_s64_m, svint64_t,
...
**	ret
*/
TEST_UNIFORM_Z (sub_s64_m_prfx, svint64_t,
		z0 = svsub_s64_m (p0, z1, z2),
		z0 = svsub_m (p0, z1, z2))

/* Bad RA choice: no preferred output sequence.  */
TEST_UNIFORM_Z (sub_s64_m_bad_ra, svint64_t,
		z1 = svsub_s64_m (p0, z0, z1),
		z1 = svsub_m (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_ZS (sub_x0_s64_m, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (sub_x0_s64_m_prfx, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (sub_d0_s64_m, svint64_t, int64_t,
		 z1 = svsub_n_s64_m (p0, z1, d0),
		 z1 = svsub_m (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (sub_d0_s64_m_prfx, svint64_t, int64_t,
		 z1 = svsub_n_s64_m (p0, z2, d0),
		 z1 = svsub_m (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_Z (sub_1_s64_m, svint64_t,
...
**	ret
*/
TEST_UNIFORM_Z (sub_1_s64_m_prfx, svint64_t,
...
**	ret
*/
TEST_UNIFORM_Z (sub_s64_z_tied, svint64_t,
...
**	ret
*/
TEST_UNIFORM_Z (sub_s64_z_rev, svint64_t,
		z1 = svsub_s64_z (p0, z0, z1),
		z1 = svsub_z (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_ZS (sub_x0_s64_z_tied, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (sub_x0_s64_z_untied, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (sub_d0_s64_z_tied, svint64_t, int64_t,
		 z1 = svsub_n_s64_z (p0, z1, d0),
		 z1 = svsub_z (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (sub_d0_s64_z_untied, svint64_t, int64_t,
		 z1 = svsub_n_s64_z (p0, z2, d0),
		 z1 = svsub_z (p0, z2, d0))
...
**	ret
*/
TEST_UNIFORM_Z (sub_s64_x_z0, svint64_t,
...
**	ret
*/
TEST_UNIFORM_Z (sub_s64_x_z1, svint64_t,
		z1 = svsub_s64_x (p0, z0, z1),
		z1 = svsub_x (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_Z (sub_s64_x_z2, svint64_t,
		z2 = svsub_s64_x (p0, z0, z1),
		z2 = svsub_x (p0, z0, z1))
...
**	ret
*/
TEST_UNIFORM_ZS (sub_x0_s64_x_z0, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (sub_x0_s64_x_z1, svint64_t, int64_t,
		 z1 = svsub_n_s64_x (p0, z0, x0),
		 z1 = svsub_x (p0, z0, x0))
...
**	ret
*/
TEST_UNIFORM_ZS (sub_d0_s64_x_z1, svint64_t, int64_t,
		 z1 = svsub_n_s64_x (p0, z1, d0),
		 z1 = svsub_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_ZS (sub_d0_s64_x_z2, svint64_t, int64_t,
		 z2 = svsub_n_s64_x (p0, z1, d0),
		 z2 = svsub_x (p0, z1, d0))
...
**	ret
*/
TEST_UNIFORM_Z (sub_1_s64_x, svint64_t,
...
**	ret
*/
TEST_UNIFORM_Z (sub_1_s64_x_prfx, svint64_t,
