...
**	ret
*/
TEST_UNIFORM_ZS (sub_b4_u8_m_tied1, svuint8_t, uint8_t,
		 z0 = svsub_n_u8_m (p0, z0, d4),
		 z0 = svsub_m (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (sub_b4_u8_m_untied, svuint8_t, uint8_t,
		 z0 = svsub_n_u8_m (p0, z1, d4),
		 z0 = svsub_m (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (sub_b4_u8_z_tied1, svuint8_t, uint8_t,
		 z0 = svsub_n_u8_z (p0, z0, d4),
		 z0 = svsub_z (p0, z0, d4))

/*
** sub_b4_u8_z_untied: { xfail *-*-* }
**	mov	(z[0-9]+\.b), b4
**	movprfx	z0\.b, p0/z, z1\.b
**	sub	z0\.b, p0/m, z0\.b, \1
**	ret
*/
TEST_UNIFORM_ZS (sub_b4_u8_z_untied, svuint8_t, uint8_t,
		 z0 = svsub_n_u8_z (p0, z1, d4),
		 z0 = svsub_z (p0, z1, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (sub_b4_u8_x_tied1, svuint8_t, uint8_t,
		 z0 = svsub_n_u8_x (p0, z0, d4),
		 z0 = svsub_x (p0, z0, d4))
...
**	ret
*/
TEST_UNIFORM_ZS (sub_b4_u8_x_untied, svuint8_t, uint8_t,
		 z0 = svsub_n_u8_x (p0, z1, d4),
		 z0 = svsub_x (p0, z1, d4))
