...
**	ret
*/
TEST_UNIFORM_ZS (subr_d4_f64_m_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_d4_f64_m_untied, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_d4_f64_z_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_d4_f64_z_untied, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_d4_f64_x_tied1, svfloat64_t, double,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_d4_f64_x_untied, svfloat64_t, double,
...
TEST_UNIFORM_ZS (ptrue_subr_x0_f64_x_untied, svfloat64_t, double,
		 z0 = svsubr_n_f64_x (svptrue_b64 (), z1, x0),
		 z0 = svsubr_x (svptrue_b64 (), z1, x0))

/*
** ptrue_subr_d4_f64_x_tied1:
**	mov	(z[0-9]+\.d), d4
**	fsub	z0\.d, \1, z0\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_subr_d4_f64_x_tied1, svfloat64_t, double,
		 z0 = svsubr_n_f64_x (svptrue_b64 (), z0, d4),
		 z0 = svsubr_x (svptrue_b64 (), z0, d4))

/*
** ptrue_subr_d4_f64_x_untied:
**	mov	(z[0-9]+\.d), d4
**	fsub	z0\.d, \1, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (ptrue_subr_d4_f64_x_untied, svfloat64_t, double,
		 z0 = svsubr_n_f64_x (svptrue_b64 (), z1, d4),
		 z0 = svsubr_x (svptrue_b64 (), z1, d4))
...
TEST_UNIFORM_Z (ptrue_b32_subr_f64_x_tied2, svfloat64_t,
		z0 = svsubr_f64_x (svptrue_b32 (), z1, z0),
...
TEST_UNIFORM_Z (ptrue_b32_subr_f64_x_untied, svfloat64_t,
		z0 = svsubr_f64_x (svptrue_b32 (), z1, z2),
...
TEST_UNIFORM_Z (ptrue_b16_subr_f64_x_tied2, svfloat64_t,
		z0 = svsubr_f64_x (svptrue_b16 (), z1, z0),
...
TEST_UNIFORM_Z (ptrue_b16_subr_f64_x_untied, svfloat64_t,
		z0 = svsubr_f64_x (svptrue_b16 (), z1, z2),
...
TEST_UNIFORM_Z (ptrue_b8_subr_f64_x_tied2, svfloat64_t,
		z0 = svsubr_f64_x (svptrue_b8 (), z1, z0),
		z0 = svsubr_x (svptrue_b8 (), z1, z0))
...
TEST_UNIFORM_Z (ptrue_b8_subr_f64_x_untied, svfloat64_t,
		z0 = svsubr_f64_x (svptrue_b8 (), z1, z2),
		z0 = svsubr_x (svptrue_b8 (), z1, z2))
