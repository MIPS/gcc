...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s16_m_tied1, svint16_t, int16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s16_m_untied, svint16_t, int16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_h4_s16_m_tied1, svint16_t, int16_t,
		 z0 = svsubr_n_s16_m (p0, z0, d4),
		 z0 = svsubr_m (p0, z0, d4))

/*
** subr_h4_s16_m_untied:
**	mov	(z[0-9]+\.h), h4
**	movprfx	z0, z1
**	subr	z0\.h, p0/m, z0\.h, \1
**	ret
*/
TEST_UNIFORM_ZS (subr_h4_s16_m_untied, svint16_t, int16_t,
		 z0 = svsubr_n_s16_m (p0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s16_z_tied1, svint16_t, int16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_h4_s16_z_tied1, svint16_t, int16_t,
		 z0 = svsubr_n_s16_z (p0, z0, d4),
		 z0 = svsubr_z (p0, z0, d4))

/*
** subr_h4_s16_z_untied:
**	mov	(z[0-9]+\.h), h4
** (
**	movprfx	z0\.h, p0/z, z1\.h
**	subr	z0\.h, p0/m, z0\.h, \1
...
**	ret
*/
TEST_UNIFORM_ZS (subr_h4_s16_z_untied, svint16_t, int16_t,
		 z0 = svsubr_n_s16_z (p0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s16_x_tied1, svint16_t, int16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s16_x_untied, svint16_t, int16_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_h4_s16_x_tied1, svint16_t, int16_t,
		 z0 = svsubr_n_s16_x (p0, z0, d4),
		 z0 = svsubr_x (p0, z0, d4))

/*
** subr_h4_s16_x_untied:
**	mov	(z[0-9]+\.h), h4
**	sub	z0\.h, \1, z1\.h
**	ret
*/
TEST_UNIFORM_ZS (subr_h4_s16_x_untied, svint16_t, int16_t,
		 z0 = svsubr_n_s16_x (p0, z1, d4),
