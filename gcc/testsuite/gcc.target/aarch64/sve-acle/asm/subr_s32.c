...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s32_m_tied1, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s32_m_untied, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_s4_s32_m_tied1, svint32_t, int32_t,
		 z0 = svsubr_n_s32_m (p0, z0, d4),
		 z0 = svsubr_m (p0, z0, d4))

/*
** subr_s4_s32_m_untied:
**	mov	(z[0-9]+\.s), s4
**	movprfx	z0, z1
**	subr	z0\.s, p0/m, z0\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (subr_s4_s32_m_untied, svint32_t, int32_t,
		 z0 = svsubr_n_s32_m (p0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s32_z_tied1, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_s4_s32_z_tied1, svint32_t, int32_t,
		 z0 = svsubr_n_s32_z (p0, z0, d4),
		 z0 = svsubr_z (p0, z0, d4))

/*
** subr_s4_s32_z_untied:
**	mov	(z[0-9]+\.s), s4
** (
**	movprfx	z0\.s, p0/z, z1\.s
**	subr	z0\.s, p0/m, z0\.s, \1
...
**	ret
*/
TEST_UNIFORM_ZS (subr_s4_s32_z_untied, svint32_t, int32_t,
		 z0 = svsubr_n_s32_z (p0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s32_x_tied1, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s32_x_untied, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_s4_s32_x_tied1, svint32_t, int32_t,
		 z0 = svsubr_n_s32_x (p0, z0, d4),
		 z0 = svsubr_x (p0, z0, d4))

/*
** subr_s4_s32_x_untied:
**	mov	(z[0-9]+\.s), s4
**	sub	z0\.s, \1, z1\.s
**	ret
*/
TEST_UNIFORM_ZS (subr_s4_s32_x_untied, svint32_t, int32_t,
		 z0 = svsubr_n_s32_x (p0, z1, d4),
