...
**	ret
*/
TEST_UNIFORM_ZS (subr_s0_s32_m_tied1, svint32_t, int32_t,
		 z1 = svsubr_n_s32_m (p0, z1, d0),
		 z1 = svsubr_m (p0, z1, d0))

/*
** subr_s0_s32_m_untied:
**	mov	(z[0-9]+\.s), s0
**	movprfx	z1, z2
**	subr	z1\.s, p0/m, z1\.s, \1
**	ret
*/
TEST_UNIFORM_ZS (subr_s0_s32_m_untied, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_s0_s32_z_tied1, svint32_t, int32_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_s0_s32_x_tied1, svint32_t, int32_t,
		 z1 = svsubr_n_s32_x (p0, z1, d0),
		 z1 = svsubr_x (p0, z1, d0))

/*
** subr_s0_s32_x_untied:
**	mov	(z[0-9]+\.s), s0
**	sub	z2\.s, \1, z1\.s
**	ret
*/
TEST_UNIFORM_ZS (subr_s0_s32_x_untied, svint32_t, int32_t,
