...
**	ret
*/
TEST_UNIFORM_ZS (subr_x0_s64_m_tied1, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_x0_s64_m_untied, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_d4_s64_m_tied1, svint64_t, int64_t,
		 z0 = svsubr_n_s64_m (p0, z0, d4),
		 z0 = svsubr_m (p0, z0, d4))

/*
** subr_d4_s64_m_untied:
**	mov	(z[0-9]+\.d), d4
**	movprfx	z0, z1
**	subr	z0\.d, p0/m, z0\.d, \1
**	ret
*/
TEST_UNIFORM_ZS (subr_d4_s64_m_untied, svint64_t, int64_t,
		 z0 = svsubr_n_s64_m (p0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (subr_x0_s64_z_tied1, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_d4_s64_z_tied1, svint64_t, int64_t,
		 z0 = svsubr_n_s64_z (p0, z0, d4),
		 z0 = svsubr_z (p0, z0, d4))

/*
** subr_d4_s64_z_untied:
**	mov	(z[0-9]+\.d), d4
** (
**	movprfx	z0\.d, p0/z, z1\.d
**	subr	z0\.d, p0/m, z0\.d, \1
...
**	ret
*/
TEST_UNIFORM_ZS (subr_d4_s64_z_untied, svint64_t, int64_t,
		 z0 = svsubr_n_s64_z (p0, z1, d4),
...
**	ret
*/
TEST_UNIFORM_ZS (subr_x0_s64_x_tied1, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_x0_s64_x_untied, svint64_t, int64_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_d4_s64_x_tied1, svint64_t, int64_t,
		 z0 = svsubr_n_s64_x (p0, z0, d4),
		 z0 = svsubr_x (p0, z0, d4))

/*
** subr_d4_s64_x_untied:
**	mov	(z[0-9]+\.d), d4
**	sub	z0\.d, \1, z1\.d
**	ret
*/
TEST_UNIFORM_ZS (subr_d4_s64_x_untied, svint64_t, int64_t,
		 z0 = svsubr_n_s64_x (p0, z1, d4),
