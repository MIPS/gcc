...
**	ret
*/
TEST_UNIFORM_Z (subr_s8_m, svint8_t,
...
**	ret
*/
TEST_UNIFORM_Z (subr_s8_m_prfx, svint8_t,
		z0 = svsubr_s8_m (p0, z1, z2),
		z0 = svsubr_m (p0, z1, z2))

/* Bad RA choice: no preferred output sequence.  */
TEST_UNIFORM_Z (subr_s8_m_bad_ra, svint8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s8_m, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s8_m_prfx, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_b0_s8_m, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_b0_s8_m_prfx, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_Z (subr_1_s8_m, svint8_t,
...
**	ret
*/
TEST_UNIFORM_Z (subr_1_s8_m_prfx, svint8_t,
...
**	ret
*/
TEST_UNIFORM_Z (subr_s8_z_tied, svint8_t,
...
**	ret
*/
TEST_UNIFORM_Z (subr_s8_z_rev, svint8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s8_z_tied, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_b0_s8_z_tied, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_Z (subr_s8_x_z0, svint8_t,
...
**	ret
*/
TEST_UNIFORM_Z (subr_s8_x_z1, svint8_t,
...
**	ret
*/
TEST_UNIFORM_Z (subr_s8_x_z2, svint8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s8_x_z0, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_w0_s8_x_z1, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_b0_s8_x_z1, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_ZS (subr_b0_s8_x_z2, svint8_t, int8_t,
...
**	ret
*/
TEST_UNIFORM_Z (subr_1_s8_x, svint8_t,
...
**	ret
*/
TEST_UNIFORM_Z (subr_1_s8_x_prfx, svint8_t,
