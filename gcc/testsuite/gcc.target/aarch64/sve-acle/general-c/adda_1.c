    ...
    svint32_t i32)
{
  ...
  svadda (pg, pg, f32); /* { dg-error "incompatible type for argument 2 of 'svadda_f32'" } */
  svadda (pg, f32, f32); /* { dg-error "incompatible type for argument 2 of 'svadda_f32'" } */
  svadda (pg, f32, f); /* { dg-error "passing 'float' to argument 3 of 'svadda', which expects an SVE vector type" } */
  svadda (pg, i, i32); /* { dg-error "'svadda' has no form that takes 'svint32_t' arguments" } */
  svadda (pg, i32, i); /* { dg-error "passing 'int' to argument 3 of 'svadda', which expects an SVE vector type" } */
}
