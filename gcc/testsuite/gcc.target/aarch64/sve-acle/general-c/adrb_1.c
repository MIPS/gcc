    ...
    svint64_t s64, svuint64_t u64, svfloat64_t f64)
{
  ...
  svadrb_offset (u32, u8); /* { dg-error {cannot combine a base of type 'svuint32_t' with an offset of type 'svuint8_t'} } */
  svadrb_offset (u32, u16); /* { dg-error {cannot combine a base of type 'svuint32_t' with an offset of type 'svuint16_t'} } */
