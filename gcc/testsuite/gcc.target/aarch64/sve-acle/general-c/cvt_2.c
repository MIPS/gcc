      ...
      svfloat64_t f64)
{
  ...
  svcvt_f64_m (f32, pg, s32); /* { dg-error "incompatible type for argument 1 of 'svcvt_f64_s32_m'" } */
  svcvt_f64_m (0, pg, s32); /* { dg-error "passing 'int' to argument 1 of 'svcvt_f64_m', which expects an SVE vector type" } */
