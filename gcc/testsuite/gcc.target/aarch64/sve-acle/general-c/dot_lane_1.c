...
f1 (svbool_t pg, svint8_t s8, svuint8_t u8, svint16_t s16, svuint16_t u16,
    ...
    svfloat32_t f32, svfloat64_t f64, int i)
{
  ...
  svdot_lane (u32, 0, u8, 0); /* { dg-error "passing 'int' to argument 2 of 'svdot_lane_u32', which expects 'svuint8_t'" } */
  svdot_lane (u32, u8, 0, 0); /* { dg-error "passing 'int' to argument 3 of 'svdot_lane_u32', which expects 'svuint8_t'" } */

  svdot_lane (s32, s8, s8, 0);
  svdot_lane (s32, u8, s8, 0); /* { dg-error "passing 'svuint8_t' to argument 2 of 'svdot_lane_s32', which expects 'svint8_t'" } */
  svdot_lane (s32, s8, u8, 0); /* { dg-error "passing 'svuint8_t' to argument 3 of 'svdot_lane_s32', which expects 'svint8_t'" } */
  svdot_lane (s32, s32, s32, 0); /* { dg-error "passing 'svint32_t' to argument 2 of 'svdot_lane_s32', which expects 'svint8_t'" } */

  svdot_lane (u32, u8, u8, 0);
  svdot_lane (u32, s8, u8, 0); /* { dg-error "passing 'svint8_t' to argument 2 of 'svdot_lane_u32', which expects 'svuint8_t'" } */
  svdot_lane (u32, u8, s8, 0); /* { dg-error "passing 'svint8_t' to argument 3 of 'svdot_lane_u32', which expects 'svuint8_t'" } */
  svdot_lane (u32, u32, u32, 0); /* { dg-error "passing 'svuint32_t' to argument 2 of 'svdot_lane_u32', which expects 'svuint8_t'" } */

  svdot_lane (s64, s16, s16, 0);
  svdot_lane (s64, u16, s16, 0); /* { dg-error "passing 'svuint16_t' to argument 2 of 'svdot_lane_s64', which expects 'svint16_t'" } */
  svdot_lane (s64, s16, u16, 0); /* { dg-error "passing 'svuint16_t' to argument 3 of 'svdot_lane_s64', which expects 'svint16_t'" } */
  svdot_lane (s64, s64, s64, 0); /* { dg-error "passing 'svint64_t' to argument 2 of 'svdot_lane_s64', which expects 'svint16_t'" } */

  svdot_lane (u64, u16, u16, 0);
  svdot_lane (u64, s16, u16, 0); /* { dg-error "passing 'svint16_t' to argument 2 of 'svdot_lane_u64', which expects 'svuint16_t'" } */
  svdot_lane (u64, u16, s16, 0); /* { dg-error "passing 'svint16_t' to argument 3 of 'svdot_lane_u64', which expects 'svuint16_t'" } */
  svdot_lane (u64, u64, u64, 0); /* { dg-error "passing 'svuint64_t' to argument 2 of 'svdot_lane_u64', which expects 'svuint16_t'" } */
