    ...
    svint64_t s64, svuint64_t u64, svfloat64_t f64, enum svprfop op)
{
  ...
  svprfh_gather_index (pg, 0, s32, SV_PLDL1KEEP); /* { dg-error {passing 'int' to argument 2 of 'svprfh_gather_index', which expects a vector or pointer base address} } */
  ...
  svprfh_gather_index (pg, s32_ptr, s8, SV_PLDL1KEEP); /* { dg-error "passing 'svint8_t' to argument 3 of 'svprfh_gather_index', which expects a vector of 32-bit of 64-bit integers" } */
  svprfh_gather_index (pg, s32_ptr, u8, SV_PLDL1KEEP); /* { dg-error "passing 'svuint8_t' to argument 3 of 'svprfh_gather_index', which expects a vector of 32-bit of 64-bit integers" } */
  svprfh_gather_index (pg, s32_ptr, s16, SV_PLDL1KEEP); /* { dg-error "passing 'svint16_t' to argument 3 of 'svprfh_gather_index', which expects a vector of 32-bit of 64-bit integers" } */
  svprfh_gather_index (pg, s32_ptr, u16, SV_PLDL1KEEP); /* { dg-error "passing 'svuint16_t' to argument 3 of 'svprfh_gather_index', which expects a vector of 32-bit of 64-bit integers" } */
  svprfh_gather_index (pg, s32_ptr, f16, SV_PLDL1KEEP); /* { dg-error "passing 'svfloat16_t' to argument 3 of 'svprfh_gather_index', which expects a vector of 32-bit of 64-bit integers" } */
  svprfh_gather_index (pg, s32_ptr, s32, SV_PLDL1KEEP);
  svprfh_gather_index (pg, s32_ptr, u32, SV_PLDL1KEEP);
  svprfh_gather_index (pg, s32_ptr, f32, SV_PLDL1KEEP); /* { dg-error "passing 'svfloat32_t' to argument 3 of 'svprfh_gather_index', which expects a vector of 32-bit of 64-bit integers" } */
  svprfh_gather_index (pg, s32_ptr, s64, SV_PLDL1KEEP);
  svprfh_gather_index (pg, s32_ptr, u64, SV_PLDL1KEEP);
  svprfh_gather_index (pg, s32_ptr, f64, SV_PLDL1KEEP); /* { dg-error "passing 'svfloat64_t' to argument 3 of 'svprfh_gather_index', which expects a vector of 32-bit of 64-bit integers" } */
