...
f1 (svbool_t pg, svuint8_t u8, svuint8x2_t u8x2, svuint8x3_t u8x3, int x)
{
  ...
  u8x2 = svset2 (u8x2, 0, u8x2); /* { dg-error "passing 'svuint8x2_t' to argument 3 of 'svset2', which expects 'svuint8_t'" } */
  u8x2 = svset2 (u8x2, 0, f64); /* { dg-error "passing 'svfloat64_t' to argument 3 of 'svset2', which expects 'svuint8_t'" } */
  u8x2 = svset2 (u8x2, 0, pg); /* { dg-error "passing 'svbool_t' to argument 3 of 'svset2', which expects 'svuint8_t'" } */
