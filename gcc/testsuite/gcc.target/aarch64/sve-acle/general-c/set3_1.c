    ...
    int x)
{
  ...
  f16x3 = svset3 (f16x3, 0, f16x3); /* { dg-error "passing 'svfloat16x3_t' to argument 3 of 'svset3', which expects 'svfloat16_t'" } */
  f16x3 = svset3 (f16x3, 0, f64); /* { dg-error "passing 'svfloat64_t' to argument 3 of 'svset3', which expects 'svfloat16_t'" } */
  f16x3 = svset3 (f16x3, 0, pg); /* { dg-error "passing 'svbool_t' to argument 3 of 'svset3', which expects 'svfloat16_t'" } */
