...
f1 (svbool_t pg, svint32_t s32, svint32x4_t s32x4, svint32x2_t s32x2, int x)
{
  ...
  s32x4 = svset4 (s32x4, 0, s32x4); /* { dg-error "passing 'svint32x4_t' to argument 3 of 'svset4', which expects 'svint32_t'" } */
  s32x4 = svset4 (s32x4, 0, f64); /* { dg-error "passing 'svfloat64_t' to argument 3 of 'svset4', which expects 'svint32_t'" } */
  s32x4 = svset4 (s32x4, 0, pg); /* { dg-error "passing 'svbool_t' to argument 3 of 'svset4', which expects 'svint32_t'" } */
