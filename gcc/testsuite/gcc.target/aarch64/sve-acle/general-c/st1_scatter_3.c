    ...
    svint64_t s64, svuint64_t u64, svfloat64_t f64)
{
  ...
  svst1_scatter_index (pg, 0, s32, s32); /* { dg-error "passing 'int' to argument 2 of 'svst1_scatter_index', which expects a vector or pointer base address" } */
  ...
  svst1_scatter_index (pg, u32, pg, s32); /* { dg-error {incompatible type for argument 3 of 'svst1_scatter_u32base_index_s32'} } */
  svst1_scatter_index (pg, u32, s32, s32); /* { dg-error {incompatible type for argument 3 of 'svst1_scatter_u32base_index_s32'} } */
