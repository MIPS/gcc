    ...
    svint64_t s64, svuint64_t u64, svfloat64_t f64, enum svprfop op)
{
  ...
  svprfb_gather_offset (pg, 0, s32, SV_PLDL1KEEP); /* { dg-error {passing 'int' to argument 2 of 'svprfb_gather_offset', which expects a vector or pointer base address} } */
  ...
  svprfb_gather_offset (pg, s32_ptr, s8, SV_PLDL1KEEP); /* { dg-error "passing 'svint8_t' to argument 3 of 'svprfb_gather_offset', which expects a vector of 32-bit of 64-bit integers" } */
  svprfb_gather_offset (pg, s32_ptr, u8, SV_PLDL1KEEP); /* { dg-error "passing 'svuint8_t' to argument 3 of 'svprfb_gather_offset', which expects a vector of 32-bit of 64-bit integers" } */
  svprfb_gather_offset (pg, s32_ptr, s16, SV_PLDL1KEEP); /* { dg-error "passing 'svint16_t' to argument 3 of 'svprfb_gather_offset', which expects a vector of 32-bit of 64-bit integers" } */
  svprfb_gather_offset (pg, s32_ptr, u16, SV_PLDL1KEEP); /* { dg-error "passing 'svuint16_t' to argument 3 of 'svprfb_gather_offset', which expects a vector of 32-bit of 64-bit integers" } */
  svprfb_gather_offset (pg, s32_ptr, f16, SV_PLDL1KEEP); /* { dg-error "passing 'svfloat16_t' to argument 3 of 'svprfb_gather_offset', which expects a vector of 32-bit of 64-bit integers" } */
  svprfb_gather_offset (pg, s32_ptr, s32, SV_PLDL1KEEP);
  svprfb_gather_offset (pg, s32_ptr, u32, SV_PLDL1KEEP);
  svprfb_gather_offset (pg, s32_ptr, f32, SV_PLDL1KEEP); /* { dg-error "passing 'svfloat32_t' to argument 3 of 'svprfb_gather_offset', which expects a vector of 32-bit of 64-bit integers" } */
  svprfb_gather_offset (pg, s32_ptr, s64, SV_PLDL1KEEP);
  svprfb_gather_offset (pg, s32_ptr, u64, SV_PLDL1KEEP);
  svprfb_gather_offset (pg, s32_ptr, f64, SV_PLDL1KEEP); /* { dg-error "passing 'svfloat64_t' to argument 3 of 'svprfb_gather_offset', which expects a vector of 32-bit of 64-bit integers" } */
