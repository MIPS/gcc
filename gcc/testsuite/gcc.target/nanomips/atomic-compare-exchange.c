...
/* Test lightweight barriers with __atomic_compare_exchange routines for each
   valid memory model.  */
...
/* One acquire fence for each: acquire, acq-rel.  */
/* { dg-final { scan-assembler-times "\tsync\t17" 4 } } */
/* One release fence for each: release, acq-rel.  */
/* { dg-final { scan-assembler-times "\tsync\t18" 4 } } */
/* Two full barriers for each: seq_cst.  */
