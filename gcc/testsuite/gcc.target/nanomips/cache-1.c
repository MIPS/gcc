...
/* { dg-final { scan-assembler "\tcache\t0x14,0\\(\\\$a0\\)" } } */
/* { dg-final { scan-assembler "\tcache\t0x18,20\\(\\\$a0\\)" } } */
/* { dg-final { scan-assembler "\tcache\t(0x|)0,0\\(\\\$a.\\)" } } */
/* { dg-final { scan-assembler "\tcache\t0x4,-80\\(\\\$a0\\)" } } */
