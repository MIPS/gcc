...
/* lwpc reg, %got_pcrel32(a_ext_func) # 1 */
/* jalrc reg # 3 */
...
/* lwpc reg, %got_pcrel32(a_ext_func) # 2 */
...
/* { dg-final { scan-assembler-times "lwpc\t\\\$\[ast0-9\]+,%got_pcrel32\\(a_ext_func\\)" 2 } } */
...
/* lwpc reg, %got_pcrel32(m_ext_func) # 1 */
/* jalrc reg # 8 */
...
/* lwpc reg, %got_pcrel32(m_ext_func) # 2 */
...
/* { dg-final { scan-assembler-times "lwpc\t\\\$\[ast0-9\]+,%got_pcrel32\\(m_ext_func\\)" 2 } } */
