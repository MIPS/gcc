...
/* { dg-final { scan-assembler "lw\t\\\$\[ast0-9\]+,%got_disp\\(m_ext_func\\)\\(\\\$gp\\)" } } */
/* jalrc reg # 4 */

/* { dg-final { scan-assembler "aluipc\t\\\$\[ast0-9\]+,%pcrel_hi\\(m_sta_func\\)" } } */
/* { dg-final { scan-assembler "addiu\t\\\$\[ast0-9\]+,\\\$\[ast0-9\]+,%lo\\(m_sta_func\\)" } } */
/* balc m_sta_fptr # 1*/
