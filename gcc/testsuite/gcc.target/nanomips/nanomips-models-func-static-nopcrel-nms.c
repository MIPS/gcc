/* { dg-do compile } */
/* { dg-options "-m32 -march=32r6s -mno-pcrel" } */
/* { dg-skip-if "" { *-*-* } { "-O1" "-O2" "-O3" "-Os" } { "" } } */

/* balc a_static */

/* lui reg, %hi(a_longcall) # 1 */
/* addiu reg, reg, %lo(a_longcall) # 1 */
/* jalrc reg # 1 */
...
/* addiu reg, reg, %lo(a_longcall) # 2 */
/* balc a_takes_fptr # 2 */

/* lapc reg, a_static # 2 */
/* lui reg, %hi(a_long_takes_fptr) # 1 */
/* addiu reg, reg, %lo(a_long_takes_fptr) # 1 */
/* jalrc reg # 2 */

/* lui reg, %hi(a_longcall) # 3 */
/* addiu reg, reg, %lo(a_longcall) # 3 */
/* lui reg, %hi(a_long_takes_fptr) # 2 */
/* addiu reg, reg, %lo(a_long_takes_fptr) # 2 */
/* jalrc reg # 3 */

/* { dg-final { scan-assembler "balc\ta_static" } } */
/* { dg-final { scan-assembler-times "lui\t\\\$\[ast0-9\]+,%hi\\(a_longcall\\)" 3 } } */
/* { dg-final { scan-assembler-times "addiu\t\\\$\[ast0-9\]+,\\\$\[ast0-9\]+,%lo\\(a_longcall\\)" 3 } } */
...
/* { dg-final { scan-assembler-times "addiu\t\\\$\[ast0-9\]+,\\\$\[ast0-9\]+,%lo\\(a_long_takes_fptr\\)" 2 } } */

/* balc m_static */

/* lui reg, %hi(m_longcall) # 1 */
/* addiu reg, reg, %lo(m_longcall) # 1 */
/* jalrc reg # 4 */

/* lui reg, %hi(m_static) # 1 */
/* addiu reg, reg, %lo(m_static) # 1 */
/* balc m_takes_fptr # 1 */

/* lui reg, %hi(m_longcall) # 2 */
/* addiu reg, reg, %lo(m_longcall) # 2 */
/* balc m_takes_fptr # 2 */

/* lui reg, %hi(m_static) # 2 */
/* addiu reg, reg, %lo(m_static) # 2 */
/* lui reg, %hi(m_long_takes_fptr) # 1 */
/* addiu reg, reg, %lo(m_long_takes_fptr) # 1 */
/* jalrc reg # 5 */

/* lui reg, %hi(m_longcall) # 3 */
/* addiu reg, reg, %lo(m_longcall) # 3 */
/* lui reg, %hi(m_long_takes_fptr) # 2 */
/* addiu reg, reg, %lo(m_long_takes_fptr) # 2 */
/* jalrc reg # 6 */

/* { dg-final { scan-assembler "balc\tm_static" } } */
/* { dg-final { scan-assembler-times "lui\t\\\$\[ast0-9\]+,%hi\\(m_longcall\\)" 3 } } */
/* { dg-final { scan-assembler-times "addiu\t\\\$\[ast0-9\]+,\\\$\[ast0-9\]+,%lo\\(m_longcall\\)" 3 } } */
/* { dg-final { scan-assembler-times "lui\t\\\$\[ast0-9\]+,%hi\\(m_static\\)" 2 } } */
/* { dg-final { scan-assembler-times "addiu\t\\\$\[ast0-9\]+,\\\$\[ast0-9\]+,%lo\\(m_static\\)" 2 } } */
/* { dg-final { scan-assembler-times "balc\tm_takes_fptr" 2 } } */
/* { dg-final { scan-assembler-times "lui\t\\\$\[ast0-9\]+,%hi\\(m_long_takes_fptr\\)" 2 } } */
/* { dg-final { scan-assembler-times "addiu\t\\\$\[ast0-9\]+,\\\$\[ast0-9\]+,%lo\\(m_long_takes_fptr\\)" 2 } } */

/* lui reg, %hi(l_static) # 1 */
/* addiu reg, reg, %lo(l_static) # 1 */
/* jalrc reg # 7 */

/* lui reg, %hi(l_longcall) # 1 */
/* addiu reg, reg, %lo(l_longcall) # 1 */
/* jalrc reg # 8 */

/* lui reg, %hi(l_static) # 2 */
/* addiu reg, reg, %lo(l_static) # 2 */
/* lui reg, %hi(l_takes_fptr) # 1 */
/* addiu reg, reg, %lo(l_takes_fptr) # 1 */
/* jalrc reg # 9 */

/* lui reg, %hi(l_longcall) # 2 */
/* addiu reg, reg, %lo(l_longcall) # 2 */
/* lui reg, %hi(l_takes_fptr) # 2 */
/* addiu reg, reg, %lo(l_takes_fptr) # 2 */
/* jalrc reg # 10 */

/* lui reg, %hi(l_static) # 3 */
/* addiu reg, reg, %lo(l_static) # 3 */
/* lui reg, %hi(l_long_takes_fptr) # 1 */
/* addiu reg, reg, %lo(l_long_takes_fptr) # 1 */
/* jalrc reg # 11 */

/* lui reg, %hi(l_longcall) # 3 */
/* addiu reg, reg, %lo(l_longcall) # 3 */
/* lui reg, %hi(l_long_takes_fptr) # 2 */
/* addiu reg, reg, %lo(l_long_takes_fptr) # 2 */
/* jalrc reg # 12 */

/* { dg-final { scan-assembler-times "lui\t\\\$\[ast0-9\]+,%hi\\(l_static\\)" 3 } } */
/* { dg-final { scan-assembler-times "addiu\t\\\$\[ast0-9\]+,\\\$\[ast0-9\]+,%lo\\(l_static\\)" 3 } } */
/* { dg-final { scan-assembler-times "lui\t\\\$\[ast0-9\]+,%hi\\(l_longcall\\)" 3 } } */
/* { dg-final { scan-assembler-times "addiu\t\\\$\[ast0-9\]+,\\\$\[ast0-9\]+,%lo\\(l_longcall\\)" 3 } } */
/* { dg-final { scan-assembler-times "lui\t\\\$\[ast0-9\]+,%hi\\(l_takes_fptr\\)" 2 } } */
/* { dg-final { scan-assembler-times "addiu\t\\\$\[ast0-9\]+,\\\$\[ast0-9\]+,%lo\\(l_takes_fptr\\)" 2 } } */
/* { dg-final { scan-assembler-times "lui\t\\\$\[ast0-9\]+,%hi\\(l_long_takes_fptr\\)" 2 } } */
/* { dg-final { scan-assembler-times "addiu\t\\\$\[ast0-9\]+,\\\$\[ast0-9\]+,%lo\\(l_long_takes_fptr\\)" 2 } } */
