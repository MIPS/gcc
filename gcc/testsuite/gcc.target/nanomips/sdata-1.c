...
/* { dg-final { scan-assembler     "%gp_?rel\(32\)?\\(l4a\\)" } } */
/* { dg-final { scan-assembler     "%gp_?rel\(32\)?\\(l4b\\)" } } */
/* { dg-final { scan-assembler     "%gp_?rel\(32\)?\\(l4c\\)" } } */
/* { dg-final { scan-assembler     "%gp_?rel\(32\)?\\(e4a\\)" } } */
/* { dg-final { scan-assembler     "%gp_?rel\(32\)?\\(e4b\\)" } } */
/* { dg-final { scan-assembler     "%gp_?rel\(32\)?\\(c4\\)" } } */
/* { dg-final { scan-assembler     "%gp_?rel\(32\)?\\(g4a\\)" } } */
/* { dg-final { scan-assembler     "%gp_?rel\(32\)?\\(g4b\\)" } } */
/* { dg-final { scan-assembler     "%gp_?rel\(32\)?\\(g4c\\)" } } */

/* { dg-final { scan-assembler-not "%gp_?rel\(32\)?\\(l8a\\)" } } */
/* { dg-final { scan-assembler-not "%gp_?rel\(32\)?\\(l8b\\)" } } */
/* { dg-final { scan-assembler     "%gp_?rel\(32\)?\\(l8c\\)" } } */
/* { dg-final { scan-assembler-not "%gp_?rel\(32\)?\\(e8a\\)" } } */
/* { dg-final { scan-assembler     "%gp_?rel\(32\)?\\(e8b\\)" } } */
/* { dg-final { scan-assembler-not "%gp_?rel\(32\)?\\(c8\\)" } } */
/* { dg-final { scan-assembler-not "%gp_?rel\(32\)?\\(g8a\\)" } } */
/* { dg-final { scan-assembler-not "%gp_?rel\(32\)?\\(g8b\\)" } } */
/* { dg-final { scan-assembler     "%gp_?rel\(32\)?\\(g8c\\)" } } */
