/* { dg-do compile } */
/* { dg-options "-m32 -march=32r6 -fpic -mcmodel=auto -mtls-dialect=trad -ftls-model=global-dynamic" } */
...
/* { dg-final { scan-assembler "f_addr:.*\tbalc\t__tls_get_addr.*f_addr\n" } } */
int *
f_addr ()
{
  int *x;
...
/* { dg-final { scan-assembler "f_load:.*\tbalc\t__tls_get_addr.*f_load\n" } } */
...
/* { dg-final { scan-assembler "f_store:.*\tbalc\t__tls_get_addr.*f_store\n" } } */
