...
contains
	...
	!$acc enter data copyin (i, c, r, ia, ca(3:6), ra, rp, ti, vi, aa)
	!$acc enter data create (i, c, r, ia, ca(3:6), ra, rp, ti, vi, aa)
	!$acc enter data present_or_copyin (i, c, r, ia, ca(3:6), ra, rp, ti, vi, aa)
	!$acc enter data pcopyin (i, c, r, ia, ca(3:6), ra, rp, ti, vi, aa)
	!$acc enter data present_or_create (i, c, r, ia, ca(3:6), ra, rp, ti, vi, aa)
	!$acc enter data pcreate (i, c, r, ia, ca(3:6), ra, rp, ti, vi, aa)
	...
	!$acc exit data copyout (i, c, r, ia, ca(3:6), ra, rp, ti, vi, aa)
	!$acc exit data delete (i, c, r, ia, ca(3:6), ra, rp, ti, vi, aa)
	end subroutine foo
end module test
