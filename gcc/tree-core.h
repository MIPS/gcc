...
/* The _FloatN and _FloatNx types must be consecutive, and in the
  ...
  TPI_FLOAT16_TYPE,
  TPI_FLOATN_TYPE_FIRST = TPI_FLOAT16_TYPE,
  TPI_FLOATN_NX_TYPE_FIRST = TPI_FLOAT16_TYPE,
  TPI_FLOAT32_TYPE,
  TPI_FLOAT64_TYPE,
  TPI_FLOAT128_TYPE,
  TPI_FLOATN_TYPE_LAST = TPI_FLOAT128_TYPE,
#define NUM_FLOATN_TYPES (TPI_FLOATN_TYPE_LAST - TPI_FLOATN_TYPE_FIRST + 1)
  TPI_FLOAT32X_TYPE,
  TPI_FLOATNX_TYPE_FIRST = TPI_FLOAT32X_TYPE,
  TPI_FLOAT64X_TYPE,
  TPI_FLOAT128X_TYPE,
  TPI_FLOATNX_TYPE_LAST = TPI_FLOAT128X_TYPE,
  TPI_FLOATN_NX_TYPE_LAST = TPI_FLOAT128X_TYPE,
#define NUM_FLOATNX_TYPES (TPI_FLOATNX_TYPE_LAST - TPI_FLOATNX_TYPE_FIRST + 1)
#define NUM_FLOATN_NX_TYPES (TPI_FLOATN_NX_TYPE_LAST		\
			     - TPI_FLOATN_NX_TYPE_FIRST		\
			     + 1)
  ...
  TPI_COMPLEX_FLOAT16_TYPE,
  TPI_COMPLEX_FLOATN_NX_TYPE_FIRST = TPI_COMPLEX_FLOAT16_TYPE,
  TPI_COMPLEX_FLOAT32_TYPE,
  TPI_COMPLEX_FLOAT64_TYPE,
  TPI_COMPLEX_FLOAT128_TYPE,
  TPI_COMPLEX_FLOAT32X_TYPE,
  TPI_COMPLEX_FLOAT64X_TYPE,
  TPI_COMPLEX_FLOAT128X_TYPE,
