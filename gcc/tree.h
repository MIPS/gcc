...
/* Defined in tree.c due to lack of flag_trapv being visible here.  
...
#define CALL_WITH_BOUNDS_P(NODE) (CALL_EXPR_CHECK (NODE)->u.base.deprecated_flag)
...
#define SET_EXPR_LOCATION(NODE, LOCUS) EXPR_CHECK ((NODE))->u.exp.locus = (LOCUS)
...
#define OMP_CLAUSE_HAS_LOCATION(NODE) \
  ...
  != UNKNOWN_LOCATION)
#define OMP_CLAUSE_LOCATION(NODE)  (OMP_CLAUSE_CHECK (NODE))->u.omp_clause.locus
...
#define OMP_CLAUSE_IF_MODIFIER(NODE)	\
  (OMP_CLAUSE_SUBCODE_CHECK (NODE, OMP_CLAUSE_IF)->u.omp_clause.subcode.if_modifier)
...
#define SET_SSA_NAME_VAR_OR_IDENTIFIER(NODE,VAR) \
  do { SSA_NAME_CHECK (NODE)->u.ssa_name.var = (VAR); } while (0)
...
#define BLOCK_FRAGMENT_ORIGIN(NODE) (BLOCK_CHECK (NODE)->u.block.fragment_origin)
...
#define DECL_NAMELESS(NODE) (DECL_MINIMAL_CHECK (NODE)->u.base.u.bits.nameless_flag)
...
#define DECL_ALIGN(NODE) (DECL_COMMON_CHECK (NODE)->u.decl_common.align)
...
#define DECL_EXTERNAL(NODE) (DECL_COMMON_CHECK (NODE)->u.decl_common.decl_flag_1)
...
#define DECL_PURE_P(NODE) (FUNCTION_DECL_CHECK (NODE)->u.function_decl.pure_flag)
...
#define DECL_NO_INSTRUMENT_FUNCTION_ENTRY_EXIT(NODE) \
  (FUNCTION_DECL_CHECK (NODE)->u.function_decl.no_instrument_function_entry_exit)
...
REAL_VALUE_TYPE real_value_from_int_cst (const ttype_p, const_tree);
