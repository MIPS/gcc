...
#define SET_TYPE_STRUCTURAL_EQUALITY_P(NODE) ((NODE)->set_structural_equality_p ())
/* It would be better to replace this old form with the new everywhere.  */
#undef SET_TYPE_STRUCTURAL_EQUALITY
#define SET_TYPE_STRUCTURAL_EQUALITY(NODE)  SET_TYPE_STRUCTURAL_EQUALITY_P(NODE)


/* Undefine a few of the SET_ macros that already exist.  */
#undef SET_TYPE_MODE
#undef SET_TYPE_VECTOR_SUBPARTS

/* Undefine all the TYPE_ macros.  */
#undef TYPE_HASH
...
/* Undefine the variosu TYPE condition checking macros.  */
#undef VECTOR_TYPE_P
...
/* Define the GET accessor macros.  */
...
#define TYPE_SIZES_GIMPLIFIED(NODE) ((NODE)->sizes_gimplified_p ())
...
#define TYPE_NO_FORCE_BLK(NODE) ((NODE)->no_force_blk_p ())
...
#define TYPE_QUALS_NO_ADDR_SPACE_NO_ATOMIC(NODE) 			\
				    ((NODE)->quals_no_addr_space_no_atomic ())
...
#define TYPE_CONTAINS_PLACEHOLDER_INTERNAL(NODE)			\
				    ((NODE)->contains_placeholder_internal ())
...
#define TYPE_CACHED_VALUES(NODE) ((NODE)->cached_values ())
...
/* Define the type condition checking macros.  */
...
#define COMPLETE_OR_UNBOUND_ARRAY_TYPE_P(NODE)				\
				    ((NODE)->complete_or_unbound_array_p ())
#define FUNC_OR_METHOD_TYPE_P(NODE) ((NODE)->func_or_method_p ())
 
/* Define the SET macros.  */
#define SET_TYPE_HASH(NODE, VAL) ((NODE)->set_hash (VAL))
#define SET_TYPE_ARTIFICIAL(NODE, VAL)  ((NODE)->set_artificial_p (VAL))
#define SET_TYPE_REF_CAN_ALIAS_ALL(NODE, VAL)				\
				      ((NODE)->set_ref_can_alias_all_p (VAL))
#define SET_TYPE_CACHED_VALUES_P(NODE, VAL) ((NODE)->set_cached_values_p (VAL))
#define SET_TYPE_SIZES_GIMPLIFIED(NODE, VAL)				\
					((NODE)->set_sizes_gimplified_p (VAL))
#define SET_TYPE_UNSIGNED(NODE, VAL) ((NODE)->set_unsigned_p (VAL))
#define SET_TYPE_SIGN(NODE, VAL) ((NODE)->set_sign (VAL))
#define SET_TYPE_OVERFLOW_WRAPS(NODE, VAL) ((NODE)->set_overflow_wraps_p (VAL))
#define SET_TYPE_OVERFLOW_UNDEFINED(NODE, VAL)				\
					((NODE)->set_overflow_undefined_p (VAL))
#define SET_TYPE_OVERFLOW_TRAPS(NODE, VAL) ((NODE)->set_overflow_traps_p (VAL))
#define SET_TYPE_OVERFLOW_SANITIZED(NODE, VAL)				\
					((NODE)->set_overflow_sanitized_p (VAL))
#define SET_TYPE_ALIGN_OK(NODE, VAL) ((NODE)->set_align_ok_p (VAL))
#define SET_TYPE_REF_IS_RVALUE(NODE, VAL) ((NODE)->set_ref_is_rvalue_p (VAL))
#define SET_TYPE_REVERSE_STORAGE_ORDER(NODE, VAL)			\
				    ((NODE)->set_reverse_storage_order_p (VAL))
#define SET_TYPE_SATURATING(NODE, VAL) ((NODE)->set_saturating_p (VAL))
#define SET_TYPE_UID(NODE, VAL) ((NODE)->set_uid (VAL))
#define SET_TYPE_SIZE(NODE, VAL) ((NODE)->set_size (VAL))
#define SET_TYPE_SIZE_UNIT(NODE, VAL) ((NODE)->set_size_unit (VAL))
#define SET_TYPE_POINTER_TO(NODE, VAL) ((NODE)->set_pointer_to (VAL))
#define SET_TYPE_REFERENCE_TO(NODE, VAL) ((NODE)->set_reference_to (VAL))
#define SET_TYPE_PRECISION(NODE, VAL) ((NODE)->set_precision (VAL))
#define SET_TYPE_NAME(NODE, VAL) ((NODE)->set_name (VAL))
#define SET_TYPE_NEXT_VARIANT(NODE, VAL) ((NODE)->set_next_variant (VAL))
#define SET_TYPE_MAIN_VARIANT(NODE, VAL) ((NODE)->set_main_variant (VAL))
#define SET_TYPE_CONTEXT(NODE, VAL) ((NODE)->set_context (VAL))
#define SET_TYPE_MODE_RAW(NODE, VAL) ((NODE)->set_mode_raw (VAL))
#define SET_TYPE_MODE(NODE, VAL) ((NODE)->set_mode (VAL))
#define SET_TYPE_CANONICAL(NODE, VAL) ((NODE)->set_canonical (VAL))
#define SET_TYPE_IBIT(NODE, VAL) ((NODE)->set_ibit (VAL))
#define SET_TYPE_FBIT(NODE, VAL) ((NODE)->set_fbit (VAL))
#define SET_TYPE_ALIAS_SET(NODE, VAL) ((NODE)->set_alias_set (VAL))
#define SET_TYPE_ALIAS_SET_KNOWN_P(NODE, VAL)				\
					  ((NODE)->set_alias_set_known_p (VAL))
#define SET_TYPE_ATTRIBUTES(NODE, VAL) ((NODE)->set_attributes (VAL))
#define SET_TYPE_ALIGN(NODE, VAL) ((NODE)->set_align (VAL))
#define SET_TYPE_USER_ALIGN(NODE, VAL) ((NODE)->set_user_align_p (VAL))
#define SET_TYPE_ALIGN_UNIT(NODE, VAL) ((NODE)->set_align_unit (VAL))
#define SET_TYPE_STUB_DECL(NODE, VAL) ((NODE)->set_stub_decl (VAL))
#define SET_TYPE_NO_FORCE_BLK(NODE, VAL) ((NODE)->set_no_force_blk_p (VAL))
#define SET_TYPE_VOLATILE(NODE, VAL) ((NODE)->set_volatile_p (VAL))
#define SET_TYPE_ATOMIC(NODE, VAL) ((NODE)->set_atomic_p (VAL))
#define SET_TYPE_READONLY(NODE, VAL) ((NODE)->set_readonly_p (VAL))
#define SET_TYPE_RESTRICT(NODE, VAL) ((NODE)->set_restrict_p (VAL))
#define SET_TYPE_NAMELESS(NODE, VAL) ((NODE)->set_nameless_p (VAL))
#define SET_TYPE_ADDR_SPACE(NODE, VAL) ((NODE)->set_addr_space (VAL))
#define SET_TYPE_QUALS(NODE, VAL) ((NODE)->set_quals (VAL))
#define SET_TYPE_QUALS_NO_ADDR_SPACE(NODE, VAL)				\
					((NODE)->set_quals_no_addr_space (VAL))
#define SET_TYPE_QUALS_NO_ADDR_SPACE_NO_ATOMIC(NODE, VAL)		\
			      ((NODE)->set_quals_no_addr_space_no_atomic (VAL))
#define SET_TYPE_LANG_FLAG_0(NODE, VAL) ((NODE)->set_lang_flag_0_p (VAL))
#define SET_TYPE_LANG_FLAG_1(NODE, VAL) ((NODE)->set_lang_flag_1_p (VAL))
#define SET_TYPE_LANG_FLAG_2(NODE, VAL) ((NODE)->set_lang_flag_2_p (VAL))
#define SET_TYPE_LANG_FLAG_3(NODE, VAL) ((NODE)->set_lang_flag_3_p (VAL))
#define SET_TYPE_LANG_FLAG_4(NODE, VAL) ((NODE)->set_lang_flag_4_p (VAL))
#define SET_TYPE_LANG_FLAG_5(NODE, VAL) ((NODE)->set_lang_flag_5_p (VAL))
#define SET_TYPE_LANG_FLAG_6(NODE, VAL) ((NODE)->set_lang_flag_6_p (VAL))
#define SET_TYPE_STRING_FLAG(NODE, VAL) ((NODE)->set_string_flag_p (VAL))
#define SET_TYPE_VECTOR_SUBPARTS(NODE, VAL) ((NODE)->set_vector_subparts (VAL))
#define SET_TYPE_VECTOR_OPAQUE(NODE, VAL) ((NODE)->set_vector_opaque_p (VAL))
#define SET_TYPE_NEEDS_CONSTRUCTING(NODE, VAL)				\
				      ((NODE)->set_needs_constructing_p (VAL))
#define SET_TYPE_TRANSPARENT_AGGR(NODE, VAL)				\
					((NODE)->set_transparent_aggr_p (VAL))
#define SET_TYPE_NONALIASED_COMPONENT(NODE, VAL)			\
				    ((NODE)->set_nonaliased_component_p (VAL))
#define SET_TYPE_PACKED(NODE, VAL) ((NODE)->set_packed_p (VAL))
#define SET_TYPE_CONTAINS_PLACEHOLDER_INTERNAL(NODE, VAL)		\
			    ((NODE)->set_contains_placeholder_internal (VAL))
#define SET_TYPE_FINAL_P(NODE, VAL) ((NODE)->set_final_p (VAL))
#define SET_TYPE_SYMTAB_ADDRESS(NODE, VAL) ((NODE)->set_symtab_address (VAL))
#define SET_TYPE_SYMTAB_POINTER(NODE, VAL) ((NODE)->set_symtab_pointer (VAL))
#define SET_TYPE_SYMTAB_DIE(NODE, VAL) ((NODE)->set_symtab_die (VAL))
#define SET_TYPE_SYMTAB_IS_ADDRESS (NODE, VAL)				\
					((NODE)->set_symtab_is_address_p (VAL))
#define SET_TYPE_SYMTAB_IS_POINTER (NODE, VAL)				\
					((NODE)->set_symtab_is_pointer_p (VAL))
#define SET_TYPE_SYMTAB_IS_DIE (NODE, VAL) ((NODE)->set_symtab_is_die_p (VAL))
#define SET_TYPE_LANG_SPECIFIC(NODE, VAL) ((NODE)->set_lang_specific (VAL))
#define SET_TYPE_VALUES(NODE, VAL) ((NODE)->set_values (VAL))
#define SET_TYPE_DOMAIN(NODE, VAL) ((NODE)->set_domain (VAL))
#define SET_TYPE_FIELDS(NODE, VAL) ((NODE)->set_fields (VAL))
#define SET_TYPE_CACHED_VALUES(NODE, VAL) ((NODE)->set_cached_values (VAL))
#define SET_TYPE_ARG_TYPES(NODE, VAL) ((NODE)->set_arg_types (VAL))
#define SET_TYPE_VALUES_RAW(NODE, VAL) ((NODE)->set_values_raw (VAL))
#define SET_TYPE_METHODS(NODE, VAL) ((NODE)->set_methods (VAL))
#define SET_TYPE_VFIELD(NODE, VAL) ((NODE)->set_vfield (VAL))
#define SET_TYPE_METHOD_BASETYPE(NODE, VAL) ((NODE)->set_method_basetype (VAL))
#define SET_TYPE_OFFSET_BASETYPE(NODE, VAL) ((NODE)->set_offset_basetype (VAL))
#define SET_TYPE_MAXVAL(NODE, VAL) ((NODE)->set_maxval (VAL))
#define SET_TYPE_MINVAL(NODE, VAL) ((NODE)->set_minval (VAL))
#define SET_TYPE_NEXT_PTR_TO(NODE, VAL) ((NODE)->set_next_ptr_to (VAL))
#define SET_TYPE_NEXT_REF_TO(NODE, VAL) ((NODE)->set_next_ref_to (VAL))
#define SET_TYPE_MIN_VALUE(NODE, VAL) ((NODE)->set_min_value (VAL))
#define SET_TYPE_MAX_VALUE(NODE, VAL) ((NODE)->set_max_value (VAL))
#define SET_TYPE_ARRAY_MAX_SIZE(NODE, VAL) ((NODE)->set_array_max_size (VAL))
#define SET_TYPE_BINFO(NODE, VAL) ((NODE)->set_binfo (VAL))
#define SET_TYPE_LANG_SLOT_1(NODE, VAL) ((NODE)->set_lang_slot_1 (VAL))
#define SET_TYPE_IDENTIFIER(NODE, VAL) ((NODE)->set_identifier (VAL))
#define SET_TYPE_FILE_SCOPE_P(NODE, VAL) ((NODE)->set_file_scope_p (VAL))
#define SET_TYPE_DECL_SUPPRESS_DEBUG(NODE, VAL)				\
					((NODE)->set_decl_surpress_debug (VAL))


/* Define the macros to take the address of a field.  */
...
/* Once a file is converted, the type field should only be settable with a 
   ttype * node.  */
static inline void
SET_TREE_TYPE (tree node, ttype *t)
{
  (CONTAINS_STRUCT_CHECK (node, TS_TYPED)->u.typed.type) = t;
}

static inline void
SET_TREE_TYPE (ttype *node, ttype *t)
{
  node->set_type (t);
}

/* And fro taking the address of a TREE_TYPE field.  */
