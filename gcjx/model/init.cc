...
void
model_initializer_block::resolve (resolution_scope *scope)
{
  model_block::resolve (scope);
}

void
model_initializer_block::compute_normal_completion
    (normal_completion_state &state)
{
  model_block::compute_normal_completion (state);
