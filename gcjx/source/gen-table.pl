...
# Characters we want definitions for.
# Mostly these are used in the lexer.
%want = ('BACKSLASH' => 1,
	 'SLASH' => 1,
	 'BACKSPACE' => 1,
	 'HORIZONTAL TABULATION' => 1,
	 'FORM FEED' => 1,
	 'LINE FEED' => 1,
	 'CARRIAGE RETURN' => 1,
	 'LATIN SMALL LETTER A' => 1,
	 'LATIN CAPITAL LETTER A' => 1,
	 'LATIN SMALL LETTER B' => 1,
	 'LATIN SMALL LETTER D' => 1,
	 'LATIN CAPITAL LETTER D' => 1,
	 'LATIN SMALL LETTER E' => 1,
	 'LATIN CAPITAL LETTER E' => 1,
	 'LATIN SMALL LETTER F' => 1,
	 'LATIN CAPITAL LETTER F' => 1,
	 'LATIN SMALL LETTER L' => 1,
	 'LATIN CAPITAL LETTER L' => 1,
	 'LATIN SMALL LETTER N' => 1,
	 'LATIN SMALL LETTER R' => 1,
	 'LATIN SMALL LETTER T' => 1,
	 'LATIN SMALL LETTER U' => 1,
	 'LATIN SMALL LETTER X' => 1,
	 'LATIN CAPITAL LETTER X' => 1,
	 'QUOTATION MARK' => 1,
	 'APOSTROPHE' => 1,
	 'DIGIT ZERO' => 1,
	 'DIGIT ONE' => 1,
	 ...
	 'RIGHT CURLY BRACKET' => 1,
	 'LEFT SQUARE BRACKET' => 1,
...
while (<INPUT>)
{
    ...
    if (defined $want{$fields[$NAME]})
    {
	$got{$fields[$NAME]} = $code;
    }
    elsif (defined $want{$fields[$OLD_NAME]})
    {
	$got{$fields[$OLD_NAME]} = $code;
    }
...
sub print_tables
{
    ...
    foreach $key (sort keys %want)
    {
	die "Whoops!  Missing $key!" unless defined $got{$key};
	(my $out = $key) =~ s/[ -]/_/g;
	print OUT "#define UNICODE_$out   $got{$key}\n";
    }

    # This one is too terrible.
    print OUT "#define UNICODE_TAB  UNICODE_HORIZONTAL_TABULATION\n";
