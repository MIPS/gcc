			     ...
			     HOST_WIDE_INT bu_mask)
{
  ...
  if ((flags & (OPTION_MASK_FLOAT128_VSX | OPTION_MASK_FLOAT128_GPR)) != 0)
  ...
  if ((flags & OPTION_MASK_FLOAT128_GPR) != 0)
    rs6000_define_or_undefine_macro (define_p, "__FLOAT128_GPR__");
