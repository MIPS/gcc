...
(define_expand "extendkftf2"
  [(set (match_operand:TF 0 "vsx_register_operand" "")
	(float_extend:TF (match_operand:KF 1 "vsx_register_operand" "")))]
...
(define_expand "trunctfkf2"
  [(set (match_operand:KF 0 "vsx_register_operand" "")
	(float_extend:KF (match_operand:TF 1 "vsx_register_operand" "")))]
  "FLOAT128_IEEE_P (TFmode)"
{
  rs6000_expand_float128_convert (operands[0], operands[1], false);
  DONE;
