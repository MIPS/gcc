       ...
       || (TARGET_POWERPC64 && TARGET_DIRECT_MOVE))"
{
  ...
  else if (<MODE>mode == TFmode && TARGET_IEEEQUAD)
    {
...
(define_expand "signbit<mode>2"
  [(set (match_operand:SI 0 "gpc_reg_operand" "")
	(unspec:SI [(match_operand:SFDF 1 "input_operand" "")]
		   UNSPEC_SIGNBIT))]
  "TARGET_POWERPC64 && TARGET_DIRECT_MOVE"
  "")
...
(define_insn_and_split "signbit<mode>2_dm"
  [(set (match_operand:SI 0 "gpc_reg_operand" "=r,r,r,r")
	(unspec:SI
	 [(match_operand:SIGNBIT 1 "input_operand" "<Fsignbit>,m,0,r")]
	 UNSPEC_SIGNBIT))]
  "TARGET_POWERPC64 && TARGET_DIRECT_MOVE"
  "#"
  "&& reload_completed"
...
(define_insn_and_split "*signbit_<u>di_<mode>2_dm"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=r,r,r,r")
	(any_extend:DI
	 (unspec:SI [(match_operand:SIGNBIT 1 "input_operand" "<Fsignbit>,m,0,r")]
		    UNSPEC_SIGNBIT)))]
  "TARGET_POWERPC64 && TARGET_DIRECT_MOVE"
  "#"
  "&& reload_completed"
