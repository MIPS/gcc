...
(define_expand "extenddf<mode>2"
  [(set (match_operand:FLOAT128 0 "nonimmediate_operand" "")
	(float_extend:FLOAT128 (match_operand:DF 1 "input_operand" "")))]
   ...
   && TARGET_LONG_DOUBLE_128"
{
  if (FLOAT128_IEEE_P (<MODE>mode))
    ...
    emit_insn (gen_extenddfif2_fprs (operands[0], operands[1]));
  else
    gcc_unreachable ();
  DONE;
})

(define_expand "extenddf<mode>2_fprs"
  [(parallel [(set (match_operand:IBM128 0 "nonimmediate_operand" "")
		   (float_extend:IBM128
...
(define_insn_and_split "*extenddf<mode>2_internal"
  [(set (match_operand:IBM128 0 "nonimmediate_operand" "=m,Y,ws,d,&d")
	(float_extend:IBM128
	 (match_operand:DF 1 "input_operand" "d,r,md,md,md")))
  ...
  [(pc)]
{
  ...
  emit_move_insn (simplify_gen_subreg (DFmode, operands[0], <MODE>mode, hi_word),
		  operands[1]);
  emit_move_insn (simplify_gen_subreg (DFmode, operands[0], <MODE>mode, lo_word),
		  operands[2]);
  DONE;
})
...
(define_insn_and_split "trunc<mode>df2_internal1"
  [(set (match_operand:DF 0 "gpc_reg_operand" "=d,?d")
	(float_truncate:DF (match_operand:IBM128 1 "gpc_reg_operand" "0,d")))]
...
(define_expand "floatdi<mode>2"
  [(set (match_operand:IEEE128 0 "nonimmediate_operand" "")
...
(define_expand "floatuns<IEEE128:mode><SDI:mode>2"
  [(set (match_operand:IEEE128 0 "nonimmediate_operand" "")
