...
main (void)
{
  ...
  test_signbit (__builtin_copysign ((__float128)__builtin_inf (), +1.0q), 0);
  test_signbit (__builtin_copysign ((__float128)__builtin_inf (), -1.0q), 1);

  test_signbit (__builtin_copysign ((__float128)__builtin_nan (""), +1.0q), 0);
  test_signbit (__builtin_copysign ((__float128)__builtin_nan (""), -1.0q), 1);
