...
TFtype _q_qadd (TFtype, TFtype);
TFtype _q_qsub (TFtype, TFtype);
TFtype _q_qmul (TFtype, TFtype);
TFtype _q_qdiv (TFtype, TFtype);
TFtype _q_qneg (TFtype);
