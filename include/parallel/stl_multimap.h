  ...
  */
  template <typename _Key, typename _Tp,
    ...
    private:
      ...
      typedef __gnu_parallel::_Rb_tree<key_type, value_type, _Select1st<value_type>,
                 key_compare, _Pair_alloc_type> _Rep_type;
      typedef typename _Rep_type::base_type sequential;
	...
	return *this;
      ...
      template<typename _InputIterator>
        void
        insert(_InputIterator __first, _InputIterator __last, __gnu_parallel::sequential_tag)
        { _M_t.sequential::_M_insert_equal(__first, __last); }
