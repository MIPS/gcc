...
(define_insn "zero_extendsi<mode>2"
  [(set (match_operand:EXTSI 0 "gpc_reg_operand" "=r,r,wz,wu,wj,wJwK")
	(zero_extend:EXTSI (match_operand:SI 1 "reg_or_mem_operand" "m,r,Z,Z,r,wJwK")))]
  ""
  "@
   lwz%U1%X1 %0,%1
   rldicl %0,%1,0,32
   ...
   mtvsrwz %x0,%1
   xxextractuw %x0,%x1,1"
  [(set_attr "type" "load,shift,fpload,fpload,mffgpr,vecexts")])
