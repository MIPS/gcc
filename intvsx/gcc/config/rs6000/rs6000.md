...
(define_insn "zero_extendsi<mode>2"
  [(set (match_operand:EXTSI 0 "gpc_reg_operand" "=r,r,wi,?*wj,?r,?*wJ")
	(zero_extend:EXTSI (match_operand:SI 1 "reg_or_mem_operand" "m,r,Z,r,wj,wJ")))]
  ""
  "@
   lwz%U1%X1 %0,%1
   rldicl %0,%1,0,32
   ...
   mfvsrwz %0,%x1
   xxextractuw %x0,%x1,1"
  [(set_attr "type" "load,shift,fpload,mffgpr,mftgpr,vecexts")])
...
(define_insn "extendsi<mode>2"
  [(set (match_operand:EXTSI 0 "gpc_reg_operand" "=r,r,wi,?wj,?*wK")
	(sign_extend:EXTSI (match_operand:SI 1 "lwa_operand" "Y,r,Z,r,wK")))]
  ""
  "@
   lwa%U1%X1 %0,%1
   extsw %0,%1
   ...
   mtvsrwa %x0,%1
   vextsw2d %0,%1"
  [(set_attr "type" "load,exts,fpload,mffgpr,vecexts")
   (set_attr "sign_extend" "yes")])
...
(define_insn "lfiwzx"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=d,wj,wj,wJ")
	(unspec:DI [(match_operand:SI 1 "reg_or_indexed_operand" "Z,Z,r,wJ")]
		   UNSPEC_LFIWZX))]
...
;;		MR           LA           LWZ          L{F,XS}IWZX  STW
;;		ST{F,XS}IWX  LI           LIS          #            XXLOR
;;		XXSPLTIB 0   XXSPLTIB -1  VSPLTISW     XXLXOR 0     XXLORC -1
;;		P9 const     MTVSRWZ      MFVSRWZ      MF%1         MT%0
;;		MT%0         NOP
...
(define_split
  ...
  "TARGET_VSX_SIMODE && TARGET_P9_VECTOR && reload_completed"
  [(const_int 0)]
{
  rtx op0 = operands[0];
  rtx op1 = operands[1];
