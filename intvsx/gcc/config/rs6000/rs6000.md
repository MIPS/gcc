...
;;		MR         LBZ        LXSIBZX    STB        STXSIBX    LI
;;		XXLOR      load 0     load -1    XXSPLTIB   MFVSRWZ    MTVSRWZ
;;		MF%1       MT%1       NOP
(define_insn "*movqi_internal"
  [(set (match_operand:QI 0 "nonimmediate_operand"
		"=r,        r,        ?*wJwK,    m,         Z,         r,
		 ?*wJwK,    ?*wJwK,   ?*wJwK,    ?*wJwK,    r,         ?*wJwK,
		 r,         *c*l,     *h")

	(match_operand:QI 1 "input_operand"
		"r,        m,         Z,         r,         ?wJwK,     i,
		 ?*wJwK,   O,         wM,        wE,        ?*wJwK,    r,
		 *h, r,    0"))]
  ...
  [(set_attr "type"
		"*,        load,      fpload,    store,     fpstore,   *,
		 vecsimple,vecperm,   vecperm,   vecperm,   mftgpr,    mffgpr,
		 mfjmpr,   mtjmpr,    *")])

