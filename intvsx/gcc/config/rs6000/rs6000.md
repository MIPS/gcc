...
(define_insn "zero_extendsi<mode>2"
  [(set (match_operand:EXTSI 0 "gpc_reg_operand"  "=r,wI,wH,r,wIwH")
	(zero_extend:EXTSI
	 (match_operand:SI 1 "reg_or_mem_operand" "m, Z, Z, r,r")))]
  ""
  "@
   lwz%U1%X1 %0,%1
   lfiwzx %0,%y1
   ...
   rldicl %0,%1,0,32
   mtvsrwz %x0,%1"
  [(set_attr "type" "load,fpload,fpload,shift,mffgpr")])
...
(define_insn "extendsi<mode>2"
  [(set (match_operand:EXTSI 0 "gpc_reg_operand"            "=r,wI,wH,r,wIwH,wK")
	(sign_extend:EXTSI (match_operand:SI 1 "lwa_operand" "Y,Z, Z, r,r,   wK")))]
  ""
  "@
   lwa%U1%X1 %0,%1
   lfiwax %0,%y1
   ...
   mtvsrwa %x0,%1
   vextsw2d %0,%1"
  [(set_attr "type" "load,fpload,fpload,exts,mffgpr,vecperm")
   (set_attr "sign_extend" "yes")])
...
; In the past, we didn't define lfiwax/lfiwzx with the normal definition,
; because we didn't want to support putting SImode in FPR registers.
(define_insn "lfiwax"
...
; If we allow 32-bit integers in VSX registers, we don't need this code.
...
(define_insn_and_split "floatsi<mode>2_lfiwax"
  ...
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT && TARGET_LFIWAX
   && !TARGET_VSX_SImode && <SI_CONVERT_FP> && can_create_pseudo_p ()"
  "#"
  ""
  [(pc)]
  "
...
(define_insn_and_split "floatunssi<mode>2_lfiwzx"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<Fv>")
   ...
   (clobber (match_scratch:DI 2 "=wi"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT && TARGET_LFIWZX
   && !TARGET_VSX_SImode && <SI_CONVERT_FP>"
  "#"
  ""
  [(pc)]
  "
  ...
  "
{
  ...
  else if (TARGET_LFIWAX && TARGET_FCFID && !TARGET_VSX_SImode)
    {
  ...
  "
{
  ...
  else if (TARGET_LFIWZX && TARGET_FCFIDUS && !TARGET_VSX_SImode)
    {
  ...
  "
{
  ...
  else if (TARGET_LFIWZX && TARGET_FCFID && !TARGET_VSX_SImode)
    {
...
;;		XXLXOR 0     XXLORC -1    MTVSRWZ      MFVSRWZ      MF%1
;;		MT%0         MT%0         NOP
(define_insn "*movsi_internal1"								                           
  ...
  [(set_attr "type"
		 ...
		 *,          veclogical,  vecsimple,   vecsimple,   vecsimple,
		 veclogical, veclogical,  mffgpr,      mftgpr,      *,
		 *,          *,           *")
