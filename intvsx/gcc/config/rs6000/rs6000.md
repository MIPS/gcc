...
(define_insn "zero_extendsi<mode>2"
  [(set (match_operand:EXTSI 0 "gpc_reg_operand" "=r,r,wj,wz,wu,wJ")
	(zero_extend:EXTSI (match_operand:SI 1 "reg_or_mem_operand" "m,r,r,Z,Z,wJ")))]
  ""
  "@
   lwz%U1%X1 %0,%1
   rldicl %0,%1,0,32
   ...
   lxsiwzx %x0,%y1
   xxextractuw %x0,%x1,1"
  [(set_attr "type" "load,shift,mffgpr,fpload,fpload,vecexts")])
...
(define_insn "extendsi<mode>2"
  [(set (match_operand:EXTSI 0 "gpc_reg_operand" "=r,r,wj,wl,wu,wK")
	(sign_extend:EXTSI (match_operand:SI 1 "lwa_operand" "Y,r,r,Z,Z,wK")))]
  ""
  "@
   lwa%U1%X1 %0,%1
   extsw %0,%1
   ...
   lxsiwax %x0,%y1
   vextsw2d %0,%1"
  [(set_attr "type" "load,exts,mffgpr,fpload,fpload,vecexts")
   (set_attr "sign_extend" "yes")])
