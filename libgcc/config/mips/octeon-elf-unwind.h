...
#if defined _ABIN32 && _MIPS_SIM == _ABIN32 && defined __MIPSEB__
  /* The register save slot is 8 bytes and uw_update_context fetches RA as a
     pointer so use the lower half for N32.  */
  fs->regs.reg[DWARF_ALT_FRAME_RETURN_COLUMN].loc.offset += 4;
#endif
