...
void _gfortran_caf_co_sum (gfc_descriptor_t *, caf_vector_t *, int, int *,
                           char *, int);
void _gfortran_caf_co_min (gfc_descriptor_t *, caf_vector_t *, int, int *,
                           char *, int, int);
void _gfortran_caf_co_max (gfc_descriptor_t *, caf_vector_t *, int, int *,
                           char *, int, int);
