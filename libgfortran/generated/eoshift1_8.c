...
void
__eoshift1_8 (const g95_array_char * ret, const g95_array_char * array,
    const g95_array_i8 * h, const char * pbound, const G95_INTEGER_8 * pwhich)
{
