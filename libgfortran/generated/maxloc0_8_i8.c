...
void
__maxloc0_8_i8 (g95_array_i8 * retarray, g95_array_i8 *array)
{
  ...
  G95_INTEGER_8 maxval;

  /* Initialize the return value.  */
  for (n = 0; n < rank; n++)
    dest[n * dstride] = 0;
  maxval = -G95_INTEGER_8_HUGE;
...
void
__mmaxloc0_8_i8 (g95_array_i8 * retarray, g95_array_i8 *array, g95_array_l4 * mask)
{
  index_type count[G95_MAX_DIMENSIONS];
  index_type extent[G95_MAX_DIMENSIONS];
  index_type sstride[G95_MAX_DIMENSIONS];
