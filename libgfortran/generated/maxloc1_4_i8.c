...
void
__maxloc1_4_i8 (g95_array_i4 * retarray, g95_array_i8 *array, index_type *pdim)
{
...
void
__mmaxloc1_4_i8 (g95_array_i4 * retarray, g95_array_i8 * array, index_type *pdim, g95_array_l4 * mask)
{
  index_type count[G95_MAX_DIMENSIONS - 1];
  index_type extent[G95_MAX_DIMENSIONS - 1];
  index_type sstride[G95_MAX_DIMENSIONS - 1];
