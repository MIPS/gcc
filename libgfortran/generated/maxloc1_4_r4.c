...
void
__maxloc1_4_r4 (g95_array_i4 * retarray, g95_array_r4 *array, index_type *pdim)
{
  ...
  while (base)
    {
      G95_REAL_4 *src;
      G95_INTEGER_4 result;
      src = base;
      {

  G95_REAL_4 maxval;
  maxval = -G95_REAL_4_HUGE;
  result = 0;
...
void
__mmaxloc1_4_r4 (g95_array_i4 * retarray, g95_array_r4 * array, index_type *pdim, g95_array_l4 * mask)
{
  index_type count[G95_MAX_DIMENSIONS - 1];
  index_type extent[G95_MAX_DIMENSIONS - 1];
  index_type sstride[G95_MAX_DIMENSIONS - 1];
