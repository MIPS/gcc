...
void
__product_r4 (g95_array_r4 * retarray, g95_array_r4 *array, index_type *pdim)
{
...
void
__mproduct_r4 (g95_array_r4 * retarray, g95_array_r4 * array, index_type *pdim, g95_array_l4 * mask)
{
  index_type count[G95_MAX_DIMENSIONS - 1];
  index_type extent[G95_MAX_DIMENSIONS - 1];
  index_type sstride[G95_MAX_DIMENSIONS - 1];
