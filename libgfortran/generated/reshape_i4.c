...
/* The shape parameter is ignored. We can currently deduce the shape from the
   return array.  */
void
__reshape_4 (g95_array_i4 * ret, g95_array_i4 * source, shape_type * shape,
                      g95_array_i4 * pad, shape_type * order)
{
  ...
  index_type pdim;
  index_type psize;
  const G95_INTEGER_4 *pptr;

  const G95_INTEGER_4 *src;
  int n;
  int dim;
