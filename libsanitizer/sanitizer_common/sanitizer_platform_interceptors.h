...
#define SANITIZER_INTERCEPT_GLOB (SI_LINUX_NOT_ANDROID && SI_LINUX_NOT_UCLIBC ) || SI_SOLARIS
#define SANITIZER_INTERCEPT_GLOB64 (SI_LINUX_NOT_ANDROID && SI_LINUX_NOT_UCLIBC)
...
#define SANITIZER_INTERCEPT_GETIFADDRS                                        \
  (SI_FREEBSD || SI_NETBSD || SI_OPENBSD ||                                   \
   (SI_LINUX_NOT_ANDROID  && SI_LINUX_NOT_UCLIBC)                             \
   || SI_MAC || SI_SOLARIS)
