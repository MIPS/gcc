...
namespace __gnu_debug
{
  ...
  template<typename _Iterator, typename _Sequence>
    ...
    public:
      ...
      _Safe_iterator() : _Safe_iterator_base(), _M_current() { }
...
namespace std {
  _GLIBCXX_LATE_CHECK
  template <typename _Iterator, typename _Sequence>
  requires InputIterator<_Iterator>
  concept_map InputIterator<__gnu_debug::_Safe_iterator<_Iterator, _Sequence> > {};

  _GLIBCXX_LATE_CHECK
  template <typename _Iterator, typename _Sequence>
  requires ForwardIterator<_Iterator>
  concept_map ForwardIterator<__gnu_debug::_Safe_iterator<_Iterator, _Sequence> > {};

  _GLIBCXX_LATE_CHECK
  template <typename _Iterator, typename _Sequence>
  requires BidirectionalIterator<_Iterator>
  concept_map BidirectionalIterator<__gnu_debug::_Safe_iterator<_Iterator, _Sequence> > {};

  _GLIBCXX_LATE_CHECK
  template <typename _Iterator, typename _Sequence>
  requires RandomAccessIterator<_Iterator>
  concept_map RandomAccessIterator<__gnu_debug::_Safe_iterator<_Iterator, _Sequence> > {};
}
