...
#include <ext/algorithm> // For lexicographical_compare_3way
#include <ext/numeric> // For power

_GLIBCXX_BEGIN_NAMESPACE(std)
_GLIBCXX_BEGIN_NAMESPACE(tr2)
  ...
  template <typename _CharT, typename _Alloc>
    inline
    _Rope_iterator<_CharT, _Alloc>::
    _Rope_iterator(basic_rope<_CharT, _Alloc>& __r, size_t __pos)
  ...
  template <typename _CharT, typename _Alloc>
    typename basic_rope<_CharT, _Alloc>::_RopeLeaf*
    basic_rope<_CharT, _Alloc>::
	...
	_Data_allocate(_S_rounded_up_size(__old_len + __len));
      ...
      std::uninitialized_copy_n(__r->_M_data, __old_len, __new_data);
      std::uninitialized_copy_n(__iter, __len, __new_data + __old_len);
  ...
  template <typename _CharT, typename _Alloc>
      ...
      if (_S_allocated_capacity(__old_len) >= __old_len + __len)
	{
	  ...
	  std::uninitialized_copy_n(__iter, __len, __r->_M_data + __old_len);
	  if (_S_is_basic_char_type((_CharT*)0))
  ...
  template <typename _CharT, typename _Alloc>
    typename basic_rope<_CharT, _Alloc>::_RopeRep*
    basic_rope<_CharT, _Alloc>::
  ...
  template<typename _CharT>
    ...
    public:
      ...
      {
	std::uninitialized_copy_n(__leaf, __n, _M_buf_ptr);
	_M_buf_ptr += __n;
	return true;
      }
    };
  ...
  inline bool
  _Rope_is_simple(char16_t*)
  { return true; }

  inline bool
  _Rope_is_simple(char32_t*)
  { return true; }
#endif
  ...
  template<typename _CharT, typename _Traits, typename _Alloc>
    ...
    operator<<(basic_ostream<_CharT, _Traits>& __o,
	       const basic_rope<_CharT, _Alloc>& __r)
    {
  ...
  template <typename _CharT, typename _Alloc>
	...
	case __detail::_S_leaf:
	  {
	    _RopeLeaf* __l = (_RopeLeaf*)__r;
	    return std::copy_n(__l->_M_data, __l->_M_size, __buffer);
	  }
	case __detail::_S_function:
	case __detail::_S_substringfn:
  ...
  template <typename _CharT, typename _Alloc>
	  ...
	  if (__detail::_S_leaf == __right->_M_tag)
	    {
	      ...
	      return __gnu_cxx::lexicographical_compare_3way(__l->_M_data,
      ...
      else
	{
	  ...
	  if (__detail::_S_leaf == __right->_M_tag)
	    {
	      _RopeLeaf* __r = (_RopeLeaf*) __right;
	      return __gnu_cxx::lexicographical_compare_3way(__lstart, __lend,
						  __r->_M_data, __r->_M_data
						  + __right_len);
	    }
	  else
  ...
  template <typename _CharT, typename _Alloc>
    basic_rope<_CharT, _Alloc>::
    basic_rope(size_t __n, _CharT __c, const allocator_type& __a)
    : _Base(__a)
    {
      basic_rope<_CharT,_Alloc> __result;
      const size_t __exponentiate_threshold = 32;
      size_t __exponent;
      size_t __rest;
      _CharT* __rest_buffer;
      _RopeRep* __remainder;
      basic_rope<_CharT, _Alloc> __remainder_rope;
  ...
  template<typename _CharT, typename _Alloc>
    _CharT
    basic_rope<_CharT, _Alloc>::_S_empty_c_str[1];
  ...
  template<typename _CharT, typename _Alloc>
    const _CharT* basic_rope<_CharT, _Alloc>::
    replace_with_c_str()
    {
      if (0 == this->_M_tree_ptr)
	{
  ...
  template<typename _Rope_iterator>  // was templated on CharT and Alloc
    void		          // VC++ workaround
		 ...
		 _Rope_iterator __last)
    {
      ...
      basic_rope<_CharT, _Alloc>& __r(__first.container());
      basic_rope<_CharT, _Alloc> __prefix = __r.substr(0, __first.index());
      basic_rope<_CharT, _Alloc> __suffix =
	__r.substr(__last.index(), __r.size() - __last.index());
      basic_rope<_CharT, _Alloc> __part1 =
	__r.substr(__middle.index(), __last.index() - __middle.index());
      basic_rope<_CharT, _Alloc> __part2 =
