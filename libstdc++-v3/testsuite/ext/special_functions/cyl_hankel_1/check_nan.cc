...
test01()
{
  ...
  std::complex<float> a = __gnu_cxx::cyl_hankel_1(nuf, xf);
  std::complex<float> b = __gnu_cxx::cyl_hankel_1f(nuf, xf);
  std::complex<double> c = __gnu_cxx::cyl_hankel_1(nud, xd);
  std::complex<long double> d = __gnu_cxx::cyl_hankel_1(nul, xl);
  std::complex<long double> e = __gnu_cxx::cyl_hankel_1l(nul, xl);
