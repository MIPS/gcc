...
test01()
{
  ...
  float a = __gnu_cxx::ellint_d(kf, phif);
  float b = __gnu_cxx::ellint_df(kf, phif);
  double c = __gnu_cxx::ellint_d(kd, phid);
  long double d = __gnu_cxx::ellint_d(kl, phil);
  long double e = __gnu_cxx::ellint_dl(kl, phil);
