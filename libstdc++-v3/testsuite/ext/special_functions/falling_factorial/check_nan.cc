...
test01()
{
  ...
  float a = __gnu_cxx::pochhammer_lower(af, nf);
  float b = __gnu_cxx::pochhammer_lowerf(af, nf);
  double c = __gnu_cxx::pochhammer_lower(ad, nd);
  long double d = __gnu_cxx::pochhammer_lower(al, nl);
  long double e = __gnu_cxx::pochhammer_lowerl(al, nl);
