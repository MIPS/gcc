...
test01()
{
  ...
  float a = __gnu_cxx::heuman_lambda(phif, kf);
  float b = __gnu_cxx::heuman_lambdaf(phif, kf);
  double c = __gnu_cxx::heuman_lambda(phid, kd);
  long double d = __gnu_cxx::heuman_lambda(phil, kl);
  long double e = __gnu_cxx::heuman_lambdal(phil, kl);
