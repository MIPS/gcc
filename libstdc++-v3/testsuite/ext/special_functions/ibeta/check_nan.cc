...
test01()
{
  ...
  float a = __gnu_cxx::ibeta(bf, af, xf);
  float b = __gnu_cxx::ibetaf(bf, af, xf);
  double c = __gnu_cxx::ibeta(bd, ad, xd);
  long double d = __gnu_cxx::ibeta(bl, al, xl);
  long double e = __gnu_cxx::ibetal(bl, al, xl);
...
test02()
{
  ...
  float a = __gnu_cxx::ibeta(af, bf, xf);
  float b = __gnu_cxx::ibetaf(af, bf, xf);
  double c = __gnu_cxx::ibeta(ad, bd, xd);
  long double d = __gnu_cxx::ibeta(al, bl, xl);
  long double e = __gnu_cxx::ibetal(al, bl, xl);
