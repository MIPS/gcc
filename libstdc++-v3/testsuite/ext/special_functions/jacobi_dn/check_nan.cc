...
test01()
{
  ...
  float a = __gnu_cxx::jacobi_dn(kf, uf);
  float b = __gnu_cxx::jacobi_dnf(kf, uf);
  double c = __gnu_cxx::jacobi_dn(kd, ud);
  long double d = __gnu_cxx::jacobi_dn(kl, ul);
  long double e = __gnu_cxx::jacobi_dnl(kl, ul);
