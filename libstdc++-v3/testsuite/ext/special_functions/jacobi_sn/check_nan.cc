...
test01()
{
  ...
  float a = __gnu_cxx::jacobi_sn(kf, uf);
  float b = __gnu_cxx::jacobi_snf(kf, uf);
  double c = __gnu_cxx::jacobi_sn(kd, ud);
  long double d = __gnu_cxx::jacobi_sn(kl, ul);
  long double e = __gnu_cxx::jacobi_snl(kl, ul);
