...
test01()
{
  ...
  float a = __gnu_cxx::jacobi_zeta(kf, phif);
  float b = __gnu_cxx::jacobi_zetaf(kf, phif);
  double c = __gnu_cxx::jacobi_zeta(kd, phid);
  long double d = __gnu_cxx::jacobi_zeta(kl, phil);
  long double e = __gnu_cxx::jacobi_zetal(kl, phil);
