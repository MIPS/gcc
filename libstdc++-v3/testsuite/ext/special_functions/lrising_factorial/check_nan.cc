...
test01()
{
  ...
  float a = __gnu_cxx::lpochhammer(af, nf);
  float b = __gnu_cxx::lpochhammerf(af, nf);
  double c = __gnu_cxx::lpochhammer(ad, nd);
  long double d = __gnu_cxx::lpochhammer(al, bl);
  long double e = __gnu_cxx::lpochhammerl(al, bl);
...
test02()
{
  ...
  float b = __gnu_cxx::lpochhammerf(af, nf);
  double c = __gnu_cxx::lpochhammer(ad, nd);
  long double d = __gnu_cxx::lpochhammer(al, nl);
  long double e = __gnu_cxx::lpochhammerl(al, nl);
