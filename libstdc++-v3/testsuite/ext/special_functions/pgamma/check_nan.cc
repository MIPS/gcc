...
test01()
{
  ...
  float a = __gnu_cxx::pgamma(af, xf);
  float b = __gnu_cxx::pgammaf(af, xf);
  double c = __gnu_cxx::pgamma(ad, xd);
  long double d = __gnu_cxx::pgamma(al, xl);
  long double e = __gnu_cxx::pgammal(al, xl);
