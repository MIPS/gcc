...
test01()
{
  ...
  float a = __gnu_cxx::qgamma(af, xf);
  float b = __gnu_cxx::qgammaf(af, xf);
  double c = __gnu_cxx::qgamma(ad, xd);
  long double d = __gnu_cxx::qgamma(al, xl);
  long double e = __gnu_cxx::qgammal(al, xl);
