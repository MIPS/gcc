...
test01()
{
  ...
  std::complex<float> a = __gnu_cxx::sph_hankel_1(n, xf);
  std::complex<float> b = __gnu_cxx::sph_hankel_1f(n, xf);
  std::complex<double> c = __gnu_cxx::sph_hankel_1(n, xd);
  std::complex<long double> d = __gnu_cxx::sph_hankel_1(n, xl);
  std::complex<long double> e = __gnu_cxx::sph_hankel_1l(n, xl);
