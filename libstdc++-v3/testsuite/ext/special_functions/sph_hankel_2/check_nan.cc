...
test01()
{
  ...
  std::complex<float> a = __gnu_cxx::sph_hankel_2(n, xf);
  std::complex<float> b = __gnu_cxx::sph_hankel_2f(n, xf);
  std::complex<double> c = __gnu_cxx::sph_hankel_2(n, xd);
  std::complex<long double> d = __gnu_cxx::sph_hankel_2(n, xl);
  std::complex<long double> e = __gnu_cxx::sph_hankel_2l(n, xl);
