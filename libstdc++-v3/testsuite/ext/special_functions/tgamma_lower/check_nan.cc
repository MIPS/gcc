...
test01()
{
  ...
  float a = __gnu_cxx::tgamma_lower(af, xf);
  float b = __gnu_cxx::tgamma_lowerf(af, xf);
  double c = __gnu_cxx::tgamma_lower(ad, xd);
  long double d = __gnu_cxx::tgamma_lower(al, xl);
  long double e = __gnu_cxx::tgamma_lowerl(al, xl);
