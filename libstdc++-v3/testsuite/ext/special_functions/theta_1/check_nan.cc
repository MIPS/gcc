...
test01()
{
  ...
  float a = __gnu_cxx::theta_1(nuf, xf);
  float b = __gnu_cxx::theta_1f(nuf, xf);
  double c = __gnu_cxx::theta_1(nud, xd);
  long double d = __gnu_cxx::theta_1(nul, xl);
  long double e = __gnu_cxx::theta_1l(nul, xl);
