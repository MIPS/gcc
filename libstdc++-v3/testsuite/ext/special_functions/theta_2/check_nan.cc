...
test01()
{
  ...
  float a = __gnu_cxx::theta_2(nuf, xf);
  float b = __gnu_cxx::theta_2f(nuf, xf);
  double c = __gnu_cxx::theta_2(nud, xd);
  long double d = __gnu_cxx::theta_2(nul, xl);
  long double e = __gnu_cxx::theta_2l(nul, xl);
