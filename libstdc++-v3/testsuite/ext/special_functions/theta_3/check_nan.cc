...
test01()
{
  ...
  float a = __gnu_cxx::theta_3(nuf, xf);
  float b = __gnu_cxx::theta_3f(nuf, xf);
  double c = __gnu_cxx::theta_3(nud, xd);
  long double d = __gnu_cxx::theta_3(nul, xl);
  long double e = __gnu_cxx::theta_3l(nul, xl);
