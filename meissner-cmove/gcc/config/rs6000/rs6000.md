	...
	(if_then_else:GPR
	 (match_operator 1 "branch_comparison_operator"
			 [(match_operand 2 "cc_reg_operand" "y,y")
			  (const_int 0)])
	 (match_operand:GPR 3 "add_operand" "0,rIL")
	 (match_operand:GPR 4 "add_operand" "rIL,0")))]
  "TARGET_BCP8"
{
  bool reverse_p = (which_alternative == 1);
  ...
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r,r")
	(if_then_else:GPR
	 (match_operator 1 "bcp8_comparison_operator"
	    [(match_operand:GPR2 2 "gpc_reg_operand" "r,r")
	     (match_operand:GPR2 3 "reg_or_cint_operand" "rIK,rIK")])
	 (match_operand:GPR 4 "add_operand" "0,rIL")
	 (match_operand:GPR 5 "add_operand" "rIL,0")))
   (clobber (match_scratch:CC 6 "=y,y"))]
