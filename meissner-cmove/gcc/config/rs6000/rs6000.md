...
(define_insn "*bcp8<GPR:mode>_signed<GPR2:mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r,r")
	(if_then_else:GPR
	 (match_operator 1 "signed_branch_comparison_operator"
	    [(match_operand:GPR2 2 "gpc_reg_operand" "r,r")
	     (match_operand:GPR2 3 "reg_or_short_operand" "rI,rI")])
...
{
  bool reverse_p = (which_alternative == 1);
  rtx cond = gen_rtx_fmt_ee (GET_CODE (operands[1]), CCmode, operands[6],
			     const0_rtx);
...
(define_insn "*bcp8<GPR:mode>_unsigned<GPR2:mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r,r")
	(if_then_else:GPR
	 (match_operator 1 "unsigned_branch_comparison_operator"
	    [(match_operand:GPR2 2 "gpc_reg_operand" "r,r")
	     (match_operand:GPR2 3 "reg_or_short_operand" "rI,rI")])
	 (match_operand:GPR 4 "add_operand" "0,rIL")
	 (match_operand:GPR 5 "add_operand" "rIL,0")))
   (clobber (match_scratch:CCUNS 6 "=y,y"))]
  "TARGET_BCP8 && TARGET_BCP8_MERGE"
{
  bool reverse_p = (which_alternative == 1);
  rtx cond = gen_rtx_fmt_ee (GET_CODE (operands[1]), CCUNSmode, operands[6],
			     const0_rtx);
