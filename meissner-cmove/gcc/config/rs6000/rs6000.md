...
(define_constants
  [(STACK_POINTER_REGNUM	1)
   ...
   ; Flags for hiding ISEL and only generating it for specific ops BCP8 is not
   ; really an isel, but it looks like one at the RTL level, and at the machine
   ; level it is similar to ISEL.
   (ISEL_BCP8			0)
   (ISEL_IABS			1)
   (ISEL_IMINMAX		2)
   (ISEL_SETCC			3)
...
;; If this is a branch conditional + 8 insn or an ISEL
(define_attr "isel_type" "neither,bcp8,isel"
  (if_then_else (eq_attr "isel")
		(const_string "isel")
		(const_string "neither")))
...
; Iterator for CC modes
(define_mode_iterator CR [CC CCEQ CCUNS CCFP])
(define_mode_iterator ICR [CC CCEQ CCUNS])
...
;; Signed/unsigned minimum/maximum
(define_insn_and_split "smin<mode>3"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(smin:GPR (match_operand:GPR 1 "gpc_reg_operand" "%r")
  ...
  "
{
  rs6000_expand_iminmax (operands[0], SMIN, operands[1], operands[2]);
  DONE;
}")

(define_insn_and_split "smax<mode>3"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(smax:GPR (match_operand:GPR 1 "gpc_reg_operand" "%r")
		  (match_operand:GPR 2 "reg_or_short_operand" "rI")))]
  "TARGET_IMINMAX"
  "#"
  ""
  ...
  "
{
  rs6000_expand_iminmax (operands[0], SMAX, operands[1], operands[2]);
  DONE;
}")

(define_insn_and_split "umin<mode>3"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(umin:GPR (match_operand:GPR 1 "gpc_reg_operand" "%r")
		  (match_operand:GPR 2 "reg_or_short_operand" "rI")))]
  "TARGET_IMINMAX"
  "#"
  ""
  ...
  "
{
  rs6000_expand_iminmax (operands[0], UMIN, operands[1], operands[2]);
  DONE;
}")

(define_insn_and_split "umax<mode>3"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(umax:GPR (match_operand:GPR 1 "gpc_reg_operand" "%r")
		  (match_operand:GPR 2 "reg_or_short_operand" "rI")))]
  "TARGET_IMINMAX"
  "#"
  ""
  ...
  "
{
  rs6000_expand_iminmax (operands[0], UMAX, operands[1], operands[2]);
  DONE;
}")
...
(define_insn_and_split "abs<mode>2"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "")
	(abs:GPR (match_operand:GPR 1 "gpc_reg_operand" "")))]
  "TARGET_IABS"
  "#"
  ""
  [(const_int 0)]
  "
{
  ...
  if (TARGET_IABS_ISEL)		/* use ISEL instruction.  */
    {
      tmp1 = gen_reg_rtx (<MODE>mode);
      cc = gen_reg_rtx (CCmode);
      lt = gen_rtx_LT (VOIDmode, cc, const0_rtx);
      cmp = gen_rtx_COMPARE (CCmode, op1, const0_rtx);
      emit_insn (gen_neg<mode>2 (tmp1, op1));
      emit_insn (gen_rtx_SET (VOIDmode, cc, cmp));
      emit_insn (gen_isel<mode> (op0, lt, tmp1, op1, cc, GEN_INT (ISEL_IABS)));
      DONE;
    }
  else if (TARGET_IABS_BCP8)	/* Use branch conditional + 8.  */
    {
      tmp1 = gen_reg_rtx (<MODE>mode);
      cc = gen_reg_rtx (CCmode);
      lt = gen_rtx_LT (CCmode, cc, const0_rtx);
      cmp = gen_rtx_COMPARE (CCmode, op1, const0_rtx);
      emit_insn (gen_neg<mode>2 (tmp1, op1));
      emit_insn (gen_rtx_SET (VOIDmode, cc, cmp));
      emit_insn (gen_bcp8<mode> (op0, lt, cc, tmp1, op1));
      DONE;
    }
  else if (TARGET_IABS_SHIFT)	/* Use shift/xor/subtract.  */
    {
      tmp1 = gen_reg_rtx (<MODE>mode);
      tmp2 = gen_reg_rtx (<MODE>mode);
      shift = GEN_INT ((<MODE>mode == SImode) ? 31 : 63);
      emit_insn (gen_ashr<mode>3 (tmp1, op1, shift));
      emit_insn (gen_xor<mode>3 (tmp2, tmp1, op1));
      emit_insn (gen_sub<mode>3 (op0, tmp2, tmp1));
      DONE;
    }
  else
    FAIL;
...
(define_insn_and_split "*nabs<mode>2"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "")
	(neg:GPR (abs:GPR (match_operand:GPR 1 "gpc_reg_operand" ""))))]
  "TARGET_IABS"
  "#"
  ""
  [(const_int 0)]
  ...
  if (TARGET_IABS_ISEL)		/* use ISEL instruction.  */
    {
      ...
      emit_insn (gen_neg<mode>2 (tmp1, op1));
      emit_insn (gen_rtx_SET (VOIDmode, cc, cmp));
      emit_insn (gen_isel<mode> (op0, lt, op1, tmp1, cc, GEN_INT (ISEL_IABS)));
      DONE;
    }
  else if (TARGET_IABS_BCP8)	/* Use branch conditional + 8.  */
    {
      ...
      emit_insn (gen_neg<mode>2 (tmp1, op1));
      emit_insn (gen_rtx_SET (VOIDmode, cc, cmp));
      emit_insn (gen_bcp8<mode> (op0, lt, cc, op1, tmp1));
      DONE;
    }
  else if (TARGET_IABS_SHIFT)	/* Use shift/xor/subtract.  */
    {
      ...
      emit_insn (gen_ashr<mode>3 (tmp1, op1, shift));
      emit_insn (gen_xor<mode>3 (tmp2, tmp1, op1));
      emit_insn (gen_sub<mode>3 (op0, tmp1, tmp2));
      DONE;
    }
  else
    FAIL;
...
;; Conditional integer move
(define_expand "mov<mode>cc"
   [(set (match_operand:GPR 0 "gpc_reg_operand" "")
	 (if_then_else:GPR (match_operand 1 "comparison_operator" "")
			   (match_operand:GPR 2 "gpc_reg_operand" "")
			   (match_operand:GPR 3 "gpc_reg_operand" "")))]
  "TARGET_SETCC_ISEL_OR_BCP8"
  "
{
...
(define_expand "isel<mode>"
  [(parallel [(set (match_operand:GPR 0 "gpc_reg_operand" "r")
		   (if_then_else:GPR
		    (match_operator 1 "scc_comparison_operator"
				    [(match_operand 4 "cc_reg_operand" "")
				     (const_int 0)])
		    (match_operand:GPR 2 "reg_or_zero_operand" "")
		    (match_operand:GPR 3 "gpc_reg_operand" "")))
	      (use (match_operand 5 "const_int_operand" ""))])]
  ""
  "")

(define_insn "*isel_normal<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r,r")
	(if_then_else:GPR
	 (match_operator 1 "scc_comparison_operator"
			 [(match_operand 4 "cc_reg_operand" "y,y")
			  (const_int 0)])
	 (match_operand:GPR 2 "reg_or_zero_operand" "O,b")
	 (match_operand:GPR 3 "gpc_reg_operand" "r,r")))
   (use (match_operand 5 "const_int_operand" "i,i"))]
  "ISEL_OK_P (INTVAL (operands[5]))"
  "*
{ return output_isel (operands); }"
  [(set_attr "type" "isel")
   (set_attr "isel_type" "isel")
   (set_attr "length" "4")])

(define_insn "*isel_reversed<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r,r")
	(if_then_else:GPR
	 (match_operator 1 "scc_rev_comparison_operator"
			 [(match_operand 4 "cc_reg_operand" "y,y")
			  (const_int 0)])
	 (match_operand:GPR 2 "gpc_reg_operand" "r,r")
	 (match_operand:GPR 3 "reg_or_zero_operand" "b,O")))
   (use (match_operand 5 "const_int_operand" "i,i"))]
  "ISEL_OK_P (INTVAL (operands[5]))"
  "*
{ return output_isel (operands); }"
...
;; Branch conditional+8 support.  Some powerpc machines have a special
;; optimization that can optimize a branch around a single instruction that is
;; an integer move or a restricted form of store add, and, or, or xor
;; operation.  We don't expose this branch to flow control to make sure that
;; the compiler does not put anything else into the slot.

(define_insn "bcp8<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=b")
	(if_then_else:GPR
	 ...
	 (match_operand:GPR 4 "add_operand" "rIL")))
   (use (const_int ISEL_BCP8))]
  ""
  "*
{
  output_asm_insn (output_cbranch (operands[1], \"1f\", 0, insn, 0), operands);
  if (GET_CODE (operands[4]) == CONST_INT)
    {
      if (satisfies_constraint_I (operands[4]))
	output_asm_insn (\"{lil|li} %0,%4\", operands);
      else if (satisfies_constraint_L (operands[4]))
	output_asm_insn (\"{liu|lis} %0,%v4\", operands);
      else
	gcc_unreachable ();
    }
  else
    output_asm_insn (\"mr %0,%4\", operands);

  fputs (\"1:\n\", asm_out_file);
  return \"\";
}"
  [(set_attr "type" "isel")
   (set_attr "isel_type" "bcp8")
   (set_attr "length" "8")])


;; Branch conditional+8 logical operations
;; The power7 only optimizes the register operations.
(define_insn "*bcp8_cond_exec_bool<mode>"
  [(cond_exec
    (match_operator 0 "branch_comparison_operator"
		    [(match_operand 1 "cc_reg_operand" "y")
		     (const_int 0)])
    (set (match_operand:GPR 2 "gpc_reg_operand" "=r")
	 (match_operator:GPR 3 "bcp8_bool_operator"
			     [(match_operand:GPR 4 "gpc_reg_operand" "r")
			      (match_operand:GPR 5 "gpc_reg_operand" "r")])))]
  "TARGET_SETCC_BCP8 && TARGET_BCP8_COND_EXEC"
  "*
{
  output_asm_insn (output_cbranch (operands[0], \"2f\", 1, insn, 0), operands);
  output_asm_insn (\"%q3 %2,%4,%5\", operands);
  fputs (\"2:\n\", asm_out_file);
  return \"\";
}"
  [(set_attr "type" "isel")
...
;; Branch conditional+8 add operations
(define_insn "*bcp8_cond_exec_add<mode>"
  [(cond_exec
    (match_operator 0 "branch_comparison_operator"
		    [(match_operand 1 "cc_reg_operand" "y,y,y")
		     (const_int 0)])
    (set (match_operand:GPR 2 "gpc_reg_operand" "=r,r,r")
	 (plus:GPR (match_operand:GPR 3 "gpc_reg_operand" "r,r,r")
		   (match_operand:GPR 4 "add_operand" "r,I,L"))))]
  "TARGET_SETCC_BCP8 && TARGET_BCP8_COND_EXEC"
  "*
{
  const char *insn_str;
  output_asm_insn (output_cbranch (operands[0], \"3f\", 1, insn, 0), operands);
  if (GET_CODE (operands[4]) != CONST_INT)
    insn_str = \"{cax|add} %2,%3,%4\";
  else if (satisfies_constraint_I (operands[4]))
    insn_str = \"{cal %2,%4(%3)|addi %2,%3,%4}\";
  else if (satisfies_constraint_L (operands[4]))
    insn_str = \"{cau|addis} %2,%3,%v4\";
  else
    gcc_unreachable ();

  output_asm_insn (insn_str, operands);
  fputs (\"3:\n\", asm_out_file);
  return \"\";
}"
  [(set_attr "type" "isel")
...
;; Branch conditional+8 store operations
(define_insn "*bcp8_cond_exec_store<mode>"
  [(cond_exec
    (match_operator 0 "branch_comparison_operator"
		    [(match_operand 1 "cc_reg_operand" "y")
		     (const_int 0)])
    (set (match_operand:INT1 2 "bcp8_store_operand" "=m")
	 (match_operand:INT1 3 "gpc_reg_operand" "r")))]
  "TARGET_SETCC_BCP8 && TARGET_BCP8_COND_EXEC"
  "*
{
  const char *insn_str;
  enum machine_mode mode = GET_MODE (operands[2]);
  output_asm_insn (output_cbranch (operands[0], \"4f\", 1, insn, 0), operands);
  if (mode == QImode)
    insn_str = \"stb%U2%X2 %3,%2\";
  else if (mode == HImode)
    insn_str = \"sth%U2%X2 %3,%2\";
  else if (mode == SImode)
    insn_str = \"stw%U2%X2 %3,%2\";
  else if (mode == DImode)
    insn_str = \"std%U2%X2 %3,%2\";
  else
    gcc_unreachable ();
...

;; Setcc (set conditional) support.  On 64-bit systems, try creating the result
;; as 64-bit first to avoid sign extend operations.
(define_expand "cstore<mode>4"
  ...
  "
{
  if (TARGET_POWERPC64 && can_create_pseudo_p () && TARGET_SETCC_ISEL_OR_BCP8)
    {
      rtx save_result = operands[0];
      operands[0] = gen_reg_rtx (DImode);
      if (rs6000_emit_sCOND (<MODE>mode, operands))
	{
	  convert_move (save_result, operands[0], 0);
	  DONE;
	}

      operands[0] = save_result;
    }
...
;;
;; Split insn into move to GPR and then extract bit.  Hopefully something will
;; be scheduled between the mfcr and the rlwinm
(define_insn_and_split "*setcc<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
  ...
  "
{
  ...
  rtx op1 = operands[1];
  rtx op2 = operands[2];
  rtx tmp = (can_create_pseudo_p ()) ? gen_reg_rtx (<MODE>mode) : op0;
  emit_insn (gen_setcc<mode>_internal1 (tmp, op1, op2));
  emit_insn (gen_setcc<mode>_internal2 (op0, tmp, op1, op2));
  DONE;
}"
  [(set (attr "type")
...
;; Move the CR register to a GPR without doing an extract
(define_insn "setcc<mode>_internal1"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(unspec:GPR [(match_operator:GPR 1 "scc_comparison_operator"
					 [(match_operand 2 "cc_reg_operand" "y")
					  (const_int 0)])] UNSPEC_SETCC))]
  ""
  "mfcr %0%Q2"
  [(set (attr "type")
	(if_then_else (match_test "TARGET_MFCRF")
...
;; Extract the value from CR copied to the GPR, using the bit information from
;; the original CR register
(define_insn "setcc<mode>_internal2"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(unspec:GPR [(match_operand:GPR 1 "gpc_reg_operand" "r")
		     (match_operator:GPR 2 "scc_comparison_operator"
					 [(match_operand 3 "cc_reg_operand" "y")
					  (const_int 0)])] UNSPEC_SETCC))]
  ""
  "{rlinm|rlwinm} %0,%1,%J2,1"
...
(define_insn "*setccsi_internal3"
  ...
  "TARGET_32BIT && TARGET_SETCC_MFCR"
  "@
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_cr0_operand" "")
   ...
   (set (match_operand:SI 3 "gpc_reg_operand" "")
	(match_op_dup 1 [(match_dup 2) (const_int 0)]))]
  "TARGET_32BIT && reload_completed && TARGET_SETCC_MFCR"
  [(set (match_dup 3)
	(match_op_dup 1 [(match_dup 2) (const_int 0)]))
   (set (match_dup 0)
	(compare:CC (match_dup 3)
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_micro_cr0_operand" "")
   ...
   (set (match_operand:SI 4 "gpc_reg_operand" "")
	(ashift:SI (match_op_dup 1 [(match_dup 2) (const_int 0)])
		   (match_dup 3)))]
  "reload_completed && TARGET_SETCC_MFCR"
  [(set (match_dup 4)
	(ashift:SI (match_op_dup 1 [(match_dup 2) (const_int 0)])
		   (match_dup 3)))
   (set (match_dup 0)
   ...
   (set (match_operand:SI 3 "gpc_reg_operand" "=r")
	(match_operator:SI 4 "scc_comparison_operator"
			   [(match_operand 5 "cc_reg_operand" "y")
			    (const_int 0)]))]
  "REGNO (operands[2]) != REGNO (operands[5]) && TARGET_SETCC_MFCR"
...
(define_split
  ...
  "! gpc_reg_operand (operands[2], SImode) && TARGET_SETCC_MFCR"
  [(set (match_dup 5) (match_dup 2))
...
(define_insn "*plus_eqsi"
  ...
  "TARGET_32BIT && TARGET_EQ_NE && TARGET_SETCC_MFCR"
  "@
...
(define_insn "*compare_plus_eqsi"
  ...
  "TARGET_32BIT && optimize_size && TARGET_EQ_NE && TARGET_SETCC_MFCR"
  "@
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_cr0_operand" "")
	(compare:CC
	 ...
	 (const_int 0)))
   (clobber (match_scratch:SI 4 ""))]
  "TARGET_32BIT && optimize_size && reload_completed && TARGET_EQ_NE
   && TARGET_SETCC_MFCR"
  [(set (match_dup 4)
...
(define_insn "*ne0di"
  ...
  "TARGET_64BIT && TARGET_EQ_NE && TARGET_SETCC_MFCR"
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_cr0_operand" "")
   ...
   (clobber (match_scratch:SI 3 ""))
   (clobber (match_scratch:SI 4 ""))]
  "TARGET_32BIT && reload_completed && TARGET_EQ_NE && TARGET_SETCC_MFCR"
  [(parallel [(set (match_dup 3)
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_micro_cr0_operand" "")
	(compare:CC
	 ...
	 (const_int 0)))
   (clobber (match_scratch:DI 3 ""))]
  "TARGET_64BIT && reload_completed && TARGET_EQ_NE && TARGET_SETCC_MFCR"
  [(set (match_dup 3)
  ...
  [(set (match_operand:CC 4 "cc_reg_not_micro_cr0_operand" "")
   ...
   (set (match_operand:DI 0 "gpc_reg_operand" "")
	(plus:DI (lshiftrt:DI (neg:DI (abs:DI (match_dup 1))) (const_int 63))
		 (match_dup 2)))
   (clobber (match_scratch:DI 3 ""))]
  "TARGET_64BIT && reload_completed && TARGET_SETCC_MFCR"
  [(parallel [(set (match_dup 0)
	(plus:DI (lshiftrt:DI (neg:DI (abs:DI (match_dup 1))) (const_int 63))
		 (match_dup 2)))
   (clobber (match_dup 3))])
...
(define_insn "*plus_leu_comparesi"
  [(set (match_operand:CC 0 "cc_reg_operand" "=x,?y")
	(compare:CC
...
(define_insn "*plus_leu_compare2si"
  [(set (match_operand:CC 4 "cc_reg_operand" "=x,?y")
	(compare:CC
	 (plus:SI (leu:SI (match_operand:SI 1 "gpc_reg_operand" "r,r")
			  (match_operand:SI 2 "reg_or_short_operand" "rI,rI"))
...
(define_insn "*and_compare2_leusi"
  [(set (match_operand:CC 4 "cc_reg_operand" "=x,?y")
	(compare:CC
	 (and:SI (neg:SI
		  (leu:SI (match_operand:SI 1 "gpc_reg_operand" "r,r")
...
(define_insn "*compare_plus_gtdi"
  [(set (match_operand:CC 0 "cc_reg_operand" "=x,?y")
	(compare:CC
	 ...
	 (const_int 0)))
   (clobber (match_scratch:DI 3 "=&r,&r"))]
  "TARGET_64BIT && TARGET_SETCC_MFCR"
  "@
...
(define_insn "*compare_plus_gt2di"
  [(set (match_operand:CC 3 "cc_reg_operand" "=x,?y")
	(compare:CC
	 (plus:DI (gt:DI (match_operand:DI 1 "gpc_reg_operand" "r,r")
			 (const_int 0))
...

;; Setcc operations done via branch conditional + 8.
(define_insn_and_split "*setcc_bcp8<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(match_operator:GPR 1 "branch_comparison_operator"
			    [(match_operand 2 "cc_reg_operand" "y")
			     (const_int 0)]))]
  "TARGET_SETCC_BCP8"
  "#"
...
;; Combiner pattern for negating the result of a bcp8 operation
(define_insn_and_split "setcc_neg_bcp8<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(neg:GPR
	 (match_operator:GPR 1 "branch_comparison_operator"
			     [(match_operand 2 "cc_reg_operand" "y")
...
(define_insn_and_split "setcc_neg_bcp8disi"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=r")
	(sign_extend:DI
	 (neg:SI
	  (match_operator:SI 1 "branch_comparison_operator"
			     [(match_operand 2 "cc_reg_operand" "y")
			      (const_int 0)]))))]
  "TARGET_SETCC_BCP8"
  "#"
...
;; Combiner pattern for adding the result of a setcc bcp8 operation
(define_insn_and_split "*setcc_plus_bcp8<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r,&r")
	(plus:GPR
	 (match_operator:GPR 1 "branch_comparison_operator"
			     [(match_operand 2 "cc_reg_operand" "y,y")
			      (const_int 0)])
	 (match_operand:GPR 3 "gpc_reg_operand" "0,r")))]
  "TARGET_SETCC_BCP8 && TARGET_BCP8_COND_EXEC"
  "#"
  "TARGET_SETCC_BCP8 && TARGET_BCP8_COND_EXEC"
  [(cond_exec
...
;; Setcc operations for using ISEL
(define_expand "setcc_isel<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(match_operator:GPR 1 "scc_comparison_operator"
			    [(match_operand 2 "cc_reg_operand" "y")
			     (const_int 0)]))]
  "TARGET_SETCC_ISEL && can_create_pseudo_p ()"
  "")

(define_insn_and_split "*setcc_isel_normal<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(match_operator:GPR 1 "scc_comparison_operator"
			    [(match_operand 2 "cc_reg_operand" "y")
			     (const_int 0)]))]
  ...
  [(parallel [(set (match_dup 0)
		   (if_then_else:GPR (match_dup 1)
				     (match_dup 3)
				     (match_dup 4)))
	      (use (const_int ISEL_SETCC))])]
  "
{
  operands[3] = force_reg (<MODE>mode, const1_rtx);
  operands[4] = force_reg (<MODE>mode, const0_rtx);
}"
  [(set_attr "type" "isel")
   (set_attr "isel_type" "isel")
   (set_attr "length" "8")])

(define_insn_and_split "*setcc_isel_reverse<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
...
;; Combiner pattern for negative of setcc operations if ISEL is used
(define_insn_and_split "*setcc_neg_isel<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=&b")
	(neg:GPR
	 (match_operator:GPR 1 "scc_comparison_operator"
			     [(match_operand 2 "cc_reg_operand" "y")
  ...
  "
{
  operands[3] = force_reg (<MODE>mode, constm1_rtx);
  operands[4] = force_reg (<MODE>mode, const0_rtx);
}"
  [(set_attr "type" "isel")
   (set_attr "isel_type" "isel")
...
(define_insn_and_split "*setcc_neg_iseldisi"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=&b")
	(sign_extend:DI
	 (neg:SI
	  (match_operator:SI 1 "scc_comparison_operator"
  ...
  "TARGET_POWERPC64 && TARGET_SETCC_ISEL && can_create_pseudo_p ()"
  "#"
  "TARGET_POWERPC64 && TARGET_SETCC_ISEL && can_create_pseudo_p ()"
  [(parallel [(set (match_dup 0)
		   (if_then_else:DI (match_dup 1)
  ...
  "
{
  operands[3] = force_reg (DImode, constm1_rtx);
  operands[4] = force_reg (DImode, const0_rtx);
}"
  [(set_attr "type" "isel")
   (set_attr "isel_type" "isel")
   (set_attr "length" "12")])

(define_insn_and_split "*setcc_neg_isel_rev<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=&b")
	(neg:GPR
	 (match_operator:GPR 1 "scc_rev_comparison_operator"
			     [(match_operand 2 "cc_reg_operand" "y")
...
(define_insn_and_split "*setcc_neg_isel_revdisi"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=&b")
	(sign_extend:DI
	 (neg:SI
	  (match_operator:SI 1 "scc_rev_comparison_operator"
			     [(match_operand 2 "cc_reg_operand" "y")
			      (const_int 0)]))))]
  "TARGET_POWERPC64 && TARGET_SETCC_ISEL && can_create_pseudo_p ()"
  "#"
...
(define_insn_and_split "*setcc_plus_isel<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(plus:GPR
	 (match_operator:GPR 1 "branch_comparison_operator"
			     [(match_operand 2 "cc_reg_operand" "y")
...
(define_insn ""
  ...
  "*
{
  return output_cbranch (operands[1], \"%l0\", 0, insn, 1);
}"
  [(set_attr "type" "branch")])
...
(define_insn ""
  ...
  "*
{
  return output_cbranch (operands[0], NULL, 0, insn, 1);
}"
  [(set_attr "type" "jmpreg")
   (set_attr "length" "4")])
...
(define_insn ""
  ...
  "*
{
  return output_cbranch (operands[1], \"%l0\", 1, insn, 1);
}"
  [(set_attr "type" "branch")])
...
(define_insn ""
  ...
  "*
{
  return output_cbranch (operands[0], NULL, 1, insn, 1);
}"
  [(set_attr "type" "jmpreg")
   (set_attr "length" "4")])
