  ...
  if (TARGET_IABS_ISEL)		/* use ISEL instruction.  */
    {
      ...
      emit_insn (gen_isel_<mode> (op0, lt, tmp1, op1, cc, GEN_INT (ISEL_IABS)));
      DONE;
    }
  else if (TARGET_IABS_BCP8)	/* Use branch conditional + 8.  */
    {
      ...
      emit_insn (gen_neg<mode>2 (tmp1, op1));
      emit_insn (gen_rtx_SET (VOIDmode, cc, cmp));
      emit_insn (gen_bcp8_<mode> (op0, lt, cc, tmp1, op1));
      DONE;
    }
  ...
  if (TARGET_IABS_ISEL)		/* use ISEL instruction.  */
    {
      ...
      emit_insn (gen_neg<mode>2 (tmp1, op1));
      emit_insn (gen_rtx_SET (VOIDmode, cc, cmp));
      emit_insn (gen_isel_<mode> (op0, lt, op1, tmp1, cc, GEN_INT (ISEL_IABS)));
      DONE;
    }
  else if (TARGET_IABS_BCP8)	/* Use branch conditional + 8.  */
    {
      ...
      emit_insn (gen_neg<mode>2 (tmp1, op1));
      emit_insn (gen_rtx_SET (VOIDmode, cc, cmp));
      emit_insn (gen_bcp8_<mode> (op0, lt, cc, op1, tmp1));
      DONE;
    }
  else if (TARGET_IABS_SHIFT)	/* Use shift/xor/subtract.  */
    {
...
(define_insn "*isel_reversed_<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r,r")
	(if_then_else:GPR
...
(define_expand "cstore<mode>4"
  ...
  "TARGET_SETCC || TARGET_SETCC_EQ"
  "
{
  if (TARGET_SETCC_EQ && !TARGET_SETCC && GET_CODE (operands[1]) != EQ)
    FAIL;
  ...
  if (TARGET_SETCC_MFCR)
	  ...
	  && INTVAL (operands[3]) < 0)
	{
      ...
      /* For SNE, we would prefer that the xor/abs sequence be used for
	 integers. For SEQ, likewise, except that comparisons with zero should
	 be done with an scc insns.  However, due to the order that combine see
	 the resulting insns, we must, in fact, allow SEQ for integers.  Fail in
...
(define_insn_and_split "*cmp<ICR:mode>_and_add<GPR:mode>"
  [(set (match_operand:ICR 3 "cc_reg_operand" "=y")
	(compare:ICR (match_operand:GPR 1 "gpc_reg_operand" "r")
		     (match_operand:GPR 2 "short_cint_operand" "i")))
   (set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(plus:GPR (match_dup 1)
		  (match_operand:GPR 4 "short_cint_operand" "i")))]
  ""
  "#"
  ""
  [(set (match_dup 3) (compare:ICR (match_dup 1) (match_dup 2)))
   (set (match_dup 0) (plus:GPR (match_dup 1) (match_dup 4)))]
  ""
  [(set_attr "length" "8")])
...
(define_insn ""
  ...
  "TARGET_SETCC_MFCR && TARGET_32BIT"
  "@
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_cr0_operand" "")
   ...
   (set (match_operand:SI 3 "gpc_reg_operand" "")
	(match_op_dup 1 [(match_dup 2) (const_int 0)]))]
  "TARGET_SETCC_MFCR && TARGET_32BIT && reload_completed"
  [(set (match_dup 3)
	(match_op_dup 1 [(match_dup 2) (const_int 0)]))
   (set (match_dup 0)
	(compare:CC (match_dup 3)
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_micro_cr0_operand" "")
   ...
   (set (match_operand:SI 4 "gpc_reg_operand" "")
	(ashift:SI (match_op_dup 1 [(match_dup 2) (const_int 0)])
		   (match_dup 3)))]
  "TARGET_SETCC_MFCR && reload_completed"
  [(set (match_dup 4)
	(ashift:SI (match_op_dup 1 [(match_dup 2) (const_int 0)])
		   (match_dup 3)))
   (set (match_dup 0)
   ...
   (set (match_operand:SI 3 "gpc_reg_operand" "=r")
	(match_operator:SI 4 "scc_comparison_operator"
			   [(match_operand 5 "cc_reg_operand" "y")
			    (const_int 0)]))]
  "TARGET_SETCC_MFCR && REGNO (operands[2]) != REGNO (operands[5])"
  ...
  [(set (match_operand:DI 0 "gpc_reg_operand" "=r")
   ...
   (set (match_operand:DI 3 "gpc_reg_operand" "=r")
	(match_operator:DI 4 "scc_comparison_operator"
			   [(match_operand 5 "cc_reg_operand" "y")
			    (const_int 0)]))]
  "TARGET_SETCC_MFCR && TARGET_POWERPC64
...
(define_insn_and_split "setcc_eq<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(eq:GPR (match_operand:GPR 1 "gpc_reg_operand" "r")
		(match_operand:GPR 2 "scc_eq_operand" "<scc_eq_op2>")))]
  "!TARGET_POWER && TARGET_SETCC_EQ"
  "#"
  "!TARGET_POWER && TARGET_SETCC_EQ"
  [(set (match_dup 0)
	(clz:GPR (match_dup 3)))
...
(define_insn_and_split "*eq<mode>_compare"
  ...
  "!TARGET_POWER && optimize_size && TARGET_SETCC_EQ"
  "#"
  "!TARGET_POWER && optimize_size && TARGET_SETCC_EQ"
  [(set (match_dup 0)
	(clz:P (match_dup 4)))
...
(define_split
  ...
  "! gpc_reg_operand (operands[2], SImode) && TARGET_SETCC_EQ"
  [(set (match_dup 5) (match_dup 2))
...
(define_insn "*compare_plus_eqsi"
  ...
  "TARGET_32BIT && optimize_size && TARGET_SETCC_EQ"
  "@
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_cr0_operand" "")
	(compare:CC
	 ...
	 (const_int 0)))
   (clobber (match_scratch:SI 4 ""))]
  "TARGET_32BIT && optimize_size && reload_completed && TARGET_SETCC_EQ"
  [(set (match_dup 4)
...
(define_insn "*ne0si"
  ...
  "! TARGET_POWER && TARGET_32BIT && TARGET_SETCC_EQ"
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_cr0_operand" "")
   ...
   (clobber (match_scratch:SI 3 ""))
   (clobber (match_scratch:SI 4 ""))]
  "TARGET_32BIT && reload_completed && TARGET_SETCC_EQ"
  [(parallel [(set (match_dup 3)
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_micro_cr0_operand" "")
	(compare:CC
	 ...
	 (const_int 0)))
   (clobber (match_scratch:DI 3 ""))]
  "TARGET_64BIT && reload_completed && TARGET_SETCC_EQ"
  [(set (match_dup 3)
...
;; Setcc operations done via branch conditional + 8.  We define the DI varients
;; so that combine will eliminate the sign_extend on 64-bit systems.
...
(define_insn_and_split "setcc_neg_bcp8<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(neg:GPR (match_operator:GPR 1 "branch_comparison_operator"
				     [(match_operand 2 "cc_reg_operand" "y")
				      (const_int 0)])))]
  "TARGET_SETCC_BCP8"
  "#"
...
;; Combiner pattern for adding the result of a bcp8 operation
(define_insn_and_split "*setcc_add_bcp8<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r,&r")
	(plus:GPR (match_operator:GPR 1 "branch_comparison_operator"
				      [(match_operand 2 "cc_reg_operand" "y,y")
				       (const_int 0)])
...
;; Setcc operations done via ISEL.  We define the DI varients so that combine
;; will eliminate the sign_extend on 64-bit systems.
(define_insn_and_split "setcc_isel<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(match_operator:GPR 1 "scc_comparison_operator"
			    [(match_operand 2 "cc_reg_operand" "y")
			     (const_int 0)]))
   (clobber (match_scratch:GPR 3 "=&b"))]
...
(define_insn_and_split "setcc_isel_rev<mode>"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
