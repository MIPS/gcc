  ...
  "
{
  ...
  /* Take care of the possibility that operands[3] might be negative but this
     might be a logical operation.  That insn doesn't exist.  */

  if (GET_CODE (operands[3]) == CONST_INT && INTVAL (operands[3]) < 0
      && (cond_code == GTU || cond_code == GEU || cond_code == LTU
	  || cond_code == LEU))
    {
      operands[3] = force_reg (<MODE>mode, operands[3]);
      operands[1] = gen_rtx_fmt_ee (cond_code, GET_MODE (operands[1]),
...
(define_expand "cstore<mode>4"
  [(use (match_operator 1 "rs6000_cbranch_operator"
   ...
   (clobber (match_operand:SI 0 "register_operand"))]
  "TARGET_SETCC_MFCR || TARGET_SETCC_BCP8"
  "
{
  rs6000_emit_sCOND (<MODE>mode, operands);
  DONE;
...
(define_insn_and_split "setcc_eq<mode>"
  ...
  "!TARGET_POWER && TARGET_SETCC && TARGET_EQ_NE"
  "#"
  "!TARGET_POWER && TARGET_SETCC && TARGET_EQ_NE"
  [(set (match_dup 0)
	(clz:GPR (match_dup 3)))
...
(define_insn_and_split "*eq<mode>_compare"
  ...
  "!TARGET_POWER && optimize_size && TARGET_SETCC && TARGET_EQ_NE"
  "#"
  "!TARGET_POWER && optimize_size && TARGET_SETCC && TARGET_EQ_NE"
  [(set (match_dup 0)
	(clz:P (match_dup 4)))
...
(define_split
  ...
  "! gpc_reg_operand (operands[2], SImode) && TARGET_SETCC && TARGET_EQ_NE"
  [(set (match_dup 5) (match_dup 2))
...
(define_insn "*plus_eqsi"
  ...
  "TARGET_32BIT && TARGET_SETCC && TARGET_EQ_NE"
  "@
...
(define_insn "*compare_plus_eqsi"
  ...
  "TARGET_32BIT && optimize_size && TARGET_SETCC && TARGET_EQ_NE"
  "@
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_cr0_operand" "")
	(compare:CC
	 ...
	 (const_int 0)))
   (clobber (match_scratch:SI 4 ""))]
  "TARGET_32BIT && optimize_size && reload_completed && TARGET_SETCC
   && TARGET_EQ_NE"
  [(set (match_dup 4)
...
(define_insn "*ne0si"
  ...
  "! TARGET_POWER && TARGET_32BIT && TARGET_SETCC && TARGET_EQ_NE"
...
(define_insn "*ne0di"
  ...
  "TARGET_64BIT && TARGET_SETCC && TARGET_EQ_NE"
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_cr0_operand" "")
   ...
   (clobber (match_scratch:SI 3 ""))
   (clobber (match_scratch:SI 4 ""))]
  "TARGET_32BIT && reload_completed && TARGET_SETCC && TARGET_EQ_NE"
  [(parallel [(set (match_dup 3)
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_micro_cr0_operand" "")
	(compare:CC
	 ...
	 (const_int 0)))
   (clobber (match_scratch:DI 3 ""))]
  "TARGET_64BIT && reload_completed && TARGET_SETCC && TARGET_EQ_NE"
  [(set (match_dup 3)
