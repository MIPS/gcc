...
(define_constants
  [(STACK_POINTER_REGNUM	1)
   ...
   ; really an isel, but it looks like one at the RTL level.
   (ISEL_GENERAL		0)
   (ISEL_BCP8			1)
   (ISEL_IABS			2)
   (ISEL_IMINMAX		3)
...
(define_expand "cstore<mode>4"
  ...
  "
{
  if (TARGET_SETCC_EQ_ONLY && GET_CODE (operands[1]) != EQ)
    FAIL;
...
(define_insn "*ne0si"
  ...
  "! TARGET_POWER && TARGET_32BIT && !TARGET_SETCC_ISEL && TARGET_SETCC_EQ"
