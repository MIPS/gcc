  ...
  "
{
  ...
  /* Special case 0 which can be loaded by ISEL, but we need to swap the sense
     of the test.  */
  ...
  if (TARGET_IMINMAX_ISEL)
     emit_insn (gen_isel_<mode> (op0, cond, op1, op2, cc,
  ...
  "
{
  ...
  /* Use ISEL or branch cond.+8.  */
  cc = gen_reg_rtx (CCUNSmode);
  op2 = force_reg (<MODE>mode, op2);
  cmp = gen_rtx_COMPARE (CCUNSmode, op1, op2);
  cond = gen_rtx_LTU (VOIDmode, cc, const0_rtx);
  ...
  "
{
  ...
  op2 = force_reg (<MODE>mode, op2);
  cmp = gen_rtx_COMPARE (CCUNSmode, op1, op2);
  cond = gen_rtx_GTU (VOIDmode, cc, const0_rtx);
