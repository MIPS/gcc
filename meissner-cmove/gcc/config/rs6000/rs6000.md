...
(define_insn_and_split "smin<mode>3"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(smin:GPR (match_operand:GPR 1 "reg_or_short_operand" "%r")
  ...
  "
{
  if (!rs6000_expand_int_minmax (operands[0], SMIN, operands[1], operands[2]))
    FAIL;
  DONE;
}")
...
(define_insn_and_split "smax<mode>3"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(smax:GPR (match_operand:GPR 1 "reg_or_short_operand" "%r")
		  (match_operand:GPR 2 "reg_or_short_operand" "rI")))]
  "TARGET_INT_MINMAX"
  "#"
  ""
  ...
  "
{
  if (!rs6000_expand_int_minmax (operands[0], SMAX, operands[1], operands[2]))
    FAIL;
  DONE;
}")
...
(define_insn_and_split "umin<mode>3"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(umin:GPR (match_operand:GPR 1 "reg_or_short_operand" "%r")
		  (match_operand:GPR 2 "reg_or_short_operand" "rI")))]
  "TARGET_INT_MINMAX"
  "#"
  ""
  ...
  "
{
  if (!rs6000_expand_int_minmax (operands[0], UMIN, operands[1], operands[2]))
    FAIL;
  DONE;
}")
...
(define_insn_and_split "umax<mode>3"
  [(set (match_operand:GPR 0 "gpc_reg_operand" "=r")
	(umax:GPR (match_operand:GPR 1 "reg_or_short_operand" "%r")
		  (match_operand:GPR 2 "reg_or_short_operand" "rI")))]
  "TARGET_INT_MINMAX"
  "#"
  ""
  ...
  "
{
  if (!rs6000_expand_int_minmax (operands[0], UMAX, operands[1], operands[2]))
    FAIL;
  DONE;
}")
...
(define_insn "*bcp8<mode>"
  ...
  "*
{
  output_asm_insn (output_cbranch (operands[1], \"1f\", 0, insn, false),
		   operands);
...
(define_insn "*bcp8_cond_exec_bool<mode>"
  ...
  "*
{
  output_asm_insn (output_cbranch (operands[0], \"2f\", 1, insn, false),
		   operands);
...
{
  const char *insn_str;
  output_asm_insn (output_cbranch (operands[0], \"3f\", 1, insn, false),
		   operands);
  if (GET_CODE (operands[4]) != CONST_INT)
