...
(define_insn "*smax<mode>3_vsx"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<Ff>,<Fv>")
	(smax:SFDF (match_operand:SFDF 1 "gpc_reg_operand" "%<Ff>,<Fv>")
		   (match_operand:SFDF 2 "gpc_reg_operand" "<Ff>,<Fv>")))]
  "TARGET_<MODE>_FPR && TARGET_VSX && !TARGET_P9_MINMAX"
  "xsmaxdp %x0,%x1,%x2"
  [(set_attr "type" "fp")])

(define_insn "*smax<mode>3_p9"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<Fv>")
	(smax:SFDF (match_operand:SFDF 1 "gpc_reg_operand" "%<Fv>")
...
(define_expand "smin<mode>3"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "")
	(smin:SFDF (match_operand:SFDF 1 "gpc_reg_operand" "")
		   (match_operand:SFDF 2 "gpc_reg_operand" "")))]
  "TARGET_MINMAX_<MODE>"
{
...
(define_insn "*smin<mode>3_p9"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<Fv>")
	(smin:SFDF (match_operand:SFDF 1 "gpc_reg_operand" "%<Fv>")
		   (match_operand:SFDF 2 "gpc_reg_operand" "<Fv>")))]
  "TARGET_P9_MINMAX"
  "xsmincdp %x0,%x1,%x2"
  [(set_attr "type" "fp")])
