  ...
  "
{
  ...
  if (<E500_CONVERT>)
    emit_insn (gen_spe_fix_trunc<mode>si2 (operands[0], operands[1]));
  ...
  "
{
  ...
  if (<E500_CONVERT>)
    emit_insn (gen_spe_fixuns_trunc<mode>si2 (operands[0], operands[1]));
  else
    {
      tmp = gen_reg_rtx (DImode);
      stack = rs6000_allocate_stack_temp (SImode, false, true);
...
(define_expand "floatsisf2"
  ...
  "TARGET_HARD_FLOAT && TARGET_SINGLE_FLOAT
   && (!TARGET_FPRS
       || (TARGET_FPRS && TARGET_DOUBLE_FLOAT && TARGET_FCFID))"
  "
{
  ...
  if (TARGET_FPRS && TARGET_DOUBLE_FLOAT)
    {
      rtx dreg = gen_reg_rtx (DFmode);
      emit_insn (gen_floatsidf2 (dreg, operands[1]));
      emit_insn (gen_truncdfsf2 (operands[0], dreg));
      DONE;
    }
}")
