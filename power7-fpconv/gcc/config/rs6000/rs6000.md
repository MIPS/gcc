...
; Instead of creating a new cpu type for fpload followed by fp, just use
; fpload for now
(define_insn_and_split "floatsi<mode>2_lfiwax"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=d,d,?<rreg2>,?<rreg2>")
	(float:SFDF (match_operand:SI 1 "nonimmediate_operand" "Z,r,Z,r")))
   (clobber (match_operand:SI 2 "indexed_or_indirect_operand" "=Z,Z,Z,Z"))
   (clobber (match_operand:DI 3 "gpc_reg_operand" "=0,0,d,d"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT && TARGET_LFIWAX
   && <SI_CONVERT_FP>"
  "#"
...
(define_insn_and_split "floatunssi<mode>2_lfiwzx"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=d,d,?<rreg2>,?<rreg2>")
	(unsigned_float:SFDF (match_operand:SI 1 "gpc_reg_operand" "Z,r,Z,r")))
   (clobber (match_operand:SI 2 "indexed_or_indirect_operand" "=Z,Z,Z,Z"))
   (clobber (match_operand:DI 3 "gpc_reg_operand" "=0,0,d,d"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT && TARGET_LFIWZX
   && <SI_CONVERT_FP>"
...
(define_insn_and_split "fix_trunc<mode>si2_stfiwx"
  [(set (match_operand:SI 0 "gpc_reg_operand" "=r,?r")
	(fix:SI (match_operand:SFDF 1 "gpc_reg_operand" "d,<rreg2>")))
...
; Instead of creating a new cpu type for fp operation followed by store, just
; use fp for now.
(define_insn_and_split "*fix_trunc<mode>si2_mem"
  [(set (match_operand:SI 0 "memory_operand" "=Z,?Z")
	(fix:SI (match_operand:SFDF 1 "gpc_reg_operand" "d,<rreg2>")))
   (clobber (match_scratch:DI 2 "=1,d"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT
   && (<MODE>mode != SFmode || TARGET_SINGLE_FLOAT)
   && TARGET_STFIWX"
  "#"
...
(define_insn_and_split "fixuns_trunc<mode>si2_stfiwx"
  [(set (match_operand:SI 0 "gpc_reg_operand" "=r,?r")
	(unsigned_fix:SI
	 (match_operand:SFDF 1 "gpc_reg_operand" "d,<rreg2>")))
   (clobber (match_operand:DI 2 "gpc_reg_operand" "=1,d"))
   (clobber (match_operand:SI 3 "indexed_or_indirect_operand" "=Z,Z"))]
...
(define_insn_and_split "*fixuns_trunc<mode>si2_mem"
  [(set (match_operand:SI 0 "memory_operand" "=Z,?Z")
	(unsigned_fix:SI (match_operand:SFDF 1 "gpc_reg_operand" "d,<rreg2>")))
   (clobber (match_scratch:DI 2 "=1,d"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && <TARGET_FLOAT> && TARGET_FCTIWUZ
   && TARGET_STFIWX"
  "#"
...
(define_insn "*movdi_mfpgpr"
  [(set (match_operand:DI 0 "nonimmediate_operand" "=r,r,m,r,r,r,r,*d,*d,m,r,*h,*h,r,*d,ws")
	(match_operand:DI 1 "input_operand" "r,m,r,I,L,nF,R,d,m,d,*h,r,0,*d,r,O"))]
  "TARGET_POWERPC64 && TARGET_MFPGPR && TARGET_HARD_FLOAT && TARGET_FPRS
   && (gpc_reg_operand (operands[0], DImode)
       || gpc_reg_operand (operands[1], DImode))"
  "@
   ...
   mffgpr %0,%1
   xxlxor %x0,%x0,%x0"
  [(set_attr "type" "*,load,store,*,*,*,*,fp,fpload,fpstore,mfjmpr,mtjmpr,*,mftgpr,mffgpr,vecsimple")
   (set_attr "length" "4,4,4,4,4,20,4,4,4,4,4,4,4,4,4,4")])

(define_insn "*movdi_internal64"
  [(set (match_operand:DI 0 "nonimmediate_operand" "=r,r,m,r,r,r,r,*d,*d,m,r,*h,*h,ws")
