...
(define_insn "*fnmsubsf4_powerpc"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f")
	(minus:SF
	 (mult:SF (neg:SF (match_operand:SF 1 "gpc_reg_operand" "%f"))
		  (match_operand:SF 2 "gpc_reg_operand" "f"))
	 (match_operand:SF 3 "gpc_reg_operand" "f")))]
  "TARGET_POWERPC && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FUSED_MADD
   && TARGET_SINGLE_FLOAT && HONOR_SIGNED_ZEROS (SFmode)"
...
;; These aren't canonical, but the reciprocal divide and sqrt generate them
(define_insn "*fnsubsf4_powerpc2"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f")
...
(define_insn "*fnmsubdf4_fpr"
  [(set (match_operand:DF 0 "gpc_reg_operand" "=f")
	(minus:DF
	 (mult:DF (neg:DF (match_operand:DF 1 "gpc_reg_operand" "%f"))
		  (match_operand:DF 2 "gpc_reg_operand" "f"))
	 (match_operand:DF 3 "gpc_reg_operand" "f")))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FUSED_MADD && TARGET_DOUBLE_FLOAT
   && HONOR_SIGNED_ZEROS (DFmode)
...
(define_insn "*movdf_hardfloat32"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=!r, ??r, m, ws, ?wa, ws, ?wa,  Z, ?Z, f, f, m, !r, !r, !r")
	(match_operand:DF 1 "input_operand"          "r,   m, r, ws,  wa,  Z,   Z, ws, wa, f, m, f,  G,  H,  F"))]
  "! TARGET_POWERPC64 && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT 
  ...
  "*
{
  ...
  [(set_attr "type" "two, load, store, fp, fp, fpload, fpload, fpstore, fpstore, fp, fpload, fpstore, *,  *,  *")
   (set_attr "length" "8,   16,    16,  4,  4,      4,      4,       4,       4,  4,      4,       4, 8, 12, 16")])
...
(define_insn "*movdf_hardfloat64_mfpgpr"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=Y, r, !r, ws, ?wa, ws, ?wa,  Z, ?Z, f, f, m, *c*l, !r, *h, !r, !r, !r, r, f")
	(match_operand:DF 1 "input_operand"         "r, Y,  r, ws, ?wa,  Z,   Z, ws, wa, f, m, f,    r,  h,  0,  G,  H,  F, f, r"))]
  "TARGET_POWERPC64 && TARGET_MFPGPR && TARGET_HARD_FLOAT && TARGET_FPRS 
   && TARGET_DOUBLE_FLOAT
   && (gpc_reg_operand (operands[0], DFmode)
       || gpc_reg_operand (operands[1], DFmode))"
  "@
   ...
   mftgpr %0,%1
   mffgpr %0,%1"
  [(set_attr "type" "store, load, *, fp, fp, fpload, fpload, fpstore, fpstore, fp, fpload, fpstore, mtjmpr, mfjmpr, *, *,  *,  *, mftgpr, mffgpr")
   (set_attr "length"   "4,    4, 4,  4,  4,      4,      4,       4,       4,  4,      4,       4,      4,      4, 4, 8, 12, 16,      4,      4")])

; ld/std require word-aligned displacements -> 'Y' constraint.
; List Y->r and r->Y before r->r for reload.
(define_insn "*movdf_hardfloat64"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=Y, r, !r, ws, ?wa, ws, ?wa,  Z, ?Z, f, f, m, *c*l, !r, *h, !r, !r, !r")
	(match_operand:DF 1 "input_operand"         "r, Y,  r, ws,  wa,  Z,   Z, ws, wa, f, m, f,    r,  h,  0,  G,  H,  F"))]
  "TARGET_POWERPC64 && !TARGET_MFPGPR && TARGET_HARD_FLOAT && TARGET_FPRS 
   && TARGET_DOUBLE_FLOAT
   && (gpc_reg_operand (operands[0], DFmode)
       || gpc_reg_operand (operands[1], DFmode))"
  "@
   ...
   #
   #"
  [(set_attr "type" "store, load, *, fp, fp, fpload, fpload, fpstore, fpstore, fp, fpload, fpstore, mtjmpr, mfjmpr,  *,  *,  *, *")
   (set_attr "length" "  4,    4, 4,  4,  4,      4,      4,       4,       4,  4,      4,       4,      4,      4,  4,  8, 12, 16")])
