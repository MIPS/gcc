...
;; Optimize (float)(int)x type operations when x is a SF type to not store the
...
(define_insn_and_split "*float<mode>_fixsisf2"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg2>")
	(float:SFDF (fix:SI (match_operand:SF 1 "gpc_reg_operand" "f"))))
   (clobber (match_scratch:DI 2 "=d"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT
...
(define_insn_and_split "*float<mode>_fixdisf2"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg2>")
	(float:SFDF (fix:DI (match_operand:SF 1 "gpc_reg_operand" "f"))))
   (clobber (match_scratch:DI 2 "=d"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT
   && TARGET_SINGLE_FLOAT && <SI_CONVERT_FP>"
  "#"
...
(define_insn_and_split "*float<mode>_fixsidf2"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg2>")
	(float:SFDF (fix:SI (match_operand:DF 1 "gpc_reg_operand" "d"))))
   (clobber (match_scratch:DI 2 "=d"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT
   && TARGET_SINGLE_FLOAT && <SI_CONVERT_FP>"
  "#"
