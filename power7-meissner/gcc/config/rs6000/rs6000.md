...
(define_insn "lfiwax"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=d")
	(unspec:DI [(match_operand:SI 1 "memory_operand" "Z")] UNSPEC_LFIWAX))]
...
(define_insn_and_split "floatsi<mode>2_lfiwax"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg>,<rreg>")
   ...
   (clobber (match_operand:SI 3 "memory_operand" "=Z,Z"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT && TARGET_LFIWAX
   && <SI_CONVERT_FP>"
  "#"
  "&& 1"
...
(define_insn_and_split "floatsi<mode>2_lfiwax_ext"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg2>")
	(float:SFDF
	 (sign_extend:DI
  ...
  "#"
  "&& reload_completed"
  [(set (match_dup 2) (unspec:DI [(match_dup 1)] UNSPEC_LFIWAX))
...
(define_insn "lfiwzx"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=d")
	(unspec:DI [(match_operand:SI 1 "memory_operand" "Z")] UNSPEC_LFIWZX))]
...
(define_insn_and_split "floatunssi<mode>2_lfiwzx_ext"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg2>")
	(unsigned_float:SFDF
	 (zero_extend:DI
	  (match_operand:SI 1 "memory_operand" "Z"))))
  ...
  "#"
  "&& reload_completed"
  [(set (match_dup 2) (unspec:DI [(match_dup 1)] UNSPEC_LFIWZX))
   (set (match_dup 0) (float:<MODE> (match_dup 2)))]
  ""
  [(set_attr "length" "8")])
  ...
  if (TARGET_STFIWX)
    {
      ...
      emit_insn (gen_fix_truncdfsi2_stfiwx (operands[0], operands[1], reg,
					    stack));
      DONE;
    }
