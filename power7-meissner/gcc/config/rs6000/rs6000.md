...
(define_mode_attr SIGN_SI_CVT_FP [(SF "TARGET_FCFIDS && TARGET_LFIWAX")
				  (DF "TARGET_FCFID  && TARGET_LFIWAX")])

(define_mode_attr UNS_SI_CVT_FP [(SF "TARGET_FCFIDS && TARGET_LFIWAX")
				 (DF "TARGET_FCFID  && TARGET_LFIWAX")])
...
(define_insn_and_split "floatsi<mode>2_lfiwax"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg>")
	(float:SFDF (sign_extend:DI (match_operand:SI 1 "memory_operand" "Z"))))
   (clobber (match_operand:DI 2 "gpc_reg_operand" "=<rreg2>"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT && <SIGN_SI_CVT_FP>"
  "#"
  "&& 1"
  [(set (match_dup 2)
	(unspec:DI [(match_dup 1)] UNSPEC_LFIWAX))
   (set (match_dup 0)
...
(define_insn_and_split "floatunssi<mode>2_lfiwzx"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg>")
	(float:SFDF (zero_extend:DI (match_operand:SI 1 "memory_operand" "Z"))))
   (clobber (match_operand:DI 2 "gpc_reg_operand" "=<rreg2>"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT && <UNS_SI_CVT_FP>"
  "#"
  "&& 1"
  [(set (match_dup 2)
	(unspec:DI [(match_dup 1)] UNSPEC_LFIWZX))
   (set (match_dup 0)
	(float:<MODE> (match_dup 2)))]
  ""
  [(set_attr "length" "8")])
