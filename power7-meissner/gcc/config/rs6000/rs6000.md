...
(define_insn ""
  ...
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_FUSED_MADD && TARGET_DOUBLE_FLOAT
   && rs6000_vector_info[DFmode].arith == VECTOR_NONE"
  "{fma|fmadd} %0,%1,%2,%3"
  [(set_attr "type" "dmul")
...
(define_insn "*movdf_hardfloat32"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=!r,??r,m,f,f,m,!r,!r,!r,wa,wa,Z")
	(match_operand:DF 1 "input_operand" "r,m,r,f,m,f,G,H,F,wa,Z,wa"))]
  "! TARGET_POWERPC64 && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT 
  ...
  "*
{
  ...
  [(set_attr "type" "two,load,store,fp,fpload,fpstore,*,*,*,vecsimple,fpload,fpstore")
   (set_attr "length" "8,16,16,4,4,4,8,12,16,4,4,4")])
...
(define_insn "*movdf_hardfloat64_mfpgpr"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=Y,r,!r,f,f,m,*c*l,!r,*h,!r,!r,!r,r,f,ws,ws,Z")
	(match_operand:DF 1 "input_operand" "r,Y,r,f,m,f,r,h,0,G,H,F,f,r,ws,Z,ws"))]
  "TARGET_POWERPC64 && TARGET_MFPGPR && TARGET_HARD_FLOAT && TARGET_FPRS 
   && TARGET_DOUBLE_FLOAT
   && (gpc_reg_operand (operands[0], DFmode)
       || gpc_reg_operand (operands[1], DFmode))"
  "@
   ...
   lxsd%U1x %x0,%y1
   stxsd%U0x %x1,%y0"
  [(set_attr "type" "store,load,*,fp,fpload,fpstore,mtjmpr,mfjmpr,*,*,*,*,mftgpr,mffgpr,vecsimple,fpload,fpstore")
   (set_attr "length" "4,4,4,4,4,4,4,4,4,8,12,16,4,4,4,4,4")])

; ld/std require word-aligned displacements -> 'Y' constraint.
; List Y->r and r->Y before r->r for reload.
(define_insn "*movdf_hardfloat64"
  [(set (match_operand:DF 0 "nonimmediate_operand" "=Y,r,!r,f,f,m,*c*l,!r,*h,!r,!r,!r,ws,ws,Z")
	(match_operand:DF 1 "input_operand" "r,Y,r,f,m,f,r,h,0,G,H,F,ws,Z,ws"))]
  "TARGET_POWERPC64 && !TARGET_MFPGPR && TARGET_HARD_FLOAT && TARGET_FPRS 
   && TARGET_DOUBLE_FLOAT
   && (gpc_reg_operand (operands[0], DFmode)
       || gpc_reg_operand (operands[1], DFmode))"
  "@
   ...
   lxsd%U1x %x0,%y1
   stxsd%U0x %x1,%y0"
  [(set_attr "type" "store,load,*,fp,fpload,fpstore,mtjmpr,mfjmpr,*,*,*,*,vecsimple,fpload,fpstore")
   (set_attr "length" "4,4,4,4,4,4,4,4,4,8,12,16,4,4,4")])
