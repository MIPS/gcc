...
(define_insn ""
  [(set (match_operand:DI 0 "gpc_reg_operand" "=r")
	(match_operator:DI 1 "scc_comparison_operator"
			   [(match_operand 2 "cc_reg_operand" "y")
			    (const_int 0)]))]
  "TARGET_POWERPC64 && (!TARGET_ISEL || !TARGET_ISEL_HACK)"
  "mfcr %0%Q2\;{rlinm|rlwinm} %0,%0,%J1,1"
  [(set (attr "type")
     (cond [(ne (symbol_ref "TARGET_MFCRF") (const_int 0))
		(const_string "mfcrf")
...
(define_insn ""
  ...
  "TARGET_32BIT && (!TARGET_ISEL || !TARGET_ISEL_HACK)"
  "@
...
(define_split
  [(set (match_operand:CC 0 "cc_reg_not_cr0_operand" "")
   ...
   (set (match_operand:SI 3 "gpc_reg_operand" "")
	(match_op_dup 1 [(match_dup 2) (const_int 0)]))]
  "TARGET_32BIT && reload_completed && (!TARGET_ISEL || !TARGET_ISEL_HACK)"
  [(set (match_dup 3)
	(match_op_dup 1 [(match_dup 2) (const_int 0)]))
   (set (match_dup 0)
	(compare:CC (match_dup 3)
...
(define_insn_and_split "*eq<mode>"
  ...
  "!TARGET_POWER && (!TARGET_ISEL || !TARGET_ISEL_HACK)"
  "#"
  "!TARGET_POWER && (!TARGET_ISEL || !TARGET_ISEL_HACK)"
  [(set (match_dup 0)
	(clz:GPR (match_dup 3)))
...
(define_insn_and_split "*eq<mode>_compare"
  ...
  "!TARGET_POWER && optimize_size && (!TARGET_ISEL || !TARGET_ISEL_HACK)"
  "#"
  "!TARGET_POWER && optimize_size && (!TARGET_ISEL || !TARGET_ISEL_HACK)"
  [(set (match_dup 0)
	(clz:P (match_dup 4)))
