...
(define_expand "copysign<mode>3_fcpsgn"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "")
	(if_then_else:SFDF
	 (ge:SFDF (match_operand:SFDF 2 "gpc_reg_operand" "")
		  (match_dup 3))
	 (abs:SFDF (match_operand:SFDF 1 "gpc_reg_operand" ""))
	 (neg:SFDF (abs:SFDF (match_dup 1)))))]
...
(define_insn "*copysign<mode>3_fcpsgn"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg2>")
	(if_then_else:SFDF
	 (ge:SFDF (match_operand:SFDF 2 "gpc_reg_operand" "<rreg2>")
		  (match_operand:SFDF 3 "zero_constant" "j"))
	 (abs:SFDF (match_operand:SFDF 1 "gpc_reg_operand" ""))
	 (neg:SFDF (abs:SFDF (match_dup 1)))))]
  "TARGET_CMPB && !VECTOR_UNIT_VSX_P (<MODE>mode)"
  "fcpsgn %0,%2,%1"
...
(define_insn_and_split "floatsi<mode>2_lfiwax"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg>,<rreg>")
	(float:SFDF (match_operand:SI 1 "nonimmediate_operand" "Z,r")))
   (clobber (match_operand:DI 2 "gpc_reg_operand" "=d,d"))
   (clobber (match_operand:SI 3 "indexed_or_indirect_operand" "=Z,Z"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT && TARGET_LFIWAX
   && <SI_CONVERT_FP>"
  "#"
  ""
  ...
  "
{
  if (MEM_P (operands[1]))
    {
      operands[1] = rs6000_make_indexed_or_indirect_address (operands[1]);
      emit_insn (gen_lfiwax (operands[2], operands[1]));
    }
  else
    {
      emit_move_insn (operands[3], operands[1]);
      operands[3] = rs6000_make_indexed_or_indirect_address (operands[3]);
      emit_insn (gen_lfiwax (operands[2], operands[3]));
    }
...
(define_insn_and_split "floatsi<mode>2_lfiwax2"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg2>")
	(float:SFDF
	 (sign_extend:DI
...
(define_insn_and_split "floatunssi<mode>2_lfiwzx"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg>,<rreg>")
	(unsigned_float:SFDF (match_operand:SI 1 "nonimmediate_operand" "Z,r")))
   (clobber (match_operand:DI 2 "gpc_reg_operand" "=d,d"))
   (clobber (match_operand:SI 3 "indexed_or_indirect_operand" "=Z,Z"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT && TARGET_LFIWZX
   && <SI_CONVERT_FP>"
  ...
  "
{
  if (MEM_P (operands[1]))
    ...
    {
      emit_move_insn (operands[3], operands[1]);
      emit_insn (gen_lfiwzx (operands[2], operands[3]));
    }
  emit_insn (gen_floatdi<mode>2 (operands[0], operands[2]));
  DONE;
}"
...
(define_insn_and_split "floatunssi<mode>2_lfiwzx2"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg2>")
	(unsigned_float:SFDF
	 (zero_extend:DI
	  (match_operand:SI 1 "indexed_or_indirect_operand" "Z"))))
...
; For each of these conversions, there is a define_expand, and a
; define_insn_and_split.  The idea is to allow constant folding with the
; template of the define_insn, then to have the insns split later (between
; sched1 and final).
  ...
  "
{
  if (TARGET_E500_DOUBLE)
  ...
  else if (TARGET_FCFID)
    {
      if (!REG_P (operands[1]))
	operands[1] = force_reg (SImode, operands[1]);
      operands[1] = convert_to_mode (DImode, operands[1], false);
...
(define_expand "floatunssisf2"
  ...
  "TARGET_HARD_FLOAT && TARGET_SINGLE_FLOAT
   && (!TARGET_FPRS
       || (TARGET_DOUBLE_FLOAT && TARGET_LFIWZX && TARGET_FCFIDUS))"
  "
{
  if (TARGET_FPRS && TARGET_LFIWZX && TARGET_FCFIDUS)
    {
  ...
  "
{
  ...
  else if (TARGET_FCFID && TARGET_POWERPC64)
    {
      if (!REG_P (operands[1]))
	operands[1] = force_reg (SImode, operands[1]);
      operands[1] = convert_to_mode (DImode, operands[1], true);
      emit_insn (gen_floatdidf2 (operands[0], operands[1]));
      DONE;
    }
...
(define_insn_and_split "fix_trunc<mode>si2_stfiwx"
  [(set (match_operand:SI 0 "nonimmediate_operand" "=Z,r")
	(fix:SI (match_operand:SFDF 1 "gpc_reg_operand" "<rreg2>,<rreg2>")))
   (clobber (match_operand:DI 2 "gpc_reg_operand" "=d,d"))
   (clobber (match_operand:SI 3 "indexed_or_indirect_operand" "=Z,Z"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT
   ...
   && TARGET_STFIWX"
  "#"
  "&& (reload_completed || MEM_P (operands[0]) || !TARGET_MFPGPR)"
  [(pc)]
  "
{
  ...
  else if (TARGET_MFPGPR && TARGET_POWERPC64 && REG_P (operands[0])
...
(define_insn_and_split "fix_trunc<mode>si2_stfiwx2"
  [(set (match_operand:SI 0 "indexed_or_indirect_operand" "=Z")
...
(define_expand "fix_trunc<mode>si2"
  ...
  "(TARGET_POWER2 || TARGET_POWERPC) && TARGET_HARD_FLOAT
   && ((TARGET_FPRS && <TARGET_FLOAT>)
       || (<MODE>mode == DFmode && TARGET_E500_DOUBLE))"
  "
{
  if (<MODE>mode == DFmode && TARGET_E500_DOUBLE)
    {
     emit_insn (gen_spe_fix_truncdfsi2 (operands[0], operands[1]));
     DONE;
    }
  operands[2] = gen_reg_rtx (DImode);
  if (TARGET_STFIWX && MEM_P (operands[0]))
    {
      operands[0] = rs6000_make_indexed_or_indirect_address (operands[0]);
      emit_insn (gen_fix_trunc<mode>si2_stfiwx2 (operands[0], operands[1],
						 operands[2]));
      DONE;
    }
  else if (TARGET_STFIWX)
    {
      rtx stack = assign_stack_temp (SImode, GET_MODE_SIZE (SImode), 0);
...
(define_insn_and_split "*fix_truncdfsi2_internal"
  ...
  "(TARGET_POWER2 || TARGET_POWERPC) && TARGET_HARD_FLOAT && TARGET_FPRS 
   && TARGET_DOUBLE_FLOAT && !TARGET_STFIWX"
  "#"
  ""
  [(pc)]
  "
{
  ...
  emit_insn (gen_fctiwz_df (operands[2], operands[1]));
  emit_move_insn (operands[3], operands[2]);
...
(define_insn_and_split "fixuns_trunc<mode>si2_stfiwx"
  [(set (match_operand:SI 0 "nonimmediate_operand" "=Z,r")
	(unsigned_fix:SI
	 (match_operand:SFDF 1 "gpc_reg_operand" "<rreg2>,<rreg2>")))
   (clobber (match_operand:DI 2 "gpc_reg_operand" "=d,d"))
   (clobber (match_operand:SI 3 "indexed_or_indirect_operand" "=Z,Z"))]
...
(define_insn_and_split "fixuns_trunc<mode>si2_stfiwx2"
  [(set (match_operand:SI 0 "indexed_or_indirect_operand" "=Z")
  ...
  "
{
  ...
  if (MEM_P (operands[0]))
    {
      operands[0] = rs6000_make_indexed_or_indirect_address (operands[0]);
      emit_insn (gen_fixuns_trunc<mode>si2_stfiwx2 (operands[0], operands[1],
						    tmp));
      DONE;
    }
  else
...
(define_expand "fixuns_trunc<mode>di2"
  ...
  "TARGET_HARD_FLOAT && (TARGET_POPCNTD || VECTOR_UNIT_VSX_P (<MODE>mode))"
  "")

(define_insn "*fixuns_trunc<mode>di2_internal"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=d")
...
(define_expand "fctiwz_<mode>"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=d")
	(unspec:DI [(fix:SI (match_operand:SFDF 1 "gpc_reg_operand" "<rreg2>"))]
		   UNSPEC_FCTIWZ))]
  "(TARGET_POWER2 || TARGET_POWERPC) && TARGET_HARD_FLOAT && TARGET_FPRS
   && TARGET_DOUBLE_FLOAT"
  "")
...
(define_insn "*fctiwz_<mode>"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=d")
	(unspec:DI [(fix:SI (match_operand:SFDF 1 "gpc_reg_operand" "<rreg2>"))]
		   UNSPEC_FCTIWZ))]
  "(TARGET_POWER2 || TARGET_POWERPC) && TARGET_HARD_FLOAT && TARGET_FPRS
   && TARGET_DOUBLE_FLOAT && !VECTOR_UNIT_VSX_P (DFmode)"
  "{fcirz|fctiwz} %0,%1"
  [(set_attr "type" "fp")])

(define_expand "fctiwuz_<mode>"
  [(set (match_operand:DI 0 "gpc_reg_operand" "=d")
	(unspec:DI [(unsigned_fix:SI
		     (match_operand:SFDF 1 "gpc_reg_operand" "<rreg2>"))]
		   UNSPEC_FCTIWUZ))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT && TARGET_POPCNTD"
  "")
...
;; Optimize (float)(long)x type operations when x is a SF type to not store the
;; intermediate value on the stack and then reload it.  We make a combined
;; instruction, and then split it back into the separate instructions.
;; Unfortunately, we can't optimize (float)(int) type operations, since
;; fctiwz isn't specified to clear the upper 32-bit.
(define_insn_and_split "*float<mode>_fixdisf2"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg2>")
	(float:SFDF
	 (fix:DI
  ...
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT
   && TARGET_SINGLE_FLOAT && <SI_CONVERT_FP>"
  "#"
  "&& reload_completed"
  [(set (match_dup 2) (fix:DI (match_dup 1)))
   (set (match_dup 0) (float:<MODE> (match_dup 2)))]
  ""
  [(set_attr "length" "8")])

(define_insn_and_split "*float<mode>_fixdidf2"
  [(set (match_operand:SFDF 0 "gpc_reg_operand" "=<rreg2>")
	(float:SFDF (fix:DI (match_operand:DF 1 "gpc_reg_operand" "d"))))
   (clobber (match_scratch:DI 2 "=d"))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT
   && TARGET_SINGLE_FLOAT && <SI_CONVERT_FP>
...
(define_expand "floatsisf2"
  ...
  "TARGET_HARD_FLOAT && TARGET_SINGLE_FLOAT
   && (!TARGET_FPRS
       || (TARGET_FPRS && TARGET_DOUBLE_FLOAT && TARGET_FCFIDS
	   && TARGET_LFIWAX))"
  "
{
  if (TARGET_FPRS && TARGET_FCFIDS && TARGET_LFIWAX)
    {
      rs6000_expand_convert_si_to_sfdf (operands[0], operands[1], false);
      DONE;
    }
...
; Allow memory operands in the source so that the optimizer/register allocator
; doesn't try to load the value too early in a GPR and then use store/load to
; move it to a FPR and suffer from a store-load hit.  Reload will synthesize
...
(define_insn "*floatdidf2_fcfid"
  [(set (match_operand:DF 0 "gpc_reg_operand" "=d")
	(float:DF (match_operand:DI 1 "nonimmediate_operand" "d")))]
  "TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT && TARGET_FPRS && TARGET_FCFID
   && !VECTOR_UNIT_VSX_P (DFmode)"
  "fcfid %0,%1"
  [(set_attr "type" "fp")
...
(define_expand "floatunsdidf2"
  [(set (match_operand:DF 0 "gpc_reg_operand" "")
	(unsigned_float:DF (match_operand:DI 1 "nonimmediate_operand" "")))]
  "TARGET_FCFIDU || VECTOR_UNIT_VSX_P (DFmode)"
  "")

(define_insn "*floatunsdidf2_fdfidu"
  [(set (match_operand:DF 0 "gpc_reg_operand" "=d")
	(unsigned_float:DF (match_operand:DI 1 "nonimmediate_operand" "d")))]
  "TARGET_FCFIDU && !VECTOR_UNIT_VSX_P (DFmode)"
  "fcfidu %0,%1"
  [(set_attr "type" "fp")
   (set_attr "length" "4")])
...
(define_insn "*fix_truncdfdi2_fpr"
  ...
  "TARGET_HARD_FLOAT && TARGET_DOUBLE_FLOAT && TARGET_FPRS
    && TARGET_FCFID && !VECTOR_UNIT_VSX_P (DFmode)"
  "fctidz %0,%1"
  [(set_attr "type" "fp")])
...
(define_expand "floatdisf2"
  ...
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_SINGLE_FLOAT
   && (TARGET_POWERPC64 || TARGET_FCFIDS
       || (TARGET_FCFID && flag_unsafe_math_optimizations))"
  "
{
  if (!TARGET_FCFIDS)
    {
      rtx val = operands[1];
      if (!REG_P (val))
	val = operands[1] = force_reg (DImode, val);
...
(define_insn "floatdisf2_fcfids"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f")
	(float:SF (match_operand:DI 1 "nonimmediate_operand" "d")))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_SINGLE_FLOAT
...
(define_insn "floatunsdisf2"
  [(set (match_operand:SF 0 "gpc_reg_operand" "=f")
        (unsigned_float:SF (match_operand:DI 1 "nonimmediate_operand" "d")))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_SINGLE_FLOAT
...
(define_insn "*movdi_mfpgpr"
  [(set (match_operand:DI 0 "nonimmediate_operand" "=r,r,m,r,r, r,r,*d,*d,m,*wa,*wa, Z, r,*h,*h, r,*d")
	(match_operand:DI 1 "input_operand"         "r,m,r,I,L,nF,R, d, m,d, wa,  Z,wa,*h, r, 0,*d, r"))]
  "TARGET_POWERPC64 && TARGET_MFPGPR && TARGET_HARD_FLOAT && TARGET_FPRS
   && (gpc_reg_operand (operands[0], DImode)
       || gpc_reg_operand (operands[1], DImode))"
  "@
   ...
   mftgpr %0,%1
   mffgpr %0,%1"
  [(set_attr "type" "*,load,store,*,*,*,*,fp,fpload,fpstore,fp,fpload,fpstore,mfjmpr,mtjmpr,*,mftgpr,mffgpr")
   (set_attr "length" "4,4,4,4,4,20,4,4,4,4,4,4,4,4,4,4,4,4")])

(define_insn "*movdi_internal64"
  [(set (match_operand:DI 0 "nonimmediate_operand" "=r,r,m,r,r, r,r,*d,*d,m,*wa,*wa, Z, r,*h,*h")
	(match_operand:DI 1 "input_operand"         "r,m,r,I,L,nF,R, d, m,d, wa,  Z,wa,*h, r, 0"))]
  "TARGET_POWERPC64 && (!TARGET_MFPGPR || !TARGET_HARD_FLOAT || !TARGET_FPRS)
   && (gpc_reg_operand (operands[0], DImode)
       || gpc_reg_operand (operands[1], DImode))"
  "@
   ...
   mt%0 %1
   {cror 0,0,0|nop}"
  [(set_attr "type" "*,load,store,*,*,*,*,fp,fpload,fpstore,fp,fpload,fpstore,mfjmpr,mtjmpr,*")
