...
;; Use the move to CR instruction to optimize switch statements
(define_insn_and_split "casesi_internal<mode>"
  [(set (pc)
	(unspec:P [(match_operand:SI 0 "register_operand" "r")
		   (match_operand:SI 1 "const_int_operand" "i")
		   (label_ref (match_operand 2))
  ...
  "
{
  rs6000_split_casesi (operands[0], operands[1], operands[2], operands[3]);
  DONE;
}")
...
(define_expand "casesi"
  ...
  "
{
  rs6000_expand_casesi (operands[0], operands[1], operands[2], operands[3],
		        operands[4]);
  DONE;
}")
