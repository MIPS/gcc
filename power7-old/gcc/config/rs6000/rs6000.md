...
(define_expand "rsqrt<mode>2"
  [(set (match_operand:FP2 0 "gpc_reg_operand" "")
	(unspec:FP2 [(match_operand:FP2 1 "gpc_reg_operand" "")]
		    UNSPEC_RSQRT))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_PPC_GFXOPT
   && ((<MODE>mode == SFmode && TARGET_SINGLE_FLOAT)
       || (<MODE>mode == DFmode && TARGET_DOUBLE_FLOAT))"
{
...
(define_insn "*rsqrtdf_internal1"
  [(set (match_operand:DF 0 "gpc_reg_operand" "=d")
	(unspec:DF [(match_operand:DF 1 "gpc_reg_operand" "d")]
		   UNSPEC_RSQRT))]
  "TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT && TARGET_PPC_GFXOPT
   && !VECTOR_UNIT_VSX_P (DFmode)"
  "frsqrte %0,%1"
  [(set_attr "type" "fp")])
