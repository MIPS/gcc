...

;; If the register allocator for medium/large code model creates a reference
;; during register allocation, it will often times create:
;;
;;	(set (reg1) (high ...))
...
(define_peephole2
  [(set (match_operand:DI 0 "base_reg_operand" "")
   ...
   (set (match_operand:DFORM 2 "dform_reg_operand_no_pseudo" "")
	(match_operand:DFORM 3 "memory_operand" ""))]
...
(define_peephole2
  [(set (match_operand:DI 0 "base_reg_operand" "")
	(match_operand:DI 1 "lo_sum_operand" ""))
   (set (match_operand:DFORM 2 "memory_operand" "")
