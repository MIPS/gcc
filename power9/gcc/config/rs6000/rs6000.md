...
; break DF/DD move alternatives on 64-bit systems into smaller pieces
; classic FP registers (stfd, lfd, fmr)
(define_mode_attr D32d1 [(DF "m,d,d")			(DD "m,d,d")])
(define_mode_attr D32d2 [(DF "d,m,d")			(DD "d,m,d")])

; Altivec registers (stxsdx, stxsd, lxsdx, lxsd)
(define_mode_attr D32a1 [(DF "Z, o, wv,wb")		(DD "wn,wn,wn,wn")])
(define_mode_attr D32a2 [(DF "wv,wb,Z, o")		(DD "wn,wn,wn,wn")])

; VSX registers (xxlor, xxlxor)
(define_mode_attr D32v1 [(DF "ws,ws")			(DD "wn,wz")])
(define_mode_attr D32v2 [(DF "ws,j")			(DD "wn,j")])

; GPR registers (std, ld, mr, li)
(define_mode_attr D32g1 [(DF " Y,!r,!r,!r")		(DD " Y,!r,!r,!r")])
(define_mode_attr D32g2 [(DF "!r, Y, r, j")		(DD "!r, Y, r, j")])

(define_insn "*mov<mode>_hardfloat32"
  [(set (match_operand:FMOVE64 0 "nonimmediate_operand" "=<D32d1>,<D32a1>,<D32v1>,<D32g1>")
	(match_operand:FMOVE64 1 "input_operand"         "<D32d2>,<D32a2>,<D32v2>,<D32g2>"))]
  ...
  "@
   ...
   #
   #"
  [(set_attr "type"   "fpstore,fpload,fp,fpstore,fpstore,fpload,fpload,vecsimple,vecsimple,store,load,integer,integer")
...
; break DF/DD move alternatives on 64-bit systems into smaller pieces
; classic FP registers (stfd, lfd, fmr)
(define_mode_attr D64d1 [(DF "m,d,d")			(DD "m,d,d")])
(define_mode_attr D64d2 [(DF "d,m,d")			(DD "d,m,d")])

; Altivec registers (stxsdx, stxsd, lxsdx, lxsd)
(define_mode_attr D64a1 [(DF "Z, o, wv,wb")		(DD "wn,wn,wn,wn")])
(define_mode_attr D64a2 [(DF "wv,wb,Z, o")		(DD "wn,wn,wn,wn")])

; VSX registers (xxlor, xxlxor)
(define_mode_attr D64v1 [(DF "ws,ws")			(DD "wn,wz")])
(define_mode_attr D64v2 [(DF "ws,j")			(DD "wn,j")])

; GPR registers (std, ld, mr, li)
(define_mode_attr D64g1 [(DF " Y,!r,!r,!r")		(DD " Y,!r,!r,!r")])
(define_mode_attr D64g2 [(DF "!r, Y, r, j")		(DD "!r, Y, r, j")])

; Direct move, move to/from SPR (mtspr, mfspr, nop, mftgpr, mffgpr, mfvsrd, mtvsrd)
(define_mode_attr D64s1 [(DF "*c*l,!r,*h,r, wg,r, wk")	(DD "*c*l,!r,*h,r, wg,r, wh")])
(define_mode_attr D64s2 [(DF " r,   h, 0,wg,r, wk,r")	(DD " r,   h, 0,wg,r, wh,r ")])

(define_insn "*mov<mode>_hardfloat64"
  [(set (match_operand:FMOVE64 0 "nonimmediate_operand" "=<D64d1>,<D64a1>,<D64v1>,<D64g1>,<D64s1>")
	(match_operand:FMOVE64 1 "input_operand"         "<D64d2>,<D64a2>,<D64v2>,<D64g2>,<D64s2>"))]
  "TARGET_POWERPC64 && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT
   && (gpc_reg_operand (operands[0], <MODE>mode)
       || gpc_reg_operand (operands[1], <MODE>mode))"
  "@
   ...
   mfvsrd %0,%x1
   mtvsrd %x0,%1"
  [(set_attr "type" "fpstore,fpload,fp,fpstore,fpstore,fpload,fpload,vecsimple,vecsimple,store,load,integer,integer,mtjmpr,mfjmpr,*,mftgpr,mffgpr,mftgpr,mffgpr")
   (set_attr "length" "4")])
