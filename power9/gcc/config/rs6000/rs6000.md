...
;; If we have direct move, disable the optimization, as it is faster to do a
;; direct move to a GPR to sign/zero extend the value then it is store the
;; value on the stack and reload it.
