...
; break DF/DD move alternatives on 32-bit systems into smaller pieces
; classic FP registers        stfd, lfd, fmr
(define_mode_attr D32d1 [(DF "m,    d,   d")
			 (DD "m,    d,   d")])

(define_mode_attr D32d2 [(DF "d,    m,   d")
			 (DD "d,    m,   d")])

; Altivec/VSX registers       stxsdx, stxsd, lxsdx, lxsd, xxlor, xxlxor
(define_mode_attr D32v1 [(DF "Z,      o,     wv,    wb,   ws,    ws")
			 (DD "wn,     wn,    wn,    wn,   wn,    wz")])

(define_mode_attr D32v2 [(DF "wv,     wb,    Z,     o,    ws,    j")
			 (DD "wn,     wn,    wn,    wn,   wn,    j")])

; GPR registers               st,  lwz, mr, li)
(define_mode_attr D32g1 [(DF "Y,   !r,  !r, !r")
			 (DD "Y,   !r,  !r, !r")])

(define_mode_attr D32g2 [(DF "!r,  Y,   r,  j")
			 (DD "!r,  Y,   r,  j")])

(define_insn "*mov<mode>_hardfloat32"
  [(set (match_operand:FMOVE64 0 "nonimmediate_operand" "=<D32d1>,<D32v1>,<D32g1>")
	(match_operand:FMOVE64 1 "input_operand"         "<D32d2>,<D32v2>,<D32g2>"))]
...
; classic FP registers        stfd, lfd, fmr
(define_mode_attr D64d1 [(DF "m,    d,   d")
			 (DD "m,    d,   d")])

(define_mode_attr D64d2 [(DF "d,    m,   d")
			 (DD "d,    m,   d")])

; Altivec/VSX registers       stxsdx, stxsd, lxsdx, lxsd, xxlor, xxlxor
(define_mode_attr D64v1 [(DF "Z,      Y,     wv,    wb,   ws,    ws")
			 (DD "wn,     wn,    wn,    wn,   wn,    wz")])

(define_mode_attr D64v2 [(DF "wv,     wb,    Z,     Y,    ws,    j")
			 (DD "wn,     wn,    wn,    wn,   wn,    j")])

; GPR registers               std, ld, mr, li
(define_mode_attr D64g1 [(DF " Y,  !r, !r, !r")
			 (DD " Y,  !r, !r, !r")])

(define_mode_attr D64g2 [(DF "!r,  Y,  r,  j")
			 (DD "!r,  Y,  r,  j")])

; Move between registers      mtspr, mfspr, nop, mftgpr, mffgpr, mfvsrd, mtvsrd)
(define_mode_attr D64s1 [(DF "*h,    !r,    *h,   ?*r,   ?*wg,   ?*r,    ?*wk")
			 (DD "*h,    !r,    *h,   ?*r,   ?*wg,   ?*r,    ?*wh")])

(define_mode_attr D64s2 [(DF "r,     h,     0,    wg,     r,      wk,     r")
			 (DD "r,     h,     0,    wg,     r,      wh,     r")])

(define_insn "*mov<mode>_hardfloat64"
  [(set (match_operand:FMOVE64 0 "nonimmediate_operand" "=<D64d1>,<D64v1>,<D64g1>,<D64s1>")
	(match_operand:FMOVE64 1 "input_operand"         "<D64d2>,<D64v2>,<D64g2>,<D64s2>"))]
  "TARGET_POWERPC64 && TARGET_HARD_FLOAT && TARGET_FPRS && TARGET_DOUBLE_FLOAT
   && (gpc_reg_operand (operands[0], <MODE>mode)
       || gpc_reg_operand (operands[1], <MODE>mode))"
  "@
