...
;; Supported integer vector modes (not 64 bit).
  ...
  "TARGET_NEON"
{
  ...
  int hi = INTVAL (operands[2]) / half_elts;
...
(define_insn "ior<mode>3_64"
  [(set (match_operand:V64 0 "s_register_operand" "=w,w")
	(unspec:V64 [(match_operand:V64 1 "s_register_operand" "w,0")
		     (match_operand:V64 2 "neon_logic_op2" "w,Dl")]
                    UNSPEC_VORR))]
  "TARGET_NEON"
{
  switch (which_alternative)
...
(define_insn "and<mode>3_64"
  [(set (match_operand:V64 0 "s_register_operand" "=w,w")
	(unspec:V64 [(match_operand:V64 1 "s_register_operand" "w,0")
		     (match_operand:V64 2 "neon_inv_logic_op2" "w,DL")]
                    UNSPEC_VAND))]
  "TARGET_NEON"
{
  switch (which_alternative)
...
(define_insn "orn<mode>3_neon"
  [(set (match_operand:V64 0 "s_register_operand" "=w")
	(unspec:V64 [(match_operand:V64 1 "s_register_operand" "w")
		     (match_operand:V64 2 "s_register_operand" "w")]
                    UNSPEC_VORN))]
  "TARGET_NEON"
  "vorn\t%<V_reg>0, %<V_reg>1, %<V_reg>2")
...
(define_insn "neon_vceq<mode>"
  [(set (match_operand:<V_cmp_result> 0 "s_register_operand" "=w")
        (unspec:<V_cmp_result> [(match_operand:VDQ 1 "s_register_operand" "w")
		                (match_operand:VDQ 2 "s_register_operand" "w")
                                (match_operand:SI 3 "immediate_operand" "i")]
                               UNSPEC_VCEQ))]
  "TARGET_NEON"
...
(define_insn "neon_vaba<mode>"
  [(set (match_operand:VDQI 0 "s_register_operand" "=w")
        (unspec:VDQI [(match_operand:VDQI 1 "s_register_operand" "0")
		      (match_operand:VDQI 2 "s_register_operand" "w")
		      (match_operand:VDQI 3 "s_register_operand" "w")
                      (match_operand:SI 4 "immediate_operand" "i")]
                     UNSPEC_VABA))]
  "TARGET_NEON"
...
(define_insn "neon_vpaddl<mode>"
  [(set (match_operand:<V_double_width> 0 "s_register_operand" "=w")
        (unspec:<V_double_width> [(match_operand:VDQI 1 "s_register_operand" "w")
                                  (match_operand:SI 2 "immediate_operand" "i")]
                                 UNSPEC_VPADDL))]
  "TARGET_NEON"
...
(define_insn "neon_vdup_n<mode>"
  [(set (match_operand:VDQ 0 "s_register_operand" "=w")
	(unspec:VDQ [(match_operand:<V_elem> 1 "s_register_operand" "r")]
                    UNSPEC_VDUP_N))]
  "TARGET_NEON"
...
(define_insn "neon_vtrn<mode>_internal"
  [(set (match_operand:VDQ 0 "s_register_operand" "=w")
	(unspec:VDQ [(match_operand:VDQ 1 "s_register_operand" "0")]
                    UNSPEC_VTRN1))
   (set (match_operand:VDQ 2 "s_register_operand" "=w")
        (unspec:VDQ [(match_operand:VDQ 3 "s_register_operand" "2")]
		    UNSPEC_VTRN2))]
  "TARGET_NEON"
...
(define_insn "neon_vst1<mode>"
  [(unspec:VDX [(mem:VDX (match_operand:SI 0 "s_register_operand" "r"))
...
(define_insn "neon_vst1<mode>"
  [(unspec:VQX [(mem:VQX (match_operand:SI 0 "s_register_operand" "r"))
...
(define_insn "neon_vst1_lane<mode>"
  [(unspec:VDX [(mem:<V_elem> (match_operand:SI 0 "s_register_operand" "r"))
                (match_operand:VDX 1 "s_register_operand" "w")
                (match_operand:SI 2 "immediate_operand" "i")]
               UNSPEC_VST1_LANE)]
  "TARGET_NEON"
...
(define_insn "neon_vst1_lane<mode>"
  [(unspec:VQX [(mem:<V_elem> (match_operand:SI 0 "s_register_operand" "r"))
                (match_operand:VQX 1 "s_register_operand" "w")
                (match_operand:SI 2 "immediate_operand" "i")]
               UNSPEC_VST1_LANE)]
  "TARGET_NEON"
...
(define_insn "neon_vst2<mode>"
  [(unspec:VDX [(mem:TI (match_operand:SI 0 "s_register_operand" "r"))
...
(define_insn "neon_vst2<mode>"
  [(unspec:VQ [(mem:OI (match_operand:SI 0 "s_register_operand" "r"))
...
(define_insn "neon_vst2_lane<mode>"
  [(unspec:VD [(mem:<V_two_elem> (match_operand:SI 0 "s_register_operand" "r"))
               (match_operand:TI 1 "s_register_operand" "w")
               (match_operand:SI 2 "immediate_operand" "i")]
              UNSPEC_VST2_LANE)]
  "TARGET_NEON"
...
(define_insn "neon_vst2_lane<mode>"
  [(unspec:VMQ [(mem:<V_two_elem> (match_operand:SI 0 "s_register_operand" "r"))
                (match_operand:OI 1 "s_register_operand" "w")
                (match_operand:SI 2 "immediate_operand" "i")]
               UNSPEC_VST2_LANE)]
  "TARGET_NEON"
...
(define_insn "neon_vst3<mode>"
  [(unspec:VDX [(mem:EI (match_operand:SI 0 "s_register_operand" "r"))
...
(define_insn "neon_vst3_lane<mode>"
  [(unspec:VD [(mem:<V_three_elem> (match_operand:SI 0 "s_register_operand" "r"))
               (match_operand:EI 1 "s_register_operand" "w")
               (match_operand:SI 2 "immediate_operand" "i")]
              UNSPEC_VST3_LANE)]
  "TARGET_NEON"
...
(define_insn "neon_vst3_lane<mode>"
  [(unspec:VMQ [(mem:<V_three_elem> (match_operand:SI 0 "s_register_operand" "r"))
                (match_operand:CI 1 "s_register_operand" "w")
                (match_operand:SI 2 "immediate_operand" "i")]
               UNSPEC_VST3_LANE)]
  "TARGET_NEON"
...
(define_insn "neon_vst4<mode>"
  [(unspec:VDX [(mem:OI (match_operand:SI 0 "s_register_operand" "r"))
                (match_operand:OI 1 "s_register_operand" "w")]
               UNSPEC_VST4)]
  "TARGET_NEON"
{
...
(define_insn "neon_vst4_lane<mode>"
  [(unspec:VD [(mem:<V_four_elem> (match_operand:SI 0 "s_register_operand" "r"))
               (match_operand:OI 1 "s_register_operand" "w")
               (match_operand:SI 2 "immediate_operand" "i")]
              UNSPEC_VST4_LANE)]
  "TARGET_NEON"
...
(define_insn "neon_vst4_lane<mode>"
  [(unspec:VMQ [(mem:<V_four_elem> (match_operand:SI 0 "s_register_operand" "r"))
                (match_operand:XI 1 "s_register_operand" "w")
                (match_operand:SI 2 "immediate_operand" "i")]
               UNSPEC_VST4_LANE)]
  "TARGET_NEON"
