...
;;- divide instructions.  The m68k_arch_coldfire flag turns the use of the
...
(define_insn ""
  ...
  ""
{
  if (m68k_arch_68020 || m68k_arch_coldfire || ! ADDRESS_REG_P (operands[0]))
    return "tst%.l %0";
...
{
  m68k_last_compare_had_fp_operands = 1;
  if (m68k_arch_coldfire && !reload_completed)
...
(define_insn ""
  ...
  "(unsigned) INTVAL (operands[1]) < 8 && !m68k_arch_coldfire"
{
    ...
    || !(GET_CODE (operands[0]) == MEM && MEM_VOLATILE_P (operands[0])))"
{
  ...
  if (DATA_REG_P (operands[0]) && TUNE_68000)
    return "moveq #0,%0";
  return "clr%.l %0";
})
...
(define_insn "*movsi_smallconst"
  [(set (match_operand:SI 0 "nonimmediate_operand" "=m")
        (unspec:SI [(match_operand:SI 1 "const_int_operand" "i")]
		    UNSPEC_MOVEQ_MEM))]
  "reload_completed && !m68k_arch_coldfire"
{
  return output_move_simode (operands);
})
...
(define_insn "*movsi_cf"
  ...
  "m68k_arch_coldfire && !m68k_arch_isab"
  "* return output_move_simode (operands);")
...
(define_insn "movsf_cf_soft"
  ...
  "m68k_arch_coldfire && !TARGET_COLDFIRE_FPU"
{
  return "move%.l %1,%0";
})
...
(define_insn ""
  ...
  "! TARGET_68881 && ! m68k_arch_coldfire"
{
  if (FP_REG_P (operands[0]))
    {
      if (FP_REG_P (operands[1]))
...
(define_split
  ...
  "!m68k_arch_isab && reload_completed && reg_mentioned_p (operands[0], operands[1])"
...
(define_split
  [(set (match_operand 0 "register_operand" "")
	(zero_extend (match_operand 1 "nonimmediate_src_operand" "")))]
  "!m68k_arch_isab && reload_completed"
  [(set (match_dup 0)
	(const_int 0))
   (set (strict_low_part (match_dup 2))
	(match_dup 1))]
  ...
  ""
{
  ...
  if (m68k_arch_68020 || m68k_arch_coldfire)
    {
      if (ADDRESS_REG_P (operands[1]))
...
(define_insn "*68k_extendqisi2"
  ...
  "m68k_arch_68020 || (m68k_arch_coldfire && !m68k_arch_isab)"
  "extb%.l %0")

...
(define_expand "ftrunc<mode>2"
  ...
  "TARGET_HARD_FLOAT && !m68k_arch_68040"
  "")
    ...
    [(set (subreg:SI (match_operand:DI 0 "register_operand" "") 4)
     ...
     (set (subreg:SI (match_dup 0) 0)
	  (truncate:SI (lshiftrt:DI (mult:DI (zero_extend:DI (match_dup 1))
				    ...
				    (const_int 32))))])]
  "m68k_arch_68020 && !TUNE_68060 && !m68k_arch_coldfire"
  "")
...
(define_insn "divmodhi4"
  ...
  "!m68k_arch_coldfire || m68k_cf_hwdiv"
{
...
(define_insn "andsi3_5200"
  ...
  "m68k_arch_coldfire"
{
  if (m68k_arch_isab && DATA_REG_P (operands[0])
...
(define_insn "clzsi2"
  ...
  "m68k_arch_isaaplus || m68k_arch_isac"
  "ff1 %0")

  ...
  if (INTVAL (operands[2]) == 1)
  ...
  else /* 32 < INTVAL (operands[2]) <= 63 */
    {
      ...
      return INTVAL (operands[2]) >= 15 ? "ext%.w %d0" :
	     m68k_arch_68020 ? "extb%.l %0" : "ext%.w %0\;ext%.l %0";
    }
})
...
(define_insn ""
  ...
  "m68k_arch_68020 && TARGET_BITFIELD
...
(define_expand "seq"
  ...
  ""
{
  if ((m68k_arch_68060 || TARGET_COLDFIRE_FPU)
...
(define_insn ""
  [(set (pc)
   ...
   (set (match_dup 0)
	(plus:HI (match_dup 0)
		 (const_int -1)))]
  "!m68k_arch_coldfire && find_reg_note (insn, REG_NONNEG, 0)"
{
  CC_STATUS_INIT;
  if (DATA_REG_P (operands[0]))
    return "dbra %0,%l1";
  ...
  [(set (match_operand:SI 0 "register_operand" "+r")
   ...
   (set (reg:SI SP_REG)
        (plus:SI (reg:SI SP_REG)
                 (match_operand:SI 1 "const_int_operand" "n")))]
  "m68k_arch_68020 || INTVAL (operands[1]) >= -0x8004"
{
...
(define_insn "unlink"
  [(set (reg:SI SP_REG)
	(plus:SI (match_operand:SI 0 "register_operand" "=r") (const_int 4)))
   (set (match_dup 0)
	(mem:SI (match_dup 0)))]
  ""
  "unlk %0")
...
(define_peephole2
  ...
  "HARD_FP_REG_P (operands[0]) && ! HARD_FP_REG_P (operands[1])"
...
(define_peephole2 
  ...
  [(set (reg:SI SP_REG) (plus:SI (reg:SI SP_REG)
				 (match_dup 3)))
   (set (mem:SF (reg:SI SP_REG))
	(match_dup 2))]
  "operands[3] = GEN_INT(INTVAL(operands[0]) - 4);"
)

;; Speed up stack adjust followed by a fullword fixedpoint push.
;; The 68k movsi patten doesn't allow small constants.
...
{
  operands[3] = GEN_INT(INTVAL(operands[0]) - 4);
  if (!m68k_arch_coldfire && GET_CODE(operands[2]) == CONST_INT)
    {
      HOST_WIDE_INT val = INTVAL(operands[2]);
      if (val >= -0x80 && val < 0x80 && val != 0)
...
(define_peephole2
  ...
  "!m68k_arch_coldfire && !reg_mentioned_p (stack_pointer_rtx, operands[0])"
   ...
   (parallel
    [(set (pc)
     ...
     (set (match_dup 0)
	  (plus:HI (match_dup 0)
		   (const_int -1)))])]
  "!m68k_arch_coldfire && DATA_REG_P (operands[0]) && ! flags_in_68881 ()"
{
  CC_STATUS_INIT;
...
(define_insn "conditional_trap"
  ...
  "m68k_arch_68020 && ! flags_in_68881 ()"
{
