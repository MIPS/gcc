...
extern vector short pack_from_mem (short *p_a, short *p_b,
				   short *p_c, short *p_d,
				   short *p_e, short *p_f,
				   short *p_g, short *p_h)
  __attribute__((__noinline__));
...
extern vector short splat_from_mem (short *p_a)
  __attribute__((__noinline__));
...
vector short
pack_from_mem (short *p_a, short *p_b, short *p_c, short *p_d,
...
int main (void)
{
  ...
  check (pack_from_mem (&expected[0], &expected[1], &expected[2],
  ...
  check_splat (splat_from_mem (&splat_expected));
