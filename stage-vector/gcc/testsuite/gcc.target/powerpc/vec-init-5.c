...
extern vector signed char pack_from_mem (signed char *p_a, signed char *p_b,
...
extern vector signed char splat_from_mem (signed char *p_a)
  __attribute__((__noinline__));
...
vector signed char
pack_from_mem (signed char *p_a, signed char *p_b, signed char *p_c, signed char *p_d,
...
vector signed char
splat_from_mem (signed char *p_a)
{
