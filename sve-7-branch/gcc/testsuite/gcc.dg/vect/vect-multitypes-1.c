...
/* { dg-final { scan-tree-dump-times "Alignment of access forced using peeling" 2 "vect" { xfail { { vect_element_align_preferred || vect_sizes_32B_16B } || { vect_no_align && { ! vect_hw_misalign } } } } } } */
